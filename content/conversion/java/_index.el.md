...
############################# Head ############################
head_title: "Java API μετατροπής εγγράφου | Μετατροπή PDF, Word, Excel, PPTX, HTML και εικόνων"
head_description: "API μετατροπής εγγράφου Java. Μετατροπή PDF, Word, DOC, DOCX, Excel, Υπολογιστικά φύλλα, PPT, PPTX, HTML, PSD, MPT, MPP, Email, MSG, EMLX, AutoCAD και μορφές αρχείων εικόνας."

############################# Header ############################
title: "Μετατροπή εγγράφου<br>μέσω Java API"
...
code:
  title: "Πώς να μετατρέψετε αρχεία PDF σε Java"
...
overview:
  ...
  description: "Εξερευνήστε τις δυνατότητες του API για γρήγορη και άψογη μετατροπή αρχείων PDF, Microsoft Office, HTML, eBook και εικόνας εντός εφαρμογών Java"
  features:
    # feature loop
...
platforms:
  ...
  description: "Το GroupDocs.Conversion για Java υποστηρίζει τα ακόλουθα λειτουργικά συστήματα, πλαίσια και διαχειριστές πακέτων"
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    Το GroupDocs.Conversion για Java υποστηρίζει λειτουργίες με τις ακόλουθες [μορφές αρχείων](https://docs.groupdocs.com/conversion/java/supported-file-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  ...
  items:
    ...
    - icon: "extract"
      ...
      content: "Ενσωματώστε απρόσκοπτα τις δυνατότητες μετατροπής στις εφαρμογές σας Java, καθιστώντας τις απρόσκοπτα μέρος της ροής εργασίας σας."
...
code_samples:
  ...
  description: "Ορισμένες περιπτώσεις χρησιμοποιούν τυπικές λειτουργίες GroupDocs.Conversion για Java"
  items:
    # code sample loop
    - title: "Μετατροπή PDF σε εικόνα"
      content: |
        Ένα συνηθισμένο σενάριο περιλαμβάνει τη μετατροπή ολόκληρου του εγγράφου PDF ή συγκεκριμένων σελίδων σε μια συλλογή εικόνων. Το GroupDocs.Conversion για Java προσφέρει τη δυνατότητα μετατροπής αρχείων PDF σε διάφορες μορφές εικόνας, όπως TIFF, JPG, PNG, GIF, BMP και άλλα. 
        Μπορείτε να επιλέξετε τη μορφή εικόνας που προτιμάτε χρησιμοποιώντας την κλάση ImageFileType.
        {{< landing/code title="Μετατροπή PDF σε PNG σε Java">}}
        ```java {style=abap} 
    ...
    - title: "Μετατροπή τμήματος ενός μεγάλου εγγράφου"
      content: |
        Με το GroupDocs.Conversion για Java, μπορείτε εύκολα να μετατρέψετε συγκεκριμένες σελίδες από ένα μεγάλο έγγραφο. 
        ...
        {{< landing/code title="Μετατροπή DOCX (σελίδες 2-4) σε PDF σε Java">}}
        ```java {style=abap}   
        import com.groupdocs.conversion.Converter;
...
#     content: "Εξαιρετική εξυπηρέτηση και εξαιρετικά προϊόντα. Ήταν εξαιρετικά χρήσιμοι και ανταποκρινόμενοι κατά τη διαδικασία υλοποίησης του GroupDocs.Viewer για Java, δεν μπορεί να τα προτείνει αρκετά."
#     author: "Μάρτιν Λασάργκα"
#     company: "Product Manager στην Axentria ECM by G.S.I."

#   # review loop
#   - title: "GroupDocs.Viewer"
#     content: "Μετά την εφαρμογή και τη χρήση του GroupDocs.Viewer για Java στο έργο, φαίνεται να λειτουργεί πολύ καλά. Έχω δοκιμάσει με πολλά έγγραφα και μέχρι στιγμής καλά. Όλα όσα έχω ρίξει σε αυτό αποδίδονται όμορφα και φαίνονται εξίσου καλά με ένα πρόγραμμα προβολής PDF ή MS Word."
#     author: "Ματς Ουστάντ"
