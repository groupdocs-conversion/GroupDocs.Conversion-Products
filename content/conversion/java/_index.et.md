...
############################# Head ############################
head_title: "Java dokumendi teisendamise API | Teisendage PDF, Word, Excel, PPTX, HTML ja pildid"
head_description: "Java dokumendi teisendamise API. Teisendage PDF-i, Wordi, DOC, DOCX, Exceli, arvutustabelite, PPT, PPTX, HTML, PSD, MPT, MPP, e-posti, MSG, EMLX, AutoCADi ja pildifailivorminguid."

############################# Header ############################
title: "Dokumendi teisendamine<br>Java API kaudu"
...
code:
  title: "Kuidas PDF-faile Java-vormingus teisendada"
  more: "Veel näiteid"
...
overview:
  ...
  description: "Avastage API võimalusi PDF-i, Microsoft Office'i, HTML-i, e-raamatu ja pildifailide kiireks ja veatuks teisendamiseks Java rakendustes"
  features:
    # feature loop
...
platforms:
  ...
  description: "GroupDocs.Conversion for Java toetab järgmisi operatsioonisüsteeme, raamistikke ja paketihaldureid"
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    GroupDocs.Conversion for Java toetab toiminguid järgmiste [failivormingutega](https://docs.groupdocs.com/conversion/java/supported-file-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  ...
  description: "Teisendage PDF- ja kontoridokumendid sujuvalt HTML-, JPG-, PNG-, BMP-, TIFF-, SVG- ja paljudesse muudesse vormingutesse. GroupDocs.Conversion for Java API on loodud nii, et seda oleks lihtne kasutada ja teie projektiga integreerida. See toetab kõiki populaarseid dokumendivorminguid koos võimalusega kohandada teisendusprotsessi."
  ...
  items:
    ...
    - icon: "extract"
      ...
      content: "Integreerige teisendusvõimalused sujuvalt oma Java-rakendustesse, muutes selle oma töövoo sujuvaks osaks."
...
code_samples:
  ...
  description: "Mõned kasutavad tüüpilisi GroupDocs.Conversion Java-toiminguid"
  items:
    # code sample loop
    - title: "Teisendage PDF pildiks"
      content: |
        Sageli esinev stsenaarium hõlmab terve PDF-dokumendi või konkreetsete lehtede teisendamist piltide kogumiks. GroupDocs.Conversion for Java pakub võimalust teisendada PDF-faile erinevatesse pildivormingutesse, nagu TIFF, JPG, PNG, GIF, BMP ja palju muud. 
        Saate valida oma eelistatud pildivormingu, kasutades ImageFileType klassi.
        {{< landing/code title="PDF-i teisendamine Javas PNG-vormingusse">}}
        ```java {style=abap} 
    ...
    - title: "Suure dokumendi segmendi teisendamine"
      content: |
        Rakenduse GroupDocs.Conversion for Java abil saate hõlpsalt teisendada kindlaid lehti pikast dokumendist. 
        Sõltuvalt teie vajadustest on selle saavutamiseks kaks meetodit. Saate teisendada mitut lehekülge või konkreetseid lehti.
        {{< landing/code title="Teisendage Javas DOCX (lk 2-4) PDF-iks">}}
        ```java {style=abap}   
        import com.groupdocs.conversion.Converter;
...
#     content: "Suurepärane teenindus ja suurepärased tooted. Nad olid Java juurutusprotsessis GroupDocs.Vieweri jaoks äärmiselt abivalmid ja reageerivad, kuid ei saa neid piisavalt soovitada."
#     author: "Martin Lasarga"
#     company: "Axentria ECM tootejuht G.S.I."

#   # review loop
#   - title: "GroupDocs.Viewer"
#     content: "Pärast Java jaoks mõeldud GroupDocs.Vieweri rakendamist ja kasutamist projektis tundub, et see töötab väga hästi. Olen katsetanud paljude dokumentidega ja siiani on kõik hästi. Kõik, mida olen sellele visanud, renderdab kenasti ja näeb välja täpselt sama hea kui PDF-vaaturis või MS Wordis."
#     author: "Mats Oustad"
