...
############################# Head ############################
head_title: "Java API za pretvorbu dokumenata | Pretvorite PDF, Word, Excel, PPTX, HTML i slike"
...
############################# Header ############################
title: "Pretvorba dokumenata<br>putem Java API-ja"
...
code:
  title: "Kako pretvoriti PDF datoteke u Java"
  more: "Više primjera"
...
overview:
  ...
  description: "Istražite mogućnosti API-ja za brzu i besprijekornu konverziju PDF, Microsoft Office, HTML, eBook i slikovnih datoteka unutar Java aplikacija"
  features:
    # feature loop
...
platforms:
  ...
  description: "GroupDocs.Conversion za Javu podržava sljedeće operativne sustave, okvire i upravitelje paketa"
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    GroupDocs.Conversion za Javu podržava rad sa sljedećim [formatima datoteka](https://docs.groupdocs.com/conversion/java/supported-file-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  ...
  description: "Besprijekorno pretvorite PDF i uredske dokumente u HTML, JPG, PNG, BMP, TIFF, SVG i mnoge druge formate. GroupDocs.Conversion za Java API dizajniran je za jednostavno korištenje i integraciju u vaš projekt. Podržava sve popularne formate dokumenata s mogućnošću prilagođavanja procesa pretvorbe."
  ...
  items:
    ...
    - icon: "extract"
      ...
      content: "Besprijekorno integrirajte mogućnosti pretvorbe u svoje Java aplikacije, čineći ih neprimjetnim dijelom vašeg tijeka rada."
...
code_samples:
  enable: true
  title: "Uzorci kodova"
  description: "Neki slučajevi upotrebe tipičnih GroupDocs.Conversion za Java operacije"
  items:
    # code sample loop
    - title: "Pretvorite PDF u sliku"
      content: |
        Scenarij koji se često susreće uključuje pretvaranje cijelog PDF dokumenta ili određenih stranica u kolekciju slika. GroupDocs.Conversion za Javu nudi mogućnost pretvaranja PDF-ova u različite slikovne formate, kao što su TIFF, JPG, PNG, GIF, BMP i drugi. 
        Možete odabrati željeni format slike pomoću klase ImageFileType.
        {{< landing/code title="Pretvaranje PDF-a u PNG u Javi">}}
        ```java {style=abap} 
    ...
    - title: "Pretvorite segment velikog dokumenta"
      content: |
        S GroupDocs.Conversion za Javu možete bez napora pretvoriti određene stranice iz dugog dokumenta. 
        ...
        {{< landing/code title="Pretvorite DOCX (stranice 2-4) u PDF u Javi">}}
        ```java {style=abap}   
        import com.groupdocs.conversion.Converter;
...
#     content: "Izvrsna usluga i izvrsni proizvodi. Bili su izuzetno korisni i osjetljivi tijekom procesa implementacije GroupDocs.Viewer za Javu, ne mogu ih dovoljno preporučiti."
#     author: "Martin Lasarga"
#     company: "Voditelj proizvoda u tvrtki Axentria ECM by G.S.I."

#   # review loop
#   - title: "GroupDocs.Viewer"
#     content: "Nakon implementacije i korištenja GroupDocs.Viewer za Javu u projektu, čini se da radi vrlo dobro. Testirao sam s puno dokumenata i za sada je dobro. Sve što sam bacio na njega lijepo se prikazuje i izgleda jednako dobro kao što bi izgledalo u PDF pregledniku ili MS Wordu."
#     author: "Mats Oustad"
