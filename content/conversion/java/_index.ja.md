...
features:
  ...
  description: "PDF およびオフィス ドキュメントを HTML、JPG、PNG、BMP、TIFF、SVG、およびその他の多くの形式にシームレスに変換します。 GroupDocs.Conversion for Java API は、使いやすくプロジェクトに統合できるように設計されています。変換プロセスをカスタマイズする機能により、一般的なドキュメント形式をすべてサポートしています。"
...
#     content: "優れたサービスと優れた製品。これらは、GroupDocs.Viewer for Java の実装プロセス中に非常に役に立ち、応答も速かったですが、あまりお勧めできません。"
#     author: "マーティン・ラサーガ"
