...
############################# Head ############################
head_title: "Java დოკუმენტის კონვერტაციის API | გადაიყვანეთ PDF, Word, Excel, PPTX, HTML და სურათები"
head_description: "Java დოკუმენტის კონვერტაციის API. გადაიყვანეთ PDF, Word, DOC, DOCX, Excel, ცხრილები, PPT, PPTX, HTML, PSD, MPT, MPP, ელფოსტა, MSG, EMLX, AutoCAD და გამოსახულების ფაილის ფორმატები."

############################# Header ############################
title: "დოკუმენტის კონვერტაცია<br>Java API-ის საშუალებით"
...
code:
  title: "როგორ გადავიტანოთ PDF ფაილები Java-ში"
...
overview:
  ...
  description: "გამოიკვლიეთ API-ს შესაძლებლობები PDF, Microsoft Office, HTML, eBook და გამოსახულების ფაილების სწრაფი და უნაკლო კონვერტაციისთვის Java აპლიკაციებში"
  features:
    # feature loop
...
platforms:
  ...
  description: "GroupDocs.Conversion for Java მხარს უჭერს შემდეგ ოპერაციულ სისტემებს, ჩარჩოებსა და პაკეტის მენეჯერებს"
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    GroupDocs.Conversion for Java მხარს უჭერს ოპერაციებს შემდეგი [ფაილის ფორმატები] (https://docs.groupdocs.com/conversion/java/supported-file-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  ...
  description: "შეუფერხებლად გადააკეთეთ PDF და საოფისე დოკუმენტები HTML, JPG, PNG, BMP, TIFF, SVG და სხვა მრავალ ფორმატში. GroupDocs.Conversion for Java API შექმნილია იმისთვის, რომ იყოს მარტივი გამოსაყენებლად და ინტეგრირდეს თქვენს პროექტში. იგი მხარს უჭერს ყველა პოპულარულ დოკუმენტის ფორმატს, კონვერტაციის პროცესის მორგების შესაძლებლობით."
  ...
  items:
    ...
    - icon: "extract"
      ...
      content: "შეუფერხებლად დააკავშირეთ კონვერტაციის შესაძლებლობები თქვენს Java აპლიკაციებში, რაც მას თქვენი სამუშაო პროცესის შეუფერხებელ ნაწილად აქცევს."
...
code_samples:
  ...
  description: "ზოგიერთი იყენებს ტიპიური GroupDocs.Conversion-ის შემთხვევებს Java ოპერაციებისთვის"
  items:
    # code sample loop
    - title: "გადაიყვანეთ PDF სურათად"
      content: |
        ხშირად ნაცნობი სცენარი მოიცავს მთელი PDF დოკუმენტის ან კონკრეტული გვერდების გადაქცევას სურათების კოლექციად. GroupDocs.Conversion for Java გთავაზობთ PDF-ების გადაქცევის შესაძლებლობას გამოსახულების სხვადასხვა ფორმატში, როგორიცაა TIFF, JPG, PNG, GIF, BMP და სხვა. 
        თქვენ შეგიძლიათ აირჩიოთ სურათის სასურველი ფორმატი ImageFileType კლასის გამოყენებით.
        {{< landing/code title="PDF-ის გადაყვანა PNG-ად Java-ში">}}
        ```java {style=abap} 
    ...
    - title: "დიდი დოკუმენტის სეგმენტის კონვერტაცია"
      content: |
        GroupDocs.Conversion-ით Java-სთვის შეგიძლიათ მარტივად გადაიყვანოთ კონკრეტული გვერდები გრძელი დოკუმენტიდან. 
        ...
        {{< landing/code title="გადაიყვანეთ DOCX (გვერდები 2-4) PDF-ზე Java-ში">}}
        ```java {style=abap}   
        import com.groupdocs.conversion.Converter;
...
#     content: "შესანიშნავი მომსახურება და შესანიშნავი პროდუქტები. ისინი ძალიან სასარგებლო და პასუხისმგებელნი იყვნენ GroupDocs.Viewer for Java განხორციელების პროცესის დროს, ვერ გირჩევთ მათ საკმარისად დიდ რეკომენდაციას."
#     author: "მარტინ ლასარგა"
#     company: "პროდუქტის მენეჯერი Axentria ECM-ში G.S.I."

#   # review loop
#   - title: "GroupDocs.Viewer"
#     content: "პროექტში GroupDocs.Viewer Java-სთვის დანერგვისა და გამოყენების შემდეგ, როგორც ჩანს, ის ძალიან კარგად მუშაობს. ბევრი საბუთით მაქვს ტესტირება და ჯერჯერობით კარგია. ყველაფერი, რაც მე გადავყარე, ლამაზად არის გადმოცემული და გამოიყურება ისეთივე კარგად, როგორც PDF მაყურებელში ან MS Word-ში."
#     author: "მატს ოსტადი"
