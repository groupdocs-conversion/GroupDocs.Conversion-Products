...
############################# Head ############################
head_title: "Java API penukaran dokumen | Tukar PDF, Word, Excel, PPTX, HTML dan imej"
head_description: "Java API penukaran dokumen. Tukar PDF, Word, DOC, DOCX, Excel, Hamparan, PPT, PPTX, HTML, JPA, MPT, MPP, E-mel, MSG, EMLX, AutoCAD dan format fail imej."

############################# Header ############################
title: "Penukaran dokumen<br>melalui Java API"
...
code:
  title: "Bagaimana untuk menukar fail PDF dalam Java"
...
overview:
  ...
  description: "Terokai keupayaan API untuk penukaran fail PDF, Microsoft Office, HTML, eBook dan imej yang pantas dan sempurna dalam aplikasi Java"
  features:
    # feature loop
...
platforms:
  ...
  description: "GroupDocs.Conversion untuk Java menyokong sistem pengendalian, rangka kerja dan pengurus pakej berikut"
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    GroupDocs.Conversion untuk Java menyokong operasi dengan [format fail] berikut (https://docs.groupdocs.com/conversion/java/supported-file-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  ...
  description: "Tukar dokumen PDF dan pejabat dengan lancar kepada HTML, JPG, PNG, BMP, TIFF, SVG dan banyak lagi format lain. GroupDocs.Conversion for Java API direka bentuk agar mudah digunakan dan disepadukan ke dalam projek anda. Ia menyokong semua format dokumen popular dengan keupayaan untuk menyesuaikan proses penukaran."
  ...
  items:
    ...
    - icon: "extract"
      ...
      content: "Sepadukan dengan lancar keupayaan penukaran ke dalam aplikasi Java anda, menjadikannya sebahagian lancar aliran kerja anda."
...
code_samples:
  enable: true
  title: "Sampel kod"
  description: "Sesetengah kes menggunakan GroupDocs.Conversion untuk operasi Java"
  items:
    # code sample loop
    - title: "Tukar PDF kepada imej"
      content: |
        Senario yang biasa ditemui melibatkan penukaran keseluruhan dokumen PDF atau halaman tertentu kepada koleksi imej. GroupDocs.Conversion untuk Java menawarkan keupayaan untuk menukar PDF kepada pelbagai format imej, seperti TIFF, JPG, PNG, GIF, BMP dan banyak lagi. 
        Anda boleh memilih format imej pilihan anda menggunakan kelas ImageFileType.
        {{< landing/code title="Menukar PDF kepada PNG dalam Java">}}
        ```java {style=abap} 
    ...
    - title: "Tukar segmen dokumen besar"
      content: |
        Dengan GroupDocs.Conversion untuk Java, anda boleh menukar halaman tertentu dengan mudah daripada dokumen yang panjang. 
        ...
        {{< landing/code title="Tukar DOCX (halaman 2-4) kepada PDF dalam Java">}}
        ```java {style=abap}   
        import com.groupdocs.conversion.Converter;
...
#     content: "Perkhidmatan yang sangat baik dan produk yang sangat baik. Mereka sangat membantu dan responsif semasa proses pelaksanaan GroupDocs.Viewer untuk Java, tidak boleh mengesyorkannya dengan cukup tinggi."
#     author: "Martin Lasarga"
#     company: "Pengurus Produk di Axentria ECM oleh G.S.I."

#   # review loop
#   - title: "GroupDocs.Viewer"
#     content: "Selepas melaksanakan dan menggunakan GroupDocs.Viewer untuk Java dalam projek, ia kelihatan berfungsi dengan baik. Saya telah menguji dengan banyak dokumen dan setakat ini baik. Semua yang saya lemparkan padanya dipaparkan dengan baik dan kelihatan sama baiknya seperti dalam pemapar PDF atau MS Word."
#     author: "Mats Oustad"
