...
############################# Header ############################
title: "Conversão de documentos<br>através da API Java"
...
features:
  ...
  items:
    ...
    - icon: "extract"
      ...
      content: "Integre perfeitamente os recursos de conversão em seus aplicativos Java, tornando-os uma parte integrada do seu fluxo de trabalho."
...
#     content: "Excelente atendimento e excelentes produtos. Eles foram extremamente úteis e responsivos durante o processo de implementação do GroupDocs.Viewer para Java, não posso recomendá-los o suficiente."
