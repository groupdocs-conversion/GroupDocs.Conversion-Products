...
############################# Head ############################
head_title: "Java API na konverziu dokumentov | Konvertujte PDF, Word, Excel, PPTX, HTML a obrázky"
head_description: "Rozhranie API na konverziu dokumentov Java. Konvertujte formáty PDF, Word, DOC, DOCX, Excel, tabuľky, PPT, PPTX, HTML, PSD, MPT, MPP, Email, MSG, EMLX, AutoCAD a obrázkové súbory."

############################# Header ############################
title: "Konverzia dokumentov<br>cez Java API"
...
code:
  title: "Ako previesť súbory PDF v jazyku Java"
  more: "Viac príkladov"
...
overview:
  ...
  description: "Preskúmajte možnosti rozhrania API na rýchlu a bezchybnú konverziu súborov PDF, Microsoft Office, HTML, elektronických kníh a obrázkových súborov v aplikáciách Java"
  features:
    # feature loop
...
platforms:
  ...
  description: "GroupDocs.Conversion for Java podporuje nasledujúce operačné systémy, rámce a správcov balíkov"
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    GroupDocs.Conversion for Java podporuje operácie s nasledujúcimi [formátmi súborov](https://docs.groupdocs.com/conversion/java/supported-file-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  ...
  description: "Bezproblémovo konvertujte PDF a kancelárske dokumenty do HTML, JPG, PNG, BMP, TIFF, SVG a mnohých ďalších formátov. GroupDocs.Conversion for Java API je navrhnuté tak, aby sa dalo ľahko používať a integrovať do vášho projektu. Podporuje všetky populárne formáty dokumentov s možnosťou prispôsobenia procesu prevodu."
  ...
  items:
    ...
    - icon: "extract"
      ...
      content: "Bezproblémovo integrujte možnosti konverzie do svojich aplikácií Java, čím sa stane bezproblémovou súčasťou vášho pracovného postupu."
...
code_samples:
  enable: true
  title: "Vzorky kódu"
  description: "Niektoré prípady použitia typických GroupDocs.Conversion pre operácie Java"
  items:
    # code sample loop
    - title: "Previesť PDF na obrázok"
      content: |
        Bežne sa vyskytujúci scenár zahŕňa konverziu celého dokumentu PDF alebo konkrétnych strán na kolekciu obrázkov. GroupDocs.Conversion for Java ponúka možnosť konvertovať súbory PDF do rôznych obrazových formátov, ako sú TIFF, JPG, PNG, GIF, BMP a ďalšie. 
        Uprednostňovaný formát obrázka si môžete vybrať pomocou triedy ImageFileType.
        {{< landing/code title="Konverzia PDF do PNG v jazyku Java">}}
        ```java {style=abap} 
    ...
    - title: "Previesť segment veľkého dokumentu"
      content: |
        S GroupDocs.Conversion for Java môžete bez námahy previesť konkrétne stránky z dlhého dokumentu. 
        ...
        {{< landing/code title="Preveďte DOCX (strany 2-4) do formátu PDF v jazyku Java">}}
        ```java {style=abap}   
        import com.groupdocs.conversion.Converter;
...
#     content: "Vynikajúce služby a vynikajúce produkty. Počas procesu implementácie GroupDocs.Viewer pre Java boli mimoriadne nápomocní a pohotoví, nemôžeme ich dostatočne odporučiť."
#     author: "Martin Lasarga"
#     company: "Product Manager v spoločnosti Axentria ECM by G.S.I."

#   # review loop
#   - title: "GroupDocs.Viewer"
#     content: "Po implementácii a použití GroupDocs.Viewer pre Java v projekte to vyzerá, že funguje veľmi dobre. Testoval som s množstvom dokumentov a zatiaľ je to dobré. Všetko, čo som naň hodil, sa pekne vykresľuje a vyzerá rovnako dobre ako v prehliadači PDF alebo MS Word."
#     author: "Mats Oustad"
