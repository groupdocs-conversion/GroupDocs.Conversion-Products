...
head_title: "Konversi AI ke AI di Jawa – Konversi AI ke AI"
head_description: "Konversi AI ke AI di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File AI ke AI di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi AI ke AI di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file AI ke AI dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file AI dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen AI
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (AI) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format target AI
...
demos:
    ...
    content: |
        Konversikan AI ke AI sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
