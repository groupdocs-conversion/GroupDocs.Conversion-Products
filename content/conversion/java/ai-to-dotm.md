...
############################# Head ############################
head_title: "AI to DOTM Conversion in Java – Convert AI to DOTM"
head_description: "Convert AI to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "AI to DOTM Live Demos"
    content: |
        Convert AI to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
