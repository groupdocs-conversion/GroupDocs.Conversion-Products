...
head_title: "Konversi AI ke EPUB di Jawa – Konversi AI ke EPUB"
head_description: "Konversi AI ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File AI ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi AI ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file AI ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung AI hingga EPUB"
    content: |
        Konversikan AI ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
