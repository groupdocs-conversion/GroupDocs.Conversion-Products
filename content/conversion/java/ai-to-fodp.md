...
############################# Head ############################
head_title: "AI to FODP Conversion in Java – Convert AI to FODP"
head_description: "Convert AI to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to FODP in few lines of code.
...
demos:
    enable: true
    title: "AI to FODP Live Demos"
    content: |
        Convert AI to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
