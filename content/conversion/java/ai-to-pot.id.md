...
head_title: "Konversi AI ke POT di Jawa – Konversi AI ke POT"
head_description: "Konversi AI ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File AI ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi AI ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file AI ke POT dalam beberapa baris kode.
