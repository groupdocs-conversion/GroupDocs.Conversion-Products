...
head_title: "Konversi AI ke PPSM di Jawa – Konversi AI ke PPSM"
head_description: "Konversi AI ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File AI ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi AI ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file AI ke PPSM dalam beberapa baris kode.
