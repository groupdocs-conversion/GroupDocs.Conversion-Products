...
############################# Head ############################
head_title: "AI to PPSM Conversion in Java – Convert AI to PPSM"
head_description: "Convert AI to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "AI to PPSM Live Demos"
    content: |
        Convert AI to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
