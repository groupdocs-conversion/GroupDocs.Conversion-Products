...
############################# Head ############################
head_title: "Преобразование AI в SXC в Java — преобразование AI в SXC"
head_description: "Преобразуйте AI в SXC на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов AI в SXC в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию AI в SXC в Java"
    content_left: |
