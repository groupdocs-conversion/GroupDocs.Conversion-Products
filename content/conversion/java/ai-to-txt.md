...
############################# Head ############################
head_title: "AI to TXT Conversion in Java – Convert AI to TXT"
head_description: "Convert AI to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to TXT in few lines of code.
...
demos:
    enable: true
    title: "AI to TXT Live Demos"
    content: |
        Convert AI to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
