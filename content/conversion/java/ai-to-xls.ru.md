...
############################# Head ############################
head_title: "Преобразование AI в XLS в Java — преобразование AI в XLS"
head_description: "Преобразуйте AI в XLS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов AI в XLS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию AI в XLS в Java"
    content_left: |
...
demos:
    enable: true
    title: "Преобразование AI в XLS Живые демонстрации"
    content: |
