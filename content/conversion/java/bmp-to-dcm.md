...
############################# Head ############################
head_title: "BMP to DCM Conversion in Java – Convert BMP to DCM"
head_description: "Convert BMP to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to DCM in few lines of code.
...
demos:
    enable: true
    title: "BMP to DCM Live Demos"
    content: |
        Convert BMP to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
