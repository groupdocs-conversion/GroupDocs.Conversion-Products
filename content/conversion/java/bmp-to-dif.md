...
############################# Head ############################
head_title: "BMP to DIF Conversion in Java – Convert BMP to DIF"
head_description: "Convert BMP to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to DIF in few lines of code.
...
demos:
    enable: true
    title: "BMP to DIF Live Demos"
    content: |
        Convert BMP to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
