...
head_title: "Konversi BMP ke DOTM di Jawa – Konversi BMP ke DOTM"
head_description: "Konversi BMP ke DOTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File BMP ke DOTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi BMP ke DOTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file BMP ke DOTM dalam beberapa baris kode.
