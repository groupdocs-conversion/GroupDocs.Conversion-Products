...
head_title: "Konversi BMP ke EPUB di Jawa – Konversi BMP ke EPUB"
head_description: "Konversi BMP ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File BMP ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi BMP ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file BMP ke EPUB dalam beberapa baris kode.
