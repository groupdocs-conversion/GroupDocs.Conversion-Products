...
############################# Head ############################
head_title: "BMP to FODP Conversion in Java – Convert BMP to FODP"
head_description: "Convert BMP to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to FODP in few lines of code.
...
demos:
    enable: true
    title: "BMP to FODP Live Demos"
    content: |
        Convert BMP to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
