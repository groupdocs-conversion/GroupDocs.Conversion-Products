...
head_title: "Konversi BMP ke OTT di Jawa – Konversi BMP ke OTT"
head_description: "Konversi BMP ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File BMP ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi BMP ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file BMP ke OTT dalam beberapa baris kode.
