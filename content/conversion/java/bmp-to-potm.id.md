...
head_title: "Konversi BMP ke POTM di Jawa – Konversi BMP ke POTM"
head_description: "Konversi BMP ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File BMP ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi BMP ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file BMP ke POTM dalam beberapa baris kode.
