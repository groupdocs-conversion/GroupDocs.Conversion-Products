...
############################# Head #############################
head_title: "Java BMP zu WMF Konverter API - BMP in Java-Anwendungen transformieren"
head_description: "BMP zu WMF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "BMP in WMF in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von BMP in WMF Datei in Java" 
    content: |
      Die Transformation von BMP in WMF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // BMP in WMF Datei konvertieren        
        ```            
