...
head_title: "Konversi BMP ke XLTX di Jawa – Konversi BMP ke XLTX"
head_description: "Konversi BMP ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File BMP ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi BMP ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file BMP ke XLTX dalam beberapa baris kode.
