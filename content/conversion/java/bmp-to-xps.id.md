...
head_title: "Konversi BMP ke XPS di Jawa – Konversi BMP ke XPS"
head_description: "Konversi BMP ke XPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File BMP ke XPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi BMP ke XPS di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file BMP ke XPS dalam beberapa baris kode.
