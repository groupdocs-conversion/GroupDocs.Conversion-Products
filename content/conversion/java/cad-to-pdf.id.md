...
head_title: "Konversi CAD ke PDF di Jawa – Konversi CAD ke PDF"
head_description: "Konversi CAD ke PDF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CAD ke PDF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CAD ke PDF di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CAD ke PDF dalam beberapa baris kode.
