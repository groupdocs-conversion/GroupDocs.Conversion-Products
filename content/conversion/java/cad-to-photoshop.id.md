...
head_title: "Konversi CAD ke PHOTOSHOP di Jawa – Konversi CAD ke PHOTOSHOP"
head_description: "Konversi CAD ke PHOTOSHOP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CAD ke PHOTOSHOP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CAD ke PHOTOSHOP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CAD ke PHOTOSHOP dalam beberapa baris kode.
