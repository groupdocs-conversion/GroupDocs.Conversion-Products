...
head_title: "Konversi CAD ke WORD di Jawa – Konversi CAD ke WORD"
head_description: "Konversi CAD ke WORD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CAD ke WORD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CAD ke WORD di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CAD ke WORD dalam beberapa baris kode.
