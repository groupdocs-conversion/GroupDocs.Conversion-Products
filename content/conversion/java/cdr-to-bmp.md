...
############################# Head ############################
head_title: "CDR to BMP Conversion in Java – Convert CDR to BMP"
head_description: "Convert CDR to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to BMP in few lines of code.
...
demos:
    enable: true
    title: "CDR to BMP Live Demos"
    content: |
        Convert CDR to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
