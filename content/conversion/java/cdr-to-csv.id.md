...
head_title: "Konversi CDR ke CSV di Jawa – Konversi CDR ke CSV"
head_description: "Konversi CDR ke CSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke CSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke CSV di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke CSV dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga CSV"
    content: |
        Konversikan CDR ke CSV sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
