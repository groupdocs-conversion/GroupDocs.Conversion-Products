...
head_title: "Konversi CDR ke DCM di Jawa – Konversi CDR ke DCM"
head_description: "Konversi CDR ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke DCM di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga DCM"
    content: |
        Konversikan CDR ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
