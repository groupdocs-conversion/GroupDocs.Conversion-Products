...
############################# Head ############################
head_title: "CDR to EMF Conversion in Java – Convert CDR to EMF"
head_description: "Convert CDR to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to EMF in few lines of code.
