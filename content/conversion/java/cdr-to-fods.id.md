...
head_title: "Konversi CDR ke FODS di Jawa – Konversi CDR ke FODS"
head_description: "Konversi CDR ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga FODS"
    content: |
        Konversikan CDR ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
