...
############################# Head #############################
head_title: "Java CDR to ICO Converter API - transform CDR to ICO in Java apps"
head_description: "View CDR to ICO files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert CDR to ICO in Java" 
description: "Experience the efficiency of a native, high-performance CDR to ICO file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert CDR to ICO file in Java" 
    content: |
      Transforming CDR to ICO is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
