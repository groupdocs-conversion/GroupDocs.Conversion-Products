...
############################# Head #############################
head_title: "Java CDR to ODP Converter API - transform CDR to ODP in Java apps"
head_description: "View CDR to ODP files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert CDR to ODP in Java" 
description: "Experience the efficiency of a native, high-performance CDR to ODP file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert CDR to ODP file in Java" 
    content: |
      Transforming CDR to ODP is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the CDR file with full path. 
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convertTo("converted.odp")    // Specify output path for converted file
            .convert();                     // Convert CDR to ODP file        
        ```            
