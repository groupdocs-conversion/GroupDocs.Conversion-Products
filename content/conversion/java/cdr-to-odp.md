...
############################# Head ############################
head_title: "CDR to ODP Conversion in Java – Convert CDR to ODP"
head_description: "Convert CDR to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to ODP in few lines of code.
...
demos:
    enable: true
    title: "CDR to ODP Live Demos"
    content: |
        Convert CDR to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
