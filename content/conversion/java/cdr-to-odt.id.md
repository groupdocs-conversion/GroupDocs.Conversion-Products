...
head_title: "Konversi CDR ke ODT di Jawa – Konversi CDR ke ODT"
head_description: "Konversi CDR ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga ODT"
    content: |
        Konversikan CDR ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
