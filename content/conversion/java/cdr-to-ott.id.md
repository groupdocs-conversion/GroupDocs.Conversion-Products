...
head_title: "Konversi CDR ke OTT di Jawa – Konversi CDR ke OTT"
head_description: "Konversi CDR ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke OTT dalam beberapa baris kode.
