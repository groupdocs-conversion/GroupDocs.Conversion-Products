...
head_title: "Konversi CDR ke PDF di Jawa – Konversi CDR ke PDF"
head_description: "Konversi CDR ke PDF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke PDF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke PDF di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke PDF dalam beberapa baris kode.
