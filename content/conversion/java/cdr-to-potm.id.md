...
head_title: "Konversi CDR ke POTM di Jawa – Konversi CDR ke POTM"
head_description: "Konversi CDR ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke POTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga POTM"
    content: |
        Konversikan CDR ke POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
