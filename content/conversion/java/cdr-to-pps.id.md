...
head_title: "Konversi CDR ke PPS di Jawa – Konversi CDR ke PPS"
head_description: "Konversi CDR ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke PPS di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga PPS"
    content: |
        Konversikan CDR ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
