...
head_title: "Konversi CDR ke PPT di Jawa – Konversi CDR ke PPT"
head_description: "Konversi CDR ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke PPT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga PPT"
    content: |
        Konversikan CDR ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
