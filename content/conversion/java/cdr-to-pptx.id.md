...
head_title: "Konversi CDR ke PPTX di Jawa – Konversi CDR ke PPTX"
head_description: "Konversi CDR ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke PPTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga PPTX"
    content: |
        Konversikan CDR ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
