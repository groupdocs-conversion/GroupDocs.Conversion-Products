...
############################# Head ############################
head_title: "CDR to RTF Conversion in Java – Convert CDR to RTF"
head_description: "Convert CDR to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to RTF in few lines of code.
...
demos:
    enable: true
    title: "CDR to RTF Live Demos"
    content: |
        Convert CDR to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
