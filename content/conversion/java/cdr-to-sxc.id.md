...
head_title: "Konversi CDR ke SXC di Jawa – Konversi CDR ke SXC"
head_description: "Konversi CDR ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke SXC dalam beberapa baris kode.
