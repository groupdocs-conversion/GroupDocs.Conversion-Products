...
head_title: "Konversi CDR ke TXT di Jawa – Konversi CDR ke TXT"
head_description: "Konversi CDR ke TXT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke TXT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke TXT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke TXT dalam beberapa baris kode.
