...
head_title: "Konversi CDR ke XLAM di Jawa – Konversi CDR ke XLAM"
head_description: "Konversi CDR ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga XLAM"
    content: |
        Konversikan CDR ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
