...
head_title: "Konversi CDR ke XLS di Jawa – Konversi CDR ke XLS"
head_description: "Konversi CDR ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga XLS"
    content: |
        Konversikan CDR ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
