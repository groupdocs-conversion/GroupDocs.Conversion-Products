...
head_title: "Konversi CDR ke XLSB di Jawa – Konversi CDR ke XLSB"
head_description: "Konversi CDR ke XLSB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke XLSB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke XLSB di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke XLSB dalam beberapa baris kode.
