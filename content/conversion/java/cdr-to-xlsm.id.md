...
head_title: "Konversi CDR ke XLSM di Jawa – Konversi CDR ke XLSM"
head_description: "Konversi CDR ke XLSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke XLSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke XLSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke XLSM dalam beberapa baris kode.
