...
head_title: "Konversi CDR ke XLSX di Jawa – Konversi CDR ke XLSX"
head_description: "Konversi CDR ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga XLSX"
    content: |
        Konversikan CDR ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
