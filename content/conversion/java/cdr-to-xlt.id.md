...
head_title: "Konversi CDR ke XLT di Jawa – Konversi CDR ke XLT"
head_description: "Konversi CDR ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga XLT"
    content: |
        Konversikan CDR ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
