...
head_title: "Konversi CDR ke XLTM di Jawa – Konversi CDR ke XLTM"
head_description: "Konversi CDR ke XLTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CDR ke XLTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CDR ke XLTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CDR ke XLTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CDR hingga XLTM"
    content: |
        Konversikan CDR ke XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
