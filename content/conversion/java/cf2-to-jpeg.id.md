...
head_title: "Konversi CF2 ke JPEG di Jawa – Konversi CF2 ke JPEG"
head_description: "Konversi CF2 ke JPEG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CF2 ke JPEG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CF2 ke JPEG di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CF2 ke JPEG dalam beberapa baris kode.
