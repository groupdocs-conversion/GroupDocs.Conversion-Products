...
############################# Head #############################
head_title: "Java CF2 to PDF Converter API - transform CF2 to PDF in Java apps"
head_description: "View CF2 to PDF files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert CF2 to PDF in Java" 
description: "Experience the efficiency of a native, high-performance CF2 to PDF file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert CF2 to PDF file in Java" 
    content: |
      Transforming CF2 to PDF is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the CF2 file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.cf2")              // Set up input CF2 file
            .convertTo("converted.pdf")    // Specify output path for converted file
            .convert();                     // Convert CF2 to PDF file        
        ```            
