...
head_title: "Konversi CF2 ke XLS di Jawa – Konversi CF2 ke XLS"
head_description: "Konversi CF2 ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CF2 ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CF2 ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CF2 ke XLS dalam beberapa baris kode.
