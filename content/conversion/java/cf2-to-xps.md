...
############################# Head ############################
head_title: "CF2 to XPS Conversion in Java – Convert CF2 to XPS"
head_description: "Convert CF2 to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CF2 Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CF2 to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CF2 file to XPS in few lines of code.
...
demos:
    enable: true
    title: "CF2 to XPS Live Demos"
    content: |
        Convert CF2 to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
