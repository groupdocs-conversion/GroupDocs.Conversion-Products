...
head_title: "Konversi CGM ke DOCM di Jawa – Konversi CGM ke DOCM"
head_description: "Konversi CGM ke DOCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke DOCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke DOCM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke DOCM dalam beberapa baris kode.
