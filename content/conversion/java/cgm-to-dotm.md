...
############################# Head ############################
head_title: "CGM to DOTM Conversion in Java – Convert CGM to DOTM"
head_description: "Convert CGM to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "CGM to DOTM Live Demos"
    content: |
        Convert CGM to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
