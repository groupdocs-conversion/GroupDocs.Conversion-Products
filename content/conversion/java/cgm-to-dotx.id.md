...
head_title: "Konversi CGM ke DOTX di Jawa – Konversi CGM ke DOTX"
head_description: "Konversi CGM ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke DOTX dalam beberapa baris kode.
