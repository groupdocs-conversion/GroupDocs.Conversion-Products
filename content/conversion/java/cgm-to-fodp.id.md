...
head_title: "Konversi CGM ke FODP di Jawa – Konversi CGM ke FODP"
head_description: "Konversi CGM ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CGM hingga FODP"
    content: |
        Konversikan CGM ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
