...
head_title: "Konversi CGM ke MHT di Jawa – Konversi CGM ke MHT"
head_description: "Konversi CGM ke MHT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke MHT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke MHT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke MHT dalam beberapa baris kode.
