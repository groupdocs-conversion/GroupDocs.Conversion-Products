...
head_title: "Konversi CGM ke MHTM di Jawa – Konversi CGM ke MHTM"
head_description: "Konversi CGM ke MHTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke MHTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke MHTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke MHTM dalam beberapa baris kode.
