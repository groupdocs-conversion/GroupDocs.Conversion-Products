...
############################# Head ############################
head_title: "CGM to MHTM Conversion in Java – Convert CGM to MHTM"
head_description: "Convert CGM to MHTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to MHTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to MHTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to MHTM in few lines of code.

        *   Create a new instance of Converter class and load the CGM file with full path
        *   Set ConvertOptions for the MHTM document type
        *   Call the convert() method and pass the document name (full path) and format (MHTM) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target MHTM format
...
demos:
    enable: true
    title: "CGM to MHTM Live Demos"
    content: |
        Convert CGM to MHTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
