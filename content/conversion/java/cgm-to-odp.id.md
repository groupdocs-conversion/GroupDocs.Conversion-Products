...
head_title: "Konversi CGM ke ODP di Jawa – Konversi CGM ke ODP"
head_description: "Konversi CGM ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CGM hingga ODP"
    content: |
        Konversikan CGM ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
