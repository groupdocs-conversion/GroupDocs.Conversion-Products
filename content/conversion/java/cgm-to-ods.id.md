...
head_title: "Konversi CGM ke ODS di Jawa – Konversi CGM ke ODS"
head_description: "Konversi CGM ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke ODS dalam beberapa baris kode.
