...
head_title: "Konversi CGM ke OTP di Jawa – Konversi CGM ke OTP"
head_description: "Konversi CGM ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke OTP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke OTP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke OTP dalam beberapa baris kode.
