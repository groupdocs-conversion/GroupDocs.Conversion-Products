...
head_title: "Konversi CGM ke PDF di Jawa – Konversi CGM ke PDF"
head_description: "Konversi CGM ke PDF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke PDF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke PDF di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke PDF dalam beberapa baris kode.
