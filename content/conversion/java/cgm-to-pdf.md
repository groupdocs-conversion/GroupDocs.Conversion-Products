...
############################# Head ############################
head_title: "CGM to PDF Conversion in Java – Convert CGM to PDF"
head_description: "Convert CGM to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to PDF in few lines of code.
...
demos:
    enable: true
    title: "CGM to PDF Live Demos"
    content: |
        Convert CGM to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
