...
head_title: "Konversi CGM ke PPTX di Jawa – Konversi CGM ke PPTX"
head_description: "Konversi CGM ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke PPTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CGM hingga PPTX"
    content: |
        Konversikan CGM ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
