...
############################# Head ############################
head_title: "CGM to PSD Conversion in Java – Convert CGM to PSD"
head_description: "Convert CGM to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to PSD in few lines of code.
...
demos:
    enable: true
    title: "CGM to PSD Live Demos"
    content: |
        Convert CGM to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
