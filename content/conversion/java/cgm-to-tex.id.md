...
head_title: "Konversi CGM ke TEX di Jawa – Konversi CGM ke TEX"
head_description: "Konversi CGM ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke TEX dalam beberapa baris kode.
