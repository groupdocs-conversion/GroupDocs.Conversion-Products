...
head_title: "Konversi CGM ke XLSM di Jawa – Konversi CGM ke XLSM"
head_description: "Konversi CGM ke XLSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CGM ke XLSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CGM ke XLSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CGM ke XLSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung CGM hingga XLSM"
    content: |
        Konversikan CGM ke XLSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
