...
head_title: "Konversi CMX ke DIF di Jawa – Konversi CMX ke DIF"
head_description: "Konversi CMX ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CMX ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CMX ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CMX ke DIF dalam beberapa baris kode.
