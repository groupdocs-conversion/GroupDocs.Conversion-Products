...
head_title: "Konversi CMX ke DOCX di Jawa – Konversi CMX ke DOCX"
head_description: "Konversi CMX ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CMX ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CMX ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CMX ke DOCX dalam beberapa baris kode.
