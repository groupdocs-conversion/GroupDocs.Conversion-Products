...
############################# Head ############################
head_title: "CMX to DOCX Conversion in Java – Convert CMX to DOCX"
head_description: "Convert CMX to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "CMX to DOCX Live Demos"
    content: |
        Convert CMX to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
