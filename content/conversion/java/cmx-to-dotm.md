...
############################# Head ############################
head_title: "CMX to DOTM Conversion in Java – Convert CMX to DOTM"
head_description: "Convert CMX to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "CMX to DOTM Live Demos"
    content: |
        Convert CMX to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
