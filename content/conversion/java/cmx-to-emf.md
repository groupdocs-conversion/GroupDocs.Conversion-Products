...
############################# Head ############################
head_title: "CMX to EMF Conversion in Java – Convert CMX to EMF"
head_description: "Convert CMX to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to EMF in few lines of code.
...
demos:
    enable: true
    title: "CMX to EMF Live Demos"
    content: |
        Convert CMX to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
