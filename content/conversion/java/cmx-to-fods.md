...
############################# Head ############################
head_title: "CMX to FODS Conversion in Java – Convert CMX to FODS"
head_description: "Convert CMX to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to FODS in few lines of code.
...
demos:
    enable: true
    title: "CMX to FODS Live Demos"
    content: |
        Convert CMX to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
