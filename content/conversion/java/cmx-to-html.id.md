...
head_title: "Konversi CMX ke HTML di Jawa – Konversi CMX ke HTML"
head_description: "Konversi CMX ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CMX ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CMX ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CMX ke HTML dalam beberapa baris kode.
