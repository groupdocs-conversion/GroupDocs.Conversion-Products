...
head_title: "Konversi CMX ke OTT di Jawa – Konversi CMX ke OTT"
head_description: "Konversi CMX ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CMX ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CMX ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CMX ke OTT dalam beberapa baris kode.
