...
head_title: "Konversi CMX ke PPSM di Jawa – Konversi CMX ke PPSM"
head_description: "Konversi CMX ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CMX ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CMX ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CMX ke PPSM dalam beberapa baris kode.
