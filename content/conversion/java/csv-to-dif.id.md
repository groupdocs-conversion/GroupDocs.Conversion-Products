...
breadcrumb: CSV ke DIF di Java

############################# Head ############################
head_title: "Konversi CSV ke DIF di Java"
head_description: "Konversi CSV ke DIF di Java dengan beberapa baris kode. Konversi lebih dari 160 format file menggunakan API konversi dokumen GroupDocs untuk Java"

############################# Header ############################
title: "Konversi CSV ke DIF di Java"
description: "Konversi CSV ke DIF dengan beberapa baris kode Java"
...
overview:
    enable: true
    content: |
        Konversikan file CSV Anda menjadi DIF di Java. Hanya membutuhkan beberapa baris kode Java pada platform pilihan Anda, seperti Windows, Linux, macOS.
        Anda dapat mencoba mengonversi CSV ke DIF secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skrip konversi file sederhana, Anda dapat mencoba opsi yang lebih canggih untuk memuat file sumber CSV dan menyimpan output DIF. 
        ...
        * tambahkan tanda air ke DIF yang dikonversi.

        Setelah konversi selesai, Anda dapat menyimpan file DIF ke jalur file lokal Anda atau ke penyimpanan pihak ketiga mana pun seperti FTP, Amazon S3, Google Drive, Dropbox, dll. Harap diperhatikan - untuk mengonversi CSV untuk DIF, Anda tidak perlu menginstal software tambahan apapun, seperti MS Office, Open Office, Adobe Acrobat Reader dll.


############################# Steps ############################
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi CSV ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) memungkinkan pengembang untuk dengan mudah mengonversi file CSV ke DIF dengan beberapa baris kode.
        
        * Buat instance baru dari kelas Converter dan unggah file CSV dengan path lengkap
        * Setel ConvertOptions untuk jenis dokumen ke DIF
...
demos:
    enable: true
    title: "CSV ke DIF Demo Langsung"
    content: |
       Kunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) kami dan coba konversi CSV ke DIF sekarang. Demo gratis memiliki manfaat sebagai berikut
