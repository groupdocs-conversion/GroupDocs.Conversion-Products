...
breadcrumb: CSV to METAFILE in Java

############################# Head ############################
head_title: "CSV to METAFILE Converter in Java"
head_description: "Convert CSV to METAFILE in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert CSV to METAFILE in Java"
description: "CSV to METAFILE conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your CSV files to METAFILE in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert CSV to METAFILE in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a CSV file to METAFILE with a few lines of code.
