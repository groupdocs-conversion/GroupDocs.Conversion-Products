...
############################# Head #############################
head_title: "Java CSV zu ODS Konverter API - CSV in Java-Anwendungen transformieren"
head_description: "CSV zu ODS Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "CSV in ODS in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken CSV zu ODS Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von CSV in ODS Datei in Java" 
    content: |
      Die Transformation von CSV in ODS wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convertTo("converted.ods")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // CSV in ODS Datei konvertieren        
        ```            
