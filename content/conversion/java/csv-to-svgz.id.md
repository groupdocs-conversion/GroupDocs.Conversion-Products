...
head_title: "Konversi CSV ke SVGZ di Jawa – Konversi CSV ke SVGZ"
head_description: "Konversi CSV ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File CSV ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi CSV ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file CSV ke SVGZ dalam beberapa baris kode.
