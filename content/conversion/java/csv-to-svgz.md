...
############################# Head ############################
head_title: "CSV to SVGZ Conversion in Java – Convert CSV to SVGZ"
head_description: "Convert CSV to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CSV Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CSV to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CSV file to SVGZ in few lines of code.
...
demos:
    enable: true
    title: "CSV to SVGZ Live Demos"
    content: |
        Convert CSV to SVGZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
