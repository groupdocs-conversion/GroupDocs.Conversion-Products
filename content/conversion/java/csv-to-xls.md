...
############################# Head ############################
head_title: "CSV to XLS Conversion in Java – Convert CSV to XLS"
head_description: "Convert CSV to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CSV Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CSV to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CSV file to XLS in few lines of code.
...
demos:
    enable: true
    title: "CSV to XLS Live Demos"
    content: |
        Convert CSV to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
