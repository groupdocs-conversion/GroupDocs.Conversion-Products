...
############################# Head #############################
head_title: "Java CSV to XLSX Converter API - transform CSV to XLSX in Java apps"
head_description: "View CSV to XLSX files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert CSV to XLSX in Java" 
description: "Experience the efficiency of a native, high-performance CSV to XLSX file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert CSV to XLSX file in Java" 
    content: |
      Transforming CSV to XLSX is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert CSV to XLSX file        
        ```            
