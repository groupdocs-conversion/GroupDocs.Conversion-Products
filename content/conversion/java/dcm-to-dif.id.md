...
head_title: "Konversi DCM ke DIF di Jawa – Konversi DCM ke DIF"
head_description: "Konversi DCM ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DCM ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DCM ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DCM ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DCM hingga DIF"
    content: |
        Konversikan DCM ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
