...
head_title: "Konversi DCM ke DOCM di Jawa – Konversi DCM ke DOCM"
head_description: "Konversi DCM ke DOCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DCM ke DOCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DCM ke DOCM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DCM ke DOCM dalam beberapa baris kode.
