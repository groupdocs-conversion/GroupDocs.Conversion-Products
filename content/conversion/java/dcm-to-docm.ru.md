...
############################# Head ############################
head_title: "Преобразование DCM в DOCM в Java — преобразование DCM в DOCM"
head_description: "Преобразование DCM в DOCM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DCM в DOCM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DCM в DOCM в Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл DCM в DOCM, написав всего несколько строк кода.
