...
############################# Head ############################
head_title: "Преобразование DCM в DOTM в Java — преобразование DCM в DOTM"
head_description: "Преобразование DCM в DOTM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DCM в DOTM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DCM в DOTM в Java"
    content_left: |
