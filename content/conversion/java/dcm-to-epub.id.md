...
head_title: "Konversi DCM ke EPUB di Jawa – Konversi DCM ke EPUB"
head_description: "Konversi DCM ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DCM ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DCM ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DCM ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DCM hingga EPUB"
    content: |
        Konversikan DCM ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
