...
############################# Head ############################
head_title: "Conversor de DCM a GIF en Java"
head_description: "Convierta DCM a GIF en Java usando unas pocas líneas de código. Utilice la API de conversión de documentos de GroupDocs para convertir más de 160 formatos de archivo."
...
overview:
    enable: true
    content: |
        Convierta sus archivos DCM a GIF en Java fácilmente. Puede usar solo un par de líneas de código Java en cualquier plataforma de su elección, como Windows, Linux, macOS.
        Puede probar la conversión de DCM a GIF de forma gratuita y evaluar la calidad de los resultados de la conversión. Junto con los escenarios de conversión de archivos simples, puede probar opciones más avanzadas para cargar el archivo de origen DCM y para guardar el resultado de salida GIF. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) facilita a los desarrolladores convertir un archivo DCM a GIF con unas pocas líneas de código.
...
demos:
    ...
    content: |
       Convierta DCM a GIF ahora visitando el sitio web de [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). La demostración en línea tiene las siguientes ventajas
