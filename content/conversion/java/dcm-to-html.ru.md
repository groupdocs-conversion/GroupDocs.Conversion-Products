...
############################# Head ############################
head_title: "Преобразование DCM в HTML в Java — Преобразование DCM в HTML"
head_description: "Преобразование DCM в HTML на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DCM в HTML в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DCM в HTML в Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл DCM в HTML, написав всего несколько строк кода.
