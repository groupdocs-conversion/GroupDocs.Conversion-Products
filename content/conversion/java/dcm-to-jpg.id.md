...
head_title: "Konversi DCM ke JPG di Jawa – Konversi DCM ke JPG"
head_description: "Konversi DCM ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DCM ke JPG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DCM ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DCM hingga JPG"
    content: |
        Konversikan DCM ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
