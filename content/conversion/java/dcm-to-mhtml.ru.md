...
############################# Head ############################
head_title: "Преобразование DCM в MHTML в Java — Преобразование DCM в MHTML"
head_description: "Преобразование DCM в MHTML на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DCM в MHTML в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DCM в MHTML в Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл DCM в MHTML, написав всего несколько строк кода.
