...
head_title: "Konversi DCM ke PPSM di Jawa – Konversi DCM ke PPSM"
head_description: "Konversi DCM ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DCM ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DCM ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DCM ke PPSM dalam beberapa baris kode.
