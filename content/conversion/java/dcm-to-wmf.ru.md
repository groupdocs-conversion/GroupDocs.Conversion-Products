...
############################# Head ############################
head_title: "Преобразование DCM в WMF в Java — преобразование DCM в WMF"
head_description: "Преобразование DCM в WMF на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DCM в WMF в Java"
...
demos:
    enable: true
    title: "DCM в WMF Живые демонстрации"
    content: |
