...
head_title: "Konversi DCM ke XLSM di Jawa – Konversi DCM ke XLSM"
head_description: "Konversi DCM ke XLSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DCM ke XLSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DCM ke XLSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DCM ke XLSM dalam beberapa baris kode.
