...
head_title: "Konversi DGN ke BMP di Jawa – Konversi DGN ke BMP"
head_description: "Konversi DGN ke BMP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DGN ke BMP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DGN ke BMP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DGN ke BMP dalam beberapa baris kode.
