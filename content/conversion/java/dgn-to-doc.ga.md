...
breadcrumb: DGN go DOC in Java

############################# Head ############################
head_title: "Tiontaigh DGN go DOC in Java"
head_description: "DGN go DOC tiontú in Java le cúpla líne de chód. Tiontaigh níos mó ná 160 formáid comhaid ag baint úsáid as an API tiontaithe doiciméad GroupDocs le haghaidh Java"

############################# Header ############################
title: "Tiontaigh DGN go DOC in Java"
description: "DGN go DOC tiontú le cúpla líne de chód Java"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid DGN go DOC in Java. Ní thógann sé ach cúpla líne de chód Java ar aon ardán de do rogha féin, ar nós Windows, Linux, macOS.
        Is féidir leat triail a bhaint as DGN a thiontú go DOC saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le scripteanna simplí comhshó comhad, is féidir leat triail a bhaint as roghanna níos sofaisticiúla chun an comhad foinse DGN a luchtú agus an t-aschur DOC a stóráil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun DGN a thiontú go DOC in Java"
    content_left: |
        Ceadaíonn [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) d'fhorbróirí comhad DGN a thiontú go DOC go héasca le cúpla líne de chód.
...
demos:
    ...
    content: |
       Tabhair cuairt ar ár suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) agus bain triail as DGN go DOC tiontú anois. Tá na buntáistí seo a leanas ag an taispeántas saor in aisce
