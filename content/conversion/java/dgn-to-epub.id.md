...
head_title: "Konversi DGN ke EPUB di Jawa – Konversi DGN ke EPUB"
head_description: "Konversi DGN ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DGN ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DGN ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DGN ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DGN hingga EPUB"
    content: |
        Konversikan DGN ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
