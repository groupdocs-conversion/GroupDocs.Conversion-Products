...
############################# Head ############################
head_title: "DGN to GIF Conversion in Java – Convert DGN to GIF"
head_description: "Convert DGN to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to GIF in few lines of code.
...
demos:
    enable: true
    title: "DGN to GIF Live Demos"
    content: |
        Convert DGN to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
