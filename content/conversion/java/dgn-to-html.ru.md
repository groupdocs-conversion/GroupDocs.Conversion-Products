...
############################# Head #############################
head_title: "Java API конвертер DGN в HTML - конвертировать в Java приложениях"
head_description: "Просматривайте файлы DGN в Java, J2EE, J2SE приложениях. Поддерживается просмотр более 180 форматов файлов документов и изображений в режиме HTML, PDF или изображения с расширенными функциями управления опциями просмотра документов."

############################# Header ############################
title: "Конвертировать DGN в HTML на Java" 
description: "Опыт высокопроизводительного нативного API конвертации файлов DGN в HTML для Java, J2EE и J2SE приложений. Наслаждайтесь поддержкой широкого набора дополнительных функций, позволяющих настраивать внешний вид выходного документа." 
...
steps:
    enable: true
    title: "Шаги для преобразования файла DGN в файл HTML на Java" 
    content: |
      Преобразование DGN в HTML становится простым с помощью <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, требующим всего нескольких простых шагов.
      ...
      3. Загрузите файл DGN с полным путем. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.dgn")              // Настройте входной файл DGN
            .convertTo("converted.html")    // Укажите путь к конвертированному файлу
            .convert();                     // Конвертировать файл DGN в файл HTML        
        ```            
