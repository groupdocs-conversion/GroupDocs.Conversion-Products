...
head_title: "Konversi DGN ke JPG di Jawa – Konversi DGN ke JPG"
head_description: "Konversi DGN ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DGN ke JPG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DGN ke JPG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DGN ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DGN hingga JPG"
    content: |
        Konversikan DGN ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
