...
############################# Head ############################
head_title: "DGN to JPG Conversion in Java – Convert DGN to JPG"
head_description: "Convert DGN to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to JPG in few lines of code.
...
demos:
    enable: true
    title: "DGN to JPG Live Demos"
    content: |
        Convert DGN to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
