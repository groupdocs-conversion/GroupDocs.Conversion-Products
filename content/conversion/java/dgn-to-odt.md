...
############################# Head ############################
head_title: "DGN to ODT Conversion in Java – Convert DGN to ODT"
head_description: "Convert DGN to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to ODT in few lines of code.
...
demos:
    enable: true
    title: "DGN to ODT Live Demos"
    content: |
        Convert DGN to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
