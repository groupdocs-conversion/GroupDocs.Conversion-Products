...
############################# Head ############################
head_title: "Преобразование DGN в OTT в Java — преобразование DGN в OTT"
head_description: "Преобразование DGN в OTT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DGN в OTT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DGN в OTT в Java"
    content_left: |
