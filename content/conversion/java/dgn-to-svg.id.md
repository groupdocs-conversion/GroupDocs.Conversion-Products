...
head_title: "Konversi DGN ke SVG di Jawa – Konversi DGN ke SVG"
head_description: "Konversi DGN ke SVG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DGN ke SVG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DGN ke SVG di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DGN ke SVG dalam beberapa baris kode.
