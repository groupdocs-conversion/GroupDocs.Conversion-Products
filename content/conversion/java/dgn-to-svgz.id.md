...
head_title: "Konversi DGN ke SVGZ di Jawa – Konversi DGN ke SVGZ"
head_description: "Konversi DGN ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DGN ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DGN ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DGN ke SVGZ dalam beberapa baris kode.
