...
############################# Head ############################
head_title: "DGN to SVGZ Conversion in Java – Convert DGN to SVGZ"
head_description: "Convert DGN to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to SVGZ in few lines of code.
...
demos:
    enable: true
    title: "DGN to SVGZ Live Demos"
    content: |
        Convert DGN to SVGZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
