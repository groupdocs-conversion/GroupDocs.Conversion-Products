...
############################# Head ############################
head_title: "DGN to TEX Conversion in Java – Convert DGN to TEX"
head_description: "Convert DGN to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to TEX in few lines of code.
...
demos:
    enable: true
    title: "DGN to TEX Live Demos"
    content: |
        Convert DGN to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
