...
############################# Head ############################
head_title: "DGN to TSV Conversion in Java – Convert DGN to TSV"
head_description: "Convert DGN to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to TSV in few lines of code.
...
demos:
    enable: true
    title: "DGN to TSV Live Demos"
    content: |
        Convert DGN to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
