...
############################# Head #############################
head_title: "Java DGN zu XML Konverter API - DGN in Java-Anwendungen transformieren"
head_description: "DGN zu XML Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "DGN in XML in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken DGN zu XML Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von DGN in XML Datei in Java" 
    content: |
      Die Transformation von DGN in XML wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die DGN Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // DGN in XML Datei konvertieren        
        ```            
