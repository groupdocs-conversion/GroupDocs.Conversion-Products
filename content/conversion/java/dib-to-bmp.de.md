...
############################# Head #############################
head_title: "Java DIB zu BMP Konverter API - DIB in Java-Anwendungen transformieren"
head_description: "DIB zu BMP Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "DIB in BMP in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken DIB zu BMP Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von DIB in BMP Datei in Java" 
    content: |
      Die Transformation von DIB in BMP wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die DIB Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.dib")              // Richten Sie die Eingabedatei DIB ein
            .convertTo("converted.bmp")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // DIB in BMP Datei konvertieren        
        ```            
