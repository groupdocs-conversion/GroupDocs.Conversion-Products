...
############################# Head #############################
head_title: "Java DIB to BMP Converter API - transform DIB to BMP in Java apps"
head_description: "View DIB to BMP files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert DIB to BMP in Java" 
description: "Experience the efficiency of a native, high-performance DIB to BMP file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert DIB to BMP file in Java" 
    content: |
      Transforming DIB to BMP is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the DIB file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.dib")              // Set up input DIB file
            .convertTo("converted.bmp")    // Specify output path for converted file
            .convert();                     // Convert DIB to BMP file        
        ```            
