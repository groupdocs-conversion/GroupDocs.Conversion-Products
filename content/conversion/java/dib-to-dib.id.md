...
head_title: "Konversi DIB ke DIB di Jawa – Konversi DIB ke DIB"
head_description: "Konversi DIB ke DIB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DIB ke DIB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DIB ke DIB di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DIB ke DIB dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file DIB dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen DIB
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (DIB) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format target DIB
