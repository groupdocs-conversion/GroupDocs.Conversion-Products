...
############################# Head ############################
head_title: "Преобразование DIB в DIB в Java — преобразование DIB в DIB"
head_description: "Преобразование DIB в DIB на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DIB в DIB в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования DIB в DIB в Java"
    content_left: |
    ...
    code: |
        ...
        // Готовим параметры преобразования для целевого формата DIB
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "DIB к DIB"
          link: "/conversion/java/dib-to-dib/"
