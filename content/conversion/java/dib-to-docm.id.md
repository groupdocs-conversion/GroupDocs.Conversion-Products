...
head_title: "Konversi DIB ke DOCM di Jawa – Konversi DIB ke DOCM"
head_description: "Konversi DIB ke DOCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DIB ke DOCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DIB ke DOCM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DIB ke DOCM dalam beberapa baris kode.
