...
head_title: "Konversi DIB ke EPUB di Jawa – Konversi DIB ke EPUB"
head_description: "Konversi DIB ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DIB ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DIB ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DIB ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DIB hingga EPUB"
    content: |
        Konversikan DIB ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
