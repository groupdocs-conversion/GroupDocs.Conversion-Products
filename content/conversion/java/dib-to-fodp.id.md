...
head_title: "Konversi DIB ke FODP di Jawa – Konversi DIB ke FODP"
head_description: "Konversi DIB ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DIB ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DIB ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DIB ke FODP dalam beberapa baris kode.
