...
head_title: "Konversi DIB ke ODT di Jawa – Konversi DIB ke ODT"
head_description: "Konversi DIB ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DIB ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DIB ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DIB ke ODT dalam beberapa baris kode.
