...
head_title: "Konversi DIB ke POT di Jawa – Konversi DIB ke POT"
head_description: "Konversi DIB ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DIB ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DIB ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DIB ke POT dalam beberapa baris kode.
