...
############################# Head ############################
head_title: "DIB to POTM Conversion in Java – Convert DIB to POTM"
head_description: "Convert DIB to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DIB Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DIB to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DIB file to POTM in few lines of code.
...
demos:
    enable: true
    title: "DIB to POTM Live Demos"
    content: |
        Convert DIB to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
