...
############################# Head ############################
head_title: "DIB to WEBP Conversion in Java – Convert DIB to WEBP"
head_description: "Convert DIB to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DIB Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DIB to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DIB file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "DIB to WEBP Live Demos"
    content: |
        Convert DIB to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
