...
head_title: "Konversi DIB ke XLSM di Jawa – Konversi DIB ke XLSM"
head_description: "Konversi DIB ke XLSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DIB ke XLSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DIB ke XLSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DIB ke XLSM dalam beberapa baris kode.
