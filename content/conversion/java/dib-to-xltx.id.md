...
head_title: "Konversi DIB ke XLTX di Jawa – Konversi DIB ke XLTX"
head_description: "Konversi DIB ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DIB ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DIB ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DIB ke XLTX dalam beberapa baris kode.
