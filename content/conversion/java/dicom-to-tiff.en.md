...
############################# Head #############################
head_title: "Java DICOM to TIFF Converter API - transform DICOM to TIFF in Java apps"
head_description: "View DICOM to TIFF files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert DICOM to TIFF in Java" 
description: "Experience the efficiency of a native, high-performance DICOM to TIFF file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert DICOM to TIFF file in Java" 
    content: |
      Transforming DICOM to TIFF is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert DICOM to TIFF file        
        ```            
