...
head_title: "Konversi DJVU ke DOCX di Jawa – Konversi DJVU ke DOCX"
head_description: "Konversi DJVU ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DJVU hingga DOCX"
    content: |
        Konversikan DJVU ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
