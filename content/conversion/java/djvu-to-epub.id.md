...
head_title: "Konversi DJVU ke EPUB di Jawa – Konversi DJVU ke EPUB"
head_description: "Konversi DJVU ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke EPUB dalam beberapa baris kode.
