...
head_title: "Konversi DJVU ke JP2 di Jawa – Konversi DJVU ke JP2"
head_description: "Konversi DJVU ke JP2 di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke JP2 di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke JP2 dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DJVU hingga JP2"
    content: |
        Konversikan DJVU ke JP2 sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
