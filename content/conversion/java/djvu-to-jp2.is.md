...
breadcrumb: DJVU til JP2 í Java

############################# Head ############################
head_title: "Umbreyttu DJVU í JP2 í Java"
head_description: "DJVU til JP2 viðskipti í Java með nokkrum línum af kóða. Umbreyttu yfir 160 skráarsniðum með því að nota GroupDocs skjalabreytingarforritaskil fyrir Java"

############################# Header ############################
title: "Umbreyttu DJVU í JP2 í Java"
description: "DJVU til JP2 viðskipti með nokkrum línum af Java kóða"
...
overview:
    enable: true
    content: |
        Umbreyttu DJVU skránum þínum í JP2 í Java. Það tekur aðeins nokkrar línur af Java kóða á hvaða vettvang sem þú velur, eins og Windows, Linux, macOS.
        Þú getur prófað að breyta DJVU í JP2 ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingarforskriftum geturðu prófað flóknari valkosti til að hlaða DJVU frumskránni og geyma JP2 úttakið. 
        ...
        * bæta vatnsmerki við breytta JP2.
        ...
        Þegar umbreytingunni er lokið geturðu vistað JP2 skrána á staðbundinni skráarslóð þinni eða í hvaða geymslu sem er þriðja aðila eins og FTP, Amazon S3, Google Drive, Dropbox osfrv. Athugaðu - til að umbreyta DJVU til JP2, þú þarft ekki að setja upp neinn viðbótarhugbúnað, eins og MS Office, Open Office, Adobe Acrobat Reader o.s.frv.


############################# Steps ############################
steps:
    enable: true
    title_left: "Skref til að breyta DJVU í JP2 í Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) gerir forriturum kleift að umbreyta DJVU skrá auðveldlega í JP2 með nokkrum línum af kóða.
...
demos:
    ...
    content: |
       Farðu á [GroupDocs.Conversion app](https://products.groupdocs.app/conversion/family) vefsíðu okkar og reyndu DJVU í JP2 viðskipti núna. Ókeypis kynningin hefur eftirfarandi kosti
