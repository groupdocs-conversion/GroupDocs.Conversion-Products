...
############################# Head ############################
head_title: "Преобразование DJVU в JPG на Java — Преобразование DJVU в JPG"
head_description: "Конвертируйте DJVU в JPG на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DJVU в JPG на Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования DJVU в JPG в Java"
    content_left: |
...
demos:
    enable: true
    title: "Живые демонстрации из DJVU в JPG"
    content: |
