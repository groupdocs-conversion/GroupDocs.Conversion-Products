...
head_title: "Konversi DJVU ke MHT di Jawa – Konversi DJVU ke MHT"
head_description: "Konversi DJVU ke MHT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke MHT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke MHT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke MHT dalam beberapa baris kode.
