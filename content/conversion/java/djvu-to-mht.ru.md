...
############################# Head ############################
head_title: "Преобразование DJVU в MHT в Java — Преобразование DJVU в MHT"
head_description: "Преобразуйте DJVU в MHT на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DJVU в MHT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DJVU в MHT в Java"
    content_left: |
...
demos:
    enable: true
    title: "Живые демонстрации с DJVU на MHT"
    content: |
