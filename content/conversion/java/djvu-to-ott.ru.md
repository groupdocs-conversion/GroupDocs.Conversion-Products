...
############################# Head ############################
head_title: "Преобразование DJVU в OTT на Java — Преобразование DJVU в OTT"
head_description: "Преобразуйте DJVU в OTT на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DJVU в OTT на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DJVU в OTT в Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл DJVU в OTT, написав всего несколько строк кода.
