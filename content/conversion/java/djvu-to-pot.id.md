...
head_title: "Konversi DJVU ke POT di Jawa – Konversi DJVU ke POT"
head_description: "Konversi DJVU ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke POT dalam beberapa baris kode.
