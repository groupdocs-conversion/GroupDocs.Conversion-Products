...
head_title: "Konversi DJVU ke POTX di Jawa – Konversi DJVU ke POTX"
head_description: "Konversi DJVU ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke POTX dalam beberapa baris kode.
