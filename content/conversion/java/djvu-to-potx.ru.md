...
############################# Head ############################
head_title: "Преобразование DJVU в POTX в Java — Преобразование DJVU в POTX"
head_description: "Преобразуйте DJVU в POTX на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DJVU в POTX на Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования DJVU в POTX в Java"
    content_left: |
...
demos:
    enable: true
    title: "Живые демонстрации с DJVU на POTX"
    content: |
