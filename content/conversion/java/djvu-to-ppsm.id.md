...
head_title: "Konversi DJVU ke PPSM di Jawa – Konversi DJVU ke PPSM"
head_description: "Konversi DJVU ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke PPSM dalam beberapa baris kode.
