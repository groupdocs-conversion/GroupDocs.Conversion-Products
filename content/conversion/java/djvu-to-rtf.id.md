...
head_title: "Konversi DJVU ke RTF di Jawa – Konversi DJVU ke RTF"
head_description: "Konversi DJVU ke RTF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke RTF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke RTF di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke RTF dalam beberapa baris kode.
