...
head_title: "Konversi DJVU ke TSV di Jawa – Konversi DJVU ke TSV"
head_description: "Konversi DJVU ke TSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke TSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke TSV di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke TSV dalam beberapa baris kode.
