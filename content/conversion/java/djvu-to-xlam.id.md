...
head_title: "Konversi DJVU ke XLAM di Jawa – Konversi DJVU ke XLAM"
head_description: "Konversi DJVU ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke XLAM dalam beberapa baris kode.
