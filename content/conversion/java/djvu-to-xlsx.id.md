...
head_title: "Konversi DJVU ke XLSX di Jawa – Konversi DJVU ke XLSX"
head_description: "Konversi DJVU ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DJVU ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DJVU ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DJVU ke XLSX dalam beberapa baris kode.
...
demos:
    ...
    content: |
        Konversikan DJVU ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
