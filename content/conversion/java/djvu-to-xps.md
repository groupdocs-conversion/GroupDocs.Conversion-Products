...
############################# Head ############################
head_title: "DJVU to XPS Conversion in Java – Convert DJVU to XPS"
head_description: "Convert DJVU to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to XPS in few lines of code.
...
demos:
    enable: true
    title: "DJVU to XPS Live Demos"
    content: |
        Convert DJVU to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
