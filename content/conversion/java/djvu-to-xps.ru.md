...
############################# Head ############################
head_title: "Преобразование DJVU в XPS в Java — Преобразование DJVU в XPS"
head_description: "Преобразование DJVU в XPS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DJVU в XPS на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DJVU в XPS в Java"
    content_left: |
