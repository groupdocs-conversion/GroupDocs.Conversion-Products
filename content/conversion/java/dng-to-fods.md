...
############################# Head ############################
head_title: "DNG to FODS Conversion in Java – Convert DNG to FODS"
head_description: "Convert DNG to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DNG Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DNG to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DNG file to FODS in few lines of code.
...
demos:
    enable: true
    title: "DNG to FODS Live Demos"
    content: |
        Convert DNG to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
