...
head_title: "Konversi DNG ke ODP di Jawa – Konversi DNG ke ODP"
head_description: "Konversi DNG ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DNG ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DNG ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DNG ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DNG hingga ODP"
    content: |
        Konversikan DNG ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
