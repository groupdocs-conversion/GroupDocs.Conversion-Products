...
############################# Head ############################
head_title: "DNG to ODP Conversion in Java – Convert DNG to ODP"
head_description: "Convert DNG to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DNG Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DNG to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DNG file to ODP in few lines of code.
...
demos:
    enable: true
    title: "DNG to ODP Live Demos"
    content: |
        Convert DNG to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
