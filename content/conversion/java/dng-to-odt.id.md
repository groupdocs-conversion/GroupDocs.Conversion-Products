...
head_title: "Konversi DNG ke ODT di Jawa – Konversi DNG ke ODT"
head_description: "Konversi DNG ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DNG ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DNG ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DNG ke ODT dalam beberapa baris kode.
