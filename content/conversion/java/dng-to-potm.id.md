...
head_title: "Konversi DNG ke POTM di Jawa – Konversi DNG ke POTM"
head_description: "Konversi DNG ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DNG ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DNG ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DNG ke POTM dalam beberapa baris kode.
