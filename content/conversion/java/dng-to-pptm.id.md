...
head_title: "Konversi DNG ke PPTM di Jawa – Konversi DNG ke PPTM"
head_description: "Konversi DNG ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DNG ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DNG ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DNG ke PPTM dalam beberapa baris kode.
