...
head_title: "Konversi DNG ke TEX di Jawa – Konversi DNG ke TEX"
head_description: "Konversi DNG ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DNG ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DNG ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DNG ke TEX dalam beberapa baris kode.
