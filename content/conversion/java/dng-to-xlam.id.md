...
head_title: "Konversi DNG ke XLAM di Jawa – Konversi DNG ke XLAM"
head_description: "Konversi DNG ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DNG ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DNG ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DNG ke XLAM dalam beberapa baris kode.
