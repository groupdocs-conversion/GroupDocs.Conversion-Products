...
############################# Head ############################
head_title: "DOC to DOCX Conversion in Java – Convert DOC to DOCX"
head_description: "Convert DOC to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "DOC to DOCX Live Demos"
    content: |
        Convert DOC to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
