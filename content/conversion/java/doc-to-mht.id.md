...
head_title: "Konversi DOC ke MHT di Jawa – Konversi DOC ke MHT"
head_description: "Konversi DOC ke MHT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke MHT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke MHT di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke MHT dalam beberapa baris kode.
