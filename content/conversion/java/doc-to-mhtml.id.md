...
head_title: "Konversi DOC ke MHTML di Jawa – Konversi DOC ke MHTML"
head_description: "Konversi DOC ke MHTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke MHTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke MHTML di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke MHTML dalam beberapa baris kode.
