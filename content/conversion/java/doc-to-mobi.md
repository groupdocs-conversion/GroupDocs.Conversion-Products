...
############################# Head ############################
head_title: "DOC to MOBI Conversion in Java – Convert DOC to MOBI"
head_description: "Convert DOC to MOBI in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to MOBI in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to MOBI in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to MOBI in few lines of code.
...
demos:
    enable: true
    title: "DOC to MOBI Live Demos"
    content: |
        Convert DOC to MOBI right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
