...
head_title: "Konversi DOC ke PPSM di Jawa – Konversi DOC ke PPSM"
head_description: "Konversi DOC ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke PPSM dalam beberapa baris kode.
