...
head_title: "Konversi DOC ke PPTM di Jawa – Konversi DOC ke PPTM"
head_description: "Konversi DOC ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke PPTM dalam beberapa baris kode.
