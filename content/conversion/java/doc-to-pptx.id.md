...
head_title: "Konversi DOC ke PPTX di Jawa – Konversi DOC ke PPTX"
head_description: "Konversi DOC ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke PPTX dalam beberapa baris kode.
