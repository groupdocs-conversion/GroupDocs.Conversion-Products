...
breadcrumb: DOC - RTF itt Java

############################# Head ############################
head_title: "A(z) DOC konvertálása RTF-re a Java programban"
head_description: "DOC – RTF konverzió a Java termékben néhány sor kóddal. Több mint 160 fájlformátum konvertálása a GroupDocs dokumentumkonverziós API segítségével a következőhöz: Java"

############################# Header ############################
title: "A(z) DOC konvertálása RTF-re a Java programban"
description: "DOC – RTF konverzió néhány soros Java kóddal"
...
overview:
    enable: true
    content: |
        Alakítsa át DOC fájljait RTF formátumra a Java termékben. Csak néhány sornyi Java kódra van szüksége bármely választott platformon, például Windowson, Linuxon vagy macOS-en.
        Megpróbálhatja ingyenesen konvertálni a(z) DOC-t RTF-re, és értékelje a konverziós eredmények minőségét. Az egyszerű fájlkonverziós szkriptek mellett kifinomultabb lehetőségeket is kipróbálhat a DOC forrásfájl betöltésére és a RTF kimenet tárolására. 
...
steps:
    enable: true
    title_left: "Lépések a(z) DOC konvertálásához RTF-re a Java programban"
    content_left: |
        A [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) lehetővé teszi a fejlesztők számára, hogy a DOC fájlt néhány soros kóddal egyszerűen RTF-re konvertálják.
...
demos:
    ...
    content: |
       Látogassa meg [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) webhelyünket, és próbálja ki a(z) DOC–RTF konverziót most. Az ingyenes demó a következő előnyökkel jár
