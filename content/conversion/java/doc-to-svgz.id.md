...
head_title: "Konversi DOC ke SVGZ di Jawa – Konversi DOC ke SVGZ"
head_description: "Konversi DOC ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke SVGZ dalam beberapa baris kode.
