...
head_title: "Konversi DOC ke SXC di Jawa – Konversi DOC ke SXC"
head_description: "Konversi DOC ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOC hingga SXC"
    content: |
        Konversikan DOC ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
