...
head_title: "Konversi DOC ke TEX di Jawa – Konversi DOC ke TEX"
head_description: "Konversi DOC ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke TEX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke TEX dalam beberapa baris kode.
