...
head_title: "Konversi DOC ke WEBP di Jawa – Konversi DOC ke WEBP"
head_description: "Konversi DOC ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke WEBP dalam beberapa baris kode.
