...
head_title: "Konversi DOC ke XLSB di Jawa – Konversi DOC ke XLSB"
head_description: "Konversi DOC ke XLSB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOC ke XLSB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOC ke XLSB di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOC ke XLSB dalam beberapa baris kode.
