...
############################# Head ############################
head_title: "DOC to XLSB Conversion in Java – Convert DOC to XLSB"
head_description: "Convert DOC to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to XLSB in few lines of code.
