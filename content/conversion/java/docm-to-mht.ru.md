...
############################# Head ############################
head_title: "Преобразование DOCM в MHT в Java — преобразование DOCM в MHT"
head_description: "Преобразование DOCM в MHT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DOCM в MHT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DOCM в MHT в Java"
    content_left: |
