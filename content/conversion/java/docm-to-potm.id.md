...
head_title: "Konversi DOCM ke POTM di Jawa – Konversi DOCM ke POTM"
head_description: "Konversi DOCM ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCM ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCM ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOCM ke POTM dalam beberapa baris kode.
