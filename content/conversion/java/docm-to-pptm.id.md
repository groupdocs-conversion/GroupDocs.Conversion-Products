...
head_title: "Konversi DOCM ke PPTM di Jawa – Konversi DOCM ke PPTM"
head_description: "Konversi DOCM ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCM ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCM ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOCM ke PPTM dalam beberapa baris kode.
