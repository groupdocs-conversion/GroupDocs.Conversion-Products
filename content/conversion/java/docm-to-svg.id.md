...
head_title: "Konversi DOCM ke SVG di Jawa – Konversi DOCM ke SVG"
head_description: "Konversi DOCM ke SVG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCM ke SVG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCM ke SVG di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOCM ke SVG dalam beberapa baris kode.
