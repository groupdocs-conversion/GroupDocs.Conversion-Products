...
head_title: "Konversi DOCM ke XLTX di Jawa – Konversi DOCM ke XLTX"
head_description: "Konversi DOCM ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCM ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCM ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOCM ke XLTX dalam beberapa baris kode.
