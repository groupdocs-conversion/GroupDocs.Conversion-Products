...
breadcrumb: DOCX to AI in Java

############################# Head ############################
head_title: "DOCX to AI Converter in Java"
head_description: "Convert DOCX to AI in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert DOCX to AI in Java"
description: "DOCX to AI conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your DOCX files to AI in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert DOCX to AI in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a DOCX file to AI with a few lines of code.
