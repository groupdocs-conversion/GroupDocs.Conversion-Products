...
############################# Head #############################
head_title: "Java API แปลง DOCX เป็น DWF - แปลงในแอปพลิเคชัน Java"
...
############################# Header ############################
title: "แปลง DOCX เป็น DWF ใน Java" 
description: "ประสบการณ์ API ที่มีประสิทธิภาพสูงสำหรับการแปลงไฟล์ DOCX เป็น DWF สำหรับแอปพลิเคชัน Java, J2EE และ J2SE มีการรองรับคุณลักษณะเพิ่มเติมอย่างหลากหลายเพื่อการปรับแต่งรูปแบบเอกสารผลลัพธ์" 
...
steps:
    enable: true
    title: "ขั้นตอนในการแปลงไฟล์ DOCX เป็นไฟล์ DWF ใน Java" 
    content: |
      การแปลง DOCX เป็น DWF กลายเป็นง่ายด้วย <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> คุณจำเป็นต้องทำเพียงไม่กี่ขั้นตอนง่ายๆ
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // แปลงไฟล์ DOCX เป็นไฟล์ DWF        
        ```            
