...
############################# Head ############################
head_title: "DOCX to EMZ Conversion in Java – Convert DOCX to EMZ"
head_description: "Convert DOCX to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCX Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCX to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCX file to EMZ in few lines of code.
...
demos:
    enable: true
    title: "DOCX to EMZ Live Demos"
    content: |
        Convert DOCX to EMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
