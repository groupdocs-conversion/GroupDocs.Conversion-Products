...
############################# Head #############################
head_title: "Java DOCX zu HTML Konverter API - DOCX in Java-Anwendungen transformieren"
head_description: "DOCX zu HTML Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "DOCX in HTML in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken DOCX zu HTML Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von DOCX in HTML Datei in Java" 
    content: |
      Die Transformation von DOCX in HTML wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
