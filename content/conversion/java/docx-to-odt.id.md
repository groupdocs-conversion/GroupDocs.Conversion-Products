...
head_title: "Konversi DOCX ke ODT di Jawa – Konversi DOCX ke ODT"
head_description: "Konversi DOCX ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCX ke ODT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOCX ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOCX hingga ODT"
    content: |
        Konversikan DOCX ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
