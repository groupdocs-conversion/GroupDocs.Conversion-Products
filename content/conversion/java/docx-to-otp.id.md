...
head_title: "Konversi DOCX ke OTP di Jawa – Konversi DOCX ke OTP"
head_description: "Konversi DOCX ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCX ke OTP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCX ke OTP di Java"
    content_left: |
        [GroupDocs.Conversion](conversion/java) memudahkan pengembang untuk mengonversi file DOCX ke OTP dalam beberapa baris kode.
