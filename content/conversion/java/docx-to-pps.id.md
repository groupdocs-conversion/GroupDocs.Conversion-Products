...
head_title: "Konversi DOCX ke PPS di Jawa – Konversi DOCX ke PPS"
head_description: "Konversi DOCX ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCX ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCX ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOCX ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOCX hingga PPS"
    content: |
        Konversikan DOCX ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
