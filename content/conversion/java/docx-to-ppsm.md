...
############################# Head ############################
head_title: "DOCX to PPSM Conversion in Java – Convert DOCX to PPSM"
head_description: "Convert DOCX to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCX Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCX to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCX file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "DOCX to PPSM Live Demos"
    content: |
        Convert DOCX to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
