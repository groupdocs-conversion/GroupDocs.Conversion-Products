...
head_title: "Konversi DOCX ke SVGZ di Jawa – Konversi DOCX ke SVGZ"
head_description: "Konversi DOCX ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCX ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCX ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOCX ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOCX hingga SVGZ"
    content: |
        Konversikan DOCX ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
