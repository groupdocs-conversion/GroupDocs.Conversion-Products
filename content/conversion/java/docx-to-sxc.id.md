...
head_title: "Konversi DOCX ke SXC di Jawa – Konversi DOCX ke SXC"
head_description: "Konversi DOCX ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCX ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCX ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOCX ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOCX hingga SXC"
    content: |
        Konversikan DOCX ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
