...
############################# Head #############################
head_title: "Java DOCX zu TEX Konverter API - DOCX in Java-Anwendungen transformieren"
head_description: "DOCX zu TEX Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "DOCX in TEX in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von DOCX in TEX Datei in Java" 
    content: |
      Die Transformation von DOCX in TEX wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // DOCX in TEX Datei konvertieren        
        ```            
