...
head_title: "Konversi DOCX ke XLSX di Jawa – Konversi DOCX ke XLSX"
head_description: "Konversi DOCX ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCX ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCX ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOCX ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOCX hingga XLSX"
    content: |
        Konversikan DOCX ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
