...
head_title: "Konversi DOCX ke XLTX di Jawa – Konversi DOCX ke XLTX"
head_description: "Konversi DOCX ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOCX ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOCX ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOCX ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOCX hingga XLTX"
    content: |
        Konversikan DOCX ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
