...
############################# Head ############################
head_title: "DOT to BMP Conversion in Java – Convert DOT to BMP"
head_description: "Convert DOT to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOT Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOT to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOT file to BMP in few lines of code.
...
demos:
    enable: true
    title: "DOT to BMP Live Demos"
    content: |
        Convert DOT to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
