...
head_title: "Konversi DOT ke DOTX di Jawa – Konversi DOT ke DOTX"
head_description: "Konversi DOT ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOT ke DOTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOT ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOT hingga DOTX"
    content: |
        Konversikan DOT ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
