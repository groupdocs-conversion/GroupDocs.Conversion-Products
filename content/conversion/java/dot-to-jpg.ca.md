...
breadcrumb: DOT a JPG a Java

############################# Head ############################
head_title: "Converteix DOT a JPG a Java"
head_description: "Conversió de DOT a JPG a Java amb unes quantes línies de codi. Converteix més de 160 formats de fitxer mitjançant l'API de conversió de documents de GroupDocs per a Java"

############################# Header ############################
title: "Converteix DOT a JPG a Java"
description: "Conversió de DOT a JPG amb unes poques línies de codi Java"
...
overview:
    enable: true
    content: |
        Convertiu els vostres fitxers DOT a JPG a Java. Només calen un parell de línies de codi Java a qualsevol plataforma que trieu, com ara Windows, Linux, macOS.
        Podeu provar de convertir DOT a JPG de manera gratuïta i avaluar la qualitat dels resultats de la conversió. Juntament amb els scripts de conversió de fitxers senzills, podeu provar opcions més sofisticades per carregar el fitxer font DOT i emmagatzemar la sortida JPG. 
        ...
        * afegeix una marca d'aigua al JPG convertit.
        ...
        Un cop finalitzada la conversió, podeu desar el fitxer JPG a la ruta del fitxer local o a qualsevol emmagatzematge de tercers, com ara FTP, Amazon S3, Google Drive, Dropbox, etc. Tingueu en compte: per convertir DOT a JPG, no cal que instal·leu cap programari addicional, com ara MS Office, Open Office, Adobe Acrobat Reader, etc.


############################# Steps ############################
steps:
    enable: true
    title_left: "Passos per convertir DOT a JPG a Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) permet als desenvolupadors convertir fàcilment el fitxer DOT a JPG amb unes poques línies de codi.
...
demos:
    ...
    content: |
       Visiteu el nostre lloc web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) i proveu ara la conversió de DOT a JPG. La demostració gratuïta té els següents avantatges
