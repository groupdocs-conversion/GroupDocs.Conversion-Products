...
############################# Head #############################
head_title: "Java DOT zu JPG Konverter API - DOT in Java-Anwendungen transformieren"
head_description: "DOT zu JPG Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "DOT in JPG in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von DOT in JPG Datei in Java" 
    content: |
      Die Transformation von DOT in JPG wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // DOT in JPG Datei konvertieren        
        ```            
