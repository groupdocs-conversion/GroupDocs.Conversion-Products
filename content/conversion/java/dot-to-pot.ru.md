...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) упрощает для разработчиков преобразование файла DOT в файл POT с помощью нескольких строк кода.
