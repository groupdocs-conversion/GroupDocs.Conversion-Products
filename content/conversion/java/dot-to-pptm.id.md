...
head_title: "Konversi DOT ke PPTM di Jawa – Konversi DOT ke PPTM"
head_description: "Konversi DOT ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOT ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOT ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOT ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOT hingga PPTM"
    content: |
        Konversikan DOT ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
