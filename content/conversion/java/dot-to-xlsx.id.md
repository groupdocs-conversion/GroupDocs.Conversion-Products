...
head_title: "Konversi DOT ke XLSX di Jawa – Konversi DOT ke XLSX"
head_description: "Konversi DOT ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOT ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOT ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOT ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOT hingga XLSX"
    content: |
        Konversikan DOT ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
