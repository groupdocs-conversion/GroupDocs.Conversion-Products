...
head_title: "Konversi DOTM ke DIF di Jawa – Konversi DOTM ke DIF"
head_description: "Konversi DOTM ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTM ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTM ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTM ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTM hingga DIF"
    content: |
        Konversikan DOTM ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
