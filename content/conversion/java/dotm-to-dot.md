...
############################# Head ############################
head_title: "DOTM to DOT Conversion in Java – Convert DOTM to DOT"
head_description: "Convert DOTM to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTM Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTM to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTM file to DOT in few lines of code.
...
demos:
    enable: true
    title: "DOTM to DOT Live Demos"
    content: |
        Convert DOTM to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
