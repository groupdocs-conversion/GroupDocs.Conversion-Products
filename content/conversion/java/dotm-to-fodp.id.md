...
head_title: "Konversi DOTM ke FODP di Jawa – Konversi DOTM ke FODP"
head_description: "Konversi DOTM ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTM ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTM ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTM ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTM hingga FODP"
    content: |
        Konversikan DOTM ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
