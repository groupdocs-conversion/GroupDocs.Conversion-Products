...
head_title: "Konversi DOTM ke FODS di Jawa – Konversi DOTM ke FODS"
head_description: "Konversi DOTM ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTM ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTM ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTM ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTM hingga FODS"
    content: |
        Konversikan DOTM ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
