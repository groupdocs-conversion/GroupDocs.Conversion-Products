...
head_title: "Konversi DOTM ke HTML di Jawa – Konversi DOTM ke HTML"
head_description: "Konversi DOTM ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTM ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTM ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTM ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTM hingga HTML"
    content: |
        Konversikan DOTM ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
