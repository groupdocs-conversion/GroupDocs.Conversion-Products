...
head_title: "Konversi DOTM ke ODP di Jawa – Konversi DOTM ke ODP"
head_description: "Konversi DOTM ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTM ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTM ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTM ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTM hingga ODP"
    content: |
        Konversikan DOTM ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
