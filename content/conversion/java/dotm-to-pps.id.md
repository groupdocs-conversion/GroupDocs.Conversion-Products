...
head_title: "Konversi DOTM ke PPS di Jawa – Konversi DOTM ke PPS"
head_description: "Konversi DOTM ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTM ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTM ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTM ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTM hingga PPS"
    content: |
        Konversikan DOTM ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
