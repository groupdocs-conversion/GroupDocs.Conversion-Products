...
head_title: "Konversi DOTM ke PPSX di Jawa – Konversi DOTM ke PPSX"
head_description: "Konversi DOTM ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTM ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTM ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTM ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTM hingga PPSX"
    content: |
        Konversikan DOTM ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
