...
############################# Head ############################
head_title: "DOTM to PPSX Conversion in Java – Convert DOTM to PPSX"
head_description: "Convert DOTM to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTM Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTM to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTM file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "DOTM to PPSX Live Demos"
    content: |
        Convert DOTM to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
