...
head_title: "Konversi DOTM ke PPT di Jawa – Konversi DOTM ke PPT"
head_description: "Konversi DOTM ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTM ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTM ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTM ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTM hingga PPT"
    content: |
        Konversikan DOTM ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
