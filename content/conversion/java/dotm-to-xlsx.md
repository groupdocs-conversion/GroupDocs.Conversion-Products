...
############################# Head ############################
head_title: "DOTM to XLSX Conversion in Java – Convert DOTM to XLSX"
head_description: "Convert DOTM to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTM Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTM to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTM file to XLSX in few lines of code.
