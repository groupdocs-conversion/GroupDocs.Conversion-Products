...
head_title: "Konversi DOTX ke DCM di Jawa – Konversi DOTX ke DCM"
head_description: "Konversi DOTX ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga DCM"
    content: |
        Konversikan DOTX ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
