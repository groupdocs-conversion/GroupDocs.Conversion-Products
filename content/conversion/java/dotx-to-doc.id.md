...
head_title: "Konversi DOTX ke DOC di Jawa – Konversi DOTX ke DOC"
head_description: "Konversi DOTX ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke DOC di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga DOC"
    content: |
        Konversikan DOTX ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
