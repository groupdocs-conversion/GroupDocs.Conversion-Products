...
head_title: "Konversi DOTX ke DOCX di Jawa – Konversi DOTX ke DOCX"
head_description: "Konversi DOTX ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke DOCX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga DOCX"
    content: |
        Konversikan DOTX ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
