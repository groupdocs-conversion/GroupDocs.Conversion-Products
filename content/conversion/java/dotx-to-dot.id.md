...
head_title: "Konversi DOTX ke DOT di Jawa – Konversi DOTX ke DOT"
head_description: "Konversi DOTX ke DOT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke DOT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke DOT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga DOT"
    content: |
        Konversikan DOTX ke DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
