...
head_title: "Konversi DOTX ke FODP di Jawa – Konversi DOTX ke FODP"
head_description: "Konversi DOTX ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga FODP"
    content: |
        Konversikan DOTX ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
