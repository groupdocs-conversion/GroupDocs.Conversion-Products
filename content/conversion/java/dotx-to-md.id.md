...
head_title: "Konversi DOTX ke MD di Jawa – Konversi DOTX ke MD"
head_description: "Konversi DOTX ke MD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke MD di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke MD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga MD"
    content: |
        Konversikan DOTX ke MD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
