...
############################# Head #############################
head_title: "Java DOTX to PDF Converter API - transform DOTX to PDF in Java apps"
head_description: "View DOTX to PDF files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert DOTX to PDF in Java" 
description: "Experience the efficiency of a native, high-performance DOTX to PDF file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert DOTX to PDF file in Java" 
    content: |
      Transforming DOTX to PDF is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert DOTX to PDF file        
        ```            
