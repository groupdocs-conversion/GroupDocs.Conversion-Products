...
head_title: "Konversi DOTX ke POTX di Jawa – Konversi DOTX ke POTX"
head_description: "Konversi DOTX ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga POTX"
    content: |
        Konversikan DOTX ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
