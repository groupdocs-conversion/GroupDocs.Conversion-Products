...
head_title: "Konversi DOTX ke PPS di Jawa – Konversi DOTX ke PPS"
head_description: "Konversi DOTX ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga PPS"
    content: |
        Konversikan DOTX ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
