...
head_title: "Konversi DOTX ke PPSM di Jawa – Konversi DOTX ke PPSM"
head_description: "Konversi DOTX ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke PPSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga PPSM"
    content: |
        Konversikan DOTX ke PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
