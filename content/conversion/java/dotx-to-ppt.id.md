...
head_title: "Konversi DOTX ke PPT di Jawa – Konversi DOTX ke PPT"
head_description: "Konversi DOTX ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga PPT"
    content: |
        Konversikan DOTX ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
