...
head_title: "Konversi DOTX ke PPTX di Jawa – Konversi DOTX ke PPTX"
head_description: "Konversi DOTX ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga PPTX"
    content: |
        Konversikan DOTX ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
