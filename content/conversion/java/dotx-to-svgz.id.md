...
head_title: "Konversi DOTX ke SVGZ di Jawa – Konversi DOTX ke SVGZ"
head_description: "Konversi DOTX ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga SVGZ"
    content: |
        Konversikan DOTX ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
