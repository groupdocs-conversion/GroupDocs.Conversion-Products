...
head_title: "Konversi DOTX ke SXC di Jawa – Konversi DOTX ke SXC"
head_description: "Konversi DOTX ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga SXC"
    content: |
        Konversikan DOTX ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
