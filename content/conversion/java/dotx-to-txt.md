...
############################# Head ############################
head_title: "DOTX to TXT Conversion in Java – Convert DOTX to TXT"
head_description: "Convert DOTX to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTX Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTX to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTX file to TXT in few lines of code.
...
demos:
    enable: true
    title: "DOTX to TXT Live Demos"
    content: |
        Convert DOTX to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
