...
head_title: "Konversi DOTX ke XLS di Jawa – Konversi DOTX ke XLS"
head_description: "Konversi DOTX ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga XLS"
    content: |
        Konversikan DOTX ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
