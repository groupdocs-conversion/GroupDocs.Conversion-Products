...
head_title: "Konversi DOTX ke XLSB di Jawa – Konversi DOTX ke XLSB"
head_description: "Konversi DOTX ke XLSB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke XLSB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke XLSB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke XLSB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga XLSB"
    content: |
        Konversikan DOTX ke XLSB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
