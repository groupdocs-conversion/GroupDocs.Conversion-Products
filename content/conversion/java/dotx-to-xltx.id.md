...
head_title: "Konversi DOTX ke XLTX di Jawa – Konversi DOTX ke XLTX"
head_description: "Konversi DOTX ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DOTX ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DOTX ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DOTX ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DOTX hingga XLTX"
    content: |
        Konversikan DOTX ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
