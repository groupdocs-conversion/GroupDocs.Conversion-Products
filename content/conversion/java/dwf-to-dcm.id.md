...
head_title: "Konversi DWF ke DCM di Jawa – Konversi DWF ke DCM"
head_description: "Konversi DWF ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga DCM"
    content: |
        Konversikan DWF ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
