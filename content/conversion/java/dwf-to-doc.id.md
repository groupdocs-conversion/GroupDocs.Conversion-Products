...
head_title: "Konversi DWF ke DOC di Jawa – Konversi DWF ke DOC"
head_description: "Konversi DWF ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke DOC di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga DOC"
    content: |
        Konversikan DWF ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
