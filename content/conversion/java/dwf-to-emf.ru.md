...
############################# Head ############################
head_title: "Преобразование DWF в EMF в Java — Преобразование DWF в EMF"
head_description: "Преобразование DWF в EMF на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DWF в EMF в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DWF в EMF в Java"
    content_left: |
