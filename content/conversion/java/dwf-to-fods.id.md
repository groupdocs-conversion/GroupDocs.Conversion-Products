...
head_title: "Konversi DWF ke FODS di Jawa – Konversi DWF ke FODS"
head_description: "Konversi DWF ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga FODS"
    content: |
        Konversikan DWF ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
