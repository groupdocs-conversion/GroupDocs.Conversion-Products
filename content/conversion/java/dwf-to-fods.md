...
############################# Head ############################
head_title: "DWF to FODS Conversion in Java – Convert DWF to FODS"
head_description: "Convert DWF to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWF Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWF to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWF file to FODS in few lines of code.
...
demos:
    enable: true
    title: "DWF to FODS Live Demos"
    content: |
        Convert DWF to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
