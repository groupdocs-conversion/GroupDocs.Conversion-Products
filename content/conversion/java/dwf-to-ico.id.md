...
head_title: "Konversi DWF ke ICO di Jawa – Konversi DWF ke ICO"
head_description: "Konversi DWF ke ICO di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke ICO di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke ICO di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke ICO dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga ICO"
    content: |
        Konversikan DWF ke ICO sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
