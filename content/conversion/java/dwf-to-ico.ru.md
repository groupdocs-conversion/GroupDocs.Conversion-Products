...
############################# Head ############################
head_title: "Преобразование DWF в ICO в Java — Преобразование DWF в ICO"
head_description: "Преобразование DWF в ICO на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DWF в ICO в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию DWF в ICO в Java"
    content_left: |
