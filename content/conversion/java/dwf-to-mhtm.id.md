...
head_title: "Konversi DWF ke MHTM di Jawa – Konversi DWF ke MHTM"
head_description: "Konversi DWF ke MHTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke MHTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke MHTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke MHTM dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file DWF dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen MHTM
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (MHTM) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format MHTM target
...
demos:
    ...
    content: |
        Konversikan DWF ke MHTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
