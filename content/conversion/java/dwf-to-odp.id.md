...
head_title: "Konversi DWF ke ODP di Jawa – Konversi DWF ke ODP"
head_description: "Konversi DWF ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke ODP di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga ODP"
    content: |
        Konversikan DWF ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
