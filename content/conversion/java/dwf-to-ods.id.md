...
head_title: "Konversi DWF ke ODS di Jawa – Konversi DWF ke ODS"
head_description: "Konversi DWF ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga ODS"
    content: |
        Konversikan DWF ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
