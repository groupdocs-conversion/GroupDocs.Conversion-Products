...
head_title: "Konversi DWF ke ODT di Jawa – Konversi DWF ke ODT"
head_description: "Konversi DWF ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke ODT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga ODT"
    content: |
        Konversikan DWF ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
