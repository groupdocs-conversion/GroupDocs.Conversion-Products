...
head_title: "Konversi DWF ke OTT di Jawa – Konversi DWF ke OTT"
head_description: "Konversi DWF ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga OTT"
    content: |
        Konversikan DWF ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
