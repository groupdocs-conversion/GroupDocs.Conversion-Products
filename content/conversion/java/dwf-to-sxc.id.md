...
head_title: "Konversi DWF ke SXC di Jawa – Konversi DWF ke SXC"
head_description: "Konversi DWF ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga SXC"
    content: |
        Konversikan DWF ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
