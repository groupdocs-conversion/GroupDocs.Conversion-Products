...
head_title: "Konversi DWF ke TEX di Jawa – Konversi DWF ke TEX"
head_description: "Konversi DWF ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga TEX"
    content: |
        Konversikan DWF ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
