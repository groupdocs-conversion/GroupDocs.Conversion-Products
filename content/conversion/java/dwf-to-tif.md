...
############################# Head ############################
head_title: "DWF to TIF Conversion in Java – Convert DWF to TIF"
head_description: "Convert DWF to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWF Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWF to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWF file to TIF in few lines of code.
...
demos:
    enable: true
    title: "DWF to TIF Live Demos"
    content: |
        Convert DWF to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
