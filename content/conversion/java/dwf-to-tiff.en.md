...
############################# Head #############################
head_title: "Java DWF to TIFF Converter API - transform DWF to TIFF in Java apps"
head_description: "View DWF to TIFF files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert DWF to TIFF in Java" 
description: "Experience the efficiency of a native, high-performance DWF to TIFF file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert DWF to TIFF file in Java" 
    content: |
      Transforming DWF to TIFF is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert DWF to TIFF file        
        ```            
