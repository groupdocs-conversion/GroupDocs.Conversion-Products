...
############################# Head #############################
head_title: "API de conversión de DWF a TIFF para Java - transformar DWF a TIFF en aplicaciones Java"
head_description: "Vea archivos DWF a TIFF en aplicaciones Java, J2EE, J2SE. Admite la visualización de más de 180 formatos de archivo de documento e imagen en modo HTML, PDF o imagen con funciones avanzadas para administrar opciones de visualización de documentos."

############################# Header ############################
title: "Convertir DWF a TIFF en Java" 
description: "Experimente la eficiencia de una API de conversión de archivos nativa y de alto rendimiento de DWF a TIFF diseñada para aplicaciones Java, J2EE y J2SE. Disfrute del soporte para un conjunto extenso de funciones adicionales, lo que permite la personalización de la apariencia del documento de salida." 
...
steps:
    enable: true
    title: "Pasos para convertir archivo DWF a TIFF en Java" 
    content: |
      La transformación de DWF a TIFF se simplifica con <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, solo requiere unos pocos pasos sencillos.
      ...
      3. Cargue el archivo DWF con la ruta completa. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.dwf")              // Configurar archivo de entrada DWF
            .convertTo("converted.tiff")    // Especificar la ruta de salida para el archivo convertido
            .convert();                     // Convertir archivo DWF a TIFF        
        ```            
