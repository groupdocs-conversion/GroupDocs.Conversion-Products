...
############################# Head #############################
head_title: "Java DWF zu WEBP Konverter API - DWF in Java-Anwendungen transformieren"
head_description: "DWF zu WEBP Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "DWF in WEBP in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken DWF zu WEBP Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von DWF in WEBP Datei in Java" 
    content: |
      Die Transformation von DWF in WEBP wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die DWF Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // DWF in WEBP Datei konvertieren        
        ```            
