...
head_title: "Konversi DWF ke XLS di Jawa – Konversi DWF ke XLS"
head_description: "Konversi DWF ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga XLS"
    content: |
        Konversikan DWF ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
