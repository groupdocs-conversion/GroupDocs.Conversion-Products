...
head_title: "Konversi DWF ke XLSX di Jawa – Konversi DWF ke XLSX"
head_description: "Konversi DWF ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga XLSX"
    content: |
        Konversikan DWF ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
