...
head_title: "Konversi DWF ke XLT di Jawa – Konversi DWF ke XLT"
head_description: "Konversi DWF ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga XLT"
    content: |
        Konversikan DWF ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
