...
head_title: "Konversi DWF ke XLTM di Jawa – Konversi DWF ke XLTM"
head_description: "Konversi DWF ke XLTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWF ke XLTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWF ke XLTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWF ke XLTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWF hingga XLTM"
    content: |
        Konversikan DWF ke XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
