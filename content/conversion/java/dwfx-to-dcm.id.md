...
head_title: "Konversi DWFX ke DCM di Jawa – Konversi DWFX ke DCM"
head_description: "Konversi DWFX ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWFX ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWFX ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWFX ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWFX hingga DCM"
    content: |
        Konversikan DWFX ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
