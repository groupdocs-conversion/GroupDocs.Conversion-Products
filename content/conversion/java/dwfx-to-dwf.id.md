...
head_title: "Konversi DWFX ke DWF di Jawa – Konversi DWFX ke DWF"
head_description: "Konversi DWFX ke DWF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWFX ke DWF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWFX ke DWF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWFX ke DWF dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file DWFX dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen DWF
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (DWF) sebagai parameter
...
demos:
    enable: true
    title: "Demo Langsung DWFX hingga DWF"
    content: |
        Konversikan DWFX ke DWF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
