...
head_title: "Konversi DWFX ke EPUB di Jawa – Konversi DWFX ke EPUB"
head_description: "Konversi DWFX ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWFX ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWFX ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWFX ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWFX hingga EPUB"
    content: |
        Konversikan DWFX ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
