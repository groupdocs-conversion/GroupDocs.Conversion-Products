...
head_title: "Konversi DWFX ke JP2 di Jawa – Konversi DWFX ke JP2"
head_description: "Konversi DWFX ke JP2 di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWFX ke JP2 di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWFX ke JP2 di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWFX ke JP2 dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWFX hingga JP2"
    content: |
        Konversikan DWFX ke JP2 sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
