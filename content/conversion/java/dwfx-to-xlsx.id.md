...
head_title: "Konversi DWFX ke XLSX di Jawa – Konversi DWFX ke XLSX"
head_description: "Konversi DWFX ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWFX ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWFX ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWFX ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWFX hingga XLSX"
    content: |
        Konversikan DWFX ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
