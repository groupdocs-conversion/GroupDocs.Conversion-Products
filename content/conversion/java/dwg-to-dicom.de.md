...
############################# Head #############################
head_title: "Java DWG zu DICOM Konverter API - DWG in Java-Anwendungen transformieren"
head_description: "DWG zu DICOM Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "DWG in DICOM in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken DWG zu DICOM Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von DWG in DICOM Datei in Java" 
    content: |
      Die Transformation von DWG in DICOM wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
