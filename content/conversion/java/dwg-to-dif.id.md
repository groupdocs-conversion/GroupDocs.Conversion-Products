...
head_title: "Konversi DWG ke DIF di Jawa – Konversi DWG ke DIF"
head_description: "Konversi DWG ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWG ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWG ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWG ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWG hingga DIF"
    content: |
        Konversikan DWG ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
