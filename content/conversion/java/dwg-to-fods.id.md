...
head_title: "Konversi DWG ke FODS di Jawa – Konversi DWG ke FODS"
head_description: "Konversi DWG ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWG ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWG ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWG ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWG hingga FODS"
    content: |
        Konversikan DWG ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
