...
head_title: "Konversi DWG ke MD di Jawa – Konversi DWG ke MD"
head_description: "Konversi DWG ke MD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWG ke MD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWG ke MD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWG ke MD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWG hingga MD"
    content: |
        Konversikan DWG ke MD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
