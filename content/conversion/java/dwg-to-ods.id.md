...
head_title: "Konversi DWG ke ODS di Jawa – Konversi DWG ke ODS"
head_description: "Konversi DWG ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWG ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWG ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWG ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWG hingga ODS"
    content: |
        Konversikan DWG ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
