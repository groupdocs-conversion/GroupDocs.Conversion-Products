...
############################# Head #############################
head_title: "Java DWG to PPTX Converter API - transform DWG to PPTX in Java apps"
head_description: "View DWG to PPTX files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert DWG to PPTX in Java" 
description: "Experience the efficiency of a native, high-performance DWG to PPTX file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert DWG to PPTX file in Java" 
    content: |
      Transforming DWG to PPTX is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert DWG to PPTX file        
        ```            
