...
head_title: "Konversi DWG ke SVG di Jawa – Konversi DWG ke SVG"
head_description: "Konversi DWG ke SVG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWG ke SVG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWG ke SVG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWG ke SVG dalam beberapa baris kode.
