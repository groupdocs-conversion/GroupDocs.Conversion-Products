...
head_title: "Konversi DWG ke SXC di Jawa – Konversi DWG ke SXC"
head_description: "Konversi DWG ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWG ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWG ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWG ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWG hingga SXC"
    content: |
        Konversikan DWG ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
