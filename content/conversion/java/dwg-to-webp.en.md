...
############################# Head #############################
head_title: "Java DWG to WEBP Converter API - transform DWG to WEBP in Java apps"
head_description: "View DWG to WEBP files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert DWG to WEBP in Java" 
description: "Experience the efficiency of a native, high-performance DWG to WEBP file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert DWG to WEBP file in Java" 
    content: |
      Transforming DWG to WEBP is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the DWG file with full path. 
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert DWG to WEBP file        
        ```            
