...
head_title: "Konversi DWG ke WEBP di Jawa – Konversi DWG ke WEBP"
head_description: "Konversi DWG ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWG ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWG ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWG ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWG hingga WEBP"
    content: |
        Konversikan DWG ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
