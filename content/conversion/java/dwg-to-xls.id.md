...
head_title: "Konversi DWG ke XLS di Jawa – Konversi DWG ke XLS"
head_description: "Konversi DWG ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DWG ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DWG ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DWG ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DWG hingga XLS"
    content: |
        Konversikan DWG ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
