...
############################# Head ############################
head_title: "DWG to XLT Conversion in Java – Convert DWG to XLT"
head_description: "Convert DWG to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWG Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWG to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWG file to XLT in few lines of code.
...
demos:
    enable: true
    title: "DWG to XLT Live Demos"
    content: |
        Convert DWG to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
