...
############################# Head ############################
head_title: "DWT to HTML Conversion in Java – Convert DWT to HTML"
head_description: "Convert DWT to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWT Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWT to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWT file to HTML in few lines of code.
...
demos:
    enable: true
    title: "DWT to HTML Live Demos"
    content: |
        Convert DWT to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
