...
breadcrumb: DWT do ODP w Java

############################# Head ############################
head_title: "Konwertuj DWT na ODP w Java"
head_description: "Konwersja DWT na ODP w Java z kilkoma linijkami kodu. Konwertuj ponad 160 formatów plików za pomocą interfejsu API konwersji dokumentów GroupDocs dla Java"

############################# Header ############################
title: "Konwertuj DWT na ODP w Java"
description: "Konwersja DWT do ODP z kilkoma linijkami kodu Java"
...
overview:
    enable: true
    content: |
        Przekonwertuj swoje pliki DWT na ODP w Java. Zajmuje tylko kilka linii kodu Java na dowolnej wybranej platformie, takiej jak Windows, Linux, macOS.
        Możesz spróbować przekonwertować DWT na ODP za darmo i ocenić jakość wyników konwersji. Oprócz prostych skryptów konwersji plików możesz wypróbować bardziej wyrafinowane opcje ładowania pliku źródłowego DWT i przechowywania danych wyjściowych ODP. 
...
steps:
    enable: true
    title_left: "Kroki konwersji DWT na ODP w Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) pozwala programistom łatwo przekonwertować plik DWT na ODP za pomocą kilku linijek kodu.
...
demos:
    ...
    content: |
       Odwiedź naszą witrynę [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) i wypróbuj teraz konwersję DWT na ODP. Darmowe demo ma następujące zalety
