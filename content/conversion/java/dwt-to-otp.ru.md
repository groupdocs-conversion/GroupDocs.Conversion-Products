...
############################# Head ############################
head_title: "Преобразование DWT в OTP в Java — преобразование DWT в OTP"
head_description: "Преобразование DWT в OTP на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов DWT в OTP в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования DWT в OTP в Java"
    content_left: |
