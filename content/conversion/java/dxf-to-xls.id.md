...
head_title: "Konversi DXF ke XLS di Jawa – Konversi DXF ke XLS"
head_description: "Konversi DXF ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File DXF ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi DXF ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file DXF ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung DXF hingga XLS"
    content: |
        Konversikan DXF ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
