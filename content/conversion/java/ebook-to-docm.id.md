...
head_title: "Konversi EBOOK ke DOCM di Jawa – Konversi EBOOK ke DOCM"
head_description: "Konversi EBOOK ke DOCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EBOOK ke DOCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EBOOK ke DOCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EBOOK ke DOCM dalam beberapa baris kode.
