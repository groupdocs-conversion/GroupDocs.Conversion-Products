...
head_title: "Konversi EBOOK ke EMAIL di Jawa – Konversi EBOOK ke EMAIL"
head_description: "Konversi EBOOK ke EMAIL di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EBOOK ke EMAIL di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EBOOK ke EMAIL di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EBOOK ke EMAIL dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file EBOOK dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen EMAIL
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (EMAIL) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format EMAIL target
...
demos:
    enable: true
    title: "Demo Langsung EBOOK hingga EMAIL"
    content: |
        Konversikan EBOOK ke EMAIL sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
...
about_formats:
    ...
    format:
        - icon: "far fa-file-EMAIL"
          title: " Tentang Format File EMAIL"
          content: |
