...
head_title: "Konversi EBOOK ke ODS di Jawa – Konversi EBOOK ke ODS"
head_description: "Konversi EBOOK ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EBOOK ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EBOOK ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EBOOK ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EBOOK hingga ODS"
    content: |
        Konversikan EBOOK ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
