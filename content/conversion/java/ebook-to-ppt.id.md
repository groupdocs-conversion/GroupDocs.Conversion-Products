...
head_title: "Konversi EBOOK ke PPT di Jawa – Konversi EBOOK ke PPT"
head_description: "Konversi EBOOK ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EBOOK ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EBOOK ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EBOOK ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EBOOK hingga PPT"
    content: |
        Konversikan EBOOK ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
