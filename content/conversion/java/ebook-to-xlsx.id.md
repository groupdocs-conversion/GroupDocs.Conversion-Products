...
head_title: "Konversi EBOOK ke XLSX di Jawa – Konversi EBOOK ke XLSX"
head_description: "Konversi EBOOK ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EBOOK ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EBOOK ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EBOOK ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EBOOK hingga XLSX"
    content: |
        Konversikan EBOOK ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
