...
head_title: "Konversi EMAIL ke EPUB di Jawa – Konversi EMAIL ke EPUB"
head_description: "Konversi EMAIL ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMAIL ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMAIL ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMAIL ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMAIL hingga EPUB"
    content: |
        Konversikan EMAIL ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
