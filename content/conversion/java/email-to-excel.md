...
############################# Head ############################
head_title: "EMAIL to EXCEL Conversion in Java – Convert EMAIL to EXCEL"
head_description: "Convert EMAIL to EXCEL in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to EXCEL in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to EXCEL in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to EXCEL in few lines of code.
...
demos:
    enable: true
    title: "EMAIL to EXCEL Live Demos"
    content: |
        Convert EMAIL to EXCEL right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
