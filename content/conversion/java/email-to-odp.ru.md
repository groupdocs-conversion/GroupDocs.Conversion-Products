...
############################# Head ############################
head_title: "Преобразование EMAIL в ODP в Java — преобразование EMAIL в ODP"
head_description: "Преобразуйте EMAIL в ODP на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов EMAIL в ODP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию EMAIL в ODP в Java"
    content_left: |
