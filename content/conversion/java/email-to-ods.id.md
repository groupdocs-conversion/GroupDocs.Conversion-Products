...
head_title: "Konversi EMAIL ke ODS di Jawa – Konversi EMAIL ke ODS"
head_description: "Konversi EMAIL ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMAIL ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMAIL ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMAIL ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMAIL hingga ODS"
    content: |
        Konversikan EMAIL ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
