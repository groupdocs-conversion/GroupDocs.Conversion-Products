...
############################# Head ############################
head_title: "EMAIL to ODS Conversion in Java – Convert EMAIL to ODS"
head_description: "Convert EMAIL to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to ODS in few lines of code.
...
demos:
    enable: true
    title: "EMAIL to ODS Live Demos"
    content: |
        Convert EMAIL to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
