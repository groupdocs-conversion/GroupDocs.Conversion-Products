...
head_title: "Konversi EMAIL ke ODT di Jawa – Konversi EMAIL ke ODT"
head_description: "Konversi EMAIL ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMAIL ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMAIL ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMAIL ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMAIL hingga ODT"
    content: |
        Konversikan EMAIL ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
