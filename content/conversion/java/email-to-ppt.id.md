...
head_title: "Konversi EMAIL ke PPT di Jawa – Konversi EMAIL ke PPT"
head_description: "Konversi EMAIL ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMAIL ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMAIL ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMAIL ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMAIL hingga PPT"
    content: |
        Konversikan EMAIL ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
