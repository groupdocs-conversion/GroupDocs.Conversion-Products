...
############################# Head ############################
head_title: "Преобразование EMAIL в WEB на Java — преобразование EMAIL в WEB"
head_description: "Преобразуйте EMAIL в WEB на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов EMAIL в WEB на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию EMAIL в WEB на Java"
    content_left: |
