...
############################# Head ############################
head_title: "EMAIL to XLSM Conversion in Java – Convert EMAIL to XLSM"
head_description: "Convert EMAIL to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "EMAIL to XLSM Live Demos"
    content: |
        Convert EMAIL to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
