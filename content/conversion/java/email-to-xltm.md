...
############################# Head ############################
head_title: "EMAIL to XLTM Conversion in Java – Convert EMAIL to XLTM"
head_description: "Convert EMAIL to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "EMAIL to XLTM Live Demos"
    content: |
        Convert EMAIL to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
