...
############################# Head ############################
head_title: "Преобразование EMAIL в XLTM в Java — преобразование EMAIL в XLTM"
head_description: "Преобразуйте EMAIL в XLTM на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов EMAIL в XLTM на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию EMAIL в XLTM в Java"
    content_left: |
