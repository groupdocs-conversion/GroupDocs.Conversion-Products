...
head_title: "Konversi EMAIL ke XLTX di Jawa – Konversi EMAIL ke XLTX"
head_description: "Konversi EMAIL ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMAIL ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMAIL ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMAIL ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMAIL hingga XLTX"
    content: |
        Konversikan EMAIL ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
