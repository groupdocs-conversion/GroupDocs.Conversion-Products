...
############################# Head ############################
head_title: "Преобразование EMAIL в XLTX в Java — преобразование EMAIL в XLTX"
head_description: "Преобразование EMAIL в XLTX на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов EMAIL в XLTX в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования EMAIL в XLTX в Java"
    content_left: |
