...
head_title: "Konversi EMF ke EML di Jawa – Konversi EMF ke EML"
head_description: "Konversi EMF ke EML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMF ke EML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMF ke EML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMF ke EML dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file EMF dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen EML
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (EML) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format EML target
...
demos:
    enable: true
    title: "Demo Langsung EMF hingga EML"
    content: |
        Konversikan EMF ke EML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
