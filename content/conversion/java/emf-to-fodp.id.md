...
head_title: "Konversi EMF ke FODP di Jawa – Konversi EMF ke FODP"
head_description: "Konversi EMF ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMF ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMF ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMF ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMF hingga FODP"
    content: |
        Konversikan EMF ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
