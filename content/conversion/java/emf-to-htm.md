...
############################# Head ############################
head_title: "EMF to HTM Conversion in Java – Convert EMF to HTM"
head_description: "Convert EMF to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMF Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMF to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMF file to HTM in few lines of code.
