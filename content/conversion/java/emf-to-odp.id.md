...
head_title: "Konversi EMF ke ODP di Jawa – Konversi EMF ke ODP"
head_description: "Konversi EMF ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMF ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMF ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMF ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMF hingga ODP"
    content: |
        Konversikan EMF ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
