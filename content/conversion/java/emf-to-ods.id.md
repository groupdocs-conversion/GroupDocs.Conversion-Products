...
head_title: "Konversi EMF ke ODS di Jawa – Konversi EMF ke ODS"
head_description: "Konversi EMF ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMF ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMF ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMF ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMF hingga ODS"
    content: |
        Konversikan EMF ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
