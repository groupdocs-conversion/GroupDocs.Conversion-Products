...
############################# Head ############################
head_title: "EML to DIF Conversion in Java – Convert EML to DIF"
head_description: "Convert EML to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to DIF in few lines of code.
...
demos:
    enable: true
    title: "EML to DIF Live Demos"
    content: |
        Convert EML to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
