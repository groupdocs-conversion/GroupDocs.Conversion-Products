...
############################# Head ############################
head_title: "EML to DOT Conversion in Java – Convert EML to DOT"
head_description: "Convert EML to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to DOT in few lines of code.
