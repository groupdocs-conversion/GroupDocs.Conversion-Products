...
############################# Head ############################
head_title: "EML to MHTML Conversion in Java – Convert EML to MHTML"
head_description: "Convert EML to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "EML to MHTML Live Demos"
    content: |
        Convert EML to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
