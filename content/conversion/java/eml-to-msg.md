...
############################# Head ############################
head_title: "EML to MSG Conversion in Java – Convert EML to MSG"
head_description: "Convert EML to MSG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to MSG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to MSG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to MSG in few lines of code.
...
demos:
    enable: true
    title: "EML to MSG Live Demos"
    content: |
        Convert EML to MSG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
