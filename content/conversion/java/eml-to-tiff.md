...
############################# Head ############################
head_title: "EML to TIFF Conversion in Java – Convert EML to TIFF"
head_description: "Convert EML to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to TIFF in few lines of code.
