...
############################# Head ############################
head_title: "EML to XLSX Conversion in Java – Convert EML to XLSX"
head_description: "Convert EML to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "EML to XLSX Live Demos"
    content: |
        Convert EML to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
