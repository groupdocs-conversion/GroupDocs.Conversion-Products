...
breadcrumb: Java에서 EMLX에서 EML

############################# Head ############################
head_title: "Java에서 EMLX에서 EML로 변환기"
head_description: "몇 줄의 코드를 사용하여 Java에서 EMLX을 EML로 변환합니다. GroupDocs 문서 변환 API를 사용하여 160개 이상의 파일 형식을 변환합니다."

############################# Header ############################
title: "Java에서 EMLX을(를) EML로 변환"
description: "몇 줄의 Java 코드로 EMLX에서 EML로 변환"
...
overview:
    enable: true
    content: |
        Java에서 EMLX 파일을 EML로 쉽게 변환하세요. Windows, Linux, macOS와 같이 선택한 플랫폼에서 몇 개의 Java 코드 줄만 사용할 수 있습니다.
        무료로 EMLX에서 EML로의 변환을 시도하고 변환 결과 품질을 평가할 수 있습니다. 간단한 파일 변환 시나리오와 함께 소스 EMLX 파일을 로드하고 출력 EML 결과를 저장하기 위한 고급 옵션을 시도할 수 있습니다. 
        ...
        * 변환된 EML 파일 등에 워터마크 추가.
        ...
        변환이 완료되면 EML 파일을 로컬 파일 경로나 FTP, Amazon S3, Google Drive, Dropbox 등과 같은 타사 저장소에 저장할 수 있습니다. 참고 - EMLX을(를) EML MS Office, Open Office, Adobe Acrobat Reader 등과 같은 추가 소프트웨어를 설치할 필요가 없습니다.
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/)을 사용하면 몇 줄의 코드로 개발자가 EMLX 파일을 EML로 쉽게 변환할 수 있습니다.
...
demos:
    ...
    content: |
       지금 [GroupDocs.Conversion 앱](https://products.groupdocs.app/conversion/family) 웹사이트를 방문하여 EMLX을(를) EML로 변환하세요. 온라인 데모에는 다음과 같은 장점이 있습니다.
