...
############################# Head ############################
head_title: "Преобразование EMLX в OTT в Java — преобразование EMLX в OTT"
head_description: "Преобразуйте EMLX в OTT на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов EMLX в OTT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию EMLX в OTT в Java"
    content_left: |
