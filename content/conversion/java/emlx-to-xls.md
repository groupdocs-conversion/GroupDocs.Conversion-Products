...
############################# Head ############################
head_title: "EMLX to XLS Conversion in Java – Convert EMLX to XLS"
head_description: "Convert EMLX to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMLX Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMLX to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMLX file to XLS in few lines of code.
...
demos:
    enable: true
    title: "EMLX to XLS Live Demos"
    content: |
        Convert EMLX to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
