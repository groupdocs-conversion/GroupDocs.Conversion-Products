...
head_title: "Konversi EMLX ke XLSX di Jawa – Konversi EMLX ke XLSX"
head_description: "Konversi EMLX ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EMLX ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EMLX ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EMLX ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EMLX hingga XLSX"
    content: |
        Konversikan EMLX ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
