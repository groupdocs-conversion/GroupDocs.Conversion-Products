...
############################# Head ############################
head_title: "EPS to FODS Conversion in Java – Convert EPS to FODS"
head_description: "Convert EPS to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPS Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPS to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPS file to FODS in few lines of code.
...
demos:
    enable: true
    title: "EPS to FODS Live Demos"
    content: |
        Convert EPS to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
