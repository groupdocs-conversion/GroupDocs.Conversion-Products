...
############################# Head ############################
head_title: "EPS to ODP Conversion in Java – Convert EPS to ODP"
head_description: "Convert EPS to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPS Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPS to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPS file to ODP in few lines of code.
...
demos:
    enable: true
    title: "EPS to ODP Live Demos"
    content: |
        Convert EPS to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
