...
############################# Head ############################
head_title: "EPS to SVG Conversion in Java – Convert EPS to SVG"
head_description: "Convert EPS to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPS Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPS to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPS file to SVG in few lines of code.
...
demos:
    enable: true
    title: "EPS to SVG Live Demos"
    content: |
        Convert EPS to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
