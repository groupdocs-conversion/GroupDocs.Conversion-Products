...
head_title: "Konversi EPUB ke CSV di Jawa – Konversi EPUB ke CSV"
head_description: "Konversi EPUB ke CSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke CSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke CSV di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke CSV dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga CSV"
    content: |
        Konversikan EPUB ke CSV sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
