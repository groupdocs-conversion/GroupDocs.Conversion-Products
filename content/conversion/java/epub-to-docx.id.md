...
head_title: "Konversi EPUB ke DOCX di Jawa – Konversi EPUB ke DOCX"
head_description: "Konversi EPUB ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga DOCX"
    content: |
        Konversikan EPUB ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
