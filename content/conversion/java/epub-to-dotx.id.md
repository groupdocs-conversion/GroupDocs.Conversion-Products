...
head_title: "Konversi EPUB ke DOTX di Jawa – Konversi EPUB ke DOTX"
head_description: "Konversi EPUB ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga DOTX"
    content: |
        Konversikan EPUB ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
