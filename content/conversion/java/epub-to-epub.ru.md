...
head_description: "Преобразуйте EPUB в EPUB на Java, используя несколько строк кода. Используйте API преобразования документов GroupDocs для преобразования более 160 форматов файлов."

############################# Header ############################
title: "Преобразование EPUB в EPUB в Java"
description: "Конвертировать EPUB в EPUB с помощью нескольких строк кода Java"
...
overview:
    enable: true
    content: |
        Легко конвертируйте файлы EPUB в EPUB на Java. Вы можете использовать всего пару строк кода Java на любой платформе по вашему выбору, например - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Шаги по преобразованию EPUB в EPUB в Java"
    content_left: |
