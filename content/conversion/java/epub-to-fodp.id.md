...
head_title: "Konversi EPUB ke FODP di Jawa – Konversi EPUB ke FODP"
head_description: "Konversi EPUB ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga FODP"
    content: |
        Konversikan EPUB ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
