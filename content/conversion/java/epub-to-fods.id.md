...
head_title: "Konversi EPUB ke FODS di Jawa – Konversi EPUB ke FODS"
head_description: "Konversi EPUB ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga FODS"
    content: |
        Konversikan EPUB ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
