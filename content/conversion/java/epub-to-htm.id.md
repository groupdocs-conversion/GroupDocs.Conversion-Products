...
head_title: "Konversi EPUB ke HTM di Jawa – Konversi EPUB ke HTM"
head_description: "Konversi EPUB ke HTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke HTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke HTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke HTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga HTM"
    content: |
        Konversikan EPUB ke HTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
