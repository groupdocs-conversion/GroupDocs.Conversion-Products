...
head_title: "Konversi EPUB ke HTML di Jawa – Konversi EPUB ke HTML"
head_description: "Konversi EPUB ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga HTML"
    content: |
        Konversikan EPUB ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
