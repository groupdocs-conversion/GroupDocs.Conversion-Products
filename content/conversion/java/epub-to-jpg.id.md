...
head_title: "Konversi EPUB ke JPG di Jawa – Konversi EPUB ke JPG"
head_description: "Konversi EPUB ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke JPG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga JPG"
    content: |
        Konversikan EPUB ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
