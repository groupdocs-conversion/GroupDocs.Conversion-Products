...
head_title: "Konversi EPUB ke MD di Jawa – Konversi EPUB ke MD"
head_description: "Konversi EPUB ke MD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke MD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke MD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke MD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga MD"
    content: |
        Konversikan EPUB ke MD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
