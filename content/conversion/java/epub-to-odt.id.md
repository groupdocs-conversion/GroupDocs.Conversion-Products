...
head_title: "Konversi EPUB ke ODT di Jawa – Konversi EPUB ke ODT"
head_description: "Konversi EPUB ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga ODT"
    content: |
        Konversikan EPUB ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
