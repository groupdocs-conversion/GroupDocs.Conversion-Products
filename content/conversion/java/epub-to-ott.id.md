...
head_title: "Konversi EPUB ke OTT di Jawa – Konversi EPUB ke OTT"
head_description: "Konversi EPUB ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga OTT"
    content: |
        Konversikan EPUB ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
