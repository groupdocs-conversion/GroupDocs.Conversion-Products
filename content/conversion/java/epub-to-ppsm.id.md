...
head_title: "Konversi EPUB ke PPSM di Jawa – Konversi EPUB ke PPSM"
head_description: "Konversi EPUB ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke PPSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga PPSM"
    content: |
        Konversikan EPUB ke PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
