...
head_title: "Konversi EPUB ke PPSX di Jawa – Konversi EPUB ke PPSX"
head_description: "Konversi EPUB ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga PPSX"
    content: |
        Konversikan EPUB ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
