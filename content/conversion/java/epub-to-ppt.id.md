...
head_title: "Konversi EPUB ke PPT di Jawa – Konversi EPUB ke PPT"
head_description: "Konversi EPUB ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga PPT"
    content: |
        Konversikan EPUB ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
