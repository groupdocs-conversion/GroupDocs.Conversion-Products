...
head_title: "Konversi EPUB ke PPTX di Jawa – Konversi EPUB ke PPTX"
head_description: "Konversi EPUB ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga PPTX"
    content: |
        Konversikan EPUB ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
