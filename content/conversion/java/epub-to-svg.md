...
############################# Head ############################
head_title: "EPUB to SVG Conversion in Java – Convert EPUB to SVG"
head_description: "Convert EPUB to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPUB Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPUB to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPUB file to SVG in few lines of code.
