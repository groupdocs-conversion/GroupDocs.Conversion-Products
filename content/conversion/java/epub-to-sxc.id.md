...
head_title: "Konversi EPUB ke SXC di Jawa – Konversi EPUB ke SXC"
head_description: "Konversi EPUB ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga SXC"
    content: |
        Konversikan EPUB ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
