...
head_title: "Konversi EPUB ke XLAM di Jawa – Konversi EPUB ke XLAM"
head_description: "Konversi EPUB ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga XLAM"
    content: |
        Konversikan EPUB ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
