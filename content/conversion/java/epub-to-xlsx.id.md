...
head_title: "Konversi EPUB ke XLSX di Jawa – Konversi EPUB ke XLSX"
head_description: "Konversi EPUB ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga XLSX"
    content: |
        Konversikan EPUB ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
