...
head_title: "Konversi EPUB ke XLTX di Jawa – Konversi EPUB ke XLTX"
head_description: "Konversi EPUB ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EPUB ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EPUB ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EPUB ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EPUB hingga XLTX"
    content: |
        Konversikan EPUB ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
