...
############################# Head ############################
head_title: "EXCEL to DOCM Conversion in Java – Convert EXCEL to DOCM"
head_description: "Convert EXCEL to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EXCEL Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EXCEL to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EXCEL file to DOCM in few lines of code.
