...
############################# Head ############################
head_title: "EXCEL to EMF Conversion in Java – Convert EXCEL to EMF"
head_description: "Convert EXCEL to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EXCEL Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EXCEL to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EXCEL file to EMF in few lines of code.
...
demos:
    enable: true
    title: "EXCEL to EMF Live Demos"
    content: |
        Convert EXCEL to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
