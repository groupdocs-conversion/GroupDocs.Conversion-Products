...
############################# Head ############################
head_title: "Преобразование EXCEL в EMZ в Java - Преобразование EXCEL в EMZ"
head_description: "Преобразование EXCEL в EMZ на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов EXCEL в EMZ в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования EXCEL в EMZ в Java"
    content_left: |
...
demos:
    enable: true
    title: "Презентация EXCEL для EMZ Живые демонстрации"
    content: |
