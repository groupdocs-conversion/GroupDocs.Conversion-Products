...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) упрощает для разработчиков преобразование файла EXCEL в формат EXCEL с помощью нескольких строк кода.
...
more_formats:
    ...
    format: 
        # format loop
        - name: "EXCEL в EPUB"
          link: "/conversion/java/excel-to-epub/"
        ...
        # format loop
        - name: "EXCEL в EXCEL"
          link: "/conversion/java/excel-to-excel/"
