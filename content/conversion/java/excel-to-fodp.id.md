...
head_title: "Konversi EXCEL ke FODP di Jawa – Konversi EXCEL ke FODP"
head_description: "Konversi EXCEL ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EXCEL ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EXCEL ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EXCEL ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EXCEL hingga FODP"
    content: |
        Konversikan EXCEL ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
