...
head_title: "Konversi EXCEL ke FODS di Jawa – Konversi EXCEL ke FODS"
head_description: "Konversi EXCEL ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EXCEL ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EXCEL ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EXCEL ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EXCEL hingga FODS"
    content: |
        Konversikan EXCEL ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
