...
head_title: "Konversi EXCEL ke ODS di Jawa – Konversi EXCEL ke ODS"
head_description: "Konversi EXCEL ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EXCEL ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EXCEL ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EXCEL ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EXCEL hingga ODS"
    content: |
        Konversikan EXCEL ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
