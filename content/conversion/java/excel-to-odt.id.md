...
head_title: "Konversi EXCEL ke ODT di Jawa – Konversi EXCEL ke ODT"
head_description: "Konversi EXCEL ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EXCEL ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EXCEL ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EXCEL ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EXCEL hingga ODT"
    content: |
        Konversikan EXCEL ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
