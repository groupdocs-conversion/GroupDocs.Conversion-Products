...
head_title: "Konversi EXCEL ke PPTM di Jawa – Konversi EXCEL ke PPTM"
head_description: "Konversi EXCEL ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EXCEL ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EXCEL ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EXCEL ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EXCEL hingga PPTM"
    content: |
        Konversikan EXCEL ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
