...
head_title: "Konversi EXCEL ke SXC di Jawa – Konversi EXCEL ke SXC"
head_description: "Konversi EXCEL ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EXCEL ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EXCEL ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EXCEL ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EXCEL hingga SXC"
    content: |
        Konversikan EXCEL ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
