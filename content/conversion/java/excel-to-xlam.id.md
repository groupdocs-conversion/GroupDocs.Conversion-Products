...
head_title: "Konversi EXCEL ke XLAM di Jawa – Konversi EXCEL ke XLAM"
head_description: "Konversi EXCEL ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File EXCEL ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi EXCEL ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file EXCEL ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung EXCEL hingga XLAM"
    content: |
        Konversikan EXCEL ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
