...
############################# Head ############################
head_title: "Преобразование EXCEL в XLAM в Java — Преобразование EXCEL в XLAM"
head_description: "Преобразование EXCEL в XLAM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов EXCEL в XLAM в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования EXCEL в XLAM в Java"
    content_left: |
...
demos:
    enable: true
    title: "Преобразование EXCEL в XLAM Живые демонстрации"
    content: |
