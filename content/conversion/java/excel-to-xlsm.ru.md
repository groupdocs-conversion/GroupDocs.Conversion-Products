...
############################# Head ############################
head_title: "Преобразование EXCEL в XLSM в Java — Преобразование EXCEL в XLSM"
head_description: "Преобразование EXCEL в XLSM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов EXCEL в XLSM в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования EXCEL в XLSM в Java"
    content_left: |
...
demos:
    enable: true
    title: "Преобразование EXCEL в XLSM Живые демонстрации"
    content: |
