...
############################# Head ############################
head_title: "EXCEL to XPS Conversion in Java – Convert EXCEL to XPS"
head_description: "Convert EXCEL to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EXCEL Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EXCEL to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EXCEL file to XPS in few lines of code.
...
demos:
    enable: true
    title: "EXCEL to XPS Live Demos"
    content: |
        Convert EXCEL to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
