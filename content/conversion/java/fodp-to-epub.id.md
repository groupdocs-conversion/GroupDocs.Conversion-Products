...
breadcrumb: FODP ke EPUB di Java

############################# Head ############################
head_title: "Konversi FODP ke EPUB di Java"
head_description: "Konversi FODP ke EPUB di Java dengan beberapa baris kode. Konversi lebih dari 160 format file menggunakan API konversi dokumen GroupDocs untuk Java"

############################# Header ############################
title: "Konversi FODP ke EPUB di Java"
description: "Konversi FODP ke EPUB dengan beberapa baris kode Java"
...
overview:
    enable: true
    content: |
        Konversikan file FODP Anda menjadi EPUB di Java. Hanya membutuhkan beberapa baris kode Java pada platform pilihan Anda, seperti Windows, Linux, macOS.
        Anda dapat mencoba mengonversi FODP ke EPUB secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skrip konversi file sederhana, Anda dapat mencoba opsi yang lebih canggih untuk memuat file sumber FODP dan menyimpan output EPUB. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi FODP ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) memungkinkan pengembang untuk dengan mudah mengonversi file FODP ke EPUB dengan beberapa baris kode.
...
demos:
    ...
    content: |
       Kunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) kami dan coba konversi FODP ke EPUB sekarang. Demo gratis memiliki manfaat sebagai berikut
