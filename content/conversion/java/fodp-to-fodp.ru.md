...
############################# Head ############################
head_title: "Преобразование FODP в FODP в Java — преобразование FODP в FODP"
head_description: "Преобразование FODP в FODP на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов FODP в FODP в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования FODP в FODP в Java"
    content_left: |
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "FODP в FODP"
          link: "/conversion/java/fodp-to-fodp/"
