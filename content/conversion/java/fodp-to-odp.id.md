...
head_title: "Konversi FODP ke ODP di Jawa – Konversi FODP ke ODP"
head_description: "Konversi FODP ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODP ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODP ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODP ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODP hingga ODP"
    content: |
        Konversikan FODP ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
