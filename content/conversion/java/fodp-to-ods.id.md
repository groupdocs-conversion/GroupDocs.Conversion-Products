...
head_title: "Konversi FODP ke ODS di Jawa – Konversi FODP ke ODS"
head_description: "Konversi FODP ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODP ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODP ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODP ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODP hingga ODS"
    content: |
        Konversikan FODP ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
