...
head_title: "Konversi FODP ke SVG di Jawa – Konversi FODP ke SVG"
head_description: "Konversi FODP ke SVG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODP ke SVG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODP ke SVG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODP ke SVG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODP hingga SVG"
    content: |
        Konversikan FODP ke SVG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
