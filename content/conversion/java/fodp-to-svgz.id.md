...
head_title: "Konversi FODP ke SVGZ di Jawa – Konversi FODP ke SVGZ"
head_description: "Konversi FODP ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODP ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODP ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODP ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODP hingga SVGZ"
    content: |
        Konversikan FODP ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
