...
head_title: "Konversi FODP ke SXC di Jawa – Konversi FODP ke SXC"
head_description: "Konversi FODP ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODP ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODP ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODP ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODP hingga SXC"
    content: |
        Konversikan FODP ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
