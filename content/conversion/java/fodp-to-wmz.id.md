...
head_title: "Konversi FODP ke WMZ di Jawa – Konversi FODP ke WMZ"
head_description: "Konversi FODP ke WMZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODP ke WMZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODP ke WMZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODP ke WMZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODP hingga WMZ"
    content: |
        Konversikan FODP ke WMZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
