...
############################# Head ############################
head_title: "FODP to WMZ Conversion in Java – Convert FODP to WMZ"
head_description: "Convert FODP to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODP Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODP to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODP file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "FODP to WMZ Live Demos"
    content: |
        Convert FODP to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
