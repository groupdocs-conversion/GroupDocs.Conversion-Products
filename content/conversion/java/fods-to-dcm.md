...
############################# Head ############################
head_title: "FODS to DCM Conversion in Java – Convert FODS to DCM"
head_description: "Convert FODS to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to DCM in few lines of code.
...
demos:
    enable: true
    title: "FODS to DCM Live Demos"
    content: |
        Convert FODS to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
