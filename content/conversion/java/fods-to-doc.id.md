...
head_title: "Konversi FODS ke DOC di Jawa – Konversi FODS ke DOC"
head_description: "Konversi FODS ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODS ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODS ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODS ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODS hingga DOC"
    content: |
        Konversikan FODS ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
