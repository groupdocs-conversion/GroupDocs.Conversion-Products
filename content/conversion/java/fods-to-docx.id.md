...
head_title: "Konversi FODS ke DOCX di Jawa – Konversi FODS ke DOCX"
head_description: "Konversi FODS ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODS ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODS ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODS ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODS hingga DOCX"
    content: |
        Konversikan FODS ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
