...
############################# Head ############################
head_title: "Преобразование FODS в FODS в Java — преобразование FODS в FODS"
head_description: "Преобразование FODS в FODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов FODS в FODS на Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования FODS в FODS в Java"
    content_left: |
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "FODS к FODS"
          link: "/conversion/java/fods-to-fods/"
