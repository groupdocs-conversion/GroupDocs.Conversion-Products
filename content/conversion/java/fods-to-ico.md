...
############################# Head ############################
head_title: "FODS to ICO Conversion in Java – Convert FODS to ICO"
head_description: "Convert FODS to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to ICO in few lines of code.
...
demos:
    enable: true
    title: "FODS to ICO Live Demos"
    content: |
        Convert FODS to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
