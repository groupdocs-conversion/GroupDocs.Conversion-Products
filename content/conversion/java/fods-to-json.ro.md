...
breadcrumb: FODS la JSON în Java

############################# Head ############################
head_title: "Convertiți FODS în JSON în Java"
head_description: "Conversie FODS în JSON în Java cu câteva rânduri de cod. Convertiți peste 160 de formate de fișiere folosind API-ul de conversie a documentelor GroupDocs pentru Java"

############################# Header ############################
title: "Convertiți FODS în JSON în Java"
description: "Conversie FODS în JSON cu câteva rânduri de cod Java"
...
overview:
    enable: true
    content: |
        Convertiți fișierele dvs. FODS în JSON în Java. Este nevoie de doar câteva linii de cod Java pe orice platformă la alegere, cum ar fi Windows, Linux, macOS.
        Puteți încerca să convertiți gratuit FODS în JSON și să evaluați calitatea rezultatelor conversiei. Împreună cu scripturile simple de conversie a fișierelor, puteți încerca opțiuni mai sofisticate pentru încărcarea fișierului sursă FODS și stocarea rezultatului JSON. 
        ...
        * adăugați un filigran la JSON convertit.
        ...
        Odată ce conversia este finalizată, puteți salva fișierul JSON în calea fișierului local sau în orice spațiu de stocare terță parte, cum ar fi FTP, Amazon S3, Google Drive, Dropbox etc. Rețineți - pentru a converti FODS la JSON, nu trebuie să instalați niciun software suplimentar, cum ar fi MS Office, Open Office, Adobe Acrobat Reader etc.


############################# Steps ############################
steps:
    enable: true
    title_left: "Pași pentru a converti FODS în JSON în Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) permite dezvoltatorilor să convertească cu ușurință fișierul FODS în JSON cu câteva linii de cod.
...
demos:
    enable: true
    title: "De la FODS la JSON Demo live"
    content: |
       Accesați site-ul nostru [Aplicația GroupDocs.Conversion](https://products.groupdocs.app/conversion/family) și încercați acum conversia FODS în JSON. Demo-ul gratuit are următoarele beneficii
