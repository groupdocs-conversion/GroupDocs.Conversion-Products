...
############################# Head ############################
head_title: "FODS to MHTML Conversion in Java – Convert FODS to MHTML"
head_description: "Convert FODS to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "FODS to MHTML Live Demos"
    content: |
        Convert FODS to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
