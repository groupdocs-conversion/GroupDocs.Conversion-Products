...
head_title: "Konversi FODS ke ODP di Jawa – Konversi FODS ke ODP"
head_description: "Konversi FODS ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODS ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODS ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODS ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODS hingga ODP"
    content: |
        Konversikan FODS ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
