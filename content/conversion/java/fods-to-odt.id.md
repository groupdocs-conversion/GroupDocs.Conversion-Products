...
head_title: "Konversi FODS ke ODT di Jawa – Konversi FODS ke ODT"
head_description: "Konversi FODS ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODS ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODS ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODS ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODS hingga ODT"
    content: |
        Konversikan FODS ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
