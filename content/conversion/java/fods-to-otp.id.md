...
head_title: "Konversi FODS ke OTP di Jawa – Konversi FODS ke OTP"
head_description: "Konversi FODS ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODS ke OTP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODS ke OTP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODS ke OTP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODS hingga OTP"
    content: |
        Konversikan FODS ke OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
