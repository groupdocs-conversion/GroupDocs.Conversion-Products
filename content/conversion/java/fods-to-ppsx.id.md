...
head_title: "Konversi FODS ke PPSX di Jawa – Konversi FODS ke PPSX"
head_description: "Konversi FODS ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODS ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODS ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODS ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODS hingga PPSX"
    content: |
        Konversikan FODS ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
