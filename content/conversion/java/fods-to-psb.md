...
breadcrumb: FODS to PSB in Java

############################# Head ############################
head_title: "FODS to PSB Converter in Java"
head_description: "Convert FODS to PSB in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert FODS to PSB in Java"
description: "FODS to PSB conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your FODS files to PSB in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert FODS to PSB in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a FODS file to PSB with a few lines of code.
