...
############################# Head ############################
head_title: "FODS to PSD Conversion in Java – Convert FODS to PSD"
head_description: "Convert FODS to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to PSD in few lines of code.
...
demos:
    enable: true
    title: "FODS to PSD Live Demos"
    content: |
        Convert FODS to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
