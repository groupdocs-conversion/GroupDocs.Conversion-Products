...
head_title: "Konversi FODS ke SVGZ di Jawa – Konversi FODS ke SVGZ"
head_description: "Konversi FODS ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File FODS ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi FODS ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file FODS ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung FODS hingga SVGZ"
    content: |
        Konversikan FODS ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
