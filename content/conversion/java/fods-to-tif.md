...
############################# Head ############################
head_title: "FODS to TIF Conversion in Java – Convert FODS to TIF"
head_description: "Convert FODS to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to TIF in few lines of code.
...
demos:
    enable: true
    title: "FODS to TIF Live Demos"
    content: |
        Convert FODS to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
