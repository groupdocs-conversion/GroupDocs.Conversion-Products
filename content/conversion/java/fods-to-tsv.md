...
############################# Head ############################
head_title: "FODS to TSV Conversion in Java – Convert FODS to TSV"
head_description: "Convert FODS to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to TSV in few lines of code.
...
demos:
    enable: true
    title: "FODS to TSV Live Demos"
    content: |
        Convert FODS to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
