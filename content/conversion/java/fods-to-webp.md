...
############################# Head ############################
head_title: "FODS to WEBP Conversion in Java – Convert FODS to WEBP"
head_description: "Convert FODS to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "FODS to WEBP Live Demos"
    content: |
        Convert FODS to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
