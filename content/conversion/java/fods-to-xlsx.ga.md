...
breadcrumb: FODS go XLSX in Java

############################# Head ############################
head_title: "Tiontaigh FODS go XLSX in Java"
head_description: "FODS go XLSX tiontú in Java le cúpla líne de chód. Tiontaigh níos mó ná 160 formáid comhaid ag baint úsáid as an API tiontaithe doiciméad GroupDocs le haghaidh Java"

############################# Header ############################
title: "Tiontaigh FODS go XLSX in Java"
description: "FODS go XLSX tiontú le cúpla líne de chód Java"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid FODS go XLSX in Java. Ní thógann sé ach cúpla líne de chód Java ar aon ardán de do rogha féin, ar nós Windows, Linux, macOS.
        Is féidir leat triail a bhaint as FODS a thiontú go XLSX saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le scripteanna simplí comhshó comhad, is féidir leat triail a bhaint as roghanna níos sofaisticiúla chun an comhad foinse FODS a luchtú agus an t-aschur XLSX a stóráil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun FODS a thiontú go XLSX in Java"
    content_left: |
        Ceadaíonn [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) d'fhorbróirí comhad FODS a thiontú go XLSX go héasca le cúpla líne de chód.
...
demos:
    enable: true
    title: "FODS go XLSX Taispeántas Beo"
    content: |
       Tabhair cuairt ar ár suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) agus bain triail as FODS go XLSX tiontú anois. Tá na buntáistí seo a leanas ag an taispeántas saor in aisce
