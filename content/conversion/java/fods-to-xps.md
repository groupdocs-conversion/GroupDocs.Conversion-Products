...
############################# Head ############################
head_title: "FODS to XPS Conversion in Java – Convert FODS to XPS"
head_description: "Convert FODS to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to XPS in few lines of code.
...
demos:
    enable: true
    title: "FODS to XPS Live Demos"
    content: |
        Convert FODS to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
