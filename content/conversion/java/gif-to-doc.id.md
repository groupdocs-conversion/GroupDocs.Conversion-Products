...
head_title: "Konversi GIF ke DOC di Jawa – Konversi GIF ke DOC"
head_description: "Konversi GIF ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga DOC"
    content: |
        Konversikan GIF ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
