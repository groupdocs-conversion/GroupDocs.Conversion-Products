...
head_title: "Konversi GIF ke HTML di Jawa – Konversi GIF ke HTML"
head_description: "Konversi GIF ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga HTML"
    content: |
        Konversikan GIF ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
