...
head_title: "Konversi GIF ke ODP di Jawa – Konversi GIF ke ODP"
head_description: "Konversi GIF ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga ODP"
    content: |
        Konversikan GIF ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
