...
head_title: "Konversi GIF ke ODT di Jawa – Konversi GIF ke ODT"
head_description: "Konversi GIF ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga ODT"
    content: |
        Konversikan GIF ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
