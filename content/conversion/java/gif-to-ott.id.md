...
head_title: "Konversi GIF ke OTT di Jawa – Konversi GIF ke OTT"
head_description: "Konversi GIF ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga OTT"
    content: |
        Konversikan GIF ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
