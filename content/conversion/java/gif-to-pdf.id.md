...
head_title: "Konversi GIF ke PDF di Jawa – Konversi GIF ke PDF"
head_description: "Konversi GIF ke PDF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke PDF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke PDF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke PDF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga PDF"
    content: |
        Konversikan GIF ke PDF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
