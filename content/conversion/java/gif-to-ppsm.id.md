...
head_title: "Konversi GIF ke PPSM di Jawa – Konversi GIF ke PPSM"
head_description: "Konversi GIF ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke PPSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga PPSM"
    content: |
        Konversikan GIF ke PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
