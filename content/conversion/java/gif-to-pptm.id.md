...
head_title: "Konversi GIF ke PPTM di Jawa – Konversi GIF ke PPTM"
head_description: "Konversi GIF ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga PPTM"
    content: |
        Konversikan GIF ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
