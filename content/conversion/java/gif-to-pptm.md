...
############################# Head ############################
head_title: "GIF to PPTM Conversion in Java – Convert GIF to PPTM"
head_description: "Convert GIF to PPTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert GIF Files to PPTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting GIF to PPTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the GIF file to PPTM in few lines of code.
...
demos:
    enable: true
    title: "GIF to PPTM Live Demos"
    content: |
        Convert GIF to PPTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
