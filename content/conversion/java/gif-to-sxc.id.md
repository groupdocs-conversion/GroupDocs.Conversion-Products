...
head_title: "Konversi GIF ke SXC di Jawa – Konversi GIF ke SXC"
head_description: "Konversi GIF ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga SXC"
    content: |
        Konversikan GIF ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
