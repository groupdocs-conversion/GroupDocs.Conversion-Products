...
head_title: "Konversi GIF ke WEBP di Jawa – Konversi GIF ke WEBP"
head_description: "Konversi GIF ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke WEBP di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga WEBP"
    content: |
        Konversikan GIF ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
