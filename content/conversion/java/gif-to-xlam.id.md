...
head_title: "Konversi GIF ke XLAM di Jawa – Konversi GIF ke XLAM"
head_description: "Konversi GIF ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga XLAM"
    content: |
        Konversikan GIF ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
