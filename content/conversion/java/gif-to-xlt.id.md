...
head_title: "Konversi GIF ke XLT di Jawa – Konversi GIF ke XLT"
head_description: "Konversi GIF ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga XLT"
    content: |
        Konversikan GIF ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
