...
head_title: "Konversi GIF ke XPS di Jawa – Konversi GIF ke XPS"
head_description: "Konversi GIF ke XPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File GIF ke XPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi GIF ke XPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file GIF ke XPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung GIF hingga XPS"
    content: |
        Konversikan GIF ke XPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
