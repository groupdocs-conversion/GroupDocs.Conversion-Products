...
head_title: "Konversi HTM ke DCM di Jawa – Konversi HTM ke DCM"
head_description: "Konversi HTM ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga DCM"
    content: |
        Konversikan HTM ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
