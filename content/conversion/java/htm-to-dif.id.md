...
head_title: "Konversi HTM ke DIF di Jawa – Konversi HTM ke DIF"
head_description: "Konversi HTM ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga DIF"
    content: |
        Konversikan HTM ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
