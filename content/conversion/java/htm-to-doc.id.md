...
head_title: "Konversi HTM ke DOC di Jawa – Konversi HTM ke DOC"
head_description: "Konversi HTM ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke DOC di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga DOC"
    content: |
        Konversikan HTM ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
