...
head_title: "Konversi HTM ke DOTX di Jawa – Konversi HTM ke DOTX"
head_description: "Konversi HTM ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke DOTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga DOTX"
    content: |
        Konversikan HTM ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
