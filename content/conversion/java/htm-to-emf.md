...
############################# Head ############################
head_title: "HTM to EMF Conversion in Java – Convert HTM to EMF"
head_description: "Convert HTM to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to EMF in few lines of code.
...
demos:
    enable: true
    title: "HTM to EMF Live Demos"
    content: |
        Convert HTM to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
