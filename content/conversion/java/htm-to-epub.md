...
############################# Head ############################
head_title: "HTM to EPUB Conversion in Java – Convert HTM to EPUB"
head_description: "Convert HTM to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "HTM to EPUB Live Demos"
    content: |
        Convert HTM to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
