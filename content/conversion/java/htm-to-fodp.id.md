...
head_title: "Konversi HTM ke FODP di Jawa – Konversi HTM ke FODP"
head_description: "Konversi HTM ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga FODP"
    content: |
        Konversikan HTM ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
