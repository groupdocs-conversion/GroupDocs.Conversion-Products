...
head_title: "Konversi HTM ke FODS di Jawa – Konversi HTM ke FODS"
head_description: "Konversi HTM ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga FODS"
    content: |
        Konversikan HTM ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
