...
head_title: "Konversi HTM ke HTML di Jawa – Konversi HTM ke HTML"
head_description: "Konversi HTM ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga HTML"
    content: |
        Konversikan HTM ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
