...
############################# Head ############################
head_title: "HTM to JPG Conversion in Java – Convert HTM to JPG"
head_description: "Convert HTM to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to JPG in few lines of code.
...
demos:
    enable: true
    title: "HTM to JPG Live Demos"
    content: |
        Convert HTM to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
