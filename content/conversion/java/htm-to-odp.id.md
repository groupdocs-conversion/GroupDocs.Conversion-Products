...
head_title: "Konversi HTM ke ODP di Jawa – Konversi HTM ke ODP"
head_description: "Konversi HTM ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga ODP"
    content: |
        Konversikan HTM ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
