...
head_title: "Konversi HTM ke ODS di Jawa – Konversi HTM ke ODS"
head_description: "Konversi HTM ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga ODS"
    content: |
        Konversikan HTM ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
