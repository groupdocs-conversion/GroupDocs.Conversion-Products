...
############################# Head ############################
head_title: "HTM to ODT Conversion in Java – Convert HTM to ODT"
head_description: "Convert HTM to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to ODT in few lines of code.
...
demos:
    enable: true
    title: "HTM to ODT Live Demos"
    content: |
        Convert HTM to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
