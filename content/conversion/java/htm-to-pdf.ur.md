...
breadcrumb: Java میں HTM سے PDF

############################# Head ############################
head_title: "{{PROgLang}} میں HTM کو PDF میں تبدیل کریں"
head_description: "کوڈ کی چند سطروں کے ساتھ Java میں HTM سے PDF کی تبدیلی۔ Java کے لیے GroupDocs دستاویز کنورژن API کا استعمال کرتے ہوئے 160 سے زیادہ فائل فارمیٹس میں تبدیل کریں"

############################# Header ############################
title: "{{PROgLang}} میں HTM کو PDF میں تبدیل کریں"
description: "HTM سے PDF کی تبدیلی Java کوڈ کی چند سطروں کے ساتھ"
...
overview:
    enable: true
    content: |
        اپنی HTM فائلوں کو Java میں PDF میں تبدیل کریں۔ یہ آپ کی پسند کے کسی بھی پلیٹ فارم، جیسے کہ Windows، Linux، macOS پر Java کوڈ کی صرف دو لائنیں لیتا ہے۔
        آپ مفت میں HTM کو PDF میں تبدیل کرنے کی کوشش کر سکتے ہیں اور تبدیلی کے نتائج کے معیار کا جائزہ لے سکتے ہیں۔ سادہ فائل کنورژن سکرپٹ کے ساتھ، آپ HTM سورس فائل کو لوڈ کرنے اور PDF آؤٹ پٹ کو اسٹور کرنے کے لیے مزید نفیس اختیارات آزما سکتے ہیں۔ 
        ...
        * تبدیل شدہ PDF میں واٹر مارک شامل کریں.
        ...
        تبدیلی مکمل ہونے کے بعد، آپ PDF فائل کو اپنے مقامی فائل پاتھ میں یا کسی تیسرے فریق اسٹوریج جیسے FTP، Amazon S3، Google Drive، Dropbox وغیرہ میں محفوظ کر سکتے ہیں۔ براہ کرم نوٹ کریں - HTM کو تبدیل کرنے کے لیے PDF تک، آپ کو کوئی اضافی سافٹ ویئر انسٹال کرنے کی ضرورت نہیں ہے، جیسے MS Office، Open Office، Adobe Acrobat Reader وغیرہ۔
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) ڈویلپرز کو کوڈ کی چند سطروں کے ساتھ آسانی سے HTM فائل کو PDF میں تبدیل کرنے کی اجازت دیتا ہے۔
...
demos:
    ...
    content: |
       ہماری [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) ویب سائٹ پر جائیں اور ابھی HTM سے PDF کی تبدیلی آزمائیں۔ مفت ڈیمو کے درج ذیل فوائد ہیں۔
