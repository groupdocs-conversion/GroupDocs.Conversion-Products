...
############################# Head ############################
head_title: "HTM to POT Conversion in Java – Convert HTM to POT"
head_description: "Convert HTM to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to POT in few lines of code.
...
demos:
    enable: true
    title: "HTM to POT Live Demos"
    content: |
        Convert HTM to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
