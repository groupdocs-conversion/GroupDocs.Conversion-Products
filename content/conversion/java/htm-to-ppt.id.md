...
head_title: "Konversi HTM ke PPT di Jawa – Konversi HTM ke PPT"
head_description: "Konversi HTM ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga PPT"
    content: |
        Konversikan HTM ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
