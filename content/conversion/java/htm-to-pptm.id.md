...
head_title: "Konversi HTM ke PPTM di Jawa – Konversi HTM ke PPTM"
head_description: "Konversi HTM ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga PPTM"
    content: |
        Konversikan HTM ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
