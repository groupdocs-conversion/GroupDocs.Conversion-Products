...
head_title: "Konversi HTM ke PPTX di Jawa – Konversi HTM ke PPTX"
head_description: "Konversi HTM ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga PPTX"
    content: |
        Konversikan HTM ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
