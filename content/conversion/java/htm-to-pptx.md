...
############################# Head ############################
head_title: "HTM to PPTX Conversion in Java – Convert HTM to PPTX"
head_description: "Convert HTM to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "HTM to PPTX Live Demos"
    content: |
        Convert HTM to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
