...
############################# Head ############################
head_title: "HTM to SVG Conversion in Java – Convert HTM to SVG"
head_description: "Convert HTM to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to SVG in few lines of code.
...
demos:
    enable: true
    title: "HTM to SVG Live Demos"
    content: |
        Convert HTM to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
