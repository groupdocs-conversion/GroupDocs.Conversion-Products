...
head_title: "Konversi HTM ke SVGZ di Jawa – Konversi HTM ke SVGZ"
head_description: "Konversi HTM ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga SVGZ"
    content: |
        Konversikan HTM ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
