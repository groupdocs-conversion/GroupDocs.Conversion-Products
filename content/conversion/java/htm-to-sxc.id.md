...
head_title: "Konversi HTM ke SXC di Jawa – Konversi HTM ke SXC"
head_description: "Konversi HTM ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga SXC"
    content: |
        Konversikan HTM ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
