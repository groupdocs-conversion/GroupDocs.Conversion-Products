...
############################# Head ############################
head_title: "HTM to TXT Conversion in Java – Convert HTM to TXT"
head_description: "Convert HTM to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to TXT in few lines of code.
...
demos:
    enable: true
    title: "HTM to TXT Live Demos"
    content: |
        Convert HTM to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
