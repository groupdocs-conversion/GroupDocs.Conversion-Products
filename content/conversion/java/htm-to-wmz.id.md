...
head_title: "Konversi HTM ke WMZ di Jawa – Konversi HTM ke WMZ"
head_description: "Konversi HTM ke WMZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke WMZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke WMZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke WMZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga WMZ"
    content: |
        Konversikan HTM ke WMZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
