...
############################# Head ############################
head_title: "HTM to WMZ Conversion in Java – Convert HTM to WMZ"
head_description: "Convert HTM to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "HTM to WMZ Live Demos"
    content: |
        Convert HTM to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
