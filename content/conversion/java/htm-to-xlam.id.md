...
head_title: "Konversi HTM ke XLAM di Jawa – Konversi HTM ke XLAM"
head_description: "Konversi HTM ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTM ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTM ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTM ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTM hingga XLAM"
    content: |
        Konversikan HTM ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
