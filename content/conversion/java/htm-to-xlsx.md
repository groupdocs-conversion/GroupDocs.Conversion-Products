...
############################# Head ############################
head_title: "HTM to XLSX Conversion in Java – Convert HTM to XLSX"
head_description: "Convert HTM to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "HTM to XLSX Live Demos"
    content: |
        Convert HTM to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
