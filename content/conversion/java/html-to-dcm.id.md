...
head_title: "Konversi HTML ke DCM di Jawa – Konversi HTML ke DCM"
head_description: "Konversi HTML ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga DCM"
    content: |
        Konversikan HTML ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
