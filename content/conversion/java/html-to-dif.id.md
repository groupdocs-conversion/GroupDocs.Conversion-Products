...
head_title: "Konversi HTML ke DIF di Jawa – Konversi HTML ke DIF"
head_description: "Konversi HTML ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga DIF"
    content: |
        Konversikan HTML ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
