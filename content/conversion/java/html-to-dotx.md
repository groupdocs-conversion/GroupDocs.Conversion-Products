...
############################# Head ############################
head_title: "HTML to DOTX Conversion in Java – Convert HTML to DOTX"
head_description: "Convert HTML to DOTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to DOTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to DOTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to DOTX in few lines of code.
...
demos:
    enable: true
    title: "HTML to DOTX Live Demos"
    content: |
        Convert HTML to DOTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
