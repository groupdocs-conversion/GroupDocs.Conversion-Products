...
head_title: "Konversi HTML ke EMF di Jawa – Konversi HTML ke EMF"
head_description: "Konversi HTML ke EMF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke EMF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke EMF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke EMF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga EMF"
    content: |
        Konversikan HTML ke EMF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
