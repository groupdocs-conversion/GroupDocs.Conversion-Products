...
############################# Head #############################
head_title: "API de conversão de HTML para EMF em Java - transforme HTML em aplicativos Java"
head_description: "Veja arquivos HTML para EMF em aplicativos Java, J2EE, J2SE. Suporta visualização de mais de 180 formatos de arquivo de documentos e imagens em modo HTML, PDF ou imagem com recursos avançados para gerenciar opções de visualização de documentos."

############################# Header ############################
title: "Converter HTML para EMF em Java" 
description: "Experimente a eficiência de uma API de conversão de arquivos HTML para EMF nativa e de alto desempenho projetada para aplicativos Java, J2EE e J2SE. Aproveite o suporte a um extenso conjunto de recursos adicionais, permitindo a personalização da aparência do documento de saída." 
...
steps:
    enable: true
    title: "Passos para converter arquivo HTML para EMF em Java" 
    content: |
      Transformar HTML para EMF é simples com <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requerendo apenas alguns passos simples.
