...
head_title: "Konversi HTML ke FODP di Jawa – Konversi HTML ke FODP"
head_description: "Konversi HTML ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga FODP"
    content: |
        Konversikan HTML ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
