...
############################# Head ############################
head_title: "HTML to FODP Conversion in Java – Convert HTML to FODP"
head_description: "Convert HTML to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to FODP in few lines of code.
...
demos:
    enable: true
    title: "HTML to FODP Live Demos"
    content: |
        Convert HTML to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
