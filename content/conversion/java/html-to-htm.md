...
############################# Head ############################
head_title: "HTML to HTM Conversion in Java – Convert HTML to HTM"
head_description: "Convert HTML to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to HTM in few lines of code.
...
demos:
    enable: true
    title: "HTML to HTM Live Demos"
    content: |
        Convert HTML to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
