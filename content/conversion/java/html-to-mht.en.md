...
############################# Head #############################
head_title: "Java HTML to MHT Converter API - transform HTML to MHT in Java apps"
head_description: "View HTML to MHT files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert HTML to MHT in Java" 
description: "Experience the efficiency of a native, high-performance HTML to MHT file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert HTML to MHT file in Java" 
    content: |
      Transforming HTML to MHT is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // Convert HTML to MHT file        
        ```            
