...
############################# Head ############################
head_title: "HTML to MHT Conversion in Java – Convert HTML to MHT"
head_description: "Convert HTML to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to MHT in few lines of code.
...
demos:
    enable: true
    title: "HTML to MHT Live Demos"
    content: |
        Convert HTML to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
