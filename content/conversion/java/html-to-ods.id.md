...
head_title: "Konversi HTML ke ODS di Jawa – Konversi HTML ke ODS"
head_description: "Konversi HTML ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga ODS"
    content: |
        Konversikan HTML ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
