...
head_title: "Konversi HTML ke ODT di Jawa – Konversi HTML ke ODT"
head_description: "Konversi HTML ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke ODT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga ODT"
    content: |
        Konversikan HTML ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
