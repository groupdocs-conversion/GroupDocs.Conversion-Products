...
head_title: "Konversi HTML ke POTM di Jawa – Konversi HTML ke POTM"
head_description: "Konversi HTML ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke POTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga POTM"
    content: |
        Konversikan HTML ke POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
