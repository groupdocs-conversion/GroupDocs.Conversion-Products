...
head_title: "Konversi HTML ke POTX di Jawa – Konversi HTML ke POTX"
head_description: "Konversi HTML ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga POTX"
    content: |
        Konversikan HTML ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
