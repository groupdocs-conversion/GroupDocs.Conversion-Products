...
head_title: "Konversi HTML ke PPS di Jawa – Konversi HTML ke PPS"
head_description: "Konversi HTML ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga PPS"
    content: |
        Konversikan HTML ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
