...
head_title: "Konversi HTML ke PPT di Jawa – Konversi HTML ke PPT"
head_description: "Konversi HTML ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga PPT"
    content: |
        Konversikan HTML ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
