...
############################# Head ############################
head_title: "HTML to PPT Conversion in Java – Convert HTML to PPT"
head_description: "Convert HTML to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to PPT in few lines of code.
...
demos:
    enable: true
    title: "HTML to PPT Live Demos"
    content: |
        Convert HTML to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
