...
head_title: "Konversi HTML ke SVGZ di Jawa – Konversi HTML ke SVGZ"
head_description: "Konversi HTML ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga SVGZ"
    content: |
        Konversikan HTML ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
