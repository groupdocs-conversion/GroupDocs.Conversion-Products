...
head_title: "Konversi HTML ke SXC di Jawa – Konversi HTML ke SXC"
head_description: "Konversi HTML ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga SXC"
    content: |
        Konversikan HTML ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
