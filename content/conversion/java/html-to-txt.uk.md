...
############################# Head #############################
head_title: "Java API конвертування HTML у TXT - перетворити у додатках Java"
...
############################# Header ############################
title: "Перетворити HTML у TXT в Java" 
description: "Випробуйте ефективність нативного, високопродуктивного API конвертування файлів HTML у TXT для застосунків Java, J2EE та J2SE. Насолоджуйтеся підтримкою ряду додаткових функцій, які дозволяють налаштувати вигляд вихідного документа." 
...
steps:
    enable: true
    title: "Кроки для конвертації файлу HTML у файл TXT у Java" 
    content: |
      Перетворення HTML у TXT стає простим з допомогою <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, потрібно лише декілька простих кроків.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Конвертування файлу HTML у файл TXT        
        ```            
