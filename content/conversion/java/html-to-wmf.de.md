...
############################# Head #############################
head_title: "Java HTML zu WMF Konverter API - HTML in Java-Anwendungen transformieren"
head_description: "HTML zu WMF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "HTML in WMF in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von HTML in WMF Datei in Java" 
    content: |
      Die Transformation von HTML in WMF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // HTML in WMF Datei konvertieren        
        ```            
