...
head_title: "Konversi HTML ke WMZ di Jawa – Konversi HTML ke WMZ"
head_description: "Konversi HTML ke WMZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke WMZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke WMZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke WMZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga WMZ"
    content: |
        Konversikan HTML ke WMZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
