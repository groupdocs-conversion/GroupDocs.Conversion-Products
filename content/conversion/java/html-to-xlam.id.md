...
head_title: "Konversi HTML ke XLAM di Jawa – Konversi HTML ke XLAM"
head_description: "Konversi HTML ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga XLAM"
    content: |
        Konversikan HTML ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
