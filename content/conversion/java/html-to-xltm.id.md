...
head_title: "Konversi HTML ke XLTM di Jawa – Konversi HTML ke XLTM"
head_description: "Konversi HTML ke XLTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File HTML ke XLTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi HTML ke XLTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file HTML ke XLTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung HTML hingga XLTM"
    content: |
        Konversikan HTML ke XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
