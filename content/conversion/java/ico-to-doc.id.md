...
head_title: "Konversi ICO ke DOC di Jawa – Konversi ICO ke DOC"
head_description: "Konversi ICO ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga DOC"
    content: |
        Konversikan ICO ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
