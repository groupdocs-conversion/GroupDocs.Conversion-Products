...
head_title: "Konversi ICO ke DOTX di Jawa – Konversi ICO ke DOTX"
head_description: "Konversi ICO ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga DOTX"
    content: |
        Konversikan ICO ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
