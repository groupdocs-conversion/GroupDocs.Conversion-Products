...
head_title: "Konversi ICO ke EPUB di Jawa – Konversi ICO ke EPUB"
head_description: "Konversi ICO ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga EPUB"
    content: |
        Konversikan ICO ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
