...
head_title: "Konversi ICO ke FODP di Jawa – Konversi ICO ke FODP"
head_description: "Konversi ICO ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga FODP"
    content: |
        Konversikan ICO ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
