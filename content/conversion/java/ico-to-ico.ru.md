...
############################# Head ############################
head_title: "Преобразование ICO в ICO в Java — преобразование ICO в ICO"
head_description: "Преобразуйте ICO в ICO на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в ICO на Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования ICO в ICO в Java"
    content_left: |
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "ICO в ICO"
          link: "/conversion/java/ico-to-ico/"
