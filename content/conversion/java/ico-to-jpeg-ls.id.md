...
head_title: "Konversi ICO ke JPEG-LS di Jawa – Konversi ICO ke JPEG-LS"
head_description: "Konversi ICO ke JPEG-LS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke JPEG-LS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke JPEG-LS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke JPEG-LS dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file ICO dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen JPEG-LS
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (JPEG-LS) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format JPEG-LS target
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga JPEG-LS"
    content: |
        Konversikan ICO ke JPEG-LS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
