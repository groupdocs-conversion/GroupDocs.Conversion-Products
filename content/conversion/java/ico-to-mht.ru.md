...
############################# Head ############################
head_title: "Преобразование ICO в MHT в Java — преобразование ICO в MHT"
head_description: "Преобразуйте ICO в MHT на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в MHT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ICO в MHT в Java"
    content_left: |
