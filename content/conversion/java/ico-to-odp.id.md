...
head_title: "Konversi ICO ke ODP di Jawa – Konversi ICO ke ODP"
head_description: "Konversi ICO ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga ODP"
    content: |
        Konversikan ICO ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
