...
############################# Head ############################
head_title: "Преобразование ICO в ODS в Java — преобразование ICO в ODS"
head_description: "Преобразуйте ICO в ODS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ICO в ODS в Java"
    content_left: |
