...
head_title: "Konversi ICO ke ODT di Jawa – Konversi ICO ke ODT"
head_description: "Konversi ICO ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga ODT"
    content: |
        Konversikan ICO ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
