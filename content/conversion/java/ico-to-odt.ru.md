...
############################# Head ############################
head_title: "Преобразование ICO в ODT в Java — преобразование ICO в ODT"
head_description: "Преобразуйте ICO в ODT на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в ODT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ICO в ODT в Java"
    content_left: |
