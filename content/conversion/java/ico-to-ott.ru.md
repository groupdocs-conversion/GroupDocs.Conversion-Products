...
############################# Head ############################
head_title: "Преобразование ICO в OTT в Java — преобразование ICO в OTT"
head_description: "Преобразуйте ICO в OTT на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в OTT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ICO в OTT в Java"
    content_left: |
