...
############################# Head #############################
head_title: "Java ICO zu PNG Konverter API - ICO in Java-Anwendungen transformieren"
head_description: "ICO zu PNG Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "ICO in PNG in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken ICO zu PNG Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von ICO in PNG Datei in Java" 
    content: |
      Die Transformation von ICO in PNG wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // ICO in PNG Datei konvertieren        
        ```            
