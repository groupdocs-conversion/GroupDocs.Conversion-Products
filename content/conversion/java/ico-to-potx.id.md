...
head_title: "Konversi ICO ke POTX di Jawa – Konversi ICO ke POTX"
head_description: "Konversi ICO ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga POTX"
    content: |
        Konversikan ICO ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
