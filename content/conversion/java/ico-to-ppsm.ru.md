...
############################# Head ############################
head_title: "Преобразование ICO в PPSM в Java — преобразование ICO в PPSM"
head_description: "Преобразуйте ICO в PPSM на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в PPSM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ICO в PPSM в Java"
    content_left: |
