...
############################# Head ############################
head_title: "ICO to PPT Conversion in Java – Convert ICO to PPT"
head_description: "Convert ICO to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to PPT in few lines of code.
