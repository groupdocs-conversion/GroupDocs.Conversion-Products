...
head_title: "Konversi ICO ke PPTM di Jawa – Konversi ICO ke PPTM"
head_description: "Konversi ICO ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga PPTM"
    content: |
        Konversikan ICO ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
