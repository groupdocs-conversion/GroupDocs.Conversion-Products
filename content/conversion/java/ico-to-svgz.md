...
############################# Head ############################
head_title: "ICO to SVGZ Conversion in Java – Convert ICO to SVGZ"
head_description: "Convert ICO to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to SVGZ in few lines of code.
...
demos:
    enable: true
    title: "ICO to SVGZ Live Demos"
    content: |
        Convert ICO to SVGZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
