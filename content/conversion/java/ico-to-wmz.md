...
############################# Head ############################
head_title: "ICO to WMZ Conversion in Java – Convert ICO to WMZ"
head_description: "Convert ICO to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "ICO to WMZ Live Demos"
    content: |
        Convert ICO to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
