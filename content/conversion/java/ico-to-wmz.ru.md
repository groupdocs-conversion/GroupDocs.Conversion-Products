...
############################# Head ############################
head_title: "Преобразование ICO в WMZ на Java – Преобразование ICO в WMZ"
head_description: "Конвертируйте ICO в WMZ на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в WMZ на Java"
...
steps:
    enable: true
    title_left: "Шаги по конвертации ICO в WMZ на Java"
    content_left: |
