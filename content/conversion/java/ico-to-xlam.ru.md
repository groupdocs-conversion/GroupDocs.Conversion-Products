...
############################# Head ############################
head_title: "Преобразование ICO в XLAM в Java — преобразование ICO в XLAM"
head_description: "Преобразование ICO в XLAM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в XLAM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ICO в XLAM в Java"
    content_left: |
