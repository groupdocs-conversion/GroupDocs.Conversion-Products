...
head_title: "Konversi ICO ke XLS di Jawa – Konversi ICO ke XLS"
head_description: "Konversi ICO ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ICO ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ICO ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ICO ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ICO hingga XLS"
    content: |
        Konversikan ICO ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
