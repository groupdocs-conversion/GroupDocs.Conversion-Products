...
############################# Head ############################
head_title: "Преобразование ICO в XLSM в Java — преобразование ICO в XLSM"
head_description: "Преобразование ICO в XLSM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ICO в XLSM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ICO в XLSM в Java"
    content_left: |
