...
############################# Head ############################
head_title: "ICO to XLTM Conversion in Java – Convert ICO to XLTM"
head_description: "Convert ICO to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "ICO to XLTM Live Demos"
    content: |
        Convert ICO to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
