...
head_title: "Konversi IFC ke BMP di Jawa – Konversi IFC ke BMP"
head_description: "Konversi IFC ke BMP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke BMP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke BMP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke BMP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga BMP"
    content: |
        Konversikan IFC ke BMP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
