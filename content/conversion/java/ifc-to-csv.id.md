...
head_title: "Konversi IFC ke CSV di Jawa – Konversi IFC ke CSV"
head_description: "Konversi IFC ke CSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke CSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke CSV di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke CSV dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga CSV"
    content: |
        Konversikan IFC ke CSV sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
