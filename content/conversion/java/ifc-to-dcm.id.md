...
head_title: "Konversi IFC ke DCM di Jawa – Konversi IFC ke DCM"
head_description: "Konversi IFC ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga DCM"
    content: |
        Konversikan IFC ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
