...
head_title: "Konversi IFC ke DIF di Jawa – Konversi IFC ke DIF"
head_description: "Konversi IFC ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga DIF"
    content: |
        Konversikan IFC ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
