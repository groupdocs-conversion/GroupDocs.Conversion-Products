...
head_title: "Konversi IFC ke DOC di Jawa – Konversi IFC ke DOC"
head_description: "Konversi IFC ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke DOC di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga DOC"
    content: |
        Konversikan IFC ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
