...
head_title: "Konversi IFC ke DOCX di Jawa – Konversi IFC ke DOCX"
head_description: "Konversi IFC ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke DOCX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga DOCX"
    content: |
        Konversikan IFC ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
