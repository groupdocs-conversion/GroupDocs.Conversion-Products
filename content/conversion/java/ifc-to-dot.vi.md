...
breadcrumb: IFC đến DOT trong Java

############################# Head ############################
head_title: "Chuyển đổi IFC thành DOT trong Java"
head_description: "Chuyển đổi IFC thành DOT trong Java với một vài dòng mã. Chuyển đổi hơn 160 định dạng tệp bằng API chuyển đổi tài liệu GroupDocs cho Java"

############################# Header ############################
title: "Chuyển đổi IFC thành DOT trong Java"
description: "Chuyển đổi IFC thành DOT với một vài dòng mã Java"
...
overview:
    enable: true
    content: |
        Chuyển đổi các tệp IFC của bạn thành DOT trong Java. Chỉ cần một vài dòng mã Java trên bất kỳ nền tảng nào bạn chọn, chẳng hạn như Windows, Linux, macOS.
        Bạn có thể thử chuyển đổi IFC thành DOT miễn phí và đánh giá chất lượng của kết quả chuyển đổi. Cùng với các tập lệnh chuyển đổi tệp đơn giản, bạn có thể thử các tùy chọn phức tạp hơn để tải tệp nguồn IFC và lưu trữ đầu ra DOT. 
...
steps:
    enable: true
    title_left: "Các bước chuyển đổi IFC thành DOT trong Java"
    content_left: |
...
demos:
    enable: true
    title: "Bản trình diễn trực tiếp từ IFC đến DOT"
    content: |
