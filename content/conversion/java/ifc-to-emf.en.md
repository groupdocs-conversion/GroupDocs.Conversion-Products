...
############################# Head #############################
head_title: "Java IFC to EMF Converter API - transform IFC to EMF in Java apps"
head_description: "View IFC to EMF files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert IFC to EMF in Java" 
description: "Experience the efficiency of a native, high-performance IFC to EMF file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert IFC to EMF file in Java" 
    content: |
      Transforming IFC to EMF is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert IFC to EMF file        
        ```            
