...
head_title: "Konversi IFC ke EMF di Jawa – Konversi IFC ke EMF"
head_description: "Konversi IFC ke EMF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke EMF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke EMF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke EMF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga EMF"
    content: |
        Konversikan IFC ke EMF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
