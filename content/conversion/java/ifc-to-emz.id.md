...
head_title: "Konversi IFC ke EMZ di Jawa – Konversi IFC ke EMZ"
head_description: "Konversi IFC ke EMZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke EMZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke EMZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke EMZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga EMZ"
    content: |
        Konversikan IFC ke EMZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
