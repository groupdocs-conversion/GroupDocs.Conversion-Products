...
############################# Head ############################
head_title: "IFC to EPUB Conversion in Java – Convert IFC to EPUB"
head_description: "Convert IFC to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "IFC to EPUB Live Demos"
    content: |
        Convert IFC to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
