...
head_title: "Konversi IFC ke FODS di Jawa – Konversi IFC ke FODS"
head_description: "Konversi IFC ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga FODS"
    content: |
        Konversikan IFC ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
