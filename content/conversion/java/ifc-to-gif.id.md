...
head_title: "Konversi IFC ke GIF di Jawa – Konversi IFC ke GIF"
head_description: "Konversi IFC ke GIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke GIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke GIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke GIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga GIF"
    content: |
        Konversikan IFC ke GIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
