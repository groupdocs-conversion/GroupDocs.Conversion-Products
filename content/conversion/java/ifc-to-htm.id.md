...
head_title: "Konversi IFC ke HTM di Jawa – Konversi IFC ke HTM"
head_description: "Konversi IFC ke HTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke HTM di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke HTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga HTM"
    content: |
        Konversikan IFC ke HTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
