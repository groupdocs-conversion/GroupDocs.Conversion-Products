...
head_title: "Konversi IFC ke ICO di Jawa – Konversi IFC ke ICO"
head_description: "Konversi IFC ke ICO di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke ICO di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke ICO di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke ICO dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga ICO"
    content: |
        Konversikan IFC ke ICO sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
