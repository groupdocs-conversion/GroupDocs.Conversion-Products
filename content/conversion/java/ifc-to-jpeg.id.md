...
head_title: "Konversi IFC ke JPEG di Jawa – Konversi IFC ke JPEG"
head_description: "Konversi IFC ke JPEG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke JPEG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke JPEG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke JPEG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga JPEG"
    content: |
        Konversikan IFC ke JPEG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
