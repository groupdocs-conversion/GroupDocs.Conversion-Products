...
head_title: "Konversi IFC ke JPG di Jawa – Konversi IFC ke JPG"
head_description: "Konversi IFC ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke JPG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke JPG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga JPG"
    content: |
        Konversikan IFC ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
