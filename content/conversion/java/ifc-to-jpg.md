...
############################# Head ############################
head_title: "IFC to JPG Conversion in Java – Convert IFC to JPG"
head_description: "Convert IFC to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to JPG in few lines of code.
...
demos:
    enable: true
    title: "IFC to JPG Live Demos"
    content: |
        Convert IFC to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
