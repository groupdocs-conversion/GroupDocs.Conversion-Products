...
############################# Head ############################
head_title: "IFC to MD Conversion in Java – Convert IFC to MD"
head_description: "Convert IFC to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to MD in few lines of code.
...
demos:
    enable: true
    title: "IFC to MD Live Demos"
    content: |
        Convert IFC to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
