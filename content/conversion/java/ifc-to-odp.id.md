...
head_title: "Konversi IFC ke ODP di Jawa – Konversi IFC ke ODP"
head_description: "Konversi IFC ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke ODP di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga ODP"
    content: |
        Konversikan IFC ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
