...
############################# Head ############################
head_title: "IFC to ODP Conversion in Java – Convert IFC to ODP"
head_description: "Convert IFC to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to ODP in few lines of code.
