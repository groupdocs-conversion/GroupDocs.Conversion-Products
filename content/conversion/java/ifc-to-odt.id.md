...
head_title: "Konversi IFC ke ODT di Jawa – Konversi IFC ke ODT"
head_description: "Konversi IFC ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke ODT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga ODT"
    content: |
        Konversikan IFC ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
