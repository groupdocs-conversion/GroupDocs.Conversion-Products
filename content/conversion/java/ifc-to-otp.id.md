...
head_title: "Konversi IFC ke OTP di Jawa – Konversi IFC ke OTP"
head_description: "Konversi IFC ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke OTP di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke OTP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga OTP"
    content: |
        Konversikan IFC ke OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
