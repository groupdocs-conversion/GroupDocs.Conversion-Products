...
head_title: "Konversi IFC ke OTT di Jawa – Konversi IFC ke OTT"
head_description: "Konversi IFC ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga OTT"
    content: |
        Konversikan IFC ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
