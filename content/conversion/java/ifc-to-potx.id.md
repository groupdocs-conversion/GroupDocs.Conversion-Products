...
head_title: "Konversi IFC ke POTX di Jawa – Konversi IFC ke POTX"
head_description: "Konversi IFC ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke POTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga POTX"
    content: |
        Konversikan IFC ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
