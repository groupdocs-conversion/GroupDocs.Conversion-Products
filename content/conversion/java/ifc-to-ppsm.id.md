...
head_title: "Konversi IFC ke PPSM di Jawa – Konversi IFC ke PPSM"
head_description: "Konversi IFC ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke PPSM di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke PPSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga PPSM"
    content: |
        Konversikan IFC ke PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
