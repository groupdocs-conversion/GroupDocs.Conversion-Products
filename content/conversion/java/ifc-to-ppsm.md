...
############################# Head ############################
head_title: "IFC to PPSM Conversion in Java – Convert IFC to PPSM"
head_description: "Convert IFC to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "IFC to PPSM Live Demos"
    content: |
        Convert IFC to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
