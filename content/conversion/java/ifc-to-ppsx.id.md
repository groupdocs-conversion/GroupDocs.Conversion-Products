...
head_title: "Konversi IFC ke PPSX di Jawa – Konversi IFC ke PPSX"
head_description: "Konversi IFC ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke PPSX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga PPSX"
    content: |
        Konversikan IFC ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
