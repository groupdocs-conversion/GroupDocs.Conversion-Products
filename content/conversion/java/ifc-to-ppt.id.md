...
head_title: "Konversi IFC ke PPT di Jawa – Konversi IFC ke PPT"
head_description: "Konversi IFC ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke PPT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga PPT"
    content: |
        Konversikan IFC ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
