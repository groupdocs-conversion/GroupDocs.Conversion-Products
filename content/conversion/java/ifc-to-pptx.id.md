...
head_title: "Konversi IFC ke PPTX di Jawa – Konversi IFC ke PPTX"
head_description: "Konversi IFC ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke PPTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga PPTX"
    content: |
        Konversikan IFC ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
