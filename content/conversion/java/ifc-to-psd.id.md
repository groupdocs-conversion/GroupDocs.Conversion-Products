...
head_title: "Konversi IFC ke PSD di Jawa – Konversi IFC ke PSD"
head_description: "Konversi IFC ke PSD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke PSD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke PSD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke PSD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga PSD"
    content: |
        Konversikan IFC ke PSD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
