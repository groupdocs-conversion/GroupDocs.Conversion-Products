...
head_title: "Konversi IFC ke SVG di Jawa – Konversi IFC ke SVG"
head_description: "Konversi IFC ke SVG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke SVG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke SVG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke SVG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga SVG"
    content: |
        Konversikan IFC ke SVG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
