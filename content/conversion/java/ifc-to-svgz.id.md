...
head_title: "Konversi IFC ke SVGZ di Jawa – Konversi IFC ke SVGZ"
head_description: "Konversi IFC ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga SVGZ"
    content: |
        Konversikan IFC ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
