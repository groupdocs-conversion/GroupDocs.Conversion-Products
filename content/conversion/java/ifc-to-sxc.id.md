...
head_title: "Konversi IFC ke SXC di Jawa – Konversi IFC ke SXC"
head_description: "Konversi IFC ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga SXC"
    content: |
        Konversikan IFC ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
