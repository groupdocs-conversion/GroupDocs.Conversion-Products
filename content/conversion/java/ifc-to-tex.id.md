...
head_title: "Konversi IFC ke TEX di Jawa – Konversi IFC ke TEX"
head_description: "Konversi IFC ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga TEX"
    content: |
        Konversikan IFC ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
