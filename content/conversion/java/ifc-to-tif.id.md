...
head_title: "Konversi IFC ke TIF di Jawa – Konversi IFC ke TIF"
head_description: "Konversi IFC ke TIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke TIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke TIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke TIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga TIF"
    content: |
        Konversikan IFC ke TIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
