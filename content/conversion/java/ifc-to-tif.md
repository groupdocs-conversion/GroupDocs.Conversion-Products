...
############################# Head ############################
head_title: "IFC to TIF Conversion in Java – Convert IFC to TIF"
head_description: "Convert IFC to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to TIF in few lines of code.
...
demos:
    enable: true
    title: "IFC to TIF Live Demos"
    content: |
        Convert IFC to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
