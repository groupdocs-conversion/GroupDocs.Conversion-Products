...
head_title: "Konversi IFC ke TXT di Jawa – Konversi IFC ke TXT"
head_description: "Konversi IFC ke TXT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke TXT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke TXT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke TXT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga TXT"
    content: |
        Konversikan IFC ke TXT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
