...
head_title: "Konversi IFC ke WEBP di Jawa – Konversi IFC ke WEBP"
head_description: "Konversi IFC ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga WEBP"
    content: |
        Konversikan IFC ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
