...
head_title: "Konversi IFC ke WMF di Jawa – Konversi IFC ke WMF"
head_description: "Konversi IFC ke WMF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke WMF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke WMF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke WMF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga WMF"
    content: |
        Konversikan IFC ke WMF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
