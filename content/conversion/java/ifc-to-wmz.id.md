...
head_title: "Konversi IFC ke WMZ di Jawa – Konversi IFC ke WMZ"
head_description: "Konversi IFC ke WMZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke WMZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke WMZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke WMZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga WMZ"
    content: |
        Konversikan IFC ke WMZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
