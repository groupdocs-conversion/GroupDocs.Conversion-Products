...
head_title: "Konversi IFC ke XLS di Jawa – Konversi IFC ke XLS"
head_description: "Konversi IFC ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga XLS"
    content: |
        Konversikan IFC ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
