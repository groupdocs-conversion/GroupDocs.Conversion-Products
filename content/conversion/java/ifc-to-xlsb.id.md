...
head_title: "Konversi IFC ke XLSB di Jawa – Konversi IFC ke XLSB"
head_description: "Konversi IFC ke XLSB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke XLSB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke XLSB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke XLSB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga XLSB"
    content: |
        Konversikan IFC ke XLSB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
