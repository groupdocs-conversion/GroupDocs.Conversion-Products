...
head_title: "Konversi IFC ke XLSM di Jawa – Konversi IFC ke XLSM"
head_description: "Konversi IFC ke XLSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke XLSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke XLSM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke XLSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga XLSM"
    content: |
        Konversikan IFC ke XLSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
