...
head_title: "Konversi IFC ke XLSX di Jawa – Konversi IFC ke XLSX"
head_description: "Konversi IFC ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga XLSX"
    content: |
        Konversikan IFC ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
