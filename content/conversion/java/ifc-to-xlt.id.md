...
head_title: "Konversi IFC ke XLT di Jawa – Konversi IFC ke XLT"
head_description: "Konversi IFC ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga XLT"
    content: |
        Konversikan IFC ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
