...
head_title: "Konversi IFC ke XLTX di Jawa – Konversi IFC ke XLTX"
head_description: "Konversi IFC ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga XLTX"
    content: |
        Konversikan IFC ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
