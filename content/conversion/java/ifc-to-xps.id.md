...
head_title: "Konversi IFC ke XPS di Jawa – Konversi IFC ke XPS"
head_description: "Konversi IFC ke XPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IFC ke XPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IFC ke XPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IFC ke XPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IFC hingga XPS"
    content: |
        Konversikan IFC ke XPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
