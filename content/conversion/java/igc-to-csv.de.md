...
############################# Head #############################
head_title: "Java IGC zu CSV Konverter API - IGC in Java-Anwendungen transformieren"
head_description: "IGC zu CSV Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "IGC in CSV in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken IGC zu CSV Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von IGC in CSV Datei in Java" 
    content: |
      Die Transformation von IGC in CSV wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die IGC Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.igc")              // Richten Sie die Eingabedatei IGC ein
            .convertTo("converted.csv")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // IGC in CSV Datei konvertieren        
        ```            
