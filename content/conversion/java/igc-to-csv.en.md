...
############################# Head #############################
head_title: "Java IGC to CSV Converter API - transform IGC to CSV in Java apps"
head_description: "View IGC to CSV files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert IGC to CSV in Java" 
description: "Experience the efficiency of a native, high-performance IGC to CSV file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert IGC to CSV file in Java" 
    content: |
      Transforming IGC to CSV is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the IGC file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.igc")              // Set up input IGC file
            .convertTo("converted.csv")    // Specify output path for converted file
            .convert();                     // Convert IGC to CSV file        
        ```            
