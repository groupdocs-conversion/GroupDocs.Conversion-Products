...
draft: false
otherformats: 
breadcrumb: IGC to EML in Java

############################# Head ############################
head_title: "IGC to EML Converter in Java"
head_description: "Convert IGC to EML in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert IGC to EML in Java"
description: "IGC to EML conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your IGC files to EML in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert IGC to EML in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a IGC file to EML with a few lines of code.
