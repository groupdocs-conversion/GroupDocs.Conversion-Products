...
breadcrumb: IGS til DOC í Java

############################# Head ############################
head_title: "Umbreyttu IGS í DOC í Java"
head_description: "IGS til DOC viðskipti í Java með nokkrum línum af kóða. Umbreyttu yfir 160 skráarsniðum með því að nota GroupDocs skjalabreytingarforritaskil fyrir Java"

############################# Header ############################
title: "Umbreyttu IGS í DOC í Java"
description: "IGS til DOC viðskipti með nokkrum línum af Java kóða"
...
overview:
    enable: true
    content: |
        Umbreyttu IGS skránum þínum í DOC í Java. Það tekur aðeins nokkrar línur af Java kóða á hvaða vettvang sem þú velur, eins og Windows, Linux, macOS.
        Þú getur prófað að breyta IGS í DOC ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingarforskriftum geturðu prófað flóknari valkosti til að hlaða IGS frumskránni og geyma DOC úttakið. 
...
steps:
    enable: true
    title_left: "Skref til að breyta IGS í DOC í Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) gerir forriturum kleift að umbreyta IGS skrá auðveldlega í DOC með nokkrum línum af kóða.
...
demos:
    ...
    content: |
       Farðu á [GroupDocs.Conversion app](https://products.groupdocs.app/conversion/family) vefsíðu okkar og reyndu IGS í DOC viðskipti núna. Ókeypis kynningin hefur eftirfarandi kosti
