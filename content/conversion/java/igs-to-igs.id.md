...
head_title: "Konversi IGS ke IGS di Jawa – Konversi IGS ke IGS"
head_description: "Konversi IGS ke IGS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IGS ke IGS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IGS ke IGS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IGS ke IGS dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file IGS dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen IGS
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (IGS) sebagai parameter
...
demos:
    enable: true
    title: "Demo Langsung IGS hingga IGS"
    content: |
        Konversikan IGS ke IGS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
