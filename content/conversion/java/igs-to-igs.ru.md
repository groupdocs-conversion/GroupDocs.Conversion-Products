...
############################# Head ############################
head_title: "Преобразование IGS в IGS в Java — Преобразование IGS в IGS"
head_description: "Преобразование IGS в IGS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов IGS в IGS в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования IGS в IGS в Java"
    content_left: |
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "IGS в IGS"
          link: "/conversion/java/igs-to-igs/"
