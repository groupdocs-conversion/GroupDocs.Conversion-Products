...
head_title: "Konversi IGS ke OTT di Jawa – Konversi IGS ke OTT"
head_description: "Konversi IGS ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IGS ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IGS ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IGS ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IGS hingga OTT"
    content: |
        Konversikan IGS ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
