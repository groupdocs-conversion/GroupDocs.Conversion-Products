...
############################# Head ############################
head_title: "IGS to POT Conversion in Java – Convert IGS to POT"
head_description: "Convert IGS to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to POT in few lines of code.
