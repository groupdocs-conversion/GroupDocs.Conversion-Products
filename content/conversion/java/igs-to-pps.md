...
############################# Head ############################
head_title: "IGS to PPS Conversion in Java – Convert IGS to PPS"
head_description: "Convert IGS to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to PPS in few lines of code.
...
demos:
    enable: true
    title: "IGS to PPS Live Demos"
    content: |
        Convert IGS to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
