...
head_title: "Konversi IGS ke PSD di Jawa – Konversi IGS ke PSD"
head_description: "Konversi IGS ke PSD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IGS ke PSD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IGS ke PSD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IGS ke PSD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IGS hingga PSD"
    content: |
        Konversikan IGS ke PSD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
