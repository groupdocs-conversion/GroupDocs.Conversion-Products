...
head_title: "Konversi IGS ke SVG di Jawa – Konversi IGS ke SVG"
head_description: "Konversi IGS ke SVG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IGS ke SVG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IGS ke SVG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IGS ke SVG dalam beberapa baris kode.
