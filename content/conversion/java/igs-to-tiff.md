...
############################# Head ############################
head_title: "IGS to TIFF Conversion in Java – Convert IGS to TIFF"
head_description: "Convert IGS to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "IGS to TIFF Live Demos"
    content: |
        Convert IGS to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
