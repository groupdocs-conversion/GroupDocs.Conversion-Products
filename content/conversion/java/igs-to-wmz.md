...
############################# Head ############################
head_title: "IGS to WMZ Conversion in Java – Convert IGS to WMZ"
head_description: "Convert IGS to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "IGS to WMZ Live Demos"
    content: |
        Convert IGS to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
