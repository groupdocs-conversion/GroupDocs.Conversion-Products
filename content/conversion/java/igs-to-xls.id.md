...
head_title: "Konversi IGS ke XLS di Jawa – Konversi IGS ke XLS"
head_description: "Konversi IGS ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IGS ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IGS ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IGS ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IGS hingga XLS"
    content: |
        Konversikan IGS ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
