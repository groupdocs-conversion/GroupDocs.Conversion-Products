...
head_title: "Konversi IGS ke XPS di Jawa – Konversi IGS ke XPS"
head_description: "Konversi IGS ke XPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IGS ke XPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IGS ke XPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IGS ke XPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IGS hingga XPS"
    content: |
        Konversikan IGS ke XPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
