...
############################# Head ############################
head_title: "Преобразование ИЗОБРАЖЕНИЯ в POWERPOINT в Java – Преобразование ИЗОБРАЖЕНИЯ в POWERPOINT"
head_description: "Преобразуйте IMAGE в POWERPOINT на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов IMAGE в POWERPOINT на Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования ИЗОБРАЖЕНИЯ в POWERPOINT в Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) упрощает для разработчиков преобразование файла IMAGE в формат POWERPOINT с помощью нескольких строк кода.
...
demos:
    enable: true
    title: "IMAGE в POWERPOINT Живые демонстрации"
    content: |
