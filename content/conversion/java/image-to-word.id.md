...
head_title: "Konversi IMAGE ke WORD di Jawa – Konversi IMAGE ke WORD"
head_description: "Konversi IMAGE ke WORD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File IMAGE ke WORD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi IMAGE ke WORD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file IMAGE ke WORD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung IMAGE hingga WORD"
    content: |
        Konversikan IMAGE ke WORD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
