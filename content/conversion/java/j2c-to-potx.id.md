...
head_title: "Konversi J2C ke POTX di Jawa – Konversi J2C ke POTX"
head_description: "Konversi J2C ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File J2C ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi J2C ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file J2C ke POTX dalam beberapa baris kode.
