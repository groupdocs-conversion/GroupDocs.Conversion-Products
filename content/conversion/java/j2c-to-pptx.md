...
############################# Head ############################
head_title: "J2C to PPTX Conversion in Java – Convert J2C to PPTX"
head_description: "Convert J2C to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert J2C Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting J2C to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the J2C file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "J2C to PPTX Live Demos"
    content: |
        Convert J2C to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
