...
breadcrumb: J2C do SVG v Java

############################# Head ############################
head_title: "Převést J2C na SVG v Java"
head_description: "Převod J2C na SVG v Java pomocí několika řádků kódu. Převeďte více než 160 formátů souborů pomocí rozhraní API pro převod dokumentů GroupDocs pro Java"

############################# Header ############################
title: "Převést J2C na SVG v Java"
description: "Převod J2C na SVG s několika řádky kódu Java"
...
overview:
    enable: true
    content: |
        Převeďte své soubory J2C na SVG ve službě Java. Na libovolné platformě dle vašeho výběru, jako jsou Windows, Linux, macOS, stačí jen pár řádků kódu Java.
        Můžete zkusit zdarma převést J2C na SVG a vyhodnotit kvalitu výsledků převodu. Spolu s jednoduchými skripty pro převod souborů můžete vyzkoušet sofistikovanější možnosti pro načtení zdrojového souboru J2C a uložení výstupu SVG. 
        ...
        * přidat vodoznak do převedeného SVG.
        ...
        Po dokončení převodu můžete soubor SVG uložit do místní cesty k souboru nebo do libovolného úložiště třetí strany, jako je FTP, Amazon S3, Disk Google, Dropbox atd. Poznámka – pro převod J2C do SVG, nemusíte instalovat žádný další software, jako je MS Office, Open Office, Adobe Acrobat Reader atd.


############################# Steps ############################
steps:
    enable: true
    title_left: "Kroky k převodu J2C na SVG v Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) umožňuje vývojářům snadno převést soubor J2C na SVG pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od J2C do SVG"
    content: |
       Navštivte naši webovou stránku [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) a vyzkoušejte konverzi J2C na SVG nyní. Bezplatná ukázka má následující výhody
