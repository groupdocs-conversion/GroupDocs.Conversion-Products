...
head_title: "Konversi J2C ke XLTX di Jawa – Konversi J2C ke XLTX"
head_description: "Konversi J2C ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File J2C ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi J2C ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file J2C ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung J2C hingga XLTX"
    content: |
        Konversikan J2C ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
