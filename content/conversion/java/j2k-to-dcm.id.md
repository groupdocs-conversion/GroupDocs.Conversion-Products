...
head_title: "Konversi J2K ke DCM di Jawa – Konversi J2K ke DCM"
head_description: "Konversi J2K ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File J2K ke DCM di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file J2K ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung J2K hingga DCM"
    content: |
        Konversikan J2K ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
