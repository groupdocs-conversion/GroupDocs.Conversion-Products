...
head_title: "Konversi J2K ke FODS di Jawa – Konversi J2K ke FODS"
head_description: "Konversi J2K ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File J2K ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi J2K ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file J2K ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung J2K hingga FODS"
    content: |
        Konversikan J2K ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
