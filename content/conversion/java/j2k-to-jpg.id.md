...
head_title: "Konversi J2K ke JPG di Jawa – Konversi J2K ke JPG"
head_description: "Konversi J2K ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File J2K ke JPG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file J2K ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung J2K hingga JPG"
    content: |
        Konversikan J2K ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
