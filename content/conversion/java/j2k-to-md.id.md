...
head_title: "Konversi J2K ke MD di Jawa – Konversi J2K ke MD"
head_description: "Konversi J2K ke MD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File J2K ke MD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi J2K ke MD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file J2K ke MD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung J2K hingga MD"
    content: |
        Konversikan J2K ke MD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
