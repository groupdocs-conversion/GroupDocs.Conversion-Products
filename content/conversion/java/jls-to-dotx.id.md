...
head_title: "Konversi JLS ke DOTX di Jawa – Konversi JLS ke DOTX"
head_description: "Konversi JLS ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JLS ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JLS ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JLS ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JLS hingga DOTX"
    content: |
        Konversikan JLS ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
