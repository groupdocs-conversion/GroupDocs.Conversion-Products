...
head_title: "Konversi JLS ke EPUB di Jawa – Konversi JLS ke EPUB"
head_description: "Konversi JLS ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JLS ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JLS ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JLS ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JLS hingga EPUB"
    content: |
        Konversikan JLS ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
