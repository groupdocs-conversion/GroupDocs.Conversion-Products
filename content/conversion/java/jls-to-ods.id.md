...
head_title: "Konversi JLS ke ODS di Jawa – Konversi JLS ke ODS"
head_description: "Konversi JLS ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JLS ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JLS ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JLS ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JLS hingga ODS"
    content: |
        Konversikan JLS ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
