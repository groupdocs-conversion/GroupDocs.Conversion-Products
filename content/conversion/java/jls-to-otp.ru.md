...
############################# Head ############################
head_title: "Преобразование JLS в OTP в Java — преобразование JLS в OTP"
head_description: "Преобразование JLS в OTP на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов JLS в OTP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию JLS в OTP в Java"
    content_left: |
