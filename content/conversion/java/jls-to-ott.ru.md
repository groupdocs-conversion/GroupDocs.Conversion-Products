...
############################# Head ############################
head_title: "Преобразование JLS в OTT в Java — преобразование JLS в OTT"
head_description: "Преобразование JLS в OTT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов JLS в OTT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию JLS в OTT в Java"
    content_left: |
...
demos:
    enable: true
    title: "Демонстрации JLS в OTT Live"
    content: |
        Конвертируйте JLS в OTT прямо сейчас, посетив веб-сайт [GroupDocs.Conversion Живые демонстрации](https://products.groupdocs.app/conversion/family).
