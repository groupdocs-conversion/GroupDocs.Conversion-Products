...
head_title: "Konversi JLS ke PPTM di Jawa – Konversi JLS ke PPTM"
head_description: "Konversi JLS ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JLS ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JLS ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JLS ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JLS hingga PPTM"
    content: |
        Konversikan JLS ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
