...
head_title: "Konversi JLS ke SXC di Jawa – Konversi JLS ke SXC"
head_description: "Konversi JLS ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JLS ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JLS ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JLS ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JLS hingga SXC"
    content: |
        Konversikan JLS ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
