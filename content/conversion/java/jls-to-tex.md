...
############################# Head ############################
head_title: "JLS to TEX Conversion in Java – Convert JLS to TEX"
head_description: "Convert JLS to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to TEX in few lines of code.
