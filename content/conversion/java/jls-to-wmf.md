...
############################# Head ############################
head_title: "JLS to WMF Conversion in Java – Convert JLS to WMF"
head_description: "Convert JLS to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to WMF in few lines of code.
...
demos:
    enable: true
    title: "JLS to WMF Live Demos"
    content: |
        Convert JLS to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
