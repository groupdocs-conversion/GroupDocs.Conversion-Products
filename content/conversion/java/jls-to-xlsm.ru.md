...
############################# Head ############################
head_title: "Преобразование JLS в XLSM в Java — преобразование JLS в XLSM"
head_description: "Преобразование JLS в XLSM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов JLS в XLSM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию JLS в XLSM в Java"
    content_left: |
