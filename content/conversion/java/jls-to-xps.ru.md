...
############################# Head ############################
head_title: "Преобразование JLS в XPS в Java — преобразование JLS в XPS"
head_description: "Преобразование JLS в XPS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов JLS в XPS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию JLS в XPS в Java"
    content_left: |
