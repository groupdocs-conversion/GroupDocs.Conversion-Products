...
head_title: "Konversi JP2 ke HTML di Jawa – Konversi JP2 ke HTML"
head_description: "Konversi JP2 ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JP2 ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JP2 ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JP2 ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JP2 hingga HTML"
    content: |
        Konversikan JP2 ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
