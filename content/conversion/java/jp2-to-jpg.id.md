...
head_title: "Konversi JP2 ke JPG di Jawa – Konversi JP2 ke JPG"
head_description: "Konversi JP2 ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JP2 ke JPG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JP2 ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JP2 hingga JPG"
    content: |
        Konversikan JP2 ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
