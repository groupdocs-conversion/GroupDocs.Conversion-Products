...
head_title: "Konversi JP2 ke TEX di Jawa – Konversi JP2 ke TEX"
head_description: "Konversi JP2 ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JP2 ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JP2 ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JP2 ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JP2 hingga TEX"
    content: |
        Konversikan JP2 ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
