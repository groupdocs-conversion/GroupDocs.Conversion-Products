...
############################# Head #############################
head_title: "Java JP2 to TIFF Converter API - transform JP2 to TIFF in Java apps"
head_description: "View JP2 to TIFF files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert JP2 to TIFF in Java" 
description: "Experience the efficiency of a native, high-performance JP2 to TIFF file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert JP2 to TIFF file in Java" 
    content: |
      Transforming JP2 to TIFF is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the JP2 file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.jp2")              // Set up input JP2 file
            .convertTo("converted.tiff")    // Specify output path for converted file
            .convert();                     // Convert JP2 to TIFF file        
        ```            
