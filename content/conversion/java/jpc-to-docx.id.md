...
head_title: "Konversi JPC ke DOCX di Jawa – Konversi JPC ke DOCX"
head_description: "Konversi JPC ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPC ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPC ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPC ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPC hingga DOCX"
    content: |
        Konversikan JPC ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
