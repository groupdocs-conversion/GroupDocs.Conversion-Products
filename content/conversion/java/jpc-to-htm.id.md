...
head_title: "Konversi JPC ke HTM di Jawa – Konversi JPC ke HTM"
head_description: "Konversi JPC ke HTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPC ke HTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPC ke HTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPC ke HTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPC hingga HTM"
    content: |
        Konversikan JPC ke HTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
