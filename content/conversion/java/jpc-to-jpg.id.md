...
head_title: "Konversi JPC ke JPG di Jawa – Konversi JPC ke JPG"
head_description: "Konversi JPC ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPC ke JPG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPC ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPC hingga JPG"
    content: |
        Konversikan JPC ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
