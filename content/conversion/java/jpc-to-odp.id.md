...
head_title: "Konversi JPC ke ODP di Jawa – Konversi JPC ke ODP"
head_description: "Konversi JPC ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPC ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPC ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPC ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPC hingga ODP"
    content: |
        Konversikan JPC ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
