...
head_title: "Konversi JPC ke OTP di Jawa – Konversi JPC ke OTP"
head_description: "Konversi JPC ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPC ke OTP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPC ke OTP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPC ke OTP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPC hingga OTP"
    content: |
        Konversikan JPC ke OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
