...
############################# Head ############################
head_title: "Преобразование JPC в OTT в Java — преобразование JPC в OTT"
head_description: "Преобразование JPC в OTT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов JPC в OTT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию JPC в OTT в Java"
    content_left: |
