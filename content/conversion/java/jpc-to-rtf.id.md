...
head_title: "Konversi JPC ke RTF di Jawa – Konversi JPC ke RTF"
head_description: "Konversi JPC ke RTF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPC ke RTF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPC ke RTF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPC ke RTF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPC hingga RTF"
    content: |
        Konversikan JPC ke RTF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
