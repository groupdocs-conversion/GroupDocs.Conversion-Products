...
head_title: "Konversi JPC ke TEX di Jawa – Konversi JPC ke TEX"
head_description: "Konversi JPC ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPC ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPC ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPC ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPC hingga TEX"
    content: |
        Konversikan JPC ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
