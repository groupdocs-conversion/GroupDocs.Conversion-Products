...
############################# Head ############################
head_title: "JPC to TIFF Conversion in Java – Convert JPC to TIFF"
head_description: "Convert JPC to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPC Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPC to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPC file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "JPC to TIFF Live Demos"
    content: |
        Convert JPC to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
