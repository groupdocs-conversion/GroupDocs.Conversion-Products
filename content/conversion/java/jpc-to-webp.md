...
############################# Head ############################
head_title: "JPC to WEBP Conversion in Java – Convert JPC to WEBP"
head_description: "Convert JPC to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPC Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPC to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPC file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "JPC to WEBP Live Demos"
    content: |
        Convert JPC to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
