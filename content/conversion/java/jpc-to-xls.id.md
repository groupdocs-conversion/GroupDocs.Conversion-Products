...
head_title: "Konversi JPC ke XLS di Jawa – Konversi JPC ke XLS"
head_description: "Konversi JPC ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPC ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPC ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPC ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPC hingga XLS"
    content: |
        Konversikan JPC ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
