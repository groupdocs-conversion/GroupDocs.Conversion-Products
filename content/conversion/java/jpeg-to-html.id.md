...
head_title: "Konversi JPEG ke HTML di Jawa – Konversi JPEG ke HTML"
head_description: "Konversi JPEG ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPEG ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPEG ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPEG ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPEG hingga HTML"
    content: |
        Konversikan JPEG ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
