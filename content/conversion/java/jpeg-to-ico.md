...
############################# Head ############################
head_title: "JPEG to ICO Conversion in Java – Convert JPEG to ICO"
head_description: "Convert JPEG to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to ICO in few lines of code.
...
demos:
    enable: true
    title: "JPEG to ICO Live Demos"
    content: |
        Convert JPEG to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
