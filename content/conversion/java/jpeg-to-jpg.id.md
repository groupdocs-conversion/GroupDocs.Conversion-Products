...
head_title: "Konversi JPEG ke JPG di Jawa – Konversi JPEG ke JPG"
head_description: "Konversi JPEG ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPEG ke JPG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPEG ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPEG hingga JPG"
    content: |
        Konversikan JPEG ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
