...
head_title: "Konversi JPEG ke ODT di Jawa – Konversi JPEG ke ODT"
head_description: "Konversi JPEG ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPEG ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPEG ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPEG ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPEG hingga ODT"
    content: |
        Konversikan JPEG ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
