...
head_title: "Konversi JPEG ke OTT di Jawa – Konversi JPEG ke OTT"
head_description: "Konversi JPEG ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPEG ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPEG ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPEG ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPEG hingga OTT"
    content: |
        Konversikan JPEG ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
