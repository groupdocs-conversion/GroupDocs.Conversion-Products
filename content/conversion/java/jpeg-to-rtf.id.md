...
head_title: "Konversi JPEG ke RTF di Jawa – Konversi JPEG ke RTF"
head_description: "Konversi JPEG ke RTF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPEG ke RTF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPEG ke RTF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPEG ke RTF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPEG hingga RTF"
    content: |
        Konversikan JPEG ke RTF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
