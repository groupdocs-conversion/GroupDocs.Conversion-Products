...
############################# Head ############################
head_title: "JPEG to WEBP Conversion in Java – Convert JPEG to WEBP"
head_description: "Convert JPEG to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "JPEG to WEBP Live Demos"
    content: |
        Convert JPEG to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
