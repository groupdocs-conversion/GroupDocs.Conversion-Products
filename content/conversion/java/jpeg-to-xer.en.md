...
breadcrumb: JPEG to XER in Java

############################# Head ############################
head_title: "JPEG to XER Converter in Java"
head_description: "Convert JPEG to XER in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert JPEG to XER in Java"
description: "JPEG to XER conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your JPEG files to XER in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert JPEG to XER in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a JPEG file to XER with a few lines of code.
