...
head_title: "Konversi JPEG ke XLAM di Jawa – Konversi JPEG ke XLAM"
head_description: "Konversi JPEG ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPEG ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPEG ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPEG ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPEG hingga XLAM"
    content: |
        Konversikan JPEG ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
