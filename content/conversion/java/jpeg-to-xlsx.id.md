...
head_title: "Konversi JPEG ke XLSX di Jawa – Konversi JPEG ke XLSX"
head_description: "Konversi JPEG ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPEG ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPEG ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPEG ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPEG hingga XLSX"
    content: |
        Konversikan JPEG ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
