...
############################# Head #############################
head_title: "Java JPEG2000 zu BMP Konverter API - JPEG2000 in Java-Anwendungen transformieren"
head_description: "JPEG2000 zu BMP Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "JPEG2000 in BMP in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken JPEG2000 zu BMP Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von JPEG2000 in BMP Datei in Java" 
    content: |
      Die Transformation von JPEG2000 in BMP wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die JPEG2000 Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.jpeg2000")              // Richten Sie die Eingabedatei JPEG2000 ein
            .convertTo("converted.bmp")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // JPEG2000 in BMP Datei konvertieren        
        ```            
