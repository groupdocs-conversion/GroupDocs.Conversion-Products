...
############################# Head #############################
head_title: "Java JPEG2000 to BMP Converter API - transform JPEG2000 to BMP in Java apps"
head_description: "View JPEG2000 to BMP files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert JPEG2000 to BMP in Java" 
description: "Experience the efficiency of a native, high-performance JPEG2000 to BMP file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert JPEG2000 to BMP file in Java" 
    content: |
      Transforming JPEG2000 to BMP is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the JPEG2000 file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.jpeg2000")              // Set up input JPEG2000 file
            .convertTo("converted.bmp")    // Specify output path for converted file
            .convert();                     // Convert JPEG2000 to BMP file        
        ```            
