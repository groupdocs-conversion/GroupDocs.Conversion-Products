...
head_title: "Konversi JPF ke DOCX di Jawa – Konversi JPF ke DOCX"
head_description: "Konversi JPF ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPF ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPF ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPF ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPF hingga DOCX"
    content: |
        Konversikan JPF ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
