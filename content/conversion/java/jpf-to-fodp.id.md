...
head_title: "Konversi JPF ke FODP di Jawa – Konversi JPF ke FODP"
head_description: "Konversi JPF ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPF ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPF ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPF ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPF hingga FODP"
    content: |
        Konversikan JPF ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
