...
head_title: "Konversi JPF ke HTML di Jawa – Konversi JPF ke HTML"
head_description: "Konversi JPF ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPF ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPF ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPF ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPF hingga HTML"
    content: |
        Konversikan JPF ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
