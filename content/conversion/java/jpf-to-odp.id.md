...
head_title: "Konversi JPF ke ODP di Jawa – Konversi JPF ke ODP"
head_description: "Konversi JPF ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPF ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPF ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPF ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPF hingga ODP"
    content: |
        Konversikan JPF ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
