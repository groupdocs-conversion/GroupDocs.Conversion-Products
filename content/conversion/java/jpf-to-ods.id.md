...
head_title: "Konversi JPF ke ODS di Jawa – Konversi JPF ke ODS"
head_description: "Konversi JPF ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPF ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPF ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPF ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPF hingga ODS"
    content: |
        Konversikan JPF ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
