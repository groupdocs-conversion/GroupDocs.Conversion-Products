...
head_title: "Konversi JPF ke ODT di Jawa – Konversi JPF ke ODT"
head_description: "Konversi JPF ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPF ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPF ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPF ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPF hingga ODT"
    content: |
        Konversikan JPF ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
