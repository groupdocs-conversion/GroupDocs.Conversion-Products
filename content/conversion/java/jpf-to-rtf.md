...
############################# Head ############################
head_title: "JPF to RTF Conversion in Java – Convert JPF to RTF"
head_description: "Convert JPF to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPF Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPF to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPF file to RTF in few lines of code.
