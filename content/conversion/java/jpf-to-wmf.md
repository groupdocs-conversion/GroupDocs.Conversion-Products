...
############################# Head ############################
head_title: "JPF to WMF Conversion in Java – Convert JPF to WMF"
head_description: "Convert JPF to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPF Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPF to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPF file to WMF in few lines of code.
...
demos:
    enable: true
    title: "JPF to WMF Live Demos"
    content: |
        Convert JPF to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
