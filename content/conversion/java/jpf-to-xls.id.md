...
head_title: "Konversi JPF ke XLS di Jawa – Konversi JPF ke XLS"
head_description: "Konversi JPF ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPF ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPF ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPF ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPF hingga XLS"
    content: |
        Konversikan JPF ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
