...
############################# Head #############################
head_title: "Java JPG to BMP Converter API - transform JPG to BMP in Java apps"
head_description: "View JPG to BMP files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert JPG to BMP in Java" 
description: "Experience the efficiency of a native, high-performance JPG to BMP file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert JPG to BMP file in Java" 
    content: |
      Transforming JPG to BMP is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // Convert JPG to BMP file        
        ```            
