...
############################# Head ############################
head_title: "JPG to DCM Conversion in Java – Convert JPG to DCM"
head_description: "Convert JPG to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to DCM in few lines of code.
...
demos:
    enable: true
    title: "JPG to DCM Live Demos"
    content: |
        Convert JPG to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
