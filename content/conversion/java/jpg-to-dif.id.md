...
head_title: "Konversi JPG ke DIF di Jawa – Konversi JPG ke DIF"
head_description: "Konversi JPG ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga DIF"
    content: |
        Konversikan JPG ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
