...
head_title: "Konversi JPG ke EPUB di Jawa – Konversi JPG ke EPUB"
head_description: "Konversi JPG ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga EPUB"
    content: |
        Konversikan JPG ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
