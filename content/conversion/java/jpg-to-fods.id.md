...
head_title: "Konversi JPG ke FODS di Jawa – Konversi JPG ke FODS"
head_description: "Konversi JPG ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga FODS"
    content: |
        Konversikan JPG ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
