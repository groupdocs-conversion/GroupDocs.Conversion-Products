...
############################# Head #############################
head_title: "Java JPG zu GIF Konverter API - JPG in Java-Anwendungen transformieren"
head_description: "JPG zu GIF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "JPG in GIF in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken JPG zu GIF Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von JPG in GIF Datei in Java" 
    content: |
      Die Transformation von JPG in GIF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // JPG in GIF Datei konvertieren        
        ```            
