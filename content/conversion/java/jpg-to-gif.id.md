...
head_title: "Konversi JPG ke GIF di Jawa – Konversi JPG ke GIF"
head_description: "Konversi JPG ke GIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke GIF di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke GIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga GIF"
    content: |
        Konversikan JPG ke GIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
