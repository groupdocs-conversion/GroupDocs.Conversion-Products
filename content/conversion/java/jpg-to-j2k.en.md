...
############################# Head #############################
head_title: "Java JPG to J2K Converter API - transform JPG to J2K in Java apps"
head_description: "View JPG to J2K files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert JPG to J2K in Java" 
description: "Experience the efficiency of a native, high-performance JPG to J2K file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert JPG to J2K file in Java" 
    content: |
      Transforming JPG to J2K is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convertTo("converted.j2k")    // Specify output path for converted file
            .convert();                     // Convert JPG to J2K file        
        ```            
