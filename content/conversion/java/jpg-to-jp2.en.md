...
############################# Head #############################
head_title: "Java JPG to JP2 Converter API - transform JPG to JP2 in Java apps"
head_description: "View JPG to JP2 files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert JPG to JP2 in Java" 
description: "Experience the efficiency of a native, high-performance JPG to JP2 file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert JPG to JP2 file in Java" 
    content: |
      Transforming JPG to JP2 is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the JPG file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.jpg")              // Set up input JPG file
            .convertTo("converted.jp2")    // Specify output path for converted file
            .convert();                     // Convert JPG to JP2 file        
        ```            
