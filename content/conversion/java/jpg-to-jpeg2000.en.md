...
############################# Head #############################
head_title: "Java JPG to JPEG2000 Converter API - transform JPG to JPEG2000 in Java apps"
head_description: "View JPG to JPEG2000 files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert JPG to JPEG2000 in Java" 
description: "Experience the efficiency of a native, high-performance JPG to JPEG2000 file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert JPG to JPEG2000 file in Java" 
    content: |
      Transforming JPG to JPEG2000 is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert JPG to JPEG2000 file        
        ```            
