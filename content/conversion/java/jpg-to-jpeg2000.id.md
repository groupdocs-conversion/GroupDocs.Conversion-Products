...
############################# Head #############################
head_title: "API Konverter JPG ke JPEG2000 untuk Java - konversi dalam aplikasi Java"
head_description: "Tampilkan file JPG ke JPEG2000 dalam aplikasi Java, J2EE, J2SE. Mendukung penampilan lebih dari 180 format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi penampilan dokumen."

############################# Header ############################
title: "Konversi JPG ke JPEG2000 dalam Java" 
description: "Rasakan efisiensi dari API konverter file yang asli dan berkinerja tinggi dari JPG ke JPEG2000 yang dirancang untuk aplikasi Java, J2EE, dan J2SE. Nikmati dukungan untuk serangkaian fitur tambahan yang luas, memungkinkan penyesuaian penampilan dokumen output." 
...
steps:
    enable: true
    title: "Langkah-langkah untuk mengonversi file JPG ke JPEG2000 dalam Java" 
    content: |
      Pemrosesan JPG ke JPEG2000 dibuat sederhana dengan <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, hanya memerlukan beberapa langkah sederhana.
      ...
      3. Muat file JPG dengan jalur lengkap. 
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convertTo("converted.jpeg2000")    // Tentukan jalur output untuk file yang dikonversi
            .convert();                    // Konversi file JPG ke JPEG2000        
        ```            
