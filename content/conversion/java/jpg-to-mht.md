...
############################# Head ############################
head_title: "JPG to MHT Conversion in Java – Convert JPG to MHT"
head_description: "Convert JPG to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to MHT in few lines of code.
...
demos:
    enable: true
    title: "JPG to MHT Live Demos"
    content: |
        Convert JPG to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
