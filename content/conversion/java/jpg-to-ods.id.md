...
head_title: "Konversi JPG ke ODS di Jawa – Konversi JPG ke ODS"
head_description: "Konversi JPG ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga ODS"
    content: |
        Konversikan JPG ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
