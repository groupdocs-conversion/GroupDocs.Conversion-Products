...
head_title: "Konversi JPG ke ODT di Jawa – Konversi JPG ke ODT"
head_description: "Konversi JPG ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga ODT"
    content: |
        Konversikan JPG ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
