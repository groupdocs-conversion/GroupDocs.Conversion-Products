...
############################# Head ############################
head_title: "JPG to ODT Conversion in Java – Convert JPG to ODT"
head_description: "Convert JPG to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to ODT in few lines of code.
...
demos:
    enable: true
    title: "JPG to ODT Live Demos"
    content: |
        Convert JPG to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
