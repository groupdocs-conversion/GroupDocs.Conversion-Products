...
head_title: "Konversi JPG ke POT di Jawa – Konversi JPG ke POT"
head_description: "Konversi JPG ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke POT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga POT"
    content: |
        Konversikan JPG ke POT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
