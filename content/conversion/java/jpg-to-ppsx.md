...
############################# Head ############################
head_title: "JPG to PPSX Conversion in Java – Convert JPG to PPSX"
head_description: "Convert JPG to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "JPG to PPSX Live Demos"
    content: |
        Convert JPG to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
