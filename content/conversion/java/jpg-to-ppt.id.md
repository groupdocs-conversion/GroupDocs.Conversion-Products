...
head_title: "Konversi JPG ke PPT di Jawa – Konversi JPG ke PPT"
head_description: "Konversi JPG ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke PPT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga PPT"
    content: |
        Konversikan JPG ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
