...
head_title: "Konversi JPG ke PPTX di Jawa – Konversi JPG ke PPTX"
head_description: "Konversi JPG ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke PPTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga PPTX"
    content: |
        Konversikan JPG ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
