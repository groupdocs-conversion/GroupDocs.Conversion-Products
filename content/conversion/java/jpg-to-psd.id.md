...
head_title: "Konversi JPG ke PSD di Jawa – Konversi JPG ke PSD"
head_description: "Konversi JPG ke PSD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke PSD di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke PSD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga PSD"
    content: |
        Konversikan JPG ke PSD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
