...
############################# Head ############################
head_title: "JPG to PSD Conversion in Java – Convert JPG to PSD"
head_description: "Convert JPG to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to PSD in few lines of code.
...
demos:
    enable: true
    title: "JPG to PSD Live Demos"
    content: |
        Convert JPG to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
