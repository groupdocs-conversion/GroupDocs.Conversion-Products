...
head_title: "Konversi JPG ke TEX di Jawa – Konversi JPG ke TEX"
head_description: "Konversi JPG ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga TEX"
    content: |
        Konversikan JPG ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
