...
############################# Head ############################
head_title: "JPG to WMF Conversion in Java – Convert JPG to WMF"
head_description: "Convert JPG to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to WMF in few lines of code.
...
demos:
    enable: true
    title: "JPG to WMF Live Demos"
    content: |
        Convert JPG to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
