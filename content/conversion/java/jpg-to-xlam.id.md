...
head_title: "Konversi JPG ke XLAM di Jawa – Konversi JPG ke XLAM"
head_description: "Konversi JPG ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga XLAM"
    content: |
        Konversikan JPG ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
