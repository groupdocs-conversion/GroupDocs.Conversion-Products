...
head_title: "Konversi JPG ke XLSX di Jawa – Konversi JPG ke XLSX"
head_description: "Konversi JPG ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPG ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPG ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPG ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPG hingga XLSX"
    content: |
        Konversikan JPG ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
