...
head_title: "Konversi JPM ke EPUB di Jawa – Konversi JPM ke EPUB"
head_description: "Konversi JPM ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPM ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPM ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPM ke EPUB dalam beberapa baris kode.
