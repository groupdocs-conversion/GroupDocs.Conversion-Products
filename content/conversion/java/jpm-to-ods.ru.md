...
############################# Head ############################
head_title: "Преобразование JPM в ODS в Java — преобразование JPM в ODS"
head_description: "Преобразуйте JPM в ODS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов JPM в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию JPM в ODS в Java"
    content_left: |
