...
head_title: "Konversi JPM ke SXC di Jawa – Konversi JPM ke SXC"
head_description: "Konversi JPM ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPM ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPM ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPM ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPM hingga SXC"
    content: |
        Konversikan JPM ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
