...
############################# Head ############################
head_title: "JPM to TIF Conversion in Java – Convert JPM to TIF"
head_description: "Convert JPM to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPM Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPM to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPM file to TIF in few lines of code.
...
demos:
    enable: true
    title: "JPM to TIF Live Demos"
    content: |
        Convert JPM to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
