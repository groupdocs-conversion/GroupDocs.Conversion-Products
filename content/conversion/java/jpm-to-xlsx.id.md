...
head_title: "Konversi JPM ke XLSX di Jawa – Konversi JPM ke XLSX"
head_description: "Konversi JPM ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPM ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPM ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPM ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPM hingga XLSX"
    content: |
        Konversikan JPM ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
