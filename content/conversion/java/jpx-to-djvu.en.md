...
breadcrumb: JPX to DJVU in Java

############################# Head ############################
head_title: "JPX to DJVU Converter in Java"
head_description: "Convert JPX to DJVU in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert JPX to DJVU in Java"
description: "JPX to DJVU conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your JPX files to DJVU in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert JPX to DJVU in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a JPX file to DJVU with a few lines of code.
