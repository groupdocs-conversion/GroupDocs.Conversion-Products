...
############################# Head ############################
head_title: "JPX to DOCX Conversion in Java – Convert JPX to DOCX"
head_description: "Convert JPX to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "JPX to DOCX Live Demos"
    content: |
        Convert JPX to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
