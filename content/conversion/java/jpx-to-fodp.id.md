...
head_title: "Konversi JPX ke FODP di Jawa – Konversi JPX ke FODP"
head_description: "Konversi JPX ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga FODP"
    content: |
        Konversikan JPX ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
