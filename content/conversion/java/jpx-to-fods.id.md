...
head_title: "Konversi JPX ke FODS di Jawa – Konversi JPX ke FODS"
head_description: "Konversi JPX ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga FODS"
    content: |
        Konversikan JPX ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
