...
head_title: "Konversi JPX ke HTM di Jawa – Konversi JPX ke HTM"
head_description: "Konversi JPX ke HTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke HTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke HTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke HTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga HTM"
    content: |
        Konversikan JPX ke HTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
