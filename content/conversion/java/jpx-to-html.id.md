...
head_title: "Konversi JPX ke HTML di Jawa – Konversi JPX ke HTML"
head_description: "Konversi JPX ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga HTML"
    content: |
        Konversikan JPX ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
