...
############################# Head ############################
head_title: "JPX to HTML Conversion in Java – Convert JPX to HTML"
head_description: "Convert JPX to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to HTML in few lines of code.
...
demos:
    enable: true
    title: "JPX to HTML Live Demos"
    content: |
        Convert JPX to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
