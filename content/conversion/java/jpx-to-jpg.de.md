...
############################# Head #############################
head_title: "Java JPX zu JPG Konverter API - JPX in Java-Anwendungen transformieren"
head_description: "JPX zu JPG Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "JPX in JPG in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken JPX zu JPG Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von JPX in JPG Datei in Java" 
    content: |
      Die Transformation von JPX in JPG wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die JPX Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.jpx")              // Richten Sie die Eingabedatei JPX ein
            .convertTo("converted.jpg")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                    // JPX in JPG Datei konvertieren        
        ```            
