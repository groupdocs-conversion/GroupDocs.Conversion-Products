...
############################# Head #############################
head_title: "Java JPX to JPG Converter API - transform JPX to JPG in Java apps"
head_description: "View JPX to JPG files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert JPX to JPG in Java" 
description: "Experience the efficiency of a native, high-performance JPX to JPG file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert JPX to JPG file in Java" 
    content: |
      Transforming JPX to JPG is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the JPX file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.jpx")              // Set up input JPX file
            .convertTo("converted.jpg")    // Specify output path for converted file
            .convert();                    // Convert JPX to JPG file        
        ```            
