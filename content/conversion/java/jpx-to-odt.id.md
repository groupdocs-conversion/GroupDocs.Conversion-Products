...
head_title: "Konversi JPX ke ODT di Jawa – Konversi JPX ke ODT"
head_description: "Konversi JPX ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga ODT"
    content: |
        Konversikan JPX ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
