...
head_title: "Konversi JPX ke POTM di Jawa – Konversi JPX ke POTM"
head_description: "Konversi JPX ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke POTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga POTM"
    content: |
        Konversikan JPX ke POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
