...
head_title: "Konversi JPX ke PPSX di Jawa – Konversi JPX ke PPSX"
head_description: "Konversi JPX ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke PPSX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga PPSX"
    content: |
        Konversikan JPX ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
