...
head_title: "Konversi JPX ke TEX di Jawa – Konversi JPX ke TEX"
head_description: "Konversi JPX ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga TEX"
    content: |
        Konversikan JPX ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
