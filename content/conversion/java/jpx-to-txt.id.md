...
head_title: "Konversi JPX ke TXT di Jawa – Konversi JPX ke TXT"
head_description: "Konversi JPX ke TXT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke TXT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke TXT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke TXT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga TXT"
    content: |
        Konversikan JPX ke TXT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
