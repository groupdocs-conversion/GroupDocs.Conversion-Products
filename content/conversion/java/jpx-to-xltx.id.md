...
head_title: "Konversi JPX ke XLTX di Jawa – Konversi JPX ke XLTX"
head_description: "Konversi JPX ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga XLTX"
    content: |
        Konversikan JPX ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
