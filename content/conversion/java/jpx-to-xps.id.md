...
head_title: "Konversi JPX ke XPS di Jawa – Konversi JPX ke XPS"
head_description: "Konversi JPX ke XPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File JPX ke XPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi JPX ke XPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file JPX ke XPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung JPX hingga XPS"
    content: |
        Konversikan JPX ke XPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
