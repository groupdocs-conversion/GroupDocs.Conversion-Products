...
############################# Head #############################
head_title: "Java API แปลง JSON เป็น DOCX - แปลงในแอปพลิเคชัน Java"
...
############################# Header ############################
title: "แปลง JSON เป็น DOCX ใน Java" 
description: "ประสบการณ์ API ที่มีประสิทธิภาพสูงสำหรับการแปลงไฟล์ JSON เป็น DOCX สำหรับแอปพลิเคชัน Java, J2EE และ J2SE มีการรองรับคุณลักษณะเพิ่มเติมอย่างหลากหลายเพื่อการปรับแต่งรูปแบบเอกสารผลลัพธ์" 
...
steps:
    enable: true
    title: "ขั้นตอนในการแปลงไฟล์ JSON เป็นไฟล์ DOCX ใน Java" 
    content: |
      การแปลง JSON เป็น DOCX กลายเป็นง่ายด้วย <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> คุณจำเป็นต้องทำเพียงไม่กี่ขั้นตอนง่ายๆ
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // แปลงไฟล์ JSON เป็นไฟล์ DOCX        
        ```            
