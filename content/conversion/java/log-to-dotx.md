...
############################# Head ############################
head_title: "LOG to DOTX Conversion in Java – Convert LOG to DOTX"
head_description: "Convert LOG to DOTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to DOTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to DOTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to DOTX in few lines of code.
...
demos:
    enable: true
    title: "LOG to DOTX Live Demos"
    content: |
        Convert LOG to DOTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
