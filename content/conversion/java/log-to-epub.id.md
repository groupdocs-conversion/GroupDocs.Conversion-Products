...
head_title: "Konversi LOG ke EPUB di Jawa – Konversi LOG ke EPUB"
head_description: "Konversi LOG ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File LOG ke EPUB di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file LOG ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung LOG hingga EPUB"
    content: |
        Konversikan LOG ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
