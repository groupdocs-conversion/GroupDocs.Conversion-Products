...
head_title: "Konversi LOG ke ODS di Jawa – Konversi LOG ke ODS"
head_description: "Konversi LOG ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File LOG ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi LOG ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file LOG ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung LOG hingga ODS"
    content: |
        Konversikan LOG ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
