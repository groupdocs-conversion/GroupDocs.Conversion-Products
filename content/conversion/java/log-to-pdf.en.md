...
############################# Head #############################
head_title: "Java LOG to PDF Converter API - transform LOG to PDF in Java apps"
head_description: "View LOG to PDF files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert LOG to PDF in Java" 
description: "Experience the efficiency of a native, high-performance LOG to PDF file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert LOG to PDF file in Java" 
    content: |
      Transforming LOG to PDF is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // Convert LOG to PDF file        
        ```            
