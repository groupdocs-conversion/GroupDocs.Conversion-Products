...
breadcrumb: LOG to PHOTOSHOP in Java

############################# Head ############################
head_title: "LOG to PHOTOSHOP Converter in Java"
head_description: "Convert LOG to PHOTOSHOP in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert LOG to PHOTOSHOP in Java"
description: "LOG to PHOTOSHOP conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your LOG files to PHOTOSHOP in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert LOG to PHOTOSHOP in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a LOG file to PHOTOSHOP with a few lines of code.
