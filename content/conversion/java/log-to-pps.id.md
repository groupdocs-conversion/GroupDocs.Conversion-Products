...
head_title: "Konversi LOG ke PPS di Jawa – Konversi LOG ke PPS"
head_description: "Konversi LOG ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File LOG ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi LOG ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file LOG ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung LOG hingga PPS"
    content: |
        Konversikan LOG ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
