...
############################# Head ############################
head_title: "LOG to PPTM Conversion in Java – Convert LOG to PPTM"
head_description: "Convert LOG to PPTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to PPTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to PPTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to PPTM in few lines of code.
...
demos:
    enable: true
    title: "LOG to PPTM Live Demos"
    content: |
        Convert LOG to PPTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
