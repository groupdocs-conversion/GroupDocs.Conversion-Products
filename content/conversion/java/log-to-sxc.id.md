...
head_title: "Konversi LOG ke SXC di Jawa – Konversi LOG ke SXC"
head_description: "Konversi LOG ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File LOG ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi LOG ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file LOG ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung LOG hingga SXC"
    content: |
        Konversikan LOG ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
