...
############################# Head ############################
head_title: "LOG to SXC Conversion in Java – Convert LOG to SXC"
head_description: "Convert LOG to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to SXC in few lines of code.
...
demos:
    enable: true
    title: "LOG to SXC Live Demos"
    content: |
        Convert LOG to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
