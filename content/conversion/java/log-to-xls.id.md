...
head_title: "Konversi LOG ke XLS di Jawa – Konversi LOG ke XLS"
head_description: "Konversi LOG ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File LOG ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi LOG ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file LOG ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung LOG hingga XLS"
    content: |
        Konversikan LOG ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
