...
############################# Head #############################
head_title: "Java LOG zu XLSX Konverter API - LOG in Java-Anwendungen transformieren"
head_description: "LOG zu XLSX Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "LOG in XLSX in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken LOG zu XLSX Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von LOG in XLSX Datei in Java" 
    content: |
      Die Transformation von LOG in XLSX wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // LOG in XLSX Datei konvertieren        
        ```            
