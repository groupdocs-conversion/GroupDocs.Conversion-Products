...
head_title: "Konversi LOG ke XLSX di Jawa – Konversi LOG ke XLSX"
head_description: "Konversi LOG ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File LOG ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi LOG ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file LOG ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung LOG hingga XLSX"
    content: |
        Konversikan LOG ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
