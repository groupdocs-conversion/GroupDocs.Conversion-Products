...
############################# Head ############################
head_title: "LOG to XLSX Conversion in Java – Convert LOG to XLSX"
head_description: "Convert LOG to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "LOG to XLSX Live Demos"
    content: |
        Convert LOG to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
