...
############################# Head #############################
head_title: "Java MB zu HTML Konverter API - MB in Java-Anwendungen transformieren"
head_description: "MB zu HTML Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "MB in HTML in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken MB zu HTML Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von MB in HTML Datei in Java" 
    content: |
      Die Transformation von MB in HTML wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die MB Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.mb")              // Richten Sie die Eingabedatei MB ein
            .convertTo("converted.html")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // MB in HTML Datei konvertieren        
        ```            
