...
head_title: "Konversi MBOX ke FODP di Jawa – Konversi MBOX ke FODP"
head_description: "Konversi MBOX ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MBOX ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MBOX ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MBOX ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MBOX hingga FODP"
    content: |
        Konversikan MBOX ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
