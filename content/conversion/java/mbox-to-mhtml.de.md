...
############################# Head #############################
head_title: "Java MBOX zu MHTML Konverter API - MBOX in Java-Anwendungen transformieren"
head_description: "MBOX zu MHTML Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "MBOX in MHTML in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken MBOX zu MHTML Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von MBOX in MHTML Datei in Java" 
    content: |
      Die Transformation von MBOX in MHTML wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die MBOX Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.mbox")              // Richten Sie die Eingabedatei MBOX ein
            .convertTo("converted.mhtml")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // MBOX in MHTML Datei konvertieren        
        ```            
