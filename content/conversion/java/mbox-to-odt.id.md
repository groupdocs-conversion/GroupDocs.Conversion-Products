...
head_title: "Konversi MBOX ke ODT di Jawa – Konversi MBOX ke ODT"
head_description: "Konversi MBOX ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MBOX ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MBOX ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MBOX ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MBOX hingga ODT"
    content: |
        Konversikan MBOX ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
