...
############################# Head ############################
head_title: "Преобразование MBOX в OTT в Java — преобразование MBOX в OTT"
head_description: "Преобразование MBOX в OTT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов MBOX в OTT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию MBOX в OTT в Java"
    content_left: |
