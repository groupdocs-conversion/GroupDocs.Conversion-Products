...
head_title: "Konversi MBOX ke PPTX di Jawa – Konversi MBOX ke PPTX"
head_description: "Konversi MBOX ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MBOX ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MBOX ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MBOX ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MBOX hingga PPTX"
    content: |
        Konversikan MBOX ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
