...
############################# Head ############################
head_title: "MBOX to RTF Conversion in Java – Convert MBOX to RTF"
head_description: "Convert MBOX to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MBOX Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MBOX to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MBOX file to RTF in few lines of code.
...
demos:
    enable: true
    title: "MBOX to RTF Live Demos"
    content: |
        Convert MBOX to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
