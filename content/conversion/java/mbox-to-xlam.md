...
############################# Head ############################
head_title: "MBOX to XLAM Conversion in Java – Convert MBOX to XLAM"
head_description: "Convert MBOX to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MBOX Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MBOX to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MBOX file to XLAM in few lines of code.
