...
head_title: "Konversi MBOX ke XLSX di Jawa – Konversi MBOX ke XLSX"
head_description: "Konversi MBOX ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MBOX ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MBOX ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MBOX ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MBOX hingga XLSX"
    content: |
        Konversikan MBOX ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
