...
############################# Head #############################
head_title: "Java MBOX to XML Converter API - transform MBOX to XML in Java apps"
head_description: "View MBOX to XML files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert MBOX to XML in Java" 
description: "Experience the efficiency of a native, high-performance MBOX to XML file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert MBOX to XML file in Java" 
    content: |
      Transforming MBOX to XML is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the MBOX file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.mbox")              // Set up input MBOX file
            .convertTo("converted.xml")    // Specify output path for converted file
            .convert();                    // Convert MBOX to XML file        
        ```            
