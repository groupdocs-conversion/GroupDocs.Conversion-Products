...
############################# Head ############################
head_title: "Преобразование MBOX в XPS в Java — преобразование MBOX в XPS"
head_description: "Преобразование MBOX в XPS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов MBOX в XPS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию MBOX в XPS в Java"
    content_left: |
