...
############################# Head ############################
head_title: "MD to DOT Conversion in Java – Convert MD to DOT"
head_description: "Convert MD to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to DOT in few lines of code.
...
demos:
    enable: true
    title: "MD to DOT Live Demos"
    content: |
        Convert MD to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
