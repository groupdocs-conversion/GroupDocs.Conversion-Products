...
head_title: "Konversi MD ke FODP di Jawa – Konversi MD ke FODP"
head_description: "Konversi MD ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MD ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MD ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MD ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MD hingga FODP"
    content: |
        Konversikan MD ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
