...
head_title: "Konversi MD ke POT di Jawa – Konversi MD ke POT"
head_description: "Konversi MD ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MD ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MD ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MD ke POT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MD hingga POT"
    content: |
        Konversikan MD ke POT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
