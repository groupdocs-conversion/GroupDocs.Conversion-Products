...
head_title: "Konversi MD ke POTX di Jawa – Konversi MD ke POTX"
head_description: "Konversi MD ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MD ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MD ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MD ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MD hingga POTX"
    content: |
        Konversikan MD ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
