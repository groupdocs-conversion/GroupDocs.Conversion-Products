...
head_title: "Konversi MD ke PPS di Jawa – Konversi MD ke PPS"
head_description: "Konversi MD ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MD ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MD ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MD ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MD hingga PPS"
    content: |
        Konversikan MD ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
