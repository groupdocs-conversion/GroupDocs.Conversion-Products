...
head_title: "Konversi MD ke PPT di Jawa – Konversi MD ke PPT"
head_description: "Konversi MD ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MD ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MD ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MD ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MD hingga PPT"
    content: |
        Konversikan MD ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
