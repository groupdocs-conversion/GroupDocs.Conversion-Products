...
head_title: "Konversi MD ke PPTM di Jawa – Konversi MD ke PPTM"
head_description: "Konversi MD ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MD ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MD ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MD ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MD hingga PPTM"
    content: |
        Konversikan MD ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
