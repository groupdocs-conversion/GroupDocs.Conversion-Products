...
############################# Head ############################
head_title: "MD to PPTX Conversion in Java – Convert MD to PPTX"
head_description: "Convert MD to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "MD to PPTX Live Demos"
    content: |
        Convert MD to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
