...
############################# Head ############################
head_title: "MD to SVG Conversion in Java – Convert MD to SVG"
head_description: "Convert MD to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to SVG in few lines of code.
