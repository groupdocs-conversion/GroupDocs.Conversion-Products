...
head_title: "Konversi MD ke SXC di Jawa – Konversi MD ke SXC"
head_description: "Konversi MD ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MD ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MD ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MD ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MD hingga SXC"
    content: |
        Konversikan MD ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
