...
head_title: "Konversi MD ke XLAM di Jawa – Konversi MD ke XLAM"
head_description: "Konversi MD ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MD ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MD ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MD ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MD hingga XLAM"
    content: |
        Konversikan MD ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
