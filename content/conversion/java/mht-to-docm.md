...
############################# Head ############################
head_title: "MHT to DOCM Conversion in Java – Convert MHT to DOCM"
head_description: "Convert MHT to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "MHT to DOCM Live Demos"
    content: |
        Convert MHT to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
