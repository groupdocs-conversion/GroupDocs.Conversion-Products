...
############################# Head #############################
head_title: "Java MHT zu JSON Konverter API - MHT in Java-Anwendungen transformieren"
head_description: "MHT zu JSON Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "MHT in JSON in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von MHT in JSON Datei in Java" 
    content: |
      Die Transformation von MHT in JSON wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // MHT in JSON Datei konvertieren        
        ```            
