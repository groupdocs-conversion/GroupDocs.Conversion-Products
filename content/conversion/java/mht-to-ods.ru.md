...
############################# Head ############################
head_title: "Преобразование MHT в ODS в Java — преобразование MHT в ODS"
head_description: "Преобразуйте MHT в ODS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов MHT в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию MHT в ODS в Java"
    content_left: |
