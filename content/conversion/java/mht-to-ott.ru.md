...
############################# Head ############################
head_title: "Преобразование MHT в OTT в Java — преобразование MHT в OTT"
head_description: "Преобразование MHT в OTT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов MHT в OTT в Java"
...
demos:
    enable: true
    title: "MHT в OTT Живые демонстрации"
    content: |
