...
############################# Head #############################
head_title: "Java MHTML to HTML Converter API - transform MHTML to HTML in Java apps"
head_description: "View MHTML to HTML files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert MHTML to HTML in Java" 
description: "Experience the efficiency of a native, high-performance MHTML to HTML file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert MHTML to HTML file in Java" 
    content: |
      Transforming MHTML to HTML is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the MHTML file with full path. 
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert MHTML to HTML file        
        ```            
