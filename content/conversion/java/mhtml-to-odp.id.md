...
head_title: "Konversi MHTML ke ODP di Jawa – Konversi MHTML ke ODP"
head_description: "Konversi MHTML ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MHTML ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MHTML ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MHTML ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MHTML hingga ODP"
    content: |
        Konversikan MHTML ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
