...
head_title: "Konversi MOBI ke EMZ di Jawa – Konversi MOBI ke EMZ"
head_description: "Konversi MOBI ke EMZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MOBI ke EMZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MOBI ke EMZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MOBI ke EMZ dalam beberapa baris kode.
