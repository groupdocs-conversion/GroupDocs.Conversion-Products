...
head_title: "Konversi MOBI ke FODP di Jawa – Konversi MOBI ke FODP"
head_description: "Konversi MOBI ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MOBI ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MOBI ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MOBI ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MOBI hingga FODP"
    content: |
        Konversikan MOBI ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
