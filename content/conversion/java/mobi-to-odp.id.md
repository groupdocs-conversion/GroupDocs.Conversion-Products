...
head_title: "Konversi MOBI ke ODP di Jawa – Konversi MOBI ke ODP"
head_description: "Konversi MOBI ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MOBI ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MOBI ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MOBI ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MOBI hingga ODP"
    content: |
        Konversikan MOBI ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
