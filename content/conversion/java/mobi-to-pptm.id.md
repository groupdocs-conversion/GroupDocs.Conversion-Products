...
head_title: "Konversi MOBI ke PPTM di Jawa – Konversi MOBI ke PPTM"
head_description: "Konversi MOBI ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MOBI ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MOBI ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MOBI ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MOBI hingga PPTM"
    content: |
        Konversikan MOBI ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
