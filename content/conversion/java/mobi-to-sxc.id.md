...
head_title: "Konversi MOBI ke SXC di Jawa – Konversi MOBI ke SXC"
head_description: "Konversi MOBI ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MOBI ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MOBI ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MOBI ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MOBI hingga SXC"
    content: |
        Konversikan MOBI ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
