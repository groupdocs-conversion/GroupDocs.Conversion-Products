...
head_title: "Konversi MOBI ke XLS di Jawa – Konversi MOBI ke XLS"
head_description: "Konversi MOBI ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MOBI ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MOBI ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MOBI ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MOBI hingga XLS"
    content: |
        Konversikan MOBI ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
