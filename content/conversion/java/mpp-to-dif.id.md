...
head_title: "Konversi MPP ke DIF di Jawa – Konversi MPP ke DIF"
head_description: "Konversi MPP ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPP ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPP ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPP ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPP hingga DIF"
    content: |
        Konversikan MPP ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
