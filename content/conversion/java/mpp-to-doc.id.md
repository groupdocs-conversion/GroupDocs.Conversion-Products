...
head_title: "Konversi MPP ke DOC di Jawa – Konversi MPP ke DOC"
head_description: "Konversi MPP ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPP ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPP ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPP ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPP hingga DOC"
    content: |
        Konversikan MPP ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
