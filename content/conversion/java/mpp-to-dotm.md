...
############################# Head ############################
head_title: "MPP to DOTM Conversion in Java – Convert MPP to DOTM"
head_description: "Convert MPP to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "MPP to DOTM Live Demos"
    content: |
        Convert MPP to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
