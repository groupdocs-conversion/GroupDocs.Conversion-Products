...
############################# Head ############################
head_title: "MPP to GIF Conversion in Java – Convert MPP to GIF"
head_description: "Convert MPP to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to GIF in few lines of code.
...
demos:
    enable: true
    title: "MPP to GIF Live Demos"
    content: |
        Convert MPP to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
