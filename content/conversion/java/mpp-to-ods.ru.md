...
############################# Head ############################
head_title: "Преобразование MPP в ODS в Java — преобразование MPP в ODS"
head_description: "Преобразование MPP в ODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов MPP в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию MPP в ODS в Java"
    content_left: |
