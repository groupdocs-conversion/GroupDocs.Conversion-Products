...
head_title: "Konversi MPP ke ODT di Jawa – Konversi MPP ke ODT"
head_description: "Konversi MPP ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPP ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPP ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPP ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPP hingga ODT"
    content: |
        Konversikan MPP ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
