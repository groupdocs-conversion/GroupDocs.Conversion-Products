...
head_title: "Konversi MPP ke OTS di Jawa – Konversi MPP ke OTS"
head_description: "Konversi MPP ke OTS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPP ke OTS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPP ke OTS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPP ke OTS dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file MPP dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen OTS
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (OTS) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format OTS target
