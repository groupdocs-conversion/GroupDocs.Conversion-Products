...
head_title: "Konversi MPP ke OTT di Jawa – Konversi MPP ke OTT"
head_description: "Konversi MPP ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPP ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPP ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPP ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPP hingga OTT"
    content: |
        Konversikan MPP ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
