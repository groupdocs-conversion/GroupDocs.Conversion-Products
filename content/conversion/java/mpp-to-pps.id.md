...
head_title: "Konversi MPP ke PPS di Jawa – Konversi MPP ke PPS"
head_description: "Konversi MPP ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPP ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPP ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPP ke PPS dalam beberapa baris kode.
