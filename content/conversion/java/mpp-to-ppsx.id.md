...
head_title: "Konversi MPP ke PPSX di Jawa – Konversi MPP ke PPSX"
head_description: "Konversi MPP ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPP ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPP ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPP ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPP hingga PPSX"
    content: |
        Konversikan MPP ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
