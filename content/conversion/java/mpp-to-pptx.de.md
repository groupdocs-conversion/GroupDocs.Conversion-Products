...
############################# Head #############################
head_title: "Java MPP zu PPTX Konverter API - MPP in Java-Anwendungen transformieren"
head_description: "MPP zu PPTX Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "MPP in PPTX in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken MPP zu PPTX Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von MPP in PPTX Datei in Java" 
    content: |
      Die Transformation von MPP in PPTX wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
