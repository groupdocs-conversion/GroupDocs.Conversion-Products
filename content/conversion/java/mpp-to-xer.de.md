...
############################# Head #############################
head_title: "Java MPP zu XER Konverter API - MPP in Java-Anwendungen transformieren"
head_description: "MPP zu XER Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "MPP in XER in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken MPP zu XER Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von MPP in XER Datei in Java" 
    content: |
      Die Transformation von MPP in XER wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // MPP in XER Datei konvertieren        
        ```            
