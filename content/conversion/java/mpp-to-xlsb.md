...
############################# Head ############################
head_title: "MPP to XLSB Conversion in Java – Convert MPP to XLSB"
head_description: "Convert MPP to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to XLSB in few lines of code.
...
demos:
    enable: true
    title: "MPP to XLSB Live Demos"
    content: |
        Convert MPP to XLSB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
