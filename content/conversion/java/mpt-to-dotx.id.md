...
head_title: "Konversi MPT ke DOTX di Jawa – Konversi MPT ke DOTX"
head_description: "Konversi MPT ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPT ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPT ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPT ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPT hingga DOTX"
    content: |
        Konversikan MPT ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
