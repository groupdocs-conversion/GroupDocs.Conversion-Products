...
head_title: "Konversi MPT ke EPUB di Jawa – Konversi MPT ke EPUB"
head_description: "Konversi MPT ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPT ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPT ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPT ke EPUB dalam beberapa baris kode.
