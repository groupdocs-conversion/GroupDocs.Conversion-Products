...
############################# Head ############################
head_title: "MPT to HTML Conversion in Java – Convert MPT to HTML"
head_description: "Convert MPT to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to HTML in few lines of code.
...
demos:
    enable: true
    title: "MPT to HTML Live Demos"
    content: |
        Convert MPT to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
