...
############################# Head ############################
head_title: "MPT to MD Conversion in Java – Convert MPT to MD"
head_description: "Convert MPT to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to MD in few lines of code.
...
demos:
    enable: true
    title: "MPT to MD Live Demos"
    content: |
        Convert MPT to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
