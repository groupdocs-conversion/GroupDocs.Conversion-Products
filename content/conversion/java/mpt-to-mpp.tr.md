...
breadcrumb: MPT - MPP, Java içinde

############################# Head ############################
head_title: "MPT öğesini Java içinde MPP biçimine dönüştürün"
head_description: "Birkaç satır kodla Java ürününde MPT - MPP dönüşümü. Java için GroupDocs belge dönüştürme API'sini kullanarak 160'tan fazla dosya biçimini dönüştürün"

############################# Header ############################
title: "MPT öğesini Java içinde MPP biçimine dönüştürün"
description: "Birkaç satır Java koduyla MPT - MPP dönüşümü"
...
overview:
    enable: true
    content: |
        MPT dosyalarınızı Java içinde MPP dosyasına dönüştürün. Windows, Linux, macOS gibi seçtiğiniz herhangi bir platformda yalnızca birkaç satır Java kodu gerekir.
        MPT öğesini MPP biçimine ücretsiz olarak dönüştürmeyi deneyebilir ve dönüşüm sonuçlarının kalitesini değerlendirebilirsiniz. Basit dosya dönüştürme komut dosyalarının yanı sıra, MPT kaynak dosyasını yüklemek ve MPP çıktısını depolamak için daha karmaşık seçenekleri deneyebilirsiniz. 
        ...
        * belgenin görünümünü korumak için eksik yazı tiplerini değiştirin.
        ...
        MPP dosyası için gelişmiş dönüştürme seçenekleri de vardır:

        * bir belgenin belirli bir sayfasını veya bir dizi sayfayı dönüştürmek;
        * dönüştürülmüş MPP öğesine bir filigran ekleyin.

        Dönüştürme işlemi tamamlandıktan sonra, MPP dosyasını yerel dosya yolunuza veya FTP, Amazon S3, Google Drive, Dropbox vb. gibi herhangi bir üçüncü taraf depolama alanına kaydedebilirsiniz. Lütfen dikkat - MPT dönüştürmek için MPP için MS Office, Open Office, Adobe Acrobat Reader vb. gibi herhangi bir ek yazılım yüklemeniz gerekmez.


############################# Steps ############################
steps:
    enable: true
    title_left: "Java içinde MPT öğesini MPP biçimine dönüştürme adımları"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/), geliştiricilerin birkaç satır kodla MPT dosyasını MPP dosyasına kolayca dönüştürmesine olanak tanır.
        
        * Converter sınıfının yeni bir örneğini oluşturun ve tam yolla MPT dosyasını yükleyin
        * Belge türü için ConvertOptions'ı MPP olarak ayarlayın
        * convert() yöntemini çağırın ve belge adını (tam yol) ve biçimi (MPP) parametre olarak iletin
    ...
    code: |
        ...
        // Dönüştürme için MPT kaynak dosyasını yükleyin
          ...
          // MPP hedef biçimi için dönüşüm seçenekleri hazırlayın
          ConvertOptions convertOptions = new FileType().fromExtension("mpp").getConvertOptions();
          // MPP biçimine dönüştürün
          converter.convert("output.mpp", convertOptions);
        ```

demos:
    enable: true
    title: "MPT - MPP Canlı Demo"
    content: |
       [GroupDocs.Conversion Uygulaması](https://products.groupdocs.app/conversion/family) web sitemizi ziyaret edin ve MPT - MPP dönüşümünü şimdi deneyin. Ücretsiz demo aşağıdaki avantajlara sahiptir
