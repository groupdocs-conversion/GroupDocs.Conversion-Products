...
head_title: "Konversi MPT ke ODP di Jawa – Konversi MPT ke ODP"
head_description: "Konversi MPT ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPT ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPT ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPT ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPT hingga ODP"
    content: |
        Konversikan MPT ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
