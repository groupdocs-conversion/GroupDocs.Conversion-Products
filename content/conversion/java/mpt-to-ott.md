...
############################# Head ############################
head_title: "MPT to OTT Conversion in Java – Convert MPT to OTT"
head_description: "Convert MPT to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to OTT in few lines of code.
...
demos:
    enable: true
    title: "MPT to OTT Live Demos"
    content: |
        Convert MPT to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
