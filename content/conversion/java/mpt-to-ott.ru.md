...
############################# Head ############################
head_title: "Преобразование MPT в OTT в Java — Преобразование MPT в OTT"
head_description: "Преобразование MPT в OTT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов MPT в OTT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию MPT в OTT в Java"
    content_left: |
