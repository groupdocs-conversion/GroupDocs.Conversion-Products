...
############################# Head ############################
head_title: "MPT to PDF Conversion in Java – Convert MPT to PDF"
head_description: "Convert MPT to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to PDF in few lines of code.
