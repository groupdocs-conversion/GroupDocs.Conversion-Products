...
head_title: "Konversi MPT ke PPTM di Jawa – Konversi MPT ke PPTM"
head_description: "Konversi MPT ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPT ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPT ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPT ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPT hingga PPTM"
    content: |
        Konversikan MPT ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
