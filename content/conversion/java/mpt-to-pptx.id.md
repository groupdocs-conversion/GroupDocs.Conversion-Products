...
head_title: "Konversi MPT ke PPTX di Jawa – Konversi MPT ke PPTX"
head_description: "Konversi MPT ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPT ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPT ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPT ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPT hingga PPTX"
    content: |
        Konversikan MPT ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
