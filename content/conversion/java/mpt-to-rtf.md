...
############################# Head ############################
head_title: "MPT to RTF Conversion in Java – Convert MPT to RTF"
head_description: "Convert MPT to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to RTF in few lines of code.
...
demos:
    enable: true
    title: "MPT to RTF Live Demos"
    content: |
        Convert MPT to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
