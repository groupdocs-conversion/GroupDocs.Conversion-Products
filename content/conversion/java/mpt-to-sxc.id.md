...
head_title: "Konversi MPT ke SXC di Jawa – Konversi MPT ke SXC"
head_description: "Konversi MPT ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPT ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPT ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPT ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPT hingga SXC"
    content: |
        Konversikan MPT ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
