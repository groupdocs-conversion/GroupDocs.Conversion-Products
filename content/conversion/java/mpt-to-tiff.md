...
############################# Head ############################
head_title: "MPT to TIFF Conversion in Java – Convert MPT to TIFF"
head_description: "Convert MPT to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "MPT to TIFF Live Demos"
    content: |
        Convert MPT to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
