...
############################# Head ############################
head_title: "MPT to WEBP Conversion in Java – Convert MPT to WEBP"
head_description: "Convert MPT to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "MPT to WEBP Live Demos"
    content: |
        Convert MPT to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
