...
head_title: "Konversi MPT ke XLS di Jawa – Konversi MPT ke XLS"
head_description: "Konversi MPT ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPT ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPT ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPT ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPT hingga XLS"
    content: |
        Konversikan MPT ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
