...
############################# Head ############################
head_title: "MPX to BMP Conversion in Java – Convert MPX to BMP"
head_description: "Convert MPX to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to BMP in few lines of code.
...
demos:
    enable: true
    title: "MPX to BMP Live Demos"
    content: |
        Convert MPX to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
