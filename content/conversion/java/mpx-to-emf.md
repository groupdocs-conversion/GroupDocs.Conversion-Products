...
############################# Head ############################
head_title: "MPX to EMF Conversion in Java – Convert MPX to EMF"
head_description: "Convert MPX to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to EMF in few lines of code.
...
demos:
    enable: true
    title: "MPX to EMF Live Demos"
    content: |
        Convert MPX to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
