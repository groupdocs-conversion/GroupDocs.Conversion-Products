...
############################# Head ############################
head_title: "MPX to EPUB Conversion in Java – Convert MPX to EPUB"
head_description: "Convert MPX to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "MPX to EPUB Live Demos"
    content: |
        Convert MPX to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
