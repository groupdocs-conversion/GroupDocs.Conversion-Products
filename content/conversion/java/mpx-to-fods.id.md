...
head_title: "Konversi MPX ke FODS di Jawa – Konversi MPX ke FODS"
head_description: "Konversi MPX ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPX ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPX ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPX ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPX hingga FODS"
    content: |
        Konversikan MPX ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
