...
############################# Head ############################
head_title: "MPX to MHTML Conversion in Java – Convert MPX to MHTML"
head_description: "Convert MPX to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "MPX to MHTML Live Demos"
    content: |
        Convert MPX to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
