...
############################# Head #############################
head_title: "Java MPX to MPP Converter API - transform MPX to MPP in Java apps"
head_description: "View MPX to MPP files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert MPX to MPP in Java" 
description: "Experience the efficiency of a native, high-performance MPX to MPP file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert MPX to MPP file in Java" 
    content: |
      Transforming MPX to MPP is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert MPX to MPP file        
        ```            
