...
head_title: "Konversi MPX ke ODT di Jawa – Konversi MPX ke ODT"
head_description: "Konversi MPX ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPX ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPX ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPX ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPX hingga ODT"
    content: |
        Konversikan MPX ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
