...
head_title: "Konversi MPX ke OTT di Jawa – Konversi MPX ke OTT"
head_description: "Konversi MPX ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPX ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPX ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPX ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPX hingga OTT"
    content: |
        Konversikan MPX ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
