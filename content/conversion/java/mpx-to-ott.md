...
############################# Head ############################
head_title: "MPX to OTT Conversion in Java – Convert MPX to OTT"
head_description: "Convert MPX to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to OTT in few lines of code.
