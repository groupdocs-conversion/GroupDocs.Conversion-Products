...
############################# Head ############################
head_title: "Преобразование MPX в OTT в Java — преобразование MPX в OTT"
head_description: "Преобразование MPX в OTT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов MPX в OTT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию MPX в OTT в Java"
    content_left: |
