...
############################# Head ############################
head_title: "MPX to PNG Conversion in Java – Convert MPX to PNG"
head_description: "Convert MPX to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to PNG in few lines of code.
...
demos:
    enable: true
    title: "MPX to PNG Live Demos"
    content: |
        Convert MPX to PNG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
