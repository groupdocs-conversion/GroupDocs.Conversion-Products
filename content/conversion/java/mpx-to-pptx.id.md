...
head_title: "Konversi MPX ke PPTX di Jawa – Konversi MPX ke PPTX"
head_description: "Konversi MPX ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPX ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPX ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPX ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPX hingga PPTX"
    content: |
        Konversikan MPX ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
