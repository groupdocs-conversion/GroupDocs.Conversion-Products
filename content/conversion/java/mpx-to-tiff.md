...
############################# Head ############################
head_title: "MPX to TIFF Conversion in Java – Convert MPX to TIFF"
head_description: "Convert MPX to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "MPX to TIFF Live Demos"
    content: |
        Convert MPX to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
