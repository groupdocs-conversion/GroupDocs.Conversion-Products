...
############################# Head ############################
head_title: "MPX to TSV Conversion in Java – Convert MPX to TSV"
head_description: "Convert MPX to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to TSV in few lines of code.
...
demos:
    enable: true
    title: "MPX to TSV Live Demos"
    content: |
        Convert MPX to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
