...
head_title: "Konversi MPX ke XLS di Jawa – Konversi MPX ke XLS"
head_description: "Konversi MPX ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MPX ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MPX ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MPX ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MPX hingga XLS"
    content: |
        Konversikan MPX ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
