...
############################# Head ############################
head_title: "MPX to XLSX Conversion in Java – Convert MPX to XLSX"
head_description: "Convert MPX to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "MPX to XLSX Live Demos"
    content: |
        Convert MPX to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
