...
head_title: "Konversi MSG ke DIF di Jawa – Konversi MSG ke DIF"
head_description: "Konversi MSG ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File MSG ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi MSG ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file MSG ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung MSG hingga DIF"
    content: |
        Konversikan MSG ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
