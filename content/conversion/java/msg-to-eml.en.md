...
############################# Head #############################
head_title: "Java MSG to EML Converter API - transform MSG to EML in Java apps"
head_description: "View MSG to EML files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert MSG to EML in Java" 
description: "Experience the efficiency of a native, high-performance MSG to EML file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert MSG to EML file in Java" 
    content: |
      Transforming MSG to EML is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
