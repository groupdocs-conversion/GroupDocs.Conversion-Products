...
############################# Head ############################
head_title: "MSG to ODT Conversion in Java – Convert MSG to ODT"
head_description: "Convert MSG to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MSG Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MSG to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MSG file to ODT in few lines of code.
...
demos:
    enable: true
    title: "MSG to ODT Live Demos"
    content: |
        Convert MSG to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
