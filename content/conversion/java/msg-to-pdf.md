...
############################# Head ############################
head_title: "MSG to PDF Conversion in Java – Convert MSG to PDF"
head_description: "Convert MSG to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MSG Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MSG to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MSG file to PDF in few lines of code.
