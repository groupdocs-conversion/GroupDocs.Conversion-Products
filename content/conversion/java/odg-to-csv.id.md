...
head_title: "Konversi ODG ke CSV di Jawa – Konversi ODG ke CSV"
head_description: "Konversi ODG ke CSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke CSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke CSV di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke CSV dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga CSV"
    content: |
        Konversikan ODG ke CSV sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
