...
head_title: "Konversi ODG ke DIF di Jawa – Konversi ODG ke DIF"
head_description: "Konversi ODG ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga DIF"
    content: |
        Konversikan ODG ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
