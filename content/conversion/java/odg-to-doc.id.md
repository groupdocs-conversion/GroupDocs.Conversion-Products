...
head_title: "Konversi ODG ke DOC di Jawa – Konversi ODG ke DOC"
head_description: "Konversi ODG ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga DOC"
    content: |
        Konversikan ODG ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
