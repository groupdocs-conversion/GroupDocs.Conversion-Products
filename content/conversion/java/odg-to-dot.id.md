...
head_title: "Konversi ODG ke DOT di Jawa – Konversi ODG ke DOT"
head_description: "Konversi ODG ke DOT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke DOT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke DOT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke DOT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga DOT"
    content: |
        Konversikan ODG ke DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
