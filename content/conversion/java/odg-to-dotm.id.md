...
head_title: "Konversi ODG ke DOTM di Jawa – Konversi ODG ke DOTM"
head_description: "Konversi ODG ke DOTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke DOTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke DOTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke DOTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga DOTM"
    content: |
        Konversikan ODG ke DOTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
