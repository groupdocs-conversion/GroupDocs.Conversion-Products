...
head_title: "Konversi ODG ke DOTX di Jawa – Konversi ODG ke DOTX"
head_description: "Konversi ODG ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga DOTX"
    content: |
        Konversikan ODG ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
