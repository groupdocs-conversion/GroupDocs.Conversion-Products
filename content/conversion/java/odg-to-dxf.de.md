...
############################# Head #############################
head_title: "Java ODG zu DXF Konverter API - ODG in Java-Anwendungen transformieren"
head_description: "ODG zu DXF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "ODG in DXF in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken ODG zu DXF Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von ODG in DXF Datei in Java" 
    content: |
      Die Transformation von ODG in DXF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die ODG Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.odg")              // Richten Sie die Eingabedatei ODG ein
            .convertTo("converted.dxf")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // ODG in DXF Datei konvertieren        
        ```            
