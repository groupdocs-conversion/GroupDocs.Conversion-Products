...
head_title: "Konversi ODG ke EPUB di Jawa – Konversi ODG ke EPUB"
head_description: "Konversi ODG ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga EPUB"
    content: |
        Konversikan ODG ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
