...
############################# Head ############################
head_title: "ODG to EPUB Conversion in Java – Convert ODG to EPUB"
head_description: "Convert ODG to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "ODG to EPUB Live Demos"
    content: |
        Convert ODG to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
