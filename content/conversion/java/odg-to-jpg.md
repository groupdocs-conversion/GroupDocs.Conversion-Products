...
############################# Head ############################
head_title: "ODG to JPG Conversion in Java – Convert ODG to JPG"
head_description: "Convert ODG to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to JPG in few lines of code.
