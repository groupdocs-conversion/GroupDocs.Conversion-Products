...
head_title: "Konversi ODG ke MD di Jawa – Konversi ODG ke MD"
head_description: "Konversi ODG ke MD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke MD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke MD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke MD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga MD"
    content: |
        Konversikan ODG ke MD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
