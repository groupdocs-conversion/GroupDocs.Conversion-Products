...
head_title: "Konversi ODG ke MHTML di Jawa – Konversi ODG ke MHTML"
head_description: "Konversi ODG ke MHTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke MHTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke MHTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke MHTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga MHTML"
    content: |
        Konversikan ODG ke MHTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
