...
############################# Head ############################
head_title: "ODG to MHTML Conversion in Java – Convert ODG to MHTML"
head_description: "Convert ODG to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "ODG to MHTML Live Demos"
    content: |
        Convert ODG to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
