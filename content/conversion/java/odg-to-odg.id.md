...
head_title: "Konversi ODG ke ODG di Jawa – Konversi ODG ke ODG"
head_description: "Konversi ODG ke ODG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke ODG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke ODG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke ODG dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file ODG dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen ODG
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (ODG) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format target ODG
