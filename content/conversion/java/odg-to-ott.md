...
############################# Head ############################
head_title: "ODG to OTT Conversion in Java – Convert ODG to OTT"
head_description: "Convert ODG to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to OTT in few lines of code.
...
demos:
    enable: true
    title: "ODG to OTT Live Demos"
    content: |
        Convert ODG to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
