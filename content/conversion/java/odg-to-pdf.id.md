...
head_title: "Konversi ODG ke PDF di Jawa – Konversi ODG ke PDF"
head_description: "Konversi ODG ke PDF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke PDF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke PDF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke PDF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga PDF"
    content: |
        Konversikan ODG ke PDF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
