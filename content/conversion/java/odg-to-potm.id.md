...
head_title: "Konversi ODG ke POTM di Jawa – Konversi ODG ke POTM"
head_description: "Konversi ODG ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke POTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga POTM"
    content: |
        Konversikan ODG ke POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
