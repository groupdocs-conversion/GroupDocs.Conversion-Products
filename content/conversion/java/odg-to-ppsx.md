...
############################# Head ############################
head_title: "ODG to PPSX Conversion in Java – Convert ODG to PPSX"
head_description: "Convert ODG to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "ODG to PPSX Live Demos"
    content: |
        Convert ODG to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
