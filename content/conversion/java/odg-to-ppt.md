...
############################# Head ############################
head_title: "ODG to PPT Conversion in Java – Convert ODG to PPT"
head_description: "Convert ODG to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to PPT in few lines of code.
...
demos:
    enable: true
    title: "ODG to PPT Live Demos"
    content: |
        Convert ODG to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
