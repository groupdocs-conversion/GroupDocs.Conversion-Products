...
head_title: "Konversi ODG ke PPTM di Jawa – Konversi ODG ke PPTM"
head_description: "Konversi ODG ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga PPTM"
    content: |
        Konversikan ODG ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
