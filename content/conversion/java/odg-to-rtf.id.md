...
head_title: "Konversi ODG ke RTF di Jawa – Konversi ODG ke RTF"
head_description: "Konversi ODG ke RTF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke RTF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke RTF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke RTF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga RTF"
    content: |
        Konversikan ODG ke RTF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
