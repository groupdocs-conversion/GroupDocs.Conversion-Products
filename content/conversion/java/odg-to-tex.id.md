...
head_title: "Konversi ODG ke TEX di Jawa – Konversi ODG ke TEX"
head_description: "Konversi ODG ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga TEX"
    content: |
        Konversikan ODG ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
