...
head_title: "Konversi ODG ke TXT di Jawa – Konversi ODG ke TXT"
head_description: "Konversi ODG ke TXT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke TXT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke TXT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke TXT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga TXT"
    content: |
        Konversikan ODG ke TXT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
