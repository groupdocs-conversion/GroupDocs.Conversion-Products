...
############################# Head #############################
head_title: "Java ODG to VSDX Converter API - transform ODG to VSDX in Java apps"
head_description: "View ODG to VSDX files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert ODG to VSDX in Java" 
description: "Experience the efficiency of a native, high-performance ODG to VSDX file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert ODG to VSDX file in Java" 
    content: |
      Transforming ODG to VSDX is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the ODG file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.odg")              // Set up input ODG file
            .convertTo("converted.vsdx")    // Specify output path for converted file
            .convert();                     // Convert ODG to VSDX file        
        ```            
