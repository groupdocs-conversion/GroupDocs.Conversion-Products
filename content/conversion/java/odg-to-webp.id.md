...
head_title: "Konversi ODG ke WEBP di Jawa – Konversi ODG ke WEBP"
head_description: "Konversi ODG ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke WEBP di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga WEBP"
    content: |
        Konversikan ODG ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
