...
head_title: "Konversi ODG ke XLAM di Jawa – Konversi ODG ke XLAM"
head_description: "Konversi ODG ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga XLAM"
    content: |
        Konversikan ODG ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
