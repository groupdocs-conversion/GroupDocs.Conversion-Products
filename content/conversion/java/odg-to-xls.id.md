...
head_title: "Konversi ODG ke XLS di Jawa – Konversi ODG ke XLS"
head_description: "Konversi ODG ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga XLS"
    content: |
        Konversikan ODG ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
