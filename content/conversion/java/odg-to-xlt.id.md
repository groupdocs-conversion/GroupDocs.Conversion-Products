...
head_title: "Konversi ODG ke XLT di Jawa – Konversi ODG ke XLT"
head_description: "Konversi ODG ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga XLT"
    content: |
        Konversikan ODG ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
