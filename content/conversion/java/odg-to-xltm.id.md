...
head_title: "Konversi ODG ke XLTM di Jawa – Konversi ODG ke XLTM"
head_description: "Konversi ODG ke XLTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODG ke XLTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODG ke XLTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODG ke XLTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODG hingga XLTM"
    content: |
        Konversikan ODG ke XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
