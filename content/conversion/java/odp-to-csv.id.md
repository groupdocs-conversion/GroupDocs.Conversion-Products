...
head_title: "Konversi ODP ke CSV di Jawa – Konversi ODP ke CSV"
head_description: "Konversi ODP ke CSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke CSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke CSV di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke CSV dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga CSV"
    content: |
        Konversikan ODP ke CSV sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
