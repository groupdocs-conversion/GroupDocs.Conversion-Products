...
head_title: "Konversi ODP ke FODP di Jawa – Konversi ODP ke FODP"
head_description: "Konversi ODP ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga FODP"
    content: |
        Konversikan ODP ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
