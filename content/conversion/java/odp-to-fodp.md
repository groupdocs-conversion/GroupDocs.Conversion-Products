...
############################# Head ############################
head_title: "ODP to FODP Conversion in Java – Convert ODP to FODP"
head_description: "Convert ODP to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to FODP in few lines of code.
...
demos:
    enable: true
    title: "ODP to FODP Live Demos"
    content: |
        Convert ODP to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
