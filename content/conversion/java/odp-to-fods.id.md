...
head_title: "Konversi ODP ke FODS di Jawa – Konversi ODP ke FODS"
head_description: "Konversi ODP ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga FODS"
    content: |
        Konversikan ODP ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
