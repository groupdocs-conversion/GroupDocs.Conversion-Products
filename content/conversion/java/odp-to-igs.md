...
breadcrumb: ODP to IGS in Java

############################# Head ############################
head_title: "ODP to IGS Converter in Java"
head_description: "Convert ODP to IGS in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert ODP to IGS in Java"
description: "ODP to IGS conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your ODP files to IGS in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert ODP to IGS in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a ODP file to IGS with a few lines of code.
