...
head_title: "Konversi ODP ke MHTML di Jawa – Konversi ODP ke MHTML"
head_description: "Konversi ODP ke MHTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke MHTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke MHTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke MHTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga MHTML"
    content: |
        Konversikan ODP ke MHTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
