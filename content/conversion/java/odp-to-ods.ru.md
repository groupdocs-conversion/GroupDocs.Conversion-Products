...
############################# Head ############################
head_title: "Преобразование ODP в ODS в Java — Преобразование ODP в ODS"
head_description: "Преобразование ODP в ODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ODP в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ODP в ODS в Java"
    content_left: |
...
demos:
    enable: true
    title: "ODP в ODS Живые демонстрации"
    content: |
        Преобразуйте ODP в ODS прямо сейчас, посетив веб-сайт [GroupDocs.Conversion Живые демонстрации](https://products.groupdocs.app/conversion/family).
