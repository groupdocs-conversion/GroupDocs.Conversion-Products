...
############################# Head ############################
head_title: "ODP to OTP Conversion in Java – Convert ODP to OTP"
head_description: "Convert ODP to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to OTP in few lines of code.
...
demos:
    enable: true
    title: "ODP to OTP Live Demos"
    content: |
        Convert ODP to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
