...
head_title: "Konversi ODP ke POT di Jawa – Konversi ODP ke POT"
head_description: "Konversi ODP ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke POT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga POT"
    content: |
        Konversikan ODP ke POT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
