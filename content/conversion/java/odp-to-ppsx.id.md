...
head_title: "Konversi ODP ke PPSX di Jawa – Konversi ODP ke PPSX"
head_description: "Konversi ODP ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga PPSX"
    content: |
        Konversikan ODP ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
