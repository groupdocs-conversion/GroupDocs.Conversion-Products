...
head_title: "Konversi ODP ke PPT di Jawa – Konversi ODP ke PPT"
head_description: "Konversi ODP ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga PPT"
    content: |
        Konversikan ODP ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
