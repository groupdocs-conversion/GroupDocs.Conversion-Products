...
############################# Head ############################
head_title: "Преобразование ODP в PPTM в Java — преобразование ODP в PPTM"
head_description: "Преобразование ODP в PPTM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ODP в PPTM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ODP в PPTM в Java"
    content_left: |
