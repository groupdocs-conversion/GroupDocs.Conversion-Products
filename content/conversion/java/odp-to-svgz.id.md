...
head_title: "Konversi ODP ke SVGZ di Jawa – Konversi ODP ke SVGZ"
head_description: "Konversi ODP ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga SVGZ"
    content: |
        Konversikan ODP ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
