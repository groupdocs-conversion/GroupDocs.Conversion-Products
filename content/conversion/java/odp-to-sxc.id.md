...
head_title: "Konversi ODP ke SXC di Jawa – Konversi ODP ke SXC"
head_description: "Konversi ODP ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga SXC"
    content: |
        Konversikan ODP ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
