...
############################# Head ############################
head_title: "ODP to TXT Conversion in Java – Convert ODP to TXT"
head_description: "Convert ODP to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to TXT in few lines of code.
...
demos:
    enable: true
    title: "ODP to TXT Live Demos"
    content: |
        Convert ODP to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
