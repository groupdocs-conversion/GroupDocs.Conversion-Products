...
head_title: "Konversi ODP ke WEBP di Jawa – Konversi ODP ke WEBP"
head_description: "Konversi ODP ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke WEBP dalam beberapa baris kode.
