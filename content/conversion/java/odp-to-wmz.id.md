...
head_title: "Konversi ODP ke WMZ di Jawa – Konversi ODP ke WMZ"
head_description: "Konversi ODP ke WMZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke WMZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke WMZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke WMZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga WMZ"
    content: |
        Konversikan ODP ke WMZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
