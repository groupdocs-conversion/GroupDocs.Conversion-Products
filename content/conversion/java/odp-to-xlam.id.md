...
head_title: "Konversi ODP ke XLAM di Jawa – Konversi ODP ke XLAM"
head_description: "Konversi ODP ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga XLAM"
    content: |
        Konversikan ODP ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
