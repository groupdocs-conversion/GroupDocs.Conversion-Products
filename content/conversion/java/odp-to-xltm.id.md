...
head_title: "Konversi ODP ke XLTM di Jawa – Konversi ODP ke XLTM"
head_description: "Konversi ODP ke XLTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke XLTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke XLTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke XLTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga XLTM"
    content: |
        Konversikan ODP ke XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
