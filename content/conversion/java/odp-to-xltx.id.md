...
head_title: "Konversi ODP ke XLTX di Jawa – Konversi ODP ke XLTX"
head_description: "Konversi ODP ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODP ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODP ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODP ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODP hingga XLTX"
    content: |
        Konversikan ODP ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
