...
head_title: "Konversi ODS ke DOC di Jawa – Konversi ODS ke DOC"
head_description: "Konversi ODS ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga DOC"
    content: |
        Konversikan ODS ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
