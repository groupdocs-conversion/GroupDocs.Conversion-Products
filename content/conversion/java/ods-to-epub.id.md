...
head_title: "Konversi ODS ke EPUB di Jawa – Konversi ODS ke EPUB"
head_description: "Konversi ODS ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke EPUB di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga EPUB"
    content: |
        Konversikan ODS ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
