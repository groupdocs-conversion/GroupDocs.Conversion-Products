...
head_title: "Konversi ODS ke FODP di Jawa – Konversi ODS ke FODP"
head_description: "Konversi ODS ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga FODP"
    content: |
        Konversikan ODS ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
