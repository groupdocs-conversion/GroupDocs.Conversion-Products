...
############################# Head ############################
head_title: "ODS to FODS Conversion in Java – Convert ODS to FODS"
head_description: "Convert ODS to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODS Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODS to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODS file to FODS in few lines of code.
...
demos:
    enable: true
    title: "ODS to FODS Live Demos"
    content: |
        Convert ODS to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
