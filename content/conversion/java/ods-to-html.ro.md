...
breadcrumb: ODS la HTML în Java

############################# Head ############################
head_title: "Convertiți ODS în HTML în Java"
head_description: "Conversie ODS în HTML în Java cu câteva rânduri de cod. Convertiți peste 160 de formate de fișiere folosind API-ul de conversie a documentelor GroupDocs pentru Java"

############################# Header ############################
title: "Convertiți ODS în HTML în Java"
description: "Conversie ODS în HTML cu câteva rânduri de cod Java"
...
overview:
    enable: true
    content: |
        Convertiți fișierele dvs. ODS în HTML în Java. Este nevoie de doar câteva linii de cod Java pe orice platformă la alegere, cum ar fi Windows, Linux, macOS.
        Puteți încerca să convertiți gratuit ODS în HTML și să evaluați calitatea rezultatelor conversiei. Împreună cu scripturile simple de conversie a fișierelor, puteți încerca opțiuni mai sofisticate pentru încărcarea fișierului sursă ODS și stocarea rezultatului HTML. 
...
steps:
    enable: true
    title_left: "Pași pentru a converti ODS în HTML în Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) permite dezvoltatorilor să convertească cu ușurință fișierul ODS în HTML cu câteva linii de cod.
...
demos:
    enable: true
    title: "De la ODS la HTML Demo live"
    content: |
       Accesați site-ul nostru [Aplicația GroupDocs.Conversion](https://products.groupdocs.app/conversion/family) și încercați acum conversia ODS în HTML. Demo-ul gratuit are următoarele beneficii
