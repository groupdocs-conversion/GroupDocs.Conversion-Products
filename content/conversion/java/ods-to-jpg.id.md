...
head_title: "Konversi ODS ke JPG di Jawa – Konversi ODS ke JPG"
head_description: "Konversi ODS ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke JPG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke JPG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke JPG dalam beberapa baris kode.
