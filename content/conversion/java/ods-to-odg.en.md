...
breadcrumb: ODS to ODG in Java

############################# Head ############################
head_title: "ODS to ODG Converter in Java"
head_description: "Convert ODS to ODG in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert ODS to ODG in Java"
description: "ODS to ODG conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your ODS files to ODG in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert ODS to ODG in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a ODS file to ODG with a few lines of code.
