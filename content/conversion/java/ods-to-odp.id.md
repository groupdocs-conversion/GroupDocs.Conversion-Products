...
head_title: "Konversi ODS ke ODP di Jawa – Konversi ODS ke ODP"
head_description: "Konversi ODS ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga ODP"
    content: |
        Konversikan ODS ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
