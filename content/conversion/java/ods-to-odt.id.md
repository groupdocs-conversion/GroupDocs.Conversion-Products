...
head_title: "Konversi ODS ke ODT di Jawa – Konversi ODS ke ODT"
head_description: "Konversi ODS ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga ODT"
    content: |
        Konversikan ODS ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
