...
head_title: "Konversi ODS ke POT di Jawa – Konversi ODS ke POT"
head_description: "Konversi ODS ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke POT dalam beberapa baris kode.
