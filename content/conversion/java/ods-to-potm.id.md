...
head_title: "Konversi ODS ke POTM di Jawa – Konversi ODS ke POTM"
head_description: "Konversi ODS ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke POTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga POTM"
    content: |
        Konversikan ODS ke POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
