...
head_title: "Konversi ODS ke PPSM di Jawa – Konversi ODS ke PPSM"
head_description: "Konversi ODS ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke PPSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga PPSM"
    content: |
        Konversikan ODS ke PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
