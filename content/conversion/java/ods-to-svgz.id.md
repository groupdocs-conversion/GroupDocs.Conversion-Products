...
head_title: "Konversi ODS ke SVGZ di Jawa – Konversi ODS ke SVGZ"
head_description: "Konversi ODS ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga SVGZ"
    content: |
        Konversikan ODS ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
