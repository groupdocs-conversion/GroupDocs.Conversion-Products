...
head_title: "Konversi ODS ke WEBP di Jawa – Konversi ODS ke WEBP"
head_description: "Konversi ODS ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODS ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODS ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODS ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODS hingga WEBP"
    content: |
        Konversikan ODS ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
