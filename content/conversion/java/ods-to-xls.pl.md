...
breadcrumb: ODS do XLS w Java

############################# Head ############################
head_title: "Konwertuj ODS na XLS w Java"
head_description: "Konwersja ODS na XLS w Java z kilkoma linijkami kodu. Konwertuj ponad 160 formatów plików za pomocą interfejsu API konwersji dokumentów GroupDocs dla Java"

############################# Header ############################
title: "Konwertuj ODS na XLS w Java"
description: "Konwersja ODS do XLS z kilkoma linijkami kodu Java"
...
overview:
    enable: true
    content: |
        Przekonwertuj swoje pliki ODS na XLS w Java. Zajmuje tylko kilka linii kodu Java na dowolnej wybranej platformie, takiej jak Windows, Linux, macOS.
        Możesz spróbować przekonwertować ODS na XLS za darmo i ocenić jakość wyników konwersji. Oprócz prostych skryptów konwersji plików możesz wypróbować bardziej wyrafinowane opcje ładowania pliku źródłowego ODS i przechowywania danych wyjściowych XLS. 
...
steps:
    enable: true
    title_left: "Kroki konwersji ODS na XLS w Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) pozwala programistom łatwo przekonwertować plik ODS na XLS za pomocą kilku linijek kodu.
...
demos:
    enable: true
    title: "ODS do XLS demonstracji na żywo"
    content: |
       Odwiedź naszą witrynę [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) i wypróbuj teraz konwersję ODS na XLS. Darmowe demo ma następujące zalety
