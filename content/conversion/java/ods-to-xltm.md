...
############################# Head ############################
head_title: "ODS to XLTM Conversion in Java – Convert ODS to XLTM"
head_description: "Convert ODS to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODS Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODS to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODS file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "ODS to XLTM Live Demos"
    content: |
        Convert ODS to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
