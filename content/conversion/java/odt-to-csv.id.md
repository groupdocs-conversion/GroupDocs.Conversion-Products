...
head_title: "Konversi ODT ke CSV di Jawa – Konversi ODT ke CSV"
head_description: "Konversi ODT ke CSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke CSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke CSV di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke CSV dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga CSV"
    content: |
        Konversikan ODT ke CSV sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
