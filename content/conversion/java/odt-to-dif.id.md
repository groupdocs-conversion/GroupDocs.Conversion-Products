...
head_title: "Konversi ODT ke DIF di Jawa – Konversi ODT ke DIF"
head_description: "Konversi ODT ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga DIF"
    content: |
        Konversikan ODT ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
