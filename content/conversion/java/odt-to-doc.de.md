...
############################# Head #############################
head_title: "Java ODT zu DOC Konverter API - ODT in Java-Anwendungen transformieren"
head_description: "ODT zu DOC Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "ODT in DOC in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken ODT zu DOC Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von ODT in DOC Datei in Java" 
    content: |
      Die Transformation von ODT in DOC wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die ODT Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.odt")              // Richten Sie die Eingabedatei ODT ein
            .convertTo("converted.doc")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                    // ODT in DOC Datei konvertieren        
        ```            
