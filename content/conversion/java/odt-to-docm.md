...
############################# Head ############################
head_title: "ODT to DOCM Conversion in Java – Convert ODT to DOCM"
head_description: "Convert ODT to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "ODT to DOCM Live Demos"
    content: |
        Convert ODT to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
