...
head_title: "Konversi ODT ke HTM di Jawa – Konversi ODT ke HTM"
head_description: "Konversi ODT ke HTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke HTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke HTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke HTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga HTM"
    content: |
        Konversikan ODT ke HTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
