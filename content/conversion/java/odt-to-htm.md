...
############################# Head ############################
head_title: "ODT to HTM Conversion in Java – Convert ODT to HTM"
head_description: "Convert ODT to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to HTM in few lines of code.
...
demos:
    enable: true
    title: "ODT to HTM Live Demos"
    content: |
        Convert ODT to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
