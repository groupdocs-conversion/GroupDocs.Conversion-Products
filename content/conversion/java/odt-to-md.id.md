...
head_title: "Konversi ODT ke MD di Jawa – Konversi ODT ke MD"
head_description: "Konversi ODT ke MD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke MD di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke MD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga MD"
    content: |
        Konversikan ODT ke MD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
