...
############################# Head ############################
head_title: "ODT to MD Conversion in Java – Convert ODT to MD"
head_description: "Convert ODT to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to MD in few lines of code.
...
demos:
    enable: true
    title: "ODT to MD Live Demos"
    content: |
        Convert ODT to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
