...
head_title: "Konversi ODT ke ODP di Jawa – Konversi ODT ke ODP"
head_description: "Konversi ODT ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga ODP"
    content: |
        Konversikan ODT ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
