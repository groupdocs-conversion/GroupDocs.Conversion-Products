...
head_title: "Konversi ODT ke PPS di Jawa – Konversi ODT ke PPS"
head_description: "Konversi ODT ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga PPS"
    content: |
        Konversikan ODT ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
