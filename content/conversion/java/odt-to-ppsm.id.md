...
head_title: "Konversi ODT ke PPSM di Jawa – Konversi ODT ke PPSM"
head_description: "Konversi ODT ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke PPSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga PPSM"
    content: |
        Konversikan ODT ke PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
