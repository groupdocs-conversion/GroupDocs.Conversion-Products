...
head_title: "Konversi ODT ke SVGZ di Jawa – Konversi ODT ke SVGZ"
head_description: "Konversi ODT ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke SVGZ di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke SVGZ di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga SVGZ"
    content: |
        Konversikan ODT ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
