...
head_title: "Konversi ODT ke WMF di Jawa – Konversi ODT ke WMF"
head_description: "Konversi ODT ke WMF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke WMF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke WMF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke WMF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga WMF"
    content: |
        Konversikan ODT ke WMF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
