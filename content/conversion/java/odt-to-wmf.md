...
############################# Head ############################
head_title: "ODT to WMF Conversion in Java – Convert ODT to WMF"
head_description: "Convert ODT to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to WMF in few lines of code.
...
demos:
    enable: true
    title: "ODT to WMF Live Demos"
    content: |
        Convert ODT to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
