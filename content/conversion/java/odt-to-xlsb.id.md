...
head_title: "Konversi ODT ke XLSB di Jawa – Konversi ODT ke XLSB"
head_description: "Konversi ODT ke XLSB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke XLSB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke XLSB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke XLSB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga XLSB"
    content: |
        Konversikan ODT ke XLSB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
