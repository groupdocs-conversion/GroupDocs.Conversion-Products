...
############################# Head ############################
head_title: "ODT to XLSM Conversion in Java – Convert ODT to XLSM"
head_description: "Convert ODT to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "ODT to XLSM Live Demos"
    content: |
        Convert ODT to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
