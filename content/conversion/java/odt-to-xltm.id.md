...
head_title: "Konversi ODT ke XLTM di Jawa – Konversi ODT ke XLTM"
head_description: "Konversi ODT ke XLTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ODT ke XLTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ODT ke XLTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ODT ke XLTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ODT hingga XLTM"
    content: |
        Konversikan ODT ke XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
