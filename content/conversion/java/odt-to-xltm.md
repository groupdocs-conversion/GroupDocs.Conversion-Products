...
############################# Head ############################
head_title: "ODT to XLTM Conversion in Java – Convert ODT to XLTM"
head_description: "Convert ODT to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "ODT to XLTM Live Demos"
    content: |
        Convert ODT to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
