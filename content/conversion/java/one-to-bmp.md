...
############################# Head ############################
head_title: "ONE to BMP Conversion in Java – Convert ONE to BMP"
head_description: "Convert ONE to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ONE Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ONE to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ONE file to BMP in few lines of code.
