...
breadcrumb: ONE do DCM v Java

############################# Head ############################
head_title: "Převést ONE na DCM v Java"
head_description: "Převod ONE na DCM v Java pomocí několika řádků kódu. Převeďte více než 160 formátů souborů pomocí rozhraní API pro převod dokumentů GroupDocs pro Java"

############################# Header ############################
title: "Převést ONE na DCM v Java"
description: "Převod ONE na DCM s několika řádky kódu Java"
...
overview:
    enable: true
    content: |
        Převeďte své soubory ONE na DCM ve službě Java. Na libovolné platformě dle vašeho výběru, jako jsou Windows, Linux, macOS, stačí jen pár řádků kódu Java.
        Můžete zkusit zdarma převést ONE na DCM a vyhodnotit kvalitu výsledků převodu. Spolu s jednoduchými skripty pro převod souborů můžete vyzkoušet sofistikovanější možnosti pro načtení zdrojového souboru ONE a uložení výstupu DCM. 
        ...
        * přidat vodoznak do převedeného DCM.
        ...
        Po dokončení převodu můžete soubor DCM uložit do místní cesty k souboru nebo do libovolného úložiště třetí strany, jako je FTP, Amazon S3, Disk Google, Dropbox atd. Poznámka – pro převod ONE do DCM, nemusíte instalovat žádný další software, jako je MS Office, Open Office, Adobe Acrobat Reader atd.


############################# Steps ############################
steps:
    enable: true
    title_left: "Kroky k převodu ONE na DCM v Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) umožňuje vývojářům snadno převést soubor ONE na DCM pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od ONE do DCM"
    content: |
       Navštivte naši webovou stránku [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) a vyzkoušejte konverzi ONE na DCM nyní. Bezplatná ukázka má následující výhody
