...
head_title: "Konversi ONE ke DIF di Jawa – Konversi ONE ke DIF"
head_description: "Konversi ONE ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ONE ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ONE ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ONE ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ONE hingga DIF"
    content: |
        Konversikan ONE ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
