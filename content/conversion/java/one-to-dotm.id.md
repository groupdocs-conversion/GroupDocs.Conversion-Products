...
head_title: "Konversi ONE ke DOTM di Jawa – Konversi ONE ke DOTM"
head_description: "Konversi ONE ke DOTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ONE ke DOTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ONE ke DOTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ONE ke DOTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ONE hingga DOTM"
    content: |
        Konversikan ONE ke DOTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
