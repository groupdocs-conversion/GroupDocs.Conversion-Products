...
############################# Head ############################
head_title: "ONE to ICO Conversion in Java – Convert ONE to ICO"
head_description: "Convert ONE to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ONE Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ONE to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ONE file to ICO in few lines of code.
...
demos:
    enable: true
    title: "ONE to ICO Live Demos"
    content: |
        Convert ONE to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
