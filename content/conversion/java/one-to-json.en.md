...
############################# Head #############################
head_title: "Java ONE to JSON Converter API - transform ONE to JSON in Java apps"
head_description: "View ONE to JSON files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert ONE to JSON in Java" 
description: "Experience the efficiency of a native, high-performance ONE to JSON file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert ONE to JSON file in Java" 
    content: |
      Transforming ONE to JSON is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the ONE file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.one")              // Set up input ONE file
            .convertTo("converted.json")    // Specify output path for converted file
            .convert();                     // Convert ONE to JSON file        
        ```            
