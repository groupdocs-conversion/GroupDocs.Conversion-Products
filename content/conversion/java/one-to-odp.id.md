...
head_title: "Konversi ONE ke ODP di Jawa – Konversi ONE ke ODP"
head_description: "Konversi ONE ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ONE ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ONE ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ONE ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ONE hingga ODP"
    content: |
        Konversikan ONE ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
