...
head_title: "Konversi ONE ke ODS di Jawa – Konversi ONE ke ODS"
head_description: "Konversi ONE ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ONE ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ONE ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ONE ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ONE hingga ODS"
    content: |
        Konversikan ONE ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
