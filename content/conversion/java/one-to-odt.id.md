...
head_title: "Konversi ONE ke ODT di Jawa – Konversi ONE ke ODT"
head_description: "Konversi ONE ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ONE ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ONE ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ONE ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ONE hingga ODT"
    content: |
        Konversikan ONE ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
