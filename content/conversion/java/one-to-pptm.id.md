...
head_title: "Konversi ONE ke PPTM di Jawa – Konversi ONE ke PPTM"
head_description: "Konversi ONE ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ONE ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ONE ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ONE ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ONE hingga PPTM"
    content: |
        Konversikan ONE ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
