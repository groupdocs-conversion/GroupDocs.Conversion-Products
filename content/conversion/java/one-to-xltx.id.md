...
head_title: "Konversi ONE ke XLTX di Jawa – Konversi ONE ke XLTX"
head_description: "Konversi ONE ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File ONE ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi ONE ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file ONE ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung ONE hingga XLTX"
    content: |
        Konversikan ONE ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
