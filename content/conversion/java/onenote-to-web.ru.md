...
############################# Head ############################
head_title: "Преобразование ONENOTE в WEB на Java — преобразование ONENOTE в WEB"
head_description: "Преобразуйте ONENOTE в WEB на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов ONENOTE в WEB на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию ONENOTE в WEB на Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл ONENOTE в WEB с помощью нескольких строк кода.
