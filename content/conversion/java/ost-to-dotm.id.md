...
head_title: "Konversi OST ke DOTM di Jawa – Konversi OST ke DOTM"
head_description: "Konversi OST ke DOTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke DOTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke DOTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke DOTM dalam beberapa baris kode.
