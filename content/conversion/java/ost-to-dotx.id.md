...
head_title: "Konversi OST ke DOTX di Jawa – Konversi OST ke DOTX"
head_description: "Konversi OST ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga DOTX"
    content: |
        Konversikan OST ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
