...
head_title: "Konversi OST ke EML di Jawa – Konversi OST ke EML"
head_description: "Konversi OST ke EML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke EML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke EML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke EML dalam beberapa baris kode.
