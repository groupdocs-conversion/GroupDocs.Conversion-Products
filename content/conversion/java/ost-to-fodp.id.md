...
head_title: "Konversi OST ke FODP di Jawa – Konversi OST ke FODP"
head_description: "Konversi OST ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga FODP"
    content: |
        Konversikan OST ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
