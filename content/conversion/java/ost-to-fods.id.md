...
head_title: "Konversi OST ke FODS di Jawa – Konversi OST ke FODS"
head_description: "Konversi OST ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga FODS"
    content: |
        Konversikan OST ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
