...
############################# Head ############################
head_title: "OST to MSG Conversion in Java – Convert OST to MSG"
head_description: "Convert OST to MSG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to MSG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to MSG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to MSG in few lines of code.
...
demos:
    enable: true
    title: "OST to MSG Live Demos"
    content: |
        Convert OST to MSG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
