...
head_title: "Konversi OST ke ODP di Jawa – Konversi OST ke ODP"
head_description: "Konversi OST ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga ODP"
    content: |
        Konversikan OST ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
