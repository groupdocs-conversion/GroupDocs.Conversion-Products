...
############################# Head ############################
head_title: "Преобразование OST в ODS в Java - Преобразование OST в ODS"
head_description: "Преобразуйте OST в ODS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OST в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OST в ODS в Java"
    content_left: |
