...
head_title: "Konversi OST ke POT di Jawa – Konversi OST ke POT"
head_description: "Konversi OST ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke POT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga POT"
    content: |
        Konversikan OST ke POT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
