...
head_title: "Konversi OST ke PPS di Jawa – Konversi OST ke PPS"
head_description: "Konversi OST ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga PPS"
    content: |
        Konversikan OST ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
