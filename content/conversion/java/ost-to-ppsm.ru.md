...
############################# Head ############################
head_title: "Преобразование OST в PPSM в Java — преобразование OST в PPSM"
head_description: "Преобразование OST в PPSM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OST в PPSM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OST в PPSM в Java"
    content_left: |
...
demos:
    enable: true
    title: "OST для живых демонстраций PPSM"
    content: |
        Преобразуйте OST в PPSM прямо сейчас, посетив веб-сайт [GroupDocs.Conversion Живые демонстрации](https://products.groupdocs.app/conversion/family).
