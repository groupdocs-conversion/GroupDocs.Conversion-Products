...
head_title: "Konversi OST ke PPTM di Jawa – Konversi OST ke PPTM"
head_description: "Konversi OST ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga PPTM"
    content: |
        Konversikan OST ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
