...
head_title: "Konversi OST ke PPTX di Jawa – Konversi OST ke PPTX"
head_description: "Konversi OST ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga PPTX"
    content: |
        Konversikan OST ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
