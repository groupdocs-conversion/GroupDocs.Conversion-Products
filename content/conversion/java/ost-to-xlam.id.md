...
head_title: "Konversi OST ke XLAM di Jawa – Konversi OST ke XLAM"
head_description: "Konversi OST ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OST ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OST ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OST ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OST hingga XLAM"
    content: |
        Konversikan OST ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
