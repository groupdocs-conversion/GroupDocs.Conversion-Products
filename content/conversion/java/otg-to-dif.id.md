...
head_title: "Konversi OTG ke DIF di Jawa – Konversi OTG ke DIF"
head_description: "Konversi OTG ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTG ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTG ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTG ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTG hingga DIF"
    content: |
        Konversikan OTG ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
