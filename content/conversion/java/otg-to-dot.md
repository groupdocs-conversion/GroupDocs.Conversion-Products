...
############################# Head ############################
head_title: "OTG to DOT Conversion in Java – Convert OTG to DOT"
head_description: "Convert OTG to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to DOT in few lines of code.
...
demos:
    enable: true
    title: "OTG to DOT Live Demos"
    content: |
        Convert OTG to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
