...
head_title: "Konversi OTG ke HTML di Jawa – Konversi OTG ke HTML"
head_description: "Konversi OTG ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTG ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTG ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTG ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTG hingga HTML"
    content: |
        Konversikan OTG ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
