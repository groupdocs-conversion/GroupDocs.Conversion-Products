...
############################# Head ############################
head_title: "OTG to MHT Conversion in Java – Convert OTG to MHT"
head_description: "Convert OTG to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to MHT in few lines of code.
...
demos:
    enable: true
    title: "OTG to MHT Live Demos"
    content: |
        Convert OTG to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
