...
############################# Head ############################
head_title: "Преобразование OTG в ODP в Java — преобразование OTG в ODP"
head_description: "Преобразуйте OTG в ODP на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTG в ODP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTG в ODP в Java"
    content_left: |
