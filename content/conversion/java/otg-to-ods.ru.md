...
############################# Head ############################
head_title: "Преобразование OTG в ODS в Java — преобразование OTG в ODS"
head_description: "Преобразуйте OTG в ODS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTG в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTG в ODS в Java"
    content_left: |
...
demos:
    enable: true
    title: "Демонстрации OTG в ODS Live"
    content: |
        Конвертируйте OTG в ODS прямо сейчас, посетив веб-сайт [GroupDocs.Conversion Живые демонстрации](https://products.groupdocs.app/conversion/family).
