...
############################# Head ############################
head_title: "OTG to POT Conversion in Java – Convert OTG to POT"
head_description: "Convert OTG to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to POT in few lines of code.
...
demos:
    enable: true
    title: "OTG to POT Live Demos"
    content: |
        Convert OTG to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
