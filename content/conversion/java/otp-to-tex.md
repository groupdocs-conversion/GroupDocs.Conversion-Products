...
############################# Head ############################
head_title: "OTP to TEX Conversion in Java – Convert OTP to TEX"
head_description: "Convert OTP to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to TEX in few lines of code.
...
demos:
    enable: true
    title: "OTP to TEX Live Demos"
    content: |
        Convert OTP to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
