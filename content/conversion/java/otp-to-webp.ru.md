...
############################# Head ############################
head_title: "Преобразование OTP в WEBP в Java — преобразование OTP в WEBP"
head_description: "Преобразование OTP в WEBP на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTP в WEBP на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTP в WEBP в Java"
    content_left: |
