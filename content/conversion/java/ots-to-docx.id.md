...
head_title: "Konversi OTS ke DOCX di Jawa – Konversi OTS ke DOCX"
head_description: "Konversi OTS ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTS ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTS ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTS ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTS hingga DOCX"
    content: |
        Konversikan OTS ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
