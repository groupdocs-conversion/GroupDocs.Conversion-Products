...
head_title: "Konversi OTS ke FODP di Jawa – Konversi OTS ke FODP"
head_description: "Konversi OTS ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTS ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTS ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTS ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTS hingga FODP"
    content: |
        Konversikan OTS ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
