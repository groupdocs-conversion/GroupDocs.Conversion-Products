...
head_title: "Konversi OTS ke GIF di Jawa – Konversi OTS ke GIF"
head_description: "Konversi OTS ke GIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTS ke GIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTS ke GIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTS ke GIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTS hingga GIF"
    content: |
        Konversikan OTS ke GIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
