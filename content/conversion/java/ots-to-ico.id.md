...
head_title: "Konversi OTS ke ICO di Jawa – Konversi OTS ke ICO"
head_description: "Konversi OTS ke ICO di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTS ke ICO di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTS ke ICO di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTS ke ICO dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTS hingga ICO"
    content: |
        Konversikan OTS ke ICO sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
