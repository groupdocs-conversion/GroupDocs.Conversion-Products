...
############################# Head ############################
head_title: "Преобразование OTS в ICO в Java - Преобразование OTS в ICO"
head_description: "Преобразуйте OTS в ICO на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTS в ICO в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTS в ICO в Java"
    content_left: |
