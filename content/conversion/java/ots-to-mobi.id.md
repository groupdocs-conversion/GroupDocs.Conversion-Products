...
head_title: "Konversi OTS ke MOBI di Jawa – Konversi OTS ke MOBI"
head_description: "Konversi OTS ke MOBI di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTS ke MOBI di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTS ke MOBI di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTS ke MOBI dalam beberapa baris kode.
