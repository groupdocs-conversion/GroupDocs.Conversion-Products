...
head_title: "Konversi OTS ke ODP di Jawa – Konversi OTS ke ODP"
head_description: "Konversi OTS ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTS ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTS ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTS ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTS hingga ODP"
    content: |
        Konversikan OTS ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
