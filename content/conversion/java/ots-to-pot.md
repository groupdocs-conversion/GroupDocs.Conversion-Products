...
############################# Head ############################
head_title: "OTS to POT Conversion in Java – Convert OTS to POT"
head_description: "Convert OTS to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to POT in few lines of code.
...
demos:
    enable: true
    title: "OTS to POT Live Demos"
    content: |
        Convert OTS to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
