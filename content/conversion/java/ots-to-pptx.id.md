...
head_title: "Konversi OTS ke PPTX di Jawa – Konversi OTS ke PPTX"
head_description: "Konversi OTS ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTS ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTS ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTS ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTS hingga PPTX"
    content: |
        Konversikan OTS ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
