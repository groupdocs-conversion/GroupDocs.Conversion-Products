...
############################# Head ############################
head_title: "OTS to RTF Conversion in Java – Convert OTS to RTF"
head_description: "Convert OTS to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to RTF in few lines of code.
...
demos:
    enable: true
    title: "OTS to RTF Live Demos"
    content: |
        Convert OTS to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
