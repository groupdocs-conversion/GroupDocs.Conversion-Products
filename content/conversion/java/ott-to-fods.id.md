...
head_title: "Konversi OTT ke FODS di Jawa – Konversi OTT ke FODS"
head_description: "Konversi OTT ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTT ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTT ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTT ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTT hingga FODS"
    content: |
        Konversikan OTT ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
