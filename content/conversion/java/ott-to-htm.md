...
############################# Head ############################
head_title: "OTT to HTM Conversion in Java – Convert OTT to HTM"
head_description: "Convert OTT to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to HTM in few lines of code.
...
demos:
    enable: true
    title: "OTT to HTM Live Demos"
    content: |
        Convert OTT to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
