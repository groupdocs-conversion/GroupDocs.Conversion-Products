...
############################# Head ############################
head_title: "OTT to ICO Conversion in Java – Convert OTT to ICO"
head_description: "Convert OTT to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to ICO in few lines of code.
...
demos:
    enable: true
    title: "OTT to ICO Live Demos"
    content: |
        Convert OTT to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
