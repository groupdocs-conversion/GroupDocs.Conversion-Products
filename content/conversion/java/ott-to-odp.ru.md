...
############################# Head ############################
head_title: "Преобразование OTT в ODP в Java — преобразование OTT в ODP"
head_description: "Преобразование OTT в ODP на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTT в ODP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTT в ODP в Java"
    content_left: |
