...
############################# Head ############################
head_title: "Преобразование OTT в POTX в Java — преобразование OTT в POTX"
head_description: "Преобразование OTT в POTX на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTT в POTX в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTT в POTX в Java"
    content_left: |
