...
############################# Head ############################
head_title: "OTT to PPS Conversion in Java – Convert OTT to PPS"
head_description: "Convert OTT to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to PPS in few lines of code.
...
demos:
    enable: true
    title: "OTT to PPS Live Demos"
    content: |
        Convert OTT to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
