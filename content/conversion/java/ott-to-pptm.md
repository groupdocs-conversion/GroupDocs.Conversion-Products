...
############################# Head ############################
head_title: "OTT to PPTM Conversion in Java – Convert OTT to PPTM"
head_description: "Convert OTT to PPTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to PPTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to PPTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to PPTM in few lines of code.
...
demos:
    enable: true
    title: "OTT to PPTM Live Demos"
    content: |
        Convert OTT to PPTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
