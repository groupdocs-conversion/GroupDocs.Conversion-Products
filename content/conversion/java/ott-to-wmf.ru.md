...
############################# Head ############################
head_title: "Преобразование OTT в WMF на Java — Преобразование OTT в WMF"
head_description: "Преобразование OTT в WMF на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTT в WMF на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTT в WMF в Java"
    content_left: |
