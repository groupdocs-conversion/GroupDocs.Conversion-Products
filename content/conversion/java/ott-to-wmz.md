...
############################# Head ############################
head_title: "OTT to WMZ Conversion in Java – Convert OTT to WMZ"
head_description: "Convert OTT to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "OTT to WMZ Live Demos"
    content: |
        Convert OTT to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
