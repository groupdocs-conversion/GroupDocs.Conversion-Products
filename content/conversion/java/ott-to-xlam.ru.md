...
############################# Head ############################
head_title: "Преобразование OTT в XLAM в Java — Преобразование OTT в XLAM"
head_description: "Преобразование OTT в XLAM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTT в XLAM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTT в XLAM в Java"
    content_left: |
