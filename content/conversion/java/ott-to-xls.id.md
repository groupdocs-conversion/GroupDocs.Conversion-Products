...
head_title: "Konversi OTT ke XLS di Jawa – Konversi OTT ke XLS"
head_description: "Konversi OTT ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OTT ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OTT ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OTT ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OTT hingga XLS"
    content: |
        Konversikan OTT ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
