...
############################# Head ############################
head_title: "Преобразование OTT в XLTX в Java — преобразование OTT в XLTX"
head_description: "Преобразование OTT в XLTX на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов OTT в XLTX в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию OTT в XLTX в Java"
    content_left: |
