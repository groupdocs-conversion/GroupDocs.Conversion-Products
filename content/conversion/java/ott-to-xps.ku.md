...
breadcrumb: OTT heta XPS di Java de

############################# Head ############################
head_title: "Di Java de OTT veguherîne XPS"
head_description: "Guhertina OTT bo XPS di Java de bi çend rêzikên kodê. Zêdetirî 160 formatên pelan bi karanîna API-ya veguherîna belgeya GroupDocs ji bo Java veguherînin"

############################# Header ############################
title: "Di Java de OTT veguherîne XPS"
description: "Guhertina OTT bo XPS bi çend rêzikên koda Java"
...
overview:
    enable: true
    content: |
        Pelên xwe yên OTT veguherînin XPS di Java de. Ew tenê çend rêzikên koda Java li ser her platformek bijartina we digire, wek Windows, Linux, macOS.
        Hûn dikarin belaş biceribînin ku OTT veguherînin XPS û kalîteya encamên veguhertinê binirxînin. Li gel skrîptên guheztina pelan ên hêsan, hûn dikarin vebijarkên sofîstîketir ji bo barkirina pelê çavkaniyê OTT û hilanîna derana XPS biceribînin. 
        ...
        * avî nîşanekê li XPS-ya guhertî zêde bike.
        ...
        Piştî ku veguhertin qediya, hûn dikarin pelê XPS li ser riya pelê xweya herêmî an jî hilanîna partiya sêyem wekî FTP, Amazon S3, Google Drive, Dropbox hwd. Ji kerema xwe bala xwe bidin - veguherînin OTT ji bo XPS, hûn ne hewce ne ku hûn nermalava zêde saz bikin, wek MS Office, Open Office, Adobe Acrobat Reader hwd.


############################# Steps ############################
steps:
    enable: true
    title_left: "Gavên veguherîna OTT bo XPS di Java de"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) destûrê dide pêşdebiran ku bi çend rêzikên kodê bi hêsanî pelê OTT veguherînin XPS.
...
demos:
    ...
    content: |
       Serdana malpera me ya [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) bikin û niha veguhertina OTT berbi XPS biceribînin. Demoya belaş xwedî feydeyên jêrîn e
