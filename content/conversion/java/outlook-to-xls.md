...
draft: false
otherformats: 
breadcrumb: OUTLOOK to XLS in Java

############################# Head ############################
head_title: "OUTLOOK to XLS Converter in Java"
head_description: "Convert OUTLOOK to XLS in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert OUTLOOK to XLS in Java"
description: "OUTLOOK to XLS conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your OUTLOOK files to XLS in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert OUTLOOK to XLS in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a OUTLOOK file to XLS with a few lines of code.
