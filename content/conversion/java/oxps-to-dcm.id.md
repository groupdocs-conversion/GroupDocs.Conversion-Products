...
head_title: "Konversi OXPS ke DCM di Jawa – Konversi OXPS ke DCM"
head_description: "Konversi OXPS ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke DCM di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga DCM"
    content: |
        Konversikan OXPS ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
