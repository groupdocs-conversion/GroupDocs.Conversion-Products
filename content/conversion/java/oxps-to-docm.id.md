...
head_title: "Konversi OXPS ke DOCM di Jawa – Konversi OXPS ke DOCM"
head_description: "Konversi OXPS ke DOCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke DOCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke DOCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke DOCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga DOCM"
    content: |
        Konversikan OXPS ke DOCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
