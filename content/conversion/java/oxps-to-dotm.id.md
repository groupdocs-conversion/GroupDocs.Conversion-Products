...
head_title: "Konversi OXPS ke DOTM di Jawa – Konversi OXPS ke DOTM"
head_description: "Konversi OXPS ke DOTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke DOTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke DOTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke DOTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga DOTM"
    content: |
        Konversikan OXPS ke DOTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
