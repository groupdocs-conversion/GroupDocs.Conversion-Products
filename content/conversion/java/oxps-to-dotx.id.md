...
head_title: "Konversi OXPS ke DOTX di Jawa – Konversi OXPS ke DOTX"
head_description: "Konversi OXPS ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga DOTX"
    content: |
        Konversikan OXPS ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
