...
############################# Head ############################
head_title: "OXPS to EMF Conversion in Java – Convert OXPS to EMF"
head_description: "Convert OXPS to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to EMF in few lines of code.
...
demos:
    enable: true
    title: "OXPS to EMF Live Demos"
    content: |
        Convert OXPS to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
