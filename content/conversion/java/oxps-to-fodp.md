...
############################# Head ############################
head_title: "OXPS to FODP Conversion in Java – Convert OXPS to FODP"
head_description: "Convert OXPS to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to FODP in few lines of code.
...
demos:
    enable: true
    title: "OXPS to FODP Live Demos"
    content: |
        Convert OXPS to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
