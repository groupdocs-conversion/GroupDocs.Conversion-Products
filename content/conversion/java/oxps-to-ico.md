...
############################# Head ############################
head_title: "OXPS to ICO Conversion in Java – Convert OXPS to ICO"
head_description: "Convert OXPS to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to ICO in few lines of code.
...
demos:
    enable: true
    title: "OXPS to ICO Live Demos"
    content: |
        Convert OXPS to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
