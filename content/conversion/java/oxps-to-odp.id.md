...
head_title: "Konversi OXPS ke ODP di Jawa – Konversi OXPS ke ODP"
head_description: "Konversi OXPS ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke ODP dalam beberapa baris kode.
