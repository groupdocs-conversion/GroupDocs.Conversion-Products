...
head_title: "Konversi OXPS ke ODS di Jawa – Konversi OXPS ke ODS"
head_description: "Konversi OXPS ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga ODS"
    content: |
        Konversikan OXPS ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
