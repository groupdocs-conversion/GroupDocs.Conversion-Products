...
head_title: "Konversi OXPS ke POTX di Jawa – Konversi OXPS ke POTX"
head_description: "Konversi OXPS ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga POTX"
    content: |
        Konversikan OXPS ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
