...
head_title: "Konversi OXPS ke PPT di Jawa – Konversi OXPS ke PPT"
head_description: "Konversi OXPS ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga PPT"
    content: |
        Konversikan OXPS ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
