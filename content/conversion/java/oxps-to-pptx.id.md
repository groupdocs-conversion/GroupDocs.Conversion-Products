...
head_title: "Konversi OXPS ke PPTX di Jawa – Konversi OXPS ke PPTX"
head_description: "Konversi OXPS ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga PPTX"
    content: |
        Konversikan OXPS ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
