...
############################# Head ############################
head_title: "OXPS to SVG Conversion in Java – Convert OXPS to SVG"
head_description: "Convert OXPS to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to SVG in few lines of code.
...
demos:
    enable: true
    title: "OXPS to SVG Live Demos"
    content: |
        Convert OXPS to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
