...
############################# Head ############################
head_title: "OXPS to XLAM Conversion in Java – Convert OXPS to XLAM"
head_description: "Convert OXPS to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "OXPS to XLAM Live Demos"
    content: |
        Convert OXPS to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
