...
head_title: "Konversi OXPS ke XLS di Jawa – Konversi OXPS ke XLS"
head_description: "Konversi OXPS ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File OXPS ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi OXPS ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file OXPS ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung OXPS hingga XLS"
    content: |
        Konversikan OXPS ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
