...
############################# Head ############################
head_title: "OXPS to XLSX Conversion in Java – Convert OXPS to XLSX"
head_description: "Convert OXPS to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "OXPS to XLSX Live Demos"
    content: |
        Convert OXPS to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
