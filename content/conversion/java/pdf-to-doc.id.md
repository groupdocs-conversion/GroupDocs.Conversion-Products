...
head_title: "Konversi PDF ke DOC di Jawa – Konversi PDF ke DOC"
head_description: "Konversi PDF ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga DOC"
    content: |
        Konversikan PDF ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
