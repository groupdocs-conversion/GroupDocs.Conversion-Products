...
head_title: "Konversi PDF ke DOCX di Jawa – Konversi PDF ke DOCX"
head_description: "Konversi PDF ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga DOCX"
    content: |
        Konversikan PDF ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
