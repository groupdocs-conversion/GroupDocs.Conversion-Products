...
############################# Head ############################
head_title: "PDF to DOCX Conversion in Java – Convert PDF to DOCX"
head_description: "Convert PDF to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "PDF to DOCX Live Demos"
    content: |
        Convert PDF to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
