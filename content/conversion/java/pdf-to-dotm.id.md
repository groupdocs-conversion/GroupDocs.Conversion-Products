...
head_title: "Konversi PDF ke DOTM di Jawa – Konversi PDF ke DOTM"
head_description: "Konversi PDF ke DOTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke DOTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke DOTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke DOTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga DOTM"
    content: |
        Konversikan PDF ke DOTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
