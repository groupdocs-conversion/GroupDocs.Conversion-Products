...
head_title: "Konversi PDF ke EBOOK di Jawa – Konversi PDF ke EBOOK"
head_description: "Konversi PDF ke EBOOK di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke EBOOK di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke EBOOK di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke EBOOK dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga EBOOK"
    content: |
        Konversikan PDF ke EBOOK sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
