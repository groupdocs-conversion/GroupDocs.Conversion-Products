...
############################# Head #############################
head_title: "Java PDF zu FODP Konverter API - PDF in Java-Anwendungen transformieren"
head_description: "PDF zu FODP Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "PDF in FODP in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken PDF zu FODP Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von PDF in FODP Datei in Java" 
    content: |
      Die Transformation von PDF in FODP wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convertTo("converted.fodp")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // PDF in FODP Datei konvertieren        
        ```            
