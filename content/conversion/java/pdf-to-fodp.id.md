...
head_title: "Konversi PDF ke FODP di Jawa – Konversi PDF ke FODP"
head_description: "Konversi PDF ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga FODP"
    content: |
        Konversikan PDF ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
