...
head_title: "Konversi PDF ke MD di Jawa – Konversi PDF ke MD"
head_description: "Konversi PDF ke MD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke MD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke MD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke MD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga MD"
    content: |
        Konversikan PDF ke MD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
