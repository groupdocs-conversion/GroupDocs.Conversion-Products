...
head_title: "Konversi PDF ke ODS di Jawa – Konversi PDF ke ODS"
head_description: "Konversi PDF ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga ODS"
    content: |
        Konversikan PDF ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
