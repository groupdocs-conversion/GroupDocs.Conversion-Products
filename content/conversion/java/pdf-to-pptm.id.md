...
head_title: "Konversi PDF ke PPTM di Jawa – Konversi PDF ke PPTM"
head_description: "Konversi PDF ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga PPTM"
    content: |
        Konversikan PDF ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
