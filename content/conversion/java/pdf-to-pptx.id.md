...
head_title: "Konversi PDF ke PPTX di Jawa – Konversi PDF ke PPTX"
head_description: "Konversi PDF ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga PPTX"
    content: |
        Konversikan PDF ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
