...
head_title: "Konversi PDF ke SXC di Jawa – Konversi PDF ke SXC"
head_description: "Konversi PDF ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PDF ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga SXC"
    content: |
        Konversikan PDF ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
