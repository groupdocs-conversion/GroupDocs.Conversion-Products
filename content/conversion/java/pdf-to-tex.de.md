...
############################# Head #############################
head_title: "Java PDF zu TEX Konverter API - PDF in Java-Anwendungen transformieren"
head_description: "PDF zu TEX Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "PDF in TEX in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von PDF in TEX Datei in Java" 
    content: |
      Die Transformation von PDF in TEX wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convertTo("converted.tex")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // PDF in TEX Datei konvertieren        
        ```            
