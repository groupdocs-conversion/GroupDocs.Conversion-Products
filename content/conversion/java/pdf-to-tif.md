...
############################# Head ############################
head_title: "PDF to TIF Conversion in Java – Convert PDF to TIF"
head_description: "Convert PDF to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to TIF in few lines of code.
...
demos:
    enable: true
    title: "PDF to TIF Live Demos"
    content: |
        Convert PDF to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
