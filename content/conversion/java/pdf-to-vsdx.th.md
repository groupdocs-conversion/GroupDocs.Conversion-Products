...
############################# Head #############################
head_title: "Java API แปลง PDF เป็น VSDX - แปลงในแอปพลิเคชัน Java"
...
############################# Header ############################
title: "แปลง PDF เป็น VSDX ใน Java" 
description: "ประสบการณ์ API ที่มีประสิทธิภาพสูงสำหรับการแปลงไฟล์ PDF เป็น VSDX สำหรับแอปพลิเคชัน Java, J2EE และ J2SE มีการรองรับคุณลักษณะเพิ่มเติมอย่างหลากหลายเพื่อการปรับแต่งรูปแบบเอกสารผลลัพธ์" 
...
steps:
    enable: true
    title: "ขั้นตอนในการแปลงไฟล์ PDF เป็นไฟล์ VSDX ใน Java" 
    content: |
      การแปลง PDF เป็น VSDX กลายเป็นง่ายด้วย <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> คุณจำเป็นต้องทำเพียงไม่กี่ขั้นตอนง่ายๆ
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // แปลงไฟล์ PDF เป็นไฟล์ VSDX        
        ```            
