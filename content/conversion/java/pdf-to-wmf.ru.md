...
head_description: "Преобразуйте PDF в WMF на Java, используя несколько строк кода. Используйте API преобразования документов GroupDocs для преобразования более 160 форматов файлов."

############################# Header ############################
title: "Преобразование PDF в WMF в Java"
description: "Конвертировать PDF в WMF с помощью нескольких строк кода Java"
...
overview:
    enable: true
    content: |
        Легко конвертируйте файлы PDF в WMF на Java. Вы можете использовать всего пару строк кода Java на любой платформе по вашему выбору, например - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Шаги по преобразованию PDF в WMF в Java"
    content_left: |
