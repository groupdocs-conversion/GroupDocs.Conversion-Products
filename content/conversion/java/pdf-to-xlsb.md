...
############################# Head ############################
head_title: "PDF to XLSB Conversion in Java – Convert PDF to XLSB"
head_description: "Convert PDF to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to XLSB in few lines of code.
...
demos:
    enable: true
    title: "PDF to XLSB Live Demos"
    content: |
        Convert PDF to XLSB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
