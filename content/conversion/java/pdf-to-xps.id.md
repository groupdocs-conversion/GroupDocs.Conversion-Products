...
head_title: "Konversi PDF ke XPS di Jawa – Konversi PDF ke XPS"
head_description: "Konversi PDF ke XPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PDF ke XPS di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PDF ke XPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PDF hingga XPS"
    content: |
        Konversikan PDF ke XPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
...
about_formats:
    ...
    format:
        - icon: "far fa-file-XPS"
          ...
          content: |
            File XPS mewakili file tata letak halaman yang didasarkan pada Spesifikasi Kertas XML yang dibuat oleh Microsoft. Format ini dikembangkan oleh Microsoft sebagai pengganti format file EMF dan mirip dengan format file PDF, tetapi menggunakan XML dalam tata letak, tampilan, dan informasi pencetakan dokumen. Faktanya, lebih dapat dibenarkan untuk mengatakan bahwa XPS adalah upaya PDF, tetapi tidak bisa mendapatkan popularitas yang cukup seperti yang dimiliki oleh PDF karena sejumlah alasan.
