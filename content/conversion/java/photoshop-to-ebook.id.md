...
head_title: "Konversi PHOTOSHOP ke EBOOK di Jawa – Konversi PHOTOSHOP ke EBOOK"
head_description: "Konversi PHOTOSHOP ke EBOOK di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PHOTOSHOP ke EBOOK di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PHOTOSHOP ke EBOOK di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PHOTOSHOP ke EBOOK dalam beberapa baris kode.
