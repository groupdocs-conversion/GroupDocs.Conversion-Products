...
############################# Head ############################
head_title: "Преобразование PHOTOSHOP в EBOOK на Java – Преобразование PHOTOSHOP в EBOOK"
head_description: "Преобразуйте PHOTOSHOP в EBOOK на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Конвертируйте файлы PHOTOSHOP в EBOOK на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию PHOTOSHOP в EBOOK на Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл PHOTOSHOP в EBOOK с помощью нескольких строк кода.
