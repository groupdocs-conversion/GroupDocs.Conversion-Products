...
head_title: "Konversi PHOTOSHOP ke EXCEL di Jawa – Konversi PHOTOSHOP ke EXCEL"
head_description: "Konversi PHOTOSHOP ke EXCEL di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PHOTOSHOP ke EXCEL di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PHOTOSHOP ke EXCEL di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PHOTOSHOP ke EXCEL dalam beberapa baris kode.
