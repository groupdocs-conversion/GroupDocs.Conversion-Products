...
draft: false
otherformats: 
breadcrumb: PHOTOSHOP to MPX in Java

############################# Head ############################
head_title: "PHOTOSHOP to MPX Converter in Java"
head_description: "Convert PHOTOSHOP to MPX in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert PHOTOSHOP to MPX in Java"
description: "PHOTOSHOP to MPX conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your PHOTOSHOP files to MPX in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert PHOTOSHOP to MPX in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a PHOTOSHOP file to MPX with a few lines of code.
