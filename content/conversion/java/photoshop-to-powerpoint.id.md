...
head_title: "Konversi PHOTOSHOP ke POWERPOINT di Jawa – Konversi PHOTOSHOP ke POWERPOINT"
head_description: "Konversi PHOTOSHOP ke POWERPOINT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PHOTOSHOP ke POWERPOINT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PHOTOSHOP ke POWERPOINT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PHOTOSHOP ke POWERPOINT dalam beberapa baris kode.
