...
############################# Head ############################
head_title: "Преобразование PHOTOSHOP в WEB на Java - Преобразование PHOTOSHOP в WEB"
head_description: "Преобразуйте PHOTOSHOP в WEB на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов PHOTOSHOP в WEB на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию PHOTOSHOP в WEB на Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл PHOTOSHOP в WEB с помощью нескольких строк кода.
