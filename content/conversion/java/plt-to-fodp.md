...
############################# Head ############################
head_title: "PLT to FODP Conversion in Java – Convert PLT to FODP"
head_description: "Convert PLT to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PLT Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PLT to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PLT file to FODP in few lines of code.
...
demos:
    enable: true
    title: "PLT to FODP Live Demos"
    content: |
        Convert PLT to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
