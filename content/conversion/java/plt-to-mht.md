...
############################# Head ############################
head_title: "PLT to MHT Conversion in Java – Convert PLT to MHT"
head_description: "Convert PLT to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PLT Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PLT to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PLT file to MHT in few lines of code.
