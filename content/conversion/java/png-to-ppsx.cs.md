...
############################# Head ############################
head_title: "Převést PNG na PPSX v Java"
head_description: "Převod PNG na PPSX v Java pomocí několika řádků kódu. Převeďte více než 160 formátů souborů pomocí rozhraní API pro převod dokumentů GroupDocs pro Java"

############################# Header ############################
title: "Převést PNG na PPSX v Java"
description: "Převod PNG na PPSX s několika řádky kódu Java"
...
overview:
    enable: true
    content: |
        Převeďte své soubory PNG na PPSX ve službě Java. Na libovolné platformě dle vašeho výběru, jako jsou Windows, Linux, macOS, stačí jen pár řádků kódu Java.
        Můžete zkusit zdarma převést PNG na PPSX a vyhodnotit kvalitu výsledků převodu. Spolu s jednoduchými skripty pro převod souborů můžete vyzkoušet sofistikovanější možnosti pro načtení zdrojového souboru PNG a uložení výstupu PPSX. 
        ...
        * přidat vodoznak do převedeného PPSX.
        ...
        Po dokončení převodu můžete soubor PPSX uložit do místní cesty k souboru nebo do libovolného úložiště třetí strany, jako je FTP, Amazon S3, Disk Google, Dropbox atd. Poznámka – pro převod PNG do PPSX, nemusíte instalovat žádný další software, jako je MS Office, Open Office, Adobe Acrobat Reader atd.


############################# Steps ############################
steps:
    enable: true
    title_left: "Kroky k převodu PNG na PPSX v Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) umožňuje vývojářům snadno převést soubor PNG na PPSX pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od PNG do PPSX"
    content: |
       Navštivte naši webovou stránku [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) a vyzkoušejte konverzi PNG na PPSX nyní. Bezplatná ukázka má následující výhody
