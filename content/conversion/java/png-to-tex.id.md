...
head_title: "Konversi PNG ke TEX di Jawa – Konversi PNG ke TEX"
head_description: "Konversi PNG ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PNG ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PNG ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PNG ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PNG hingga TEX"
    content: |
        Konversikan PNG ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
