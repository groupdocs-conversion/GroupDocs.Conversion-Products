...
############################# Head #############################
head_title: "Java PNG zu WMF Konverter API - PNG in Java-Anwendungen transformieren"
head_description: "PNG zu WMF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "PNG in WMF in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von PNG in WMF Datei in Java" 
    content: |
      Die Transformation von PNG in WMF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // PNG in WMF Datei konvertieren        
        ```            
