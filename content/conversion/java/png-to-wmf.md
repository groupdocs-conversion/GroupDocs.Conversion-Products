...
############################# Head ############################
head_title: "PNG to WMF Conversion in Java – Convert PNG to WMF"
head_description: "Convert PNG to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PNG Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PNG to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PNG file to WMF in few lines of code.
...
demos:
    enable: true
    title: "PNG to WMF Live Demos"
    content: |
        Convert PNG to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
