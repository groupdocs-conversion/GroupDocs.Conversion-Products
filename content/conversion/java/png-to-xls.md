...
############################# Head ############################
head_title: "PNG to XLS Conversion in Java – Convert PNG to XLS"
head_description: "Convert PNG to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PNG Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PNG to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PNG file to XLS in few lines of code.
...
demos:
    enable: true
    title: "PNG to XLS Live Demos"
    content: |
        Convert PNG to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
