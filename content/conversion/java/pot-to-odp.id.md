...
head_title: "Konversi POT ke ODP di Jawa – Konversi POT ke ODP"
head_description: "Konversi POT ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POT ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POT ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POT ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POT hingga ODP"
    content: |
        Konversikan POT ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
