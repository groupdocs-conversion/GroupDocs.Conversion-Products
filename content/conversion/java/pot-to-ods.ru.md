...
############################# Head ############################
head_title: "Преобразование POT в ODS в Java - преобразование POT в ODS"
head_description: "Преобразование POT в ODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов POT в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию POT в ODS в Java"
    content_left: |
