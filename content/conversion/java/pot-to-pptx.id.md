...
head_title: "Konversi POT ke PPTX di Jawa – Konversi POT ke PPTX"
head_description: "Konversi POT ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POT ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POT ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POT ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POT hingga PPTX"
    content: |
        Konversikan POT ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
