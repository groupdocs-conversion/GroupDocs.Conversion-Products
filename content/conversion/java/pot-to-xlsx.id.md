...
head_title: "Konversi POT ke XLSX di Jawa – Konversi POT ke XLSX"
head_description: "Konversi POT ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POT ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POT ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POT ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POT hingga XLSX"
    content: |
        Konversikan POT ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
