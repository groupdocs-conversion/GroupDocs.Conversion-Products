...
head_description: "Преобразуйте POTM в DOTX на Java, используя несколько строк кода. Используйте API преобразования документов GroupDocs для преобразования более 160 форматов файлов."

############################# Header ############################
title: "Преобразование POTM в DOTX в Java"
description: "Конвертировать POTM в DOTX с помощью нескольких строк кода Java"
...
overview:
    enable: true
    content: |
        Легко конвертируйте файлы POTM в DOTX на Java. Вы можете использовать всего пару строк кода Java на любой платформе по вашему выбору, например - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Шаги по преобразованию POTM в DOTX в Java"
    content_left: |
