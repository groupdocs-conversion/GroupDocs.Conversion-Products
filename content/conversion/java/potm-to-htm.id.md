...
head_title: "Konversi POTM ke HTM di Jawa – Konversi POTM ke HTM"
head_description: "Konversi POTM ke HTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTM ke HTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTM ke HTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTM ke HTM dalam beberapa baris kode.
