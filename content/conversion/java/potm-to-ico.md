...
############################# Head ############################
head_title: "POTM to ICO Conversion in Java – Convert POTM to ICO"
head_description: "Convert POTM to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTM Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTM to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTM file to ICO in few lines of code.
...
demos:
    enable: true
    title: "POTM to ICO Live Demos"
    content: |
        Convert POTM to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
