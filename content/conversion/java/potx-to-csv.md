...
############################# Head ############################
head_title: "POTX to CSV Conversion in Java – Convert POTX to CSV"
head_description: "Convert POTX to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to CSV in few lines of code.
...
demos:
    enable: true
    title: "POTX to CSV Live Demos"
    content: |
        Convert POTX to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
