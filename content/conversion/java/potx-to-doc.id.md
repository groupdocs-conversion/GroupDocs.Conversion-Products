...
head_title: "Konversi POTX ke DOC di Jawa – Konversi POTX ke DOC"
head_description: "Konversi POTX ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke DOC di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga DOC"
    content: |
        Konversikan POTX ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
