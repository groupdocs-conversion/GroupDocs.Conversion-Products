...
head_title: "Konversi POTX ke DOCX di Jawa – Konversi POTX ke DOCX"
head_description: "Konversi POTX ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke DOCX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga DOCX"
    content: |
        Konversikan POTX ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
