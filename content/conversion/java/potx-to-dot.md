...
############################# Head ############################
head_title: "POTX to DOT Conversion in Java – Convert POTX to DOT"
head_description: "Convert POTX to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to DOT in few lines of code.
