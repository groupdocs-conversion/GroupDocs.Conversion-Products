...
head_title: "Konversi POTX ke FODP di Jawa – Konversi POTX ke FODP"
head_description: "Konversi POTX ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga FODP"
    content: |
        Konversikan POTX ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
