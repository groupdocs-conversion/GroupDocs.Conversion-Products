...
head_title: "Konversi POTX ke FODS di Jawa – Konversi POTX ke FODS"
head_description: "Konversi POTX ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga FODS"
    content: |
        Konversikan POTX ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
