...
############################# Head ############################
head_title: "POTX to FODS Conversion in Java – Convert POTX to FODS"
head_description: "Convert POTX to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to FODS in few lines of code.
...
demos:
    enable: true
    title: "POTX to FODS Live Demos"
    content: |
        Convert POTX to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
