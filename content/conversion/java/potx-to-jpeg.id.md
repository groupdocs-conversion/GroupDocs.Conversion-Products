...
head_title: "Konversi POTX ke JPEG di Jawa – Konversi POTX ke JPEG"
head_description: "Konversi POTX ke JPEG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke JPEG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke JPEG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga JPEG"
    content: |
        Konversikan POTX ke JPEG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
