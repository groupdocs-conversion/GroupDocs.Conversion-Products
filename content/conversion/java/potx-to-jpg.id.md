...
head_title: "Konversi POTX ke JPG di Jawa – Konversi POTX ke JPG"
head_description: "Konversi POTX ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke JPG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga JPG"
    content: |
        Konversikan POTX ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
