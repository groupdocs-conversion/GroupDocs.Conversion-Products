...
head_title: "Konversi POTX ke ODS di Jawa – Konversi POTX ke ODS"
head_description: "Konversi POTX ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga ODS"
    content: |
        Konversikan POTX ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
