...
head_title: "Konversi POTX ke OTP di Jawa – Konversi POTX ke OTP"
head_description: "Konversi POTX ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke OTP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke OTP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke OTP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga OTP"
    content: |
        Konversikan POTX ke OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
