...
head_title: "Konversi POTX ke POTM di Jawa – Konversi POTX ke POTM"
head_description: "Konversi POTX ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke POTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga POTM"
    content: |
        Konversikan POTX ke POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
