...
head_title: "Konversi POTX ke PPS di Jawa – Konversi POTX ke PPS"
head_description: "Konversi POTX ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga PPS"
    content: |
        Konversikan POTX ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
