...
head_title: "Konversi POTX ke WEBP di Jawa – Konversi POTX ke WEBP"
head_description: "Konversi POTX ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga WEBP"
    content: |
        Konversikan POTX ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
