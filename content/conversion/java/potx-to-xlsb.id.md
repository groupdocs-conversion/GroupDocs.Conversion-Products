...
head_title: "Konversi POTX ke XLSB di Jawa – Konversi POTX ke XLSB"
head_description: "Konversi POTX ke XLSB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke XLSB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke XLSB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke XLSB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga XLSB"
    content: |
        Konversikan POTX ke XLSB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
