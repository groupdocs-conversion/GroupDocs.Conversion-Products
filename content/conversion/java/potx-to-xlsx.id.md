...
head_title: "Konversi POTX ke XLSX di Jawa – Konversi POTX ke XLSX"
head_description: "Konversi POTX ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga XLSX"
    content: |
        Konversikan POTX ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
