...
head_title: "Konversi POTX ke XLTX di Jawa – Konversi POTX ke XLTX"
head_description: "Konversi POTX ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POTX ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POTX ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POTX ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POTX hingga XLTX"
    content: |
        Konversikan POTX ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
