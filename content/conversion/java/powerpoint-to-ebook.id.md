...
head_title: "Konversi POWERPOINT ke EBOOK di Jawa – Konversi POWERPOINT ke EBOOK"
head_description: "Konversi POWERPOINT ke EBOOK di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POWERPOINT ke EBOOK di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POWERPOINT ke EBOOK di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POWERPOINT ke EBOOK dalam beberapa baris kode.
