...
head_title: "Konversi POWERPOINT ke EXCEL di Jawa – Konversi POWERPOINT ke EXCEL"
head_description: "Konversi POWERPOINT ke EXCEL di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POWERPOINT ke EXCEL di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POWERPOINT ke EXCEL di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POWERPOINT ke EXCEL dalam beberapa baris kode.
