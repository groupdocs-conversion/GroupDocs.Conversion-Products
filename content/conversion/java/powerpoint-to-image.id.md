...
head_title: "Konversi POWERPOINT ke IMAGE di Jawa – Konversi POWERPOINT ke IMAGE"
head_description: "Konversi POWERPOINT ke IMAGE di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POWERPOINT ke IMAGE di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POWERPOINT ke IMAGE di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POWERPOINT ke IMAGE dalam beberapa baris kode.
