...
head_title: "Konversi POWERPOINT ke WEB di Jawa – Konversi POWERPOINT ke WEB"
head_description: "Konversi POWERPOINT ke WEB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POWERPOINT ke WEB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POWERPOINT ke WEB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POWERPOINT ke WEB dalam beberapa baris kode.
