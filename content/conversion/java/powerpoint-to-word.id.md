...
head_title: "Konversi POWERPOINT ke WORD di Jawa – Konversi POWERPOINT ke WORD"
head_description: "Konversi POWERPOINT ke WORD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File POWERPOINT ke WORD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi POWERPOINT ke WORD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file POWERPOINT ke WORD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung POWERPOINT hingga WORD"
    content: |
        Konversikan POWERPOINT ke WORD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
