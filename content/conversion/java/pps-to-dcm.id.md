...
head_title: "Konversi PPS ke DCM di Jawa – Konversi PPS ke DCM"
head_description: "Konversi PPS ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPS ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga DCM"
    content: |
        Konversikan PPS ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
