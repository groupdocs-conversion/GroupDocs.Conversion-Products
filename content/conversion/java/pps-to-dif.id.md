...
head_title: "Konversi PPS ke DIF di Jawa – Konversi PPS ke DIF"
head_description: "Konversi PPS ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPS ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga DIF"
    content: |
        Konversikan PPS ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
