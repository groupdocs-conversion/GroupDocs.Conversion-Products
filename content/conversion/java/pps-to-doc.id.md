...
head_title: "Konversi PPS ke DOC di Jawa – Konversi PPS ke DOC"
head_description: "Konversi PPS ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke DOC di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga DOC"
    content: |
        Konversikan PPS ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
