...
head_title: "Konversi PPS ke DOCX di Jawa – Konversi PPS ke DOCX"
head_description: "Konversi PPS ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke DOCX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga DOCX"
    content: |
        Konversikan PPS ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
