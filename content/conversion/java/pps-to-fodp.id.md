...
head_title: "Konversi PPS ke FODP di Jawa – Konversi PPS ke FODP"
head_description: "Konversi PPS ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPS ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga FODP"
    content: |
        Konversikan PPS ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
