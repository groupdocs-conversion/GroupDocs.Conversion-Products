...
############################# Head ############################
head_title: "PPS to FODS Conversion in Java – Convert PPS to FODS"
head_description: "Convert PPS to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to FODS in few lines of code.
...
demos:
    enable: true
    title: "PPS to FODS Live Demos"
    content: |
        Convert PPS to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
