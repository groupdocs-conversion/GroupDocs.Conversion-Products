...
############################# Head ############################
head_title: "PPS to MHT Conversion in Java – Convert PPS to MHT"
head_description: "Convert PPS to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to MHT in few lines of code.
...
demos:
    enable: true
    title: "PPS to MHT Live Demos"
    content: |
        Convert PPS to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
