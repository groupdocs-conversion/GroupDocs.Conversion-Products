...
head_title: "Konversi PPS ke ODP di Jawa – Konversi PPS ke ODP"
head_description: "Konversi PPS ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPS ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga ODP"
    content: |
        Konversikan PPS ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
