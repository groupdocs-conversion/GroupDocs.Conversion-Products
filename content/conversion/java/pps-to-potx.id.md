...
head_title: "Konversi PPS ke POTX di Jawa – Konversi PPS ke POTX"
head_description: "Konversi PPS ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPS ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga POTX"
    content: |
        Konversikan PPS ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
