...
head_title: "Konversi PPS ke WEBP di Jawa – Konversi PPS ke WEBP"
head_description: "Konversi PPS ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPS ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga WEBP"
    content: |
        Konversikan PPS ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
