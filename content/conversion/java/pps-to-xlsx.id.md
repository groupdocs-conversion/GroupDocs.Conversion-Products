...
head_title: "Konversi PPS ke XLSX di Jawa – Konversi PPS ke XLSX"
head_description: "Konversi PPS ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPS ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga XLSX"
    content: |
        Konversikan PPS ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
