...
head_title: "Konversi PPS ke XLTX di Jawa – Konversi PPS ke XLTX"
head_description: "Konversi PPS ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPS ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPS ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPS ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPS hingga XLTX"
    content: |
        Konversikan PPS ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
