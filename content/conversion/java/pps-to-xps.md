...
############################# Head ############################
head_title: "PPS to XPS Conversion in Java – Convert PPS to XPS"
head_description: "Convert PPS to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to XPS in few lines of code.
...
demos:
    enable: true
    title: "PPS to XPS Live Demos"
    content: |
        Convert PPS to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
