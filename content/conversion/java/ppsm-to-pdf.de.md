...
############################# Head #############################
head_title: "Java PPSM zu PDF Konverter API - PPSM in Java-Anwendungen transformieren"
head_description: "PPSM zu PDF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "PPSM in PDF in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von PPSM in PDF Datei in Java" 
    content: |
      Die Transformation von PPSM in PDF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // PPSM in PDF Datei konvertieren        
        ```            
