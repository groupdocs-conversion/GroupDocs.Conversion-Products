...
head_title: "Konversi PPSM ke PPSX di Jawa – Konversi PPSM ke PPSX"
head_description: "Konversi PPSM ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSM ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSM ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSM ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSM hingga PPSX"
    content: |
        Konversikan PPSM ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
