...
############################# Head ############################
head_title: "PPSM to PPT Conversion in Java – Convert PPSM to PPT"
head_description: "Convert PPSM to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSM Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSM to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSM file to PPT in few lines of code.
...
demos:
    enable: true
    title: "PPSM to PPT Live Demos"
    content: |
        Convert PPSM to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
