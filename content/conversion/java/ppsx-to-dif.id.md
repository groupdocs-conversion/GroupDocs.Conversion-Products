...
head_title: "Konversi PPSX ke DIF di Jawa – Konversi PPSX ke DIF"
head_description: "Konversi PPSX ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga DIF"
    content: |
        Konversikan PPSX ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
