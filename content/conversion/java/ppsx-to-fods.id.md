...
head_title: "Konversi PPSX ke FODS di Jawa – Konversi PPSX ke FODS"
head_description: "Konversi PPSX ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga FODS"
    content: |
        Konversikan PPSX ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
