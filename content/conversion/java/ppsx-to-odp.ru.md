...
############################# Head ############################
head_title: "Преобразование PPSX в ODP в Java — преобразование PPSX в ODP"
head_description: "Преобразуйте PPSX в ODP на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов PPSX в ODP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию PPSX в ODP в Java"
    content_left: |
