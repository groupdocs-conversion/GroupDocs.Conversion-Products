...
############################# Head ############################
head_title: "Преобразование PPSX в ODS в Java — преобразование PPSX в ODS"
head_description: "Преобразуйте PPSX в ODS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов PPSX в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию PPSX в ODS в Java"
    content_left: |
