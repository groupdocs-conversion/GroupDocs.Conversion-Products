...
head_title: "Konversi PPSX ke POT di Jawa – Konversi PPSX ke POT"
head_description: "Konversi PPSX ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke POT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga POT"
    content: |
        Konversikan PPSX ke POT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
