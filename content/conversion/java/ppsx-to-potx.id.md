...
head_title: "Konversi PPSX ke POTX di Jawa – Konversi PPSX ke POTX"
head_description: "Konversi PPSX ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga POTX"
    content: |
        Konversikan PPSX ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
