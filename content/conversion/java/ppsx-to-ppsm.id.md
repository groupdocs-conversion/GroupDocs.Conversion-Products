...
head_title: "Konversi PPSX ke PPSM di Jawa – Konversi PPSX ke PPSM"
head_description: "Konversi PPSX ke PPSM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke PPSM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke PPSM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke PPSM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga PPSM"
    content: |
        Konversikan PPSX ke PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
