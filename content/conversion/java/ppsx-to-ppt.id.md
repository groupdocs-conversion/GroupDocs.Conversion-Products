...
head_title: "Konversi PPSX ke PPT di Jawa – Konversi PPSX ke PPT"
head_description: "Konversi PPSX ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga PPT"
    content: |
        Konversikan PPSX ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
