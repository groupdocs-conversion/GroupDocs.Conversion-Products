...
head_title: "Konversi PPSX ke PPTX di Jawa – Konversi PPSX ke PPTX"
head_description: "Konversi PPSX ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga PPTX"
    content: |
        Konversikan PPSX ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
