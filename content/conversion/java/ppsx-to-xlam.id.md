...
head_title: "Konversi PPSX ke XLAM di Jawa – Konversi PPSX ke XLAM"
head_description: "Konversi PPSX ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga XLAM"
    content: |
        Konversikan PPSX ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
