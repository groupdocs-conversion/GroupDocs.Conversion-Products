...
head_title: "Konversi PPSX ke XLS di Jawa – Konversi PPSX ke XLS"
head_description: "Konversi PPSX ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga XLS"
    content: |
        Konversikan PPSX ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
