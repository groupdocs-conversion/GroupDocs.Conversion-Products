...
head_title: "Konversi PPSX ke XLSB di Jawa – Konversi PPSX ke XLSB"
head_description: "Konversi PPSX ke XLSB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke XLSB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke XLSB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke XLSB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga XLSB"
    content: |
        Konversikan PPSX ke XLSB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
