...
head_title: "Konversi PPSX ke XLSX di Jawa – Konversi PPSX ke XLSX"
head_description: "Konversi PPSX ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga XLSX"
    content: |
        Konversikan PPSX ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
