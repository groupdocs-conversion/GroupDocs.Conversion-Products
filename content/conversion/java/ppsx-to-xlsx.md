...
############################# Head ############################
head_title: "PPSX to XLSX Conversion in Java – Convert PPSX to XLSX"
head_description: "Convert PPSX to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSX Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSX to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSX file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "PPSX to XLSX Live Demos"
    content: |
        Convert PPSX to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
