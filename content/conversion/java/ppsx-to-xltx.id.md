...
head_title: "Konversi PPSX ke XLTX di Jawa – Konversi PPSX ke XLTX"
head_description: "Konversi PPSX ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPSX ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPSX ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPSX ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPSX hingga XLTX"
    content: |
        Konversikan PPSX ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
