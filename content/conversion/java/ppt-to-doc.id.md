...
head_title: "Konversi PPT ke DOC di Jawa – Konversi PPT ke DOC"
head_description: "Konversi PPT ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke DOC di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga DOC"
    content: |
        Konversikan PPT ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
