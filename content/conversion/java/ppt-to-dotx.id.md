...
head_title: "Konversi PPT ke DOTX di Jawa – Konversi PPT ke DOTX"
head_description: "Konversi PPT ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke DOTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga DOTX"
    content: |
        Konversikan PPT ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
