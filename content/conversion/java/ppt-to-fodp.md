...
############################# Head ############################
head_title: "PPT to FODP Conversion in Java – Convert PPT to FODP"
head_description: "Convert PPT to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to FODP in few lines of code.
...
demos:
    enable: true
    title: "PPT to FODP Live Demos"
    content: |
        Convert PPT to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
