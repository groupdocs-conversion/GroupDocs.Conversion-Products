...
head_title: "Konversi PPT ke HTML di Jawa – Konversi PPT ke HTML"
head_description: "Konversi PPT ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPT ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga HTML"
    content: |
        Konversikan PPT ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
