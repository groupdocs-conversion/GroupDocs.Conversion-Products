...
head_title: "Konversi PPT ke JP2 di Jawa – Konversi PPT ke JP2"
head_description: "Konversi PPT ke JP2 di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke JP2 di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPT ke JP2 di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke JP2 dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga JP2"
    content: |
        Konversikan PPT ke JP2 sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
