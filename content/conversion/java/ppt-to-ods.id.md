...
head_title: "Konversi PPT ke ODS di Jawa – Konversi PPT ke ODS"
head_description: "Konversi PPT ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPT ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga ODS"
    content: |
        Konversikan PPT ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
