...
head_title: "Konversi PPT ke OTP di Jawa – Konversi PPT ke OTP"
head_description: "Konversi PPT ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke OTP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPT ke OTP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke OTP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga OTP"
    content: |
        Konversikan PPT ke OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
