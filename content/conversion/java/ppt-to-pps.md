...
############################# Head ############################
head_title: "PPT to PPS Conversion in Java – Convert PPT to PPS"
head_description: "Convert PPT to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to PPS in few lines of code.
...
demos:
    enable: true
    title: "PPT to PPS Live Demos"
    content: |
        Convert PPT to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
