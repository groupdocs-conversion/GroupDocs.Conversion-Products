...
head_title: "Konversi PPT ke SXC di Jawa – Konversi PPT ke SXC"
head_description: "Konversi PPT ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPT ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga SXC"
    content: |
        Konversikan PPT ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
