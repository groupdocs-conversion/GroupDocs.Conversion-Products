...
head_title: "Konversi PPT ke WEBP di Jawa – Konversi PPT ke WEBP"
head_description: "Konversi PPT ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPT ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke WEBP dalam beberapa baris kode.
