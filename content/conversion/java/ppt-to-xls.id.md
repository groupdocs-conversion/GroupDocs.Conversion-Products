...
head_title: "Konversi PPT ke XLS di Jawa – Konversi PPT ke XLS"
head_description: "Konversi PPT ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPT ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga XLS"
    content: |
        Konversikan PPT ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
