...
head_title: "Konversi PPT ke XLT di Jawa – Konversi PPT ke XLT"
head_description: "Konversi PPT ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPT ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPT ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPT ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPT hingga XLT"
    content: |
        Konversikan PPT ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
