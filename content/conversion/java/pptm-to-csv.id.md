...
head_title: "Konversi PPTM ke CSV di Jawa – Konversi PPTM ke CSV"
head_description: "Konversi PPTM ke CSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke CSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke CSV di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke CSV dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga CSV"
    content: |
        Konversikan PPTM ke CSV sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
