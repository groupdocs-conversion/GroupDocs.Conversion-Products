...
head_title: "Konversi PPTM ke DIF di Jawa – Konversi PPTM ke DIF"
head_description: "Konversi PPTM ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga DIF"
    content: |
        Konversikan PPTM ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
