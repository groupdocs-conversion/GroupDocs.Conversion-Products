...
############################# Head ############################
head_title: "PPTM to DOC Conversion in Java – Convert PPTM to DOC"
head_description: "Convert PPTM to DOC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to DOC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to DOC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to DOC in few lines of code.
...
demos:
    enable: true
    title: "PPTM to DOC Live Demos"
    content: |
        Convert PPTM to DOC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
