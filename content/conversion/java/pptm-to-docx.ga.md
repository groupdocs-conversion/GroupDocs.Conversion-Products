...
breadcrumb: PPTM go DOCX in Java

############################# Head ############################
head_title: "Tiontaigh PPTM go DOCX in Java"
head_description: "PPTM go DOCX tiontú in Java le cúpla líne de chód. Tiontaigh níos mó ná 160 formáid comhaid ag baint úsáid as an API tiontaithe doiciméad GroupDocs le haghaidh Java"

############################# Header ############################
title: "Tiontaigh PPTM go DOCX in Java"
description: "PPTM go DOCX tiontú le cúpla líne de chód Java"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid PPTM go DOCX in Java. Ní thógann sé ach cúpla líne de chód Java ar aon ardán de do rogha féin, ar nós Windows, Linux, macOS.
        Is féidir leat triail a bhaint as PPTM a thiontú go DOCX saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le scripteanna simplí comhshó comhad, is féidir leat triail a bhaint as roghanna níos sofaisticiúla chun an comhad foinse PPTM a luchtú agus an t-aschur DOCX a stóráil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun PPTM a thiontú go DOCX in Java"
    content_left: |
        Ceadaíonn [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) d'fhorbróirí comhad PPTM a thiontú go DOCX go héasca le cúpla líne de chód.
...
demos:
    enable: true
    title: "PPTM go DOCX Taispeántas Beo"
    content: |
       Tabhair cuairt ar ár suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) agus bain triail as PPTM go DOCX tiontú anois. Tá na buntáistí seo a leanas ag an taispeántas saor in aisce
