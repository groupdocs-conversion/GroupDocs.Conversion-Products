...
head_title: "Konversi PPTM ke FODP di Jawa – Konversi PPTM ke FODP"
head_description: "Konversi PPTM ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga FODP"
    content: |
        Konversikan PPTM ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
