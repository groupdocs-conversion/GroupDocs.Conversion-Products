...
head_title: "Konversi PPTM ke HTM di Jawa – Konversi PPTM ke HTM"
head_description: "Konversi PPTM ke HTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke HTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke HTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke HTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga HTM"
    content: |
        Konversikan PPTM ke HTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
