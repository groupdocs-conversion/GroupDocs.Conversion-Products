...
head_title: "Konversi PPTM ke HTML di Jawa – Konversi PPTM ke HTML"
head_description: "Konversi PPTM ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke HTML dalam beberapa baris kode.
