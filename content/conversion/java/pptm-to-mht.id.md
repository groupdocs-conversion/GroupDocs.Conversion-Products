...
head_title: "Konversi PPTM ke MHT di Jawa – Konversi PPTM ke MHT"
head_description: "Konversi PPTM ke MHT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke MHT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke MHT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke MHT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga MHT"
    content: |
        Konversikan PPTM ke MHT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
