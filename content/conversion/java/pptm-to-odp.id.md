...
head_title: "Konversi PPTM ke ODP di Jawa – Konversi PPTM ke ODP"
head_description: "Konversi PPTM ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga ODP"
    content: |
        Konversikan PPTM ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
