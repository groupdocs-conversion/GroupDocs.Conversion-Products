...
############################# Head ############################
head_title: "PPTM to PNG Conversion in Java – Convert PPTM to PNG"
head_description: "Convert PPTM to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to PNG in few lines of code.
...
demos:
    enable: true
    title: "PPTM to PNG Live Demos"
    content: |
        Convert PPTM to PNG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
