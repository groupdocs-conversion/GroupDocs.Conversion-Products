...
head_title: "Konversi PPTM ke PPS di Jawa – Konversi PPTM ke PPS"
head_description: "Konversi PPTM ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga PPS"
    content: |
        Konversikan PPTM ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
