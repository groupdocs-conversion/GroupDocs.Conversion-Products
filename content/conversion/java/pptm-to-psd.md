...
############################# Head ############################
head_title: "PPTM to PSD Conversion in Java – Convert PPTM to PSD"
head_description: "Convert PPTM to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to PSD in few lines of code.
...
demos:
    enable: true
    title: "PPTM to PSD Live Demos"
    content: |
        Convert PPTM to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
