...
############################# Head ############################
head_title: "PPTM to RTF Conversion in Java – Convert PPTM to RTF"
head_description: "Convert PPTM to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to RTF in few lines of code.
...
demos:
    enable: true
    title: "PPTM to RTF Live Demos"
    content: |
        Convert PPTM to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
