...
############################# Head ############################
head_title: "PPTM to TEX Conversion in Java – Convert PPTM to TEX"
head_description: "Convert PPTM to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to TEX in few lines of code.
...
demos:
    enable: true
    title: "PPTM to TEX Live Demos"
    content: |
        Convert PPTM to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
