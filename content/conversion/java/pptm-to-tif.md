...
############################# Head ############################
head_title: "PPTM to TIF Conversion in Java – Convert PPTM to TIF"
head_description: "Convert PPTM to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to TIF in few lines of code.
...
demos:
    enable: true
    title: "PPTM to TIF Live Demos"
    content: |
        Convert PPTM to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
