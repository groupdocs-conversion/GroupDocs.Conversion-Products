...
breadcrumb: PPTM to VSDX in Java

############################# Head ############################
head_title: "PPTM to VSDX Converter in Java"
head_description: "Convert PPTM to VSDX in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert PPTM to VSDX in Java"
description: "PPTM to VSDX conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your PPTM files to VSDX in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert PPTM to VSDX in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a PPTM file to VSDX with a few lines of code.
