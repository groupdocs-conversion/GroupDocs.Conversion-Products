...
############################# Head ############################
head_title: "PPTM to WEBP Conversion in Java – Convert PPTM to WEBP"
head_description: "Convert PPTM to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "PPTM to WEBP Live Demos"
    content: |
        Convert PPTM to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
