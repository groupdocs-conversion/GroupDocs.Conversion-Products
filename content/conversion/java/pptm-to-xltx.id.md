...
head_title: "Konversi PPTM ke XLTX di Jawa – Konversi PPTM ke XLTX"
head_description: "Konversi PPTM ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTM ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga XLTX"
    content: |
        Konversikan PPTM ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
