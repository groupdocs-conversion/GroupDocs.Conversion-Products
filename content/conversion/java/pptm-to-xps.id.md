...
head_title: "Konversi PPTM ke XPS di Jawa – Konversi PPTM ke XPS"
head_description: "Konversi PPTM ke XPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTM ke XPS di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTM ke XPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTM hingga XPS"
    content: |
        Konversikan PPTM ke XPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
