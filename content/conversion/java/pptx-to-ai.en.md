...
############################# Head #############################
head_title: "Java PPTX to AI Converter API - transform PPTX to AI in Java apps"
head_description: "View PPTX to AI files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert PPTX to AI in Java" 
description: "Experience the efficiency of a native, high-performance PPTX to AI file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert PPTX to AI file in Java" 
    content: |
      Transforming PPTX to AI is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // Convert PPTX to AI file        
        ```            
