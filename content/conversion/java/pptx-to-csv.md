...
############################# Head ############################
head_title: "PPTX to CSV Conversion in Java – Convert PPTX to CSV"
head_description: "Convert PPTX to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to CSV in few lines of code.
...
demos:
    enable: true
    title: "PPTX to CSV Live Demos"
    content: |
        Convert PPTX to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
