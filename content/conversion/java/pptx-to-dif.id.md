...
head_title: "Konversi PPTX ke DIF di Jawa – Konversi PPTX ke DIF"
head_description: "Konversi PPTX ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga DIF"
    content: |
        Konversikan PPTX ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
