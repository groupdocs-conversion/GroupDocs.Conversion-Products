...
head_title: "Konversi PPTX ke DOTX di Jawa – Konversi PPTX ke DOTX"
head_description: "Konversi PPTX ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke DOTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga DOTX"
    content: |
        Konversikan PPTX ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
