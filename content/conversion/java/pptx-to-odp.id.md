...
head_title: "Konversi PPTX ke ODP di Jawa – Konversi PPTX ke ODP"
head_description: "Konversi PPTX ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga ODP"
    content: |
        Konversikan PPTX ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
