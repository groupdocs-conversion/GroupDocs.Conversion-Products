...
head_title: "Konversi PPTX ke ODT di Jawa – Konversi PPTX ke ODT"
head_description: "Konversi PPTX ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke ODT di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga ODT"
    content: |
        Konversikan PPTX ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
