...
head_title: "Konversi PPTX ke OTP di Jawa – Konversi PPTX ke OTP"
head_description: "Konversi PPTX ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke OTP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke OTP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke OTP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga OTP"
    content: |
        Konversikan PPTX ke OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
