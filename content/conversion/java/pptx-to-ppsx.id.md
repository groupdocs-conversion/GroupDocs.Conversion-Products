...
head_title: "Konversi PPTX ke PPSX di Jawa – Konversi PPTX ke PPSX"
head_description: "Konversi PPTX ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga PPSX"
    content: |
        Konversikan PPTX ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
