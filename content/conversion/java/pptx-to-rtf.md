...
############################# Head ############################
head_title: "PPTX to RTF Conversion in Java – Convert PPTX to RTF"
head_description: "Convert PPTX to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to RTF in few lines of code.
...
demos:
    enable: true
    title: "PPTX to RTF Live Demos"
    content: |
        Convert PPTX to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
