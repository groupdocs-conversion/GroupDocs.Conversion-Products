...
head_title: "Konversi PPTX ke SVG di Jawa – Konversi PPTX ke SVG"
head_description: "Konversi PPTX ke SVG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke SVG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke SVG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke SVG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga SVG"
    content: |
        Konversikan PPTX ke SVG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
