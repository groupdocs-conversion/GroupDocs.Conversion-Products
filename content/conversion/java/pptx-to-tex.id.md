...
head_title: "Konversi PPTX ke TEX di Jawa – Konversi PPTX ke TEX"
head_description: "Konversi PPTX ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke TEX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga TEX"
    content: |
        Konversikan PPTX ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
