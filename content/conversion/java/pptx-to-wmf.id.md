...
head_title: "Konversi PPTX ke WMF di Jawa – Konversi PPTX ke WMF"
head_description: "Konversi PPTX ke WMF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke WMF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke WMF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke WMF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga WMF"
    content: |
        Konversikan PPTX ke WMF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
