...
############################# Head ############################
head_title: "PPTX to WMZ Conversion in Java – Convert PPTX to WMZ"
head_description: "Convert PPTX to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "PPTX to WMZ Live Demos"
    content: |
        Convert PPTX to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
