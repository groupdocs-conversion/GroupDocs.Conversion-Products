...
head_title: "Konversi PPTX ke XLAM di Jawa – Konversi PPTX ke XLAM"
head_description: "Konversi PPTX ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga XLAM"
    content: |
        Konversikan PPTX ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
