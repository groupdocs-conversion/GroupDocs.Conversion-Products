...
head_title: "Konversi PPTX ke XLS di Jawa – Konversi PPTX ke XLS"
head_description: "Konversi PPTX ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga XLS"
    content: |
        Konversikan PPTX ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
