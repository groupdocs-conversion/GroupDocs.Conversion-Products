...
head_title: "Konversi PPTX ke XLSB di Jawa – Konversi PPTX ke XLSB"
head_description: "Konversi PPTX ke XLSB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke XLSB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke XLSB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke XLSB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga XLSB"
    content: |
        Konversikan PPTX ke XLSB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
