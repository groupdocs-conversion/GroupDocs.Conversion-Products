...
head_title: "Konversi PPTX ke XLT di Jawa – Konversi PPTX ke XLT"
head_description: "Konversi PPTX ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga XLT"
    content: |
        Konversikan PPTX ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
