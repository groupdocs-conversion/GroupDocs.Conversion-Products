...
head_title: "Konversi PPTX ke XLTM di Jawa – Konversi PPTX ke XLTM"
head_description: "Konversi PPTX ke XLTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PPTX ke XLTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PPTX ke XLTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PPTX ke XLTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PPTX hingga XLTM"
    content: |
        Konversikan PPTX ke XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
