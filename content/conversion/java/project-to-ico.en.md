...
############################# Head ############################
head_title: "PROJECT to ICO Conversion in Java – Convert PROJECT to ICO"
head_description: "Convert PROJECT to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PROJECT Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PROJECT to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PROJECT file to ICO in few lines of code.
...
demos:
    enable: true
    title: "PROJECT to ICO Live Demos"
    content: |
        Convert PROJECT to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
