...
head_title: "Konversi PROJECT ke ICO di Jawa – Konversi PROJECT ke ICO"
head_description: "Konversi PROJECT ke ICO di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PROJECT ke ICO di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PROJECT ke ICO di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PROJECT ke ICO dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PROJECT hingga ICO"
    content: |
        Konversikan PROJECT ke ICO sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
