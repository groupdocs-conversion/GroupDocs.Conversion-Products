...
draft: false
otherformats: 
breadcrumb: PROJECT to JSON in Java

############################# Head ############################
head_title: "PROJECT to JSON Converter in Java"
head_description: "Convert PROJECT to JSON in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert PROJECT to JSON in Java"
description: "PROJECT to JSON conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your PROJECT files to JSON in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert PROJECT to JSON in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a PROJECT file to JSON with a few lines of code.
