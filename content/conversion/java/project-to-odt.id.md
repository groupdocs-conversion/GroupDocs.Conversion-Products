...
head_title: "Konversi PROJECT ke ODT di Jawa – Konversi PROJECT ke ODT"
head_description: "Konversi PROJECT ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PROJECT ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PROJECT ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PROJECT ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PROJECT hingga ODT"
    content: |
        Konversikan PROJECT ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
