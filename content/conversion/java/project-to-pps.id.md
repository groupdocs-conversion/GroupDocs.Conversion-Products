...
head_title: "Konversi PROJECT ke PPS di Jawa – Konversi PROJECT ke PPS"
head_description: "Konversi PROJECT ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PROJECT ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PROJECT ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PROJECT ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PROJECT hingga PPS"
    content: |
        Konversikan PROJECT ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
