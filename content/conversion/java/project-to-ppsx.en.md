...
############################# Head ############################
head_title: "PROJECT to PPSX Conversion in Java – Convert PROJECT to PPSX"
head_description: "Convert PROJECT to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PROJECT Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PROJECT to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PROJECT file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "PROJECT to PPSX Live Demos"
    content: |
        Convert PROJECT to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
