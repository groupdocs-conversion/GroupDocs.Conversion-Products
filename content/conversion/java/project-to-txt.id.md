...
head_title: "Konversi PROJECT ke TXT di Jawa – Konversi PROJECT ke TXT"
head_description: "Konversi PROJECT ke TXT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PROJECT ke TXT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PROJECT ke TXT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PROJECT ke TXT dalam beberapa baris kode.
