...
head_title: "Konversi PROJECT ke XLAM di Jawa – Konversi PROJECT ke XLAM"
head_description: "Konversi PROJECT ke XLAM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PROJECT ke XLAM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PROJECT ke XLAM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PROJECT ke XLAM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PROJECT hingga XLAM"
    content: |
        Konversikan PROJECT ke XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
