...
head_title: "Konversi PROJECT ke XLSX di Jawa – Konversi PROJECT ke XLSX"
head_description: "Konversi PROJECT ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PROJECT ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PROJECT ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PROJECT ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PROJECT hingga XLSX"
    content: |
        Konversikan PROJECT ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
