...
head_title: "Konversi PROJECT ke XLTX di Jawa – Konversi PROJECT ke XLTX"
head_description: "Konversi PROJECT ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PROJECT ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PROJECT ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PROJECT ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PROJECT hingga XLTX"
    content: |
        Konversikan PROJECT ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
