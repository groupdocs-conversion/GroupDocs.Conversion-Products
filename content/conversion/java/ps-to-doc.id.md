...
head_title: "Konversi PS ke DOC di Jawa – Konversi PS ke DOC"
head_description: "Konversi PS ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PS ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PS ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PS ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PS hingga DOC"
    content: |
        Konversikan PS ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
