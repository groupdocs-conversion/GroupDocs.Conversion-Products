...
head_title: "Konversi PS ke DOCX di Jawa – Konversi PS ke DOCX"
head_description: "Konversi PS ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PS ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PS ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PS ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PS hingga DOCX"
    content: |
        Konversikan PS ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
