...
head_title: "Konversi PS ke DOTX di Jawa – Konversi PS ke DOTX"
head_description: "Konversi PS ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PS ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PS ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PS ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PS hingga DOTX"
    content: |
        Konversikan PS ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
