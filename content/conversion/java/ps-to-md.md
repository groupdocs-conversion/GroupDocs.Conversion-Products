...
############################# Head ############################
head_title: "PS to MD Conversion in Java – Convert PS to MD"
head_description: "Convert PS to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PS Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PS to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PS file to MD in few lines of code.
...
demos:
    enable: true
    title: "PS to MD Live Demos"
    content: |
        Convert PS to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
