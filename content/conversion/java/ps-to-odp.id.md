...
head_title: "Konversi PS ke ODP di Jawa – Konversi PS ke ODP"
head_description: "Konversi PS ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PS ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PS ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PS ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PS hingga ODP"
    content: |
        Konversikan PS ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
