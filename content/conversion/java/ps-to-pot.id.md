...
head_title: "Konversi PS ke POT di Jawa – Konversi PS ke POT"
head_description: "Konversi PS ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PS ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PS ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PS ke POT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PS hingga POT"
    content: |
        Konversikan PS ke POT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
