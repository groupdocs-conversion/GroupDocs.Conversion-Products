...
head_title: "Konversi PS ke PPT di Jawa – Konversi PS ke PPT"
head_description: "Konversi PS ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PS ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PS ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PS ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PS hingga PPT"
    content: |
        Konversikan PS ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
