...
head_title: "Konversi PS ke PPTX di Jawa – Konversi PS ke PPTX"
head_description: "Konversi PS ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PS ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PS ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PS ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PS hingga PPTX"
    content: |
        Konversikan PS ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
