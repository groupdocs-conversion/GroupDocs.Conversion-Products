...
############################# Head ############################
head_title: "PS to TSV Conversion in Java – Convert PS to TSV"
head_description: "Convert PS to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PS Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PS to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PS file to TSV in few lines of code.
...
demos:
    enable: true
    title: "PS to TSV Live Demos"
    content: |
        Convert PS to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
