...
############################# Head ############################
head_title: "PS to WMZ Conversion in Java – Convert PS to WMZ"
head_description: "Convert PS to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PS Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PS to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PS file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "PS to WMZ Live Demos"
    content: |
        Convert PS to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
