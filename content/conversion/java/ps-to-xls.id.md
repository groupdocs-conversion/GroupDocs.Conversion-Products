...
head_title: "Konversi PS ke XLS di Jawa – Konversi PS ke XLS"
head_description: "Konversi PS ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PS ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PS ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PS ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PS hingga XLS"
    content: |
        Konversikan PS ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
