...
############################# Head ############################
head_title: "PSD to FODS Conversion in Java – Convert PSD to FODS"
head_description: "Convert PSD to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PSD Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PSD to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PSD file to FODS in few lines of code.
...
demos:
    enable: true
    title: "PSD to FODS Live Demos"
    content: |
        Convert PSD to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
