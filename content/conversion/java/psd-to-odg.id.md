...
head_title: "Konversi PSD ke ODG di Jawa – Konversi PSD ke ODG"
head_description: "Konversi PSD ke ODG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PSD ke ODG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PSD ke ODG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PSD ke ODG dalam beberapa baris kode.
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format ODG target
