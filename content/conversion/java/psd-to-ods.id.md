...
head_title: "Konversi PSD ke ODS di Jawa – Konversi PSD ke ODS"
head_description: "Konversi PSD ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PSD ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PSD ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PSD ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PSD hingga ODS"
    content: |
        Konversikan PSD ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
