...
head_title: "Konversi PSD ke ODT di Jawa – Konversi PSD ke ODT"
head_description: "Konversi PSD ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PSD ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PSD ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PSD ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PSD hingga ODT"
    content: |
        Konversikan PSD ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
