...
head_title: "Konversi PSD ke PPTM di Jawa – Konversi PSD ke PPTM"
head_description: "Konversi PSD ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PSD ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PSD ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PSD ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PSD hingga PPTM"
    content: |
        Konversikan PSD ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
