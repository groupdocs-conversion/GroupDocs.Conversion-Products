...
head_title: "Konversi PST ke DOTM di Jawa – Konversi PST ke DOTM"
head_description: "Konversi PST ke DOTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PST ke DOTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PST ke DOTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PST ke DOTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PST hingga DOTM"
    content: |
        Konversikan PST ke DOTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
