...
head_title: "Konversi PST ke EMLX di Jawa – Konversi PST ke EMLX"
head_description: "Konversi PST ke EMLX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PST ke EMLX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PST ke EMLX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PST ke EMLX dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file PST dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen EMLX
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (EMLX) sebagai parameter
...
demos:
    enable: true
    title: "Demo Langsung PST hingga EMLX"
    content: |
        Konversikan PST ke EMLX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
...
about_formats:
    ...
    format:
        - icon: "far fa-file-EMLX"
          title: " Tentang Format File EMLX"
          content: |
