...
breadcrumb: PST to METAFILE in Java

############################# Head ############################
head_title: "PST to METAFILE Converter in Java"
head_description: "Convert PST to METAFILE in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert PST to METAFILE in Java"
description: "PST to METAFILE conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your PST files to METAFILE in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert PST to METAFILE in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a PST file to METAFILE with a few lines of code.
