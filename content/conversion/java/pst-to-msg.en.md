...
############################# Head #############################
head_title: "Java PST to MSG Converter API - transform PST to MSG in Java apps"
head_description: "View PST to MSG files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert PST to MSG in Java" 
description: "Experience the efficiency of a native, high-performance PST to MSG file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert PST to MSG file in Java" 
    content: |
      Transforming PST to MSG is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the PST file with full path. 
