...
head_title: "Konversi PST ke MSG di Jawa – Konversi PST ke MSG"
head_description: "Konversi PST ke MSG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PST ke MSG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PST ke MSG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PST ke MSG dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file PST dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen MSG
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (MSG) sebagai parameter
...
demos:
    enable: true
    title: "Demo Langsung PST hingga MSG"
    content: |
        Konversikan PST ke MSG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
