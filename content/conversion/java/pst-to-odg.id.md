...
head_title: "Konversi PST ke ODG di Jawa – Konversi PST ke ODG"
head_description: "Konversi PST ke ODG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PST ke ODG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PST ke ODG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PST ke ODG dalam beberapa baris kode.
