...
head_title: "Konversi PST ke ODS di Jawa – Konversi PST ke ODS"
head_description: "Konversi PST ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PST ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PST ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PST ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PST hingga ODS"
    content: |
        Konversikan PST ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
