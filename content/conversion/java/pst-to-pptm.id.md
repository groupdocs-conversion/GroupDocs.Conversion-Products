...
head_title: "Konversi PST ke PPTM di Jawa – Konversi PST ke PPTM"
head_description: "Konversi PST ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PST ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PST ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PST ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PST hingga PPTM"
    content: |
        Konversikan PST ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
