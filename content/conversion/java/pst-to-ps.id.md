...
head_title: "Konversi PST ke PS di Jawa – Konversi PST ke PS"
head_description: "Konversi PST ke PS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PST ke PS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PST ke PS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PST ke PS dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file PST dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen PS
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (PS) sebagai parameter
...
demos:
    enable: true
    title: "Demo Langsung PST hingga PS"
    content: |
        Konversikan PST ke PS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
