...
head_title: "Konversi PST ke SXC di Jawa – Konversi PST ke SXC"
head_description: "Konversi PST ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File PST ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi PST ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file PST ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung PST hingga SXC"
    content: |
        Konversikan PST ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
