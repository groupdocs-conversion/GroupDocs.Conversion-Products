...
############################# Head ############################
head_title: "PST to XLTM Conversion in Java – Convert PST to XLTM"
head_description: "Convert PST to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PST Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PST to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PST file to XLTM in few lines of code.
