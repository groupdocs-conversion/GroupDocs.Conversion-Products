...
############################# Head ############################
head_title: "RTF to DCM Conversion in Java – Convert RTF to DCM"
head_description: "Convert RTF to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to DCM in few lines of code.
...
demos:
    enable: true
    title: "RTF to DCM Live Demos"
    content: |
        Convert RTF to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
