...
############################# Head ############################
head_title: "RTF to DOT Conversion in Java – Convert RTF to DOT"
head_description: "Convert RTF to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to DOT in few lines of code.
