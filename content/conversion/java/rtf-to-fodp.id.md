...
head_title: "Konversi RTF ke FODP di Jawa – Konversi RTF ke FODP"
head_description: "Konversi RTF ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File RTF ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi RTF ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file RTF ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung RTF hingga FODP"
    content: |
        Konversikan RTF ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
