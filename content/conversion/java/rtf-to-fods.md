...
############################# Head ############################
head_title: "RTF to FODS Conversion in Java – Convert RTF to FODS"
head_description: "Convert RTF to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to FODS in few lines of code.
...
demos:
    enable: true
    title: "RTF to FODS Live Demos"
    content: |
        Convert RTF to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
