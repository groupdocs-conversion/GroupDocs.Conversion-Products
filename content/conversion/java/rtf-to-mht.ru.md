...
############################# Head ############################
head_title: "Преобразование RTF в MHT в Java — преобразование RTF в MHT"
head_description: "Преобразование RTF в MHT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов RTF в MHT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию RTF в MHT в Java"
    content_left: |
