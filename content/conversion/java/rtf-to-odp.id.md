...
head_title: "Konversi RTF ke ODP di Jawa – Konversi RTF ke ODP"
head_description: "Konversi RTF ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File RTF ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi RTF ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file RTF ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung RTF hingga ODP"
    content: |
        Konversikan RTF ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
