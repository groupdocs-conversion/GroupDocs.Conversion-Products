...
############################# Head ############################
head_title: "RTF to ODS Conversion in Java – Convert RTF to ODS"
head_description: "Convert RTF to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to ODS in few lines of code.
...
demos:
    enable: true
    title: "RTF to ODS Live Demos"
    content: |
        Convert RTF to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
