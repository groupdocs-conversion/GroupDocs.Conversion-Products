...
############################# Head ############################
head_title: "RTF to OTP Conversion in Java – Convert RTF to OTP"
head_description: "Convert RTF to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to OTP in few lines of code.
...
demos:
    enable: true
    title: "RTF to OTP Live Demos"
    content: |
        Convert RTF to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
