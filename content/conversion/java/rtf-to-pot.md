...
############################# Head ############################
head_title: "RTF to POT Conversion in Java – Convert RTF to POT"
head_description: "Convert RTF to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to POT in few lines of code.
...
demos:
    enable: true
    title: "RTF to POT Live Demos"
    content: |
        Convert RTF to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
