...
head_title: "Konversi RTF ke SXC di Jawa – Konversi RTF ke SXC"
head_description: "Konversi RTF ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File RTF ke SXC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi RTF ke SXC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file RTF ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung RTF hingga SXC"
    content: |
        Konversikan RTF ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
