...
############################# Head ############################
head_title: "RTF to TSV Conversion in Java – Convert RTF to TSV"
head_description: "Convert RTF to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to TSV in few lines of code.
