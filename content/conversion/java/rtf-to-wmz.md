...
############################# Head ############################
head_title: "RTF to WMZ Conversion in Java – Convert RTF to WMZ"
head_description: "Convert RTF to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "RTF to WMZ Live Demos"
    content: |
        Convert RTF to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
