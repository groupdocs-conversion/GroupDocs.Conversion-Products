...
head_title: "Konversi STL ke DCM di Jawa – Konversi STL ke DCM"
head_description: "Konversi STL ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File STL ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi STL ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file STL ke DCM dalam beberapa baris kode.
