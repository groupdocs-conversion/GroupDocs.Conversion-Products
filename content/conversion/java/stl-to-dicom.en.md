...
############################# Head #############################
head_title: "Java STL to DICOM Converter API - transform STL to DICOM in Java apps"
head_description: "View STL to DICOM files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert STL to DICOM in Java" 
description: "Experience the efficiency of a native, high-performance STL to DICOM file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert STL to DICOM file in Java" 
    content: |
      Transforming STL to DICOM is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the STL file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.stl")              // Set up input STL file
            .convertTo("converted.dicom")    // Specify output path for converted file
            .convert();                     // Convert STL to DICOM file        
        ```            
