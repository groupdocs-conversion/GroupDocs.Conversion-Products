...
############################# Head #############################
head_title: "Java STL zu EMF Konverter API - STL in Java-Anwendungen transformieren"
head_description: "STL zu EMF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "STL in EMF in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken STL zu EMF Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von STL in EMF Datei in Java" 
    content: |
      Die Transformation von STL in EMF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // STL in EMF Datei konvertieren        
        ```            
