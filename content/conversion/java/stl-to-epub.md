...
############################# Head ############################
head_title: "STL to EPUB Conversion in Java – Convert STL to EPUB"
head_description: "Convert STL to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to EPUB in few lines of code.
