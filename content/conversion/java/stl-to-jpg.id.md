...
head_title: "Konversi STL ke JPG di Jawa – Konversi STL ke JPG"
head_description: "Konversi STL ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File STL ke JPG di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi STL ke JPG di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file STL ke JPG dalam beberapa baris kode.
