...
############################# Head ############################
head_title: "STL to MHTML Conversion in Java – Convert STL to MHTML"
head_description: "Convert STL to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "STL to MHTML Live Demos"
    content: |
        Convert STL to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
