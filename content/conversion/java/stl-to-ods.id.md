...
head_title: "Konversi STL ke ODS di Jawa – Konversi STL ke ODS"
head_description: "Konversi STL ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File STL ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi STL ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file STL ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung STL hingga ODS"
    content: |
        Konversikan STL ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
