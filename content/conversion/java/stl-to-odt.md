...
############################# Head ############################
head_title: "STL to ODT Conversion in Java – Convert STL to ODT"
head_description: "Convert STL to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to ODT in few lines of code.
...
demos:
    enable: true
    title: "STL to ODT Live Demos"
    content: |
        Convert STL to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
