...
breadcrumb: STL go POTM in Java

############################# Head ############################
head_title: "Tiontaigh STL go POTM in Java"
head_description: "STL go POTM tiontú in Java le cúpla líne de chód. Tiontaigh níos mó ná 160 formáid comhaid ag baint úsáid as an API tiontaithe doiciméad GroupDocs le haghaidh Java"

############################# Header ############################
title: "Tiontaigh STL go POTM in Java"
description: "STL go POTM tiontú le cúpla líne de chód Java"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid STL go POTM in Java. Ní thógann sé ach cúpla líne de chód Java ar aon ardán de do rogha féin, ar nós Windows, Linux, macOS.
        Is féidir leat triail a bhaint as STL a thiontú go POTM saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le scripteanna simplí comhshó comhad, is féidir leat triail a bhaint as roghanna níos sofaisticiúla chun an comhad foinse STL a luchtú agus an t-aschur POTM a stóráil. 
        ...
        * cuir clónna in ionad na gclónna atá ar iarraidh chun cuma an doiciméid a chaomhnú.
        ...
        Tá ardroghanna tiontaithe ann freisin don chomhad POTM:

        * tiontaigh leathanach ar leith de dhoiciméad nó raon leathanach;
        * cuir comhartha uisce leis an POTM tiontaithe.

        Nuair a bheidh an tiontú críochnaithe, is féidir leat an comhad POTM a shábháil ar do chosán comhaid áitiúil nó chuig aon stóras tríú páirtí ar nós FTP, Amazon S3, Google Drive, Dropbox etc. Tabhair faoi deara le do thoil - STL a thiontú go POTM, ní gá duit aon bhogearraí breise a shuiteáil, mar shampla MS Office, Open Office, Adobe Acrobat Reader srl.


############################# Steps ############################
steps:
    enable: true
    title_left: "Céimeanna chun STL a thiontú go POTM in Java"
    content_left: |
        Ceadaíonn [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) d'fhorbróirí comhad STL a thiontú go POTM go héasca le cúpla líne de chód.
        
        * Cruthaigh sampla nua den rang Tiontaire agus uaslódáil an comhad STL leis an gcosán iomlán
        * Socraigh ConvertOptions do chineál doiciméid go POTM
        * Glaoigh ar an modh tiontaithe() agus cuir ainm an doiciméid (cosán iomlán) agus formáid (POTM) mar pharaiméadar
    ...
    code: |
        ...
        // Luchtaigh an comhad foinse STL le haghaidh tiontaithe
          ...
          // Ullmhaigh roghanna tiontaithe don spriocfhormáid POTM
          ConvertOptions convertOptions = new FileType().fromExtension("potm").getConvertOptions();
          // Tiontaigh go formáid POTM
          converter.convert("output.potm", convertOptions);
        ```

demos:
    enable: true
    title: "STL go POTM Taispeántas Beo"
    content: |
       Tabhair cuairt ar ár suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) agus bain triail as STL go POTM tiontú anois. Tá na buntáistí seo a leanas ag an taispeántas saor in aisce
