...
############################# Head ############################
head_title: "STL to XLSB Conversion in Java – Convert STL to XLSB"
head_description: "Convert STL to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to XLSB in few lines of code.
...
demos:
    enable: true
    title: "STL to XLSB Live Demos"
    content: |
        Convert STL to XLSB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
