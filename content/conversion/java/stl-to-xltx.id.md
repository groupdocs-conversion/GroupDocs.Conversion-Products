...
head_title: "Konversi STL ke XLTX di Jawa – Konversi STL ke XLTX"
head_description: "Konversi STL ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File STL ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi STL ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file STL ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung STL hingga XLTX"
    content: |
        Konversikan STL ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
