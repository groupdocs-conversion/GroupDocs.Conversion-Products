...
############################# Head ############################
head_title: "SVG to EMF Conversion in Java – Convert SVG to EMF"
head_description: "Convert SVG to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to EMF in few lines of code.
...
demos:
    enable: true
    title: "SVG to EMF Live Demos"
    content: |
        Convert SVG to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
