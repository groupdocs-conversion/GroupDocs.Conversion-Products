...
############################# Head ############################
head_title: "SVG to FODP Conversion in Java – Convert SVG to FODP"
head_description: "Convert SVG to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to FODP in few lines of code.
...
demos:
    enable: true
    title: "SVG to FODP Live Demos"
    content: |
        Convert SVG to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
