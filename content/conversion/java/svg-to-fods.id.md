...
head_title: "Konversi SVG ke FODS di Jawa – Konversi SVG ke FODS"
head_description: "Konversi SVG ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVG ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SVG ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVG ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVG hingga FODS"
    content: |
        Konversikan SVG ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
