...
head_title: "Konversi SVG ke HTM di Jawa – Konversi SVG ke HTM"
head_description: "Konversi SVG ke HTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVG ke HTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SVG ke HTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVG ke HTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVG hingga HTM"
    content: |
        Konversikan SVG ke HTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
