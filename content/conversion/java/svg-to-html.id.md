...
head_title: "Konversi SVG ke HTML di Jawa – Konversi SVG ke HTML"
head_description: "Konversi SVG ke HTML di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVG ke HTML di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SVG ke HTML di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVG ke HTML dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVG hingga HTML"
    content: |
        Konversikan SVG ke HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
