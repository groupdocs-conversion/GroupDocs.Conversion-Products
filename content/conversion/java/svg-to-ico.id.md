...
head_title: "Konversi SVG ke ICO di Jawa – Konversi SVG ke ICO"
head_description: "Konversi SVG ke ICO di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVG ke ICO di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVG ke ICO dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVG hingga ICO"
    content: |
        Konversikan SVG ke ICO sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
