...
head_title: "Konversi SVG ke ODS di Jawa – Konversi SVG ke ODS"
head_description: "Konversi SVG ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVG ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SVG ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVG ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVG hingga ODS"
    content: |
        Konversikan SVG ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
