...
head_title: "Konversi SVG ke POTX di Jawa – Konversi SVG ke POTX"
head_description: "Konversi SVG ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVG ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SVG ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVG ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVG hingga POTX"
    content: |
        Konversikan SVG ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
