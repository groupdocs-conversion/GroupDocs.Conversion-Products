...
############################# Head ############################
head_title: "SVG to PPTX Conversion in Java – Convert SVG to PPTX"
head_description: "Convert SVG to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "SVG to PPTX Live Demos"
    content: |
        Convert SVG to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
