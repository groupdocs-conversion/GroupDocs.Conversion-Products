...
head_title: "Konversi SVG ke SVGZ di Jawa – Konversi SVG ke SVGZ"
head_description: "Konversi SVG ke SVGZ di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVG ke SVGZ di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVG ke SVGZ dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVG hingga SVGZ"
    content: |
        Konversikan SVG ke SVGZ sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
