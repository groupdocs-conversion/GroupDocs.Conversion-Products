...
head_title: "Konversi SVG ke TEX di Jawa – Konversi SVG ke TEX"
head_description: "Konversi SVG ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVG ke TEX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SVG ke TEX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVG ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVG hingga TEX"
    content: |
        Konversikan SVG ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
