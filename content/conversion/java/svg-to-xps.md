...
############################# Head ############################
head_title: "SVG to XPS Conversion in Java – Convert SVG to XPS"
head_description: "Convert SVG to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to XPS in few lines of code.
...
demos:
    enable: true
    title: "SVG to XPS Live Demos"
    content: |
        Convert SVG to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
