...
############################# Head ############################
head_title: "SVGZ to DOCX Conversion in Java – Convert SVGZ to DOCX"
head_description: "Convert SVGZ to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVGZ Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVGZ to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVGZ file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "SVGZ to DOCX Live Demos"
    content: |
        Convert SVGZ to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
