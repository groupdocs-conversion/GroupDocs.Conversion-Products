...
head_title: "Konversi SVGZ ke FODP di Jawa – Konversi SVGZ ke FODP"
head_description: "Konversi SVGZ ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVGZ ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SVGZ ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVGZ ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SVGZ hingga FODP"
    content: |
        Konversikan SVGZ ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
