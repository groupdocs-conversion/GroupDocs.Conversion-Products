...
head_title: "Konversi SVGZ ke ODS di Jawa – Konversi SVGZ ke ODS"
head_description: "Konversi SVGZ ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SVGZ ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SVGZ ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SVGZ ke ODS dalam beberapa baris kode.
