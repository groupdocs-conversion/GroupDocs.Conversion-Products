...
head_title: "Konversi SXC ke DCM di Jawa – Konversi SXC ke DCM"
head_description: "Konversi SXC ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SXC ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SXC ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SXC ke DCM dalam beberapa baris kode.
