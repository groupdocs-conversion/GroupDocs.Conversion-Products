...
############################# Head ############################
head_title: "SXC to DIF Conversion in Java – Convert SXC to DIF"
head_description: "Convert SXC to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to DIF in few lines of code.
...
demos:
    enable: true
    title: "SXC to DIF Live Demos"
    content: |
        Convert SXC to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
