...
############################# Head ############################
head_title: "SXC to FODP Conversion in Java – Convert SXC to FODP"
head_description: "Convert SXC to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to FODP in few lines of code.
...
demos:
    enable: true
    title: "SXC to FODP Live Demos"
    content: |
        Convert SXC to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
