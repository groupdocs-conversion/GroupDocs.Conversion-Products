...
breadcrumb: SXC na HTML in Java

############################# Head ############################
head_title: "Skakel SXC om na HTML in Java"
head_description: "SXC na HTML omskakeling in Java met 'n paar reëls kode. Skakel meer as 160 lêerformate om deur die GroupDocs-dokumentomskakelings-API vir Java"

############################# Header ############################
title: "Skakel SXC om na HTML in Java"
description: "SXC na HTML omskakeling met 'n paar reëls van Java-kode"
...
overview:
    enable: true
    content: |
        Skakel jou SXC lêers om na HTML in Java. Dit neem net 'n paar reëls van Java kode op enige platform van jou keuse, soos Windows, Linux, macOS.
        Jy kan probeer om SXC gratis na HTML om te skakel en die kwaliteit van die omskakelingsresultate te evalueer. Saam met eenvoudige lêeromskakelingsskrifte, kan jy meer gesofistikeerde opsies probeer om die SXC-bronlêer te laai en die HTML-uitvoer te stoor. 
...
steps:
    enable: true
    title_left: "Stappe om SXC na HTML om te skakel in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) laat ontwikkelaars toe om SXC lêer maklik om te skakel na HTML met 'n paar reëls kode.
...
demos:
    ...
    content: |
       Besoek ons ​​[GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) webwerf en probeer nou SXC na HTML omskakeling. Die gratis demo het die volgende voordele
