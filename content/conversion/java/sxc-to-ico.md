...
############################# Head ############################
head_title: "SXC to ICO Conversion in Java – Convert SXC to ICO"
head_description: "Convert SXC to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to ICO in few lines of code.
...
demos:
    enable: true
    title: "SXC to ICO Live Demos"
    content: |
        Convert SXC to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
