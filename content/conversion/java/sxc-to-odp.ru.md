...
############################# Head ############################
head_title: "Преобразование SXC в ODP в Java — преобразование SXC в ODP"
head_description: "Преобразуйте SXC в ODP на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов SXC в ODP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию SXC в ODP в Java"
    content_left: |
...
demos:
    enable: true
    title: "Демонстрации SXC в ODP Live"
    content: |
        Преобразуйте SXC в ODP прямо сейчас, посетив веб-сайт [GroupDocs.Conversion Живые демонстрации](https://products.groupdocs.app/conversion/family).
