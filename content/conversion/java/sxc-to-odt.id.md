...
head_title: "Konversi SXC ke ODT di Jawa – Konversi SXC ke ODT"
head_description: "Konversi SXC ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SXC ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SXC ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SXC ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SXC hingga ODT"
    content: |
        Konversikan SXC ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
