...
############################# Head ############################
head_title: "Преобразование SXC в ODT в Java — преобразование SXC в ODT"
head_description: "Преобразуйте SXC в ODT в Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов SXC в ODT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию SXC в ODT в Java"
    content_left: |
