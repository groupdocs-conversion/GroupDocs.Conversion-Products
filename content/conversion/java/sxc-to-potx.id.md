...
head_title: "Konversi SXC ke POTX di Jawa – Konversi SXC ke POTX"
head_description: "Konversi SXC ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SXC ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SXC ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SXC ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SXC hingga POTX"
    content: |
        Konversikan SXC ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
