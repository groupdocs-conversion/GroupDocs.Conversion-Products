...
head_title: "Konversi SXC ke PPSX di Jawa – Konversi SXC ke PPSX"
head_description: "Konversi SXC ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SXC ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SXC ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SXC ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SXC hingga PPSX"
    content: |
        Konversikan SXC ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
