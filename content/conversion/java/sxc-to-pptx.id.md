...
head_title: "Konversi SXC ke PPTX di Jawa – Konversi SXC ke PPTX"
head_description: "Konversi SXC ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File SXC ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi SXC ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file SXC ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung SXC hingga PPTX"
    content: |
        Konversikan SXC ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
