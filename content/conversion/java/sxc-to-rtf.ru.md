...
############################# Head ############################
head_title: "Преобразование SXC в RTF в Java — преобразование SXC в RTF"
head_description: "Преобразуйте SXC в RTF на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов SXC в RTF в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию SXC в RTF в Java"
    content_left: |
