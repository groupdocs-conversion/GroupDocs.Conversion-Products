...
############################# Head ############################
head_title: "SXC to TXT Conversion in Java – Convert SXC to TXT"
head_description: "Convert SXC to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to TXT in few lines of code.
...
demos:
    enable: true
    title: "SXC to TXT Live Demos"
    content: |
        Convert SXC to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
