...
############################# Head ############################
head_title: "SXC to WMF Conversion in Java – Convert SXC to WMF"
head_description: "Convert SXC to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to WMF in few lines of code.
...
demos:
    enable: true
    title: "SXC to WMF Live Demos"
    content: |
        Convert SXC to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
