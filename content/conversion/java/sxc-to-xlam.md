...
############################# Head ############################
head_title: "SXC to XLAM Conversion in Java – Convert SXC to XLAM"
head_description: "Convert SXC to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "SXC to XLAM Live Demos"
    content: |
        Convert SXC to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
