...
head_title: "Konversi TEX ke DIF di Jawa – Konversi TEX ke DIF"
head_description: "Konversi TEX ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga DIF"
    content: |
        Konversikan TEX ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
