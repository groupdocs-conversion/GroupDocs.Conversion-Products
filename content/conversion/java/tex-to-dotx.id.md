...
head_title: "Konversi TEX ke DOTX di Jawa – Konversi TEX ke DOTX"
head_description: "Konversi TEX ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga DOTX"
    content: |
        Konversikan TEX ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
