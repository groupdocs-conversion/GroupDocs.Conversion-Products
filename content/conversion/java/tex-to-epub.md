...
############################# Head ############################
head_title: "TEX to EPUB Conversion in Java – Convert TEX to EPUB"
head_description: "Convert TEX to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "TEX to EPUB Live Demos"
    content: |
        Convert TEX to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
