...
head_title: "Konversi TEX ke FODS di Jawa – Konversi TEX ke FODS"
head_description: "Konversi TEX ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga FODS"
    content: |
        Konversikan TEX ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
