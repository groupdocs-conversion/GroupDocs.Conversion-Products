...
head_title: "Konversi TEX ke J2K di Jawa – Konversi TEX ke J2K"
head_description: "Konversi TEX ke J2K di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke J2K di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke J2K di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke J2K dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file TEX dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen J2K
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (J2K) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format J2K target
