...
############################# Head ############################
head_title: "TEX to MHT Conversion in Java – Convert TEX to MHT"
head_description: "Convert TEX to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to MHT in few lines of code.
