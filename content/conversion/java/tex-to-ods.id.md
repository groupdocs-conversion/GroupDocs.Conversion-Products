...
head_title: "Konversi TEX ke ODS di Jawa – Konversi TEX ke ODS"
head_description: "Konversi TEX ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga ODS"
    content: |
        Konversikan TEX ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
