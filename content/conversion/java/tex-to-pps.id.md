...
head_title: "Konversi TEX ke PPS di Jawa – Konversi TEX ke PPS"
head_description: "Konversi TEX ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga PPS"
    content: |
        Konversikan TEX ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
