...
head_title: "Konversi TEX ke PPT di Jawa – Konversi TEX ke PPT"
head_description: "Konversi TEX ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga PPT"
    content: |
        Konversikan TEX ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
