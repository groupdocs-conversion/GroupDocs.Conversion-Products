...
head_title: "Konversi TEX ke PPTM di Jawa – Konversi TEX ke PPTM"
head_description: "Konversi TEX ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga PPTM"
    content: |
        Konversikan TEX ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
