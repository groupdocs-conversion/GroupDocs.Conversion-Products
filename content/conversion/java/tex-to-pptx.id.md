...
head_title: "Konversi TEX ke PPTX di Jawa – Konversi TEX ke PPTX"
head_description: "Konversi TEX ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga PPTX"
    content: |
        Konversikan TEX ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
