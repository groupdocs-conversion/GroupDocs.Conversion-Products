...
############################# Head ############################
head_title: "TEX to TIF Conversion in Java – Convert TEX to TIF"
head_description: "Convert TEX to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to TIF in few lines of code.
...
demos:
    enable: true
    title: "TEX to TIF Live Demos"
    content: |
        Convert TEX to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
