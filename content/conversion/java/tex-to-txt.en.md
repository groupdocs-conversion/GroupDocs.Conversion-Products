...
############################# Head #############################
head_title: "Java TEX to TXT Converter API - transform TEX to TXT in Java apps"
head_description: "View TEX to TXT files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert TEX to TXT in Java" 
description: "Experience the efficiency of a native, high-performance TEX to TXT file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert TEX to TXT file in Java" 
    content: |
      Transforming TEX to TXT is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the TEX file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.tex")              // Set up input TEX file
            .convertTo("converted.txt")    // Specify output path for converted file
            .convert();                    // Convert TEX to TXT file        
        ```            
