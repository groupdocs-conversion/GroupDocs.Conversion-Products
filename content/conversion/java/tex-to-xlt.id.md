...
head_title: "Konversi TEX ke XLT di Jawa – Konversi TEX ke XLT"
head_description: "Konversi TEX ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga XLT"
    content: |
        Konversikan TEX ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
