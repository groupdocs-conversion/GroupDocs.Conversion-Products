...
head_title: "Konversi TEX ke XLTX di Jawa – Konversi TEX ke XLTX"
head_description: "Konversi TEX ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TEX ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TEX ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TEX ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TEX hingga XLTX"
    content: |
        Konversikan TEX ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
