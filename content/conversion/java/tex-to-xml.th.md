...
############################# Head #############################
head_title: "Java API แปลง TEX เป็น XML - แปลงในแอปพลิเคชัน Java"
...
############################# Header ############################
title: "แปลง TEX เป็น XML ใน Java" 
description: "ประสบการณ์ API ที่มีประสิทธิภาพสูงสำหรับการแปลงไฟล์ TEX เป็น XML สำหรับแอปพลิเคชัน Java, J2EE และ J2SE มีการรองรับคุณลักษณะเพิ่มเติมอย่างหลากหลายเพื่อการปรับแต่งรูปแบบเอกสารผลลัพธ์" 
...
steps:
    enable: true
    title: "ขั้นตอนในการแปลงไฟล์ TEX เป็นไฟล์ XML ใน Java" 
    content: |
      การแปลง TEX เป็น XML กลายเป็นง่ายด้วย <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> คุณจำเป็นต้องทำเพียงไม่กี่ขั้นตอนง่ายๆ
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // แปลงไฟล์ TEX เป็นไฟล์ XML        
        ```            
