...
############################# Head #############################
head_title: "Java TEXT to HTML Converter API - transform TEXT to HTML in Java apps"
head_description: "View TEXT to HTML files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert TEXT to HTML in Java" 
description: "Experience the efficiency of a native, high-performance TEXT to HTML file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert TEXT to HTML file in Java" 
    content: |
      Transforming TEXT to HTML is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the TEXT file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.text")              // Set up input TEXT file
            .convertTo("converted.html")    // Specify output path for converted file
            .convert();                     // Convert TEXT to HTML file        
        ```            
