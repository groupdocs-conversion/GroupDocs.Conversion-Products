...
############################# Head ############################
head_title: "TIF to BMP Conversion in Java – Convert TIF to BMP"
head_description: "Convert TIF to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to BMP in few lines of code.
...
demos:
    enable: true
    title: "TIF to BMP Live Demos"
    content: |
        Convert TIF to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
