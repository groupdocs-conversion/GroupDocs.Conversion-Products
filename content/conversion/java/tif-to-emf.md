...
############################# Head ############################
head_title: "TIF to EMF Conversion in Java – Convert TIF to EMF"
head_description: "Convert TIF to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to EMF in few lines of code.
...
demos:
    enable: true
    title: "TIF to EMF Live Demos"
    content: |
        Convert TIF to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
