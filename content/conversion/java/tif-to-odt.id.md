...
head_title: "Konversi TIF ke ODT di Jawa – Konversi TIF ke ODT"
head_description: "Konversi TIF ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TIF ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TIF ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TIF ke ODT dalam beberapa baris kode.
