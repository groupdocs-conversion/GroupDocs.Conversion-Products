...
############################# Head #############################
head_title: "Java TIF zu WMF Konverter API - TIF in Java-Anwendungen transformieren"
head_description: "TIF zu WMF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "TIF in WMF in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von TIF in WMF Datei in Java" 
    content: |
      Die Transformation von TIF in WMF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die TIF Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.tif")              // Richten Sie die Eingabedatei TIF ein
            .convertTo("converted.wmf")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // TIF in WMF Datei konvertieren        
        ```            
