...
############################# Head ############################
head_title: "TIF to XLSM Conversion in Java – Convert TIF to XLSM"
head_description: "Convert TIF to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to XLSM in few lines of code.
