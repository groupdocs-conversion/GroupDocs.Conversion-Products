...
head_title: "Konversi TIFF ke DJVU di Jawa – Konversi TIFF ke DJVU"
head_description: "Konversi TIFF ke DJVU di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TIFF ke DJVU di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TIFF ke DJVU di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TIFF ke DJVU dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file TIFF dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen DJVU
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (DJVU) sebagai parameter
...
demos:
    enable: true
    title: "Demo Langsung TIFF hingga DJVU"
    content: |
        Konversikan TIFF ke DJVU sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
...
about_formats:
    ...
    format:
        - icon: "far fa-file-DJVU"
          title: " Tentang Format File DJVU"
          content: |
