...
############################# Head ############################
head_title: "TIFF to DOT Conversion in Java – Convert TIFF to DOT"
head_description: "Convert TIFF to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIFF Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIFF to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIFF file to DOT in few lines of code.
