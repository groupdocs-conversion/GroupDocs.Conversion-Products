...
############################# Head #############################
head_title: "Java TIFF to GIF Converter API - transform TIFF to GIF in Java apps"
head_description: "View TIFF to GIF files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert TIFF to GIF in Java" 
description: "Experience the efficiency of a native, high-performance TIFF to GIF file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert TIFF to GIF file in Java" 
    content: |
      Transforming TIFF to GIF is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert TIFF to GIF file        
        ```            
