...
############################# Head ############################
head_title: "TIFF to XLAM Conversion in Java – Convert TIFF to XLAM"
head_description: "Convert TIFF to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIFF Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIFF to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIFF file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "TIFF to XLAM Live Demos"
    content: |
        Convert TIFF to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
