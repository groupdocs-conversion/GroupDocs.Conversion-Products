...
############################# Head ############################
head_title: "TSV to DCM Conversion in Java – Convert TSV to DCM"
head_description: "Convert TSV to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TSV Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TSV to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TSV file to DCM in few lines of code.
...
demos:
    enable: true
    title: "TSV to DCM Live Demos"
    content: |
        Convert TSV to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
