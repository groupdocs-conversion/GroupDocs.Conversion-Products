...
############################# Head #############################
head_title: "Java TXT to CSV Converter API - transform TXT to CSV in Java apps"
head_description: "View TXT to CSV files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert TXT to CSV in Java" 
description: "Experience the efficiency of a native, high-performance TXT to CSV file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert TXT to CSV file in Java" 
    content: |
      Transforming TXT to CSV is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the TXT file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.txt")              // Set up input TXT file
            .convertTo("converted.csv")    // Specify output path for converted file
            .convert();                     // Convert TXT to CSV file        
        ```            
