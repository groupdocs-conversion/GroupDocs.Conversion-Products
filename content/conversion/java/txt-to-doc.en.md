...
############################# Head #############################
head_title: "Java TXT to DOC Converter API - transform TXT to DOC in Java apps"
head_description: "View TXT to DOC files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert TXT to DOC in Java" 
description: "Experience the efficiency of a native, high-performance TXT to DOC file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert TXT to DOC file in Java" 
    content: |
      Transforming TXT to DOC is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert TXT to DOC file        
        ```            
