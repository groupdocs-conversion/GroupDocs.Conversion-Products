...
head_title: "Konversi TXT ke FODP di Jawa – Konversi TXT ke FODP"
head_description: "Konversi TXT ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TXT hingga FODP"
    content: |
        Konversikan TXT ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
