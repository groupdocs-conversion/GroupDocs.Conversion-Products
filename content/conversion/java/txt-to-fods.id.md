...
head_title: "Konversi TXT ke FODS di Jawa – Konversi TXT ke FODS"
head_description: "Konversi TXT ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TXT hingga FODS"
    content: |
        Konversikan TXT ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
