...
head_title: "Konversi TXT ke ODS di Jawa – Konversi TXT ke ODS"
head_description: "Konversi TXT ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke ODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke ODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TXT hingga ODS"
    content: |
        Konversikan TXT ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
