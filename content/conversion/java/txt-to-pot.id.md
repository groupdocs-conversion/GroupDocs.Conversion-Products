...
head_title: "Konversi TXT ke POT di Jawa – Konversi TXT ke POT"
head_description: "Konversi TXT ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke POT dalam beberapa baris kode.
