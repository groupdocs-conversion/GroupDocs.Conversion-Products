...
head_title: "Konversi TXT ke PPSX di Jawa – Konversi TXT ke PPSX"
head_description: "Konversi TXT ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TXT hingga PPSX"
    content: |
        Konversikan TXT ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
