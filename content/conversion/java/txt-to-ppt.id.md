...
head_title: "Konversi TXT ke PPT di Jawa – Konversi TXT ke PPT"
head_description: "Konversi TXT ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TXT hingga PPT"
    content: |
        Konversikan TXT ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
