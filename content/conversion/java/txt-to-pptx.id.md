...
head_title: "Konversi TXT ke PPTX di Jawa – Konversi TXT ke PPTX"
head_description: "Konversi TXT ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TXT hingga PPTX"
    content: |
        Konversikan TXT ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
