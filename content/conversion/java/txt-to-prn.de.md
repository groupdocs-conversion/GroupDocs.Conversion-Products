...
############################# Head #############################
head_title: "Java TXT zu PRN Konverter API - TXT in Java-Anwendungen transformieren"
head_description: "TXT zu PRN Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "TXT in PRN in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken TXT zu PRN Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von TXT in PRN Datei in Java" 
    content: |
      Die Transformation von TXT in PRN wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die TXT Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convertTo("converted.prn")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                    // TXT in PRN Datei konvertieren        
        ```            
