...
############################# Head ############################
head_title: "TXT to SXC Conversion in Java – Convert TXT to SXC"
head_description: "Convert TXT to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to SXC in few lines of code.
...
demos:
    enable: true
    title: "TXT to SXC Live Demos"
    content: |
        Convert TXT to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
