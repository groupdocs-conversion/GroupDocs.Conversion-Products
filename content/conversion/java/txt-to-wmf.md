...
############################# Head ############################
head_title: "TXT to WMF Conversion in Java – Convert TXT to WMF"
head_description: "Convert TXT to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to WMF in few lines of code.
...
demos:
    enable: true
    title: "TXT to WMF Live Demos"
    content: |
        Convert TXT to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
