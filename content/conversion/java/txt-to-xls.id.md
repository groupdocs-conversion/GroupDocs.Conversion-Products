...
head_title: "Konversi TXT ke XLS di Jawa – Konversi TXT ke XLS"
head_description: "Konversi TXT ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TXT hingga XLS"
    content: |
        Konversikan TXT ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
