...
############################# Head ############################
head_title: "Преобразование TXT в XLSB в Java — Преобразование TXT в XLSB"
head_description: "Преобразуйте TXT в XLSB в Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов TXT в XLSB в Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования TXT в XLSB в Java"
    content_left: |
...
demos:
    enable: true
    title: "Преобразование TXT в XLSB Живые демонстрации"
    content: |
