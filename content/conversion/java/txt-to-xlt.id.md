...
head_title: "Konversi TXT ke XLT di Jawa – Konversi TXT ke XLT"
head_description: "Konversi TXT ke XLT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File TXT ke XLT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi TXT ke XLT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file TXT ke XLT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung TXT hingga XLT"
    content: |
        Konversikan TXT ke XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
