...
head_title: "Konversi VCF ke CSV di Jawa – Konversi VCF ke CSV"
head_description: "Konversi VCF ke CSV di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VCF ke CSV di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VCF ke CSV di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VCF ke CSV dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VCF hingga CSV"
    content: |
        Konversikan VCF ke CSV sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
