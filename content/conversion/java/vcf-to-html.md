...
############################# Head ############################
head_title: "VCF to HTML Conversion in Java – Convert VCF to HTML"
head_description: "Convert VCF to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to HTML in few lines of code.
