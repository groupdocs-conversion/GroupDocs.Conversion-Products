...
head_title: "Konversi VCF ke ODP di Jawa – Konversi VCF ke ODP"
head_description: "Konversi VCF ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VCF ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VCF ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VCF ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VCF hingga ODP"
    content: |
        Konversikan VCF ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
