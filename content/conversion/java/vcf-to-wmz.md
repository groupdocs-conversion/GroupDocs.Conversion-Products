...
############################# Head ############################
head_title: "VCF to WMZ Conversion in Java – Convert VCF to WMZ"
head_description: "Convert VCF to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "VCF to WMZ Live Demos"
    content: |
        Convert VCF to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
