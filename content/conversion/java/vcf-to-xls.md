...
############################# Head ############################
head_title: "VCF to XLS Conversion in Java – Convert VCF to XLS"
head_description: "Convert VCF to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to XLS in few lines of code.
...
demos:
    enable: true
    title: "VCF to XLS Live Demos"
    content: |
        Convert VCF to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
