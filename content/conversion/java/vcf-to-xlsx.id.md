...
head_title: "Konversi VCF ke XLSX di Jawa – Konversi VCF ke XLSX"
head_description: "Konversi VCF ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VCF ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VCF ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VCF ke XLSX dalam beberapa baris kode.
