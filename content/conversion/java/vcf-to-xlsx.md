...
############################# Head ############################
head_title: "VCF to XLSX Conversion in Java – Convert VCF to XLSX"
head_description: "Convert VCF to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "VCF to XLSX Live Demos"
    content: |
        Convert VCF to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
