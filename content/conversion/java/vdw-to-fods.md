...
############################# Head ############################
head_title: "VDW to FODS Conversion in Java – Convert VDW to FODS"
head_description: "Convert VDW to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDW Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDW to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDW file to FODS in few lines of code.
...
demos:
    enable: true
    title: "VDW to FODS Live Demos"
    content: |
        Convert VDW to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
