...
############################# Head ############################
head_title: "VDX to DOT Conversion in Java – Convert VDX to DOT"
head_description: "Convert VDX to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to DOT in few lines of code.
...
demos:
    enable: true
    title: "VDX to DOT Live Demos"
    content: |
        Convert VDX to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
