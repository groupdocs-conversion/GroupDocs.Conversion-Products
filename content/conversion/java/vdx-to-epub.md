...
############################# Head ############################
head_title: "VDX to EPUB Conversion in Java – Convert VDX to EPUB"
head_description: "Convert VDX to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "VDX to EPUB Live Demos"
    content: |
        Convert VDX to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
