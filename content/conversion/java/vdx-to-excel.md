...
breadcrumb: VDX to EXCEL in Java

############################# Head ############################
head_title: "VDX to EXCEL Converter in Java"
head_description: "Convert VDX to EXCEL in Java using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert VDX to EXCEL in Java"
description: "VDX to EXCEL conversion with a few lines of Java code"
...
overview:
    enable: true
    content: |
        Convert your VDX files to EXCEL in Java easily. You can use just a couple of Java code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert VDX to EXCEL in Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert a VDX file to EXCEL with a few lines of code.
