...
head_title: "Konversi VDX ke ICO di Jawa – Konversi VDX ke ICO"
head_description: "Konversi VDX ke ICO di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VDX ke ICO di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VDX ke ICO di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VDX ke ICO dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VDX hingga ICO"
    content: |
        Konversikan VDX ke ICO sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
