...
head_title: "Konversi VDX ke ODP di Jawa – Konversi VDX ke ODP"
head_description: "Konversi VDX ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VDX ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VDX ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VDX ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VDX hingga ODP"
    content: |
        Konversikan VDX ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
