...
############################# Head ############################
head_title: "VDX to OTT Conversion in Java – Convert VDX to OTT"
head_description: "Convert VDX to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to OTT in few lines of code.
...
demos:
    enable: true
    title: "VDX to OTT Live Demos"
    content: |
        Convert VDX to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
