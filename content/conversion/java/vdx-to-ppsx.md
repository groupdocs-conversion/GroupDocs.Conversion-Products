...
############################# Head ############################
head_title: "VDX to PPSX Conversion in Java – Convert VDX to PPSX"
head_description: "Convert VDX to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "VDX to PPSX Live Demos"
    content: |
        Convert VDX to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
