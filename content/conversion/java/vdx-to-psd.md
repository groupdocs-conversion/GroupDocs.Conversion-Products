...
############################# Head ############################
head_title: "VDX to PSD Conversion in Java – Convert VDX to PSD"
head_description: "Convert VDX to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to PSD in few lines of code.
