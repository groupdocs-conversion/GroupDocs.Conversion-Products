...
head_title: "Konversi VDX ke WEBP di Jawa – Konversi VDX ke WEBP"
head_description: "Konversi VDX ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VDX ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VDX ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VDX ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VDX hingga WEBP"
    content: |
        Konversikan VDX ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
