...
############################# Head ############################
head_title: "VDX to WMZ Conversion in Java – Convert VDX to WMZ"
head_description: "Convert VDX to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "VDX to WMZ Live Demos"
    content: |
        Convert VDX to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
