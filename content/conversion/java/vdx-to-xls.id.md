...
head_title: "Konversi VDX ke XLS di Jawa – Konversi VDX ke XLS"
head_description: "Konversi VDX ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VDX ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VDX ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VDX ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VDX hingga XLS"
    content: |
        Konversikan VDX ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
