...
head_title: "Konversi VDX ke XLSX di Jawa – Konversi VDX ke XLSX"
head_description: "Konversi VDX ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VDX ke XLSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VDX ke XLSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VDX ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VDX hingga XLSX"
    content: |
        Konversikan VDX ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
