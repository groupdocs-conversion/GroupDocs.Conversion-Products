...
############################# Head ############################
head_title: "VDX to XLSX Conversion in Java – Convert VDX to XLSX"
head_description: "Convert VDX to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "VDX to XLSX Live Demos"
    content: |
        Convert VDX to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
