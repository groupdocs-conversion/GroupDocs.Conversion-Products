...
############################# Head ############################
head_title: "Преобразование VISIO в электронную книгу в Java — преобразование VISIO в электронную книгу"
head_description: "Преобразование VISIO в электронную книгу на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VISIO в электронные книги на Java"
...
steps:
    enable: true
    title_left: "Действия по преобразованию VISIO в электронную книгу на Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл VISIO в электронную книгу, написав всего несколько строк кода.
