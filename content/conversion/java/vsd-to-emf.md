...
############################# Head ############################
head_title: "VSD to EMF Conversion in Java – Convert VSD to EMF"
head_description: "Convert VSD to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSD Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSD to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSD file to EMF in few lines of code.
