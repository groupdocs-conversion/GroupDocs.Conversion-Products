...
############################# Head ############################
head_title: "VSD to WMF Conversion in Java – Convert VSD to WMF"
head_description: "Convert VSD to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSD Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSD to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSD file to WMF in few lines of code.
...
demos:
    enable: true
    title: "VSD to WMF Live Demos"
    content: |
        Convert VSD to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
