...
############################# Head ############################
head_title: "Преобразование VSDM в EMF в Java — преобразование VSDM в EMF"
head_description: "Преобразуйте VSDM в EMF на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSDM в EMF в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSDM в EMF в Java"
    content_left: |
