...
############################# Head ############################
head_title: "Преобразование VSDM в ODS в Java — преобразование VSDM в ODS"
head_description: "Преобразование VSDM в ODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSDM в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSDM в ODS в Java"
    content_left: |
