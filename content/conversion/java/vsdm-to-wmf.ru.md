...
############################# Head ############################
head_title: "Преобразование VSDM в WMF в Java — преобразование VSDM в WMF"
head_description: "Преобразование VSDM в WMF на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSDM в WMF в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSDM в WMF в Java"
    content_left: |
