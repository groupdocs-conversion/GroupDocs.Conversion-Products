...
############################# Head ############################
head_title: "Преобразование VSDM в XLTX в Java — преобразование VSDM в XLTX"
head_description: "Преобразование VSDM в XLTX на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSDM в XLTX в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSDM в XLTX в Java"
    content_left: |
