...
head_title: "Konversi VSDX ke FODS di Jawa – Konversi VSDX ke FODS"
head_description: "Konversi VSDX ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSDX ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSDX ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSDX ke FODS dalam beberapa baris kode.
