...
head_title: "Konversi VSDX ke JPM di Jawa – Konversi VSDX ke JPM"
head_description: "Konversi VSDX ke JPM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSDX ke JPM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSDX ke JPM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSDX ke JPM dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file VSDX dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen JPM
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (JPM) sebagai parameter
...
demos:
    enable: true
    title: "Demo Langsung VSDX hingga JPM"
    content: |
        Konversikan VSDX ke JPM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
