...
############################# Head ############################
head_title: "Преобразование VSDX в JPM в Java — преобразование VSDX в JPM"
head_description: "Преобразуйте VSDX в JPM на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSDX в JPM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSDX в JPM в Java"
    content_left: |
