...
head_title: "Konversi VSDX ke ODP di Jawa – Konversi VSDX ke ODP"
head_description: "Konversi VSDX ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSDX ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSDX ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSDX ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VSDX hingga ODP"
    content: |
        Konversikan VSDX ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
