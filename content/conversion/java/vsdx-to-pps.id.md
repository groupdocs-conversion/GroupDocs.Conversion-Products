...
head_title: "Konversi VSDX ke PPS di Jawa – Konversi VSDX ke PPS"
head_description: "Konversi VSDX ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSDX ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSDX ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSDX ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VSDX hingga PPS"
    content: |
        Konversikan VSDX ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
