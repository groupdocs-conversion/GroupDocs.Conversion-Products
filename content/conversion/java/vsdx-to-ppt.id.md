...
head_title: "Konversi VSDX ke PPT di Jawa – Konversi VSDX ke PPT"
head_description: "Konversi VSDX ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSDX ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSDX ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSDX ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VSDX hingga PPT"
    content: |
        Konversikan VSDX ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
