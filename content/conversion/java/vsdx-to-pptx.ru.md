...
############################# Head ############################
head_title: "Преобразование VSDX в PPTX в Java — Преобразование VSDX в PPTX"
head_description: "Преобразование VSDX в PPTX на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSDX в PPTX в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSDX в PPTX в Java"
    content_left: |
