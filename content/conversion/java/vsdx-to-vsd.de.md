...
############################# Head #############################
head_title: "Java VSDX zu VSD Konverter API - VSDX in Java-Anwendungen transformieren"
head_description: "VSDX zu VSD Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "VSDX in VSD in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken VSDX zu VSD Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von VSDX in VSD Datei in Java" 
    content: |
      Die Transformation von VSDX in VSD wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convertTo("converted.vsd")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // VSDX in VSD Datei konvertieren        
        ```            
