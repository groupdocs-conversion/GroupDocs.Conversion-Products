...
############################# Head ############################
head_title: "Преобразование VSDX в WMF в Java — Преобразование VSDX в WMF"
head_description: "Преобразуйте VSDX в WMF на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSDX в WMF на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSDX в WMF в Java"
    content_left: |
