...
head_title: "Konversi VSDX ke XLS di Jawa – Konversi VSDX ke XLS"
head_description: "Konversi VSDX ke XLS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSDX ke XLS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSDX ke XLS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSDX ke XLS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VSDX hingga XLS"
    content: |
        Konversikan VSDX ke XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
