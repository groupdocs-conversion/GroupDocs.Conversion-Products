...
############################# Head ############################
head_title: "VSS to FODS Conversion in Java – Convert VSS to FODS"
head_description: "Convert VSS to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSS Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSS to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSS file to FODS in few lines of code.
