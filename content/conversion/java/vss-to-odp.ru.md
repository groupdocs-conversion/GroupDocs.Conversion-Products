...
############################# Head ############################
head_title: "Преобразование VSS в ODP в Java — преобразование VSS в ODP"
head_description: "Преобразование VSS в ODP на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSS в ODP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSS в ODP в Java"
    content_left: |
