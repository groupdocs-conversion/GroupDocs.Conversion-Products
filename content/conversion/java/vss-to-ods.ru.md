...
############################# Head ############################
head_title: "Преобразование VSS в ODS в Java — преобразование VSS в ODS"
head_description: "Преобразование VSS в ODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSS в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSS в ODS в Java"
    content_left: |
