...
############################# Head ############################
head_title: "VSSM to DOCM Conversion in Java – Convert VSSM to DOCM"
head_description: "Convert VSSM to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSSM Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSSM to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSSM file to DOCM in few lines of code.
