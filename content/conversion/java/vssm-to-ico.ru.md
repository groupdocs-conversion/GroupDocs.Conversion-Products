...
############################# Head ############################
head_title: "Преобразование VSSM в ICO в Java — преобразование VSSM в ICO"
head_description: "Преобразуйте VSSM в ICO на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSSM в ICO в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSSM в ICO в Java"
    content_left: |
