...
############################# Head ############################
head_title: "Преобразование VSSM в ODS в Java — преобразование VSSM в ODS"
head_description: "Преобразование VSSM в ODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSSM в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSSM в ODS в Java"
    content_left: |
