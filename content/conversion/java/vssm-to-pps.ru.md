...
############################# Head ############################
head_title: "Преобразование VSSM в PPS в Java — преобразование VSSM в PPS"
head_description: "Преобразование VSSM в PPS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSSM в PPS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSSM в PPS в Java"
    content_left: |
