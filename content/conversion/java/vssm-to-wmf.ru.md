...
############################# Head ############################
head_title: "Преобразование VSSM в WMF в Java — преобразование VSSM в WMF"
head_description: "Преобразование VSSM в WMF на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSSM в WMF на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSSM в WMF в Java"
    content_left: |
