...
############################# Head ############################
head_title: "Преобразование VSSM в XLS в Java — преобразование VSSM в XLS"
head_description: "Преобразование VSSM в XLS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSSM в XLS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSSM в XLS в Java"
    content_left: |
