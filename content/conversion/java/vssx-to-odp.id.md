...
head_title: "Konversi VSSX ke ODP di Jawa – Konversi VSSX ke ODP"
head_description: "Konversi VSSX ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSSX ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSSX ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSSX ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VSSX hingga ODP"
    content: |
        Konversikan VSSX ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
