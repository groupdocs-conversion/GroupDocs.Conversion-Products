...
############################# Head ############################
head_title: "Преобразование VSSX в ODS в Java — преобразование VSSX в ODS"
head_description: "Преобразование VSSX в ODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSSX в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSSX в ODS в Java"
    content_left: |
