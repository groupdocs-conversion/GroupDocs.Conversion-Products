...
############################# Head ############################
head_title: "VSSX to PPS Conversion in Java – Convert VSSX to PPS"
head_description: "Convert VSSX to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSSX Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSSX to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSSX file to PPS in few lines of code.
...
demos:
    enable: true
    title: "VSSX to PPS Live Demos"
    content: |
        Convert VSSX to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
