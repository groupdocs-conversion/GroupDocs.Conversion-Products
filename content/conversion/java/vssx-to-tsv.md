...
############################# Head ############################
head_title: "VSSX to TSV Conversion in Java – Convert VSSX to TSV"
head_description: "Convert VSSX to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSSX Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSSX to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSSX file to TSV in few lines of code.
...
demos:
    enable: true
    title: "VSSX to TSV Live Demos"
    content: |
        Convert VSSX to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
