...
############################# Head ############################
head_title: "Преобразование VSSX в XLT в Java — преобразование VSSX в XLT"
head_description: "Преобразование VSSX в XLT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSSX в XLT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSSX в XLT в Java"
    content_left: |
