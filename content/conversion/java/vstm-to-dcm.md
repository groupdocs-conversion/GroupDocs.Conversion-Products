...
############################# Head ############################
head_title: "VSTM to DCM Conversion in Java – Convert VSTM to DCM"
head_description: "Convert VSTM to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSTM Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSTM to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSTM file to DCM in few lines of code.
...
demos:
    enable: true
    title: "VSTM to DCM Live Demos"
    content: |
        Convert VSTM to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
