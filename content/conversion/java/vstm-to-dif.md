...
############################# Head ############################
head_title: "VSTM to DIF Conversion in Java – Convert VSTM to DIF"
head_description: "Convert VSTM to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSTM Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSTM to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSTM file to DIF in few lines of code.
...
demos:
    enable: true
    title: "VSTM to DIF Live Demos"
    content: |
        Convert VSTM to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
