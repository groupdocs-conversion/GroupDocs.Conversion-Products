...
############################# Head ############################
head_title: "Преобразование VSTM в ODP в Java — преобразование VSTM в ODP"
head_description: "Преобразование VSTM в ODP на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSTM в ODP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSTM в ODP в Java"
    content_left: |
