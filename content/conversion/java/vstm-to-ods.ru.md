...
############################# Head ############################
head_title: "Преобразование VSTM в ODS в Java — преобразование VSTM в ODS"
head_description: "Преобразуйте VSTM в ODS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSTM в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSTM в ODS в Java"
    content_left: |
