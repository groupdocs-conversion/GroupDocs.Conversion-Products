...
############################# Head ############################
head_title: "Преобразование VSTM в XLT в Java — преобразование VSTM в XLT"
head_description: "Преобразование VSTM в XLT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSTM в XLT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSTM в XLT в Java"
    content_left: |
