...
############################# Head ############################
head_title: "VSTX to ICO Conversion in Java – Convert VSTX to ICO"
head_description: "Convert VSTX to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSTX Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSTX to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSTX file to ICO in few lines of code.
...
demos:
    enable: true
    title: "VSTX to ICO Live Demos"
    content: |
        Convert VSTX to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
