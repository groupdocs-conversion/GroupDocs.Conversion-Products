...
head_title: "Konversi VSTX ke ODP di Jawa – Konversi VSTX ke ODP"
head_description: "Konversi VSTX ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSTX ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSTX ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSTX ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VSTX hingga ODP"
    content: |
        Konversikan VSTX ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
