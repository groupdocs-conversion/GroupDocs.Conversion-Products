...
############################# Head ############################
head_title: "Преобразование VSTX в ODS в Java — преобразование VSTX в ODS"
head_description: "Преобразуйте VSTX в ODS на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSTX в ODS в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSTX в ODS в Java"
    content_left: |
