...
############################# Head ############################
head_title: "VSTX to PPSX Conversion in Java – Convert VSTX to PPSX"
head_description: "Convert VSTX to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSTX Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSTX to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSTX file to PPSX in few lines of code.
