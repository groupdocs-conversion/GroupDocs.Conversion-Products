...
############################# Head ############################
head_title: "Преобразование VSTX в PPTM в Java — преобразование VSTX в PPTM"
head_description: "Преобразование VSTX в PPTM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSTX в PPTM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSTX в PPTM в Java"
    content_left: |
