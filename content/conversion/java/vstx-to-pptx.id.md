...
head_title: "Konversi VSTX ke PPTX di Jawa – Konversi VSTX ke PPTX"
head_description: "Konversi VSTX ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File VSTX ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi VSTX ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file VSTX ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung VSTX hingga PPTX"
    content: |
        Konversikan VSTX ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
