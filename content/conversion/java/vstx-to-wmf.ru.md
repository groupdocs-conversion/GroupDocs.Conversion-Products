...
############################# Head ############################
head_title: "Преобразование VSTX в WMF в Java — Преобразование VSTX в WMF"
head_description: "Преобразование VSTX в WMF на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSTX в WMF на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSTX в WMF в Java"
    content_left: |
