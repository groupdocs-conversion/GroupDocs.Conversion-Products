...
############################# Head ############################
head_title: "Преобразование VSX в FODS в Java — преобразование VSX в FODS"
head_description: "Преобразование VSX в FODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSX в FODS на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSX в FODS в Java"
    content_left: |
