...
############################# Head ############################
head_title: "Преобразование VSX в HTM в Java — преобразование VSX в HTM"
head_description: "Преобразуйте VSX в HTM на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSX в HTM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSX в HTM в Java"
    content_left: |
