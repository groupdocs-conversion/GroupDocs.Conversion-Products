...
############################# Head ############################
head_title: "Преобразование VSX в OTP в Java — преобразование VSX в OTP"
head_description: "Преобразование VSX в OTP на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов VSX в OTP в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию VSX в OTP в Java"
    content_left: |
