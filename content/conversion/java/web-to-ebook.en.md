...
############################# Head ############################
head_title: "WEB to EBOOK Conversion in Java – Convert WEB to EBOOK"
head_description: "Convert WEB to EBOOK in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEB Files to EBOOK in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEB to EBOOK in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEB file to EBOOK in few lines of code.
