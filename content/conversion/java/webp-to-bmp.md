...
############################# Head ############################
head_title: "WEBP to BMP Conversion in Java – Convert WEBP to BMP"
head_description: "Convert WEBP to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to BMP in few lines of code.
...
demos:
    enable: true
    title: "WEBP to BMP Live Demos"
    content: |
        Convert WEBP to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
