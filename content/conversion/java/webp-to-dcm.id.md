...
head_title: "Konversi WEBP ke DCM di Jawa – Konversi WEBP ke DCM"
head_description: "Konversi WEBP ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke DCM di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga DCM"
    content: |
        Konversikan WEBP ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
