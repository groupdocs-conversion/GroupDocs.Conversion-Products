...
############################# Head ############################
head_title: "WEBP to DIF Conversion in Java – Convert WEBP to DIF"
head_description: "Convert WEBP to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to DIF in few lines of code.
...
demos:
    enable: true
    title: "WEBP to DIF Live Demos"
    content: |
        Convert WEBP to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
