...
############################# Head ############################
head_title: "WEBP to DOT Conversion in Java – Convert WEBP to DOT"
head_description: "Convert WEBP to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to DOT in few lines of code.
...
demos:
    enable: true
    title: "WEBP to DOT Live Demos"
    content: |
        Convert WEBP to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
