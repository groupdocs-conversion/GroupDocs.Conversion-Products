...
head_title: "Konversi WEBP ke EPUB di Jawa – Konversi WEBP ke EPUB"
head_description: "Konversi WEBP ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WEBP ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga EPUB"
    content: |
        Konversikan WEBP ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
