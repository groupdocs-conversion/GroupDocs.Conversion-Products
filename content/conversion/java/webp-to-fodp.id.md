...
head_title: "Konversi WEBP ke FODP di Jawa – Konversi WEBP ke FODP"
head_description: "Konversi WEBP ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WEBP ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga FODP"
    content: |
        Konversikan WEBP ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
