...
head_title: "Konversi WEBP ke JPG di Jawa – Konversi WEBP ke JPG"
head_description: "Konversi WEBP ke JPG di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke JPG di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke JPG dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga JPG"
    content: |
        Konversikan WEBP ke JPG sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
