...
head_title: "Konversi WEBP ke ODP di Jawa – Konversi WEBP ke ODP"
head_description: "Konversi WEBP ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WEBP ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga ODP"
    content: |
        Konversikan WEBP ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
