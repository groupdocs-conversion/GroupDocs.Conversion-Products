...
head_title: "Konversi WEBP ke ODT di Jawa – Konversi WEBP ke ODT"
head_description: "Konversi WEBP ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WEBP ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga ODT"
    content: |
        Konversikan WEBP ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
