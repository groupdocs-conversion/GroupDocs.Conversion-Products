...
############################# Head ############################
head_title: "Преобразование WEBP в ODT в Java — преобразование WEBP в ODT"
head_description: "Преобразуйте WEBP в ODT на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WEBP в ODT в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию WEBP в ODT в Java"
    content_left: |
