...
############################# Head ############################
head_title: "WEBP to OTP Conversion in Java – Convert WEBP to OTP"
head_description: "Convert WEBP to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to OTP in few lines of code.
...
demos:
    enable: true
    title: "WEBP to OTP Live Demos"
    content: |
        Convert WEBP to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
