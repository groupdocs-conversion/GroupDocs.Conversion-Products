...
head_title: "Konversi WEBP ke OTT di Jawa – Konversi WEBP ke OTT"
head_description: "Konversi WEBP ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WEBP ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga OTT"
    content: |
        Konversikan WEBP ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
