...
head_title: "Konversi WEBP ke POTM di Jawa – Konversi WEBP ke POTM"
head_description: "Konversi WEBP ke POTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke POTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WEBP ke POTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke POTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga POTM"
    content: |
        Konversikan WEBP ke POTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
