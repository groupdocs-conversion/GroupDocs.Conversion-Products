...
head_title: "Konversi WEBP ke POTX di Jawa – Konversi WEBP ke POTX"
head_description: "Konversi WEBP ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WEBP ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga POTX"
    content: |
        Konversikan WEBP ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
