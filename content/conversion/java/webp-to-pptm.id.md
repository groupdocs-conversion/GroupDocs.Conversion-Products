...
head_title: "Konversi WEBP ke PPTM di Jawa – Konversi WEBP ke PPTM"
head_description: "Konversi WEBP ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WEBP ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WEBP ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WEBP ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WEBP hingga PPTM"
    content: |
        Konversikan WEBP ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
