...
############################# Head ############################
head_title: "WEBP to SVG Conversion in Java – Convert WEBP to SVG"
head_description: "Convert WEBP to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to SVG in few lines of code.
