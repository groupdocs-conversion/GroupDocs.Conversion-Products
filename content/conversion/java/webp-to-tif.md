...
############################# Head ############################
head_title: "WEBP to TIF Conversion in Java – Convert WEBP to TIF"
head_description: "Convert WEBP to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to TIF in few lines of code.
