...
############################# Head #############################
head_title: "Java WEBP zu WMF Konverter API - WEBP in Java-Anwendungen transformieren"
head_description: "WEBP zu WMF Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "WEBP in WMF in Java konvertieren" 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von WEBP in WMF Datei in Java" 
    content: |
      Die Transformation von WEBP in WMF wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // WEBP in WMF Datei konvertieren        
        ```            
