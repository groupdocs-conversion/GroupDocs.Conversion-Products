...
############################# Head ############################
head_title: "Преобразование WEBP в XLAM в Java — преобразование WEBP в XLAM"
head_description: "Преобразование WEBP в XLAM на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WEBP в XLAM в Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию WEBP в XLAM в Java"
    content_left: |
