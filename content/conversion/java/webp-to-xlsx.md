...
############################# Head ############################
head_title: "WEBP to XLSX Conversion in Java – Convert WEBP to XLSX"
head_description: "Convert WEBP to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "WEBP to XLSX Live Demos"
    content: |
        Convert WEBP to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
