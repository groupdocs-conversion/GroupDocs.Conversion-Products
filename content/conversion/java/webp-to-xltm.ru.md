...
############################# Head ############################
head_title: "Преобразование WEBP в XLTM в Java — Преобразование WEBP в XLTM"
head_description: "Преобразуйте WEBP в XLTM на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WEBP в XLTM на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию WEBP в XLTM в Java"
    content_left: |
