...
############################# Head ############################
head_title: "Преобразование WEBP в XPS в Java — преобразование WEBP в XPS"
head_description: "Преобразование WEBP в XPS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WEBP в XPS на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию WEBP в XPS в Java"
    content_left: |
