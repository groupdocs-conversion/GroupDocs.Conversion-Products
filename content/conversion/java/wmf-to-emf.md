...
############################# Head ############################
head_title: "WMF to EMF Conversion in Java – Convert WMF to EMF"
head_description: "Convert WMF to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to EMF in few lines of code.
...
demos:
    enable: true
    title: "WMF to EMF Live Demos"
    content: |
        Convert WMF to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
