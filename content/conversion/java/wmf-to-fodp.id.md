...
head_title: "Konversi WMF ke FODP di Jawa – Konversi WMF ke FODP"
head_description: "Konversi WMF ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WMF ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WMF ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WMF ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WMF hingga FODP"
    content: |
        Konversikan WMF ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
