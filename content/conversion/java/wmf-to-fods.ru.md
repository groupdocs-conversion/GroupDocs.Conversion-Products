...
############################# Head ############################
head_title: "Преобразование WMF в FODS на Java — Преобразование WMF в FODS"
head_description: "Преобразование WMF в FODS на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WMF в FODS на Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования WMF в FODS в Java"
    content_left: |
