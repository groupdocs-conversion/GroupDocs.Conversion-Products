...
head_title: "Konversi WMF ke ODP di Jawa – Konversi WMF ke ODP"
head_description: "Konversi WMF ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WMF ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WMF ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WMF ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WMF hingga ODP"
    content: |
        Konversikan WMF ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
