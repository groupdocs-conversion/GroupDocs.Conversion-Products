...
head_title: "Konversi WMF ke ODT di Jawa – Konversi WMF ke ODT"
head_description: "Konversi WMF ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WMF ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WMF ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WMF ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WMF hingga ODT"
    content: |
        Konversikan WMF ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
