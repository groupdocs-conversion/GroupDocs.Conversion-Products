...
############################# Head ############################
head_title: "WMF to ODT Conversion in Java – Convert WMF to ODT"
head_description: "Convert WMF to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to ODT in few lines of code.
