...
############################# Head ############################
head_title: "Преобразование WMF в OTT в Java — преобразование WMF в OTT"
head_description: "Преобразование WMF в OTT на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WMF в OTT на Java"
...
steps:
    enable: true
    title_left: "Шаги по преобразованию WMF в OTT в Java"
    content_left: |
