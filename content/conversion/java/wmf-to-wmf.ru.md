...
############################# Head ############################
head_title: "Преобразование WMF в WMF на Java — Преобразование WMF в WMF"
head_description: "Преобразование WMF в WMF на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WMF в WMF на Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования WMF в WMF в Java"
    content_left: |
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "WMF в WMF"
          link: "/conversion/java/wmf-to-wmf/"
