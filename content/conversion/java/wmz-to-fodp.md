...
############################# Head ############################
head_title: "WMZ to FODP Conversion in Java – Convert WMZ to FODP"
head_description: "Convert WMZ to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMZ Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMZ to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMZ file to FODP in few lines of code.
...
demos:
    enable: true
    title: "WMZ to FODP Live Demos"
    content: |
        Convert WMZ to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
