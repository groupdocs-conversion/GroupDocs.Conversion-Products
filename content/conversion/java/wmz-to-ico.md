...
############################# Head ############################
head_title: "WMZ to ICO Conversion in Java – Convert WMZ to ICO"
head_description: "Convert WMZ to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMZ Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMZ to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMZ file to ICO in few lines of code.
...
demos:
    enable: true
    title: "WMZ to ICO Live Demos"
    content: |
        Convert WMZ to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
