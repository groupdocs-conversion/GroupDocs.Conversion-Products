...
############################# Head ############################
head_title: "Преобразование WMZ в ICO в Java – Преобразование WMZ в ICO"
head_description: "Конвертируйте WMZ в ICO на Java с помощью нескольких строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WMZ в ICO в Java"
...
steps:
    enable: true
    title_left: "Шаги по конвертации WMZ в ICO в Java"
    content_left: |
