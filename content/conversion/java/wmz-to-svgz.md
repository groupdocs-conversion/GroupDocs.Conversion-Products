...
############################# Head ############################
head_title: "WMZ to SVGZ Conversion in Java – Convert WMZ to SVGZ"
head_description: "Convert WMZ to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMZ Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMZ to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMZ file to SVGZ in few lines of code.
