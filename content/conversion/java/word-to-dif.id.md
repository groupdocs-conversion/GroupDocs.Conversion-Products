...
head_title: "Konversi WORD ke DIF di Jawa – Konversi WORD ke DIF"
head_description: "Konversi WORD ke DIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke DIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke DIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke DIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga DIF"
    content: |
        Konversikan WORD ke DIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
