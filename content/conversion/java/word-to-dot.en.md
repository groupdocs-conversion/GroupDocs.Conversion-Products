...
############################# Head ############################
head_title: "WORD to DOT Conversion in Java – Convert WORD to DOT"
head_description: "Convert WORD to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to DOT in few lines of code.
...
demos:
    enable: true
    title: "WORD to DOT Live Demos"
    content: |
        Convert WORD to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
