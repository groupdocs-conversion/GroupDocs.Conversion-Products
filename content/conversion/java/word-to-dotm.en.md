...
############################# Head ############################
head_title: "WORD to DOTM Conversion in Java – Convert WORD to DOTM"
head_description: "Convert WORD to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "WORD to DOTM Live Demos"
    content: |
        Convert WORD to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
