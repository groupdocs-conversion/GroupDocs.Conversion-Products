...
head_title: "Konversi WORD ke DOTX di Jawa – Konversi WORD ke DOTX"
head_description: "Konversi WORD ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga DOTX"
    content: |
        Konversikan WORD ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
