...
############################# Head ############################
head_title: "Преобразование СЛОВА в РИСУНОК в Java - Преобразование СЛОВА в РИСУНОК"
head_description: "Преобразуйте СЛОВО в РИСУНОК на Java, используя несколько строк кода. Преобразование более 160 форматов файлов с помощью API преобразования документов GroupDocs для Java."

############################# Header ############################
title: "Преобразование файлов WORD в DRAWING на Java"
...
steps:
    enable: true
    title_left: "Шаги для преобразования СЛОВА в РИСУНОК в Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/java/) позволяет разработчикам легко преобразовать файл WORD в файл DRAWING с помощью нескольких строк кода.

        * Создайте новый экземпляр класса Converter и загрузите файл WORD с полным путем
        * Установите ConvertOptions для типа документа ЧЕРТЕЖ
        * Вызовите метод convert() и передайте имя документа (полный путь) и формат (DRAWING) в качестве параметра
    ...
    code: |
        ...
        // Подготовьте параметры преобразования для целевого формата ЧЕРТЕЖА
        ConvertOptions convertOptions = new FileType().fromExtension("drawing").getConvertOptions();
        // Преобразование в ЧЕРТЕЖНЫЙ формат
...
demos:
    enable: true
    title: "СЛОВО в РИСУНОК Живые демонстрации"
    content: |
        Преобразуйте WORD в DRAWING прямо сейчас, посетив веб-сайт [GroupDocs.Conversion Живые демонстрации](https://products.groupdocs.app/conversion/family).
