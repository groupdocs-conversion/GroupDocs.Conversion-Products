...
head_title: "Konversi WORD ke EPUB di Jawa – Konversi WORD ke EPUB"
head_description: "Konversi WORD ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke EPUB di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke EPUB di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga EPUB"
    content: |
        Konversikan WORD ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
