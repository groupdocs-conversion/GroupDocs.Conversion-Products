...
head_title: "Konversi WORD ke FODS di Jawa – Konversi WORD ke FODS"
head_description: "Konversi WORD ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga FODS"
    content: |
        Konversikan WORD ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
...
about_formats:
    ...
    format:
        - icon: "far fa-file-excel"
          ...
          content: |
            FODS adalah format file berbasis XML terkompresi ZIP untuk spreadsheet, bagan, presentasi, dan dokumen pemrosesan WORD.
