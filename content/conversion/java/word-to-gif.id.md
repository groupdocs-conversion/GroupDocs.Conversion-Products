...
head_title: "Konversi WORD ke GIF di Jawa – Konversi WORD ke GIF"
head_description: "Konversi WORD ke GIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke GIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke GIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke GIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga GIF"
    content: |
        Konversikan WORD ke GIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
