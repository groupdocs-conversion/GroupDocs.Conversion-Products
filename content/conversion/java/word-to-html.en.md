...
############################# Head ############################
head_title: "WORD to HTML Conversion in Java – Convert WORD to HTML"
head_description: "Convert WORD to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to HTML in few lines of code.
