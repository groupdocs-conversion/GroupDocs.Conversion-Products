...
head_title: "Konversi WORD ke METAFILE di Jawa – Konversi WORD ke METAFILE"
head_description: "Konversi WORD ke METAFILE di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke METAFILE di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke METAFILE di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke METAFILE dalam beberapa baris kode.

        * Buat instance baru dari kelas Converter dan muat file WORD dengan path lengkap
        * Atur ConvertOptions untuk jenis dokumen METAFILE
        * Panggil metode convert() dan berikan nama dokumen (path lengkap) dan format (METAFILE) sebagai parameter
    ...
    code: |
        ...
        // Siapkan opsi konversi untuk format METAFILE target
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga METAFILE"
    content: |
        Konversikan WORD ke METAFILE sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
