...
head_title: "Konversi WORD ke ODP di Jawa – Konversi WORD ke ODP"
head_description: "Konversi WORD ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga ODP"
    content: |
        Konversikan WORD ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
