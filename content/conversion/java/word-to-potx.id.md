...
head_title: "Konversi WORD ke POTX di Jawa – Konversi WORD ke POTX"
head_description: "Konversi WORD ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga POTX"
    content: |
        Konversikan WORD ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
