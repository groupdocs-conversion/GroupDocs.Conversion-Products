...
head_title: "Konversi WORD ke POWERPOINT di Jawa – Konversi WORD ke POWERPOINT"
head_description: "Konversi WORD ke POWERPOINT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke POWERPOINT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke POWERPOINT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke POWERPOINT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga POWERPOINT"
    content: |
        Konversikan WORD ke POWERPOINT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
