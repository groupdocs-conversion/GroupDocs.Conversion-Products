...
head_title: "Konversi WORD ke PPS di Jawa – Konversi WORD ke PPS"
head_description: "Konversi WORD ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga PPS"
    content: |
        Konversikan WORD ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
