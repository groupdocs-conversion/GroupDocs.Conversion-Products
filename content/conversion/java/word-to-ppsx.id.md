...
head_title: "Konversi WORD ke PPSX di Jawa – Konversi WORD ke PPSX"
head_description: "Konversi WORD ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga PPSX"
    content: |
        Konversikan WORD ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
