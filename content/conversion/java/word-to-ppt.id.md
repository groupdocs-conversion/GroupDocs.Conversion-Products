...
head_title: "Konversi WORD ke PPT di Jawa – Konversi WORD ke PPT"
head_description: "Konversi WORD ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga PPT"
    content: |
        Konversikan WORD ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
