...
head_title: "Konversi WORD ke PPTX di Jawa – Konversi WORD ke PPTX"
head_description: "Konversi WORD ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga PPTX"
    content: |
        Konversikan WORD ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
