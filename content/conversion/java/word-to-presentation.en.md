...
############################# Head ############################
head_title: "WORD to PRESENTATION Conversion in Java – Convert WORD to PRESENTATION"
head_description: "Convert WORD to PRESENTATION in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to PRESENTATION in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to PRESENTATION in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to PRESENTATION in few lines of code.

        *   Create a new instance of Converter class and load the WORD file with full path
        *   Set ConvertOptions for the PRESENTATION document type
        *   Call the convert() method and pass the document name (full path) and format (PRESENTATION) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target PRESENTATION format
...
demos:
    enable: true
    title: "WORD to PRESENTATION Live Demos"
    content: |
        Convert WORD to PRESENTATION right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
