...
head_title: "Konversi WORD ke RTF di Jawa – Konversi WORD ke RTF"
head_description: "Konversi WORD ke RTF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File WORD ke RTF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi WORD ke RTF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file WORD ke RTF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung WORD hingga RTF"
    content: |
        Konversikan WORD ke RTF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
