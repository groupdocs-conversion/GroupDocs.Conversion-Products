...
############################# Head ############################
head_title: "WORD to XLS Conversion in Java – Convert WORD to XLS"
head_description: "Convert WORD to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to XLS in few lines of code.
