...
############################# Head ############################
head_title: "WORD to XLTX Conversion in Java – Convert WORD to XLTX"
head_description: "Convert WORD to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to XLTX in few lines of code.
...
demos:
    enable: true
    title: "WORD to XLTX Live Demos"
    content: |
        Convert WORD to XLTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
