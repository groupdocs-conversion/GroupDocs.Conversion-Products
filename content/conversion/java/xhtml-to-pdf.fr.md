...
############################# Head #############################
head_title: "API de convertisseur de XHTML en PDF pour Java - convertir dans les applications Java"
head_description: "Afficher des fichiers XHTML en PDF dans des applications Java, J2EE, J2SE. Prend en charge l'affichage de plus de 180 formats de fichier de document et d'image en mode HTML, PDF ou image avec des fonctionnalités avancées pour gérer les options d'affichage de document."

############################# Header ############################
title: "Convertir XHTML en PDF en Java" 
description: "Découvrez l'efficacité d'une API de convertisseur de fichier native et haute performance de XHTML en PDF conçue pour les applications Java, J2EE et J2SE. Profitez du support pour un ensemble étendu de fonctionnalités supplémentaires, permettant de personnaliser l'apparence du document de sortie." 
...
steps:
    enable: true
    title: "Étapes pour convertir le fichier XHTML en PDF dans Java" 
    content: |
      La transformation de XHTML en PDF est simplifiée avec <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, nécessitant seulement quelques étapes simples.
      ...
      3. Chargez le fichier XHTML avec le chemin complet. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.xhtml")              // Configurer le fichier XHTML d'entrée
            .convertTo("converted.pdf")    // Spécifier le chemin de sortie pour le fichier converti
            .convert();                    // Convertir le fichier XHTML en PDF        
        ```            
