...
head_title: "Konversi XLAM ke FODP di Jawa – Konversi XLAM ke FODP"
head_description: "Konversi XLAM ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLAM ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLAM ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLAM ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLAM hingga FODP"
    content: |
        Konversikan XLAM ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
