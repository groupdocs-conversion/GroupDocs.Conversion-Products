...
head_title: "Konversi XLAM ke ODP di Jawa – Konversi XLAM ke ODP"
head_description: "Konversi XLAM ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLAM ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLAM ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLAM ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLAM hingga ODP"
    content: |
        Konversikan XLAM ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
