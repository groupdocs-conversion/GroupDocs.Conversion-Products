...
head_title: "Konversi XLAM ke PPTX di Jawa – Konversi XLAM ke PPTX"
head_description: "Konversi XLAM ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLAM ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLAM ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLAM ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLAM hingga PPTX"
    content: |
        Konversikan XLAM ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
