...
head_title: "Konversi XLS ke DCM di Jawa – Konversi XLS ke DCM"
head_description: "Konversi XLS ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga DCM"
    content: |
        Konversikan XLS ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
