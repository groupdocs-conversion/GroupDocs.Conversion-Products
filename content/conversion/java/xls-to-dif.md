...
############################# Head ############################
head_title: "XLS to DIF Conversion in Java – Convert XLS to DIF"
head_description: "Convert XLS to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to DIF in few lines of code.
...
demos:
    enable: true
    title: "XLS to DIF Live Demos"
    content: |
        Convert XLS to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
