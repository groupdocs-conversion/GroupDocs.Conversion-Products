...
head_title: "Konversi XLS ke DOC di Jawa – Konversi XLS ke DOC"
head_description: "Konversi XLS ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga DOC"
    content: |
        Konversikan XLS ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
