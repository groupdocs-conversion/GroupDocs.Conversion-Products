...
head_title: "Konversi XLS ke DOCX di Jawa – Konversi XLS ke DOCX"
head_description: "Konversi XLS ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga DOCX"
    content: |
        Konversikan XLS ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
