...
head_title: "Konversi XLS ke DOT di Jawa – Konversi XLS ke DOT"
head_description: "Konversi XLS ke DOT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke DOT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke DOT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke DOT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga DOT"
    content: |
        Konversikan XLS ke DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
