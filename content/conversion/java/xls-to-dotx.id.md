...
head_title: "Konversi XLS ke DOTX di Jawa – Konversi XLS ke DOTX"
head_description: "Konversi XLS ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga DOTX"
    content: |
        Konversikan XLS ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
