...
head_title: "Konversi XLS ke EPUB di Jawa – Konversi XLS ke EPUB"
head_description: "Konversi XLS ke EPUB di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke EPUB di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke EPUB dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga EPUB"
    content: |
        Konversikan XLS ke EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
