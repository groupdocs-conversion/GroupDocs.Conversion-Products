...
head_title: "Konversi XLS ke FODP di Jawa – Konversi XLS ke FODP"
head_description: "Konversi XLS ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga FODP"
    content: |
        Konversikan XLS ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
