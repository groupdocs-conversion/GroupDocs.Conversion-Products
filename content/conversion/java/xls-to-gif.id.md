...
head_title: "Konversi XLS ke GIF di Jawa – Konversi XLS ke GIF"
head_description: "Konversi XLS ke GIF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke GIF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke GIF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke GIF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga GIF"
    content: |
        Konversikan XLS ke GIF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
