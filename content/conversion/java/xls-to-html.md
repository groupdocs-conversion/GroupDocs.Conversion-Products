...
############################# Head ############################
head_title: "XLS to HTML Conversion in Java – Convert XLS to HTML"
head_description: "Convert XLS to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to HTML in few lines of code.
...
demos:
    enable: true
    title: "XLS to HTML Live Demos"
    content: |
        Convert XLS to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
