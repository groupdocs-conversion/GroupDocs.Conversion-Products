...
head_title: "Konversi XLS ke ODS di Jawa – Konversi XLS ke ODS"
head_description: "Konversi XLS ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke ODS di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga ODS"
    content: |
        Konversikan XLS ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
