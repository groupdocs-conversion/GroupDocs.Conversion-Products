...
head_title: "Konversi XLS ke OTP di Jawa – Konversi XLS ke OTP"
head_description: "Konversi XLS ke OTP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke OTP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke OTP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke OTP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga OTP"
    content: |
        Konversikan XLS ke OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
