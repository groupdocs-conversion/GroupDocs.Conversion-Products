...
head_title: "Konversi XLS ke OTT di Jawa – Konversi XLS ke OTT"
head_description: "Konversi XLS ke OTT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke OTT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke OTT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke OTT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga OTT"
    content: |
        Konversikan XLS ke OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
