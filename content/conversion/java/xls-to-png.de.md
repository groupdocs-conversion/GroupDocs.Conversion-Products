...
############################# Head #############################
head_title: "Java XLS zu PNG Konverter API - XLS in Java-Anwendungen transformieren"
head_description: "XLS zu PNG Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "XLS in PNG in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken XLS zu PNG Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von XLS in PNG Datei in Java" 
    content: |
      Die Transformation von XLS in PNG wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
