...
head_title: "Konversi XLS ke POT di Jawa – Konversi XLS ke POT"
head_description: "Konversi XLS ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke POT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga POT"
    content: |
        Konversikan XLS ke POT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
