...
head_title: "Konversi XLS ke POTX di Jawa – Konversi XLS ke POTX"
head_description: "Konversi XLS ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga POTX"
    content: |
        Konversikan XLS ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
