...
head_title: "Konversi XLS ke PPSX di Jawa – Konversi XLS ke PPSX"
head_description: "Konversi XLS ke PPSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke PPSX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke PPSX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke PPSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga PPSX"
    content: |
        Konversikan XLS ke PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
