...
############################# Head ############################
head_title: "XLS to PPSX Conversion in Java – Convert XLS to PPSX"
head_description: "Convert XLS to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "XLS to PPSX Live Demos"
    content: |
        Convert XLS to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
