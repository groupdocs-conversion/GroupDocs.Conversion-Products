...
head_title: "Konversi XLS ke PPT di Jawa – Konversi XLS ke PPT"
head_description: "Konversi XLS ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga PPT"
    content: |
        Konversikan XLS ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
