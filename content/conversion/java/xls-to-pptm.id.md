...
head_title: "Konversi XLS ke PPTM di Jawa – Konversi XLS ke PPTM"
head_description: "Konversi XLS ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga PPTM"
    content: |
        Konversikan XLS ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
