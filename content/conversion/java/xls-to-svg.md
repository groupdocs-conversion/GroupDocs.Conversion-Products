...
############################# Head ############################
head_title: "XLS to SVG Conversion in Java – Convert XLS to SVG"
head_description: "Convert XLS to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to SVG in few lines of code.
...
demos:
    enable: true
    title: "XLS to SVG Live Demos"
    content: |
        Convert XLS to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
