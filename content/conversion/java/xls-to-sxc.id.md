...
head_title: "Konversi XLS ke SXC di Jawa – Konversi XLS ke SXC"
head_description: "Konversi XLS ke SXC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke SXC di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke SXC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga SXC"
    content: |
        Konversikan XLS ke SXC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
