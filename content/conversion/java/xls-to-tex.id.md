...
head_title: "Konversi XLS ke TEX di Jawa – Konversi XLS ke TEX"
head_description: "Konversi XLS ke TEX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke TEX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke TEX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga TEX"
    content: |
        Konversikan XLS ke TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
