...
head_title: "Konversi XLS ke TXT di Jawa – Konversi XLS ke TXT"
head_description: "Konversi XLS ke TXT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke TXT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke TXT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke TXT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga TXT"
    content: |
        Konversikan XLS ke TXT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
