...
############################# Head #############################
head_title: "Java XLS zu VSDX Konverter API - XLS in Java-Anwendungen transformieren"
head_description: "XLS zu VSDX Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "XLS in VSDX in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken XLS zu VSDX Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von XLS in VSDX Datei in Java" 
    content: |
      Die Transformation von XLS in VSDX wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // XLS in VSDX Datei konvertieren        
        ```            
