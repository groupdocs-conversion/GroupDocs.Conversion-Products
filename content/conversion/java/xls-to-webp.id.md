...
head_title: "Konversi XLS ke WEBP di Jawa – Konversi XLS ke WEBP"
head_description: "Konversi XLS ke WEBP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke WEBP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLS ke WEBP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke WEBP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga WEBP"
    content: |
        Konversikan XLS ke WEBP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
