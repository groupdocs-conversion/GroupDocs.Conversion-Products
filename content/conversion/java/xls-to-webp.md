...
############################# Head ############################
head_title: "XLS to WEBP Conversion in Java – Convert XLS to WEBP"
head_description: "Convert XLS to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to WEBP in few lines of code.
