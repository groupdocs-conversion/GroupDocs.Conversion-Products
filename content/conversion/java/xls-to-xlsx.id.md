...
head_title: "Konversi XLS ke XLSX di Jawa – Konversi XLS ke XLSX"
head_description: "Konversi XLS ke XLSX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke XLSX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke XLSX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga XLSX"
    content: |
        Konversikan XLS ke XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
