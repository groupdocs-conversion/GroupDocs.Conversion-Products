...
head_title: "Konversi XLS ke XLTX di Jawa – Konversi XLS ke XLTX"
head_description: "Konversi XLS ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLS ke XLTX di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLS ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLS hingga XLTX"
    content: |
        Konversikan XLS ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
