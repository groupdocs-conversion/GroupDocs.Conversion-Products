...
head_title: "Konversi XLSB ke DCM di Jawa – Konversi XLSB ke DCM"
head_description: "Konversi XLSB ke DCM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSB ke DCM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSB ke DCM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSB ke DCM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSB hingga DCM"
    content: |
        Konversikan XLSB ke DCM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
