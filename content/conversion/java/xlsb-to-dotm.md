...
############################# Head ############################
head_title: "XLSB to DOTM Conversion in Java – Convert XLSB to DOTM"
head_description: "Convert XLSB to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSB Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSB to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSB file to DOTM in few lines of code.
