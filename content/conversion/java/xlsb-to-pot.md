...
############################# Head ############################
head_title: "XLSB to POT Conversion in Java – Convert XLSB to POT"
head_description: "Convert XLSB to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSB Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSB to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSB file to POT in few lines of code.
...
demos:
    enable: true
    title: "XLSB to POT Live Demos"
    content: |
        Convert XLSB to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
