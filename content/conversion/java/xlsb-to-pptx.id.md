...
head_title: "Konversi XLSB ke PPTX di Jawa – Konversi XLSB ke PPTX"
head_description: "Konversi XLSB ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSB ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSB ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSB ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSB hingga PPTX"
    content: |
        Konversikan XLSB ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
