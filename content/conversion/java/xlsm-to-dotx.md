...
############################# Head ############################
head_title: "XLSM to DOTX Conversion in Java – Convert XLSM to DOTX"
head_description: "Convert XLSM to DOTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSM Files to DOTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSM to DOTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSM file to DOTX in few lines of code.
