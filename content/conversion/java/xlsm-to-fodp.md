...
############################# Head ############################
head_title: "XLSM to FODP Conversion in Java – Convert XLSM to FODP"
head_description: "Convert XLSM to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSM Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSM to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSM file to FODP in few lines of code.
...
demos:
    enable: true
    title: "XLSM to FODP Live Demos"
    content: |
        Convert XLSM to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
