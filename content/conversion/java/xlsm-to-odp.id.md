...
head_title: "Konversi XLSM ke ODP di Jawa – Konversi XLSM ke ODP"
head_description: "Konversi XLSM ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSM ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSM ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSM ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSM hingga ODP"
    content: |
        Konversikan XLSM ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
