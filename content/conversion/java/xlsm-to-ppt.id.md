...
head_title: "Konversi XLSM ke PPT di Jawa – Konversi XLSM ke PPT"
head_description: "Konversi XLSM ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSM ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSM ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSM ke PPT dalam beberapa baris kode.
