...
############################# Head #############################
head_title: "Java API конвертер XLSM в XLSB - конвертировать в Java приложениях"
...
description: "Опыт высокопроизводительного нативного API конвертации файлов XLSM в XLSB для Java, J2EE и J2SE приложений. Наслаждайтесь поддержкой широкого набора дополнительных функций, позволяющих настраивать внешний вид выходного документа." 
...
steps:
    enable: true
    title: "Шаги для преобразования файла XLSM в файл XLSB на Java" 
    content: |
      Преобразование XLSM в XLSB становится простым с помощью <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, требующим всего нескольких простых шагов.
