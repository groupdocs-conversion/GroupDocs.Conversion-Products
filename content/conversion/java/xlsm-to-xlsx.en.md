...
############################# Head #############################
head_title: "Java XLSM to XLSX Converter API - transform XLSM to XLSX in Java apps"
head_description: "View XLSM to XLSX files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert XLSM to XLSX in Java" 
description: "Experience the efficiency of a native, high-performance XLSM to XLSX file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert XLSM to XLSX file in Java" 
    content: |
      Transforming XLSM to XLSX is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the XLSM file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.xlsm")              // Set up input XLSM file
            .convertTo("converted.xlsx")    // Specify output path for converted file
            .convert();                     // Convert XLSM to XLSX file        
        ```            
