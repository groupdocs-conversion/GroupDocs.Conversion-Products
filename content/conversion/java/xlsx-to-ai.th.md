...
############################# Head #############################
head_title: "Java API แปลง XLSX เป็น AI - แปลงในแอปพลิเคชัน Java"
...
############################# Header ############################
title: "แปลง XLSX เป็น AI ใน Java" 
description: "ประสบการณ์ API ที่มีประสิทธิภาพสูงสำหรับการแปลงไฟล์ XLSX เป็น AI สำหรับแอปพลิเคชัน Java, J2EE และ J2SE มีการรองรับคุณลักษณะเพิ่มเติมอย่างหลากหลายเพื่อการปรับแต่งรูปแบบเอกสารผลลัพธ์" 
...
steps:
    enable: true
    title: "ขั้นตอนในการแปลงไฟล์ XLSX เป็นไฟล์ AI ใน Java" 
    content: |
      การแปลง XLSX เป็น AI กลายเป็นง่ายด้วย <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> คุณจำเป็นต้องทำเพียงไม่กี่ขั้นตอนง่ายๆ
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                    // แปลงไฟล์ XLSX เป็นไฟล์ AI        
        ```            
