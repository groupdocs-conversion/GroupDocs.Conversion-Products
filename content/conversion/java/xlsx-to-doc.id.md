...
head_title: "Konversi XLSX ke DOC di Jawa – Konversi XLSX ke DOC"
head_description: "Konversi XLSX ke DOC di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSX ke DOC di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSX ke DOC di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSX ke DOC dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSX hingga DOC"
    content: |
        Konversikan XLSX ke DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
