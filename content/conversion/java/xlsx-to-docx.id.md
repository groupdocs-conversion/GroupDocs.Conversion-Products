...
head_title: "Konversi XLSX ke DOCX di Jawa – Konversi XLSX ke DOCX"
head_description: "Konversi XLSX ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSX ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSX ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSX ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSX hingga DOCX"
    content: |
        Konversikan XLSX ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
