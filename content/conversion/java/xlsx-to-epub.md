...
############################# Head ############################
head_title: "XLSX to EPUB Conversion in Java – Convert XLSX to EPUB"
head_description: "Convert XLSX to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "XLSX to EPUB Live Demos"
    content: |
        Convert XLSX to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
