...
############################# Head ############################
head_title: "XLSX to FODP Conversion in Java – Convert XLSX to FODP"
head_description: "Convert XLSX to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to FODP in few lines of code.
...
demos:
    enable: true
    title: "XLSX to FODP Live Demos"
    content: |
        Convert XLSX to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
