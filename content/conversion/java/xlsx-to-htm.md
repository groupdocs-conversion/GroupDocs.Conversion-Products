...
############################# Head ############################
head_title: "XLSX to HTM Conversion in Java – Convert XLSX to HTM"
head_description: "Convert XLSX to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to HTM in few lines of code.
...
demos:
    enable: true
    title: "XLSX to HTM Live Demos"
    content: |
        Convert XLSX to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
