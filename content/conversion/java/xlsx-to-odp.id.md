...
head_title: "Konversi XLSX ke ODP di Jawa – Konversi XLSX ke ODP"
head_description: "Konversi XLSX ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSX ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSX ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSX ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSX hingga ODP"
    content: |
        Konversikan XLSX ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
