...
head_title: "Konversi XLSX ke ODT di Jawa – Konversi XLSX ke ODT"
head_description: "Konversi XLSX ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSX ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSX ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSX ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSX hingga ODT"
    content: |
        Konversikan XLSX ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
