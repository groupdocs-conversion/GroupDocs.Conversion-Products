...
############################# Head ############################
head_title: "XLSX to OTP Conversion in Java – Convert XLSX to OTP"
head_description: "Convert XLSX to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to OTP in few lines of code.
...
demos:
    enable: true
    title: "XLSX to OTP Live Demos"
    content: |
        Convert XLSX to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
