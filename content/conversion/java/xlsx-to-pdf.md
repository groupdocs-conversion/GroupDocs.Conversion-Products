...
############################# Head ############################
head_title: "XLSX to PDF Conversion in Java – Convert XLSX to PDF"
head_description: "Convert XLSX to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to PDF in few lines of code.
...
demos:
    enable: true
    title: "XLSX to PDF Live Demos"
    content: |
        Convert XLSX to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
