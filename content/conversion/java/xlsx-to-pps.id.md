...
head_title: "Konversi XLSX ke PPS di Jawa – Konversi XLSX ke PPS"
head_description: "Konversi XLSX ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSX ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSX ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSX ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSX hingga PPS"
    content: |
        Konversikan XLSX ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
