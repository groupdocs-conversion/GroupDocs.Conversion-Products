...
############################# Head ############################
head_title: "XLSX to PPSX Conversion in Java – Convert XLSX to PPSX"
head_description: "Convert XLSX to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "XLSX to PPSX Live Demos"
    content: |
        Convert XLSX to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
