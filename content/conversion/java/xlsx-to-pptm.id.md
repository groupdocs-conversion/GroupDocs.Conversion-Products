...
head_title: "Konversi XLSX ke PPTM di Jawa – Konversi XLSX ke PPTM"
head_description: "Konversi XLSX ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSX ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSX ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSX ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSX hingga PPTM"
    content: |
        Konversikan XLSX ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
