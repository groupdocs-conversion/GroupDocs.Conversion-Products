...
head_title: "Konversi XLSX ke PPTX di Jawa – Konversi XLSX ke PPTX"
head_description: "Konversi XLSX ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLSX ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLSX ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLSX ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLSX hingga PPTX"
    content: |
        Konversikan XLSX ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
