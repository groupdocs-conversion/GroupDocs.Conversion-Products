...
############################# Head ############################
head_title: "XLSX to RTF Conversion in Java – Convert XLSX to RTF"
head_description: "Convert XLSX to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to RTF in few lines of code.
...
demos:
    enable: true
    title: "XLSX to RTF Live Demos"
    content: |
        Convert XLSX to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
