...
############################# Head ############################
head_title: "XLSX to XLSM Conversion in Java – Convert XLSX to XLSM"
head_description: "Convert XLSX to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "XLSX to XLSM Live Demos"
    content: |
        Convert XLSX to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
