...
############################# Head #############################
head_title: "Java XLSX to XLT Converter API - transform XLSX to XLT in Java apps"
head_description: "View XLSX to XLT files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert XLSX to XLT in Java" 
description: "Experience the efficiency of a native, high-performance XLSX to XLT file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert XLSX to XLT file in Java" 
    content: |
      Transforming XLSX to XLT is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // Convert XLSX to XLT file        
        ```            
