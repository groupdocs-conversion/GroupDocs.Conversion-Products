...
breadcrumb: XLT til DIF í Java

############################# Head ############################
head_title: "Umbreyttu XLT í DIF í Java"
head_description: "XLT til DIF viðskipti í Java með nokkrum línum af kóða. Umbreyttu yfir 160 skráarsniðum með því að nota GroupDocs skjalabreytingarforritaskil fyrir Java"

############################# Header ############################
title: "Umbreyttu XLT í DIF í Java"
description: "XLT til DIF viðskipti með nokkrum línum af Java kóða"
...
overview:
    enable: true
    content: |
        Umbreyttu XLT skránum þínum í DIF í Java. Það tekur aðeins nokkrar línur af Java kóða á hvaða vettvang sem þú velur, eins og Windows, Linux, macOS.
        Þú getur prófað að breyta XLT í DIF ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingarforskriftum geturðu prófað flóknari valkosti til að hlaða XLT frumskránni og geyma DIF úttakið. 
        ...
        * bæta vatnsmerki við breytta DIF.
        ...
        Þegar umbreytingunni er lokið geturðu vistað DIF skrána á staðbundinni skráarslóð þinni eða í hvaða geymslu sem er þriðja aðila eins og FTP, Amazon S3, Google Drive, Dropbox osfrv. Athugaðu - til að umbreyta XLT til DIF, þú þarft ekki að setja upp neinn viðbótarhugbúnað, eins og MS Office, Open Office, Adobe Acrobat Reader o.s.frv.


############################# Steps ############################
steps:
    enable: true
    title_left: "Skref til að breyta XLT í DIF í Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) gerir forriturum kleift að umbreyta XLT skrá auðveldlega í DIF með nokkrum línum af kóða.
...
demos:
    enable: true
    title: "XLT til DIF Sýning í beinni"
    content: |
       Farðu á [GroupDocs.Conversion app](https://products.groupdocs.app/conversion/family) vefsíðu okkar og reyndu XLT í DIF viðskipti núna. Ókeypis kynningin hefur eftirfarandi kosti
