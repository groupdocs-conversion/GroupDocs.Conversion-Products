...
############################# Head ############################
head_title: "XLT to DOT Conversion in Java – Convert XLT to DOT"
head_description: "Convert XLT to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLT Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLT to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLT file to DOT in few lines of code.
