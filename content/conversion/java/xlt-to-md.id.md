...
head_title: "Konversi XLT ke MD di Jawa – Konversi XLT ke MD"
head_description: "Konversi XLT ke MD di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLT ke MD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLT ke MD di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLT ke MD dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLT hingga MD"
    content: |
        Konversikan XLT ke MD sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
