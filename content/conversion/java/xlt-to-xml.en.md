...
############################# Head #############################
head_title: "Java XLT to XML Converter API - transform XLT to XML in Java apps"
head_description: "View XLT to XML files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert XLT to XML in Java" 
description: "Experience the efficiency of a native, high-performance XLT to XML file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert XLT to XML file in Java" 
    content: |
      Transforming XLT to XML is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the XLT file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.xlt")              // Set up input XLT file
            .convertTo("converted.xml")    // Specify output path for converted file
            .convert();                     // Convert XLT to XML file        
        ```            
