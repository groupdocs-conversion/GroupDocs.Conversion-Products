...
head_title: "Konversi XLTM ke ODP di Jawa – Konversi XLTM ke ODP"
head_description: "Konversi XLTM ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTM ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTM ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTM ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTM hingga ODP"
    content: |
        Konversikan XLTM ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
