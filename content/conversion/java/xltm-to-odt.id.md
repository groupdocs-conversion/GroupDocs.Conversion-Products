...
head_title: "Konversi XLTM ke ODT di Jawa – Konversi XLTM ke ODT"
head_description: "Konversi XLTM ke ODT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTM ke ODT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTM ke ODT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTM ke ODT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTM hingga ODT"
    content: |
        Konversikan XLTM ke ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
