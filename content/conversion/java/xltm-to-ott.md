...
############################# Head ############################
head_title: "XLTM to OTT Conversion in Java – Convert XLTM to OTT"
head_description: "Convert XLTM to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTM Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTM to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTM file to OTT in few lines of code.
...
demos:
    enable: true
    title: "XLTM to OTT Live Demos"
    content: |
        Convert XLTM to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
