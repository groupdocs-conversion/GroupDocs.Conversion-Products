...
head_title: "Konversi XLTM ke PPTM di Jawa – Konversi XLTM ke PPTM"
head_description: "Konversi XLTM ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTM ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTM ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTM ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTM hingga PPTM"
    content: |
        Konversikan XLTM ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
