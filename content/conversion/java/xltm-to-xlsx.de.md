...
############################# Head #############################
head_title: "Java XLTM zu XLSX Konverter API - XLTM in Java-Anwendungen transformieren"
head_description: "XLTM zu XLSX Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "XLTM in XLSX in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken XLTM zu XLSX Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von XLTM in XLSX Datei in Java" 
    content: |
      Die Transformation von XLTM in XLSX wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die XLTM Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.xltm")              // Richten Sie die Eingabedatei XLTM ein
            .convertTo("converted.xlsx")    // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .convert();                     // XLTM in XLSX Datei konvertieren        
        ```            
