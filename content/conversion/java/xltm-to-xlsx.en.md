...
############################# Head #############################
head_title: "Java XLTM to XLSX Converter API - transform XLTM to XLSX in Java apps"
head_description: "View XLTM to XLSX files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert XLTM to XLSX in Java" 
description: "Experience the efficiency of a native, high-performance XLTM to XLSX file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert XLTM to XLSX file in Java" 
    content: |
      Transforming XLTM to XLSX is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the XLTM file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.xltm")              // Set up input XLTM file
            .convertTo("converted.xlsx")    // Specify output path for converted file
            .convert();                     // Convert XLTM to XLSX file        
        ```            
