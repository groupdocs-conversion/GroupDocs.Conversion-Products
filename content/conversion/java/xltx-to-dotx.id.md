...
head_title: "Konversi XLTX ke DOTX di Jawa – Konversi XLTX ke DOTX"
head_description: "Konversi XLTX ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTX ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTX ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTX ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTX hingga DOTX"
    content: |
        Konversikan XLTX ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
