...
############################# Head ############################
head_title: "XLTX to EPUB Conversion in Java – Convert XLTX to EPUB"
head_description: "Convert XLTX to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to EPUB in few lines of code.
