...
############################# Head ############################
head_title: "XLTX to MHT Conversion in Java – Convert XLTX to MHT"
head_description: "Convert XLTX to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to MHT in few lines of code.
...
demos:
    enable: true
    title: "XLTX to MHT Live Demos"
    content: |
        Convert XLTX to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
