...
head_title: "Konversi XLTX ke ODP di Jawa – Konversi XLTX ke ODP"
head_description: "Konversi XLTX ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTX ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTX ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTX ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTX hingga ODP"
    content: |
        Konversikan XLTX ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
