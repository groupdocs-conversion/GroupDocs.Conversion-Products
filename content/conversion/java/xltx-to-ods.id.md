...
head_title: "Konversi XLTX ke ODS di Jawa – Konversi XLTX ke ODS"
head_description: "Konversi XLTX ke ODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTX ke ODS di Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTX ke ODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTX hingga ODS"
    content: |
        Konversikan XLTX ke ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
