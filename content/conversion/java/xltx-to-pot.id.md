...
head_title: "Konversi XLTX ke POT di Jawa – Konversi XLTX ke POT"
head_description: "Konversi XLTX ke POT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTX ke POT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTX ke POT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTX ke POT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTX hingga POT"
    content: |
        Konversikan XLTX ke POT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
