...
head_title: "Konversi XLTX ke POTX di Jawa – Konversi XLTX ke POTX"
head_description: "Konversi XLTX ke POTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTX ke POTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTX ke POTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTX ke POTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTX hingga POTX"
    content: |
        Konversikan XLTX ke POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
