...
############################# Head ############################
head_title: "XLTX to PPSX Conversion in Java – Convert XLTX to PPSX"
head_description: "Convert XLTX to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "XLTX to PPSX Live Demos"
    content: |
        Convert XLTX to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
