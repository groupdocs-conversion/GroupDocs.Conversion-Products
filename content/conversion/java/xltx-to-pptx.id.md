...
head_title: "Konversi XLTX ke PPTX di Jawa – Konversi XLTX ke PPTX"
head_description: "Konversi XLTX ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTX ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTX ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTX ke PPTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTX hingga PPTX"
    content: |
        Konversikan XLTX ke PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
