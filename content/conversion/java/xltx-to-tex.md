...
############################# Head ############################
head_title: "XLTX to TEX Conversion in Java – Convert XLTX to TEX"
head_description: "Convert XLTX to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to TEX in few lines of code.
...
demos:
    enable: true
    title: "XLTX to TEX Live Demos"
    content: |
        Convert XLTX to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
