...
############################# Head ############################
head_title: "XLTX to TXT Conversion in Java – Convert XLTX to TXT"
head_description: "Convert XLTX to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to TXT in few lines of code.
...
demos:
    enable: true
    title: "XLTX to TXT Live Demos"
    content: |
        Convert XLTX to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
