...
head_title: "Konversi XLTX ke WMF di Jawa – Konversi XLTX ke WMF"
head_description: "Konversi XLTX ke WMF di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XLTX ke WMF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XLTX ke WMF di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XLTX ke WMF dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XLTX hingga WMF"
    content: |
        Konversikan XLTX ke WMF sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
