...
############################# Head #############################
head_title: "Java XLTX to XLSX Converter API - transform XLTX to XLSX in Java apps"
head_description: "View XLTX to XLSX files in Java, J2EE, J2SE applications. Supports viewing 180+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Convert XLTX to XLSX in Java" 
description: "Experience the efficiency of a native, high-performance XLTX to XLSX file converter API designed for Java, J2EE, and J2SE applications. Enjoy support for an extensive set of additional features, allowing customization of the output document's appearance." 
...
steps:
    enable: true
    title: "Steps to convert XLTX to XLSX file in Java" 
    content: |
      Transforming XLTX to XLSX is made simple with <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a>, requiring just a few straightforward steps.
      ...
      3. Load the XLTX file with full path. 
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        new Converter()
            .load("input.xltx")              // Set up input XLTX file
            .convertTo("converted.xlsx")    // Specify output path for converted file
            .convert();                     // Convert XLTX to XLSX file        
        ```            
