...
breadcrumb: XML do JSON w Java

############################# Head ############################
head_title: "Konwertuj XML na JSON w Java"
head_description: "Konwersja XML na JSON w Java z kilkoma linijkami kodu. Konwertuj ponad 160 formatów plików za pomocą interfejsu API konwersji dokumentów GroupDocs dla Java"

############################# Header ############################
title: "Konwertuj XML na JSON w Java"
description: "Konwersja XML do JSON z kilkoma linijkami kodu Java"
...
overview:
    enable: true
    content: |
        Przekonwertuj swoje pliki XML na JSON w Java. Zajmuje tylko kilka linii kodu Java na dowolnej wybranej platformie, takiej jak Windows, Linux, macOS.
        Możesz spróbować przekonwertować XML na JSON za darmo i ocenić jakość wyników konwersji. Oprócz prostych skryptów konwersji plików możesz wypróbować bardziej wyrafinowane opcje ładowania pliku źródłowego XML i przechowywania danych wyjściowych JSON. 
...
steps:
    enable: true
    title_left: "Kroki konwersji XML na JSON w Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) pozwala programistom łatwo przekonwertować plik XML na JSON za pomocą kilku linijek kodu.
...
demos:
    enable: true
    title: "XML do JSON demonstracji na żywo"
    content: |
       Odwiedź naszą witrynę [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) i wypróbuj teraz konwersję XML na JSON. Darmowe demo ma następujące zalety
