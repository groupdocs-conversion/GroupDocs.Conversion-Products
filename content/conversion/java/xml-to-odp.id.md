...
head_title: "Konversi XML ke ODP di Jawa – Konversi XML ke ODP"
head_description: "Konversi XML ke ODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XML ke ODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XML ke ODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XML ke ODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XML hingga ODP"
    content: |
        Konversikan XML ke ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
