...
############################# Head ############################
head_title: "XML to ODP Conversion in Java – Convert XML to ODP"
head_description: "Convert XML to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to ODP in few lines of code.
...
demos:
    enable: true
    title: "XML to ODP Live Demos"
    content: |
        Convert XML to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
