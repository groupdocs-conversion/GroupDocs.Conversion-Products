...
############################# Head ############################
head_title: "XML to PPSM Conversion in Java – Convert XML to PPSM"
head_description: "Convert XML to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "XML to PPSM Live Demos"
    content: |
        Convert XML to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
