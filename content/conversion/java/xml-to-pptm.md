...
############################# Head ############################
head_title: "XML to PPTM Conversion in Java – Convert XML to PPTM"
head_description: "Convert XML to PPTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to PPTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to PPTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to PPTM in few lines of code.
...
demos:
    enable: true
    title: "XML to PPTM Live Demos"
    content: |
        Convert XML to PPTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
