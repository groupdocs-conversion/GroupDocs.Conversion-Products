...
############################# Head ############################
head_title: "XML to TIF Conversion in Java – Convert XML to TIF"
head_description: "Convert XML to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to TIF in few lines of code.
...
demos:
    enable: true
    title: "XML to TIF Live Demos"
    content: |
        Convert XML to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
