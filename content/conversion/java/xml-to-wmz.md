...
############################# Head ############################
head_title: "XML to WMZ Conversion in Java – Convert XML to WMZ"
head_description: "Convert XML to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to WMZ in few lines of code.
