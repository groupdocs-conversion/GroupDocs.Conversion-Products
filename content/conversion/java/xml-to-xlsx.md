...
############################# Head ############################
head_title: "XML to XLSX Conversion in Java – Convert XML to XLSX"
head_description: "Convert XML to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "XML to XLSX Live Demos"
    content: |
        Convert XML to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
