...
############################# Head ############################
head_title: "XML to XLT Conversion in Java – Convert XML to XLT"
head_description: "Convert XML to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to XLT in few lines of code.
...
demos:
    enable: true
    title: "XML to XLT Live Demos"
    content: |
        Convert XML to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
