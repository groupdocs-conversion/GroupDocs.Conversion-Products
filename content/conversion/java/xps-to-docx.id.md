...
head_title: "Konversi XPS ke DOCX di Jawa – Konversi XPS ke DOCX"
head_description: "Konversi XPS ke DOCX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke DOCX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke DOCX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke DOCX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XPS hingga DOCX"
    content: |
        Konversikan XPS ke DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
