...
############################# Head ############################
head_title: "XPS to DOT Conversion in Java – Convert XPS to DOT"
head_description: "Convert XPS to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to DOT in few lines of code.
...
demos:
    enable: true
    title: "XPS to DOT Live Demos"
    content: |
        Convert XPS to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
