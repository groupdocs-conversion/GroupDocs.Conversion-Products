...
head_title: "Konversi XPS ke DOTX di Jawa – Konversi XPS ke DOTX"
head_description: "Konversi XPS ke DOTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke DOTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke DOTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke DOTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XPS hingga DOTX"
    content: |
        Konversikan XPS ke DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
