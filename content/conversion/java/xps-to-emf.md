...
############################# Head ############################
head_title: "XPS to EMF Conversion in Java – Convert XPS to EMF"
head_description: "Convert XPS to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to EMF in few lines of code.
...
demos:
    enable: true
    title: "XPS to EMF Live Demos"
    content: |
        Convert XPS to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
