...
############################# Head ############################
head_title: "XPS to EMZ Conversion in Java – Convert XPS to EMZ"
head_description: "Convert XPS to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to EMZ in few lines of code.
...
demos:
    enable: true
    title: "XPS to EMZ Live Demos"
    content: |
        Convert XPS to EMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
