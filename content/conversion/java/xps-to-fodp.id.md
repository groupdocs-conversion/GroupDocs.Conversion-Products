...
head_title: "Konversi XPS ke FODP di Jawa – Konversi XPS ke FODP"
head_description: "Konversi XPS ke FODP di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke FODP di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke FODP di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke FODP dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XPS hingga FODP"
    content: |
        Konversikan XPS ke FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
