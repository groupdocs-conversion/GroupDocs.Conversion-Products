...
head_title: "Konversi XPS ke FODS di Jawa – Konversi XPS ke FODS"
head_description: "Konversi XPS ke FODS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke FODS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke FODS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke FODS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XPS hingga FODS"
    content: |
        Konversikan XPS ke FODS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
