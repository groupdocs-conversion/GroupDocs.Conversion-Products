...
############################# Head ############################
head_title: "XPS to GIF Conversion in Java – Convert XPS to GIF"
head_description: "Convert XPS to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to GIF in few lines of code.
