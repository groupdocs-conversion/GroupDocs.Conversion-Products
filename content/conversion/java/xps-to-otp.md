...
############################# Head ############################
head_title: "XPS to OTP Conversion in Java – Convert XPS to OTP"
head_description: "Convert XPS to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to OTP in few lines of code.
...
demos:
    enable: true
    title: "XPS to OTP Live Demos"
    content: |
        Convert XPS to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
