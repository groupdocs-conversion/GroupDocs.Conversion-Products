...
head_title: "Konversi XPS ke PPS di Jawa – Konversi XPS ke PPS"
head_description: "Konversi XPS ke PPS di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke PPS di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke PPS di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke PPS dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XPS hingga PPS"
    content: |
        Konversikan XPS ke PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
