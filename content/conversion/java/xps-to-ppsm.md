...
############################# Head ############################
head_title: "XPS to PPSM Conversion in Java – Convert XPS to PPSM"
head_description: "Convert XPS to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to PPSM in few lines of code.
