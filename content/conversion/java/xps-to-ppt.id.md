...
head_title: "Konversi XPS ke PPT di Jawa – Konversi XPS ke PPT"
head_description: "Konversi XPS ke PPT di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke PPT di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke PPT di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke PPT dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XPS hingga PPT"
    content: |
        Konversikan XPS ke PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
