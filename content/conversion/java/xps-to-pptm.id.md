...
head_title: "Konversi XPS ke PPTM di Jawa – Konversi XPS ke PPTM"
head_description: "Konversi XPS ke PPTM di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke PPTM di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke PPTM di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke PPTM dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XPS hingga PPTM"
    content: |
        Konversikan XPS ke PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
