...
head_title: "Konversi XPS ke PPTX di Jawa – Konversi XPS ke PPTX"
head_description: "Konversi XPS ke PPTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke PPTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke PPTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke PPTX dalam beberapa baris kode.
