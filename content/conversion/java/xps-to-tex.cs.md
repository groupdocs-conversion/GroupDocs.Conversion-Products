...
breadcrumb: XPS do TEX v Java

############################# Head ############################
head_title: "Převést XPS na TEX v Java"
head_description: "Převod XPS na TEX v Java pomocí několika řádků kódu. Převeďte více než 160 formátů souborů pomocí rozhraní API pro převod dokumentů GroupDocs pro Java"

############################# Header ############################
title: "Převést XPS na TEX v Java"
description: "Převod XPS na TEX s několika řádky kódu Java"
...
overview:
    enable: true
    content: |
        Převeďte své soubory XPS na TEX ve službě Java. Na libovolné platformě dle vašeho výběru, jako jsou Windows, Linux, macOS, stačí jen pár řádků kódu Java.
        Můžete zkusit zdarma převést XPS na TEX a vyhodnotit kvalitu výsledků převodu. Spolu s jednoduchými skripty pro převod souborů můžete vyzkoušet sofistikovanější možnosti pro načtení zdrojového souboru XPS a uložení výstupu TEX. 
        ...
        * přidat vodoznak do převedeného TEX.
        ...
        Po dokončení převodu můžete soubor TEX uložit do místní cesty k souboru nebo do libovolného úložiště třetí strany, jako je FTP, Amazon S3, Disk Google, Dropbox atd. Poznámka – pro převod XPS do TEX, nemusíte instalovat žádný další software, jako je MS Office, Open Office, Adobe Acrobat Reader atd.


############################# Steps ############################
steps:
    enable: true
    title_left: "Kroky k převodu XPS na TEX v Java"
    content_left: |
        [GroupDocs.Conversion for Java](https://products.groupdocs.com/conversion/java/) umožňuje vývojářům snadno převést soubor XPS na TEX pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od XPS do TEX"
    content: |
       Navštivte naši webovou stránku [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) a vyzkoušejte konverzi XPS na TEX nyní. Bezplatná ukázka má následující výhody
