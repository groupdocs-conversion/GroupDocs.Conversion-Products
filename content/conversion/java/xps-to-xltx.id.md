...
head_title: "Konversi XPS ke XLTX di Jawa – Konversi XPS ke XLTX"
head_description: "Konversi XPS ke XLTX di Java menggunakan beberapa baris kode. Konversi 160+ format file melalui API konversi dokumen GroupDocs untuk java."

title: "Konversikan File XPS ke XLTX di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengonversi XPS ke XLTX di Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) memudahkan pengembang untuk mengonversi file XPS ke XLTX dalam beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung XPS hingga XLTX"
    content: |
        Konversikan XPS ke XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
