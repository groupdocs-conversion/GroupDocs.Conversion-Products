...
############################# Head #############################
head_title: "Java XSLFO zu DOCX Konverter API - XSLFO in Java-Anwendungen transformieren"
head_description: "XSLFO zu DOCX Dateien in Java, J2EE, J2SE Anwendungen anzeigen. Unterstützt die Anzeige von 180+ Dokumenten- und Bildformate im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung von Dokumentanzeigeoptionen."

############################# Header ############################
title: "XSLFO in DOCX in Java konvertieren" 
description: "Erleben Sie die Effizienz einer nativen, leistungsstarken XSLFO zu DOCX Dateikonverter-API, die für Java-, J2EE- und J2SE-Anwendungen entwickelt wurde. Genießen Sie Unterstützung für eine umfangreiche Reihe zusätzlicher Funktionen, die eine Anpassung des Erscheinungsbilds des Ausgabedokuments ermöglichen." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von XSLFO in DOCX Datei in Java" 
    content: |
      Die Transformation von XSLFO in DOCX wird mit <a href='https://products.groupdocs.com/conversion/java/'>GroupDocs.Conversion</a> durch nur wenige einfache Schritte vereinfacht.
      ...
      3. Laden Sie die XSLFO Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ...
        new Converter()
            ...
            .convert();                     // XSLFO in DOCX Datei konvertieren        
        ```            
