...
overview:
    ...
    tabs:
      ...
      tab_one:
        description: |
          Following is an overview of GroupDocs.Conversion for .NET:
      ...
      tab_two:
        description: |
          GroupDocs.Conversion for .NET supports converting between all popular and commonly used [document file formats](https://docs.groupdocs.com/conversion/net/supported-document-formats/).
      ...
      tab_three:
        description: |
          GroupDocs.Conversion for .NET supports following Operating Systems, Frameworks & Package Managers:
...
features:
    enable: true
    title: "GroupDocs.Conversion for .NET Features"
    ...
    more_feature:
      ...
      - title: "Conversion to Image Formats"
        content: "GroupDocs.Conversion for .NET can be used to develop applications in any development environment that targets .NET platform. It is compatible with all .NET based languages and supports popular operating systems (Windows, Linux, MacOS) where Mono or .NET frameworks (including .NET Core) can be installed."
