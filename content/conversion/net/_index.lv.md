...
############################# Head ############################
head_title: "C# .NET dokumentu konvertēšanas API | Konvertējiet PDF, Word, Excel, PPTX, HTML un attēlus"
head_description: "C# .NET dokumentu konvertēšanas API. Konvertējiet PDF, Word, DOC, DOCX, Excel, izklājlapas, PPT, PPTX, HTML, PSD, MPT, MPP, e-pasta, MSG, EMLX, AutoCAD un attēlu failu formātus."

############################# Header ############################
title: "Dokumentu konvertēšana<br>izmantojot .NET API"
...
code:
  title: "Kā konvertēt PDF failus C#"
  more: "Vairāk piemēru"
...
overview:
  ...
  description: "Izpētiet API iespējas ātrai un nevainojamai PDF, Microsoft Office, HTML, e-grāmatu un attēlu failu konvertēšanai .NET lietojumprogrammās."
  features:
    # feature loop
...
platforms:
  ...
  description: "GroupDocs.Conversion for .NET atbalsta šādas operētājsistēmas, ietvarus un pakotņu pārvaldniekus"
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    GroupDocs.Conversion for .NET atbalsta darbības ar šādiem [failu formātiem](https://docs.groupdocs.com/conversion/net/supported-file-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  ...
  items:
    ...
    - icon: "extract"
      ...
      content: "Nemanāmi integrējiet konvertēšanas iespējas savās .NET lietojumprogrammās, padarot to par vienmērīgu jūsu darbplūsmas daļu."
...
code_samples:
  enable: true
  title: "Koda paraugi"
  description: "Daži izmanto tipisku GroupDocs.Conversion gadījumus .NET operācijām"
  items:
    # code sample loop
    - title: "Pārvērst PDF par attēlu"
      content: |
        ...
        {{< landing/code title="Konvertējiet PDF uz PNG formātā C#">}}
        ```csharp {style=abap}   
    ...
    - title: "Konvertējiet liela dokumenta segmentu"
      content: |
        ...
        {{< landing/code title="Konvertējiet DOCX (2.-4. lpp.) uz PDF formātā C#">}}
        ```csharp {style=abap}   
        using GroupDocs.Conversion;
        using GroupDocs.Conversion.Options.Convert;
    ...
    # code sample loop
    - title: "Raida sintakse: racionalizēta pieeja"
      content: |
        ...
        {{< landing/code title="Konvertējiet DOCX uz PDF C# valodā, izmantojot tekošu sintaksi">}}
        ```csharp {style=abap}  
        using GroupDocs.Conversion;
...
#     content: "Lielisks serviss un lieliski produkti. Viņi bija ļoti izpalīdzīgi un atsaucīgi GroupDocs.Conversion for .NET ieviešanas procesā, taču nevar tos pietiekami labi ieteikt."
#     author: "Mārtiņš Lasarga"
#     company: "Produktu vadītājs uzņēmumā Axentria ECM, G.S.I."

#   # review loop
#   - title: "GroupDocs.Viewer"
#     content: "Pēc GroupDocs.Conversion for .NET ieviešanas un izmantošanas projektā, šķiet, ka tas darbojas ļoti labi. Esmu testējis ar daudziem dokumentiem un līdz šim viss ir labi. Viss, ko esmu iemetis tajā, tiek lieliski atveidots un izskatās tikpat labi kā PDF skatītājā vai MS Word."
