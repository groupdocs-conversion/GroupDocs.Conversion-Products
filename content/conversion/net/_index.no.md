...
############################# Head ############################
head_title: "C# .NET dokumentkonverterings-API | Konverter PDF, Word, Excel, PPTX, HTML og bilder"
head_description: "C# .NET dokumentkonverterings-API. Konverter PDF, Word, DOC, DOCX, Excel, Regneark, PPT, PPTX, HTML, PSD, MPT, MPP, E-post, MSG, EMLX, AutoCAD og bildefilformater."
...
code:
  title: "Hvordan konvertere PDF-filer i C#"
...
overview:
  ...
  description: "Utforsk mulighetene til API for rask og feilfri konvertering av PDF-, Microsoft Office-, HTML-, e-bok- og bildefiler i .NET-applikasjoner"
  features:
    # feature loop
...
platforms:
  ...
  description: "GroupDocs.Conversion for .NET støtter følgende operativsystemer, rammeverk og pakkeadministratorer"
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    GroupDocs.Conversion for .NET støtter operasjoner med følgende [filformater](https://docs.groupdocs.com/conversion/net/supported-file-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  ...
  items:
    ...
    - icon: "remove"
      ...
      content: "Konverter flersidige dokumenter til bilder side for side, noe som muliggjør presis kontroll over transformasjonsprosessen og forenkler bildebasert dokumentutvinning og analyse."
    ...
    - icon: "extract"
      ...
      content: "Integrer konverteringsmulighetene sømløst i .NET-applikasjonene dine, og gjør det til en sømløs del av arbeidsflyten din."
...
code_samples:
  enable: true
  title: "Kodeprøver"
  description: "Noen bruker tilfeller av typiske GroupDocs.Conversion for .NET-operasjoner"
  items:
    # code sample loop
    - title: "Konverter PDF til bilde"
      content: |
        Et vanlig scenario innebærer å konvertere et helt PDF-dokument eller bestemte sider til en samling bilder. GroupDocs.Conversion for .NET tilbyr muligheten til å konvertere PDF-filer til ulike bildeformater, for eksempel TIFF, JPG, PNG, GIF, BMP og mer. 
        I motsetning til andre konverteringer, krever denne prosessen erklæringen fra en SavePageStream-delegat, som spesifiserer navneformatet for de lagrede bildene. Du kan velge ditt foretrukne bildeformat ved å bruke ImageFileType-klassen.
    ...
    - title: "Konverter et segment av et stort dokument"
      content: |
        Med GroupDocs.Conversion for .NET kan du enkelt konvertere bestemte sider fra et langt dokument. 
    ...
    # code sample loop
    - title: "Flytende syntaks: En strømlinjeformet tilnærming"
      content: |
        Flytende syntaks gir en kortfattet notasjon for vanlige handlinger i GroupDocs.Conversion for .NET API. 
        Kodeeksemplene nedenfor viser hvordan du kan utnytte den flytende syntaksen:
        {{< landing/code title="Konverter DOCX til PDF i C# ved hjelp av flytende syntaks">}}
        ```csharp {style=abap}  
        using GroupDocs.Conversion;
...
#     content: "Utmerket service og gode produkter. De var ekstremt hjelpsomme og lydhøre under implementeringsprosessen for GroupDocs.Conversion for .NET, kan ikke anbefale dem høyt nok."
#     author: "Martin Lasarga"
#     company: "Produktsjef hos Axentria ECM av G.S.I."

#   # review loop
#   - title: "GroupDocs.Viewer"
#     content: "Etter å ha implementert og brukt GroupDocs.Conversion for .NET i prosjektet ser det ut til å fungere veldig bra. Jeg har testet med mange dokumenter og så langt så bra. Alt jeg har kastet på det, gjengis pent og ser like bra ut som det ville gjort i en PDF-visning eller MS Word."
#     author: "Mats Oustad"
