...
overview:
  ...
  description: "สำรวจความสามารถของ API สำหรับการแปลงไฟล์ PDF, Microsoft Office, HTML, eBook และรูปภาพภายในแอปพลิเคชัน .NET อย่างรวดเร็วและไร้ที่ติ"
  features:
    # feature loop
...
formats:
  ...
  description: |
    GroupDocs.Conversion สำหรับ .NET รองรับการดำเนินการกับ [รูปแบบไฟล์](https://docs.groupdocs.com/conversion/net/supported-file-formats/) ต่อไปนี้
  groups:
    # group loop
    - color: "green"
      content: |
...
code_samples:
  enable: true
  title: "ตัวอย่างโค้ด"
  description: "กรณีการใช้งานบางอย่างของ GroupDocs.Conversion ทั่วไปสำหรับการดำเนินการ .NET"
  items:
    # code sample loop
