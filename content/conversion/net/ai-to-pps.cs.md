...
breadcrumb: AI do PPS v C#

############################# Head ############################
head_title: "Převodník AI na PPS v C#"
head_description: "Převeďte AI na PPS v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést AI na PPS v C#"
description: "Převod AI na PPS s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory AI na PPS ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi AI na PPS a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového AI souboru a pro uložení výstupního PPS výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu AI na PPS v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru AI na PPS pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od AI do PPS"
    content: |
       Převeďte AI na PPS nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
