...
############################# Head ############################
head_title: "Převodník AI na PSB v C#"
head_description: "Převeďte AI na PSB v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést AI na PSB v C#"
description: "Převod AI na PSB s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory AI na PSB ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi AI na PSB a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového AI souboru a pro uložení výstupního PSB výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu AI na PSB v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru AI na PSB pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte AI na PSB nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
