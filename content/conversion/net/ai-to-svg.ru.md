...
overview:
    enable: true
    content: |
        Преобразуйте свои файлы AI в файлы SVG в .NET. Для этого понадобится всего пара строк кода C# на любой платформе по вашему выбору, например — Windows, Linux, macOS.
