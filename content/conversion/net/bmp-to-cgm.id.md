...
head_title: "Konverter BMP ke CGM – Konversi BMP ke CGM di C# .NET"
head_description: "Bagaimana cara mengonversi BMP ke CGM di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi BMP ke CGM di C#"
description: "Konversi BMP ke CGM asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi BMP ke CGM di C#"
    content_left: |
        [GroupDocs.Conversion](conversion/net) memudahkan pengembang untuk mengonversi file BMP ke CGM menggunakan beberapa baris kode.

        * Buat instance kelas Converter dan muat file BMP dengan path lengkap
        * Buat & atur ConvertOptions untuk tipe CGM
        * Panggil metode Converter.Convert dan berikan path lengkap dan format (CGM) sebagai parameter
    ...
    code: |
        ...
        // atur opsi konversi untuk format CGM
        var convertOptions = converter.GetPossibleConversions()["cgm"].ConvertOptions;
        // konversi ke format CGM
        converter.Convert("output.cgm", convertOptions);
        ```
        
demos:
    enable: true
    title: "Demo Langsung BMP hingga CGM"
    content: |
        Konversikan BMP ke CGM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
