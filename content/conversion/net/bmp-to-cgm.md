...
############################# Head ############################
head_title: "BMP to CGM Converter – Convert BMP to CGM in C# .NET"
head_description: "How to convert BMP to CGM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert BMP to CGM in C#"
description: "Native and high performance BMP to CGM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert BMP to CGM in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the BMP file to CGM using a few lines of code.

        *   Create an instance of Converter class and load the BMP file with full path
        *   Create & set ConvertOptions for the cgm type
        *   Call Converter.Convert method and pass the full path and format (CGM) as parameter
    ...
    code: |
        ...
        // set the convert options for CGM format
