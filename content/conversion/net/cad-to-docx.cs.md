...
############################# Head ############################
head_title: "Převodník CAD na DOCX v C#"
head_description: "Převeďte CAD na DOCX v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést CAD na DOCX v C#"
description: "Převod CAD na DOCX s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory CAD na DOCX ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi CAD na DOCX a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového CAD souboru a pro uložení výstupního DOCX výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu CAD na DOCX v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru CAD na DOCX pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte CAD na DOCX nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
