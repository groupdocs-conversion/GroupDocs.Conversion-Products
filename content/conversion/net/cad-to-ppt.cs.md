...
breadcrumb: CAD do PPT v C#

############################# Head ############################
head_title: "Převodník CAD na PPT v C#"
head_description: "Převeďte CAD na PPT v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést CAD na PPT v C#"
description: "Převod CAD na PPT s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory CAD na PPT ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi CAD na PPT a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového CAD souboru a pro uložení výstupního PPT výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu CAD na PPT v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru CAD na PPT pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od CAD do PPT"
    content: |
       Převeďte CAD na PPT nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
