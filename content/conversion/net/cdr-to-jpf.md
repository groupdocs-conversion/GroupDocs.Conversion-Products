...
breadcrumb: CDR to JPF in C#

############################# Head ############################
head_title: "CDR to JPF Converter in C#"
head_description: "Convert CDR to JPF in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert CDR to JPF in C#"
description: "CDR to JPF conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your CDR files to JPF in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert CDR to JPF in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a CDR file to JPF with a few lines of code.
