...
breadcrumb: C# の CMX から EMZ

############################# Head ############################
head_title: "C# の CMX から EMZ へのコンバーター"
head_description: "数行のコードを使用して、.NET で CMX を EMZ に変換します。 GroupDocs ドキュメント変換 API を使用して、160 を超えるファイル形式を変換します。"

############################# Header ############################
title: "C# で CMX を EMZ に変換します"
description: "数行の .NET コードによる CMX から EMZ への変換"
...
overview:
    enable: true
    content: |
        .NET で CMX ファイルを EMZ に簡単に変換します。 Windows、Linux、macOS など、任意のプラットフォームで C# コード行を 2 行だけ使用できます。
...
steps:
    enable: true
    title_left: "C# で CMX を EMZ に変換する手順"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) を使用すると、開発者は数行のコードで CMX ファイルを EMZ に簡単に変換できます。
