...
head_description: "Преобразуйте CMX в PPSX на .NET, используя несколько строк кода. Используйте API преобразования документов GroupDocs для преобразования более 160 форматов файлов."

############################# Header ############################
title: "Преобразование CMX в PPSX в C#"
description: "Конвертировать CMX в PPSX с помощью нескольких строк кода .NET"
...
overview:
    enable: true
    content: |
        Легко конвертируйте файлы CMX в PPSX на .NET. Вы можете использовать всего пару строк кода C# на любой платформе по вашему выбору, например - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Шаги по преобразованию CMX в PPSX в C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) позволяет разработчикам легко преобразовать файл CMX в PPSX с помощью нескольких строк кода.
