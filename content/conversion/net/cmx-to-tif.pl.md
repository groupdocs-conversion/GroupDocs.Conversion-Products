...
steps:
    enable: true
    title_left: "Kroki konwersji CMX na TIF w C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) ułatwia programistom konwersję pliku CMX na TIF za pomocą kilku linijek kodu.
