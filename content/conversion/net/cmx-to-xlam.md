...
############################# Head ############################
head_title: "CMX to XLAM Converter – Convert CMX to XLAM in C# .NET"
head_description: "How to convert CMX to XLAM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CMX to XLAM in C#"
description: "Native and high performance CMX to XLAM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CMX file to XLAM using a few lines of code.
