...
breadcrumb: CSV til TSV í C#

############################# Head ############################
head_title: "CSV til TSV Breytir í C#"
head_description: "Umbreyttu CSV í TSV í .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Conversion API til að umbreyta yfir 160 skráarsniðum."

############################# Header ############################
title: "Umbreyttu CSV í TSV í C#"
description: "CSV til TSV viðskipti með nokkrum línum af .NET kóða"
...
overview:
    enable: true
    content: |
        Breyttu CSV skránum þínum í TSV í .NET auðveldlega. Þú getur notað aðeins nokkrar C# kóðalínur á hvaða vettvang sem þú vilt eins og - Windows, Linux, macOS.
        Þú getur prófað CSV til TSV viðskipti ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingum geturðu prófað fullkomnari valkosti til að hlaða uppruna CSV skrá og til að vista úttak TSV niðurstöðu. 
        ...
        * bættu vatnsmerki við breyttu TSV skrána og margt fleira.
        ...
        Þegar umbreytingu er lokið geturðu vistað TSV skrána þína á staðbundinni skráarslóð eða hvaða geymslu sem er þriðja aðila eins og FTP, Amazon S3, Google Drive, Dropbox osfrv. Athugaðu - til að breyta CSV í {{ TO}} það er engin þörf fyrir neinn viðbótarhugbúnað uppsettan - eins og MS Office, Open Office, Adobe Acrobat Reader o.s.frv.


############################# Steps ############################
steps:
    enable: true
    title_left: "Skref til að breyta CSV í TSV í C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) auðveldar forriturum að breyta CSV skrá í TSV með nokkrum línum af kóða.
...
demos:
    ...
    content: |
       Umbreyttu CSV í TSV núna með því að fara á [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) vefsíðuna. Demo á netinu hefur eftirfarandi kosti
