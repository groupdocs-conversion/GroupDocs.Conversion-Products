...
############################# Head ############################
head_title: "DCM to FODS Converter – Convert DCM to FODS in C# .NET"
head_description: "How to convert DCM to FODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DCM to FODS in C#"
description: "Native and high performance DCM to FODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DCM file to FODS using a few lines of code.
...
demos:
    enable: true
    title: "DCM to FODS Live Demos"
    content: |
        Convert DCM to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
