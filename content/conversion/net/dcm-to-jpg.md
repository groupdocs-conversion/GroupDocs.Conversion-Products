...
overview:
    ...
    content: |
        ...
        You can try DCM to JPG conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source DCM file and for saving output JPG result. 
        ...
        * add a watermark to the converted JPG file.
        ...
        Please note - to convert DCM to JPG there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DCM file to JPG with a few lines of code.
