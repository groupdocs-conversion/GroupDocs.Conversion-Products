...
############################# Head ############################
head_title: "DGN to DOCX Converter – Convert DGN to DOCX in C# .NET"
head_description: "How to convert DGN to DOCX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DGN to DOCX in C#"
description: "Native and high performance DGN to DOCX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DGN file to DOCX using a few lines of code.
...
demos:
    enable: true
    title: "DGN to DOCX Live Demos"
    content: |
        Convert DGN to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
