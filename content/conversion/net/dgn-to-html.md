...
############################# Head ############################
head_title: "DGN to HTML Converter – Convert DGN to HTML in C# .NET"
head_description: "How to convert DGN to HTML in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DGN to HTML in C#"
description: "Native and high performance DGN to HTML conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DGN file to HTML using a few lines of code.
...
demos:
    enable: true
    title: "DGN to HTML Live Demos"
    content: |
        Convert DGN to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
