...
breadcrumb: DGN go POT in C#

############################# Head ############################
head_title: "DGN go POT Tiontaire in C#"
head_description: "Tiontaigh DGN go POT in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh DGN go POT in C#"
description: "DGN go POT tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid DGN go POT in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as DGN go POT tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse DGN comhad a luchtú agus chun aschur POT a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun DGN a thiontú go POT in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad DGN a thiontú go POT le cúpla líne de chód.
...
demos:
    enable: true
    title: "DGN go POT Taispeántas Beo"
    content: |
       Tiontaigh DGN go POT anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
