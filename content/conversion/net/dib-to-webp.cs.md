...
############################# Head ############################
head_title: "Převodník DIB na WEBP v C#"
head_description: "Převeďte DIB na WEBP v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést DIB na WEBP v C#"
description: "Převod DIB na WEBP s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory DIB na WEBP ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi DIB na WEBP a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového DIB souboru a pro uložení výstupního WEBP výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu DIB na WEBP v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru DIB na WEBP pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od DIB do WEBP"
    content: |
       Převeďte DIB na WEBP nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
