...
breadcrumb: C# 中的 DNG 到 JP2

############################# Head ############################
head_title: "C# 中的 DNG 到 JP2 转换器"
head_description: "使用几行代码将 .NET 中的 DNG 转换为 JP2。使用 GroupDocs 文档转换 API 转换 160 多种文件格式。"

############################# Header ############################
title: "在 C# 中将 DNG 转换为 JP2"
description: "使用几行 .NET 代码将 DNG 转换为 JP2"
...
overview:
    enable: true
    content: |
        轻松将您的 DNG 文件转换为 .NET 中的 JP2。您可以在您选择的任何平台（如 Windows、Linux、macOS）中仅使用几行 C# 代码行。
...
steps:
    enable: true
    title_left: "在 C# 中将 DNG 转换为 JP2 的步骤"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) 让开发人员只需几行代码即可轻松地将 DNG 文件转换为 JP2。
