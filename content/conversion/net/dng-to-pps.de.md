...
breadcrumb: DNG nach PPS in C#

############################# Head ############################
head_title: "DNG nach PPS Konverter in C#"
head_description: "Wandeln Sie DNG in .NET mit ein paar Zeilen Code in PPS um. Verwenden Sie die GroupDocs Document Conversion API, um über 160 Dateiformate zu konvertieren."

############################# Header ############################
title: "Konvertiere DNG in PPS in C#"
description: "Umwandlung von DNG in PPS mit ein paar Zeilen .NET-Code"
...
overview:
    enable: true
    content: |
        Konvertieren Sie Ihre DNG-Dateien einfach in PPS in .NET. Sie können nur ein paar C#-Codezeilen auf jeder Plattform Ihrer Wahl verwenden, z. B. Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Schritte zum Konvertieren von DNG in PPS in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) erleichtert Entwicklern das Konvertieren einer DNG-Datei in PPS mit wenigen Codezeilen.
