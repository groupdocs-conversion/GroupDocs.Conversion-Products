...
############################# Head ############################
head_title: "DOC to HTML Converter – Convert DOC to HTML in C# .NET"
head_description: "How to convert DOC to HTML in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DOC to HTML in C#"
description: "Native and high performance DOC to HTML conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DOC to HTML in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DOC file to HTML using a few lines of code.
