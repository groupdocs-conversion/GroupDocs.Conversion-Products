...
############################# Head #############################
head_title: "API Convertitore DOC in ODT per .NET - converti in C# VB.NET"
head_description: "API convertitore file .NET per convertire DOC in ODT in qualsiasi tipo di applicazione C#, ASP.NET, VB.NET e .NET Core."

############################# Header ############################
title: "Convertitore file DOC in ODT per applicazioni C# .NET" 
...
steps:
    enable: true
    title: "Passaggi per convertire il file DOC in ODT nel linguaggio C#" 
    content: |
      Con <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> puoi trasformare DOC in ODT in pochi semplici passaggi.
    ...
    code:
      ...
      content: |
        ...
        FluentConverter
            ...
            .ConvertTo("converted.odt")     // Specificare il percorso di output per il file convertito
            .Convert();                     // Converti il file DOC in ODT        
        ```            
