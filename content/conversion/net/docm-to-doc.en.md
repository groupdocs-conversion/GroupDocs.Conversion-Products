...
breadcrumb: DOCM to DOC in C#

############################# Head ############################
head_title: "DOCM to DOC Converter in C#"
head_description: "Convert DOCM to DOC in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert DOCM to DOC in C#"
description: "DOCM to DOC conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your DOCM files to DOC in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DOCM file to DOC with a few lines of code.
