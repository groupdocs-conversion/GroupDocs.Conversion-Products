...
breadcrumb: DOCM to VSSM in C#

############################# Head ############################
head_title: "DOCM to VSSM Converter in C#"
head_description: "Convert DOCM to VSSM in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert DOCM to VSSM in C#"
description: "DOCM to VSSM conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your DOCM files to VSSM in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert DOCM to VSSM in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DOCM file to VSSM with a few lines of code.
