...
breadcrumb: DOCX to JPM in C#

############################# Head ############################
head_title: "DOCX to JPM Converter in C#"
head_description: "Convert DOCX to JPM in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert DOCX to JPM in C#"
description: "DOCX to JPM conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your DOCX files to JPM in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert DOCX to JPM in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DOCX file to JPM with a few lines of code.
