...
############################# Head #############################
head_title: "API Convertitore DOCX in TIFF per .NET - converti in C# VB.NET"
head_description: "API convertitore file .NET per convertire DOCX in TIFF in qualsiasi tipo di applicazione C#, ASP.NET, VB.NET e .NET Core."

############################# Header ############################
title: "Convertitore file DOCX in TIFF per applicazioni C# .NET" 
description: "API di conversione documenti .NET per una trasformazione senza soluzione di continuità da DOCX a TIFF all'interno di applicazioni C#, ASP.NET, VB.NET e .NET Core. Assicura una formattazione precisa e la conservazione del layout durante il processo di conversione, riducendo al minimo gli sforzi di codifica." 
...
steps:
    enable: true
    title: "Passaggi per convertire il file DOCX in TIFF nel linguaggio C#" 
    content: |
      Con <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> puoi trasformare DOCX in TIFF in pochi semplici passaggi.
      ...
      3. Carica il file DOCX con il percorso completo. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.docx")             // Imposta il file DOCX di input
            .ConvertTo("converted.tiff")     // Specificare il percorso di output per il file convertito
            .Convert();                     // Converti il file DOCX in TIFF        
        ```            
