...
breadcrumb: C# 中的 DOT 到 TEX

############################# Head ############################
head_title: "C# 中的 DOT 到 TEX 转换器"
head_description: "使用几行代码将 .NET 中的 DOT 转换为 TEX。使用 GroupDocs 文档转换 API 转换 160 多种文件格式。"

############################# Header ############################
title: "在 C# 中将 DOT 转换为 TEX"
description: "使用几行 .NET 代码将 DOT 转换为 TEX"
...
overview:
    enable: true
    content: |
        轻松将您的 DOT 文件转换为 .NET 中的 TEX。您可以在您选择的任何平台（如 Windows、Linux、macOS）中仅使用几行 C# 代码行。
...
steps:
    enable: true
    title_left: "在 C# 中将 DOT 转换为 TEX 的步骤"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) 使开发人员只需几行代码即可轻松地将 DOT 文件转换为 TEX。
