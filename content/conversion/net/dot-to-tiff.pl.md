...
steps:
    enable: true
    title_left: "Kroki konwersji DOT na TIFF w C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) ułatwia programistom konwersję pliku DOT na TIFF za pomocą kilku linijek kodu.
