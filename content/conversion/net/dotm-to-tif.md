...
overview:
    ...
    content: |
        ...
        You can try DOTM to TIF conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source DOTM file and for saving output TIF result. 
        ...
        * add a watermark to the converted TIF file.
        ...
        Please note - to convert DOTM to TIF there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DOTM file to TIF with a few lines of code.
