...
breadcrumb: DOTX to DWF in C#

############################# Head ############################
head_title: "DOTX to DWF Converter in C#"
head_description: "Convert DOTX to DWF in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert DOTX to DWF in C#"
description: "DOTX to DWF conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your DOTX files to DWF in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert DOTX to DWF in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DOTX file to DWF with a few lines of code.
