...
head_title: "Konverter DWF ke MHTM – Konversi DWF ke MHTM di C# .NET"
head_description: "Bagaimana cara mengonversi DWF ke MHTM di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi DWF ke MHTM di C#"
description: "Konversi DWF ke MHTM asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi DWF ke MHTM di C#"
    content_left: |
        [GroupDocs.Conversion](conversion/net) memudahkan pengembang untuk mengonversi file DWF ke MHTM menggunakan beberapa baris kode.

        * Buat instance kelas Converter dan muat file DWF dengan path lengkap
        * Buat & atur ConvertOptions untuk tipe MHTM
        * Panggil metode Converter.Convert dan berikan path lengkap dan format (MHTM) sebagai parameter
    ...
    code: |
        ...
        // atur opsi konversi untuk format MHTM
        var convertOptions = converter.GetPossibleConversions()["mhtm"].ConvertOptions;
        // konversi ke format MHTM
        converter.Convert("output.mhtm", convertOptions);
        ```
        
demos:
    enable: true
    title: "Demo Langsung DWF hingga MHTM"
    content: |
        Konversikan DWF ke MHTM sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family). Demo langsung memiliki manfaat sebagai berikut.
...
about_formats:
    ...
    format:
        - icon: "far fa-file-code"
          title: " Tentang Format File MHTM"
          content: |
