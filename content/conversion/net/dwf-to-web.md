...
breadcrumb: DWF to WEB in C#

############################# Head ############################
head_title: "DWF to WEB Converter in C#"
head_description: "Convert DWF to WEB in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert DWF to WEB in C#"
description: "DWF to WEB conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your DWF files to WEB in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert DWF to WEB in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DWF file to WEB with a few lines of code.
