...
breadcrumb: DWG go MHTML in C#

############################# Head ############################
head_title: "DWG go MHTML Tiontaire in C#"
head_description: "Tiontaigh DWG go MHTML in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh DWG go MHTML in C#"
description: "DWG go MHTML tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid DWG go MHTML in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as DWG go MHTML tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse DWG comhad a luchtú agus chun aschur MHTML a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun DWG a thiontú go MHTML in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad DWG a thiontú go MHTML le cúpla líne de chód.
...
demos:
    enable: true
    title: "DWG go MHTML Taispeántas Beo"
    content: |
       Tiontaigh DWG go MHTML anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
