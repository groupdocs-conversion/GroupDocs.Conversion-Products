...
breadcrumb: DWG to MOBI in C#

############################# Head ############################
head_title: "DWG to MOBI Converter in C#"
head_description: "Convert DWG to MOBI in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert DWG to MOBI in C#"
description: "DWG to MOBI conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your DWG files to MOBI in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert DWG to MOBI in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DWG file to MOBI with a few lines of code.
