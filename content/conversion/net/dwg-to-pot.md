...
############################# Head ############################
head_title: "DWG to POT Converter – Convert DWG to POT in C# .NET"
head_description: "How to convert DWG to POT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DWG to POT in C#"
description: "Native and high performance DWG to POT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DWG file to POT using a few lines of code.
...
demos:
    enable: true
    title: "DWG to POT Live Demos"
    content: |
        Convert DWG to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
