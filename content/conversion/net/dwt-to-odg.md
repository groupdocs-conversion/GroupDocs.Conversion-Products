...
breadcrumb: DWT to ODG in C#

############################# Head ############################
head_title: "DWT to ODG Converter in C#"
head_description: "Convert DWT to ODG in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert DWT to ODG in C#"
description: "DWT to ODG conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your DWT files to ODG in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert DWT to ODG in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a DWT file to ODG with a few lines of code.
