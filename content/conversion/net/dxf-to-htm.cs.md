...
breadcrumb: DXF do HTM v C#

############################# Head ############################
head_title: "Převodník DXF na HTM v C#"
head_description: "Převeďte DXF na HTM v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést DXF na HTM v C#"
description: "Převod DXF na HTM s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory DXF na HTM ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi DXF na HTM a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového DXF souboru a pro uložení výstupního HTM výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu DXF na HTM v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru DXF na HTM pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte DXF na HTM nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
