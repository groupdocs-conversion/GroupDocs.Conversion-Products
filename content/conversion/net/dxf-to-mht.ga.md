...
breadcrumb: DXF go MHT in C#

############################# Head ############################
head_title: "DXF go MHT Tiontaire in C#"
head_description: "Tiontaigh DXF go MHT in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh DXF go MHT in C#"
description: "DXF go MHT tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid DXF go MHT in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as DXF go MHT tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse DXF comhad a luchtú agus chun aschur MHT a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun DXF a thiontú go MHT in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad DXF a thiontú go MHT le cúpla líne de chód.
...
demos:
    ...
    content: |
       Tiontaigh DXF go MHT anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
