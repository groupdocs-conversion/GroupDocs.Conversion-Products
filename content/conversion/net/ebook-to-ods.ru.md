...
############################# Head ############################
head_title: "EBOOK к ODS Converter — конвертируйте EBOOK в ODS на C# .NET"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/net/) позволяет разработчикам легко преобразовать файл EBOOK в ODS с помощью нескольких строк кода.
