...
############################# Head ############################
head_title: "EBOOK to PHOTOSHOP Converter — конвертируйте EBOOK в PHOTOSHOP на C# .NET"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) позволяет разработчикам легко преобразовать файл EBOOK в PHOTOSHOP с помощью нескольких строк кода.
