...
############################# Head ############################
head_title: "EBOOK to POWERPOINT Converter — конвертируйте EBOOK в POWERPOINT на C# .NET"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) упрощает для разработчиков преобразование файла EBOOK в формат POWERPOINT с помощью нескольких строк кода.
