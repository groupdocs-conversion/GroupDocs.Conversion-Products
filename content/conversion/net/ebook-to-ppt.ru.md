...
############################# Head ############################
head_title: "EBOOK to PPT Converter — конвертируйте EBOOK в PPT на C# .NET"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) позволяет разработчикам легко преобразовать файл EBOOK в формат PPT с помощью нескольких строк кода.
