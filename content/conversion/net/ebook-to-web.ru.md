...
############################# Head ############################
head_title: "EBOOK to WEB Converter — конвертируйте EBOOK в WEB на C# .NET"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) позволяет разработчикам легко преобразовать файл EBOOK в WEB, используя несколько строк кода.
