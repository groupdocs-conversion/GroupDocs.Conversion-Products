...
############################# Head ############################
head_title: "EBOOK to WORD Converter — конвертируйте EBOOK в WORD на C# .NET"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) упрощает для разработчиков преобразование файла EBOOK в формат WORD с помощью нескольких строк кода.
