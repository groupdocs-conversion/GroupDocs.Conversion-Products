...
overview:
    ...
    content: |
        ...
        You can try EML to MSG conversion for free and evaluate conversion results quality.  Along with simple file conversion scenarios you can try more advanced options for loading source EML file and for saving output MSG result. 
        ...
        * add a watermark to the converted MSG file and many more.
        ...
        Once conversion is completed you can save your MSG file to the local file path or any third-party storage like FTP, Amazon S3, Google Drive, Dropbox etc. Please note - to convert EML to MSG there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc.
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a EML file to MSG with a few lines of code.
