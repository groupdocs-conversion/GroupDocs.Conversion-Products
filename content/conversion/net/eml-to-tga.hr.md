...
breadcrumb: EML do TGA u C#

############################# Head ############################
head_title: "EML u TGA pretvarač u C#"
head_description: "Pretvorite EML u TGA u .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Conversion API za pretvaranje preko 160 formata datoteka."

############################# Header ############################
title: "Pretvori EML u TGA u C#"
description: "Konverzija EML u TGA s nekoliko redaka .NET koda"
...
overview:
    enable: true
    content: |
        Jednostavno pretvorite svoje EML datoteke u TGA u .NET. Možete koristiti samo nekoliko C# linija koda na bilo kojoj platformi po vašem izboru kao što su - Windows, Linux, macOS.
        Možete besplatno isprobati konverziju EML u TGA i procijeniti kvalitetu rezultata konverzije. Uz jednostavne scenarije konverzije datoteka, možete isprobati naprednije opcije za učitavanje izvorne EML datoteke i za spremanje izlaznog TGA rezultata. 
...
steps:
    enable: true
    title_left: "Koraci za pretvaranje EML u TGA u C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) programerima olakšava pretvaranje EML datoteke u TGA s nekoliko redaka koda.
...
demos:
    ...
    content: |
       Pretvorite EML u TGA sada tako da posjetite [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) web mjesto. Online demo ima sljedeće prednosti
