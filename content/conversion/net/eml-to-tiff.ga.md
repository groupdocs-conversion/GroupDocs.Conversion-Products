...
breadcrumb: EML go TIFF in C#

############################# Head ############################
head_title: "EML go TIFF Tiontaire in C#"
head_description: "Tiontaigh EML go TIFF in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh EML go TIFF in C#"
description: "EML go TIFF tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid EML go TIFF in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as EML go TIFF tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse EML comhad a luchtú agus chun aschur TIFF a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun EML a thiontú go TIFF in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad EML a thiontú go TIFF le cúpla líne de chód.
...
demos:
    ...
    content: |
       Tiontaigh EML go TIFF anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
