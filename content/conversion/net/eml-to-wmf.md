...
############################# Head ############################
head_title: "EML to WMF Converter – Convert EML to WMF in C# .NET"
head_description: "How to convert EML to WMF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert EML to WMF in C#"
description: "Native and high performance EML to WMF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the EML file to WMF using a few lines of code.
