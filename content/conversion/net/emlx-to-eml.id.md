...
breadcrumb: EMLX ke EML di C#

############################# Head ############################
head_title: "Konverter EMLX ke EML di C#"
head_description: "Konversikan EMLX ke EML di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi EMLX ke EML di C#"
description: "Konversi EMLX ke EML dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file EMLX Anda ke EML di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi EMLX ke EML secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber EMLX dan untuk menyimpan hasil EML keluaran. 
        ...
        * ganti font yang hilang untuk mempertahankan tampilan dokumen.
        ...
        Ada juga opsi konversi lanjutan untuk file EML:

        * mengonversi halaman dokumen atau rentang halaman tertentu;
        * tambahkan tanda air ke file EML yang dikonversi dan banyak lagi.

        Setelah konversi selesai, Anda dapat menyimpan file EML Anda ke jalur file lokal atau penyimpanan pihak ketiga mana pun seperti FTP, Amazon S3, Google Drive, Dropbox, dll. Harap diperhatikan - untuk mengonversi EMLX ke {{ TO}} tidak perlu menginstal perangkat lunak tambahan apa pun - seperti MS Office, Open Office, Adobe Acrobat Reader, dll.


############################# Steps ############################
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi EMLX ke EML di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file EMLX ke EML dengan beberapa baris kode.
        
        * Buat instance kelas Converter dan berikan file EMLX dengan path lengkap
        * Buat dan atur ConvertOptions untuk tipe EML.
        * Panggil metode Converter.Convert dan berikan jalur dan format lengkap (EML) sebagai parameter
    ...
    code: |
        ...
        // Muat file sumber EMLX untuk konversi
          ...
          // Siapkan opsi konversi untuk format target EML
          var convertOptions = converter.GetPossibleConversions()["eml"].ConvertOptions;
          // Konversikan ke format EML
          converter.Convert("output.eml", convertOptions);
        ```

demos:
    enable: true
    title: "EMLX ke EML Demo Langsung"
    content: |
       Konversikan EMLX ke EML sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
