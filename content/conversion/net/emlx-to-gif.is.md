...
breadcrumb: EMLX til GIF í C#

############################# Head ############################
head_title: "EMLX til GIF Breytir í C#"
head_description: "Umbreyttu EMLX í GIF í .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Conversion API til að umbreyta yfir 160 skráarsniðum."

############################# Header ############################
title: "Umbreyttu EMLX í GIF í C#"
description: "EMLX til GIF viðskipti með nokkrum línum af .NET kóða"
...
overview:
    enable: true
    content: |
        Breyttu EMLX skránum þínum í GIF í .NET auðveldlega. Þú getur notað aðeins nokkrar C# kóðalínur á hvaða vettvang sem þú vilt eins og - Windows, Linux, macOS.
        Þú getur prófað EMLX til GIF viðskipti ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingum geturðu prófað fullkomnari valkosti til að hlaða uppruna EMLX skrá og til að vista úttak GIF niðurstöðu. 
...
steps:
    enable: true
    title_left: "Skref til að breyta EMLX í GIF í C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) auðveldar forriturum að breyta EMLX skrá í GIF með nokkrum línum af kóða.
...
demos:
    enable: true
    title: "EMLX til GIF Sýning í beinni"
    content: |
       Umbreyttu EMLX í GIF núna með því að fara á [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) vefsíðuna. Demo á netinu hefur eftirfarandi kosti
