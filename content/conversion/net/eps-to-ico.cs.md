...
breadcrumb: EPS do ICO v C#

############################# Head ############################
head_title: "Převodník EPS na ICO v C#"
head_description: "Převeďte EPS na ICO v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést EPS na ICO v C#"
description: "Převod EPS na ICO s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory EPS na ICO ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi EPS na ICO a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového EPS souboru a pro uložení výstupního ICO výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu EPS na ICO v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru EPS na ICO pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte EPS na ICO nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
