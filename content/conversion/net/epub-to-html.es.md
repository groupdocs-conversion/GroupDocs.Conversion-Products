...
############################# Head #############################
head_title: "API de conversión de EPUB a HTML para .NET - convertir en C# VB.NET"
head_description: "API de conversión de archivos .NET para convertir EPUB a HTML en cualquier tipo de aplicaciones C#, ASP.NET, VB.NET y .NET Core."

############################# Header ############################
title: "Convertidor de archivos EPUB a HTML para aplicaciones C# .NET" 
description: "API de conversión de documentos .NET para transformación sin problemas de EPUB a HTML dentro de aplicaciones C#, ASP.NET, VB.NET y .NET Core. Asegure la formateo preciso y la preservación del diseño durante el proceso de conversión, todo mientras minimiza los esfuerzos de codificación." 
...
steps:
    enable: true
    title: "Pasos para convertir archivo EPUB a HTML en C#" 
    content: |
      Con <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> puede transformar EPUB a HTML en unos pocos pasos.
    ...
    code:
      ...
      content: |
        ...
        FluentConverter
            ...
            .Convert();                     // Convertir archivo EPUB a HTML        
        ```            
