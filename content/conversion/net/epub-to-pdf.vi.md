...
############################# Head #############################
head_title: "API Chuyển đổi EPUB thành PDF cho .NET - chuyển đổi trong C# VB.NET"
head_description: "API chuyển đổi tệp .NET để chuyển đổi EPUB thành PDF trong bất kỳ loại ứng dụng C#, ASP.NET, VB.NET & .NET Core nào."

############################# Header ############################
title: "Chuyển đổi tệp EPUB thành PDF cho ứng dụng C# .NET" 
description: "API chuyển đổi tài liệu .NET cho phép chuyển đổi tệp EPUB thành PDF một cách mượt mà trong ứng dụng C#, ASP.NET, VB.NET & .NET Core. Đảm bảo định dạng chính xác và bảo toàn bố cục trong quá trình chuyển đổi, tất cả đều giảm thiểu công việc lập trình." 
...
steps:
    enable: true
    title: "Các bước để chuyển đổi tệp EPUB thành tệp PDF trong C#" 
    content: |
      Với <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> bạn có thể chuyển đổi EPUB thành PDF trong vài bước đơn giản.
      ...
      3. Tải tệp EPUB với đường dẫn đầy đủ. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.epub")             // Thiết lập tệp EPUB đầu vào
            .ConvertTo("converted.pdf")     // Chỉ định đường dẫn đầu ra cho tệp đã chuyển đổi
            .Convert();                     // Chuyển đổi tệp EPUB thành tệp PDF        
        ```            
