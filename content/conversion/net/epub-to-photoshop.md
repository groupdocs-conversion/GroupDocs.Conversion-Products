...
breadcrumb: EPUB to PHOTOSHOP in C#

############################# Head ############################
head_title: "EPUB to PHOTOSHOP Converter in C#"
head_description: "Convert EPUB to PHOTOSHOP in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert EPUB to PHOTOSHOP in C#"
description: "EPUB to PHOTOSHOP conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your EPUB files to PHOTOSHOP in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert EPUB to PHOTOSHOP in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a EPUB file to PHOTOSHOP with a few lines of code.
