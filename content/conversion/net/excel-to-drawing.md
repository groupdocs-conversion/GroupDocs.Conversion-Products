...
############################# Head ############################
head_title: "EXCEL to DRAWING Converter – Convert EXCEL to DRAWING in C# .NET"
head_description: "How to convert EXCEL to DRAWING in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert EXCEL to DRAWING in C#"
description: "Native and high performance EXCEL to DRAWING conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert EXCEL to DRAWING in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the EXCEL file to DRAWING using a few lines of code.

        *   Create an instance of Converter class and load the EXCEL file with full path
        *   Create & set ConvertOptions for the drawing type
        *   Call Converter.Convert method and pass the full path and format (DRAWING) as parameter
    ...
    code: |
        ...
        // set the convert options for DRAWING format
...
demos:
    enable: true
    title: "EXCEL to DRAWING Live Demos"
    content: |
        Convert EXCEL to DRAWING right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-DRAWING"
          title: " About DRAWING File Format"
          content: |
