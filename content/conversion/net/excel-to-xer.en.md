...
breadcrumb: EXCEL to XER in C#

############################# Head ############################
head_title: "EXCEL to XER Converter in C#"
head_description: "Convert EXCEL to XER in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert EXCEL to XER in C#"
description: "EXCEL to XER conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your EXCEL files to XER in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert EXCEL to XER in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a EXCEL file to XER with a few lines of code.
