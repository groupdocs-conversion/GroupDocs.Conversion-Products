...
head_title: "Konverter FODP ke ICO – Konversi FODP ke ICO di C# .NET"
head_description: "Bagaimana cara mengonversi FODP ke ICO di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi FODP ke ICO di C#"
description: "Konversi FODP ke ICO asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi FODP ke ICO di C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) memudahkan pengembang untuk mengonversi file FODP ke ICO menggunakan beberapa baris kode.
