...
breadcrumb: FODS do FODS w C#

############################# Head ############################
head_title: "Konwerter FODS na FODS w C#"
head_description: "Konwertuj FODS na FODS w .NET, używając kilku linijek kodu. Użyj interfejsu API konwersji dokumentów GroupDocs, aby przekonwertować ponad 160 formatów plików."

############################# Header ############################
title: "Konwertuj FODS na FODS w C#"
description: "Konwersja FODS do FODS z kilkoma linijkami kodu .NET"
...
overview:
    enable: true
    content: |
        Łatwo przekonwertuj swoje pliki FODS na FODS w .NET. Możesz użyć tylko kilku linii kodu C# na dowolnej wybranej platformie, takiej jak Windows, Linux, macOS.
        Możesz wypróbować konwersję FODS do FODS za darmo i ocenić jakość wyników konwersji. Oprócz prostych scenariuszy konwersji plików możesz wypróbować bardziej zaawansowane opcje ładowania źródłowego pliku {{Z}} i zapisywania wyjściowego wyniku FODS. 
        ...
        * dodaj znak wodny do przekonwertowanego pliku FODS i wielu innych.
...
steps:
    enable: true
    title_left: "Kroki konwersji FODS na FODS w C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) ułatwia programistom konwersję pliku FODS na FODS za pomocą kilku linijek kodu.
        
        * Utwórz instancję klasy Converter i podaj plik FODS z pełną ścieżką
        * Utwórz i ustaw opcje konwersji dla typu FODS.
        * Wywołaj metodę Converter.Convert i przekaż pełną ścieżkę i format (FODS) jako parametr
...
demos:
    enable: true
    title: "FODS do FODS demonstracji na żywo"
    content: |
       Konwertuj FODS na FODS teraz, odwiedzając witrynę [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online ma następujące zalety
