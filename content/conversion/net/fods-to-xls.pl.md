...
breadcrumb: FODS do XLS w C#

############################# Head ############################
head_title: "Konwerter FODS na XLS w C#"
head_description: "Konwertuj FODS na XLS w .NET, używając kilku linijek kodu. Użyj interfejsu API konwersji dokumentów GroupDocs, aby przekonwertować ponad 160 formatów plików."

############################# Header ############################
title: "Konwertuj FODS na XLS w C#"
description: "Konwersja FODS do XLS z kilkoma linijkami kodu .NET"
...
overview:
    enable: true
    content: |
        Łatwo przekonwertuj swoje pliki FODS na XLS w .NET. Możesz użyć tylko kilku linii kodu C# na dowolnej wybranej platformie, takiej jak Windows, Linux, macOS.
        Możesz wypróbować konwersję FODS do XLS za darmo i ocenić jakość wyników konwersji. Oprócz prostych scenariuszy konwersji plików możesz wypróbować bardziej zaawansowane opcje ładowania źródłowego pliku {{Z}} i zapisywania wyjściowego wyniku XLS. 
        ...
        * dodaj znak wodny do przekonwertowanego pliku XLS i wielu innych.
...
steps:
    enable: true
    title_left: "Kroki konwersji FODS na XLS w C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) ułatwia programistom konwersję pliku FODS na XLS za pomocą kilku linijek kodu.
        
        * Utwórz instancję klasy Converter i podaj plik FODS z pełną ścieżką
        * Utwórz i ustaw opcje konwersji dla typu XLS.
        * Wywołaj metodę Converter.Convert i przekaż pełną ścieżkę i format (XLS) jako parametr
...
demos:
    enable: true
    title: "FODS do XLS demonstracji na żywo"
    content: |
       Konwertuj FODS na XLS teraz, odwiedzając witrynę [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online ma następujące zalety
