...
############################# Head ############################
head_title: "Převodník FODS na XLSX v C#"
head_description: "Převeďte FODS na XLSX v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést FODS na XLSX v C#"
description: "Převod FODS na XLSX s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory FODS na XLSX ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi FODS na XLSX a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového FODS souboru a pro uložení výstupního XLSX výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu FODS na XLSX v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru FODS na XLSX pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte FODS na XLSX nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
