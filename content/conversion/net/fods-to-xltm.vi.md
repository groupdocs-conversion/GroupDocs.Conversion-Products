...
breadcrumb: FODS đến XLTM trong C#

############################# Head ############################
head_title: "Chuyển đổi FODS sang XLTM trong C#"
head_description: "Chuyển đổi FODS thành XLTM trong .NET bằng cách sử dụng một vài dòng mã. Sử dụng API chuyển đổi tài liệu GroupDocs để chuyển đổi hơn 160 định dạng tệp."

############################# Header ############################
title: "Chuyển đổi FODS thành XLTM trong C#"
description: "Chuyển đổi FODS thành XLTM với một vài dòng mã .NET"
...
overview:
    enable: true
    content: |
        Chuyển đổi các tệp FODS của bạn thành XLTM trong .NET một cách dễ dàng. Bạn chỉ có thể sử dụng một vài dòng mã C# trong bất kỳ nền tảng nào bạn chọn như - Windows, Linux, macOS.
        Bạn có thể thử chuyển đổi FODS thành XLTM miễn phí và đánh giá chất lượng kết quả chuyển đổi. Cùng với các tình huống chuyển đổi tệp đơn giản, bạn có thể thử các tùy chọn nâng cao hơn để tải tệp FODS nguồn và để lưu kết quả đầu ra XLTM. 
...
steps:
    enable: true
    title_left: "Các bước chuyển đổi FODS thành XLTM trong C#"
    content_left: |
...
demos:
    enable: true
    title: "Bản trình diễn trực tiếp từ FODS đến XLTM"
    content: |
