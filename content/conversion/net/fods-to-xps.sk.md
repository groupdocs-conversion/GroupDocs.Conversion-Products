...
breadcrumb: FODS do XPS v C#

############################# Head ############################
head_title: "Konvertor FODS na XPS v C#"
head_description: "Preveďte FODS na XPS v .NET pomocou niekoľkých riadkov kódu. Použite rozhranie GroupDocs Document Conversion API na konverziu viac ako 160 formátov súborov."

############################# Header ############################
title: "Konvertovať FODS na XPS v C#"
description: "Konverzia FODS na XPS pomocou niekoľkých riadkov kódu .NET"
...
overview:
    enable: true
    content: |
        Jednoducho skonvertujte svoje súbory FODS na XPS v .NET. Môžete použiť iba pár C# kódových riadkov na ľubovoľnej platforme podľa vášho výberu, napríklad - Windows, Linux, macOS.
        Môžete si bezplatne vyskúšať konverziu FODS na XPS a vyhodnotiť kvalitu výsledkov konverzie. Spolu s jednoduchými scenármi konverzie súborov môžete vyskúšať pokročilejšie možnosti načítania zdrojového FODS súboru a uloženia výstupného XPS výsledku. 
        ...
        * pridať vodoznak do konvertovaného súboru XPS a mnoho ďalších.
        ...
        Po dokončení konverzie môžete súbor XPS uložiť do lokálnej cesty k súboru alebo do akéhokoľvek úložiska tretej strany, ako je FTP, Amazon S3, Disk Google, Dropbox atď. Upozorňujeme, že chcete konvertovať FODS na {{ TO}} nie je potrebné inštalovať žiadny ďalší softvér – ako MS Office, Open Office, Adobe Acrobat Reader atď.


############################# Steps ############################
steps:
    enable: true
    title_left: "Kroky na konverziu FODS na XPS v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) uľahčuje vývojárom konverziu súboru FODS na XPS pomocou niekoľkých riadkov kódu.
...
demos:
    enable: true
    title: "Živá ukážka od FODS do XPS"
    content: |
       Preveďte FODS na XPS teraz na webovej lokalite [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má nasledujúce výhody
