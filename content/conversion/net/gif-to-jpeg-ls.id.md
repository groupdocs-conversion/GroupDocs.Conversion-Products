...
head_title: "Konverter GIF ke JPEG-LS – Konversi GIF ke JPEG-LS di C# .NET"
head_description: "Bagaimana cara mengonversi GIF ke JPEG-LS di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi GIF ke JPEG-LS di C#"
description: "Konversi GIF ke JPEG-LS asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi GIF ke JPEG-LS di C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) memudahkan pengembang untuk mengonversi file GIF ke JPEG-LS menggunakan beberapa baris kode.

        * Buat instance kelas Converter dan muat file GIF dengan path lengkap
        * Buat & atur ConvertOptions untuk tipe JPEG-LS
        * Panggil metode Converter.Convert dan berikan path lengkap dan format (JPEG-LS) sebagai parameter
    ...
    code: |
        ...
        // atur opsi konversi untuk format JPEG-LS
        var convertOptions = converter.GetPossibleConversions()["jpeg-ls"].ConvertOptions;
        // konversi ke format JPEG-LS
        converter.Convert("output.jpeg-ls", convertOptions);
        ```
        
demos:
    enable: true
    title: "Demo Langsung GIF hingga JPEG-LS"
    content: |
        Konversikan GIF ke JPEG-LS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
...
about_formats:
    ...
    format:
        - icon: "far fa-file-JPEG-LS"
          title: " Tentang Format File JPEG-LS"
          content: |
