...
############################# Head ############################
head_title: "GIF to POTM Converter – Convert GIF to POTM in C# .NET"
head_description: "How to convert GIF to POTM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert GIF to POTM in C#"
description: "Native and high performance GIF to POTM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the GIF file to POTM using a few lines of code.
