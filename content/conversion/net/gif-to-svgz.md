...
############################# Head ############################
head_title: "GIF to SVGZ Converter – Convert GIF to SVGZ in C# .NET"
head_description: "How to convert GIF to SVGZ in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert GIF to SVGZ in C#"
description: "Native and high performance GIF to SVGZ conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the GIF file to SVGZ using a few lines of code.
...
demos:
    enable: true
    title: "GIF to SVGZ Live Demos"
    content: |
        Convert GIF to SVGZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
