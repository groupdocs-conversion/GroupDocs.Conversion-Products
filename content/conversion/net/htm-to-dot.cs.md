...
breadcrumb: HTM do DOT v C#

############################# Head ############################
head_title: "Převodník HTM na DOT v C#"
head_description: "Převeďte HTM na DOT v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést HTM na DOT v C#"
description: "Převod HTM na DOT s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory HTM na DOT ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi HTM na DOT a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového HTM souboru a pro uložení výstupního DOT výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu HTM na DOT v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru HTM na DOT pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od HTM do DOT"
    content: |
       Převeďte HTM na DOT nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
