...
breadcrumb: HTM to EMLX in C#

############################# Head ############################
head_title: "HTM to EMLX Converter in C#"
head_description: "Convert HTM to EMLX in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert HTM to EMLX in C#"
description: "HTM to EMLX conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your HTM files to EMLX in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert HTM to EMLX in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a HTM file to EMLX with a few lines of code.
