...
breadcrumb: HTM do PNG v C#

############################# Head ############################
head_title: "Převodník HTM na PNG v C#"
head_description: "Převeďte HTM na PNG v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést HTM na PNG v C#"
description: "Převod HTM na PNG s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory HTM na PNG ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi HTM na PNG a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového HTM souboru a pro uložení výstupního PNG výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu HTM na PNG v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru HTM na PNG pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od HTM do PNG"
    content: |
       Převeďte HTM na PNG nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
