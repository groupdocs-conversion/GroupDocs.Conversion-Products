...
breadcrumb: HTML đến DOTM trong C#

############################# Head ############################
head_title: "Chuyển đổi HTML sang DOTM trong C#"
head_description: "Chuyển đổi HTML thành DOTM trong .NET bằng cách sử dụng một vài dòng mã. Sử dụng API chuyển đổi tài liệu GroupDocs để chuyển đổi hơn 160 định dạng tệp."

############################# Header ############################
title: "Chuyển đổi HTML thành DOTM trong C#"
description: "Chuyển đổi HTML thành DOTM với một vài dòng mã .NET"
...
overview:
    enable: true
    content: |
        Chuyển đổi các tệp HTML của bạn thành DOTM trong .NET một cách dễ dàng. Bạn chỉ có thể sử dụng một vài dòng mã C# trong bất kỳ nền tảng nào bạn chọn như - Windows, Linux, macOS.
        Bạn có thể thử chuyển đổi HTML thành DOTM miễn phí và đánh giá chất lượng kết quả chuyển đổi. Cùng với các tình huống chuyển đổi tệp đơn giản, bạn có thể thử các tùy chọn nâng cao hơn để tải tệp HTML nguồn và để lưu kết quả đầu ra DOTM. 
...
steps:
    enable: true
    title_left: "Các bước chuyển đổi HTML thành DOTM trong C#"
    content_left: |
...
demos:
    enable: true
    title: "Bản trình diễn trực tiếp từ HTML đến DOTM"
    content: |
