...
breadcrumb: HTML ke RTF di C#

############################# Head ############################
head_title: "Konverter HTML ke RTF di C#"
head_description: "Konversikan HTML ke RTF di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi HTML ke RTF di C#"
description: "Konversi HTML ke RTF dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file HTML Anda ke RTF di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi HTML ke RTF secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber HTML dan untuk menyimpan hasil RTF keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi HTML ke RTF di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file HTML ke RTF dengan beberapa baris kode.
...
demos:
    ...
    content: |
       Konversikan HTML ke RTF sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
