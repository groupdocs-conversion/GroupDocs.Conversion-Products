...
############################# Head #############################
head_title: "ICO zu DICOM Konverter API für .NET - konvertieren in C# VB.NET"
head_description: ".NET Dateikonverter-API zum Konvertieren von ICO zu DICOM in jeder Art von C#, ASP.NET, VB.NET & .NET Core Anwendungen."

############################# Header ############################
title: "ICO zu DICOM Dateikonverter für C# .NET Anwendungen" 
description: ".NET Dokumentenkonvertierungs-API für nahtlose Transformation von ICO in DICOM Format innerhalb von C#, ASP.NET, VB.NET & .NET Core Anwendungen. Gewährleisten Sie präzise Formatierung und Layouterhalt während des Konvertierungsprozesses und minimieren Sie gleichzeitig den Codieraufwand." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von ICO in DICOM Datei in C#" 
    content: |
      Mit <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> können Sie ICO in DICOM in wenigen Schritten umwandeln.
      ...
      3. Laden Sie die ICO Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.ico")             // Richten Sie die Eingabedatei ICO ein
            .ConvertTo("converted.dicom")     // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .Convert();                     // ICO in DICOM Datei konvertieren        
        ```            
