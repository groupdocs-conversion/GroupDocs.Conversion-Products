...
breadcrumb: IFC na HTML in C#

############################# Head ############################
head_title: "IFC na HTML-omskakelaar in C#"
head_description: "Skakel IFC om na HTML in .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Conversion API om meer as 160 lêerformate om te skakel."

############################# Header ############################
title: "Skakel IFC om na HTML in C#"
description: "IFC na HTML omskakeling met 'n paar reëls van .NET-kode"
...
overview:
    enable: true
    content: |
        Skakel jou IFC lêers maklik om na HTML in .NET. Jy kan net 'n paar C# kodelyne gebruik in enige platform van jou keuse soos - Windows, Linux, macOS.
        Jy kan die omskakeling van IFC na HTML gratis probeer en die kwaliteit van omskakelingsresultate evalueer. Saam met eenvoudige lêeromskakelingscenario's kan jy meer gevorderde opsies probeer om die bron-IFC-lêer te laai en die uitset-HTML-resultaat te stoor. 
...
steps:
    enable: true
    title_left: "Stappe om IFC na HTML om te skakel in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) maak dit maklik vir ontwikkelaars om 'n IFC lêer om te skakel na HTML met 'n paar reëls kode.
...
demos:
    enable: true
    title: "IFC na HTML Regstreekse Demo"
    content: |
       Skakel IFC nou na HTML deur die [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) webwerf te besoek. Aanlyn demo het die volgende voordele
