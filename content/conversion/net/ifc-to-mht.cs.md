...
############################# Head ############################
head_title: "Převodník IFC na MHT v C#"
head_description: "Převeďte IFC na MHT v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést IFC na MHT v C#"
description: "Převod IFC na MHT s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory IFC na MHT ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi IFC na MHT a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového IFC souboru a pro uložení výstupního MHT výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu IFC na MHT v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru IFC na MHT pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte IFC na MHT nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
