...
############################# Head ############################
head_title: "IFC to XLS Converter – Convert IFC to XLS in C# .NET"
head_description: "How to convert IFC to XLS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IFC to XLS in C#"
description: "Native and high performance IFC to XLS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IFC file to XLS using a few lines of code.
...
demos:
    enable: true
    title: "IFC to XLS Live Demos"
    content: |
        Convert IFC to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
