...
draft: false
otherformats: 
breadcrumb: IGC to SXC in C#

############################# Head ############################
head_title: "IGC to SXC Converter in C#"
head_description: "Convert IGC to SXC in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert IGC to SXC in C#"
description: "IGC to SXC conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your IGC files to SXC in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert IGC to SXC in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a IGC file to SXC with a few lines of code.
