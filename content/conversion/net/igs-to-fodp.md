...
overview:
    ...
    content: |
        ...
        You can try IGS to FODP conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source IGS file and for saving output FODP result. 
        ...
        * add a watermark to the converted FODP file.
        ...
        Please note - to convert IGS to FODP there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a IGS file to FODP with a few lines of code.
