...
breadcrumb: C# 中的 IGS 到 PPS

############################# Head ############################
head_title: "C# 中的 IGS 到 PPS 转换器"
head_description: "使用几行代码将 .NET 中的 IGS 转换为 PPS。使用 GroupDocs 文档转换 API 转换 160 多种文件格式。"

############################# Header ############################
title: "在 C# 中将 IGS 转换为 PPS"
description: "使用几行 .NET 代码将 IGS 转换为 PPS"
...
overview:
    enable: true
    content: |
        轻松将您的 IGS 文件转换为 .NET 中的 PPS。您可以在您选择的任何平台（如 Windows、Linux、macOS）中仅使用几行 C# 代码行。
...
steps:
    enable: true
    title_left: "在 C# 中将 IGS 转换为 PPS 的步骤"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) 使开发人员只需几行代码即可轻松地将 IGS 文件转换为 PPS。
