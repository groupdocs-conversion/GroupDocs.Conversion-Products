...
############################# Head ############################
head_title: "IGS to WEBP Converter – Convert IGS to WEBP in C# .NET"
head_description: "How to convert IGS to WEBP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IGS to WEBP in C#"
description: "Native and high performance IGS to WEBP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IGS file to WEBP using a few lines of code.
...
demos:
    enable: true
    title: "IGS to WEBP Live Demos"
    content: |
        Convert IGS to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
