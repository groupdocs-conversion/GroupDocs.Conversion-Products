...
############################# Head ############################
head_title: "IMAGE to EBOOK Converter — конвертируйте IMAGE в EBOOK на C# .NET"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) позволяет разработчикам легко преобразовать файл IMAGE в EBOOK с помощью нескольких строк кода.
