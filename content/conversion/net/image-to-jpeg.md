...
############################# Head ############################
head_title: "IMAGE to JPEG Converter – Convert IMAGE to JPEG in C# .NET"
head_description: "How to convert IMAGE to JPEG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IMAGE to JPEG in C#"
description: "Native and high performance IMAGE to JPEG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert IMAGE to JPEG in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IMAGE file to JPEG using a few lines of code.
