...
############################# Head ############################
head_title: "IMAGE to PHOTOSHOP Converter — конвертируйте IMAGE в PHOTOSHOP на C# .NET"
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) упрощает для разработчиков преобразование файла IMAGE в PHOTOSHOP с помощью нескольких строк кода.
