...
############################# Head ############################
head_title: "J2C to ODT Converter – Convert J2C to ODT in C# .NET"
head_description: "How to convert J2C to ODT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert J2C to ODT in C#"
description: "Native and high performance J2C to ODT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert J2C to ODT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the J2C file to ODT using a few lines of code.
