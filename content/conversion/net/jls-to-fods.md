...
############################# Head ############################
head_title: "JLS to FODS Converter – Convert JLS to FODS in C# .NET"
head_description: "How to convert JLS to FODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JLS to FODS in C#"
description: "Native and high performance JLS to FODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JLS file to FODS using a few lines of code.
