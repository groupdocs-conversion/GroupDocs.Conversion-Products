...
breadcrumb: JLS to IGS in C#

############################# Head ############################
head_title: "JLS to IGS Converter in C#"
head_description: "Convert JLS to IGS in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert JLS to IGS in C#"
description: "JLS to IGS conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your JLS files to IGS in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert JLS to IGS in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a JLS file to IGS with a few lines of code.
