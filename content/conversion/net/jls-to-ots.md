...
breadcrumb: JLS to OTS in C#

############################# Head ############################
head_title: "JLS to OTS Converter in C#"
head_description: "Convert JLS to OTS in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert JLS to OTS in C#"
description: "JLS to OTS conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your JLS files to OTS in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert JLS to OTS in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a JLS file to OTS with a few lines of code.
