...
breadcrumb: JP2 go PSD in C#

############################# Head ############################
head_title: "JP2 go PSD Tiontaire in C#"
head_description: "Tiontaigh JP2 go PSD in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh JP2 go PSD in C#"
description: "JP2 go PSD tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid JP2 go PSD in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as JP2 go PSD tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse JP2 comhad a luchtú agus chun aschur PSD a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun JP2 a thiontú go PSD in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad JP2 a thiontú go PSD le cúpla líne de chód.
...
demos:
    ...
    content: |
       Tiontaigh JP2 go PSD anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
