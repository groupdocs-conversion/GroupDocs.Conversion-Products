...
breadcrumb: JPC to J2K in C#

############################# Head ############################
head_title: "JPC to J2K Converter in C#"
head_description: "Convert JPC to J2K in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert JPC to J2K in C#"
description: "JPC to J2K conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your JPC files to J2K in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert JPC to J2K in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a JPC file to J2K with a few lines of code.
