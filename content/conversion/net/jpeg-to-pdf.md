...
############################# Head ############################
head_title: "JPEG to PDF Converter – Convert JPEG to PDF in C# .NET"
head_description: "How to convert JPEG to PDF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPEG to PDF in C#"
description: "Native and high performance JPEG to PDF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPEG file to PDF using a few lines of code.
...
demos:
    enable: true
    title: "JPEG to PDF Live Demos"
    content: |
        Convert JPEG to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
