...
############################# Head ############################
head_title: "JPEG to XLS Converter – Convert JPEG to XLS in C# .NET"
head_description: "How to convert JPEG to XLS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPEG to XLS in C#"
description: "Native and high performance JPEG to XLS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert JPEG to XLS in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPEG file to XLS using a few lines of code.
