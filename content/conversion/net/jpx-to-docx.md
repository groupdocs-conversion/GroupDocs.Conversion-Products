...
############################# Head ############################
head_title: "JPX to DOCX Converter – Convert JPX to DOCX in C# .NET"
head_description: "How to convert JPX to DOCX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPX to DOCX in C#"
description: "Native and high performance JPX to DOCX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPX file to DOCX using a few lines of code.
