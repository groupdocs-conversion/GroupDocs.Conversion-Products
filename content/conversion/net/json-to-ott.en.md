...
############################# Head #############################
head_title: "JSON to OTT Converter API for .NET - convert in C# VB.NET"
head_description: ".NET file converter API to convert JSON to OTT in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "JSON to OTT file converter for C# .NET applications" 
description: ".NET document conversion API for seamless transformation JSON to OTT format within C#, ASP.NET, VB.NET & .NET Core applications. Ensure precision formatting and layout preservation during the conversion process, all while minimizing coding efforts." 
...
steps:
    enable: true
    title: "Steps to convert JSON to OTT file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> you can transform JSON to OTT in a few steps.
    ...
    code:
      ...
      content: |
        ...
        FluentConverter
            ...
            .ConvertTo("converted.ott")     // Specify output path for converted file
            .Convert();                     // Convert JSON to OTT file        
        ```            
