...
breadcrumb: LOG to EMAIL in C#

############################# Head ############################
head_title: "LOG to EMAIL Converter in C#"
head_description: "Convert LOG to EMAIL in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert LOG to EMAIL in C#"
description: "LOG to EMAIL conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your LOG files to EMAIL in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert LOG to EMAIL in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a LOG file to EMAIL with a few lines of code.
