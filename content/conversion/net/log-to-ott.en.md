...
breadcrumb: LOG to OTT in C#

############################# Head ############################
head_title: "LOG to OTT Converter in C#"
head_description: "Convert LOG to OTT in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert LOG to OTT in C#"
description: "LOG to OTT conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your LOG files to OTT in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert LOG to OTT in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a LOG file to OTT with a few lines of code.
