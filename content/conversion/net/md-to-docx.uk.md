...
head_description: "Перетворіть MD на DOCX у .NET за допомогою кількох рядків коду. Використовуйте API перетворення документів GroupDocs, щоб конвертувати понад 160 форматів файлів."

############################# Header ############################
title: "Перетворіть MD на DOCX у C#"
description: "Перетворення MD у DOCX за допомогою кількох рядків коду .NET"
...
overview:
    enable: true
    content: |
        Легко конвертуйте файли MD у DOCX на .NET. Ви можете використовувати всього пару рядків коду C# на будь-якій платформі за вашим вибором, такі як Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Кроки для перетворення MD на DOCX у C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) дозволяє розробникам легко конвертувати файл MD у DOCX за допомогою кількох рядків коду.
