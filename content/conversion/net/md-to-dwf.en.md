...
breadcrumb: MD to DWF in C#

############################# Head ############################
head_title: "MD to DWF Converter in C#"
head_description: "Convert MD to DWF in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert MD to DWF in C#"
description: "MD to DWF conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your MD files to DWF in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert MD to DWF in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a MD file to DWF with a few lines of code.
