...
############################# Head ############################
head_title: "MD to XLAM Converter – Convert MD to XLAM in C# .NET"
head_description: "How to convert MD to XLAM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MD to XLAM in C#"
description: "Native and high performance MD to XLAM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MD file to XLAM using a few lines of code.
