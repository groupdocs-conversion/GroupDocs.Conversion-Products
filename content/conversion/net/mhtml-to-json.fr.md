...
############################# Head #############################
head_title: "API de convertisseur de MHTML en JSON pour .NET - convertir en C# VB.NET"
head_description: "API de convertisseur de fichiers .NET pour convertir MHTML en JSON dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "Convertisseur de fichiers MHTML en JSON pour applications C# .NET" 
description: "API de conversion de documents .NET pour une transformation sans faille de MHTML en JSON dans des applications C#, ASP.NET, VB.NET et .NET Core. Assurez-vous d'un formatage précis et d'une préservation de la mise en page lors du processus de conversion, tout en minimisant les efforts de codage." 
...
steps:
    enable: true
    title: "Étapes pour convertir le fichier MHTML en JSON dans C#" 
    content: |
      Avec <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a>, vous pouvez transformer MHTML en JSON en quelques étapes simples.
      ...
      3. Chargez le fichier MHTML avec le chemin complet. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.mhtml")             // Configurer le fichier MHTML d'entrée
            .ConvertTo("converted.json")     // Spécifier le chemin de sortie pour le fichier converti
            .Convert();                     // Convertir le fichier MHTML en JSON        
        ```            
