...
############################# Head ############################
head_title: "MOBI to FODP Converter – Convert MOBI to FODP in C# .NET"
head_description: "How to convert MOBI to FODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MOBI to FODP in C#"
description: "Native and high performance MOBI to FODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MOBI file to FODP using a few lines of code.
...
demos:
    enable: true
    title: "MOBI to FODP Live Demos"
    content: |
        Convert MOBI to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
