...
overview:
    ...
    content: |
        ...
        You can try MOBI to JPEG conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source MOBI file and for saving output JPEG result. 
        ...
        * add a watermark to the converted JPEG file.
        ...
        Please note - to convert MOBI to JPEG there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a MOBI file to JPEG with a few lines of code.
