...
breadcrumb: MOBI ke MD dalam C#

############################# Head ############################
head_title: "MOBI to MD Converter dalam C#"
head_description: "Tukar MOBI kepada MD dalam .NET menggunakan beberapa baris kod. Gunakan API Penukaran Dokumen GroupDocs untuk menukar lebih daripada 160 format fail."

############################# Header ############################
title: "Tukar MOBI kepada MD dalam C#"
description: "MOBI kepada MD penukaran dengan beberapa baris kod .NET."
...
overview:
    enable: true
    content: |
        Tukar fail MOBI anda kepada MD dalam .NET dengan mudah. Anda boleh menggunakan hanya beberapa baris kod C# dalam mana-mana platform pilihan anda seperti - Windows, Linux, macOS.
        Anda boleh mencuba MOBI kepada MD penukaran secara percuma dan menilai kualiti hasil penukaran. Bersama-sama dengan senario penukaran fail yang mudah, anda boleh mencuba pilihan yang lebih lanjutan untuk memuatkan sumber MOBI fail dan untuk menyimpan output MD hasil. 
        ...
        * tambahkan tera air pada fail MD yang ditukar dan banyak lagi.
        ...
        Setelah penukaran selesai, anda boleh menyimpan fail MD anda ke laluan fail setempat atau mana-mana storan pihak ketiga seperti FTP, Amazon S3, Google Drive, Dropbox dll. Sila ambil perhatian - untuk menukar MOBI kepada {{ TO}} tidak memerlukan sebarang perisian tambahan yang dipasang - seperti MS Office, Open Office, Adobe Acrobat Reader dsb.


############################# Steps ############################
steps:
    enable: true
    title_left: "Langkah-langkah untuk menukar MOBI kepada MD dalam C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pembangun menukar fail MOBI kepada MD dengan beberapa baris kod.
...
demos:
    ...
    content: |
       Tukar MOBI kepada MD sekarang dengan melawati tapak web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo dalam talian mempunyai kelebihan berikut
