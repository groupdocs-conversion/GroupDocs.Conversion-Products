...
############################# Head ############################
head_title: "MOBI to OTT Converter – Convert MOBI to OTT in C# .NET"
head_description: "How to convert MOBI to OTT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MOBI to OTT in C#"
description: "Native and high performance MOBI to OTT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MOBI file to OTT using a few lines of code.
...
demos:
    enable: true
    title: "MOBI to OTT Live Demos"
    content: |
        Convert MOBI to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
