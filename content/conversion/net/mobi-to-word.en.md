...
breadcrumb: MOBI to WORD in C#

############################# Head ############################
head_title: "MOBI to WORD Converter in C#"
head_description: "Convert MOBI to WORD in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert MOBI to WORD in C#"
description: "MOBI to WORD conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your MOBI files to WORD in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert MOBI to WORD in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a MOBI file to WORD with a few lines of code.
