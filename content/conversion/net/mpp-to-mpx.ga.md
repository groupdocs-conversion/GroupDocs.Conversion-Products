...
breadcrumb: MPP go MPX in C#

############################# Head ############################
head_title: "MPP go MPX Tiontaire in C#"
head_description: "Tiontaigh MPP go MPX in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh MPP go MPX in C#"
description: "MPP go MPX tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid MPP go MPX in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as MPP go MPX tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse MPP comhad a luchtú agus chun aschur MPX a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun MPP a thiontú go MPX in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad MPP a thiontú go MPX le cúpla líne de chód.
...
demos:
    enable: true
    title: "MPP go MPX Taispeántas Beo"
    content: |
       Tiontaigh MPP go MPX anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
