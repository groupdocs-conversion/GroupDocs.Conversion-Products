...
head_title: "Konverter MPP ke OTS – Konversi MPP ke OTS di C# .NET"
head_description: "Bagaimana cara mengonversi MPP ke OTS di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi MPP ke OTS di C#"
description: "Konversi MPP ke OTS asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi MPP ke OTS di C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) memudahkan pengembang untuk mengonversi file MPP ke OTS menggunakan beberapa baris kode.

        * Buat instance kelas Converter dan muat file MPP dengan path lengkap
        * Buat & atur ConvertOptions untuk tipe OTS
        * Panggil metode Converter.Convert dan berikan path lengkap dan format (OTS) sebagai parameter
    ...
    code: |
        ...
        // atur opsi konversi untuk format OTS
        var convertOptions = converter.GetPossibleConversions()["ots"].ConvertOptions;
        // konversi ke format OTS
        converter.Convert("output.ots", convertOptions);
        ```
        
demos:
    enable: true
    title: "Demo Langsung MPP hingga OTS"
    content: |
        Konversikan MPP ke OTS sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
