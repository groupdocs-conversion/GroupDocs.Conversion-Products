...
############################# Head ############################
head_title: "Převodník MPP na PNG v C#"
head_description: "Převeďte MPP na PNG v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést MPP na PNG v C#"
description: "Převod MPP na PNG s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory MPP na PNG ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi MPP na PNG a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového MPP souboru a pro uložení výstupního PNG výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu MPP na PNG v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru MPP na PNG pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte MPP na PNG nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
