...
############################# Head ############################
head_title: "MPP to PPTX Converter – Convert MPP to PPTX in C# .NET"
head_description: "How to convert MPP to PPTX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MPP to PPTX in C#"
description: "Native and high performance MPP to PPTX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MPP file to PPTX using a few lines of code.
