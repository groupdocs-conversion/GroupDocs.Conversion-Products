...
breadcrumb: MPP to SVG in C#

############################# Head ############################
head_title: "MPP to SVG Converter in C#"
head_description: "Convert MPP to SVG in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert MPP to SVG in C#"
description: "MPP to SVG conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your MPP files to SVG in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a MPP file to SVG with a few lines of code.
