...
breadcrumb: MPP go SVG in C#

############################# Head ############################
head_title: "MPP go SVG Tiontaire in C#"
head_description: "Tiontaigh MPP go SVG in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh MPP go SVG in C#"
description: "MPP go SVG tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid MPP go SVG in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as MPP go SVG tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse MPP comhad a luchtú agus chun aschur SVG a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun MPP a thiontú go SVG in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad MPP a thiontú go SVG le cúpla líne de chód.
...
demos:
    ...
    content: |
       Tiontaigh MPP go SVG anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
