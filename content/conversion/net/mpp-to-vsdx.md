...
breadcrumb: MPP to VSDX in C#

############################# Head ############################
head_title: "MPP to VSDX Converter in C#"
head_description: "Convert MPP to VSDX in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert MPP to VSDX in C#"
description: "MPP to VSDX conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your MPP files to VSDX in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert MPP to VSDX in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a MPP file to VSDX with a few lines of code.
