...
breadcrumb: MPT to DRAWING in C#

############################# Head ############################
head_title: "MPT to DRAWING Converter in C#"
head_description: "Convert MPT to DRAWING in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert MPT to DRAWING in C#"
description: "MPT to DRAWING conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your MPT files to DRAWING in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert MPT to DRAWING in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a MPT file to DRAWING with a few lines of code.
