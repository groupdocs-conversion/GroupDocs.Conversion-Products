...
breadcrumb: MPT til GIF í C#

############################# Head ############################
head_title: "MPT til GIF Breytir í C#"
head_description: "Umbreyttu MPT í GIF í .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Conversion API til að umbreyta yfir 160 skráarsniðum."

############################# Header ############################
title: "Umbreyttu MPT í GIF í C#"
description: "MPT til GIF viðskipti með nokkrum línum af .NET kóða"
...
overview:
    enable: true
    content: |
        Breyttu MPT skránum þínum í GIF í .NET auðveldlega. Þú getur notað aðeins nokkrar C# kóðalínur á hvaða vettvang sem þú vilt eins og - Windows, Linux, macOS.
        Þú getur prófað MPT til GIF viðskipti ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingum geturðu prófað fullkomnari valkosti til að hlaða uppruna MPT skrá og til að vista úttak GIF niðurstöðu. 
...
steps:
    enable: true
    title_left: "Skref til að breyta MPT í GIF í C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) auðveldar forriturum að breyta MPT skrá í GIF með nokkrum línum af kóða.
...
demos:
    enable: true
    title: "MPT til GIF Sýning í beinni"
    content: |
       Umbreyttu MPT í GIF núna með því að fara á [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) vefsíðuna. Demo á netinu hefur eftirfarandi kosti
