...
head_description: "Перетворіть MPT на PSB у .NET за допомогою кількох рядків коду. Використовуйте API перетворення документів GroupDocs, щоб конвертувати понад 160 форматів файлів."

############################# Header ############################
title: "Перетворіть MPT на PSB у C#"
description: "Перетворення MPT у PSB за допомогою кількох рядків коду .NET"
...
overview:
    enable: true
    content: |
        Легко конвертуйте файли MPT у PSB на .NET. Ви можете використовувати всього пару рядків коду C# на будь-якій платформі за вашим вибором, такі як Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Кроки для перетворення MPT на PSB у C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) дозволяє розробникам легко конвертувати файл MPT у PSB за допомогою кількох рядків коду.
