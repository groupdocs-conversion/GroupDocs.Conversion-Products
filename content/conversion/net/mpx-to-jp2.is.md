...
breadcrumb: MPX til JP2 í C#

############################# Head ############################
head_title: "MPX til JP2 Breytir í C#"
head_description: "Umbreyttu MPX í JP2 í .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Conversion API til að umbreyta yfir 160 skráarsniðum."

############################# Header ############################
title: "Umbreyttu MPX í JP2 í C#"
description: "MPX til JP2 viðskipti með nokkrum línum af .NET kóða"
...
overview:
    enable: true
    content: |
        Breyttu MPX skránum þínum í JP2 í .NET auðveldlega. Þú getur notað aðeins nokkrar C# kóðalínur á hvaða vettvang sem þú vilt eins og - Windows, Linux, macOS.
        Þú getur prófað MPX til JP2 viðskipti ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingum geturðu prófað fullkomnari valkosti til að hlaða uppruna MPX skrá og til að vista úttak JP2 niðurstöðu. 
...
steps:
    enable: true
    title_left: "Skref til að breyta MPX í JP2 í C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) auðveldar forriturum að breyta MPX skrá í JP2 með nokkrum línum af kóða.
...
demos:
    ...
    content: |
       Umbreyttu MPX í JP2 núna með því að fara á [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) vefsíðuna. Demo á netinu hefur eftirfarandi kosti
