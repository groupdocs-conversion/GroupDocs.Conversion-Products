...
############################# Head ############################
head_title: "Převodník MPX na JPG v C#"
head_description: "Převeďte MPX na JPG v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést MPX na JPG v C#"
description: "Převod MPX na JPG s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory MPX na JPG ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi MPX na JPG a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového MPX souboru a pro uložení výstupního JPG výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu MPX na JPG v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru MPX na JPG pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od MPX do JPG"
    content: |
       Převeďte MPX na JPG nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
