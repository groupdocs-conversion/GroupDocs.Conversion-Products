...
############################# Head #############################
head_title: "MPX to PDF Converter API for .NET - convert in C# VB.NET"
head_description: ".NET file converter API to convert MPX to PDF in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "MPX to PDF file converter for C# .NET applications" 
description: ".NET document conversion API for seamless transformation MPX to PDF format within C#, ASP.NET, VB.NET & .NET Core applications. Ensure precision formatting and layout preservation during the conversion process, all while minimizing coding efforts." 
...
steps:
    enable: true
    title: "Steps to convert MPX to PDF file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> you can transform MPX to PDF in a few steps.
      ...
      3. Load the MPX file with full path. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.mpx")               // Set up input MPX file
            .ConvertTo("converted.pdf")     // Specify output path for converted file
            .Convert();                     // Convert MPX to PDF file        
        ```            
