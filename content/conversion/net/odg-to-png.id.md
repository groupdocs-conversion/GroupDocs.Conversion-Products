...
breadcrumb: ODG ke PNG di C#

############################# Head ############################
head_title: "Konverter ODG ke PNG di C#"
head_description: "Konversikan ODG ke PNG di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi ODG ke PNG di C#"
description: "Konversi ODG ke PNG dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file ODG Anda ke PNG di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi ODG ke PNG secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber ODG dan untuk menyimpan hasil PNG keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi ODG ke PNG di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file ODG ke PNG dengan beberapa baris kode.
...
demos:
    enable: true
    title: "ODG ke PNG Demo Langsung"
    content: |
       Konversikan ODG ke PNG sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
