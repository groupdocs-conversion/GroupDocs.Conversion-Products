...
breadcrumb: ODG to TGA in C#

############################# Head ############################
head_title: "ODG to TGA Converter in C#"
head_description: "Convert ODG to TGA in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert ODG to TGA in C#"
description: "ODG to TGA conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your ODG files to TGA in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
        You can try ODG to TGA conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source ODG file and for saving output TGA result. 
        ...
        * add a watermark to the converted TGA file.
        ...
        Please note - to convert ODG to TGA there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 


############################# Steps ############################
steps:
    enable: true
    title_left: "Steps to convert ODG to TGA in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a ODG file to TGA with a few lines of code.
