...
############################# Head ############################
head_title: "Převodník ODS na CSV v C#"
head_description: "Převeďte ODS na CSV v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést ODS na CSV v C#"
description: "Převod ODS na CSV s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory ODS na CSV ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi ODS na CSV a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového ODS souboru a pro uložení výstupního CSV výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu ODS na CSV v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru ODS na CSV pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte ODS na CSV nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
