...
head_description: "Перетворіть ODS на PDF у .NET за допомогою кількох рядків коду. Використовуйте API перетворення документів GroupDocs, щоб конвертувати понад 160 форматів файлів."

############################# Header ############################
title: "Перетворіть ODS на PDF у C#"
description: "Перетворення ODS у PDF за допомогою кількох рядків коду .NET"
...
overview:
    enable: true
    content: |
        Легко конвертуйте файли ODS у PDF на .NET. Ви можете використовувати всього пару рядків коду C# на будь-якій платформі за вашим вибором, такі як Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Кроки для перетворення ODS на PDF у C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) дозволяє розробникам легко конвертувати файл ODS у PDF за допомогою кількох рядків коду.
