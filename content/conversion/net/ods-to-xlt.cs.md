...
breadcrumb: ODS do XLT v C#

############################# Head ############################
head_title: "Převodník ODS na XLT v C#"
head_description: "Převeďte ODS na XLT v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést ODS na XLT v C#"
description: "Převod ODS na XLT s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory ODS na XLT ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi ODS na XLT a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového ODS souboru a pro uložení výstupního XLT výsledku. 
        ...
        * nahradit chybějící písma pro zachování vzhledu dokumentu.
        ...
        Existují také pokročilé možnosti převodu pro soubor XLT:

        * převést konkrétní stránku dokumentu nebo rozsah stránek;
        * přidat vodoznak do převedeného souboru XLT a mnoho dalších.

        Po dokončení převodu můžete svůj soubor XLT uložit do místní cesty k souboru nebo do jakéhokoli úložiště třetí strany, jako je FTP, Amazon S3, Disk Google, Dropbox atd. Vezměte prosím na vědomí – převést ODS na {{ TO}} není potřeba instalovat žádný další software – jako MS Office, Open Office, Adobe Acrobat Reader atd.


############################# Steps ############################
steps:
    enable: true
    title_left: "Kroky k převodu ODS na XLT v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru ODS na XLT pomocí několika řádků kódu.
        
        * Vytvořte instanci třídy Converter a poskytněte souboru ODS úplnou cestu
        * Vytvořte a nastavte ConvertOptions pro typ XLT.
        * Zavolejte metodu Converter.Convert a předejte úplnou cestu a formát (XLT) jako parametr
    ...
    code: |
        ...
        // Načtěte zdrojový soubor ODS pro převod
          ...
          // Připravte možnosti konverze pro cílový formát XLT
          var convertOptions = converter.GetPossibleConversions()["xlt"].ConvertOptions;
          // Převést do formátu XLT
          converter.Convert("output.xlt", convertOptions);
        ```

demos:
    enable: true
    title: "Živá ukázka od ODS do XLT"
    content: |
       Převeďte ODS na XLT nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
