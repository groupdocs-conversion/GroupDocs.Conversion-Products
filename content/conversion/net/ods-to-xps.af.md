...
breadcrumb: ODS na XPS in C#

############################# Head ############################
head_title: "ODS na XPS-omskakelaar in C#"
head_description: "Skakel ODS om na XPS in .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Conversion API om meer as 160 lêerformate om te skakel."

############################# Header ############################
title: "Skakel ODS om na XPS in C#"
description: "ODS na XPS omskakeling met 'n paar reëls van .NET-kode"
...
overview:
    enable: true
    content: |
        Skakel jou ODS lêers maklik om na XPS in .NET. Jy kan net 'n paar C# kodelyne gebruik in enige platform van jou keuse soos - Windows, Linux, macOS.
        Jy kan die omskakeling van ODS na XPS gratis probeer en die kwaliteit van omskakelingsresultate evalueer. Saam met eenvoudige lêeromskakelingscenario's kan jy meer gevorderde opsies probeer om die bron-ODS-lêer te laai en die uitset-XPS-resultaat te stoor. 
...
steps:
    enable: true
    title_left: "Stappe om ODS na XPS om te skakel in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) maak dit maklik vir ontwikkelaars om 'n ODS lêer om te skakel na XPS met 'n paar reëls kode.
...
demos:
    enable: true
    title: "ODS na XPS Regstreekse Demo"
    content: |
       Skakel ODS nou na XPS deur die [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) webwerf te besoek. Aanlyn demo het die volgende voordele
