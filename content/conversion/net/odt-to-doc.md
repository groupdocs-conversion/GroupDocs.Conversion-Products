...
############################# Head ############################
head_title: "ODT to DOC Converter – Convert ODT to DOC in C# .NET"
head_description: "How to convert ODT to DOC in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert ODT to DOC in C#"
description: "Native and high performance ODT to DOC conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the ODT file to DOC using a few lines of code.
