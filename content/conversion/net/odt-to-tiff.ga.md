...
breadcrumb: ODT go TIFF in C#

############################# Head ############################
head_title: "ODT go TIFF Tiontaire in C#"
head_description: "Tiontaigh ODT go TIFF in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh ODT go TIFF in C#"
description: "ODT go TIFF tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid ODT go TIFF in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as ODT go TIFF tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse ODT comhad a luchtú agus chun aschur TIFF a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun ODT a thiontú go TIFF in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad ODT a thiontú go TIFF le cúpla líne de chód.
...
demos:
    enable: true
    title: "ODT go TIFF Taispeántas Beo"
    content: |
       Tiontaigh ODT go TIFF anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
