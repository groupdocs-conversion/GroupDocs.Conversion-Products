...
############################# Head ############################
head_title: "Převodník ONE na TGA v C#"
head_description: "Převeďte ONE na TGA v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést ONE na TGA v C#"
description: "Převod ONE na TGA s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory ONE na TGA ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi ONE na TGA a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového ONE souboru a pro uložení výstupního TGA výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu ONE na TGA v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru ONE na TGA pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od ONE do TGA"
    content: |
       Převeďte ONE na TGA nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
