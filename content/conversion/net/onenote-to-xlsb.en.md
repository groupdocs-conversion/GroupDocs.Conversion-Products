...
draft: false
otherformats: 
breadcrumb: ONENOTE to XLSB in C#

############################# Head ############################
head_title: "ONENOTE to XLSB Converter in C#"
head_description: "Convert ONENOTE to XLSB in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert ONENOTE to XLSB in C#"
description: "ONENOTE to XLSB conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your ONENOTE files to XLSB in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert ONENOTE to XLSB in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a ONENOTE file to XLSB with a few lines of code.
