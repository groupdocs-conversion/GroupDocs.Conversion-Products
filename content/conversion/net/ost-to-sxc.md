...
############################# Head ############################
head_title: "OST to SXC Converter – Convert OST to SXC in C# .NET"
head_description: "How to convert OST to SXC in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OST to SXC in C#"
description: "Native and high performance OST to SXC conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OST file to SXC using a few lines of code.
...
demos:
    enable: true
    title: "OST to SXC Live Demos"
    content: |
        Convert OST to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
