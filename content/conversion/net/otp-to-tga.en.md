...
breadcrumb: OTP to TGA in C#

############################# Head ############################
head_title: "OTP to TGA Converter in C#"
head_description: "Convert OTP to TGA in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert OTP to TGA in C#"
description: "OTP to TGA conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your OTP files to TGA in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert OTP to TGA in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a OTP file to TGA with a few lines of code.
