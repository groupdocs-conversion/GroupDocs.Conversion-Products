...
breadcrumb: OTP nach XPS in C#

############################# Head ############################
head_title: "OTP nach XPS Konverter in C#"
head_description: "Wandeln Sie OTP in .NET mit ein paar Zeilen Code in XPS um. Verwenden Sie die GroupDocs Document Conversion API, um über 160 Dateiformate zu konvertieren."

############################# Header ############################
title: "Konvertiere OTP in XPS in C#"
description: "Umwandlung von OTP in XPS mit ein paar Zeilen .NET-Code"
...
overview:
    enable: true
    content: |
        Konvertieren Sie Ihre OTP-Dateien einfach in XPS in .NET. Sie können nur ein paar C#-Codezeilen auf jeder Plattform Ihrer Wahl verwenden, z. B. Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Schritte zum Konvertieren von OTP in XPS in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) erleichtert Entwicklern das Konvertieren einer OTP-Datei in XPS mit wenigen Codezeilen.
