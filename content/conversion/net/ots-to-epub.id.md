...
breadcrumb: OTS ke EPUB di C#

############################# Head ############################
head_title: "Konverter OTS ke EPUB di C#"
head_description: "Konversikan OTS ke EPUB di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi OTS ke EPUB di C#"
description: "Konversi OTS ke EPUB dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file OTS Anda ke EPUB di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi OTS ke EPUB secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber OTS dan untuk menyimpan hasil EPUB keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi OTS ke EPUB di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file OTS ke EPUB dengan beberapa baris kode.
...
demos:
    ...
    content: |
       Konversikan OTS ke EPUB sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
