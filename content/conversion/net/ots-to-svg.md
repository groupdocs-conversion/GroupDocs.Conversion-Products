...
############################# Head ############################
head_title: "OTS to SVG Converter – Convert OTS to SVG in C# .NET"
head_description: "How to convert OTS to SVG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OTS to SVG in C#"
description: "Native and high performance OTS to SVG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert OTS to SVG in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OTS file to SVG using a few lines of code.
...
demos:
    enable: true
    title: "OTS to SVG Live Demos"
    content: |
        Convert OTS to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
