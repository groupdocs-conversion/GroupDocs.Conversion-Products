...
breadcrumb: OTS à XLSM en C#

############################# Head ############################
head_title: "Convertisseur OTS à XLSM en C#"
head_description: "Convertissez OTS en XLSM dans .NET en utilisant quelques lignes de code. Utilisez l'API de conversion de documents GroupDocs pour convertir plus de 160 formats de fichiers."

############################# Header ############################
title: "Convertir OTS en XLSM en C#"
description: "Conversion OTS à XLSM avec quelques lignes de code .NET"
...
overview:
    enable: true
    content: |
        Convertissez facilement vos fichiers OTS en XLSM dans .NET. Vous pouvez utiliser seulement quelques lignes de code C# dans n'importe quelle plate-forme de votre choix comme - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Étapes pour convertir OTS en XLSM en C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) permet aux développeurs de convertir facilement un fichier OTS en XLSM avec quelques lignes de code.
