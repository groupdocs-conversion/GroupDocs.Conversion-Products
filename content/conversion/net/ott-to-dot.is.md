...
breadcrumb: OTT til DOT í C#

############################# Head ############################
head_title: "OTT til DOT Breytir í C#"
head_description: "Umbreyttu OTT í DOT í .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Conversion API til að umbreyta yfir 160 skráarsniðum."

############################# Header ############################
title: "Umbreyttu OTT í DOT í C#"
description: "OTT til DOT viðskipti með nokkrum línum af .NET kóða"
...
overview:
    enable: true
    content: |
        Breyttu OTT skránum þínum í DOT í .NET auðveldlega. Þú getur notað aðeins nokkrar C# kóðalínur á hvaða vettvang sem þú vilt eins og - Windows, Linux, macOS.
        Þú getur prófað OTT til DOT viðskipti ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingum geturðu prófað fullkomnari valkosti til að hlaða uppruna OTT skrá og til að vista úttak DOT niðurstöðu. 
        ...
        * bættu vatnsmerki við breyttu DOT skrána og margt fleira.
        ...
        Þegar umbreytingu er lokið geturðu vistað DOT skrána þína á staðbundinni skráarslóð eða hvaða geymslu sem er þriðja aðila eins og FTP, Amazon S3, Google Drive, Dropbox osfrv. Athugaðu - til að breyta OTT í {{ TO}} það er engin þörf fyrir neinn viðbótarhugbúnað uppsettan - eins og MS Office, Open Office, Adobe Acrobat Reader o.s.frv.


############################# Steps ############################
steps:
    enable: true
    title_left: "Skref til að breyta OTT í DOT í C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) auðveldar forriturum að breyta OTT skrá í DOT með nokkrum línum af kóða.
...
demos:
    enable: true
    title: "OTT til DOT Sýning í beinni"
    content: |
       Umbreyttu OTT í DOT núna með því að fara á [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) vefsíðuna. Demo á netinu hefur eftirfarandi kosti
