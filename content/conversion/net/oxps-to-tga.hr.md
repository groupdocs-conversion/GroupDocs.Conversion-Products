...
breadcrumb: OXPS do TGA u C#

############################# Head ############################
head_title: "OXPS u TGA pretvarač u C#"
head_description: "Pretvorite OXPS u TGA u .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Conversion API za pretvaranje preko 160 formata datoteka."

############################# Header ############################
title: "Pretvori OXPS u TGA u C#"
description: "Konverzija OXPS u TGA s nekoliko redaka .NET koda"
...
overview:
    enable: true
    content: |
        Jednostavno pretvorite svoje OXPS datoteke u TGA u .NET. Možete koristiti samo nekoliko C# linija koda na bilo kojoj platformi po vašem izboru kao što su - Windows, Linux, macOS.
        Možete besplatno isprobati konverziju OXPS u TGA i procijeniti kvalitetu rezultata konverzije. Uz jednostavne scenarije konverzije datoteka, možete isprobati naprednije opcije za učitavanje izvorne OXPS datoteke i za spremanje izlaznog TGA rezultata. 
...
steps:
    enable: true
    title_left: "Koraci za pretvaranje OXPS u TGA u C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) programerima olakšava pretvaranje OXPS datoteke u TGA s nekoliko redaka koda.
...
demos:
    ...
    content: |
       Pretvorite OXPS u TGA sada tako da posjetite [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) web mjesto. Online demo ima sljedeće prednosti
