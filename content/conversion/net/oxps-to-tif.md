...
############################# Head ############################
head_title: "OXPS to TIF Converter – Convert OXPS to TIF in C# .NET"
head_description: "How to convert OXPS to TIF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OXPS to TIF in C#"
description: "Native and high performance OXPS to TIF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OXPS file to TIF using a few lines of code.
