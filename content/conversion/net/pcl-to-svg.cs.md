...
############################# Head ############################
head_title: "Převodník PCL na SVG v C#"
head_description: "Převeďte PCL na SVG v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést PCL na SVG v C#"
description: "Převod PCL na SVG s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory PCL na SVG ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi PCL na SVG a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového PCL souboru a pro uložení výstupního SVG výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu PCL na SVG v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru PCL na SVG pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte PCL na SVG nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
