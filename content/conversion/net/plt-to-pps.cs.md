...
breadcrumb: PLT do PPS v C#

############################# Head ############################
head_title: "Převodník PLT na PPS v C#"
head_description: "Převeďte PLT na PPS v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést PLT na PPS v C#"
description: "Převod PLT na PPS s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory PLT na PPS ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi PLT na PPS a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového PLT souboru a pro uložení výstupního PPS výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu PLT na PPS v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru PLT na PPS pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od PLT do PPS"
    content: |
       Převeďte PLT na PPS nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
