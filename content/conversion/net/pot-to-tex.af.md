...
breadcrumb: POT na TEX in C#

############################# Head ############################
head_title: "POT na TEX-omskakelaar in C#"
head_description: "Skakel POT om na TEX in .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Conversion API om meer as 160 lêerformate om te skakel."

############################# Header ############################
title: "Skakel POT om na TEX in C#"
description: "POT na TEX omskakeling met 'n paar reëls van .NET-kode"
...
overview:
    enable: true
    content: |
        Skakel jou POT lêers maklik om na TEX in .NET. Jy kan net 'n paar C# kodelyne gebruik in enige platform van jou keuse soos - Windows, Linux, macOS.
        Jy kan die omskakeling van POT na TEX gratis probeer en die kwaliteit van omskakelingsresultate evalueer. Saam met eenvoudige lêeromskakelingscenario's kan jy meer gevorderde opsies probeer om die bron-POT-lêer te laai en die uitset-TEX-resultaat te stoor. 
...
steps:
    enable: true
    title_left: "Stappe om POT na TEX om te skakel in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) maak dit maklik vir ontwikkelaars om 'n POT lêer om te skakel na TEX met 'n paar reëls kode.
...
demos:
    ...
    content: |
       Skakel POT nou na TEX deur die [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) webwerf te besoek. Aanlyn demo het die volgende voordele
