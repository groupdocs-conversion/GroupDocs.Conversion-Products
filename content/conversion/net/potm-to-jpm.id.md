...
head_title: "Konverter POTM ke JPM – Konversi POTM ke JPM di C# .NET"
head_description: "Bagaimana cara mengonversi POTM ke JPM di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi POTM ke JPM di C#"
description: "Konversi POTM ke JPM asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi POTM ke JPM di C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) memudahkan pengembang untuk mengonversi file POTM ke JPM menggunakan beberapa baris kode.

        * Buat instance kelas Converter dan muat file POTM dengan path lengkap
        * Buat & atur ConvertOptions untuk tipe JPM
        * Panggil metode Converter.Convert dan berikan path lengkap dan format (JPM) sebagai parameter
    ...
    code: |
        ...
        // atur opsi konversi untuk format JPM
