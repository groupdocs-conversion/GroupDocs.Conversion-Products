...
draft: false
otherformats: 
breadcrumb: POWERPOINT to DCM in C#

############################# Head ############################
head_title: "POWERPOINT to DCM Converter in C#"
head_description: "Convert POWERPOINT to DCM in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert POWERPOINT to DCM in C#"
description: "POWERPOINT to DCM conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your POWERPOINT files to DCM in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert POWERPOINT to DCM in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a POWERPOINT file to DCM with a few lines of code.
