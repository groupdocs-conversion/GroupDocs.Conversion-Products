...
breadcrumb: PPS to GIF in C#

############################# Head ############################
head_title: "PPS to GIF Converter in C#"
head_description: "Convert PPS to GIF in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert PPS to GIF in C#"
description: "PPS to GIF conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your PPS files to GIF in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert PPS to GIF in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a PPS file to GIF with a few lines of code.
