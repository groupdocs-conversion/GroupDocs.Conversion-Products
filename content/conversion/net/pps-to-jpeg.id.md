...
breadcrumb: PPS ke JPEG di C#

############################# Head ############################
head_title: "Konverter PPS ke JPEG di C#"
head_description: "Konversikan PPS ke JPEG di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi PPS ke JPEG di C#"
description: "Konversi PPS ke JPEG dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file PPS Anda ke JPEG di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi PPS ke JPEG secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber PPS dan untuk menyimpan hasil JPEG keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi PPS ke JPEG di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file PPS ke JPEG dengan beberapa baris kode.
...
demos:
    ...
    content: |
       Konversikan PPS ke JPEG sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
