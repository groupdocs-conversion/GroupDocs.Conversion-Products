...
overview:
    ...
    content: |
        ...
        You can try PPS to TXT conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source PPS file and for saving output TXT result. 
        ...
        * add a watermark to the converted TXT file.
        ...
        Please note - to convert PPS to TXT there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a PPS file to TXT with a few lines of code.
