...
breadcrumb: C# 中的 PPSX 到 DOT

############################# Head ############################
head_title: "C# 中的 PPSX 到 DOT 转换器"
head_description: "使用几行代码将 .NET 中的 PPSX 转换为 DOT。使用 GroupDocs 文档转换 API 转换 160 多种文件格式。"

############################# Header ############################
title: "在 C# 中将 PPSX 转换为 DOT"
description: "使用几行 .NET 代码将 PPSX 转换为 DOT"
...
overview:
    enable: true
    content: |
        轻松将您的 PPSX 文件转换为 .NET 中的 DOT。您可以在您选择的任何平台（如 Windows、Linux、macOS）中仅使用几行 C# 代码行。
...
steps:
    enable: true
    title_left: "在 C# 中将 PPSX 转换为 DOT 的步骤"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) 使开发人员只需几行代码即可轻松地将 PPSX 文件转换为 DOT。
