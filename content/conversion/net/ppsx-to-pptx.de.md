...
############################# Head #############################
head_title: "PPSX zu PPTX Konverter API für .NET - konvertieren in C# VB.NET"
head_description: ".NET Dateikonverter-API zum Konvertieren von PPSX zu PPTX in jeder Art von C#, ASP.NET, VB.NET & .NET Core Anwendungen."

############################# Header ############################
title: "PPSX zu PPTX Dateikonverter für C# .NET Anwendungen" 
description: ".NET Dokumentenkonvertierungs-API für nahtlose Transformation von PPSX in PPTX Format innerhalb von C#, ASP.NET, VB.NET & .NET Core Anwendungen. Gewährleisten Sie präzise Formatierung und Layouterhalt während des Konvertierungsprozesses und minimieren Sie gleichzeitig den Codieraufwand." 
...
steps:
    enable: true
    title: "Schritte zur Konvertierung von PPSX in PPTX Datei in C#" 
    content: |
      Mit <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> können Sie PPSX in PPTX in wenigen Schritten umwandeln.
      ...
      3. Laden Sie die PPSX Datei mit vollständigem Pfad. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.ppsx")               // Richten Sie die Eingabedatei PPSX ein
            .ConvertTo("converted.pptx")     // Geben Sie den Ausgabepfad für die konvertierte Datei an
            .Convert();                     // PPSX in PPTX Datei konvertieren        
        ```            
