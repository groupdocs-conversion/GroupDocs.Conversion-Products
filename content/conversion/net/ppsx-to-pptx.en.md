...
############################# Head #############################
head_title: "PPSX to PPTX Converter API for .NET - convert in C# VB.NET"
head_description: ".NET file converter API to convert PPSX to PPTX in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "PPSX to PPTX file converter for C# .NET applications" 
description: ".NET document conversion API for seamless transformation PPSX to PPTX format within C#, ASP.NET, VB.NET & .NET Core applications. Ensure precision formatting and layout preservation during the conversion process, all while minimizing coding efforts." 
...
steps:
    enable: true
    title: "Steps to convert PPSX to PPTX file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> you can transform PPSX to PPTX in a few steps.
      ...
      3. Load the PPSX file with full path. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.ppsx")               // Set up input PPSX file
            .ConvertTo("converted.pptx")     // Specify output path for converted file
            .Convert();                     // Convert PPSX to PPTX file        
        ```            
