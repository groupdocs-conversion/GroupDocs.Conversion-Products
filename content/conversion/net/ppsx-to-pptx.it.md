...
############################# Head #############################
head_title: "API Convertitore PPSX in PPTX per .NET - converti in C# VB.NET"
head_description: "API convertitore file .NET per convertire PPSX in PPTX in qualsiasi tipo di applicazione C#, ASP.NET, VB.NET e .NET Core."

############################# Header ############################
title: "Convertitore file PPSX in PPTX per applicazioni C# .NET" 
description: "API di conversione documenti .NET per una trasformazione senza soluzione di continuità da PPSX a PPTX all'interno di applicazioni C#, ASP.NET, VB.NET e .NET Core. Assicura una formattazione precisa e la conservazione del layout durante il processo di conversione, riducendo al minimo gli sforzi di codifica." 
...
steps:
    enable: true
    title: "Passaggi per convertire il file PPSX in PPTX nel linguaggio C#" 
    content: |
      Con <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> puoi trasformare PPSX in PPTX in pochi semplici passaggi.
      ...
      3. Carica il file PPSX con il percorso completo. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.ppsx")               // Imposta il file PPSX di input
            .ConvertTo("converted.pptx")     // Specificare il percorso di output per il file convertito
            .Convert();                     // Converti il file PPSX in PPTX        
        ```            
