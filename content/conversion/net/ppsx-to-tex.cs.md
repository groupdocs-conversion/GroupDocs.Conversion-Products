...
############################# Head ############################
head_title: "Převodník PPSX na TEX v C#"
head_description: "Převeďte PPSX na TEX v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést PPSX na TEX v C#"
description: "Převod PPSX na TEX s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory PPSX na TEX ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi PPSX na TEX a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového PPSX souboru a pro uložení výstupního TEX výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu PPSX na TEX v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru PPSX na TEX pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte PPSX na TEX nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
