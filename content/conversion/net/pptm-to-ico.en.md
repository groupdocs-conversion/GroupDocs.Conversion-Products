...
breadcrumb: PPTM to ICO in C#

############################# Head ############################
head_title: "PPTM to ICO Converter in C#"
head_description: "Convert PPTM to ICO in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert PPTM to ICO in C#"
description: "PPTM to ICO conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your PPTM files to ICO in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert PPTM to ICO in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a PPTM file to ICO with a few lines of code.
