...
breadcrumb: PPTM à ODT en C#

############################# Head ############################
head_title: "Convertisseur PPTM à ODT en C#"
head_description: "Convertissez PPTM en ODT dans .NET en utilisant quelques lignes de code. Utilisez l'API de conversion de documents GroupDocs pour convertir plus de 160 formats de fichiers."

############################# Header ############################
title: "Convertir PPTM en ODT en C#"
description: "Conversion PPTM à ODT avec quelques lignes de code .NET"
...
overview:
    enable: true
    content: |
        Convertissez facilement vos fichiers PPTM en ODT dans .NET. Vous pouvez utiliser seulement quelques lignes de code C# dans n'importe quelle plate-forme de votre choix comme - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Étapes pour convertir PPTM en ODT en C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) permet aux développeurs de convertir facilement un fichier PPTM en ODT avec quelques lignes de code.
