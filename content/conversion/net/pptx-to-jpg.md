...
############################# Head ############################
head_title: "PPTX to JPG Converter – Convert PPTX to JPG in C# .NET"
head_description: "How to convert PPTX to JPG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert PPTX to JPG in C#"
description: "Native and high performance PPTX to JPG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the PPTX file to JPG using a few lines of code.
