...
overview:
    ...
    content: |
        ...
        You can try PPTX to PNG conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source PPTX file and for saving output PNG result. 
        ...
        * add a watermark to the converted PNG file.
        ...
        Please note - to convert PPTX to PNG there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a PPTX file to PNG with a few lines of code.
