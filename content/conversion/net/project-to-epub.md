...
draft: false
otherformats: 
breadcrumb: PROJECT to EPUB in C#

############################# Head ############################
head_title: "PROJECT to EPUB Converter in C#"
head_description: "Convert PROJECT to EPUB in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert PROJECT to EPUB in C#"
description: "PROJECT to EPUB conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your PROJECT files to EPUB in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert PROJECT to EPUB in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a PROJECT file to EPUB with a few lines of code.
