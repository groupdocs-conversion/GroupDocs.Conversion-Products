...
steps:
    enable: true
    title_left: "Kroki konwersji PS na WEBP w C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) ułatwia programistom konwersję pliku PS na WEBP za pomocą kilku linijek kodu.
