...
############################# Head ############################
head_title: "PS to XPS Converter – Convert PS to XPS in C# .NET"
head_description: "How to convert PS to XPS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert PS to XPS in C#"
description: "Native and high performance PS to XPS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the PS file to XPS using a few lines of code.
...
demos:
    enable: true
    title: "PS to XPS Live Demos"
    content: |
        Convert PS to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
