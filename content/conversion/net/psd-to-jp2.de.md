...
breadcrumb: PSD nach JP2 in C#

############################# Head ############################
head_title: "PSD nach JP2 Konverter in C#"
head_description: "Wandeln Sie PSD in .NET mit ein paar Zeilen Code in JP2 um. Verwenden Sie die GroupDocs Document Conversion API, um über 160 Dateiformate zu konvertieren."

############################# Header ############################
title: "Konvertiere PSD in JP2 in C#"
description: "Umwandlung von PSD in JP2 mit ein paar Zeilen .NET-Code"
...
overview:
    enable: true
    content: |
        Konvertieren Sie Ihre PSD-Dateien einfach in JP2 in .NET. Sie können nur ein paar C#-Codezeilen auf jeder Plattform Ihrer Wahl verwenden, z. B. Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Schritte zum Konvertieren von PSD in JP2 in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) erleichtert Entwicklern das Konvertieren einer PSD-Datei in JP2 mit wenigen Codezeilen.
