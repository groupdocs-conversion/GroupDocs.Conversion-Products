...
head_title: "Konverter PST ke PS – Konversi PST ke PS di C# .NET"
head_description: "Bagaimana cara mengonversi PST ke PS di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi PST ke PS di C#"
description: "Konversi PST ke PS asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi PST ke PS di C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) memudahkan pengembang untuk mengonversi file PST ke PS menggunakan beberapa baris kode.

        * Buat instance kelas Converter dan muat file PST dengan path lengkap
        * Buat & atur ConvertOptions untuk tipe PS
        * Panggil metode Converter.Convert dan berikan path lengkap dan format (PS) sebagai parameter
    ...
    code: |
        ...
        // atur opsi konversi untuk format PS
