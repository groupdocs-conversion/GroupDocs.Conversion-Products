...
breadcrumb: RTF à DOCM en C#

############################# Head ############################
head_title: "Convertisseur RTF à DOCM en C#"
head_description: "Convertissez RTF en DOCM dans .NET en utilisant quelques lignes de code. Utilisez l'API de conversion de documents GroupDocs pour convertir plus de 160 formats de fichiers."

############################# Header ############################
title: "Convertir RTF en DOCM en C#"
description: "Conversion RTF à DOCM avec quelques lignes de code .NET"
...
overview:
    enable: true
    content: |
        Convertissez facilement vos fichiers RTF en DOCM dans .NET. Vous pouvez utiliser seulement quelques lignes de code C# dans n'importe quelle plate-forme de votre choix comme - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Étapes pour convertir RTF en DOCM en C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) permet aux développeurs de convertir facilement un fichier RTF en DOCM avec quelques lignes de code.
