...
############################# Head ############################
head_title: "RTF to FODP Converter – Convert RTF to FODP in C# .NET"
head_description: "How to convert RTF to FODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert RTF to FODP in C#"
description: "Native and high performance RTF to FODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert RTF to FODP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the RTF file to FODP using a few lines of code.
...
demos:
    enable: true
    title: "RTF to FODP Live Demos"
    content: |
        Convert RTF to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
