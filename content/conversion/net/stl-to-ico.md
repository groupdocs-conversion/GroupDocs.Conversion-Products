...
############################# Head ############################
head_title: "STL to ICO Converter – Convert STL to ICO in C# .NET"
head_description: "How to convert STL to ICO in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert STL to ICO in C#"
description: "Native and high performance STL to ICO conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the STL file to ICO using a few lines of code.
...
demos:
    enable: true
    title: "STL to ICO Live Demos"
    content: |
        Convert STL to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
