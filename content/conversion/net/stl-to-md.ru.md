...
steps:
    enable: true
    title_left: "Шаги по конвертации STL в MD в C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/net/)  упрощает для разработчиков преобразование файла STL в MD с помощью нескольких строк кода.
