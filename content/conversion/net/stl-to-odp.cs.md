...
############################# Head ############################
head_title: "Převodník STL na ODP v C#"
head_description: "Převeďte STL na ODP v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést STL na ODP v C#"
description: "Převod STL na ODP s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory STL na ODP ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi STL na ODP a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového STL souboru a pro uložení výstupního ODP výsledku. 
        ...
        * přidat vodoznak do převedeného souboru ODP a mnoho dalších.

        Po dokončení převodu můžete svůj soubor ODP uložit do místní cesty k souboru nebo do jakéhokoli úložiště třetí strany, jako je FTP, Amazon S3, Disk Google, Dropbox atd. Vezměte prosím na vědomí – převést STL na {{ TO}} není potřeba instalovat žádný další software – jako MS Office, Open Office, Adobe Acrobat Reader atd.


############################# Steps ############################
steps:
    enable: true
    title_left: "Kroky k převodu STL na ODP v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru STL na ODP pomocí několika řádků kódu.
        
        * Vytvořte instanci třídy Converter a poskytněte souboru STL úplnou cestu
        * Vytvořte a nastavte ConvertOptions pro typ ODP.
        * Zavolejte metodu Converter.Convert a předejte úplnou cestu a formát (ODP) jako parametr
...
demos:
    enable: true
    title: "Živá ukázka od STL do ODP"
    content: |
       Převeďte STL na ODP nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
