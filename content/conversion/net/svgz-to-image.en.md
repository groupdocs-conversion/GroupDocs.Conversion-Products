...
breadcrumb: SVGZ to IMAGE in C#

############################# Head ############################
head_title: "SVGZ to IMAGE Converter in C#"
head_description: "Convert SVGZ to IMAGE in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert SVGZ to IMAGE in C#"
description: "SVGZ to IMAGE conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your SVGZ files to IMAGE in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert SVGZ to IMAGE in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a SVGZ file to IMAGE with a few lines of code.
