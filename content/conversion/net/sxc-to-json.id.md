...
breadcrumb: SXC ke JSON di C#

############################# Head ############################
head_title: "Konverter SXC ke JSON di C#"
head_description: "Konversikan SXC ke JSON di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi SXC ke JSON di C#"
description: "Konversi SXC ke JSON dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file SXC Anda ke JSON di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi SXC ke JSON secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber SXC dan untuk menyimpan hasil JSON keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi SXC ke JSON di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file SXC ke JSON dengan beberapa baris kode.
...
demos:
    ...
    content: |
       Konversikan SXC ke JSON sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
