...
breadcrumb: SXC в TXT на C#

############################# Head ############################
head_title: "Конвертер SXC в TXT на C#"
head_description: "Преобразовать SXC в TXT на .NET, используя несколько строк кода. Используйте API преобразования документов GroupDocs для преобразования более 160 форматов файлов."

############################# Header ############################
title: "Преобразовать SXC в TXT на C#"
description: "Конвертер SXC в TXT с помощью нескольких строк .NET кода"
...
overview:
    enable: true
    content: |
        Преобразуйте свои файлы SXC в файлы TXT в .NET. Для этого понадобится всего пара строк кода C# на любой платформе по вашему выбору, например — Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Шаги по конвертации SXC в TXT в C#"
    content_left: |
...
demos:
    ...
    content: |
       Конвертируйте SXC в TXT прямо сейчас, посетив веб-сайт [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Онлайн демонстрация имеет следующие преимущества
