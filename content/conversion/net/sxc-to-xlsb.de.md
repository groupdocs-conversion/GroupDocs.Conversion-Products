...
breadcrumb: SXC nach XLSB in C#

############################# Head ############################
head_title: "SXC nach XLSB Konverter in C#"
head_description: "Wandeln Sie SXC in .NET mit ein paar Zeilen Code in XLSB um. Verwenden Sie die GroupDocs Document Conversion API, um über 160 Dateiformate zu konvertieren."

############################# Header ############################
title: "Konvertiere SXC in XLSB in C#"
description: "Umwandlung von SXC in XLSB mit ein paar Zeilen .NET-Code"
...
overview:
    enable: true
    content: |
        Konvertieren Sie Ihre SXC-Dateien einfach in XLSB in .NET. Sie können nur ein paar C#-Codezeilen auf jeder Plattform Ihrer Wahl verwenden, z. B. Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Schritte zum Konvertieren von SXC in XLSB in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) erleichtert Entwicklern das Konvertieren einer SXC-Datei in XLSB mit wenigen Codezeilen.
