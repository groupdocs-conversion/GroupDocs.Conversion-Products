...
############################# Head ############################
head_title: "SXC to XLSB Converter – Convert SXC to XLSB in C# .NET"
head_description: "How to convert SXC to XLSB in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert SXC to XLSB in C#"
description: "Native and high performance SXC to XLSB conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the SXC file to XLSB using a few lines of code.
