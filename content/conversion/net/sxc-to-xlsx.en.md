...
############################# Head #############################
head_title: "SXC to XLSX Converter API for .NET - convert in C# VB.NET"
head_description: ".NET file converter API to convert SXC to XLSX in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "SXC to XLSX file converter for C# .NET applications" 
description: ".NET document conversion API for seamless transformation SXC to XLSX format within C#, ASP.NET, VB.NET & .NET Core applications. Ensure precision formatting and layout preservation during the conversion process, all while minimizing coding efforts." 
...
steps:
    enable: true
    title: "Steps to convert SXC to XLSX file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> you can transform SXC to XLSX in a few steps.
      ...
      3. Load the SXC file with full path. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.sxc")             // Set up input SXC file
            .ConvertTo("converted.xlsx")     // Specify output path for converted file
            .Convert();                     // Convert SXC to XLSX file        
        ```            
