...
breadcrumb: TEX to EBOOK in C#

############################# Head ############################
head_title: "TEX to EBOOK Converter in C#"
head_description: "Convert TEX to EBOOK in .NET using a few lines of code. Use the GroupDocs Document Conversion API to convert over 160 file formats."

############################# Header ############################
title: "Convert TEX to EBOOK in C#"
description: "TEX to EBOOK conversion with a few lines of .NET code"
...
overview:
    enable: true
    content: |
        Convert your TEX files to EBOOK in .NET easily. You can use just a couple of C# code lines in any platform of your choice like - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Steps to convert TEX to EBOOK in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a TEX file to EBOOK with a few lines of code.
