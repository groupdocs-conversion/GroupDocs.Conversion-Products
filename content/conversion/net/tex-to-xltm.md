...
############################# Head ############################
head_title: "TEX to XLTM Converter – Convert TEX to XLTM in C# .NET"
head_description: "How to convert TEX to XLTM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TEX to XLTM in C#"
description: "Native and high performance TEX to XLTM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert TEX to XLTM in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TEX file to XLTM using a few lines of code.
...
demos:
    enable: true
    title: "TEX to XLTM Live Demos"
    content: |
        Convert TEX to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
