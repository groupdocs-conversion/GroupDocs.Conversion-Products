...
############################# Head #############################
head_title: "API Convertitore TEXT in DOCX per .NET - converti in C# VB.NET"
head_description: "API convertitore file .NET per convertire TEXT in DOCX in qualsiasi tipo di applicazione C#, ASP.NET, VB.NET e .NET Core."

############################# Header ############################
title: "Convertitore file TEXT in DOCX per applicazioni C# .NET" 
description: "API di conversione documenti .NET per una trasformazione senza soluzione di continuità da TEXT a DOCX all'interno di applicazioni C#, ASP.NET, VB.NET e .NET Core. Assicura una formattazione precisa e la conservazione del layout durante il processo di conversione, riducendo al minimo gli sforzi di codifica." 
...
steps:
    enable: true
    title: "Passaggi per convertire il file TEXT in DOCX nel linguaggio C#" 
    content: |
      Con <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> puoi trasformare TEXT in DOCX in pochi semplici passaggi.
      ...
      3. Carica il file TEXT con il percorso completo. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.text")             // Imposta il file TEXT di input
            .ConvertTo("converted.docx")     // Specificare il percorso di output per il file convertito
            .Convert();                     // Converti il file TEXT in DOCX        
        ```            
