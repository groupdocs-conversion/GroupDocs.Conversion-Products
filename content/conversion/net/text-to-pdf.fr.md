...
############################# Head #############################
head_title: "API de convertisseur de TEXT en PDF pour .NET - convertir en C# VB.NET"
head_description: "API de convertisseur de fichiers .NET pour convertir TEXT en PDF dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "Convertisseur de fichiers TEXT en PDF pour applications C# .NET" 
description: "API de conversion de documents .NET pour une transformation sans faille de TEXT en PDF dans des applications C#, ASP.NET, VB.NET et .NET Core. Assurez-vous d'un formatage précis et d'une préservation de la mise en page lors du processus de conversion, tout en minimisant les efforts de codage." 
...
steps:
    enable: true
    title: "Étapes pour convertir le fichier TEXT en PDF dans C#" 
    content: |
      Avec <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a>, vous pouvez transformer TEXT en PDF en quelques étapes simples.
      ...
      3. Chargez le fichier TEXT avec le chemin complet. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.text")             // Configurer le fichier TEXT d'entrée
            .ConvertTo("converted.pdf")     // Spécifier le chemin de sortie pour le fichier converti
            .Convert();                     // Convertir le fichier TEXT en PDF        
        ```            
