...
############################# Head ############################
head_title: "TIF to EPUB Converter – Convert TIF to EPUB in C# .NET"
head_description: "How to convert TIF to EPUB in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TIF to EPUB in C#"
description: "Native and high performance TIF to EPUB conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TIF file to EPUB using a few lines of code.
