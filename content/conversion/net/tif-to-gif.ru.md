...
steps:
    enable: true
    title_left: "Шаги по конвертации TIF в GIF в C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/ru/conversion/net/)  упрощает для разработчиков преобразование файла TIF в GIF с помощью нескольких строк кода.
