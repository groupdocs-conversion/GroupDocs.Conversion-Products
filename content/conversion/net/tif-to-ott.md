...
############################# Head ############################
head_title: "TIF to OTT Converter – Convert TIF to OTT in C# .NET"
head_description: "How to convert TIF to OTT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TIF to OTT in C#"
description: "Native and high performance TIF to OTT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert TIF to OTT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TIF file to OTT using a few lines of code.
