...
############################# Head #############################
head_title: "TSV to XLSB Converter API for .NET - convert in C# VB.NET"
head_description: ".NET file converter API to convert TSV to XLSB in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "TSV to XLSB file converter for C# .NET applications" 
description: ".NET document conversion API for seamless transformation TSV to XLSB format within C#, ASP.NET, VB.NET & .NET Core applications. Ensure precision formatting and layout preservation during the conversion process, all while minimizing coding efforts." 
...
steps:
    enable: true
    title: "Steps to convert TSV to XLSB file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> you can transform TSV to XLSB in a few steps.
    ...
    code:
      ...
      content: |
        ...
        FluentConverter
            ...
            .ConvertTo("converted.xlsb")     // Specify output path for converted file
            .Convert();                     // Convert TSV to XLSB file        
        ```            
