...
############################# Head ############################
head_title: "TXT to PPT Converter – Convert TXT to PPT in C# .NET"
head_description: "How to convert TXT to PPT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TXT to PPT in C#"
description: "Native and high performance TXT to PPT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert TXT to PPT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TXT file to PPT using a few lines of code.
