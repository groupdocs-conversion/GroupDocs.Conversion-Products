...
breadcrumb: C# 中的 TXT 到 PSD

############################# Head ############################
head_title: "C# 中的 TXT 到 PSD 转换器"
head_description: "使用几行代码将 .NET 中的 TXT 转换为 PSD。使用 GroupDocs 文档转换 API 转换 160 多种文件格式。"

############################# Header ############################
title: "在 C# 中将 TXT 转换为 PSD"
description: "使用几行 .NET 代码将 TXT 转换为 PSD"
...
overview:
    enable: true
    content: |
        轻松将您的 TXT 文件转换为 .NET 中的 PSD。您可以在您选择的任何平台（如 Windows、Linux、macOS）中仅使用几行 C# 代码行。
...
steps:
    enable: true
    title_left: "在 C# 中将 TXT 转换为 PSD 的步骤"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) 使开发人员只需几行代码即可轻松地将 TXT 文件转换为 PSD。
