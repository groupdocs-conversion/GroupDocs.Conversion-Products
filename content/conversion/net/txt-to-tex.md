...
############################# Head ############################
head_title: "TXT to TEX Converter – Convert TXT to TEX in C# .NET"
head_description: "How to convert TXT to TEX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TXT to TEX in C#"
description: "Native and high performance TXT to TEX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TXT file to TEX using a few lines of code.
...
demos:
    enable: true
    title: "TXT to TEX Live Demos"
    content: |
        Convert TXT to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
