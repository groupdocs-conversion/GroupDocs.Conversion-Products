...
overview:
    ...
    content: |
        ...
        You can try VSD to DOT conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source VSD file and for saving output DOT result. 
        ...
        * add a watermark to the converted DOT file.
        ...
        Please note - to convert VSD to DOT there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a VSD file to DOT with a few lines of code.
