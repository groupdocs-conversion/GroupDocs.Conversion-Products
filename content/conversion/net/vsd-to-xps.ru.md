...
breadcrumb: VSD в XPS на C#

############################# Head ############################
head_title: "Конвертер VSD в XPS на C#"
head_description: "Преобразовать VSD в XPS на .NET, используя несколько строк кода. Используйте API преобразования документов GroupDocs для преобразования более 160 форматов файлов."

############################# Header ############################
title: "Преобразовать VSD в XPS на C#"
description: "Конвертер VSD в XPS с помощью нескольких строк .NET кода"
...
overview:
    enable: true
    content: |
        Преобразуйте свои файлы VSD в файлы XPS в .NET. Для этого понадобится всего пара строк кода C# на любой платформе по вашему выбору, например — Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Шаги по конвертации VSD в XPS в C#"
    content_left: |
...
demos:
    ...
    content: |
       Конвертируйте VSD в XPS прямо сейчас, посетив веб-сайт [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Онлайн демонстрация имеет следующие преимущества
