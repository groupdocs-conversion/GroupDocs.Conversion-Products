...
breadcrumb: VSDX go VSDX in C#

############################# Head ############################
head_title: "VSDX go VSDX Tiontaire in C#"
head_description: "Tiontaigh VSDX go VSDX in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh VSDX go VSDX in C#"
description: "VSDX go VSDX tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid VSDX go VSDX in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as VSDX go VSDX tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse VSDX comhad a luchtú agus chun aschur VSDX a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun VSDX a thiontú go VSDX in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad VSDX a thiontú go VSDX le cúpla líne de chód.
...
demos:
    enable: true
    title: "VSDX go VSDX Taispeántas Beo"
    content: |
       Tiontaigh VSDX go VSDX anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
