...
breadcrumb: VSDX go VSSX in C#

############################# Head ############################
head_title: "VSDX go VSSX Tiontaire in C#"
head_description: "Tiontaigh VSDX go VSSX in .NET ag úsáid cúpla líne de chód. Bain úsáid as API Tiontaithe Doiciméad GroupDocs chun níos mó ná 160 formáid comhaid a thiontú."

############################# Header ############################
title: "Tiontaigh VSDX go VSSX in C#"
description: "VSDX go VSSX tiontú le cúpla líne de chód .NET"
...
overview:
    enable: true
    content: |
        Tiontaigh do chomhaid VSDX go VSSX in .NET go héasca. Ní féidir ach cúpla cód C# a úsáid in aon ardán de do rogha féin ar nós - Windows, Linux, macOS.
        Is féidir leat triail a bhaint as VSDX go VSSX tiontú saor in aisce agus cáilíocht na dtorthaí tiontaithe a mheas. Mar aon le cásanna simplí maidir le comhshó comhad is féidir leat roghanna níos forbartha a thriail chun foinse VSDX comhad a luchtú agus chun aschur VSSX a shábháil. 
...
steps:
    enable: true
    title_left: "Céimeanna chun VSDX a thiontú go VSSX in C#"
    content_left: |
        Déanann [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) sé éasca d'fhorbróirí comhad VSDX a thiontú go VSSX le cúpla líne de chód.
...
demos:
    ...
    content: |
       Tiontaigh VSDX go VSSX anois trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Tá na buntáistí seo a leanas ag taispeántas ar líne
