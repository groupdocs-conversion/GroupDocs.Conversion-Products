...
overview:
    ...
    content: |
        ...
        You can try VSSM to OTT conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source VSSM file and for saving output OTT result. 
        ...
        * add a watermark to the converted OTT file.
        ...
        Please note - to convert VSSM to OTT there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a VSSM file to OTT with a few lines of code.
