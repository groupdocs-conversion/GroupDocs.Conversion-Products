...
############################# Head ############################
head_title: "Převodník VSSM na XPS v C#"
head_description: "Převeďte VSSM na XPS v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést VSSM na XPS v C#"
description: "Převod VSSM na XPS s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory VSSM na XPS ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi VSSM na XPS a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového VSSM souboru a pro uložení výstupního XPS výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu VSSM na XPS v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru VSSM na XPS pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od VSSM do XPS"
    content: |
       Převeďte VSSM na XPS nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
