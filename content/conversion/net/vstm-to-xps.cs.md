...
breadcrumb: VSTM do XPS v C#

############################# Head ############################
head_title: "Převodník VSTM na XPS v C#"
head_description: "Převeďte VSTM na XPS v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést VSTM na XPS v C#"
description: "Převod VSTM na XPS s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory VSTM na XPS ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi VSTM na XPS a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového VSTM souboru a pro uložení výstupního XPS výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu VSTM na XPS v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru VSTM na XPS pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od VSTM do XPS"
    content: |
       Převeďte VSTM na XPS nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
