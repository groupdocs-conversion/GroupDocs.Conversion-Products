...
breadcrumb: VSTX à DOCX en C#

############################# Head ############################
head_title: "Convertisseur VSTX à DOCX en C#"
head_description: "Convertissez VSTX en DOCX dans .NET en utilisant quelques lignes de code. Utilisez l'API de conversion de documents GroupDocs pour convertir plus de 160 formats de fichiers."

############################# Header ############################
title: "Convertir VSTX en DOCX en C#"
description: "Conversion VSTX à DOCX avec quelques lignes de code .NET"
...
overview:
    enable: true
    content: |
        Convertissez facilement vos fichiers VSTX en DOCX dans .NET. Vous pouvez utiliser seulement quelques lignes de code C# dans n'importe quelle plate-forme de votre choix comme - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Étapes pour convertir VSTX en DOCX en C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) permet aux développeurs de convertir facilement un fichier VSTX en DOCX avec quelques lignes de code.
