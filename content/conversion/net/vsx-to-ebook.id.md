...
############################# Head #############################
head_title: "API Konverter VSX ke EBOOK untuk .NET - konversi dalam C# VB.NET"
head_description: "API konverter file .NET untuk mengkonversi VSX ke EBOOK dalam berbagai jenis aplikasi C#, ASP.NET, VB.NET, dan .NET Core."

############################# Header ############################
title: "Konverter file VSX ke EBOOK untuk aplikasi C# .NET" 
description: "API konversi dokumen .NET untuk transformasi tanpa gangguan dari VSX ke EBOOK dalam aplikasi C#, ASP.NET, VB.NET, dan .NET Core. Pastikan format dan penataan presisi tetap terjaga selama proses konversi, semua itu sambil meminimalkan upaya pengkodean." 
...
steps:
    enable: true
    title: "Langkah-langkah untuk mengonversi file VSX ke EBOOK dalam C#" 
    content: |
      Dengan <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a>, Anda dapat mentransformasikan VSX ke EBOOK dalam beberapa langkah sederhana.
      ...
      3. Muat file VSX dengan jalur lengkap. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.vsx")             // Atur file VSX input
            .ConvertTo("converted.ebook")     // Tentukan jalur output untuk file yang dikonversi
            .Convert();                     // Konversi file VSX ke EBOOK        
        ```            
