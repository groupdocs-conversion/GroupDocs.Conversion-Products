...
overview:
    ...
    content: |
        ...
        You can try VSX to VSDM conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source VSX file and for saving output VSDM result. 
        ...
        * add a watermark to the converted VSDM file.
        ...
        Please note - to convert VSX to VSDM there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a VSX file to VSDM with a few lines of code.
