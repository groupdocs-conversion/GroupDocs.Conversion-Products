...
overview:
    ...
    content: |
        ...
        You can try VTX to VSSM conversion for free and evaluate conversion results quality.
        Along with simple file conversion scenarios you can try more advanced options for loading source VTX file and for saving output VSSM result. 
        ...
        * add a watermark to the converted VSSM file.
        ...
        Please note - to convert VTX to VSSM there is no need for any additional software installed - like MS Office, Open Office, Adobe Acrobat Reader etc. 
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net/) makes it easy for developers to convert a VTX file to VSSM with a few lines of code.
