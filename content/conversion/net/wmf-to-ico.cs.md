...
############################# Head ############################
head_title: "Převodník WMF na ICO v C#"
head_description: "Převeďte WMF na ICO v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést WMF na ICO v C#"
description: "Převod WMF na ICO s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory WMF na ICO ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi WMF na ICO a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového WMF souboru a pro uložení výstupního ICO výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu WMF na ICO v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru WMF na ICO pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od WMF do ICO"
    content: |
       Převeďte WMF na ICO nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
