...
head_title: "Konverter WORD ke DRAWING – Konversi WORD ke DRAWING di C# .NET"
head_description: "Bagaimana cara mengonversi WORD ke DRAWING di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi WORD ke DRAWING di C#"
description: "Konversi WORD ke DRAWING asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi WORD ke DRAWING di C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) memudahkan pengembang untuk mengonversi file WORD ke DRAWING menggunakan beberapa baris kode.

        * Buat instance kelas Converter dan muat file WORD dengan path lengkap
        * Buat & atur ConvertOptions untuk tipe DRAWING
        * Panggil metode Converter.Convert dan berikan path lengkap dan format (DRAWING) sebagai parameter
    ...
    code: |
        ...
        // atur opsi konversi untuk format DRAWING
