...
head_title: "Konverter WORD ke PRESENTATION – Konversi WORD ke PRESENTATION di C# .NET"
head_description: "Bagaimana cara mengonversi WORD ke PRESENTATION di C# .NET menggunakan beberapa baris kode? Gunakan API konversi dokumen GroupDocs untuk mengonversi 160+ format file."

title: "Konversi WORD ke PRESENTATION di C#"
description: "Konversi WORD ke PRESENTATION asli dan berkinerja tinggi menggunakan GroupDocs.Conversion sisi server untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengkonversi WORD ke PRESENTATION di C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) memudahkan pengembang untuk mengonversi file WORD ke PRESENTATION menggunakan beberapa baris kode.

        * Buat instance kelas Converter dan muat file WORD dengan path lengkap
        * Buat & atur ConvertOptions untuk tipe PRESENTATION
        * Panggil metode Converter.Convert dan berikan path lengkap dan format (PRESENTATION) sebagai parameter
    ...
    code: |
        ...
        // atur opsi konversi untuk format PRESENTATION
        var convertOptions = converter.GetPossibleConversions()["presentation"].ConvertOptions;
        // konversi ke format PRESENTATION
        converter.Convert("output.presentation", convertOptions);
        ```
        
demos:
    enable: true
    title: "Demo Langsung WORD hingga PRESENTATION"
    content: |
        Konversikan WORD ke PRESENTATION sekarang juga dengan mengunjungi situs web [GroupDocs.Conversion Live Demo](https://products.groupdocs.app/conversion/family).  
...
about_formats:
    ...
    format:
        - icon: "far fa-file-PRESENTATION"
          title: " Tentang Format File PRESENTATION"
          content: |
...
more_formats:
    ...
    format: 
        ...
        - name: "WORD KE ODP"
          ...
          description: "Format File PRESENTATION OpenDocument"
        ...
        - name: "WORD KE PPTX"
          ...
          description: "PowerPoint Buka XML PRESENTATION"
