...
############################# Head ############################
head_title: "WORD to WEB Converter – Convert WORD to WEB in C# .NET"
head_description: "How to convert WORD to WEB in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert WORD to WEB in C#"
description: "Native and high performance WORD to WEB conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert WORD to WEB in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the WORD file to WEB using a few lines of code.
