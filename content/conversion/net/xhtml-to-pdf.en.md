...
############################# Head #############################
head_title: "XHTML to PDF Converter API for .NET - convert in C# VB.NET"
head_description: ".NET file converter API to convert XHTML to PDF in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "XHTML to PDF file converter for C# .NET applications" 
description: ".NET document conversion API for seamless transformation XHTML to PDF format within C#, ASP.NET, VB.NET & .NET Core applications. Ensure precision formatting and layout preservation during the conversion process, all while minimizing coding efforts." 
...
steps:
    enable: true
    title: "Steps to convert XHTML to PDF file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> you can transform XHTML to PDF in a few steps.
      ...
      3. Load the XHTML file with full path. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.xhtml")             // Set up input XHTML file
            .ConvertTo("converted.pdf")     // Specify output path for converted file
            .Convert();                     // Convert XHTML to PDF file        
        ```            
