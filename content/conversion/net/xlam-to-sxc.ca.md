...
breadcrumb: XLAM a SXC a C#

############################# Head ############################
head_title: "Convertidor de XLAM a SXC a C#"
head_description: "Converteix XLAM en SXC a .NET utilitzant unes quantes línies de codi. Utilitzeu l'API de conversió de documents de GroupDocs per convertir més de 160 formats de fitxer."

############################# Header ############################
title: "Converteix XLAM a SXC a C#"
description: "Conversió de XLAM a SXC amb unes poques línies de codi .NET"
...
overview:
    enable: true
    content: |
        Convertiu fàcilment els vostres fitxers XLAM a SXC a .NET. Podeu utilitzar només un parell de línies de codi C# a qualsevol plataforma que trieu, com ara Windows, Linux, macOS.
        Podeu provar la conversió de XLAM a SXC gratuïtament i avaluar la qualitat dels resultats de la conversió. Juntament amb escenaris senzills de conversió de fitxers, podeu provar opcions més avançades per carregar el fitxer d'origen XLAM i per desar el resultat de sortida SXC. 
...
steps:
    enable: true
    title_left: "Passos per convertir XLAM a SXC a C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) facilita als desenvolupadors convertir un fitxer XLAM a SXC amb unes poques línies de codi.
...
demos:
    ...
    content: |
       Convertiu XLAM a SXC ara visitant el lloc web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). La demostració en línia té els següents avantatges
