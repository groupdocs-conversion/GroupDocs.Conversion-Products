...
breadcrumb: XLAM ke SXC di C#

############################# Head ############################
head_title: "Konverter XLAM ke SXC di C#"
head_description: "Konversikan XLAM ke SXC di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi XLAM ke SXC di C#"
description: "Konversi XLAM ke SXC dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file XLAM Anda ke SXC di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi XLAM ke SXC secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber XLAM dan untuk menyimpan hasil SXC keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi XLAM ke SXC di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file XLAM ke SXC dengan beberapa baris kode.
...
demos:
    ...
    content: |
       Konversikan XLAM ke SXC sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
