...
breadcrumb: XLS à CSV en C#

############################# Head ############################
head_title: "Convertisseur XLS à CSV en C#"
head_description: "Convertissez XLS en CSV dans .NET en utilisant quelques lignes de code. Utilisez l'API de conversion de documents GroupDocs pour convertir plus de 160 formats de fichiers."

############################# Header ############################
title: "Convertir XLS en CSV en C#"
description: "Conversion XLS à CSV avec quelques lignes de code .NET"
...
overview:
    enable: true
    content: |
        Convertissez facilement vos fichiers XLS en CSV dans .NET. Vous pouvez utiliser seulement quelques lignes de code C# dans n'importe quelle plate-forme de votre choix comme - Windows, Linux, macOS.
...
steps:
    enable: true
    title_left: "Étapes pour convertir XLS en CSV en C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) permet aux développeurs de convertir facilement un fichier XLS en CSV avec quelques lignes de code.
