...
breadcrumb: XLS ke DIF di C#

############################# Head ############################
head_title: "Konverter XLS ke DIF di C#"
head_description: "Konversikan XLS ke DIF di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi XLS ke DIF di C#"
description: "Konversi XLS ke DIF dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file XLS Anda ke DIF di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi XLS ke DIF secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber XLS dan untuk menyimpan hasil DIF keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi XLS ke DIF di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file XLS ke DIF dengan beberapa baris kode.
...
demos:
    enable: true
    title: "XLS ke DIF Demo Langsung"
    content: |
       Konversikan XLS ke DIF sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
