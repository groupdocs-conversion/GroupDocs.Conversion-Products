...
breadcrumb: XLSB ke JSON di C#

############################# Head ############################
head_title: "Konverter XLSB ke JSON di C#"
head_description: "Konversikan XLSB ke JSON di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi XLSB ke JSON di C#"
description: "Konversi XLSB ke JSON dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file XLSB Anda ke JSON di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi XLSB ke JSON secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber XLSB dan untuk menyimpan hasil JSON keluaran. 
        ...
        * tambahkan tanda air ke file JSON yang dikonversi dan banyak lagi.

        Setelah konversi selesai, Anda dapat menyimpan file JSON Anda ke jalur file lokal atau penyimpanan pihak ketiga mana pun seperti FTP, Amazon S3, Google Drive, Dropbox, dll. Harap diperhatikan - untuk mengonversi XLSB ke {{ TO}} tidak perlu menginstal perangkat lunak tambahan apa pun - seperti MS Office, Open Office, Adobe Acrobat Reader, dll.


############################# Steps ############################
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi XLSB ke JSON di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file XLSB ke JSON dengan beberapa baris kode.
        
        * Buat instance kelas Converter dan berikan file XLSB dengan path lengkap
        * Buat dan atur ConvertOptions untuk tipe JSON.
        * Panggil metode Converter.Convert dan berikan jalur dan format lengkap (JSON) sebagai parameter
...
demos:
    enable: true
    title: "XLSB ke JSON Demo Langsung"
    content: |
       Konversikan XLSB ke JSON sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
