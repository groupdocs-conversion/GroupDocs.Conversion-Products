...
breadcrumb: XLSB ke XLS di C#

############################# Head ############################
head_title: "Konverter XLSB ke XLS di C#"
head_description: "Konversikan XLSB ke XLS di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi XLSB ke XLS di C#"
description: "Konversi XLSB ke XLS dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file XLSB Anda ke XLS di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi XLSB ke XLS secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber XLSB dan untuk menyimpan hasil XLS keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi XLSB ke XLS di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file XLSB ke XLS dengan beberapa baris kode.
...
demos:
    enable: true
    title: "XLSB ke XLS Demo Langsung"
    content: |
       Konversikan XLSB ke XLS sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
