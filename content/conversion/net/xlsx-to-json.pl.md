...
breadcrumb: XLSX do JSON w C#

############################# Head ############################
head_title: "Konwerter XLSX na JSON w C#"
head_description: "Konwertuj XLSX na JSON w .NET, używając kilku linijek kodu. Użyj interfejsu API konwersji dokumentów GroupDocs, aby przekonwertować ponad 160 formatów plików."

############################# Header ############################
title: "Konwertuj XLSX na JSON w C#"
description: "Konwersja XLSX do JSON z kilkoma linijkami kodu .NET"
...
overview:
    enable: true
    content: |
        Łatwo przekonwertuj swoje pliki XLSX na JSON w .NET. Możesz użyć tylko kilku linii kodu C# na dowolnej wybranej platformie, takiej jak Windows, Linux, macOS.
        Możesz wypróbować konwersję XLSX do JSON za darmo i ocenić jakość wyników konwersji. Oprócz prostych scenariuszy konwersji plików możesz wypróbować bardziej zaawansowane opcje ładowania źródłowego pliku {{Z}} i zapisywania wyjściowego wyniku JSON. 
        ...
        * dodaj znak wodny do przekonwertowanego pliku JSON i wielu innych.
...
steps:
    enable: true
    title_left: "Kroki konwersji XLSX na JSON w C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) ułatwia programistom konwersję pliku XLSX na JSON za pomocą kilku linijek kodu.
        
        * Utwórz instancję klasy Converter i podaj plik XLSX z pełną ścieżką
        * Utwórz i ustaw opcje konwersji dla typu JSON.
        * Wywołaj metodę Converter.Convert i przekaż pełną ścieżkę i format (JSON) jako parametr
...
demos:
    ...
    content: |
       Konwertuj XLSX na JSON teraz, odwiedzając witrynę [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online ma następujące zalety
