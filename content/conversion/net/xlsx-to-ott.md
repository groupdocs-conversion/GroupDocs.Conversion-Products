...
############################# Head ############################
head_title: "XLSX to OTT Converter – Convert XLSX to OTT in C# .NET"
head_description: "How to convert XLSX to OTT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLSX to OTT in C#"
description: "Native and high performance XLSX to OTT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLSX file to OTT using a few lines of code.
...
demos:
    enable: true
    title: "XLSX to OTT Live Demos"
    content: |
        Convert XLSX to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
