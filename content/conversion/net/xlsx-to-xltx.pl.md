...
breadcrumb: XLSX do XLTX w C#

############################# Head ############################
head_title: "Konwerter XLSX na XLTX w C#"
head_description: "Konwertuj XLSX na XLTX w .NET, używając kilku linijek kodu. Użyj interfejsu API konwersji dokumentów GroupDocs, aby przekonwertować ponad 160 formatów plików."

############################# Header ############################
title: "Konwertuj XLSX na XLTX w C#"
description: "Konwersja XLSX do XLTX z kilkoma linijkami kodu .NET"
...
overview:
    enable: true
    content: |
        Łatwo przekonwertuj swoje pliki XLSX na XLTX w .NET. Możesz użyć tylko kilku linii kodu C# na dowolnej wybranej platformie, takiej jak Windows, Linux, macOS.
        Możesz wypróbować konwersję XLSX do XLTX za darmo i ocenić jakość wyników konwersji. Oprócz prostych scenariuszy konwersji plików możesz wypróbować bardziej zaawansowane opcje ładowania źródłowego pliku {{Z}} i zapisywania wyjściowego wyniku XLTX. 
        ...
        * dodaj znak wodny do przekonwertowanego pliku XLTX i wielu innych.
...
steps:
    enable: true
    title_left: "Kroki konwersji XLSX na XLTX w C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) ułatwia programistom konwersję pliku XLSX na XLTX za pomocą kilku linijek kodu.
        
        * Utwórz instancję klasy Converter i podaj plik XLSX z pełną ścieżką
        * Utwórz i ustaw opcje konwersji dla typu XLTX.
        * Wywołaj metodę Converter.Convert i przekaż pełną ścieżkę i format (XLTX) jako parametr
...
demos:
    enable: true
    title: "XLSX do XLTX demonstracji na żywo"
    content: |
       Konwertuj XLSX na XLTX teraz, odwiedzając witrynę [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online ma następujące zalety
