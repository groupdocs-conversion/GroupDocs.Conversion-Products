...
breadcrumb: XLT do EPUB v C#

############################# Head ############################
head_title: "Převodník XLT na EPUB v C#"
head_description: "Převeďte XLT na EPUB v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést XLT na EPUB v C#"
description: "Převod XLT na EPUB s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory XLT na EPUB ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi XLT na EPUB a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového XLT souboru a pro uložení výstupního EPUB výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu XLT na EPUB v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru XLT na EPUB pomocí několika řádků kódu.
...
demos:
    enable: true
    title: "Živá ukázka od XLT do EPUB"
    content: |
       Převeďte XLT na EPUB nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
