...
breadcrumb: XLT ke FODS di C#

############################# Head ############################
head_title: "Konverter XLT ke FODS di C#"
head_description: "Konversikan XLT ke FODS di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi XLT ke FODS di C#"
description: "Konversi XLT ke FODS dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file XLT Anda ke FODS di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi XLT ke FODS secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber XLT dan untuk menyimpan hasil FODS keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi XLT ke FODS di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file XLT ke FODS dengan beberapa baris kode.
...
demos:
    ...
    content: |
       Konversikan XLT ke FODS sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
