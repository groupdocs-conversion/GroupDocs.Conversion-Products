...
############################# Head ############################
head_title: "XLT to OTP Converter – Convert XLT to OTP in C# .NET"
head_description: "How to convert XLT to OTP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLT to OTP in C#"
description: "Native and high performance XLT to OTP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLT file to OTP using a few lines of code.
