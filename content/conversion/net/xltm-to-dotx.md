...
############################# Head ############################
head_title: "XLTM to DOTX Converter – Convert XLTM to DOTX in C# .NET"
head_description: "How to convert XLTM to DOTX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLTM to DOTX in C#"
description: "Native and high performance XLTM to DOTX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert XLTM to DOTX in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLTM file to DOTX using a few lines of code.
