...
############################# Head ############################
head_title: "Převodník XLTX na EPUB v C#"
head_description: "Převeďte XLTX na EPUB v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést XLTX na EPUB v C#"
description: "Převod XLTX na EPUB s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory XLTX na EPUB ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi XLTX na EPUB a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového XLTX souboru a pro uložení výstupního EPUB výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu XLTX na EPUB v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru XLTX na EPUB pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte XLTX na EPUB nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
