...
steps:
    enable: true
    title_left: "Kroki konwersji XLTX na FODS w C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) ułatwia programistom konwersję pliku XLTX na FODS za pomocą kilku linijek kodu.
