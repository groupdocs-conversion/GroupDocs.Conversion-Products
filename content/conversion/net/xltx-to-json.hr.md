...
breadcrumb: XLTX do JSON u C#

############################# Head ############################
head_title: "XLTX u JSON pretvarač u C#"
head_description: "Pretvorite XLTX u JSON u .NET pomoću nekoliko redaka koda. Koristite GroupDocs Document Conversion API za pretvaranje preko 160 formata datoteka."

############################# Header ############################
title: "Pretvori XLTX u JSON u C#"
description: "Konverzija XLTX u JSON s nekoliko redaka .NET koda"
...
overview:
    enable: true
    content: |
        Jednostavno pretvorite svoje XLTX datoteke u JSON u .NET. Možete koristiti samo nekoliko C# linija koda na bilo kojoj platformi po vašem izboru kao što su - Windows, Linux, macOS.
        Možete besplatno isprobati konverziju XLTX u JSON i procijeniti kvalitetu rezultata konverzije. Uz jednostavne scenarije konverzije datoteka, možete isprobati naprednije opcije za učitavanje izvorne XLTX datoteke i za spremanje izlaznog JSON rezultata. 
...
steps:
    enable: true
    title_left: "Koraci za pretvaranje XLTX u JSON u C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) programerima olakšava pretvaranje XLTX datoteke u JSON s nekoliko redaka koda.
...
demos:
    ...
    content: |
       Pretvorite XLTX u JSON sada tako da posjetite [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) web mjesto. Online demo ima sljedeće prednosti
