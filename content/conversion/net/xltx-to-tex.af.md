...
breadcrumb: XLTX na TEX in C#

############################# Head ############################
head_title: "XLTX na TEX-omskakelaar in C#"
head_description: "Skakel XLTX om na TEX in .NET deur 'n paar reëls kode te gebruik. Gebruik die GroupDocs Document Conversion API om meer as 160 lêerformate om te skakel."

############################# Header ############################
title: "Skakel XLTX om na TEX in C#"
description: "XLTX na TEX omskakeling met 'n paar reëls van .NET-kode"
...
overview:
    enable: true
    content: |
        Skakel jou XLTX lêers maklik om na TEX in .NET. Jy kan net 'n paar C# kodelyne gebruik in enige platform van jou keuse soos - Windows, Linux, macOS.
        Jy kan die omskakeling van XLTX na TEX gratis probeer en die kwaliteit van omskakelingsresultate evalueer. Saam met eenvoudige lêeromskakelingscenario's kan jy meer gevorderde opsies probeer om die bron-XLTX-lêer te laai en die uitset-TEX-resultaat te stoor. 
...
steps:
    enable: true
    title_left: "Stappe om XLTX na TEX om te skakel in C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) maak dit maklik vir ontwikkelaars om 'n XLTX lêer om te skakel na TEX met 'n paar reëls kode.
...
demos:
    enable: true
    title: "XLTX na TEX Regstreekse Demo"
    content: |
       Skakel XLTX nou na TEX deur die [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) webwerf te besoek. Aanlyn demo het die volgende voordele
