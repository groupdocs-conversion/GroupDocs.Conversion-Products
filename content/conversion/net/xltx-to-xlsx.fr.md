...
############################# Head #############################
head_title: "API de convertisseur de XLTX en XLSX pour .NET - convertir en C# VB.NET"
head_description: "API de convertisseur de fichiers .NET pour convertir XLTX en XLSX dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "Convertisseur de fichiers XLTX en XLSX pour applications C# .NET" 
description: "API de conversion de documents .NET pour une transformation sans faille de XLTX en XLSX dans des applications C#, ASP.NET, VB.NET et .NET Core. Assurez-vous d'un formatage précis et d'une préservation de la mise en page lors du processus de conversion, tout en minimisant les efforts de codage." 
...
steps:
    enable: true
    title: "Étapes pour convertir le fichier XLTX en XLSX dans C#" 
    content: |
      Avec <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a>, vous pouvez transformer XLTX en XLSX en quelques étapes simples.
      ...
      3. Chargez le fichier XLTX avec le chemin complet. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.xltx")             // Configurer le fichier XLTX d'entrée
            .ConvertTo("converted.xlsx")     // Spécifier le chemin de sortie pour le fichier converti
            .Convert();                     // Convertir le fichier XLTX en XLSX        
        ```            
