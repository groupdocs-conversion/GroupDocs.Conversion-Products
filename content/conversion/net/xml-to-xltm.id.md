...
breadcrumb: XML ke XLTM di C#

############################# Head ############################
head_title: "Konverter XML ke XLTM di C#"
head_description: "Konversikan XML ke XLTM di .NET menggunakan beberapa baris kode. Gunakan API Konversi Dokumen GroupDocs untuk mengonversi lebih dari 160 format file."

############################# Header ############################
title: "Konversi XML ke XLTM di C#"
description: "Konversi XML ke XLTM dengan beberapa baris kode .NET"
...
overview:
    enable: true
    content: |
        Konversikan file XML Anda ke XLTM di .NET dengan mudah. Anda dapat menggunakan hanya beberapa baris kode C# di platform pilihan Anda seperti - Windows, Linux, macOS.
        Anda dapat mencoba konversi XML ke XLTM secara gratis dan mengevaluasi kualitas hasil konversi. Bersama dengan skenario konversi file sederhana, Anda dapat mencoba opsi lanjutan lainnya untuk memuat file sumber XML dan untuk menyimpan hasil XLTM keluaran. 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk mengonversi XML ke XLTM di C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) memudahkan pengembang untuk mengonversi file XML ke XLTM dengan beberapa baris kode.
...
demos:
    enable: true
    title: "XML ke XLTM Demo Langsung"
    content: |
       Konversikan XML ke XLTM sekarang dengan mengunjungi situs web [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Demo online memiliki keuntungan sebagai berikut:
