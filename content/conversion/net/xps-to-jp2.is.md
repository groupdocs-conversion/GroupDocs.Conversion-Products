...
breadcrumb: XPS til JP2 í C#

############################# Head ############################
head_title: "XPS til JP2 Breytir í C#"
head_description: "Umbreyttu XPS í JP2 í .NET með því að nota nokkrar línur af kóða. Notaðu GroupDocs Document Conversion API til að umbreyta yfir 160 skráarsniðum."

############################# Header ############################
title: "Umbreyttu XPS í JP2 í C#"
description: "XPS til JP2 viðskipti með nokkrum línum af .NET kóða"
...
overview:
    enable: true
    content: |
        Breyttu XPS skránum þínum í JP2 í .NET auðveldlega. Þú getur notað aðeins nokkrar C# kóðalínur á hvaða vettvang sem þú vilt eins og - Windows, Linux, macOS.
        Þú getur prófað XPS til JP2 viðskipti ókeypis og metið gæði viðskiptaniðurstaðna. Ásamt einföldum skráabreytingum geturðu prófað fullkomnari valkosti til að hlaða uppruna XPS skrá og til að vista úttak JP2 niðurstöðu. 
...
steps:
    enable: true
    title_left: "Skref til að breyta XPS í JP2 í C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) auðveldar forriturum að breyta XPS skrá í JP2 með nokkrum línum af kóða.
...
demos:
    ...
    content: |
       Umbreyttu XPS í JP2 núna með því að fara á [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family) vefsíðuna. Demo á netinu hefur eftirfarandi kosti
