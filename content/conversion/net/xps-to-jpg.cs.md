...
############################# Head ############################
head_title: "Převodník XPS na JPG v C#"
head_description: "Převeďte XPS na JPG v .NET pomocí několika řádků kódu. Použijte rozhraní GroupDocs Document Conversion API k převodu více než 160 formátů souborů."

############################# Header ############################
title: "Převést XPS na JPG v C#"
description: "Převod XPS na JPG s několika řádky kódu .NET"
...
overview:
    enable: true
    content: |
        Převeďte své soubory XPS na JPG ve službě .NET snadno. Můžete použít pouze několik C# řádků kódu na libovolné platformě dle vašeho výběru, jako je - Windows, Linux, macOS.
        Můžete si zdarma vyzkoušet konverzi XPS na JPG a vyhodnotit kvalitu výsledků konverze. Spolu s jednoduchými scénáři konverze souborů můžete vyzkoušet pokročilejší možnosti pro načtení zdrojového XPS souboru a pro uložení výstupního JPG výsledku. 
...
steps:
    enable: true
    title_left: "Kroky k převodu XPS na JPG v C#"
    content_left: |
        [GroupDocs.Conversion for .NET](https://products.groupdocs.com/conversion/net/) usnadňuje vývojářům převod souboru XPS na JPG pomocí několika řádků kódu.
...
demos:
    ...
    content: |
       Převeďte XPS na JPG nyní na webu [GroupDocs.Conversion App](https://products.groupdocs.app/conversion/family). Online demo má následující výhody
