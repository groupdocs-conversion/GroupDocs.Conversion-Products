...
############################# Head #############################
head_title: "API Convertitore XSLFO in PDF per .NET - converti in C# VB.NET"
head_description: "API convertitore file .NET per convertire XSLFO in PDF in qualsiasi tipo di applicazione C#, ASP.NET, VB.NET e .NET Core."

############################# Header ############################
title: "Convertitore file XSLFO in PDF per applicazioni C# .NET" 
description: "API di conversione documenti .NET per una trasformazione senza soluzione di continuità da XSLFO a PDF all'interno di applicazioni C#, ASP.NET, VB.NET e .NET Core. Assicura una formattazione precisa e la conservazione del layout durante il processo di conversione, riducendo al minimo gli sforzi di codifica." 
...
steps:
    enable: true
    title: "Passaggi per convertire il file XSLFO in PDF nel linguaggio C#" 
    content: |
      Con <a href='https://products.groupdocs.com/conversion/net/'>GroupDocs.Conversion</a> puoi trasformare XSLFO in PDF in pochi semplici passaggi.
      ...
      3. Carica il file XSLFO con il percorso completo. 
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        FluentConverter
            .Load("input.xslfo")             // Imposta il file XSLFO di input
            .ConvertTo("converted.pdf")     // Specificare il percorso di output per il file convertito
            .Convert();                     // Converti il file XSLFO in PDF        
        ```            
