...
############################# Head ############################
head_title: "AI to AI Conversion in Java – Convert AI to AI"
head_description: "Convert AI to AI in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to AI in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to AI in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to AI in few lines of code.

        *   Create a new instance of Converter class and load the AI file with full path
        *   Set ConvertOptions for the AI document type
        *   Call the convert() method and pass the document name (full path) and format (AI) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target AI format
...
demos:
    enable: true
    title: "AI to AI Live Demos"
    content: |
        Convert AI to AI right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
