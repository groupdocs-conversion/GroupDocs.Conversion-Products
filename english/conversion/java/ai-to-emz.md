...
############################# Head ############################
head_title: "AI to EMZ Conversion in Java – Convert AI to EMZ"
head_description: "Convert AI to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to EMZ in few lines of code.
