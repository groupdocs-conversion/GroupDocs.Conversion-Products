...
############################# Head ############################
head_title: "AI to EPUB Conversion in Java – Convert AI to EPUB"
head_description: "Convert AI to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "AI to EPUB Live Demos"
    content: |
        Convert AI to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
