...
############################# Head ############################
head_title: "AI to HTML Conversion in Java – Convert AI to HTML"
head_description: "Convert AI to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to HTML in few lines of code.
