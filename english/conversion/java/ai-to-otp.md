...
############################# Head ############################
head_title: "AI to OTP Conversion in Java – Convert AI to OTP"
head_description: "Convert AI to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to OTP in few lines of code.
...
demos:
    enable: true
    title: "AI to OTP Live Demos"
    content: |
        Convert AI to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
