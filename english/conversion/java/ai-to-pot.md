...
############################# Head ############################
head_title: "AI to POT Conversion in Java – Convert AI to POT"
head_description: "Convert AI to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to POT in few lines of code.
...
demos:
    enable: true
    title: "AI to POT Live Demos"
    content: |
        Convert AI to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
