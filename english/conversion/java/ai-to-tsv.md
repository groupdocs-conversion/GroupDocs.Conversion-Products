...
############################# Head ############################
head_title: "AI to TSV Conversion in Java – Convert AI to TSV"
head_description: "Convert AI to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert AI Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting AI to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the AI file to TSV in few lines of code.
...
demos:
    enable: true
    title: "AI to TSV Live Demos"
    content: |
        Convert AI to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
