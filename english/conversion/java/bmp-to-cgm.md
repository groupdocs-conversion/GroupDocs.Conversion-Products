...
############################# Head ############################
head_title: "BMP to CGM Conversion in Java – Convert BMP to CGM"
head_description: "Convert BMP to CGM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to CGM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to CGM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to CGM in few lines of code.

        *   Create a new instance of Converter class and load the BMP file with full path
        *   Set ConvertOptions for the CGM document type
        *   Call the convert() method and pass the document name (full path) and format (CGM) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target CGM format
...
demos:
    enable: true
    title: "BMP to CGM Live Demos"
    content: |
        Convert BMP to CGM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
