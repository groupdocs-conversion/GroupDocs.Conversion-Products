...
############################# Head ############################
head_title: "BMP to EMZ Conversion in Java – Convert BMP to EMZ"
head_description: "Convert BMP to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to EMZ in few lines of code.
...
demos:
    enable: true
    title: "BMP to EMZ Live Demos"
    content: |
        Convert BMP to EMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
