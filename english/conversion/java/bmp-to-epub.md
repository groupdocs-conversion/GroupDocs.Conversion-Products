...
############################# Head ############################
head_title: "BMP to EPUB Conversion in Java – Convert BMP to EPUB"
head_description: "Convert BMP to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "BMP to EPUB Live Demos"
    content: |
        Convert BMP to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
