...
############################# Head ############################
head_title: "BMP to JPG Conversion in Java – Convert BMP to JPG"
head_description: "Convert BMP to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to JPG in few lines of code.
