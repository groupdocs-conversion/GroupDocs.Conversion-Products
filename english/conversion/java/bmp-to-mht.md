...
############################# Head ############################
head_title: "BMP to MHT Conversion in Java – Convert BMP to MHT"
head_description: "Convert BMP to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to MHT in few lines of code.
...
demos:
    enable: true
    title: "BMP to MHT Live Demos"
    content: |
        Convert BMP to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
