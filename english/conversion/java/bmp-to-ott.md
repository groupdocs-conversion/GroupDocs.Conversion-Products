...
############################# Head ############################
head_title: "BMP to OTT Conversion in Java – Convert BMP to OTT"
head_description: "Convert BMP to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to OTT in few lines of code.
