...
############################# Head ############################
head_title: "BMP to POT Conversion in Java – Convert BMP to POT"
head_description: "Convert BMP to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to POT in few lines of code.
