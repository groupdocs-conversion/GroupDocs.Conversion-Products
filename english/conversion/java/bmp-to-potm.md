...
############################# Head ############################
head_title: "BMP to POTM Conversion in Java – Convert BMP to POTM"
head_description: "Convert BMP to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to POTM in few lines of code.
...
demos:
    enable: true
    title: "BMP to POTM Live Demos"
    content: |
        Convert BMP to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
