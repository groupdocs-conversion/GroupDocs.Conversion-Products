...
############################# Head ############################
head_title: "BMP to SVG Conversion in Java – Convert BMP to SVG"
head_description: "Convert BMP to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to SVG in few lines of code.
