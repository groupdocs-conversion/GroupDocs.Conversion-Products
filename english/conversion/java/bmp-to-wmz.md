...
############################# Head ############################
head_title: "BMP to WMZ Conversion in Java – Convert BMP to WMZ"
head_description: "Convert BMP to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert BMP Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting BMP to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the BMP file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "BMP to WMZ Live Demos"
    content: |
        Convert BMP to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
