...
############################# Head ############################
head_title: "CDR to DIF Conversion in Java – Convert CDR to DIF"
head_description: "Convert CDR to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to DIF in few lines of code.
...
demos:
    enable: true
    title: "CDR to DIF Live Demos"
    content: |
        Convert CDR to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
