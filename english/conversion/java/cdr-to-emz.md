...
############################# Head ############################
head_title: "CDR to EMZ Conversion in Java – Convert CDR to EMZ"
head_description: "Convert CDR to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to EMZ in few lines of code.
