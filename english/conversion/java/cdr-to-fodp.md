...
############################# Head ############################
head_title: "CDR to FODP Conversion in Java – Convert CDR to FODP"
head_description: "Convert CDR to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to FODP in few lines of code.
