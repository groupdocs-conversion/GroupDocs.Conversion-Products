...
############################# Head ############################
head_title: "CDR to MHT Conversion in Java – Convert CDR to MHT"
head_description: "Convert CDR to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to MHT in few lines of code.
...
demos:
    enable: true
    title: "CDR to MHT Live Demos"
    content: |
        Convert CDR to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
