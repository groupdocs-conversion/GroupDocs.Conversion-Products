...
############################# Head ############################
head_title: "CDR to MHTML Conversion in Java – Convert CDR to MHTML"
head_description: "Convert CDR to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to MHTML in few lines of code.
