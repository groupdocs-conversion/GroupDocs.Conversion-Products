...
############################# Head ############################
head_title: "CDR to ODS Conversion in Java – Convert CDR to ODS"
head_description: "Convert CDR to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to ODS in few lines of code.
...
demos:
    enable: true
    title: "CDR to ODS Live Demos"
    content: |
        Convert CDR to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
