...
############################# Head ############################
head_title: "CDR to PPSX Conversion in Java – Convert CDR to PPSX"
head_description: "Convert CDR to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "CDR to PPSX Live Demos"
    content: |
        Convert CDR to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
