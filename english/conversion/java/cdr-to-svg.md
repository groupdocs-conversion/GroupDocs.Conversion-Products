...
############################# Head ############################
head_title: "CDR to SVG Conversion in Java – Convert CDR to SVG"
head_description: "Convert CDR to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to SVG in few lines of code.
...
demos:
    enable: true
    title: "CDR to SVG Live Demos"
    content: |
        Convert CDR to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
