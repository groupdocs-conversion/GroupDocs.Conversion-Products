...
############################# Head ############################
head_title: "CDR to TEX Conversion in Java – Convert CDR to TEX"
head_description: "Convert CDR to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to TEX in few lines of code.
...
demos:
    enable: true
    title: "CDR to TEX Live Demos"
    content: |
        Convert CDR to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
