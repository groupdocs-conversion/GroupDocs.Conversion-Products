...
############################# Head ############################
head_title: "CDR to WMF Conversion in Java – Convert CDR to WMF"
head_description: "Convert CDR to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CDR Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CDR to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CDR file to WMF in few lines of code.
...
demos:
    enable: true
    title: "CDR to WMF Live Demos"
    content: |
        Convert CDR to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
