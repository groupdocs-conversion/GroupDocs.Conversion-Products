...
############################# Head ############################
head_title: "CF2 to ODT Conversion in Java – Convert CF2 to ODT"
head_description: "Convert CF2 to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CF2 Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CF2 to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CF2 file to ODT in few lines of code.
...
demos:
    enable: true
    title: "CF2 to ODT Live Demos"
    content: |
        Convert CF2 to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
