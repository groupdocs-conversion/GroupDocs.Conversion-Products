...
############################# Head ############################
head_title: "CGM to EMZ Conversion in Java – Convert CGM to EMZ"
head_description: "Convert CGM to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to EMZ in few lines of code.
...
demos:
    enable: true
    title: "CGM to EMZ Live Demos"
    content: |
        Convert CGM to EMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
