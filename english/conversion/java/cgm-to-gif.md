...
############################# Head ############################
head_title: "CGM to GIF Conversion in Java – Convert CGM to GIF"
head_description: "Convert CGM to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to GIF in few lines of code.
