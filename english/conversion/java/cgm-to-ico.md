...
############################# Head ############################
head_title: "CGM to ICO Conversion in Java – Convert CGM to ICO"
head_description: "Convert CGM to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to ICO in few lines of code.
...
demos:
    enable: true
    title: "CGM to ICO Live Demos"
    content: |
        Convert CGM to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
