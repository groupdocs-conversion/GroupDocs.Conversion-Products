...
############################# Head ############################
head_title: "CGM to JPEG Conversion in Java – Convert CGM to JPEG"
head_description: "Convert CGM to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "CGM to JPEG Live Demos"
    content: |
        Convert CGM to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
