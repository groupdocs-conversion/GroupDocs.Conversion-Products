...
############################# Head ############################
head_title: "CGM to MHT Conversion in Java – Convert CGM to MHT"
head_description: "Convert CGM to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to MHT in few lines of code.
...
demos:
    enable: true
    title: "CGM to MHT Live Demos"
    content: |
        Convert CGM to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
