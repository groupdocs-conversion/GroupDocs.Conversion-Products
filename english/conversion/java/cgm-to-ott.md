...
############################# Head ############################
head_title: "CGM to OTT Conversion in Java – Convert CGM to OTT"
head_description: "Convert CGM to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to OTT in few lines of code.
...
demos:
    enable: true
    title: "CGM to OTT Live Demos"
    content: |
        Convert CGM to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
