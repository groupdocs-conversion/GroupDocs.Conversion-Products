...
############################# Head ############################
head_title: "CGM to PPSX Conversion in Java – Convert CGM to PPSX"
head_description: "Convert CGM to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "CGM to PPSX Live Demos"
    content: |
        Convert CGM to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
