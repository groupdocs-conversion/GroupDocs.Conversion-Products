...
############################# Head ############################
head_title: "CGM to SVG Conversion in Java – Convert CGM to SVG"
head_description: "Convert CGM to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to SVG in few lines of code.
...
demos:
    enable: true
    title: "CGM to SVG Live Demos"
    content: |
        Convert CGM to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
