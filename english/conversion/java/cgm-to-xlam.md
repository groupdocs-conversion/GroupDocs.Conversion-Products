...
############################# Head ############################
head_title: "CGM to XLAM Conversion in Java – Convert CGM to XLAM"
head_description: "Convert CGM to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "CGM to XLAM Live Demos"
    content: |
        Convert CGM to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
