...
############################# Head ############################
head_title: "CGM to XLSB Conversion in Java – Convert CGM to XLSB"
head_description: "Convert CGM to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CGM Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CGM to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CGM file to XLSB in few lines of code.
...
demos:
    enable: true
    title: "CGM to XLSB Live Demos"
    content: |
        Convert CGM to XLSB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
