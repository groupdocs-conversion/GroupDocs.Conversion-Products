...
############################# Head ############################
head_title: "CMX to EMZ Conversion in Java – Convert CMX to EMZ"
head_description: "Convert CMX to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to EMZ in few lines of code.
...
demos:
    enable: true
    title: "CMX to EMZ Live Demos"
    content: |
        Convert CMX to EMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
