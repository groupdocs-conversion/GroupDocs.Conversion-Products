...
############################# Head ############################
head_title: "CMX to EPUB Conversion in Java – Convert CMX to EPUB"
head_description: "Convert CMX to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "CMX to EPUB Live Demos"
    content: |
        Convert CMX to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
