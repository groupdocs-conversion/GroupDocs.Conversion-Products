...
############################# Head ############################
head_title: "CMX to POT Conversion in Java – Convert CMX to POT"
head_description: "Convert CMX to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to POT in few lines of code.
...
demos:
    enable: true
    title: "CMX to POT Live Demos"
    content: |
        Convert CMX to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
