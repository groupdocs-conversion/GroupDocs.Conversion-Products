...
############################# Head ############################
head_title: "CMX to PPS Conversion in Java – Convert CMX to PPS"
head_description: "Convert CMX to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to PPS in few lines of code.
...
demos:
    enable: true
    title: "CMX to PPS Live Demos"
    content: |
        Convert CMX to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
