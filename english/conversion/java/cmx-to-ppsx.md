...
############################# Head ############################
head_title: "CMX to PPSX Conversion in Java – Convert CMX to PPSX"
head_description: "Convert CMX to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "CMX to PPSX Live Demos"
    content: |
        Convert CMX to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
