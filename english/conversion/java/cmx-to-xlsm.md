...
############################# Head ############################
head_title: "CMX to XLSM Conversion in Java – Convert CMX to XLSM"
head_description: "Convert CMX to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "CMX to XLSM Live Demos"
    content: |
        Convert CMX to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
