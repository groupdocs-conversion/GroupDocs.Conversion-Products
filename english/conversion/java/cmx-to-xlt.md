...
############################# Head ############################
head_title: "CMX to XLT Conversion in Java – Convert CMX to XLT"
head_description: "Convert CMX to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to XLT in few lines of code.
...
demos:
    enable: true
    title: "CMX to XLT Live Demos"
    content: |
        Convert CMX to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
