...
############################# Head ############################
head_title: "CMX to XPS Conversion in Java – Convert CMX to XPS"
head_description: "Convert CMX to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CMX Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CMX to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CMX file to XPS in few lines of code.
