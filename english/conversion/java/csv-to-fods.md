...
############################# Head ############################
head_title: "CSV to FODS Conversion in Java – Convert CSV to FODS"
head_description: "Convert CSV to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert CSV Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting CSV to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the CSV file to FODS in few lines of code.
...
demos:
    enable: true
    title: "CSV to FODS Live Demos"
    content: |
        Convert CSV to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
