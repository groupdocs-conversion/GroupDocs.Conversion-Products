...
############################# Head ############################
head_title: "DCM to HTM Conversion in Java – Convert DCM to HTM"
head_description: "Convert DCM to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DCM Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DCM to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DCM file to HTM in few lines of code.
...
demos:
    enable: true
    title: "DCM to HTM Live Demos"
    content: |
        Convert DCM to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
