...
############################# Head ############################
head_title: "DGN to CSV Conversion in Java – Convert DGN to CSV"
head_description: "Convert DGN to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to CSV in few lines of code.
...
demos:
    enable: true
    title: "DGN to CSV Live Demos"
    content: |
        Convert DGN to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
