...
############################# Head ############################
head_title: "DGN to DOCM Conversion in Java – Convert DGN to DOCM"
head_description: "Convert DGN to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "DGN to DOCM Live Demos"
    content: |
        Convert DGN to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
