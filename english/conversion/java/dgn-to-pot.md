...
############################# Head ############################
head_title: "DGN to POT Conversion in Java – Convert DGN to POT"
head_description: "Convert DGN to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to POT in few lines of code.
...
demos:
    enable: true
    title: "DGN to POT Live Demos"
    content: |
        Convert DGN to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
