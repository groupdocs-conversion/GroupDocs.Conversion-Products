...
############################# Head ############################
head_title: "DGN to TXT Conversion in Java – Convert DGN to TXT"
head_description: "Convert DGN to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to TXT in few lines of code.
