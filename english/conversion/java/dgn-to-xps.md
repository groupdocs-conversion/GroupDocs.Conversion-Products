...
############################# Head ############################
head_title: "DGN to XPS Conversion in Java – Convert DGN to XPS"
head_description: "Convert DGN to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DGN Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DGN to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DGN file to XPS in few lines of code.
...
demos:
    enable: true
    title: "DGN to XPS Live Demos"
    content: |
        Convert DGN to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
