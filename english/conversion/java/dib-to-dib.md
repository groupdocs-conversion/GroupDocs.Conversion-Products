...
############################# Head ############################
head_title: "DIB to DIB Conversion in Java – Convert DIB to DIB"
head_description: "Convert DIB to DIB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DIB Files to DIB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DIB to DIB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DIB file to DIB in few lines of code.

        *   Create a new instance of Converter class and load the DIB file with full path
        *   Set ConvertOptions for the DIB document type
        *   Call the convert() method and pass the document name (full path) and format (DIB) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target DIB format
