...
############################# Head ############################
head_title: "DIB to TXT Conversion in Java – Convert DIB to TXT"
head_description: "Convert DIB to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DIB Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DIB to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DIB file to TXT in few lines of code.
