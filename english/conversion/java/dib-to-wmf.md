...
############################# Head ############################
head_title: "DIB to WMF Conversion in Java – Convert DIB to WMF"
head_description: "Convert DIB to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DIB Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DIB to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DIB file to WMF in few lines of code.
...
demos:
    enable: true
    title: "DIB to WMF Live Demos"
    content: |
        Convert DIB to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
