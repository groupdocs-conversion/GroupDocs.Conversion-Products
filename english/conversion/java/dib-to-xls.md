...
############################# Head ############################
head_title: "DIB to XLS Conversion in Java – Convert DIB to XLS"
head_description: "Convert DIB to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DIB Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DIB to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DIB file to XLS in few lines of code.
...
demos:
    enable: true
    title: "DIB to XLS Live Demos"
    content: |
        Convert DIB to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
