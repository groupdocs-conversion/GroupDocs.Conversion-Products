...
############################# Head ############################
head_title: "DJVU to FODS Conversion in Java – Convert DJVU to FODS"
head_description: "Convert DJVU to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to FODS in few lines of code.
...
demos:
    enable: true
    title: "DJVU to FODS Live Demos"
    content: |
        Convert DJVU to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
