...
############################# Head ############################
head_title: "DJVU to MHTML Conversion in Java – Convert DJVU to MHTML"
head_description: "Convert DJVU to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "DJVU to MHTML Live Demos"
    content: |
        Convert DJVU to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
