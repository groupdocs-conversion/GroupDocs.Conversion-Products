...
############################# Head ############################
head_title: "DJVU to ODP Conversion in Java – Convert DJVU to ODP"
head_description: "Convert DJVU to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to ODP in few lines of code.
...
demos:
    enable: true
    title: "DJVU to ODP Live Demos"
    content: |
        Convert DJVU to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
