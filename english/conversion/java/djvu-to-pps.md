...
############################# Head ############################
head_title: "DJVU to PPS Conversion in Java – Convert DJVU to PPS"
head_description: "Convert DJVU to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to PPS in few lines of code.
...
demos:
    enable: true
    title: "DJVU to PPS Live Demos"
    content: |
        Convert DJVU to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
