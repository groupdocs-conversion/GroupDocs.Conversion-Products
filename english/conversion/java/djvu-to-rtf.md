...
############################# Head ############################
head_title: "DJVU to RTF Conversion in Java – Convert DJVU to RTF"
head_description: "Convert DJVU to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to RTF in few lines of code.
