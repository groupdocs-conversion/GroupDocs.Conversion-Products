...
############################# Head ############################
head_title: "DJVU to TIF Conversion in Java – Convert DJVU to TIF"
head_description: "Convert DJVU to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to TIF in few lines of code.
...
demos:
    enable: true
    title: "DJVU to TIF Live Demos"
    content: |
        Convert DJVU to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
