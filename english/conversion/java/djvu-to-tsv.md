...
############################# Head ############################
head_title: "DJVU to TSV Conversion in Java – Convert DJVU to TSV"
head_description: "Convert DJVU to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to TSV in few lines of code.
...
demos:
    enable: true
    title: "DJVU to TSV Live Demos"
    content: |
        Convert DJVU to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
