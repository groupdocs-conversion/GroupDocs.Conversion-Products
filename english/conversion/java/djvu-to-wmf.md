...
############################# Head ############################
head_title: "DJVU to WMF Conversion in Java – Convert DJVU to WMF"
head_description: "Convert DJVU to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to WMF in few lines of code.
...
demos:
    enable: true
    title: "DJVU to WMF Live Demos"
    content: |
        Convert DJVU to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
