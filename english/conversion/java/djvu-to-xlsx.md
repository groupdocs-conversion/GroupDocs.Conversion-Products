...
############################# Head ############################
head_title: "DJVU to XLSX Conversion in Java – Convert DJVU to XLSX"
head_description: "Convert DJVU to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DJVU Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DJVU to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DJVU file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "DJVU to XLSX Live Demos"
    content: |
        Convert DJVU to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
