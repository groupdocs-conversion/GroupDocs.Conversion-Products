...
############################# Head ############################
head_title: "DNG to JPEG Conversion in Java – Convert DNG to JPEG"
head_description: "Convert DNG to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DNG Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DNG to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DNG file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "DNG to JPEG Live Demos"
    content: |
        Convert DNG to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
