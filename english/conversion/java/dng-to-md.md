...
############################# Head ############################
head_title: "DNG to MD Conversion in Java – Convert DNG to MD"
head_description: "Convert DNG to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DNG Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DNG to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DNG file to MD in few lines of code.
...
demos:
    enable: true
    title: "DNG to MD Live Demos"
    content: |
        Convert DNG to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
