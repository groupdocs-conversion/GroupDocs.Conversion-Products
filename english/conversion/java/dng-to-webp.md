...
############################# Static ############################
layout: "auto-gen"
date: 2021-05-13T13:59:22+03:00
draft: false

############################# Head ############################
head_title: "DNG to WEBP Conversion in Java – Convert DNG to WEBP"
head_description: "Convert DNG to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DNG Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DNG to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DNG file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "DNG to WEBP Live Demos"
    content: |
        Convert DNG to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
