...
############################# Head ############################
head_title: "DNG to WMF Conversion in Java – Convert DNG to WMF"
head_description: "Convert DNG to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DNG Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DNG to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DNG file to WMF in few lines of code.
...
demos:
    enable: true
    title: "DNG to WMF Live Demos"
    content: |
        Convert DNG to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
