...
############################# Head ############################
head_title: "DNG to WMZ Conversion in Java – Convert DNG to WMZ"
head_description: "Convert DNG to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DNG Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DNG to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DNG file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "DNG to WMZ Live Demos"
    content: |
        Convert DNG to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
