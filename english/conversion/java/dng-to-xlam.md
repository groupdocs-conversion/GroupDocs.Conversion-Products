...
############################# Head ############################
head_title: "DNG to XLAM Conversion in Java – Convert DNG to XLAM"
head_description: "Convert DNG to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DNG Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DNG to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DNG file to XLAM in few lines of code.
