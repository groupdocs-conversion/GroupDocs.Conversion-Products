...
############################# Static ############################
layout: "auto-gen"
date: 2021-05-13T13:59:25+03:00
draft: false

############################# Head ############################
head_title: "DOC to DNG Conversion in Java – Convert DOC to DNG"
head_description: "Convert DOC to DNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to DNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to DNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert the DOC file to DNG in few lines of code.

        *   Create a new instance of Converter class and load the DOC file with full path
        *   Set ConvertOptions for the DNG document type
        *   Call the convert() method and pass the document name (full path) and format (DNG) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target DNG format
...
demos:
    enable: true
    title: "DOC to DNG Live Demos"
    content: |
        Convert DOC to DNG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
