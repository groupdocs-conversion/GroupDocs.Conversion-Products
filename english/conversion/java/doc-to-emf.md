...
############################# Head ############################
head_title: "DOC to EMF Conversion in Java – Convert DOC to EMF"
head_description: "Convert DOC to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to EMF in few lines of code.
...
demos:
    enable: true
    title: "DOC to EMF Live Demos"
    content: |
        Convert DOC to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
