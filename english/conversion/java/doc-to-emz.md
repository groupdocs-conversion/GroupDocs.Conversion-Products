...
############################# Head ############################
head_title: "DOC to EMZ Conversion in Java – Convert DOC to EMZ"
head_description: "Convert DOC to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to EMZ in few lines of code.
...
demos:
    enable: true
    title: "DOC to EMZ Live Demos"
    content: |
        Convert DOC to EMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
