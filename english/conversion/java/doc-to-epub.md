...
############################# Head ############################
head_title: "DOC to EPUB Conversion in Java – Convert DOC to EPUB"
head_description: "Convert DOC to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "DOC to EPUB Live Demos"
    content: |
        Convert DOC to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
