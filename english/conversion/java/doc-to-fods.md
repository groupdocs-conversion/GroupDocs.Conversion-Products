...
############################# Head ############################
head_title: "DOC to FODS Conversion in Java – Convert DOC to FODS"
head_description: "Convert DOC to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to FODS in few lines of code.
...
demos:
    enable: true
    title: "DOC to FODS Live Demos"
    content: |
        Convert DOC to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
