...
############################# Head ############################
head_title: "DOC to MD Conversion in Java – Convert DOC to MD"
head_description: "Convert DOC to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to MD in few lines of code.
...
demos:
    enable: true
    title: "DOC to MD Live Demos"
    content: |
        Convert DOC to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
