...
############################# Head ############################
head_title: "DOC to MHTML Conversion in Java – Convert DOC to MHTML"
head_description: "Convert DOC to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "DOC to MHTML Live Demos"
    content: |
        Convert DOC to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
