...
############################# Head ############################
head_title: "DOC to OTP Conversion in Java – Convert DOC to OTP"
head_description: "Convert DOC to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to OTP in few lines of code.
