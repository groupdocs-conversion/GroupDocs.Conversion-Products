...
############################# Head ############################
head_title: "DOC to SVG Conversion in Java – Convert DOC to SVG"
head_description: "Convert DOC to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to SVG in few lines of code.
...
demos:
    enable: true
    title: "DOC to SVG Live Demos"
    content: |
        Convert DOC to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
