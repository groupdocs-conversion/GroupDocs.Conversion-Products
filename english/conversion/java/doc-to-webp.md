...
############################# Head ############################
head_title: "DOC to WEBP Conversion in Java – Convert DOC to WEBP"
head_description: "Convert DOC to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOC Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOC to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOC file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "DOC to WEBP Live Demos"
    content: |
        Convert DOC to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
