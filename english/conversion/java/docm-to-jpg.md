...
############################# Head ############################
head_title: "DOCM to JPG Conversion in Java – Convert DOCM to JPG"
head_description: "Convert DOCM to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCM Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCM to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCM file to JPG in few lines of code.
...
demos:
    enable: true
    title: "DOCM to JPG Live Demos"
    content: |
        Convert DOCM to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
