...
############################# Head ############################
head_title: "DOCM to MHT Conversion in Java – Convert DOCM to MHT"
head_description: "Convert DOCM to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCM Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCM to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCM file to MHT in few lines of code.
...
demos:
    enable: true
    title: "DOCM to MHT Live Demos"
    content: |
        Convert DOCM to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
