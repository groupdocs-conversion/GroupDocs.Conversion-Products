...
############################# Head ############################
head_title: "DOCM to POT Conversion in Java – Convert DOCM to POT"
head_description: "Convert DOCM to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCM Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCM to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCM file to POT in few lines of code.
...
demos:
    enable: true
    title: "DOCM to POT Live Demos"
    content: |
        Convert DOCM to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
