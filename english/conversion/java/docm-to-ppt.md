...
############################# Head ############################
head_title: "DOCM to PPT Conversion in Java – Convert DOCM to PPT"
head_description: "Convert DOCM to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCM Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCM to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCM file to PPT in few lines of code.
...
demos:
    enable: true
    title: "DOCM to PPT Live Demos"
    content: |
        Convert DOCM to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
