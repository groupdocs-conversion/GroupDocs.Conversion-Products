...
############################# Head ############################
head_title: "DOCM to WEBP Conversion in Java – Convert DOCM to WEBP"
head_description: "Convert DOCM to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCM Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCM to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCM file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "DOCM to WEBP Live Demos"
    content: |
        Convert DOCM to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
