...
############################# Head ############################
head_title: "DOCM to XLS Conversion in Java – Convert DOCM to XLS"
head_description: "Convert DOCM to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCM Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCM to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCM file to XLS in few lines of code.
...
demos:
    enable: true
    title: "DOCM to XLS Live Demos"
    content: |
        Convert DOCM to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
