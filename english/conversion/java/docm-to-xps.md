...
############################# Head ############################
head_title: "DOCM to XPS Conversion in Java – Convert DOCM to XPS"
head_description: "Convert DOCM to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCM Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCM to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCM file to XPS in few lines of code.
...
demos:
    enable: true
    title: "DOCM to XPS Live Demos"
    content: |
        Convert DOCM to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
