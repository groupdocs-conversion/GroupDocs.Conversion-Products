...
############################# Head ############################
head_title: "DOCX to DOTM Conversion in Java – Convert DOCX to DOTM"
head_description: "Convert DOCX to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCX Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCX to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCX file to DOTM in few lines of code.
