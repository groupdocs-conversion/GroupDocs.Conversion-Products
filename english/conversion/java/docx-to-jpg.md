...
############################# Head ############################
head_title: "DOCX to JPG Conversion in Java – Convert DOCX to JPG"
head_description: "Convert DOCX to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCX Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCX to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCX file to JPG in few lines of code.
...
demos:
    enable: true
    title: "DOCX to JPG Live Demos"
    content: |
        Convert DOCX to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
