...
############################# Head ############################
head_title: "DOCX to TEX Conversion in Java – Convert DOCX to TEX"
head_description: "Convert DOCX to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCX Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCX to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCX file to TEX in few lines of code.
...
demos:
    enable: true
    title: "DOCX to TEX Live Demos"
    content: |
        Convert DOCX to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
