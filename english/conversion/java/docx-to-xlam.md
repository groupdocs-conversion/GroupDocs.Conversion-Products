...
############################# Head ############################
head_title: "DOCX to XLAM Conversion in Java – Convert DOCX to XLAM"
head_description: "Convert DOCX to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCX Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCX to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCX file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "DOCX to XLAM Live Demos"
    content: |
        Convert DOCX to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
