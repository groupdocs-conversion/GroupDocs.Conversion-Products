...
############################# Head ############################
head_title: "DOCX to XLS2003 Conversion in Java – Convert DOCX to XLS2003"
head_description: "Convert DOCX to XLS2003 in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCX Files to XLS2003 in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCX to XLS2003 in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCX file to XLS2003 in few lines of code.
...
demos:
    enable: true
    title: "DOCX to XLS2003 Live Demos"
    content: |
        Convert DOCX to XLS2003 right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
