...
############################# Head ############################
head_title: "DOCX to XLSX Conversion in Java – Convert DOCX to XLSX"
head_description: "Convert DOCX to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOCX Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOCX to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOCX file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "DOCX to XLSX Live Demos"
    content: |
        Convert DOCX to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
