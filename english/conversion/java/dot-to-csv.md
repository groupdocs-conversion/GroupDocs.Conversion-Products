...
############################# Head ############################
head_title: "DOT to CSV Conversion in Java – Convert DOT to CSV"
head_description: "Convert DOT to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOT Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOT to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOT file to CSV in few lines of code.
...
demos:
    enable: true
    title: "DOT to CSV Live Demos"
    content: |
        Convert DOT to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
