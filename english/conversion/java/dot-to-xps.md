...
############################# Head ############################
head_title: "DOT to XPS Conversion in Java – Convert DOT to XPS"
head_description: "Convert DOT to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOT Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOT to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOT file to XPS in few lines of code.
...
demos:
    enable: true
    title: "DOT to XPS Live Demos"
    content: |
        Convert DOT to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
