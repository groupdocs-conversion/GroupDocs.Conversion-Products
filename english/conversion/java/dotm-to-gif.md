...
############################# Head ############################
head_title: "DOTM to GIF Conversion in Java – Convert DOTM to GIF"
head_description: "Convert DOTM to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTM Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTM to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTM file to GIF in few lines of code.
...
demos:
    enable: true
    title: "DOTM to GIF Live Demos"
    content: |
        Convert DOTM to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
