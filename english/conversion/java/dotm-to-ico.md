...
############################# Head ############################
head_title: "DOTM to ICO Conversion in Java – Convert DOTM to ICO"
head_description: "Convert DOTM to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTM Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTM to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTM file to ICO in few lines of code.
...
demos:
    enable: true
    title: "DOTM to ICO Live Demos"
    content: |
        Convert DOTM to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
