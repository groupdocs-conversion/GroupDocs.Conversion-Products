...
############################# Head ############################
head_title: "DOTM to RTF Conversion in Java – Convert DOTM to RTF"
head_description: "Convert DOTM to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTM Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTM to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTM file to RTF in few lines of code.
...
demos:
    enable: true
    title: "DOTM to RTF Live Demos"
    content: |
        Convert DOTM to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
