...
############################# Head ############################
head_title: "DOTX to DOCX Conversion in Java – Convert DOTX to DOCX"
head_description: "Convert DOTX to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTX Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTX to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTX file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "DOTX to DOCX Live Demos"
    content: |
        Convert DOTX to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
