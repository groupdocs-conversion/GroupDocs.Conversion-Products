...
############################# Head ############################
head_title: "DOTX to FODS Conversion in Java – Convert DOTX to FODS"
head_description: "Convert DOTX to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTX Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTX to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTX file to FODS in few lines of code.
...
demos:
    enable: true
    title: "DOTX to FODS Live Demos"
    content: |
        Convert DOTX to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
