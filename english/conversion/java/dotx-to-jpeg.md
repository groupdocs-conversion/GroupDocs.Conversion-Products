...
############################# Head ############################
head_title: "DOTX to JPEG Conversion in Java – Convert DOTX to JPEG"
head_description: "Convert DOTX to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTX Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTX to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTX file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "DOTX to JPEG Live Demos"
    content: |
        Convert DOTX to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
