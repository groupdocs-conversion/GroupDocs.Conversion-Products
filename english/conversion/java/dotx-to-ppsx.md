...
############################# Head ############################
head_title: "DOTX to PPSX Conversion in Java – Convert DOTX to PPSX"
head_description: "Convert DOTX to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTX Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTX to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTX file to PPSX in few lines of code.
