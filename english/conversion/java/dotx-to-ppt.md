...
############################# Head ############################
head_title: "DOTX to PPT Conversion in Java – Convert DOTX to PPT"
head_description: "Convert DOTX to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DOTX Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DOTX to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DOTX file to PPT in few lines of code.
...
demos:
    enable: true
    title: "DOTX to PPT Live Demos"
    content: |
        Convert DOTX to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
