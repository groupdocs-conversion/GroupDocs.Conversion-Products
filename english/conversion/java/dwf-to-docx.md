...
############################# Head ############################
head_title: "DWF to DOCX Conversion in Java – Convert DWF to DOCX"
head_description: "Convert DWF to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWF Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWF to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWF file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "DWF to DOCX Live Demos"
    content: |
        Convert DWF to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
