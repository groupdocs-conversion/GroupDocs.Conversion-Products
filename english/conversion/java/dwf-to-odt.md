...
############################# Head ############################
head_title: "DWF to ODT Conversion in Java – Convert DWF to ODT"
head_description: "Convert DWF to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWF Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWF to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWF file to ODT in few lines of code.
...
demos:
    enable: true
    title: "DWF to ODT Live Demos"
    content: |
        Convert DWF to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
