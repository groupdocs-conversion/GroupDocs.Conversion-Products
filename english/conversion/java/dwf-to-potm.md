...
############################# Head ############################
head_title: "DWF to POTM Conversion in Java – Convert DWF to POTM"
head_description: "Convert DWF to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWF Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWF to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWF file to POTM in few lines of code.
