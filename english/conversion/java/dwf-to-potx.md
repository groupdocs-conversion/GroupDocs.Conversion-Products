...
############################# Head ############################
head_title: "DWF to POTX Conversion in Java – Convert DWF to POTX"
head_description: "Convert DWF to POTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWF Files to POTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWF to POTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWF file to POTX in few lines of code.
...
demos:
    enable: true
    title: "DWF to POTX Live Demos"
    content: |
        Convert DWF to POTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
