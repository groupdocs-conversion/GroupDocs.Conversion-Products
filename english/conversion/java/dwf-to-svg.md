...
############################# Head ############################
head_title: "DWF to SVG Conversion in Java – Convert DWF to SVG"
head_description: "Convert DWF to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWF Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWF to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWF file to SVG in few lines of code.
...
demos:
    enable: true
    title: "DWF to SVG Live Demos"
    content: |
        Convert DWF to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
