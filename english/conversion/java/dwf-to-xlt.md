...
############################# Head ############################
head_title: "DWF to XLT Conversion in Java – Convert DWF to XLT"
head_description: "Convert DWF to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWF Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWF to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWF file to XLT in few lines of code.
...
demos:
    enable: true
    title: "DWF to XLT Live Demos"
    content: |
        Convert DWF to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
