...
############################# Head ############################
head_title: "DWFX to HTM Conversion in Java – Convert DWFX to HTM"
head_description: "Convert DWFX to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWFX Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWFX to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWFX file to HTM in few lines of code.
...
demos:
    enable: true
    title: "DWFX to HTM Live Demos"
    content: |
        Convert DWFX to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
