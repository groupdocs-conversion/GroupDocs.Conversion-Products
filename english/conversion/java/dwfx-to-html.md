...
############################# Head ############################
head_title: "DWFX to HTML Conversion in Java – Convert DWFX to HTML"
head_description: "Convert DWFX to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWFX Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWFX to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWFX file to HTML in few lines of code.
...
demos:
    enable: true
    title: "DWFX to HTML Live Demos"
    content: |
        Convert DWFX to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
