...
############################# Head ############################
head_title: "DWG to DCM Conversion in Java – Convert DWG to DCM"
head_description: "Convert DWG to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWG Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWG to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWG file to DCM in few lines of code.
...
demos:
    enable: true
    title: "DWG to DCM Live Demos"
    content: |
        Convert DWG to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
