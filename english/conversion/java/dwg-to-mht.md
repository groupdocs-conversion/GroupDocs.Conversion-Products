...
############################# Head ############################
head_title: "DWG to MHT Conversion in Java – Convert DWG to MHT"
head_description: "Convert DWG to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWG Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWG to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWG file to MHT in few lines of code.
...
demos:
    enable: true
    title: "DWG to MHT Live Demos"
    content: |
        Convert DWG to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
