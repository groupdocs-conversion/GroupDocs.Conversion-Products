...
############################# Head ############################
head_title: "DWG to MHTML Conversion in Java – Convert DWG to MHTML"
head_description: "Convert DWG to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWG Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWG to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWG file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "DWG to MHTML Live Demos"
    content: |
        Convert DWG to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
