...
############################# Head ############################
head_title: "DWG to PPSX Conversion in Java – Convert DWG to PPSX"
head_description: "Convert DWG to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWG Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWG to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWG file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "DWG to PPSX Live Demos"
    content: |
        Convert DWG to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
