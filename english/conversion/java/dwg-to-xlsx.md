...
############################# Head ############################
head_title: "DWG to XLSX Conversion in Java – Convert DWG to XLSX"
head_description: "Convert DWG to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWG Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWG to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWG file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "DWG to XLSX Live Demos"
    content: |
        Convert DWG to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
