...
############################# Head ############################
head_title: "DWT to POT Conversion in Java – Convert DWT to POT"
head_description: "Convert DWT to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWT Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWT to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWT file to POT in few lines of code.
...
demos:
    enable: true
    title: "DWT to POT Live Demos"
    content: |
        Convert DWT to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
