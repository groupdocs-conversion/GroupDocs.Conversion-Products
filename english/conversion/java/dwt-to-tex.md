...
############################# Head ############################
head_title: "DWT to TEX Conversion in Java – Convert DWT to TEX"
head_description: "Convert DWT to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DWT Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DWT to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DWT file to TEX in few lines of code.
...
demos:
    enable: true
    title: "DWT to TEX Live Demos"
    content: |
        Convert DWT to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
