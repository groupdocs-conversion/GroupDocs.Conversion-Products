...
############################# Head ############################
head_title: "DXF to MHTML Conversion in Java – Convert DXF to MHTML"
head_description: "Convert DXF to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DXF Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DXF to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DXF file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "DXF to MHTML Live Demos"
    content: |
        Convert DXF to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
