...
############################# Head ############################
head_title: "DXF to WMF Conversion in Java – Convert DXF to WMF"
head_description: "Convert DXF to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert DXF Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting DXF to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the DXF file to WMF in few lines of code.
...
demos:
    enable: true
    title: "DXF to WMF Live Demos"
    content: |
        Convert DXF to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
