...
############################# Head ############################
head_title: "EBOOK to EMAIL Conversion in Java – Convert EBOOK to EMAIL"
head_description: "Convert EBOOK to EMAIL in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EBOOK Files to EMAIL in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EBOOK to EMAIL in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EBOOK file to EMAIL in few lines of code.
