...
############################# Head ############################
head_title: "EMAIL to DOCM Conversion in Java – Convert EMAIL to DOCM"
head_description: "Convert EMAIL to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "EMAIL to DOCM Live Demos"
    content: |
        Convert EMAIL to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
