...
############################# Head ############################
head_title: "Email to DOT Conversion in Java – Convert Email to DOT"
head_description: "Convert Email to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert Email Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting Email to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the Email file to DOT in few lines of code.
