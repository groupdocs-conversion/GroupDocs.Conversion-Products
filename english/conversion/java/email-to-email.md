...
############################# Head ############################
head_title: "EMAIL to EMAIL Conversion in Java – Convert EMAIL to EMAIL"
head_description: "Convert EMAIL to EMAIL in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to EMAIL in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to EMAIL in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to EMAIL in few lines of code.
...
demos:
    enable: true
    title: "EMAIL to EMAIL Live Demos"
    content: |
        Convert EMAIL to EMAIL right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
