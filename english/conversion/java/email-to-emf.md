...
############################# Head ############################
head_title: "EMAIL to EMF Conversion in Java – Convert EMAIL to EMF"
head_description: "Convert EMAIL to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to EMF in few lines of code.
...
demos:
    enable: true
    title: "EMAIL to EMF Live Demos"
    content: |
        Convert EMAIL to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
