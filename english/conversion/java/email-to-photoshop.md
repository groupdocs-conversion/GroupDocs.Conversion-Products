...
############################# Head ############################
head_title: "EMAIL to PHOTOSHOP Conversion in Java – Convert EMAIL to PHOTOSHOP"
head_description: "Convert EMAIL to PHOTOSHOP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to PHOTOSHOP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to PHOTOSHOP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to PHOTOSHOP in few lines of code.
