...
############################# Head ############################
head_title: "Email to PSD Conversion in Java – Convert Email to PSD"
head_description: "Convert Email to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert Email Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting Email to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the Email file to PSD in few lines of code.
...
demos:
    enable: true
    title: "Email to PSD Live Demos"
    content: |
        Convert Email to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
