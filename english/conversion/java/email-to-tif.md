...
############################# Head ############################
head_title: "EMAIL to TIF Conversion in Java – Convert EMAIL to TIF"
head_description: "Convert EMAIL to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMAIL Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMAIL to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMAIL file to TIF in few lines of code.
...
demos:
    enable: true
    title: "EMAIL to TIF Live Demos"
    content: |
        Convert EMAIL to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
