...
############################# Head ############################
head_title: "Email to XPS Conversion in Java – Convert Email to XPS"
head_description: "Convert Email to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert Email Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting Email to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the Email file to XPS in few lines of code.
...
demos:
    enable: true
    title: "Email to XPS Live Demos"
    content: |
        Convert Email to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
