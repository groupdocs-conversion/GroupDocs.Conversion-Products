...
############################# Head ############################
head_title: "EMF to DOCM Conversion in Java – Convert EMF to DOCM"
head_description: "Convert EMF to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMF Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMF to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMF file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "EMF to DOCM Live Demos"
    content: |
        Convert EMF to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
