...
############################# Head ############################
head_title: "EMF to FODP Conversion in Java – Convert EMF to FODP"
head_description: "Convert EMF to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMF Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMF to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMF file to FODP in few lines of code.
...
demos:
    enable: true
    title: "EMF to FODP Live Demos"
    content: |
        Convert EMF to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
