...
############################# Head ############################
head_title: "EMF to OTT Conversion in Java – Convert EMF to OTT"
head_description: "Convert EMF to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMF Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMF to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMF file to OTT in few lines of code.
...
demos:
    enable: true
    title: "EMF to OTT Live Demos"
    content: |
        Convert EMF to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
