...
############################# Head ############################
head_title: "EMF to SXC Conversion in Java – Convert EMF to SXC"
head_description: "Convert EMF to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMF Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMF to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMF file to SXC in few lines of code.
...
demos:
    enable: true
    title: "EMF to SXC Live Demos"
    content: |
        Convert EMF to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
