...
############################# Head ############################
head_title: "EMF to XLTM Conversion in Java – Convert EMF to XLTM"
head_description: "Convert EMF to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMF Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMF to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMF file to XLTM in few lines of code.
