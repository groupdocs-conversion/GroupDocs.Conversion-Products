...
############################# Head ############################
head_title: "EMF to XPS Conversion in Java – Convert EMF to XPS"
head_description: "Convert EMF to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMF Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMF to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMF file to XPS in few lines of code.
