...
############################# Head ############################
head_title: "EML to DOCX Conversion in Java – Convert EML to DOCX"
head_description: "Convert EML to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to DOCX in few lines of code.
