...
############################# Head ############################
head_title: "EML to GIF Conversion in Java – Convert EML to GIF"
head_description: "Convert EML to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to GIF in few lines of code.
