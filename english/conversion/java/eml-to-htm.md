...
############################# Head ############################
head_title: "EML to HTM Conversion in Java – Convert EML to HTM"
head_description: "Convert EML to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to HTM in few lines of code.
