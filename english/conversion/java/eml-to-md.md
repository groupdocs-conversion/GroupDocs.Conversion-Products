...
############################# Head ############################
head_title: "EML to MD Conversion in Java – Convert EML to MD"
head_description: "Convert EML to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to MD in few lines of code.
...
demos:
    enable: true
    title: "EML to MD Live Demos"
    content: |
        Convert EML to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
