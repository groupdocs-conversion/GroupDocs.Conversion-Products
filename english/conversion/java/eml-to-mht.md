...
############################# Head ############################
head_title: "EML to MHT Conversion in Java – Convert EML to MHT"
head_description: "Convert EML to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to MHT in few lines of code.
...
demos:
    enable: true
    title: "EML to MHT Live Demos"
    content: |
        Convert EML to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
