...
############################# Head ############################
head_title: "EML to MHTM Conversion in Java – Convert EML to MHTM"
head_description: "Convert EML to MHTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to MHTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to MHTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to MHTM in few lines of code.
...
demos:
    enable: true
    title: "EML to MHTM Live Demos"
    content: |
        Convert EML to MHTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
