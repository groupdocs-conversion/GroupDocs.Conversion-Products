...
############################# Head ############################
head_title: "EML to ODS Conversion in Java – Convert EML to ODS"
head_description: "Convert EML to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to ODS in few lines of code.
...
demos:
    enable: true
    title: "EML to ODS Live Demos"
    content: |
        Convert EML to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
