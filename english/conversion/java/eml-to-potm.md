...
############################# Head ############################
head_title: "EML to POTM Conversion in Java – Convert EML to POTM"
head_description: "Convert EML to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to POTM in few lines of code.
...
demos:
    enable: true
    title: "EML to POTM Live Demos"
    content: |
        Convert EML to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
