...
############################# Head ############################
head_title: "EML to PSD Conversion in Java – Convert EML to PSD"
head_description: "Convert EML to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to PSD in few lines of code.
