...
############################# Head ############################
head_title: "EML to SVG Conversion in Java – Convert EML to SVG"
head_description: "Convert EML to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to SVG in few lines of code.
