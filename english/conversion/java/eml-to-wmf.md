...
############################# Head ############################
head_title: "EML to WMF Conversion in Java – Convert EML to WMF"
head_description: "Convert EML to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to WMF in few lines of code.
...
demos:
    enable: true
    title: "EML to WMF Live Demos"
    content: |
        Convert EML to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
