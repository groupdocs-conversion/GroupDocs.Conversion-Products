...
############################# Head ############################
head_title: "EML to XLS Conversion in Java – Convert EML to XLS"
head_description: "Convert EML to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to XLS in few lines of code.
...
demos:
    enable: true
    title: "EML to XLS Live Demos"
    content: |
        Convert EML to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
