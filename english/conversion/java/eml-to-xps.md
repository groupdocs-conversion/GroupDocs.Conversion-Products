...
############################# Head ############################
head_title: "EML to XPS Conversion in Java – Convert EML to XPS"
head_description: "Convert EML to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EML Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EML to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EML file to XPS in few lines of code.
...
demos:
    enable: true
    title: "EML to XPS Live Demos"
    content: |
        Convert EML to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
