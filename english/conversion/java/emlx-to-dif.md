...
############################# Head ############################
head_title: "EMLX to DIF Conversion in Java – Convert EMLX to DIF"
head_description: "Convert EMLX to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMLX Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMLX to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMLX file to DIF in few lines of code.
...
demos:
    enable: true
    title: "EMLX to DIF Live Demos"
    content: |
        Convert EMLX to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
