...
############################# Head ############################
head_title: "EMLX to DOT Conversion in Java – Convert EMLX to DOT"
head_description: "Convert EMLX to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMLX Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMLX to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMLX file to DOT in few lines of code.
...
demos:
    enable: true
    title: "EMLX to DOT Live Demos"
    content: |
        Convert EMLX to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
