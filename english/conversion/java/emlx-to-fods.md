...
############################# Head ############################
head_title: "EMLX to FODS Conversion in Java – Convert EMLX to FODS"
head_description: "Convert EMLX to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMLX Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMLX to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMLX file to FODS in few lines of code.
...
demos:
    enable: true
    title: "EMLX to FODS Live Demos"
    content: |
        Convert EMLX to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
