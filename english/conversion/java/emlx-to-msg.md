...
############################# Static ############################
layout: "auto-gen"
date: 2021-05-13T14:02:22+03:00
draft: false

############################# Head ############################
head_title: "EMLX to MSG Conversion in Java – Convert EMLX to MSG"
head_description: "Convert EMLX to MSG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMLX Files to MSG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMLX to MSG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMLX file to MSG in few lines of code.

        *   Create a new instance of Converter class and load the EMLX file with full path
        *   Set ConvertOptions for the MSG document type
        *   Call the convert() method and pass the document name (full path) and format (MSG) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target MSG format
