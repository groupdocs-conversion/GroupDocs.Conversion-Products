...
############################# Head ############################
head_title: "EMLX to ODP Conversion in Java – Convert EMLX to ODP"
head_description: "Convert EMLX to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMLX Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMLX to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMLX file to ODP in few lines of code.
