...
############################# Head ############################
head_title: "EMLX to TEX Conversion in Java – Convert EMLX to TEX"
head_description: "Convert EMLX to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMLX Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMLX to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMLX file to TEX in few lines of code.
...
demos:
    enable: true
    title: "EMLX to TEX Live Demos"
    content: |
        Convert EMLX to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
