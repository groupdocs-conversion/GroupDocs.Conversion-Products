...
############################# Head ############################
head_title: "EMLX to XLSX Conversion in Java – Convert EMLX to XLSX"
head_description: "Convert EMLX to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EMLX Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EMLX to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EMLX file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "EMLX to XLSX Live Demos"
    content: |
        Convert EMLX to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
