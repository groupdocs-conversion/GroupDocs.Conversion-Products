...
############################# Head ############################
head_title: "EPS to DOCX Conversion in Java – Convert EPS to DOCX"
head_description: "Convert EPS to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPS Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPS to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPS file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "EPS to DOCX Live Demos"
    content: |
        Convert EPS to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
