...
############################# Head ############################
head_title: "EPS to FODP Conversion in Java – Convert EPS to FODP"
head_description: "Convert EPS to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPS Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPS to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPS file to FODP in few lines of code.
