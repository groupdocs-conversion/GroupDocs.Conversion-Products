...
############################# Head ############################
head_title: "EPS to ICO Conversion in Java – Convert EPS to ICO"
head_description: "Convert EPS to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPS Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPS to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPS file to ICO in few lines of code.
...
demos:
    enable: true
    title: "EPS to ICO Live Demos"
    content: |
        Convert EPS to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
