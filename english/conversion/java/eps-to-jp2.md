...
############################# Head ############################
head_title: "EPS to JP2 Conversion in Java – Convert EPS to JP2"
head_description: "Convert EPS to JP2 in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPS Files to JP2 in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPS to JP2 in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPS file to JP2 in few lines of code.
...
demos:
    enable: true
    title: "EPS to JP2 Live Demos"
    content: |
        Convert EPS to JP2 right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
