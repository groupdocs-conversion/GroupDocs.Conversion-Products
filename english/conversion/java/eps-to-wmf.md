...
############################# Head ############################
head_title: "EPS to WMF Conversion in Java – Convert EPS to WMF"
head_description: "Convert EPS to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPS Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPS to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPS file to WMF in few lines of code.
...
demos:
    enable: true
    title: "EPS to WMF Live Demos"
    content: |
        Convert EPS to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
