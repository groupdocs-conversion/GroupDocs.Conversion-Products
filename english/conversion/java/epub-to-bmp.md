...
############################# Head ############################
head_title: "EPUB to BMP Conversion in Java – Convert EPUB to BMP"
head_description: "Convert EPUB to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPUB Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPUB to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPUB file to BMP in few lines of code.
...
demos:
    enable: true
    title: "EPUB to BMP Live Demos"
    content: |
        Convert EPUB to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
