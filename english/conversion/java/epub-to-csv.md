...
############################# Head ############################
head_title: "EPUB to CSV Conversion in Java – Convert EPUB to CSV"
head_description: "Convert EPUB to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPUB Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPUB to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPUB file to CSV in few lines of code.
...
demos:
    enable: true
    title: "EPUB to CSV Live Demos"
    content: |
        Convert EPUB to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
