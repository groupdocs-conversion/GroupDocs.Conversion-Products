...
############################# Head ############################
head_title: "EPUB to HTM Conversion in Java – Convert EPUB to HTM"
head_description: "Convert EPUB to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPUB Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPUB to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPUB file to HTM in few lines of code.
...
demos:
    enable: true
    title: "EPUB to HTM Live Demos"
    content: |
        Convert EPUB to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
