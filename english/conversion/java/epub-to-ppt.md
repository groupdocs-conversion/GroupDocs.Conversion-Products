...
############################# Head ############################
head_title: "EPUB to PPT Conversion in Java – Convert EPUB to PPT"
head_description: "Convert EPUB to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPUB Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPUB to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPUB file to PPT in few lines of code.
...
demos:
    enable: true
    title: "EPUB to PPT Live Demos"
    content: |
        Convert EPUB to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
