...
############################# Head ############################
head_title: "EPUB to WMF Conversion in Java – Convert EPUB to WMF"
head_description: "Convert EPUB to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EPUB Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EPUB to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EPUB file to WMF in few lines of code.
...
demos:
    enable: true
    title: "EPUB to WMF Live Demos"
    content: |
        Convert EPUB to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
