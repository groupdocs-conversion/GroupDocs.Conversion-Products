...
############################# Head ############################
head_title: "EXCEL to EBOOK Conversion in Java – Convert EXCEL to EBOOK"
head_description: "Convert EXCEL to EBOOK in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EXCEL Files to EBOOK in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EXCEL to EBOOK in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EXCEL file to EBOOK in few lines of code.
...
demos:
    enable: true
    title: "EXCEL to EBOOK Live Demos"
    content: |
        Convert EXCEL to EBOOK right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
