...
############################# Head ############################
head_title: "EXCEL to PPSX Conversion in Java – Convert EXCEL to PPSX"
head_description: "Convert EXCEL to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EXCEL Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EXCEL to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EXCEL file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "EXCEL to PPSX Live Demos"
    content: |
        Convert EXCEL to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
