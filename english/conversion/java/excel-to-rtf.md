...
############################# Head ############################
head_title: "EXCEL to RTF Conversion in Java – Convert EXCEL to RTF"
head_description: "Convert EXCEL to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert EXCEL Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting EXCEL to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the EXCEL file to RTF in few lines of code.
...
demos:
    enable: true
    title: "EXCEL to RTF Live Demos"
    content: |
        Convert EXCEL to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
