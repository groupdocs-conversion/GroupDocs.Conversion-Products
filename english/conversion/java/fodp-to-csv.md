...
############################# Head ############################
head_title: "FODP to CSV Conversion in Java – Convert FODP to CSV"
head_description: "Convert FODP to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODP Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODP to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODP file to CSV in few lines of code.
...
demos:
    enable: true
    title: "FODP to CSV Live Demos"
    content: |
        Convert FODP to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
