...
############################# Head ############################
head_title: "FODP to DOCX Conversion in Java – Convert FODP to DOCX"
head_description: "Convert FODP to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODP Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODP to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODP file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "FODP to DOCX Live Demos"
    content: |
        Convert FODP to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
