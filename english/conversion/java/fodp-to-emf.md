...
############################# Head ############################
head_title: "FODP to EMF Conversion in Java – Convert FODP to EMF"
head_description: "Convert FODP to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODP Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODP to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODP file to EMF in few lines of code.
...
demos:
    enable: true
    title: "FODP to EMF Live Demos"
    content: |
        Convert FODP to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
