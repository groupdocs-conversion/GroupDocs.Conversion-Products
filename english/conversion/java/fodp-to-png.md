...
############################# Head ############################
head_title: "FODP to PNG Conversion in Java – Convert FODP to PNG"
head_description: "Convert FODP to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODP Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODP to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODP file to PNG in few lines of code.
...
demos:
    enable: true
    title: "FODP to PNG Live Demos"
    content: |
        Convert FODP to PNG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
