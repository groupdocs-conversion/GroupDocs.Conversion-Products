...
############################# Head ############################
head_title: "FODP to POTM Conversion in Java – Convert FODP to POTM"
head_description: "Convert FODP to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODP Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODP to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODP file to POTM in few lines of code.
...
demos:
    enable: true
    title: "FODP to POTM Live Demos"
    content: |
        Convert FODP to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
