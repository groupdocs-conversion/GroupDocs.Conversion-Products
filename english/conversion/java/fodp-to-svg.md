...
############################# Head ############################
head_title: "FODP to SVG Conversion in Java – Convert FODP to SVG"
head_description: "Convert FODP to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODP Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODP to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODP file to SVG in few lines of code.
...
demos:
    enable: true
    title: "FODP to SVG Live Demos"
    content: |
        Convert FODP to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
