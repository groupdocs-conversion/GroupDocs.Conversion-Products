...
############################# Head ############################
head_title: "FODP to XLTX Conversion in Java – Convert FODP to XLTX"
head_description: "Convert FODP to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODP Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODP to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODP file to XLTX in few lines of code.
...
demos:
    enable: true
    title: "FODP to XLTX Live Demos"
    content: |
        Convert FODP to XLTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
