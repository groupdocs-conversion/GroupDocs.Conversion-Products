...
############################# Head ############################
head_title: "FODS to DOT Conversion in Java – Convert FODS to DOT"
head_description: "Convert FODS to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to DOT in few lines of code.
...
demos:
    enable: true
    title: "FODS to DOT Live Demos"
    content: |
        Convert FODS to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
