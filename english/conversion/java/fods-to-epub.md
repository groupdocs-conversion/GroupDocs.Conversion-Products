...
############################# Head ############################
head_title: "FODS to EPUB Conversion in Java – Convert FODS to EPUB"
head_description: "Convert FODS to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "FODS to EPUB Live Demos"
    content: |
        Convert FODS to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
