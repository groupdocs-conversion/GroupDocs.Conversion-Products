...
############################# Head ############################
head_title: "FODS to FODS Conversion in Java – Convert FODS to FODS"
head_description: "Convert FODS to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to FODS in few lines of code.
...
demos:
    enable: true
    title: "FODS to FODS Live Demos"
    content: |
        Convert FODS to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
