...
############################# Head ############################
head_title: "FODS to HTML Conversion in Java – Convert FODS to HTML"
head_description: "Convert FODS to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to HTML in few lines of code.
...
demos:
    enable: true
    title: "FODS to HTML Live Demos"
    content: |
        Convert FODS to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
