...
############################# Head ############################
head_title: "FODS to MD Conversion in Java – Convert FODS to MD"
head_description: "Convert FODS to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to MD in few lines of code.
