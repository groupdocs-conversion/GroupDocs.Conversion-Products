...
############################# Head ############################
head_title: "FODS to OTP Conversion in Java – Convert FODS to OTP"
head_description: "Convert FODS to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to OTP in few lines of code.
...
demos:
    enable: true
    title: "FODS to OTP Live Demos"
    content: |
        Convert FODS to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
