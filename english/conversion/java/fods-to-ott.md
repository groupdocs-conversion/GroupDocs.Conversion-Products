...
############################# Head ############################
head_title: "FODS to OTT Conversion in Java – Convert FODS to OTT"
head_description: "Convert FODS to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to OTT in few lines of code.
...
demos:
    enable: true
    title: "FODS to OTT Live Demos"
    content: |
        Convert FODS to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
