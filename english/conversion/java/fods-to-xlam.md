...
############################# Head ############################
head_title: "FODS to XLAM Conversion in Java – Convert FODS to XLAM"
head_description: "Convert FODS to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "FODS to XLAM Live Demos"
    content: |
        Convert FODS to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
