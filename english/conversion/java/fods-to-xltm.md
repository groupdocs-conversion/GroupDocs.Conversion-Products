...
############################# Head ############################
head_title: "FODS to XLTM Conversion in Java – Convert FODS to XLTM"
head_description: "Convert FODS to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert FODS Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting FODS to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the FODS file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "FODS to XLTM Live Demos"
    content: |
        Convert FODS to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
