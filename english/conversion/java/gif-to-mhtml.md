...
############################# Head ############################
head_title: "GIF to MHTML Conversion in Java – Convert GIF to MHTML"
head_description: "Convert GIF to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert GIF Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting GIF to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the GIF file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "GIF to MHTML Live Demos"
    content: |
        Convert GIF to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
