...
############################# Head ############################
head_title: "GIF to PPS Conversion in Java – Convert GIF to PPS"
head_description: "Convert GIF to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert GIF Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting GIF to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the GIF file to PPS in few lines of code.
