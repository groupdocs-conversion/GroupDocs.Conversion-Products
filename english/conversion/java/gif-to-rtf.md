...
############################# Head ############################
head_title: "GIF to RTF Conversion in Java – Convert GIF to RTF"
head_description: "Convert GIF to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert GIF Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting GIF to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the GIF file to RTF in few lines of code.
...
demos:
    enable: true
    title: "GIF to RTF Live Demos"
    content: |
        Convert GIF to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
