...
############################# Head ############################
head_title: "HTM to DIF Conversion in Java – Convert HTM to DIF"
head_description: "Convert HTM to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to DIF in few lines of code.
...
demos:
    enable: true
    title: "HTM to DIF Live Demos"
    content: |
        Convert HTM to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
