...
############################# Head ############################
head_title: "HTM to DOCX Conversion in Java – Convert HTM to DOCX"
head_description: "Convert HTM to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "HTM to DOCX Live Demos"
    content: |
        Convert HTM to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
