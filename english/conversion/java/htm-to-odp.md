...
############################# Head ############################
head_title: "HTM to ODP Conversion in Java – Convert HTM to ODP"
head_description: "Convert HTM to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to ODP in few lines of code.
...
demos:
    enable: true
    title: "HTM to ODP Live Demos"
    content: |
        Convert HTM to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
