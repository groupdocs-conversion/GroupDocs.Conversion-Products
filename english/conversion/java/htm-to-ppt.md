...
############################# Head ############################
head_title: "HTM to PPT Conversion in Java – Convert HTM to PPT"
head_description: "Convert HTM to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to PPT in few lines of code.
