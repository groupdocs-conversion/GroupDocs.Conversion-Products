...
############################# Head ############################
head_title: "HTM to RTF Conversion in Java – Convert HTM to RTF"
head_description: "Convert HTM to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to RTF in few lines of code.
...
demos:
    enable: true
    title: "HTM to RTF Live Demos"
    content: |
        Convert HTM to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
