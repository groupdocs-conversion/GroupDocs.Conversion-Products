...
############################# Head ############################
head_title: "HTM to SVGZ Conversion in Java – Convert HTM to SVGZ"
head_description: "Convert HTM to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to SVGZ in few lines of code.
