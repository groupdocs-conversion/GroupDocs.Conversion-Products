...
############################# Head ############################
head_title: "HTM to WEBP Conversion in Java – Convert HTM to WEBP"
head_description: "Convert HTM to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to WEBP in few lines of code.
