...
############################# Head ############################
head_title: "HTM to XLTM Conversion in Java – Convert HTM to XLTM"
head_description: "Convert HTM to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTM Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTM to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTM file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "HTM to XLTM Live Demos"
    content: |
        Convert HTM to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
