...
############################# Head ############################
head_title: "HTML to FODS Conversion in Java – Convert HTML to FODS"
head_description: "Convert HTML to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to FODS in few lines of code.
