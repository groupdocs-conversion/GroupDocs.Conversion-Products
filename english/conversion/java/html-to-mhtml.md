...
############################# Head ############################
head_title: "HTML to MHTML Conversion in Java – Convert HTML to MHTML"
head_description: "Convert HTML to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "HTML to MHTML Live Demos"
    content: |
        Convert HTML to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
