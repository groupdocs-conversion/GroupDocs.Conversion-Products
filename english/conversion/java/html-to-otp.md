...
############################# Head ############################
head_title: "HTML to OTP Conversion in Java – Convert HTML to OTP"
head_description: "Convert HTML to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to OTP in few lines of code.
...
demos:
    enable: true
    title: "HTML to OTP Live Demos"
    content: |
        Convert HTML to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
