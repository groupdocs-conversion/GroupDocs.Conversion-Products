...
############################# Head ############################
head_title: "HTML to POT Conversion in Java – Convert HTML to POT"
head_description: "Convert HTML to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to POT in few lines of code.
...
demos:
    enable: true
    title: "HTML to POT Live Demos"
    content: |
        Convert HTML to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
