...
############################# Head ############################
head_title: "HTML to POTM Conversion in Java – Convert HTML to POTM"
head_description: "Convert HTML to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to POTM in few lines of code.
...
demos:
    enable: true
    title: "HTML to POTM Live Demos"
    content: |
        Convert HTML to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
