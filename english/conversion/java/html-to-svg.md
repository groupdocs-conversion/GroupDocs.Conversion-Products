...
############################# Head ############################
head_title: "HTML to SVG Conversion in Java – Convert HTML to SVG"
head_description: "Convert HTML to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to SVG in few lines of code.
