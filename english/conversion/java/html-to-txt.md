...
############################# Head ############################
head_title: "HTML to TXT Conversion in Java – Convert HTML to TXT"
head_description: "Convert HTML to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert HTML Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting HTML to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the HTML file to TXT in few lines of code.
...
demos:
    enable: true
    title: "HTML to TXT Live Demos"
    content: |
        Convert HTML to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
