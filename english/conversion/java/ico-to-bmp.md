...
############################# Head ############################
head_title: "ICO to BMP Conversion in Java – Convert ICO to BMP"
head_description: "Convert ICO to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to BMP in few lines of code.
...
demos:
    enable: true
    title: "ICO to BMP Live Demos"
    content: |
        Convert ICO to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
