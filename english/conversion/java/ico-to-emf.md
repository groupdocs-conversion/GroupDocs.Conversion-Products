...
############################# Head ############################
head_title: "ICO to EMF Conversion in Java – Convert ICO to EMF"
head_description: "Convert ICO to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to EMF in few lines of code.
