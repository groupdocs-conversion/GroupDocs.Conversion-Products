...
############################# Head ############################
head_title: "ICO to EPUB Conversion in Java – Convert ICO to EPUB"
head_description: "Convert ICO to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to EPUB in few lines of code.
