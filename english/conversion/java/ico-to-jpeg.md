...
############################# Head ############################
head_title: "ICO to JPEG Conversion in Java – Convert ICO to JPEG"
head_description: "Convert ICO to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "ICO to JPEG Live Demos"
    content: |
        Convert ICO to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
