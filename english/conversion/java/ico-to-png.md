...
############################# Head ############################
head_title: "ICO to PNG Conversion in Java – Convert ICO to PNG"
head_description: "Convert ICO to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to PNG in few lines of code.
