...
############################# Head ############################
head_title: "ICO to POT Conversion in Java – Convert ICO to POT"
head_description: "Convert ICO to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to POT in few lines of code.
...
demos:
    enable: true
    title: "ICO to POT Live Demos"
    content: |
        Convert ICO to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
