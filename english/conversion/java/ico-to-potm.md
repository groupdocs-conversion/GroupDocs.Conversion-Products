...
############################# Head ############################
head_title: "ICO to POTM Conversion in Java – Convert ICO to POTM"
head_description: "Convert ICO to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to POTM in few lines of code.
...
demos:
    enable: true
    title: "ICO to POTM Live Demos"
    content: |
        Convert ICO to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
