...
############################# Head ############################
head_title: "ICO to WMF Conversion in Java – Convert ICO to WMF"
head_description: "Convert ICO to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to WMF in few lines of code.
...
demos:
    enable: true
    title: "ICO to WMF Live Demos"
    content: |
        Convert ICO to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
