...
############################# Head ############################
head_title: "ICO to XLAM Conversion in Java – Convert ICO to XLAM"
head_description: "Convert ICO to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "ICO to XLAM Live Demos"
    content: |
        Convert ICO to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
