...
############################# Head ############################
head_title: "ICO to XLSM Conversion in Java – Convert ICO to XLSM"
head_description: "Convert ICO to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ICO Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ICO to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ICO file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "ICO to XLSM Live Demos"
    content: |
        Convert ICO to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
