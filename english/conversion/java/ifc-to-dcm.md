...
############################# Head ############################
head_title: "IFC to DCM Conversion in Java – Convert IFC to DCM"
head_description: "Convert IFC to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to DCM in few lines of code.
...
demos:
    enable: true
    title: "IFC to DCM Live Demos"
    content: |
        Convert IFC to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
