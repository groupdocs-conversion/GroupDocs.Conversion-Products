...
############################# Head ############################
head_title: "IFC to DIF Conversion in Java – Convert IFC to DIF"
head_description: "Convert IFC to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to DIF in few lines of code.
...
demos:
    enable: true
    title: "IFC to DIF Live Demos"
    content: |
        Convert IFC to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
