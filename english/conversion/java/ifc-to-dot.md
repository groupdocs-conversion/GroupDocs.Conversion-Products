...
############################# Head ############################
head_title: "IFC to DOT Conversion in Java – Convert IFC to DOT"
head_description: "Convert IFC to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to DOT in few lines of code.
...
demos:
    enable: true
    title: "IFC to DOT Live Demos"
    content: |
        Convert IFC to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
