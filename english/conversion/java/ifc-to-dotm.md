...
############################# Head ############################
head_title: "IFC to DOTM Conversion in Java – Convert IFC to DOTM"
head_description: "Convert IFC to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "IFC to DOTM Live Demos"
    content: |
        Convert IFC to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
