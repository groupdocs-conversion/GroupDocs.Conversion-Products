...
############################# Head ############################
head_title: "IFC to FODS Conversion in Java – Convert IFC to FODS"
head_description: "Convert IFC to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to FODS in few lines of code.
...
demos:
    enable: true
    title: "IFC to FODS Live Demos"
    content: |
        Convert IFC to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
