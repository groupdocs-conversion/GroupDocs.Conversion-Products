...
############################# Head ############################
head_title: "IFC to JPEG Conversion in Java – Convert IFC to JPEG"
head_description: "Convert IFC to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "IFC to JPEG Live Demos"
    content: |
        Convert IFC to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
