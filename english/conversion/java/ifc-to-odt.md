...
############################# Head ############################
head_title: "IFC to ODT Conversion in Java – Convert IFC to ODT"
head_description: "Convert IFC to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to ODT in few lines of code.
...
demos:
    enable: true
    title: "IFC to ODT Live Demos"
    content: |
        Convert IFC to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
