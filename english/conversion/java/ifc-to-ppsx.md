...
############################# Head ############################
head_title: "IFC to PPSX Conversion in Java – Convert IFC to PPSX"
head_description: "Convert IFC to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "IFC to PPSX Live Demos"
    content: |
        Convert IFC to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
