...
############################# Head ############################
head_title: "IFC to PSD Conversion in Java – Convert IFC to PSD"
head_description: "Convert IFC to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to PSD in few lines of code.
