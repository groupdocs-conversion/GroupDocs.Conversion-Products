...
############################# Head ############################
head_title: "IFC to XLSX Conversion in Java – Convert IFC to XLSX"
head_description: "Convert IFC to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to XLSX in few lines of code.
