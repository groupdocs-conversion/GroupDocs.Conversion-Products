...
############################# Head ############################
head_title: "IFC to XLT Conversion in Java – Convert IFC to XLT"
head_description: "Convert IFC to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IFC Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IFC to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IFC file to XLT in few lines of code.
...
demos:
    enable: true
    title: "IFC to XLT Live Demos"
    content: |
        Convert IFC to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
