...
############################# Head ############################
head_title: "IGS to DIF Conversion in Java – Convert IGS to DIF"
head_description: "Convert IGS to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to DIF in few lines of code.
...
demos:
    enable: true
    title: "IGS to DIF Live Demos"
    content: |
        Convert IGS to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
