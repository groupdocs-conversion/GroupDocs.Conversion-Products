...
############################# Head ############################
head_title: "IGS to DOT Conversion in Java – Convert IGS to DOT"
head_description: "Convert IGS to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to DOT in few lines of code.
...
demos:
    enable: true
    title: "IGS to DOT Live Demos"
    content: |
        Convert IGS to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
