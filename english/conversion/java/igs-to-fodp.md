...
############################# Head ############################
head_title: "IGS to FODP Conversion in Java – Convert IGS to FODP"
head_description: "Convert IGS to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to FODP in few lines of code.
