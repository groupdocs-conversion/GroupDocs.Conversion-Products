...
############################# Head ############################
head_title: "IGS to HTM Conversion in Java – Convert IGS to HTM"
head_description: "Convert IGS to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to HTM in few lines of code.
