...
############################# Head ############################
head_title: "IGS to IGS Conversion in Java – Convert IGS to IGS"
head_description: "Convert IGS to IGS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to IGS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to IGS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to IGS in few lines of code.

        *   Create a new instance of Converter class and load the IGS file with full path
        *   Set ConvertOptions for the IGS document type
        *   Call the convert() method and pass the document name (full path) and format (IGS) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target IGS format
...
demos:
    enable: true
    title: "IGS to IGS Live Demos"
    content: |
        Convert IGS to IGS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
