...
############################# Head ############################
head_title: "IGS to JPG Conversion in Java – Convert IGS to JPG"
head_description: "Convert IGS to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to JPG in few lines of code.
...
demos:
    enable: true
    title: "IGS to JPG Live Demos"
    content: |
        Convert IGS to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
