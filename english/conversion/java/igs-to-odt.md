...
############################# Head ############################
head_title: "IGS to ODT Conversion in Java – Convert IGS to ODT"
head_description: "Convert IGS to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to ODT in few lines of code.
...
demos:
    enable: true
    title: "IGS to ODT Live Demos"
    content: |
        Convert IGS to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
