...
############################# Head ############################
head_title: "IGS to OTT Conversion in Java – Convert IGS to OTT"
head_description: "Convert IGS to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to OTT in few lines of code.
...
demos:
    enable: true
    title: "IGS to OTT Live Demos"
    content: |
        Convert IGS to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
