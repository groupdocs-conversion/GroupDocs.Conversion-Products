...
############################# Head ############################
head_title: "IGS to PSD Conversion in Java – Convert IGS to PSD"
head_description: "Convert IGS to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to PSD in few lines of code.
...
demos:
    enable: true
    title: "IGS to PSD Live Demos"
    content: |
        Convert IGS to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
