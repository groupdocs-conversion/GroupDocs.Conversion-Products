...
############################# Head ############################
head_title: "IGS to RTF Conversion in Java – Convert IGS to RTF"
head_description: "Convert IGS to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to RTF in few lines of code.
...
demos:
    enable: true
    title: "IGS to RTF Live Demos"
    content: |
        Convert IGS to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
