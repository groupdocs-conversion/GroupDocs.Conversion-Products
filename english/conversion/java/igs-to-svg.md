...
############################# Head ############################
head_title: "IGS to SVG Conversion in Java – Convert IGS to SVG"
head_description: "Convert IGS to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to SVG in few lines of code.
...
demos:
    enable: true
    title: "IGS to SVG Live Demos"
    content: |
        Convert IGS to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
