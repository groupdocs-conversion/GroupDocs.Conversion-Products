...
############################# Head ############################
head_title: "IGS to XLS Conversion in Java – Convert IGS to XLS"
head_description: "Convert IGS to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to XLS in few lines of code.
...
demos:
    enable: true
    title: "IGS to XLS Live Demos"
    content: |
        Convert IGS to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
