...
############################# Head ############################
head_title: "IGS to XLTM Conversion in Java – Convert IGS to XLTM"
head_description: "Convert IGS to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "IGS to XLTM Live Demos"
    content: |
        Convert IGS to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
