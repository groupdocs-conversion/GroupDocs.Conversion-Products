...
############################# Head ############################
head_title: "IGS to XLTX Conversion in Java – Convert IGS to XLTX"
head_description: "Convert IGS to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IGS Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IGS to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IGS file to XLTX in few lines of code.
