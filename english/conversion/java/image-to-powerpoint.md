...
############################# Head ############################
head_title: "IMAGE to POWERPOINT Conversion in Java – Convert IMAGE to POWERPOINT"
head_description: "Convert IMAGE to POWERPOINT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IMAGE Files to POWERPOINT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IMAGE to POWERPOINT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IMAGE file to POWERPOINT in few lines of code.
