...
############################# Head ############################
head_title: "IMAGE to WEB Conversion in Java – Convert IMAGE to WEB"
head_description: "Convert IMAGE to WEB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert IMAGE Files to WEB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting IMAGE to WEB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the IMAGE file to WEB in few lines of code.
