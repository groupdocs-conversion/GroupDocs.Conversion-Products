...
############################# Head ############################
head_title: "JLS to DOT Conversion in Java – Convert JLS to DOT"
head_description: "Convert JLS to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to DOT in few lines of code.
...
demos:
    enable: true
    title: "JLS to DOT Live Demos"
    content: |
        Convert JLS to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
