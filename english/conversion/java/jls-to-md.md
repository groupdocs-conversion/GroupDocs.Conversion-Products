...
############################# Head ############################
head_title: "JLS to MD Conversion in Java – Convert JLS to MD"
head_description: "Convert JLS to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to MD in few lines of code.
...
demos:
    enable: true
    title: "JLS to MD Live Demos"
    content: |
        Convert JLS to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
