...
############################# Head ############################
head_title: "JLS to MHT Conversion in Java – Convert JLS to MHT"
head_description: "Convert JLS to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to MHT in few lines of code.
