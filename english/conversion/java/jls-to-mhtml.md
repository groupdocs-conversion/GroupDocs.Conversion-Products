...
############################# Head ############################
head_title: "JLS to MHTML Conversion in Java – Convert JLS to MHTML"
head_description: "Convert JLS to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to MHTML in few lines of code.
...
demos:
    enable: true
    title: "JLS to MHTML Live Demos"
    content: |
        Convert JLS to MHTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
