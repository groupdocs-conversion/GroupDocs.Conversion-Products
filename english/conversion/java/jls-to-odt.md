...
############################# Head ############################
head_title: "JLS to ODT Conversion in Java – Convert JLS to ODT"
head_description: "Convert JLS to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to ODT in few lines of code.
...
demos:
    enable: true
    title: "JLS to ODT Live Demos"
    content: |
        Convert JLS to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
