...
############################# Head ############################
head_title: "JLS to OTP Conversion in Java – Convert JLS to OTP"
head_description: "Convert JLS to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to OTP in few lines of code.
...
demos:
    enable: true
    title: "JLS to OTP Live Demos"
    content: |
        Convert JLS to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
