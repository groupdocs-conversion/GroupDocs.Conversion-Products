...
############################# Head ############################
head_title: "JLS to XLSX Conversion in Java – Convert JLS to XLSX"
head_description: "Convert JLS to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "JLS to XLSX Live Demos"
    content: |
        Convert JLS to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
