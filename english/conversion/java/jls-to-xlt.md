...
############################# Head ############################
head_title: "JLS to XLT Conversion in Java – Convert JLS to XLT"
head_description: "Convert JLS to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to XLT in few lines of code.
...
demos:
    enable: true
    title: "JLS to XLT Live Demos"
    content: |
        Convert JLS to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
