...
############################# Head ############################
head_title: "JLS to XLTX Conversion in Java – Convert JLS to XLTX"
head_description: "Convert JLS to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JLS Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JLS to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JLS file to XLTX in few lines of code.
