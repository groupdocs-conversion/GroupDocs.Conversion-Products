...
############################# Head ############################
head_title: "JP2 to JP2 Conversion in Java – Convert JP2 to JP2"
head_description: "Convert JP2 to JP2 in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JP2 Files to JP2 in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JP2 to JP2 in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JP2 file to JP2 in few lines of code.
