...
############################# Head ############################
head_title: "JP2 to TSV Conversion in Java – Convert JP2 to TSV"
head_description: "Convert JP2 to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JP2 Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JP2 to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JP2 file to TSV in few lines of code.
