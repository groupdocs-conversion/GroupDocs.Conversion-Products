...
############################# Head ############################
head_title: "JPC to FODS Conversion in Java – Convert JPC to FODS"
head_description: "Convert JPC to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPC Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPC to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPC file to FODS in few lines of code.
...
demos:
    enable: true
    title: "JPC to FODS Live Demos"
    content: |
        Convert JPC to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
