...
############################# Head ############################
head_title: "JPC to JPEG Conversion in Java – Convert JPC to JPEG"
head_description: "Convert JPC to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPC Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPC to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPC file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "JPC to JPEG Live Demos"
    content: |
        Convert JPC to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
