...
############################# Head ############################
head_title: "JPC to ODS Conversion in Java – Convert JPC to ODS"
head_description: "Convert JPC to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPC Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPC to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPC file to ODS in few lines of code.
...
demos:
    enable: true
    title: "JPC to ODS Live Demos"
    content: |
        Convert JPC to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
