...
############################# Head ############################
head_title: "JPEG-LS to JPG Conversion in Java – Convert JPEG-LS to JPG"
head_description: "Convert JPEG-LS to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG-LS Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG-LS to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG-LS file to JPG in few lines of code.
