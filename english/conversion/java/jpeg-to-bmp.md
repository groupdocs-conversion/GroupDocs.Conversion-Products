...
############################# Head ############################
head_title: "JPEG to BMP Conversion in Java – Convert JPEG to BMP"
head_description: "Convert JPEG to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to BMP in few lines of code.
...
demos:
    enable: true
    title: "JPEG to BMP Live Demos"
    content: |
        Convert JPEG to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
