...
############################# Head ############################
head_title: "JPEG to DIF Conversion in Java – Convert JPEG to DIF"
head_description: "Convert JPEG to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to DIF in few lines of code.
...
demos:
    enable: true
    title: "JPEG to DIF Live Demos"
    content: |
        Convert JPEG to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
