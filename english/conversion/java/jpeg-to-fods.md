...
############################# Head ############################
head_title: "JPEG to FODS Conversion in Java – Convert JPEG to FODS"
head_description: "Convert JPEG to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to FODS in few lines of code.
