...
############################# Head ############################
head_title: "JPEG to SVGZ Conversion in Java – Convert JPEG to SVGZ"
head_description: "Convert JPEG to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to SVGZ in few lines of code.
...
demos:
    enable: true
    title: "JPEG to SVGZ Live Demos"
    content: |
        Convert JPEG to SVGZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
