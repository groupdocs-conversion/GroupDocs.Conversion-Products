...
############################# Head ############################
head_title: "JPEG to TIF Conversion in Java – Convert JPEG to TIF"
head_description: "Convert JPEG to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to TIF in few lines of code.
...
demos:
    enable: true
    title: "JPEG to TIF Live Demos"
    content: |
        Convert JPEG to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
