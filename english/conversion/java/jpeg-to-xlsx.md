...
############################# Head ############################
head_title: "JPEG to XLSX Conversion in Java – Convert JPEG to XLSX"
head_description: "Convert JPEG to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "JPEG to XLSX Live Demos"
    content: |
        Convert JPEG to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
