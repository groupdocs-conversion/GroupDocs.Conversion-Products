...
############################# Head ############################
head_title: "JPEG to XPS Conversion in Java – Convert JPEG to XPS"
head_description: "Convert JPEG to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPEG Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPEG to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPEG file to XPS in few lines of code.
...
demos:
    enable: true
    title: "JPEG to XPS Live Demos"
    content: |
        Convert JPEG to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
