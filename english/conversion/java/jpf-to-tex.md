...
############################# Head ############################
head_title: "JPF to TEX Conversion in Java – Convert JPF to TEX"
head_description: "Convert JPF to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPF Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPF to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPF file to TEX in few lines of code.
...
demos:
    enable: true
    title: "JPF to TEX Live Demos"
    content: |
        Convert JPF to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
