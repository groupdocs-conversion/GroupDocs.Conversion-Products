...
############################# Head ############################
head_title: "JPG to DOCX Conversion in Java – Convert JPG to DOCX"
head_description: "Convert JPG to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to DOCX in few lines of code.
