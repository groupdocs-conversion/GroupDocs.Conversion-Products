...
############################# Head ############################
head_title: "JPG to EMZ Conversion in Java – Convert JPG to EMZ"
head_description: "Convert JPG to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to EMZ in few lines of code.
...
demos:
    enable: true
    title: "JPG to EMZ Live Demos"
    content: |
        Convert JPG to EMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
