...
############################# Head ############################
head_title: "JPG to GIF Conversion in Java – Convert JPG to GIF"
head_description: "Convert JPG to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to GIF in few lines of code.
...
demos:
    enable: true
    title: "JPG to GIF Live Demos"
    content: |
        Convert JPG to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
