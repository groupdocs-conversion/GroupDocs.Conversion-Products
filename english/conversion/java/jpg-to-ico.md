...
############################# Head ############################
head_title: "JPG to ICO Conversion in Java – Convert JPG to ICO"
head_description: "Convert JPG to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to ICO in few lines of code.
...
demos:
    enable: true
    title: "JPG to ICO Live Demos"
    content: |
        Convert JPG to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
