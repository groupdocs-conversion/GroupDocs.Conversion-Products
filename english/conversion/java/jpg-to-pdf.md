...
############################# Head ############################
head_title: "JPG to PDF Conversion in Java – Convert JPG to PDF"
head_description: "Convert JPG to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to PDF in few lines of code.
...
demos:
    enable: true
    title: "JPG to PDF Live Demos"
    content: |
        Convert JPG to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
