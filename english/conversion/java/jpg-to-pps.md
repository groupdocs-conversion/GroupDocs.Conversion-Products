...
############################# Head ############################
head_title: "JPG to PPS Conversion in Java – Convert JPG to PPS"
head_description: "Convert JPG to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to PPS in few lines of code.
...
demos:
    enable: true
    title: "JPG to PPS Live Demos"
    content: |
        Convert JPG to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
