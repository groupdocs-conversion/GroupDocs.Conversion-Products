...
############################# Head ############################
head_title: "JPG to SVG Conversion in Java – Convert JPG to SVG"
head_description: "Convert JPG to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to SVG in few lines of code.
...
demos:
    enable: true
    title: "JPG to SVG Live Demos"
    content: |
        Convert JPG to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
