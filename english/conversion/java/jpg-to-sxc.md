...
############################# Head ############################
head_title: "JPG to SXC Conversion in Java – Convert JPG to SXC"
head_description: "Convert JPG to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to SXC in few lines of code.
...
demos:
    enable: true
    title: "JPG to SXC Live Demos"
    content: |
        Convert JPG to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
