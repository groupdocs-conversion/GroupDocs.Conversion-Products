...
############################# Head ############################
head_title: "JPG to TEX Conversion in Java – Convert JPG to TEX"
head_description: "Convert JPG to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to TEX in few lines of code.
...
demos:
    enable: true
    title: "JPG to TEX Live Demos"
    content: |
        Convert JPG to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
