...
############################# Head ############################
head_title: "JPG to TIF Conversion in Java – Convert JPG to TIF"
head_description: "Convert JPG to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to TIF in few lines of code.
...
demos:
    enable: true
    title: "JPG to TIF Live Demos"
    content: |
        Convert JPG to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
