...
############################# Head ############################
head_title: "JPG to XLAM Conversion in Java – Convert JPG to XLAM"
head_description: "Convert JPG to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "JPG to XLAM Live Demos"
    content: |
        Convert JPG to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
