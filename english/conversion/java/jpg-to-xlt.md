...
############################# Head ############################
head_title: "JPG to XLT Conversion in Java – Convert JPG to XLT"
head_description: "Convert JPG to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPG Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPG to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPG file to XLT in few lines of code.
...
demos:
    enable: true
    title: "JPG to XLT Live Demos"
    content: |
        Convert JPG to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
