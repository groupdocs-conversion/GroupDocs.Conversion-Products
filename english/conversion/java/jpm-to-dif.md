...
############################# Head ############################
head_title: "JPM to DIF Conversion in Java – Convert JPM to DIF"
head_description: "Convert JPM to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPM Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPM to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPM file to DIF in few lines of code.
...
demos:
    enable: true
    title: "JPM to DIF Live Demos"
    content: |
        Convert JPM to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
