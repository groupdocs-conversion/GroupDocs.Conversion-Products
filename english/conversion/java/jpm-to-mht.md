...
############################# Head ############################
head_title: "JPM to MHT Conversion in Java – Convert JPM to MHT"
head_description: "Convert JPM to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPM Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPM to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPM file to MHT in few lines of code.
