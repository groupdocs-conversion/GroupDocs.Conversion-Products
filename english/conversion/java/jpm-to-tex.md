...
############################# Head ############################
head_title: "JPM to TEX Conversion in Java – Convert JPM to TEX"
head_description: "Convert JPM to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPM Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPM to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPM file to TEX in few lines of code.
...
demos:
    enable: true
    title: "JPM to TEX Live Demos"
    content: |
        Convert JPM to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
