...
############################# Head ############################
head_title: "JPM to TSV Conversion in Java – Convert JPM to TSV"
head_description: "Convert JPM to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPM Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPM to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPM file to TSV in few lines of code.
...
demos:
    enable: true
    title: "JPM to TSV Live Demos"
    content: |
        Convert JPM to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
