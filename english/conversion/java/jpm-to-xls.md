...
############################# Head ############################
head_title: "JPM to XLS Conversion in Java – Convert JPM to XLS"
head_description: "Convert JPM to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPM Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPM to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPM file to XLS in few lines of code.
...
demos:
    enable: true
    title: "JPM to XLS Live Demos"
    content: |
        Convert JPM to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
