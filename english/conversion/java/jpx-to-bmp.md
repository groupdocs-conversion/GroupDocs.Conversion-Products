...
############################# Head ############################
head_title: "JPX to BMP Conversion in Java – Convert JPX to BMP"
head_description: "Convert JPX to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to BMP in few lines of code.
...
demos:
    enable: true
    title: "JPX to BMP Live Demos"
    content: |
        Convert JPX to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
