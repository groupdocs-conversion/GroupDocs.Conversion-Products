...
############################# Head ############################
head_title: "JPX to CSV Conversion in Java – Convert JPX to CSV"
head_description: "Convert JPX to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to CSV in few lines of code.
...
demos:
    enable: true
    title: "JPX to CSV Live Demos"
    content: |
        Convert JPX to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
