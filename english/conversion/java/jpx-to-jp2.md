...
############################# Head ############################
head_title: "JPX to JP2 Conversion in Java – Convert JPX to JP2"
head_description: "Convert JPX to JP2 in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to JP2 in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to JP2 in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to JP2 in few lines of code.
