...
############################# Head ############################
head_title: "JPX to JPEG Conversion in Java – Convert JPX to JPEG"
head_description: "Convert JPX to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to JPEG in few lines of code.
