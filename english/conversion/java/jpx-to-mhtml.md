...
############################# Head ############################
head_title: "JPX to MHTML Conversion in Java – Convert JPX to MHTML"
head_description: "Convert JPX to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to MHTML in few lines of code.
