...
############################# Head ############################
head_title: "JPX to ODS Conversion in Java – Convert JPX to ODS"
head_description: "Convert JPX to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to ODS in few lines of code.
...
demos:
    enable: true
    title: "JPX to ODS Live Demos"
    content: |
        Convert JPX to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
