...
############################# Head ############################
head_title: "JPX to OTP Conversion in Java – Convert JPX to OTP"
head_description: "Convert JPX to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to OTP in few lines of code.
...
demos:
    enable: true
    title: "JPX to OTP Live Demos"
    content: |
        Convert JPX to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
