...
############################# Head ############################
head_title: "JPX to PPTX Conversion in Java – Convert JPX to PPTX"
head_description: "Convert JPX to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "JPX to PPTX Live Demos"
    content: |
        Convert JPX to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
