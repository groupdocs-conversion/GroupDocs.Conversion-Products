...
############################# Head ############################
head_title: "JPX to RTF Conversion in Java – Convert JPX to RTF"
head_description: "Convert JPX to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to RTF in few lines of code.
