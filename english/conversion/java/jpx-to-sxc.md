...
############################# Head ############################
head_title: "JPX to SXC Conversion in Java – Convert JPX to SXC"
head_description: "Convert JPX to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to SXC in few lines of code.
...
demos:
    enable: true
    title: "JPX to SXC Live Demos"
    content: |
        Convert JPX to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
