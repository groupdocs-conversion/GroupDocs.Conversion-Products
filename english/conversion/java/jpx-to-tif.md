...
############################# Head ############################
head_title: "JPX to TIF Conversion in Java – Convert JPX to TIF"
head_description: "Convert JPX to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to TIF in few lines of code.
...
demos:
    enable: true
    title: "JPX to TIF Live Demos"
    content: |
        Convert JPX to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
