...
############################# Head ############################
head_title: "JPX to XPS Conversion in Java – Convert JPX to XPS"
head_description: "Convert JPX to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert JPX Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting JPX to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the JPX file to XPS in few lines of code.
...
demos:
    enable: true
    title: "JPX to XPS Live Demos"
    content: |
        Convert JPX to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
