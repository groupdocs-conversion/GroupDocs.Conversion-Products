...
############################# Head ############################
head_title: "LOG to DOCX Conversion in Java – Convert LOG to DOCX"
head_description: "Convert LOG to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "LOG to DOCX Live Demos"
    content: |
        Convert LOG to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
