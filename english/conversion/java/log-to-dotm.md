...
############################# Head ############################
head_title: "LOG to DOTM Conversion in Java – Convert LOG to DOTM"
head_description: "Convert LOG to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "LOG to DOTM Live Demos"
    content: |
        Convert LOG to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
