...
############################# Head ############################
head_title: "LOG to FODS Conversion in Java – Convert LOG to FODS"
head_description: "Convert LOG to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to FODS in few lines of code.
...
demos:
    enable: true
    title: "LOG to FODS Live Demos"
    content: |
        Convert LOG to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
