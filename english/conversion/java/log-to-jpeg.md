...
############################# Head ############################
head_title: "LOG to JPEG Conversion in Java – Convert LOG to JPEG"
head_description: "Convert LOG to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to JPEG in few lines of code.
