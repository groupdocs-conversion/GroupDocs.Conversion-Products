...
############################# Head ############################
head_title: "LOG to PSD Conversion in Java – Convert LOG to PSD"
head_description: "Convert LOG to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to PSD in few lines of code.
...
demos:
    enable: true
    title: "LOG to PSD Live Demos"
    content: |
        Convert LOG to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
