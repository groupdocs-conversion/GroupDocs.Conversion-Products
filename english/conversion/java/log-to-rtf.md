...
############################# Head ############################
head_title: "LOG to RTF Conversion in Java – Convert LOG to RTF"
head_description: "Convert LOG to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to RTF in few lines of code.
...
demos:
    enable: true
    title: "LOG to RTF Live Demos"
    content: |
        Convert LOG to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
