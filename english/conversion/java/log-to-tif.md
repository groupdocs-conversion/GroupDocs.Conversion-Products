...
############################# Head ############################
head_title: "LOG to TIF Conversion in Java – Convert LOG to TIF"
head_description: "Convert LOG to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to TIF in few lines of code.
...
demos:
    enable: true
    title: "LOG to TIF Live Demos"
    content: |
        Convert LOG to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
