...
############################# Head ############################
head_title: "LOG to XLTX Conversion in Java – Convert LOG to XLTX"
head_description: "Convert LOG to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert LOG Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting LOG to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the LOG file to XLTX in few lines of code.
...
demos:
    enable: true
    title: "LOG to XLTX Live Demos"
    content: |
        Convert LOG to XLTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
