...
############################# Head ############################
head_title: "MBOX to CSV Conversion in Java – Convert MBOX to CSV"
head_description: "Convert MBOX to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MBOX Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MBOX to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MBOX file to CSV in few lines of code.
...
demos:
    enable: true
    title: "MBOX to CSV Live Demos"
    content: |
        Convert MBOX to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
