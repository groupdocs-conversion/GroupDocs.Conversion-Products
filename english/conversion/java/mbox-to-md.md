...
############################# Head ############################
head_title: "MBOX to MD Conversion in Java – Convert MBOX to MD"
head_description: "Convert MBOX to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MBOX Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MBOX to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MBOX file to MD in few lines of code.
...
demos:
    enable: true
    title: "MBOX to MD Live Demos"
    content: |
        Convert MBOX to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
