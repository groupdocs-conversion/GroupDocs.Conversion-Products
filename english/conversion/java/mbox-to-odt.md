...
############################# Head ############################
head_title: "MBOX to ODT Conversion in Java – Convert MBOX to ODT"
head_description: "Convert MBOX to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MBOX Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MBOX to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MBOX file to ODT in few lines of code.
...
demos:
    enable: true
    title: "MBOX to ODT Live Demos"
    content: |
        Convert MBOX to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
