...
############################# Head ############################
head_title: "MBOX to PPSM Conversion in Java – Convert MBOX to PPSM"
head_description: "Convert MBOX to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MBOX Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MBOX to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MBOX file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "MBOX to PPSM Live Demos"
    content: |
        Convert MBOX to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
