...
############################# Head ############################
head_title: "MD to DOCX Conversion in Java – Convert MD to DOCX"
head_description: "Convert MD to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "MD to DOCX Live Demos"
    content: |
        Convert MD to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
