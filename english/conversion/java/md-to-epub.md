...
############################# Head ############################
head_title: "MD to EPUB Conversion in Java – Convert MD to EPUB"
head_description: "Convert MD to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "MD to EPUB Live Demos"
    content: |
        Convert MD to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
