...
############################# Head ############################
head_title: "MD to FODS Conversion in Java – Convert MD to FODS"
head_description: "Convert MD to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to FODS in few lines of code.
...
demos:
    enable: true
    title: "MD to FODS Live Demos"
    content: |
        Convert MD to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
