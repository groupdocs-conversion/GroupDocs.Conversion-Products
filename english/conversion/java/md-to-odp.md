...
############################# Head ############################
head_title: "MD to ODP Conversion in Java – Convert MD to ODP"
head_description: "Convert MD to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to ODP in few lines of code.
...
demos:
    enable: true
    title: "MD to ODP Live Demos"
    content: |
        Convert MD to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
