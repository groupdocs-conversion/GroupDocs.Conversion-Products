...
############################# Head ############################
head_title: "MD to OTT Conversion in Java – Convert MD to OTT"
head_description: "Convert MD to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to OTT in few lines of code.
