...
############################# Head ############################
head_title: "MD to POTM Conversion in Java – Convert MD to POTM"
head_description: "Convert MD to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to POTM in few lines of code.
...
demos:
    enable: true
    title: "MD to POTM Live Demos"
    content: |
        Convert MD to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
