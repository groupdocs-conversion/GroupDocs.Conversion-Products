...
############################# Head ############################
head_title: "MD to POTX Conversion in Java – Convert MD to POTX"
head_description: "Convert MD to POTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to POTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to POTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to POTX in few lines of code.
...
demos:
    enable: true
    title: "MD to POTX Live Demos"
    content: |
        Convert MD to POTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
