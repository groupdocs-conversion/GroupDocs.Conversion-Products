...
############################# Head ############################
head_title: "MD to SVGZ Conversion in Java – Convert MD to SVGZ"
head_description: "Convert MD to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to SVGZ in few lines of code.
