...
############################# Head ############################
head_title: "MD to TEX Conversion in Java – Convert MD to TEX"
head_description: "Convert MD to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to TEX in few lines of code.
