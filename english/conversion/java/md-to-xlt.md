...
############################# Head ############################
head_title: "MD to XLT Conversion in Java – Convert MD to XLT"
head_description: "Convert MD to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MD Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MD to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MD file to XLT in few lines of code.
...
demos:
    enable: true
    title: "MD to XLT Live Demos"
    content: |
        Convert MD to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
