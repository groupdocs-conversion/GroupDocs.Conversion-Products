...
############################# Head ############################
head_title: "MHT to DOTM Conversion in Java – Convert MHT to DOTM"
head_description: "Convert MHT to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to DOTM in few lines of code.
