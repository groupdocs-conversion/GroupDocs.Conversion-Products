...
############################# Head ############################
head_title: "MHT to DOTX Conversion in Java – Convert MHT to DOTX"
head_description: "Convert MHT to DOTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to DOTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to DOTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to DOTX in few lines of code.
...
demos:
    enable: true
    title: "MHT to DOTX Live Demos"
    content: |
        Convert MHT to DOTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
