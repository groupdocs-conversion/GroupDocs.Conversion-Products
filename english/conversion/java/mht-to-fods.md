...
############################# Head ############################
head_title: "MHT to FODS Conversion in Java – Convert MHT to FODS"
head_description: "Convert MHT to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to FODS in few lines of code.
...
demos:
    enable: true
    title: "MHT to FODS Live Demos"
    content: |
        Convert MHT to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
