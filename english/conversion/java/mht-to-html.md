...
############################# Head ############################
head_title: "MHT to HTML Conversion in Java – Convert MHT to HTML"
head_description: "Convert MHT to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to HTML in few lines of code.
...
demos:
    enable: true
    title: "MHT to HTML Live Demos"
    content: |
        Convert MHT to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
