...
############################# Head ############################
head_title: "MHT to MHT Conversion in Java – Convert MHT to MHT"
head_description: "Convert MHT to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to MHT in few lines of code.
...
demos:
    enable: true
    title: "MHT to MHT Live Demos"
    content: |
        Convert MHT to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
