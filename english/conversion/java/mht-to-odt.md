...
############################# Head ############################
head_title: "MHT to ODT Conversion in Java – Convert MHT to ODT"
head_description: "Convert MHT to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to ODT in few lines of code.
...
demos:
    enable: true
    title: "MHT to ODT Live Demos"
    content: |
        Convert MHT to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
