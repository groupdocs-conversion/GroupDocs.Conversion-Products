...
############################# Head ############################
head_title: "MHT to TEX Conversion in Java – Convert MHT to TEX"
head_description: "Convert MHT to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to TEX in few lines of code.
...
demos:
    enable: true
    title: "MHT to TEX Live Demos"
    content: |
        Convert MHT to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
