...
############################# Head ############################
head_title: "MHT to TIFF Conversion in Java – Convert MHT to TIFF"
head_description: "Convert MHT to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "MHT to TIFF Live Demos"
    content: |
        Convert MHT to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
