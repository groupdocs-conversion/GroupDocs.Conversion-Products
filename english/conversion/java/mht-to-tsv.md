...
############################# Head ############################
head_title: "MHT to TSV Conversion in Java – Convert MHT to TSV"
head_description: "Convert MHT to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to TSV in few lines of code.
...
demos:
    enable: true
    title: "MHT to TSV Live Demos"
    content: |
        Convert MHT to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
