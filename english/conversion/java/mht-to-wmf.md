...
############################# Head ############################
head_title: "MHT to WMF Conversion in Java – Convert MHT to WMF"
head_description: "Convert MHT to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to WMF in few lines of code.
...
demos:
    enable: true
    title: "MHT to WMF Live Demos"
    content: |
        Convert MHT to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
