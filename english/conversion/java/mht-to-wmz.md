...
############################# Head ############################
head_title: "MHT to WMZ Conversion in Java – Convert MHT to WMZ"
head_description: "Convert MHT to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to WMZ in few lines of code.
...
demos:
    enable: true
    title: "MHT to WMZ Live Demos"
    content: |
        Convert MHT to WMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
