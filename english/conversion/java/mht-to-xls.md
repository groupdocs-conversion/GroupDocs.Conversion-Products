...
############################# Head ############################
head_title: "MHT to XLS Conversion in Java – Convert MHT to XLS"
head_description: "Convert MHT to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to XLS in few lines of code.
...
demos:
    enable: true
    title: "MHT to XLS Live Demos"
    content: |
        Convert MHT to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
