...
############################# Head ############################
head_title: "MHT to XLSM Conversion in Java – Convert MHT to XLSM"
head_description: "Convert MHT to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "MHT to XLSM Live Demos"
    content: |
        Convert MHT to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
