...
############################# Head ############################
head_title: "MHT to XLT Conversion in Java – Convert MHT to XLT"
head_description: "Convert MHT to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHT Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHT to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHT file to XLT in few lines of code.
...
demos:
    enable: true
    title: "MHT to XLT Live Demos"
    content: |
        Convert MHT to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
