...
############################# Head ############################
head_title: "MHTML to DOCM Conversion in Java – Convert MHTML to DOCM"
head_description: "Convert MHTML to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHTML file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "MHTML to DOCM Live Demos"
    content: |
        Convert MHTML to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
