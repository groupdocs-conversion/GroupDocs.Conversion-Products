...
############################# Head ############################
head_title: "MHTML to DOT Conversion in Java – Convert MHTML to DOT"
head_description: "Convert MHTML to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHTML file to DOT in few lines of code.
...
demos:
    enable: true
    title: "MHTML to DOT Live Demos"
    content: |
        Convert MHTML to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
