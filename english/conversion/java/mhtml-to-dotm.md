...
############################# Head ############################
head_title: "MHTML to DOTM Conversion in Java – Convert MHTML to DOTM"
head_description: "Convert MHTML to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHTML file to DOTM in few lines of code.
