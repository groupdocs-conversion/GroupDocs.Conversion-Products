...
############################# Head ############################
head_title: "MHTML to GIF Conversion in Java – Convert MHTML to GIF"
head_description: "Convert MHTML to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHTML file to GIF in few lines of code.
...
demos:
    enable: true
    title: "MHTML to GIF Live Demos"
    content: |
        Convert MHTML to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
