...
############################# Head ############################
head_title: "MHTML to OTT Conversion in Java – Convert MHTML to OTT"
head_description: "Convert MHTML to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert the MHTML file to OTT in few lines of code.
...
demos:
    enable: true
    title: "MHTML to OTT Live Demos"
    content: |
        Convert MHTML to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
