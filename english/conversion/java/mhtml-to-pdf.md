...
############################# Head ############################
head_title: "MHTML to PDF Conversion in Java – Convert MHTML to PDF"
head_description: "Convert MHTML to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHTML file to PDF in few lines of code.
...
demos:
    enable: true
    title: "MHTML to PDF Live Demos"
    content: |
        Convert MHTML to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
