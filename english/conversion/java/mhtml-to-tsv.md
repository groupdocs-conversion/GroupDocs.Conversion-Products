...
############################# Head ############################
head_title: "MHTML to TSV Conversion in Java – Convert MHTML to TSV"
head_description: "Convert MHTML to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHTML file to TSV in few lines of code.
...
demos:
    enable: true
    title: "MHTML to TSV Live Demos"
    content: |
        Convert MHTML to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
