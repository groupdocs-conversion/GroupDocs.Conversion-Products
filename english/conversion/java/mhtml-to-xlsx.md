...
############################# Head ############################
head_title: "MHTML to XLSX Conversion in Java – Convert MHTML to XLSX"
head_description: "Convert MHTML to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHTML file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "MHTML to XLSX Live Demos"
    content: |
        Convert MHTML to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
