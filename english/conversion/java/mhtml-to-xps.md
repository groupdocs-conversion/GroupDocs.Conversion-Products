...
############################# Head ############################
head_title: "MHTML to XPS Conversion in Java – Convert MHTML to XPS"
head_description: "Convert MHTML to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MHTML Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MHTML to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MHTML file to XPS in few lines of code.
...
demos:
    enable: true
    title: "MHTML to XPS Live Demos"
    content: |
        Convert MHTML to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
