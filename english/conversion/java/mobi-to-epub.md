...
############################# Head ############################
head_title: "MOBI to EPUB Conversion in Java – Convert MOBI to EPUB"
head_description: "Convert MOBI to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MOBI Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MOBI to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MOBI file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "MOBI to EPUB Live Demos"
    content: |
        Convert MOBI to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
