...
############################# Head ############################
head_title: "MOBI to HTM Conversion in Java – Convert MOBI to HTM"
head_description: "Convert MOBI to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MOBI Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MOBI to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MOBI file to HTM in few lines of code.
...
demos:
    enable: true
    title: "MOBI to HTM Live Demos"
    content: |
        Convert MOBI to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
