...
############################# Head ############################
head_title: "MOBI to ODP Conversion in Java – Convert MOBI to ODP"
head_description: "Convert MOBI to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MOBI Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MOBI to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MOBI file to ODP in few lines of code.
...
demos:
    enable: true
    title: "MOBI to ODP Live Demos"
    content: |
        Convert MOBI to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
