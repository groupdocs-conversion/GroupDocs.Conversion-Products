...
############################# Head ############################
head_title: "MOBI to PPTX Conversion in Java – Convert MOBI to PPTX"
head_description: "Convert MOBI to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MOBI Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MOBI to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MOBI file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "MOBI to PPTX Live Demos"
    content: |
        Convert MOBI to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
