...
############################# Head ############################
head_title: "MOBI to WMF Conversion in Java – Convert MOBI to WMF"
head_description: "Convert MOBI to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MOBI Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MOBI to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MOBI file to WMF in few lines of code.
...
demos:
    enable: true
    title: "MOBI to WMF Live Demos"
    content: |
        Convert MOBI to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
