...
############################# Head ############################
head_title: "MPP to DCM Conversion in Java – Convert MPP to DCM"
head_description: "Convert MPP to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to DCM in few lines of code.
...
demos:
    enable: true
    title: "MPP to DCM Live Demos"
    content: |
        Convert MPP to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
