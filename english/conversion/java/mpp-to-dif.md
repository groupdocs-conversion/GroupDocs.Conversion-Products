...
############################# Head ############################
head_title: "MPP to DIF Conversion in Java – Convert MPP to DIF"
head_description: "Convert MPP to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to DIF in few lines of code.
...
demos:
    enable: true
    title: "MPP to DIF Live Demos"
    content: |
        Convert MPP to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
