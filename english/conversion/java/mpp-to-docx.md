...
############################# Head ############################
head_title: "MPP to DOCX Conversion in Java – Convert MPP to DOCX"
head_description: "Convert MPP to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "MPP to DOCX Live Demos"
    content: |
        Convert MPP to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
