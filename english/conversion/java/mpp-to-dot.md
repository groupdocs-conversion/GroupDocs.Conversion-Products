...
############################# Head ############################
head_title: "MPP to DOT Conversion in Java – Convert MPP to DOT"
head_description: "Convert MPP to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to DOT in few lines of code.
...
demos:
    enable: true
    title: "MPP to DOT Live Demos"
    content: |
        Convert MPP to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
