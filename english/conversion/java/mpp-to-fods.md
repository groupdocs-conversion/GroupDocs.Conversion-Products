...
############################# Head ############################
head_title: "MPP to FODS Conversion in Java – Convert MPP to FODS"
head_description: "Convert MPP to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to FODS in few lines of code.
...
demos:
    enable: true
    title: "MPP to FODS Live Demos"
    content: |
        Convert MPP to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
