...
############################# Head ############################
head_title: "MPP to ICO Conversion in Java – Convert MPP to ICO"
head_description: "Convert MPP to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to ICO in few lines of code.
