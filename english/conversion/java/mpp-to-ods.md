...
############################# Head ############################
head_title: "MPP to ODS Conversion in Java – Convert MPP to ODS"
head_description: "Convert MPP to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to ODS in few lines of code.
...
demos:
    enable: true
    title: "MPP to ODS Live Demos"
    content: |
        Convert MPP to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
