...
############################# Head ############################
head_title: "MPP to OTP Conversion in Java – Convert MPP to OTP"
head_description: "Convert MPP to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to OTP in few lines of code.
...
demos:
    enable: true
    title: "MPP to OTP Live Demos"
    content: |
        Convert MPP to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
