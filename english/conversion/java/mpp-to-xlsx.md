...
############################# Head ############################
head_title: "MPP to XLSX Conversion in Java – Convert MPP to XLSX"
head_description: "Convert MPP to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "MPP to XLSX Live Demos"
    content: |
        Convert MPP to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
