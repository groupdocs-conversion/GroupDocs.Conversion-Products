...
############################# Head ############################
head_title: "MPP to XLTM Conversion in Java – Convert MPP to XLTM"
head_description: "Convert MPP to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "MPP to XLTM Live Demos"
    content: |
        Convert MPP to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
