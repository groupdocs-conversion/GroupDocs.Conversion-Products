...
############################# Head ############################
head_title: "MPP to XLTX Conversion in Java – Convert MPP to XLTX"
head_description: "Convert MPP to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPP Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPP to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPP file to XLTX in few lines of code.
