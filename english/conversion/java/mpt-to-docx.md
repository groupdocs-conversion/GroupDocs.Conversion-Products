...
############################# Head ############################
head_title: "MPT to DOCX Conversion in Java – Convert MPT to DOCX"
head_description: "Convert MPT to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to DOCX in few lines of code.
