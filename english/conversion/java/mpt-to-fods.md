...
############################# Head ############################
head_title: "MPT to FODS Conversion in Java – Convert MPT to FODS"
head_description: "Convert MPT to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to FODS in few lines of code.
