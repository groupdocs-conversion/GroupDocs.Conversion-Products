...
############################# Head ############################
head_title: "MPT to JP2 Conversion in Java – Convert MPT to JP2"
head_description: "Convert MPT to JP2 in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to JP2 in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to JP2 in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to JP2 in few lines of code.
