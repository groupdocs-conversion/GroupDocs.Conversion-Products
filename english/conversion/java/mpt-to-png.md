...
############################# Head ############################
head_title: "MPT to PNG Conversion in Java – Convert MPT to PNG"
head_description: "Convert MPT to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to PNG in few lines of code.
