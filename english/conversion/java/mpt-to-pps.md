...
############################# Head ############################
head_title: "MPT to PPS Conversion in Java – Convert MPT to PPS"
head_description: "Convert MPT to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to PPS in few lines of code.
...
demos:
    enable: true
    title: "MPT to PPS Live Demos"
    content: |
        Convert MPT to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
