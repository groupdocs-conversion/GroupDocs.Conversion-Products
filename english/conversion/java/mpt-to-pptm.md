...
############################# Head ############################
head_title: "MPT to PPTM Conversion in Java – Convert MPT to PPTM"
head_description: "Convert MPT to PPTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to PPTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to PPTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to PPTM in few lines of code.
