...
############################# Head ############################
head_title: "MPT to TEX Conversion in Java – Convert MPT to TEX"
head_description: "Convert MPT to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPT Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPT to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPT file to TEX in few lines of code.
...
demos:
    enable: true
    title: "MPT to TEX Live Demos"
    content: |
        Convert MPT to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
