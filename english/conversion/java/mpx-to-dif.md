...
############################# Head ############################
head_title: "MPX to DIF Conversion in Java – Convert MPX to DIF"
head_description: "Convert MPX to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to DIF in few lines of code.
