...
############################# Head ############################
head_title: "MPX to HTML Conversion in Java – Convert MPX to HTML"
head_description: "Convert MPX to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to HTML in few lines of code.
...
demos:
    enable: true
    title: "MPX to HTML Live Demos"
    content: |
        Convert MPX to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
