...
############################# Head ############################
head_title: "MPX to ICO Conversion in Java – Convert MPX to ICO"
head_description: "Convert MPX to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to ICO in few lines of code.
