...
############################# Head ############################
head_title: "MPX to JPEG Conversion in Java – Convert MPX to JPEG"
head_description: "Convert MPX to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to JPEG in few lines of code.
