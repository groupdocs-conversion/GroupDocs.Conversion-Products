...
############################# Head ############################
head_title: "MPX to MD Conversion in Java – Convert MPX to MD"
head_description: "Convert MPX to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to MD in few lines of code.
...
demos:
    enable: true
    title: "MPX to MD Live Demos"
    content: |
        Convert MPX to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
