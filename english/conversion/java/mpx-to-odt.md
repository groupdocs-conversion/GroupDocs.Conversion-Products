...
############################# Head ############################
head_title: "MPX to ODT Conversion in Java – Convert MPX to ODT"
head_description: "Convert MPX to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to ODT in few lines of code.
...
demos:
    enable: true
    title: "MPX to ODT Live Demos"
    content: |
        Convert MPX to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
