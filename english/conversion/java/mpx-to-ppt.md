...
############################# Head ############################
head_title: "MPX to PPT Conversion in Java – Convert MPX to PPT"
head_description: "Convert MPX to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to PPT in few lines of code.
...
demos:
    enable: true
    title: "MPX to PPT Live Demos"
    content: |
        Convert MPX to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
