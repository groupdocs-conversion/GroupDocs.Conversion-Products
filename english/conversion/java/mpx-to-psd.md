...
############################# Head ############################
head_title: "MPX to PSD Conversion in Java – Convert MPX to PSD"
head_description: "Convert MPX to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to PSD in few lines of code.
...
demos:
    enable: true
    title: "MPX to PSD Live Demos"
    content: |
        Convert MPX to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
