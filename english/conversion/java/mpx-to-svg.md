...
############################# Head ############################
head_title: "MPX to SVG Conversion in Java – Convert MPX to SVG"
head_description: "Convert MPX to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to SVG in few lines of code.
...
demos:
    enable: true
    title: "MPX to SVG Live Demos"
    content: |
        Convert MPX to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
