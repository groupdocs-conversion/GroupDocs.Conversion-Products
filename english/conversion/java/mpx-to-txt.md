...
############################# Head ############################
head_title: "MPX to TXT Conversion in Java – Convert MPX to TXT"
head_description: "Convert MPX to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to TXT in few lines of code.
...
demos:
    enable: true
    title: "MPX to TXT Live Demos"
    content: |
        Convert MPX to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
