...
############################# Head ############################
head_title: "MPX to XLAM Conversion in Java – Convert MPX to XLAM"
head_description: "Convert MPX to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to XLAM in few lines of code.
...
demos:
    enable: true
    title: "MPX to XLAM Live Demos"
    content: |
        Convert MPX to XLAM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
