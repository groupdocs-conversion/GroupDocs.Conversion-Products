...
############################# Head ############################
head_title: "MPX to XLSM Conversion in Java – Convert MPX to XLSM"
head_description: "Convert MPX to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to XLSM in few lines of code.
