...
############################# Head ############################
head_title: "MPX to XLTM Conversion in Java – Convert MPX to XLTM"
head_description: "Convert MPX to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "MPX to XLTM Live Demos"
    content: |
        Convert MPX to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
