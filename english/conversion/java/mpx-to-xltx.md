...
############################# Head ############################
head_title: "MPX to XLTX Conversion in Java – Convert MPX to XLTX"
head_description: "Convert MPX to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MPX Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MPX to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MPX file to XLTX in few lines of code.
...
demos:
    enable: true
    title: "MPX to XLTX Live Demos"
    content: |
        Convert MPX to XLTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
