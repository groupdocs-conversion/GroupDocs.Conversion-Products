...
############################# Head ############################
head_title: "MSG to BMP Conversion in Java – Convert MSG to BMP"
head_description: "Convert MSG to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MSG Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MSG to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MSG file to BMP in few lines of code.
