...
############################# Head ############################
head_title: "MSG to POT Conversion in Java – Convert MSG to POT"
head_description: "Convert MSG to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MSG Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MSG to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MSG file to POT in few lines of code.
