...
############################# Head ############################
head_title: "MSG to TIF Conversion in Java – Convert MSG to TIF"
head_description: "Convert MSG to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert MSG Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting MSG to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the MSG file to TIF in few lines of code.
...
demos:
    enable: true
    title: "MSG to TIF Live Demos"
    content: |
        Convert MSG to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
