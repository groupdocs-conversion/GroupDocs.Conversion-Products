...
############################# Head ############################
head_title: "ODG to ICO Conversion in Java – Convert ODG to ICO"
head_description: "Convert ODG to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to ICO in few lines of code.
...
demos:
    enable: true
    title: "ODG to ICO Live Demos"
    content: |
        Convert ODG to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
