...
############################# Head ############################
head_title: "ODG to ODG Conversion in Java – Convert ODG to ODG"
head_description: "Convert ODG to ODG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to ODG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to ODG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to ODG in few lines of code.
...
demos:
    enable: true
    title: "ODG to ODG Live Demos"
    content: |
        Convert ODG to ODG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
