...
############################# Head ############################
head_title: "ODG to PDF Conversion in Java – Convert ODG to PDF"
head_description: "Convert ODG to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to PDF in few lines of code.
...
demos:
    enable: true
    title: "ODG to PDF Live Demos"
    content: |
        Convert ODG to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
