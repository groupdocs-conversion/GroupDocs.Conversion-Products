...
############################# Head ############################
head_title: "ODG to PPTX Conversion in Java – Convert ODG to PPTX"
head_description: "Convert ODG to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "ODG to PPTX Live Demos"
    content: |
        Convert ODG to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
