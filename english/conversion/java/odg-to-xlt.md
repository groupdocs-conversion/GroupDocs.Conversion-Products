...
############################# Head ############################
head_title: "ODG to XLT Conversion in Java – Convert ODG to XLT"
head_description: "Convert ODG to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODG Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODG to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODG file to XLT in few lines of code.
...
demos:
    enable: true
    title: "ODG to XLT Live Demos"
    content: |
        Convert ODG to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
