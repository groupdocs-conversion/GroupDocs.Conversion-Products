...
############################# Head ############################
head_title: "ODP to DOCM Conversion in Java – Convert ODP to DOCM"
head_description: "Convert ODP to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "ODP to DOCM Live Demos"
    content: |
        Convert ODP to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
