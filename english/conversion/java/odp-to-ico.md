...
############################# Head ############################
head_title: "ODP to ICO Conversion in Java – Convert ODP to ICO"
head_description: "Convert ODP to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to ICO in few lines of code.
