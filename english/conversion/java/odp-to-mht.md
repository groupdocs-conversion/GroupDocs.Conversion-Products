...
############################# Head ############################
head_title: "ODP to MHT Conversion in Java – Convert ODP to MHT"
head_description: "Convert ODP to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to MHT in few lines of code.
...
demos:
    enable: true
    title: "ODP to MHT Live Demos"
    content: |
        Convert ODP to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
