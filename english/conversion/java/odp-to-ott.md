...
############################# Head ############################
head_title: "ODP to OTT Conversion in Java – Convert ODP to OTT"
head_description: "Convert ODP to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to OTT in few lines of code.
...
demos:
    enable: true
    title: "ODP to OTT Live Demos"
    content: |
        Convert ODP to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
