...
############################# Head ############################
head_title: "ODP to POTM Conversion in Java – Convert ODP to POTM"
head_description: "Convert ODP to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to POTM in few lines of code.
...
demos:
    enable: true
    title: "ODP to POTM Live Demos"
    content: |
        Convert ODP to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
