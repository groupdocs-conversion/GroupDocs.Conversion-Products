...
############################# Head ############################
head_title: "ODP to SVG Conversion in Java – Convert ODP to SVG"
head_description: "Convert ODP to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to SVG in few lines of code.
...
demos:
    enable: true
    title: "ODP to SVG Live Demos"
    content: |
        Convert ODP to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
