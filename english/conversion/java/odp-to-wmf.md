...
############################# Head ############################
head_title: "ODP to WMF Conversion in Java – Convert ODP to WMF"
head_description: "Convert ODP to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to WMF in few lines of code.
...
demos:
    enable: true
    title: "ODP to WMF Live Demos"
    content: |
        Convert ODP to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
