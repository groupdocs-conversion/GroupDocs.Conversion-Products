...
############################# Head ############################
head_title: "ODP to XLSB Conversion in Java – Convert ODP to XLSB"
head_description: "Convert ODP to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to XLSB in few lines of code.
