...
############################# Head ############################
head_title: "ODP to XLSM Conversion in Java – Convert ODP to XLSM"
head_description: "Convert ODP to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODP Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODP to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODP file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "ODP to XLSM Live Demos"
    content: |
        Convert ODP to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
