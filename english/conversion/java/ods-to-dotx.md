...
############################# Head ############################
head_title: "ODS to DOTX Conversion in Java – Convert ODS to DOTX"
head_description: "Convert ODS to DOTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODS Files to DOTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODS to DOTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODS file to DOTX in few lines of code.
