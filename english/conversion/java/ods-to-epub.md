...
############################# Head ############################
head_title: "ODS to EPUB Conversion in Java – Convert ODS to EPUB"
head_description: "Convert ODS to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODS Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODS to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODS file to EPUB in few lines of code.
