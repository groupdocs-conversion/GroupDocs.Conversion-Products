...
############################# Head ############################
head_title: "ODS to POT Conversion in Java – Convert ODS to POT"
head_description: "Convert ODS to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODS Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODS to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODS file to POT in few lines of code.
...
demos:
    enable: true
    title: "ODS to POT Live Demos"
    content: |
        Convert ODS to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
