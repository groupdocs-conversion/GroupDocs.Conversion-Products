...
############################# Head ############################
head_title: "ODS to PPSM Conversion in Java – Convert ODS to PPSM"
head_description: "Convert ODS to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODS Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODS to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODS file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "ODS to PPSM Live Demos"
    content: |
        Convert ODS to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
