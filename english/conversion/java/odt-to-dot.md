...
############################# Head ############################
head_title: "ODT to DOT Conversion in Java – Convert ODT to DOT"
head_description: "Convert ODT to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to DOT in few lines of code.
...
demos:
    enable: true
    title: "ODT to DOT Live Demos"
    content: |
        Convert ODT to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
