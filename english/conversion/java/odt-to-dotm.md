...
############################# Head ############################
head_title: "ODT to DOTM Conversion in Java – Convert ODT to DOTM"
head_description: "Convert ODT to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "ODT to DOTM Live Demos"
    content: |
        Convert ODT to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
