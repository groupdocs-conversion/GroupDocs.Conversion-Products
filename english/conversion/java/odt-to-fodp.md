...
############################# Head ############################
head_title: "ODT to FODP Conversion in Java – Convert ODT to FODP"
head_description: "Convert ODT to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to FODP in few lines of code.
