...
############################# Head ############################
head_title: "ODT to MHT Conversion in Java – Convert ODT to MHT"
head_description: "Convert ODT to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to MHT in few lines of code.
...
demos:
    enable: true
    title: "ODT to MHT Live Demos"
    content: |
        Convert ODT to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
