...
############################# Head ############################
head_title: "ODT to PDF Conversion in Java – Convert ODT to PDF"
head_description: "Convert ODT to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to PDF in few lines of code.
...
demos:
    enable: true
    title: "ODT to PDF Live Demos"
    content: |
        Convert ODT to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
