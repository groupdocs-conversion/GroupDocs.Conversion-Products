...
############################# Head ############################
head_title: "ODT to SVG Conversion in Java – Convert ODT to SVG"
head_description: "Convert ODT to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to SVG in few lines of code.
...
demos:
    enable: true
    title: "ODT to SVG Live Demos"
    content: |
        Convert ODT to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
