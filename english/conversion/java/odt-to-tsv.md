...
############################# Head ############################
head_title: "ODT to TSV Conversion in Java – Convert ODT to TSV"
head_description: "Convert ODT to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to TSV in few lines of code.
...
demos:
    enable: true
    title: "ODT to TSV Live Demos"
    content: |
        Convert ODT to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
