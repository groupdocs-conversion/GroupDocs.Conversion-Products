...
############################# Head ############################
head_title: "ODT to TXT Conversion in Java – Convert ODT to TXT"
head_description: "Convert ODT to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to TXT in few lines of code.
