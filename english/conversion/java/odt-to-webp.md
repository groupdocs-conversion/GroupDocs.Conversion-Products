...
############################# Head ############################
head_title: "ODT to WEBP Conversion in Java – Convert ODT to WEBP"
head_description: "Convert ODT to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to WEBP in few lines of code.
