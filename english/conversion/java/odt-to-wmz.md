...
############################# Head ############################
head_title: "ODT to WMZ Conversion in Java – Convert ODT to WMZ"
head_description: "Convert ODT to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to WMZ in few lines of code.
