...
############################# Head ############################
head_title: "ODT to XLAM Conversion in Java – Convert ODT to XLAM"
head_description: "Convert ODT to XLAM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to XLAM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to XLAM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to XLAM in few lines of code.
