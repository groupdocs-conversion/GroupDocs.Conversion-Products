...
############################# Head ############################
head_title: "ODT to XLSX Conversion in Java – Convert ODT to XLSX"
head_description: "Convert ODT to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ODT Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ODT to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ODT file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "ODT to XLSX Live Demos"
    content: |
        Convert ODT to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
