...
############################# Head ############################
head_title: "ONE to DOTM Conversion in Java – Convert ONE to DOTM"
head_description: "Convert ONE to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ONE Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ONE to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ONE file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "ONE to DOTM Live Demos"
    content: |
        Convert ONE to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
