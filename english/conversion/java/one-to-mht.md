...
############################# Head ############################
head_title: "ONE to MHT Conversion in Java – Convert ONE to MHT"
head_description: "Convert ONE to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ONE Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ONE to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ONE file to MHT in few lines of code.
