...
############################# Head ############################
head_title: "ONENOTE to EBOOK Conversion in Java – Convert ONENOTE to EBOOK"
head_description: "Convert ONENOTE to EBOOK in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ONENOTE Files to EBOOK in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ONENOTE to EBOOK in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ONENOTE file to EBOOK in few lines of code.
