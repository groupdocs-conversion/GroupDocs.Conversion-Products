...
############################# Head ############################
head_title: "ONENOTE to WEB Conversion in Java – Convert ONENOTE to WEB"
head_description: "Convert ONENOTE to WEB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ONENOTE Files to WEB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ONENOTE to WEB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ONENOTE file to WEB in few lines of code.
