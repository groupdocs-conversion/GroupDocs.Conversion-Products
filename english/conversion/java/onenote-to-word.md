...
############################# Head ############################
head_title: "ONENOTE to WORD Conversion in Java – Convert ONENOTE to WORD"
head_description: "Convert ONENOTE to WORD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert ONENOTE Files to WORD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting ONENOTE to WORD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the ONENOTE file to WORD in few lines of code.
