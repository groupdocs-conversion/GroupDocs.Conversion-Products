...
############################# Head ############################
head_title: "OST to DOCX Conversion in Java – Convert OST to DOCX"
head_description: "Convert OST to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "OST to DOCX Live Demos"
    content: |
        Convert OST to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
