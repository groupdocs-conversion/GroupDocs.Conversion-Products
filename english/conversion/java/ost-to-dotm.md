...
############################# Head ############################
head_title: "OST to DOTM Conversion in Java – Convert OST to DOTM"
head_description: "Convert OST to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "OST to DOTM Live Demos"
    content: |
        Convert OST to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
