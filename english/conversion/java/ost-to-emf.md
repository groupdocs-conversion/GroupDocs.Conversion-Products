...
############################# Head ############################
head_title: "OST to EMF Conversion in Java – Convert OST to EMF"
head_description: "Convert OST to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to EMF in few lines of code.
