...
############################# Head ############################
head_title: "OST to EMLX Conversion in Java – Convert OST to EMLX"
head_description: "Convert OST to EMLX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to EMLX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to EMLX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to EMLX in few lines of code.

        *   Create a new instance of Converter class and load the OST file with full path
        *   Set ConvertOptions for the EMLX document type
        *   Call the convert() method and pass the document name (full path) and format (EMLX) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target EMLX format
...
demos:
    enable: true
    title: "OST to EMLX Live Demos"
    content: |
        Convert OST to EMLX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
