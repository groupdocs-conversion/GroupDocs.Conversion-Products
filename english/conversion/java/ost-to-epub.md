...
############################# Head ############################
head_title: "OST to EPUB Conversion in Java – Convert OST to EPUB"
head_description: "Convert OST to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to EPUB in few lines of code.
