...
############################# Head ############################
head_title: "OST to FODS Conversion in Java – Convert OST to FODS"
head_description: "Convert OST to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to FODS in few lines of code.
...
demos:
    enable: true
    title: "OST to FODS Live Demos"
    content: |
        Convert OST to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
