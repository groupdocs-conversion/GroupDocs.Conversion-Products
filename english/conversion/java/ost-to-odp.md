...
############################# Head ############################
head_title: "OST to ODP Conversion in Java – Convert OST to ODP"
head_description: "Convert OST to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to ODP in few lines of code.
...
demos:
    enable: true
    title: "OST to ODP Live Demos"
    content: |
        Convert OST to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
