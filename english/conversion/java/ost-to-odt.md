...
############################# Head ############################
head_title: "OST to ODT Conversion in Java – Convert OST to ODT"
head_description: "Convert OST to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to ODT in few lines of code.
...
demos:
    enable: true
    title: "OST to ODT Live Demos"
    content: |
        Convert OST to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
