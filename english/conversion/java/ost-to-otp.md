...
############################# Head ############################
head_title: "OST to OTP Conversion in Java – Convert OST to OTP"
head_description: "Convert OST to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to OTP in few lines of code.
...
demos:
    enable: true
    title: "OST to OTP Live Demos"
    content: |
        Convert OST to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
