...
############################# Head ############################
head_title: "OST to SVGZ Conversion in Java – Convert OST to SVGZ"
head_description: "Convert OST to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OST Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OST to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OST file to SVGZ in few lines of code.
...
demos:
    enable: true
    title: "OST to SVGZ Live Demos"
    content: |
        Convert OST to SVGZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
