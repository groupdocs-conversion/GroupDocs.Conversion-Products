...
############################# Head ############################
head_title: "OTG to BMP Conversion in Java – Convert OTG to BMP"
head_description: "Convert OTG to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to BMP in few lines of code.
...
demos:
    enable: true
    title: "OTG to BMP Live Demos"
    content: |
        Convert OTG to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
