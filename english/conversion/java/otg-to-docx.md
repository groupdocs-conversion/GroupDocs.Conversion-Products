...
############################# Head ############################
head_title: "OTG to DOCX Conversion in Java – Convert OTG to DOCX"
head_description: "Convert OTG to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "OTG to DOCX Live Demos"
    content: |
        Convert OTG to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
