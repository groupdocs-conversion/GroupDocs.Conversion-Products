...
############################# Head ############################
head_title: "OTG to EPUB Conversion in Java – Convert OTG to EPUB"
head_description: "Convert OTG to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "OTG to EPUB Live Demos"
    content: |
        Convert OTG to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
