...
############################# Head ############################
head_title: "OTG to FODP Conversion in Java – Convert OTG to FODP"
head_description: "Convert OTG to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to FODP in few lines of code.
...
demos:
    enable: true
    title: "OTG to FODP Live Demos"
    content: |
        Convert OTG to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
