...
############################# Head ############################
head_title: "OTG to HTML Conversion in Java – Convert OTG to HTML"
head_description: "Convert OTG to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to HTML in few lines of code.
