...
############################# Head ############################
head_title: "OTG to ODT Conversion in Java – Convert OTG to ODT"
head_description: "Convert OTG to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to ODT in few lines of code.
