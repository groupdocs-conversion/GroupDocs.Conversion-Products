...
############################# Static ############################
layout: "auto-gen"
date: 2021-05-13T14:09:17+03:00
draft: false

############################# Head ############################
head_title: "OTG to RTF Conversion in Java – Convert OTG to RTF"
head_description: "Convert OTG to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to RTF in few lines of code.
...
demos:
    enable: true
    title: "OTG to RTF Live Demos"
    content: |
        Convert OTG to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
