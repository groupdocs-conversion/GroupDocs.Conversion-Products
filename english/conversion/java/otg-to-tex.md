...
############################# Head ############################
head_title: "OTG to TEX Conversion in Java – Convert OTG to TEX"
head_description: "Convert OTG to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to TEX in few lines of code.
...
demos:
    enable: true
    title: "OTG to TEX Live Demos"
    content: |
        Convert OTG to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
