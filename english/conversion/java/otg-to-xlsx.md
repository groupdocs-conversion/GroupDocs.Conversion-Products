...
############################# Head ############################
head_title: "OTG to XLSX Conversion in Java – Convert OTG to XLSX"
head_description: "Convert OTG to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTG Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTG to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTG file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "OTG to XLSX Live Demos"
    content: |
        Convert OTG to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
