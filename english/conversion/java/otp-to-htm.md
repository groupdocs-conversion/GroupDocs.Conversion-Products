...
############################# Head ############################
head_title: "OTP to HTM Conversion in Java – Convert OTP to HTM"
head_description: "Convert OTP to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to HTM in few lines of code.
...
demos:
    enable: true
    title: "OTP to HTM Live Demos"
    content: |
        Convert OTP to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
