...
############################# Head ############################
head_title: "OTP to ICO Conversion in Java – Convert OTP to ICO"
head_description: "Convert OTP to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to ICO in few lines of code.
...
demos:
    enable: true
    title: "OTP to ICO Live Demos"
    content: |
        Convert OTP to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
