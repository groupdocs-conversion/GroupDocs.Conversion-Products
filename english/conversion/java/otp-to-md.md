...
############################# Head ############################
head_title: "OTP to MD Conversion in Java – Convert OTP to MD"
head_description: "Convert OTP to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to MD in few lines of code.
...
demos:
    enable: true
    title: "OTP to MD Live Demos"
    content: |
        Convert OTP to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
