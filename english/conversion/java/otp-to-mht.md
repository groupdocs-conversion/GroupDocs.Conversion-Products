...
############################# Head ############################
head_title: "OTP to MHT Conversion in Java – Convert OTP to MHT"
head_description: "Convert OTP to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to MHT in few lines of code.
...
demos:
    enable: true
    title: "OTP to MHT Live Demos"
    content: |
        Convert OTP to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
