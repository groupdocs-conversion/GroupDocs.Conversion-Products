...
############################# Head ############################
head_title: "OTP to ODP Conversion in Java – Convert OTP to ODP"
head_description: "Convert OTP to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to ODP in few lines of code.
