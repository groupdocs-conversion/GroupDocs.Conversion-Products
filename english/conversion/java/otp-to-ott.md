...
############################# Head ############################
head_title: "OTP to OTT Conversion in Java – Convert OTP to OTT"
head_description: "Convert OTP to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to OTT in few lines of code.
...
demos:
    enable: true
    title: "OTP to OTT Live Demos"
    content: |
        Convert OTP to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
