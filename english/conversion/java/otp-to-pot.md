...
############################# Head ############################
head_title: "OTP to POT Conversion in Java – Convert OTP to POT"
head_description: "Convert OTP to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to POT in few lines of code.
...
demos:
    enable: true
    title: "OTP to POT Live Demos"
    content: |
        Convert OTP to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
