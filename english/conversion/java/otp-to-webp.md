...
############################# Head ############################
head_title: "OTP to WEBP Conversion in Java – Convert OTP to WEBP"
head_description: "Convert OTP to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "OTP to WEBP Live Demos"
    content: |
        Convert OTP to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
