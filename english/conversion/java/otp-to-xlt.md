...
############################# Head ############################
head_title: "OTP to XLT Conversion in Java – Convert OTP to XLT"
head_description: "Convert OTP to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTP Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTP to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTP file to XLT in few lines of code.
...
demos:
    enable: true
    title: "OTP to XLT Live Demos"
    content: |
        Convert OTP to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
