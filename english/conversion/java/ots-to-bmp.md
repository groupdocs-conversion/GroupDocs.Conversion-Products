...
############################# Head ############################
head_title: "OTS to BMP Conversion in Java – Convert OTS to BMP"
head_description: "Convert OTS to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to BMP in few lines of code.
...
demos:
    enable: true
    title: "OTS to BMP Live Demos"
    content: |
        Convert OTS to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
