...
############################# Head ############################
head_title: "OTS to CSV Conversion in Java – Convert OTS to CSV"
head_description: "Convert OTS to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to CSV in few lines of code.
...
demos:
    enable: true
    title: "OTS to CSV Live Demos"
    content: |
        Convert OTS to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
