...
############################# Head ############################
head_title: "OTS to DOCM Conversion in Java – Convert OTS to DOCM"
head_description: "Convert OTS to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to DOCM in few lines of code.
