...
############################# Head ############################
head_title: "OTS to DOCX Conversion in Java – Convert OTS to DOCX"
head_description: "Convert OTS to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "OTS to DOCX Live Demos"
    content: |
        Convert OTS to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
