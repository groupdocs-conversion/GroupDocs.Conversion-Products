...
############################# Head ############################
head_title: "OTS to DOTX Conversion in Java – Convert OTS to DOTX"
head_description: "Convert OTS to DOTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to DOTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to DOTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to DOTX in few lines of code.
...
demos:
    enable: true
    title: "OTS to DOTX Live Demos"
    content: |
        Convert OTS to DOTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
