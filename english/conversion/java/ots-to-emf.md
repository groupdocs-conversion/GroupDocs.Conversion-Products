...
############################# Head ############################
head_title: "OTS to EMF Conversion in Java – Convert OTS to EMF"
head_description: "Convert OTS to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to EMF in few lines of code.
