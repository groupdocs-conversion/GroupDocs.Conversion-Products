...
############################# Head ############################
head_title: "OTS to EPUB Conversion in Java – Convert OTS to EPUB"
head_description: "Convert OTS to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "OTS to EPUB Live Demos"
    content: |
        Convert OTS to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
