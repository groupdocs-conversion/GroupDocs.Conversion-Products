...
############################# Head ############################
head_title: "OTS to FODS Conversion in Java – Convert OTS to FODS"
head_description: "Convert OTS to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to FODS in few lines of code.
...
demos:
    enable: true
    title: "OTS to FODS Live Demos"
    content: |
        Convert OTS to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
