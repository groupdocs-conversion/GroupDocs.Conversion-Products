...
############################# Head ############################
head_title: "OTS to GIF Conversion in Java – Convert OTS to GIF"
head_description: "Convert OTS to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to GIF in few lines of code.
...
demos:
    enable: true
    title: "OTS to GIF Live Demos"
    content: |
        Convert OTS to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
