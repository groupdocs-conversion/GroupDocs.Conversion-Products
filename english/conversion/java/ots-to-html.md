...
############################# Head ############################
head_title: "OTS to HTML Conversion in Java – Convert OTS to HTML"
head_description: "Convert OTS to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to HTML in few lines of code.
...
demos:
    enable: true
    title: "OTS to HTML Live Demos"
    content: |
        Convert OTS to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
