...
############################# Head ############################
head_title: "OTS to JPEG Conversion in Java – Convert OTS to JPEG"
head_description: "Convert OTS to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "OTS to JPEG Live Demos"
    content: |
        Convert OTS to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
