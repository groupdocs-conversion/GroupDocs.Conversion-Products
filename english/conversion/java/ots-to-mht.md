...
############################# Head ############################
head_title: "OTS to MHT Conversion in Java – Convert OTS to MHT"
head_description: "Convert OTS to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to MHT in few lines of code.
...
demos:
    enable: true
    title: "OTS to MHT Live Demos"
    content: |
        Convert OTS to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
