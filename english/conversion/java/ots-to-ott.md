...
############################# Head ############################
head_title: "OTS to OTT Conversion in Java – Convert OTS to OTT"
head_description: "Convert OTS to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to OTT in few lines of code.
...
demos:
    enable: true
    title: "OTS to OTT Live Demos"
    content: |
        Convert OTS to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
