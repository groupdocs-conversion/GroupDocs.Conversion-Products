...
############################# Head ############################
head_title: "OTS to PDF Conversion in Java – Convert OTS to PDF"
head_description: "Convert OTS to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to PDF in few lines of code.
...
demos:
    enable: true
    title: "OTS to PDF Live Demos"
    content: |
        Convert OTS to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
