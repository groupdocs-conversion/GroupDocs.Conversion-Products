...
############################# Head ############################
head_title: "OTS to PNG Conversion in Java – Convert OTS to PNG"
head_description: "Convert OTS to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to PNG in few lines of code.
...
demos:
    enable: true
    title: "OTS to PNG Live Demos"
    content: |
        Convert OTS to PNG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
