...
############################# Head ############################
head_title: "OTS to PPS Conversion in Java – Convert OTS to PPS"
head_description: "Convert OTS to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to PPS in few lines of code.
...
demos:
    enable: true
    title: "OTS to PPS Live Demos"
    content: |
        Convert OTS to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
