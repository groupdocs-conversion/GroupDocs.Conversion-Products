...
############################# Head ############################
head_title: "OTS to PSD Conversion in Java – Convert OTS to PSD"
head_description: "Convert OTS to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to PSD in few lines of code.
