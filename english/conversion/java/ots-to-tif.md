...
############################# Head ############################
head_title: "OTS to TIF Conversion in Java – Convert OTS to TIF"
head_description: "Convert OTS to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to TIF in few lines of code.
...
demos:
    enable: true
    title: "OTS to TIF Live Demos"
    content: |
        Convert OTS to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
