...
############################# Head ############################
head_title: "OTS to TSV Conversion in Java – Convert OTS to TSV"
head_description: "Convert OTS to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to TSV in few lines of code.
...
demos:
    enable: true
    title: "OTS to TSV Live Demos"
    content: |
        Convert OTS to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
