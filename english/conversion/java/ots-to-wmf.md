...
############################# Head ############################
head_title: "OTS to WMF Conversion in Java – Convert OTS to WMF"
head_description: "Convert OTS to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to WMF in few lines of code.
...
demos:
    enable: true
    title: "OTS to WMF Live Demos"
    content: |
        Convert OTS to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
