...
############################# Head ############################
head_title: "OTS to XLT Conversion in Java – Convert OTS to XLT"
head_description: "Convert OTS to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTS Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTS to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTS file to XLT in few lines of code.
...
demos:
    enable: true
    title: "OTS to XLT Live Demos"
    content: |
        Convert OTS to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
