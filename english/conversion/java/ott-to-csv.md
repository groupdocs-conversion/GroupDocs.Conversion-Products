...
############################# Head ############################
head_title: "OTT to CSV Conversion in Java – Convert OTT to CSV"
head_description: "Convert OTT to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to CSV in few lines of code.
...
demos:
    enable: true
    title: "OTT to CSV Live Demos"
    content: |
        Convert OTT to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
