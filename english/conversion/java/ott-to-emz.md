...
############################# Head ############################
head_title: "OTT to EMZ Conversion in Java – Convert OTT to EMZ"
head_description: "Convert OTT to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to EMZ in few lines of code.
...
demos:
    enable: true
    title: "OTT to EMZ Live Demos"
    content: |
        Convert OTT to EMZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
