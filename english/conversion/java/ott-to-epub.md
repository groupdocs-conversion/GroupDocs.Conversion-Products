...
############################# Head ############################
head_title: "OTT to EPUB Conversion in Java – Convert OTT to EPUB"
head_description: "Convert OTT to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "OTT to EPUB Live Demos"
    content: |
        Convert OTT to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
