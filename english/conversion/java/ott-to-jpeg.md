...
############################# Head ############################
head_title: "OTT to JPEG Conversion in Java – Convert OTT to JPEG"
head_description: "Convert OTT to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "OTT to JPEG Live Demos"
    content: |
        Convert OTT to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
