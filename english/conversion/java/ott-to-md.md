...
############################# Head ############################
head_title: "OTT to MD Conversion in Java – Convert OTT to MD"
head_description: "Convert OTT to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to MD in few lines of code.
