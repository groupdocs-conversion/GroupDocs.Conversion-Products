...
############################# Head ############################
head_title: "OTT to MHT Conversion in Java – Convert OTT to MHT"
head_description: "Convert OTT to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to MHT in few lines of code.
...
demos:
    enable: true
    title: "OTT to MHT Live Demos"
    content: |
        Convert OTT to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
