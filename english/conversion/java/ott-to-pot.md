...
############################# Head ############################
head_title: "OTT to POT Conversion in Java – Convert OTT to POT"
head_description: "Convert OTT to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to POT in few lines of code.
...
demos:
    enable: true
    title: "OTT to POT Live Demos"
    content: |
        Convert OTT to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
