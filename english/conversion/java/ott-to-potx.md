...
############################# Head ############################
head_title: "OTT to POTX Conversion in Java – Convert OTT to POTX"
head_description: "Convert OTT to POTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to POTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to POTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to POTX in few lines of code.
...
demos:
    enable: true
    title: "OTT to POTX Live Demos"
    content: |
        Convert OTT to POTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
