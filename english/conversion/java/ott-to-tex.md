...
############################# Head ############################
head_title: "OTT to TEX Conversion in Java – Convert OTT to TEX"
head_description: "Convert OTT to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to TEX in few lines of code.
...
demos:
    enable: true
    title: "OTT to TEX Live Demos"
    content: |
        Convert OTT to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
