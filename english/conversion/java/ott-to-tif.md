...
############################# Head ############################
head_title: "OTT to TIF Conversion in Java – Convert OTT to TIF"
head_description: "Convert OTT to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to TIF in few lines of code.
...
demos:
    enable: true
    title: "OTT to TIF Live Demos"
    content: |
        Convert OTT to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
