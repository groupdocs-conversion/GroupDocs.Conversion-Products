...
############################# Head ############################
head_title: "OTT to TIFF Conversion in Java – Convert OTT to TIFF"
head_description: "Convert OTT to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "OTT to TIFF Live Demos"
    content: |
        Convert OTT to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
