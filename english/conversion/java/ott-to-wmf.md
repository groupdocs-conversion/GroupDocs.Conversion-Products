...
############################# Head ############################
head_title: "OTT to WMF Conversion in Java – Convert OTT to WMF"
head_description: "Convert OTT to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to WMF in few lines of code.
...
demos:
    enable: true
    title: "OTT to WMF Live Demos"
    content: |
        Convert OTT to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
