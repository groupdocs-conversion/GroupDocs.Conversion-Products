...
############################# Head ############################
head_title: "OTT to XLT Conversion in Java – Convert OTT to XLT"
head_description: "Convert OTT to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to XLT in few lines of code.
...
demos:
    enable: true
    title: "OTT to XLT Live Demos"
    content: |
        Convert OTT to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
