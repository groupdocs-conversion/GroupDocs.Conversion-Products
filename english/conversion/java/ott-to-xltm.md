...
############################# Head ############################
head_title: "OTT to XLTM Conversion in Java – Convert OTT to XLTM"
head_description: "Convert OTT to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OTT Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OTT to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OTT file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "OTT to XLTM Live Demos"
    content: |
        Convert OTT to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
