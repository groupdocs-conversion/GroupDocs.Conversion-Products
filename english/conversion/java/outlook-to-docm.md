...
############################# Head ############################
head_title: "OUTLOOK to DOCM Conversion in Java – Convert OUTLOOK to DOCM"
head_description: "Convert OUTLOOK to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OUTLOOK Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OUTLOOK to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OUTLOOK file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "OUTLOOK to DOCM Live Demos"
    content: |
        Convert OUTLOOK to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
