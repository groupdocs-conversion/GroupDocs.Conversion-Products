...
############################# Head ############################
head_title: "OUTLOOK to POTM Conversion in Java – Convert OUTLOOK to POTM"
head_description: "Convert OUTLOOK to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OUTLOOK Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OUTLOOK to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OUTLOOK file to POTM in few lines of code.
...
demos:
    enable: true
    title: "OUTLOOK to POTM Live Demos"
    content: |
        Convert OUTLOOK to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
