...
############################# Head ############################
head_title: "OUTLOOK to PPS Conversion in Java – Convert OUTLOOK to PPS"
head_description: "Convert OUTLOOK to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OUTLOOK Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OUTLOOK to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OUTLOOK file to PPS in few lines of code.
...
demos:
    enable: true
    title: "OUTLOOK to PPS Live Demos"
    content: |
        Convert OUTLOOK to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
