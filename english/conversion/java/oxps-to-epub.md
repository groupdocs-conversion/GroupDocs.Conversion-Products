...
############################# Head ############################
head_title: "OXPS to EPUB Conversion in Java – Convert OXPS to EPUB"
head_description: "Convert OXPS to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "OXPS to EPUB Live Demos"
    content: |
        Convert OXPS to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
