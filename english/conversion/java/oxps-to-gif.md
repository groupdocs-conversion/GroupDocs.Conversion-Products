...
############################# Head ############################
head_title: "OXPS to GIF Conversion in Java – Convert OXPS to GIF"
head_description: "Convert OXPS to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to GIF in few lines of code.
...
demos:
    enable: true
    title: "OXPS to GIF Live Demos"
    content: |
        Convert OXPS to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
