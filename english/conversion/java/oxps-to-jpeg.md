...
############################# Head ############################
head_title: "OXPS to JPEG Conversion in Java – Convert OXPS to JPEG"
head_description: "Convert OXPS to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "OXPS to JPEG Live Demos"
    content: |
        Convert OXPS to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
