...
############################# Head ############################
head_title: "OXPS to JPG Conversion in Java – Convert OXPS to JPG"
head_description: "Convert OXPS to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to JPG in few lines of code.
...
demos:
    enable: true
    title: "OXPS to JPG Live Demos"
    content: |
        Convert OXPS to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
