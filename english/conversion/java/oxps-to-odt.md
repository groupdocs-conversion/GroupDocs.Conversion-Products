...
############################# Head ############################
head_title: "OXPS to ODT Conversion in Java – Convert OXPS to ODT"
head_description: "Convert OXPS to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to ODT in few lines of code.
...
demos:
    enable: true
    title: "OXPS to ODT Live Demos"
    content: |
        Convert OXPS to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
