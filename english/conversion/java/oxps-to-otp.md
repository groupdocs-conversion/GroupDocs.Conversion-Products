...
############################# Head ############################
head_title: "OXPS to OTP Conversion in Java – Convert OXPS to OTP"
head_description: "Convert OXPS to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to OTP in few lines of code.
...
demos:
    enable: true
    title: "OXPS to OTP Live Demos"
    content: |
        Convert OXPS to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
