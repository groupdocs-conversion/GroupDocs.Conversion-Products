...
############################# Head ############################
head_title: "OXPS to PPS Conversion in Java – Convert OXPS to PPS"
head_description: "Convert OXPS to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to PPS in few lines of code.
...
demos:
    enable: true
    title: "OXPS to PPS Live Demos"
    content: |
        Convert OXPS to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
