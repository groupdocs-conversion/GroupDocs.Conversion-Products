...
############################# Head ############################
head_title: "OXPS to PPSM Conversion in Java – Convert OXPS to PPSM"
head_description: "Convert OXPS to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "OXPS to PPSM Live Demos"
    content: |
        Convert OXPS to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
