...
############################# Head ############################
head_title: "OXPS to SVGZ Conversion in Java – Convert OXPS to SVGZ"
head_description: "Convert OXPS to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to SVGZ in few lines of code.
...
demos:
    enable: true
    title: "OXPS to SVGZ Live Demos"
    content: |
        Convert OXPS to SVGZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
