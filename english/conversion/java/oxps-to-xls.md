...
############################# Head ############################
head_title: "OXPS to XLS Conversion in Java – Convert OXPS to XLS"
head_description: "Convert OXPS to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to XLS in few lines of code.
