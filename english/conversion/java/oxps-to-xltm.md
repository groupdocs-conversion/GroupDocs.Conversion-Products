...
############################# Head ############################
head_title: "OXPS to XLTM Conversion in Java – Convert OXPS to XLTM"
head_description: "Convert OXPS to XLTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to XLTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to XLTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to XLTM in few lines of code.
...
demos:
    enable: true
    title: "OXPS to XLTM Live Demos"
    content: |
        Convert OXPS to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
