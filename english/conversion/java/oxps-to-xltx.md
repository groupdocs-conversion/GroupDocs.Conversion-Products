...
############################# Head ############################
head_title: "OXPS to XLTX Conversion in Java – Convert OXPS to XLTX"
head_description: "Convert OXPS to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert OXPS Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting OXPS to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the OXPS file to XLTX in few lines of code.
...
demos:
    enable: true
    title: "OXPS to XLTX Live Demos"
    content: |
        Convert OXPS to XLTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
