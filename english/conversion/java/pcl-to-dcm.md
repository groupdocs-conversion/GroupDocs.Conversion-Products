...
############################# Head ############################
head_title: "PCL to DCM Conversion in Java – Convert PCL to DCM"
head_description: "Convert PCL to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PCL Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PCL to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PCL file to DCM in few lines of code.
...
demos:
    enable: true
    title: "PCL to DCM Live Demos"
    content: |
        Convert PCL to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
