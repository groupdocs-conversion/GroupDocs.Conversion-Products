...
############################# Head ############################
head_title: "PCL to SXC Conversion in Java – Convert PCL to SXC"
head_description: "Convert PCL to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PCL Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PCL to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PCL file to SXC in few lines of code.
