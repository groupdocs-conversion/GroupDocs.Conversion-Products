...
############################# Head ############################
head_title: "PDF to FODP Conversion in Java – Convert PDF to FODP"
head_description: "Convert PDF to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to FODP in few lines of code.
...
demos:
    enable: true
    title: "PDF to FODP Live Demos"
    content: |
        Convert PDF to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
