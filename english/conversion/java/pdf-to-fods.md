...
############################# Head ############################
head_title: "PDF to FODS Conversion in Java – Convert PDF to FODS"
head_description: "Convert PDF to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to FODS in few lines of code.
...
demos:
    enable: true
    title: "PDF to FODS Live Demos"
    content: |
        Convert PDF to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
