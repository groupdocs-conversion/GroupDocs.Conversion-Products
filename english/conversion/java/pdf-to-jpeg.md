...
############################# Head ############################
head_title: "PDF to JPEG Conversion in Java – Convert PDF to JPEG"
head_description: "Convert PDF to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "PDF to JPEG Live Demos"
    content: |
        Convert PDF to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
