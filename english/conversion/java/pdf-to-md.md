...
############################# Head ############################
head_title: "PDF to MD Conversion in Java – Convert PDF to MD"
head_description: "Convert PDF to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to MD in few lines of code.
...
demos:
    enable: true
    title: "PDF to MD Live Demos"
    content: |
        Convert PDF to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
