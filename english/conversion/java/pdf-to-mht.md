...
############################# Head ############################
head_title: "PDF to MHT Conversion in Java – Convert PDF to MHT"
head_description: "Convert PDF to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to MHT in few lines of code.
...
demos:
    enable: true
    title: "PDF to MHT Live Demos"
    content: |
        Convert PDF to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
