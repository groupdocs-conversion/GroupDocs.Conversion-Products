...
############################# Head ############################
head_title: "PDF to ODP Conversion in Java – Convert PDF to ODP"
head_description: "Convert PDF to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to ODP in few lines of code.
...
demos:
    enable: true
    title: "PDF to ODP Live Demos"
    content: |
        Convert PDF to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
