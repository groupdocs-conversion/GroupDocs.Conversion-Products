...
############################# Head ############################
head_title: "PDF to POT Conversion in Java – Convert PDF to POT"
head_description: "Convert PDF to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to POT in few lines of code.
...
demos:
    enable: true
    title: "PDF to POT Live Demos"
    content: |
        Convert PDF to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
