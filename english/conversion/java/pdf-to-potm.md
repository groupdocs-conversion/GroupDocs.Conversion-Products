...
############################# Head ############################
head_title: "PDF to POTM Conversion in Java – Convert PDF to POTM"
head_description: "Convert PDF to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to POTM in few lines of code.
...
demos:
    enable: true
    title: "PDF to POTM Live Demos"
    content: |
        Convert PDF to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
