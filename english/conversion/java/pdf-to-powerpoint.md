...
############################# Head ############################
head_title: "PDF to POWERPOINT Conversion in Java – Convert PDF to POWERPOINT"
head_description: "Convert PDF to POWERPOINT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to POWERPOINT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to POWERPOINT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to POWERPOINT in few lines of code.
