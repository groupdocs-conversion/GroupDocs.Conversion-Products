...
############################# Head ############################
head_title: "PDF to PPSM Conversion in Java – Convert PDF to PPSM"
head_description: "Convert PDF to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "PDF to PPSM Live Demos"
    content: |
        Convert PDF to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
