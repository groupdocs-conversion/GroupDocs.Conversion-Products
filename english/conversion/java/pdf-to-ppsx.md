...
############################# Head ############################
head_title: "PDF to PPSX Conversion in Java – Convert PDF to PPSX"
head_description: "Convert PDF to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "PDF to PPSX Live Demos"
    content: |
        Convert PDF to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
