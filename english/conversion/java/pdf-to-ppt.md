...
############################# Head ############################
head_title: "PDF to PPT Conversion in Java – Convert PDF to PPT"
head_description: "Convert PDF to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to PPT in few lines of code.
...
demos:
    enable: true
    title: "PDF to PPT Live Demos"
    content: |
        Convert PDF to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
