...
############################# Head ############################
head_title: "PDF to TEX Conversion in Java – Convert PDF to TEX"
head_description: "Convert PDF to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PDF Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PDF to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PDF file to TEX in few lines of code.
...
demos:
    enable: true
    title: "PDF to TEX Live Demos"
    content: |
        Convert PDF to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
