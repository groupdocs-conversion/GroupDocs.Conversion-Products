...
############################# Head ############################
head_title: "PHOTOSHOP to EXCEL Conversion in Java – Convert PHOTOSHOP to EXCEL"
head_description: "Convert PHOTOSHOP to EXCEL in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PHOTOSHOP Files to EXCEL in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PHOTOSHOP to EXCEL in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PHOTOSHOP file to EXCEL in few lines of code.
