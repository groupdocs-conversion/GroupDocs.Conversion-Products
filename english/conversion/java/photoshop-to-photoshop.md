...
############################# Head ############################
head_title: "PHOTOSHOP to PHOTOSHOP Conversion in Java – Convert PHOTOSHOP to PHOTOSHOP"
head_description: "Convert PHOTOSHOP to PHOTOSHOP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PHOTOSHOP Files to PHOTOSHOP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PHOTOSHOP to PHOTOSHOP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PHOTOSHOP file to PHOTOSHOP in few lines of code.
