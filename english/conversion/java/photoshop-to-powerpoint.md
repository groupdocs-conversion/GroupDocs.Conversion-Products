...
############################# Head ############################
head_title: "PHOTOSHOP to POWERPOINT Conversion in Java – Convert PHOTOSHOP to POWERPOINT"
head_description: "Convert PHOTOSHOP to POWERPOINT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PHOTOSHOP Files to POWERPOINT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PHOTOSHOP to POWERPOINT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PHOTOSHOP file to POWERPOINT in few lines of code.
...
demos:
    enable: true
    title: "PHOTOSHOP to POWERPOINT Live Demos"
    content: |
        Convert PHOTOSHOP to POWERPOINT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
