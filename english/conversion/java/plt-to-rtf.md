...
############################# Head ############################
head_title: "PLT to RTF Conversion in Java – Convert PLT to RTF"
head_description: "Convert PLT to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PLT Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PLT to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PLT file to RTF in few lines of code.
...
demos:
    enable: true
    title: "PLT to RTF Live Demos"
    content: |
        Convert PLT to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
