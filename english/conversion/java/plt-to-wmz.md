...
############################# Head ############################
head_title: "PLT to WMZ Conversion in Java – Convert PLT to WMZ"
head_description: "Convert PLT to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PLT Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PLT to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PLT file to WMZ in few lines of code.
