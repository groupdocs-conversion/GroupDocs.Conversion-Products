...
############################# Head ############################
head_title: "PNG to GIF Conversion in Java – Convert PNG to GIF"
head_description: "Convert PNG to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PNG Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PNG to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PNG file to GIF in few lines of code.
