...
############################# Head ############################
head_title: "PNG to SVG Conversion in Java – Convert PNG to SVG"
head_description: "Convert PNG to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PNG Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PNG to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PNG file to SVG in few lines of code.
...
demos:
    enable: true
    title: "PNG to SVG Live Demos"
    content: |
        Convert PNG to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
