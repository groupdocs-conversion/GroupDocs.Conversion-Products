...
############################# Head ############################
head_title: "PNG to XPS Conversion in Java – Convert PNG to XPS"
head_description: "Convert PNG to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PNG Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PNG to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PNG file to XPS in few lines of code.
...
demos:
    enable: true
    title: "PNG to XPS Live Demos"
    content: |
        Convert PNG to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
