...
############################# Head ############################
head_title: "POT to FODS Conversion in Java – Convert POT to FODS"
head_description: "Convert POT to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POT Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POT to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POT file to FODS in few lines of code.
...
demos:
    enable: true
    title: "POT to FODS Live Demos"
    content: |
        Convert POT to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
