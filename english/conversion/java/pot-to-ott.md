...
############################# Head ############################
head_title: "POT to OTT Conversion in Java – Convert POT to OTT"
head_description: "Convert POT to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POT Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POT to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POT file to OTT in few lines of code.
...
demos:
    enable: true
    title: "POT to OTT Live Demos"
    content: |
        Convert POT to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
