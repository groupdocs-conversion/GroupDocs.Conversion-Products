...
############################# Head ############################
head_title: "POT to RTF Conversion in Java – Convert POT to RTF"
head_description: "Convert POT to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POT Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POT to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POT file to RTF in few lines of code.
...
demos:
    enable: true
    title: "POT to RTF Live Demos"
    content: |
        Convert POT to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
