...
############################# Head ############################
head_title: "POTM to FODS Conversion in Java – Convert POTM to FODS"
head_description: "Convert POTM to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTM Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTM to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTM file to FODS in few lines of code.
