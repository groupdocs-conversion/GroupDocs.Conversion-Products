...
############################# Head ############################
head_title: "POTM to MD Conversion in Java – Convert POTM to MD"
head_description: "Convert POTM to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTM Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTM to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTM file to MD in few lines of code.
...
demos:
    enable: true
    title: "POTM to MD Live Demos"
    content: |
        Convert POTM to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
