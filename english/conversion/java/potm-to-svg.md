...
############################# Head ############################
head_title: "POTM to SVG Conversion in Java – Convert POTM to SVG"
head_description: "Convert POTM to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTM Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTM to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTM file to SVG in few lines of code.
