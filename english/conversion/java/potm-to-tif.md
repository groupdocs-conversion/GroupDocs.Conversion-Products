...
############################# Head ############################
head_title: "POTM to TIF Conversion in Java – Convert POTM to TIF"
head_description: "Convert POTM to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTM Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTM to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTM file to TIF in few lines of code.
...
demos:
    enable: true
    title: "POTM to TIF Live Demos"
    content: |
        Convert POTM to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
