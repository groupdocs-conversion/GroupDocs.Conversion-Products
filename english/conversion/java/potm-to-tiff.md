...
############################# Head ############################
head_title: "POTM to TIFF Conversion in Java – Convert POTM to TIFF"
head_description: "Convert POTM to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTM Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTM to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTM file to TIFF in few lines of code.
