...
############################# Head ############################
head_title: "POTM to WMZ Conversion in Java – Convert POTM to WMZ"
head_description: "Convert POTM to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTM Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTM to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTM file to WMZ in few lines of code.
