...
############################# Head ############################
head_title: "POTM to XLSX Conversion in Java – Convert POTM to XLSX"
head_description: "Convert POTM to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTM Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTM to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTM file to XLSX in few lines of code.
