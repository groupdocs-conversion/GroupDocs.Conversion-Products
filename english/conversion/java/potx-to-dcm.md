...
############################# Head ############################
head_title: "POTX to DCM Conversion in Java – Convert POTX to DCM"
head_description: "Convert POTX to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to DCM in few lines of code.
...
demos:
    enable: true
    title: "POTX to DCM Live Demos"
    content: |
        Convert POTX to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
