...
############################# Head ############################
head_title: "POTX to EMF Conversion in Java – Convert POTX to EMF"
head_description: "Convert POTX to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to EMF in few lines of code.
