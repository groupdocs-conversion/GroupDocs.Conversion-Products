...
############################# Head ############################
head_title: "POTX to OTP Conversion in Java – Convert POTX to OTP"
head_description: "Convert POTX to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to OTP in few lines of code.
