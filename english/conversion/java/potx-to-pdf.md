...
############################# Head ############################
head_title: "POTX to PDF Conversion in Java – Convert POTX to PDF"
head_description: "Convert POTX to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to PDF in few lines of code.
...
demos:
    enable: true
    title: "POTX to PDF Live Demos"
    content: |
        Convert POTX to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
