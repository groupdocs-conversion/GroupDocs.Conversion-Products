...
############################# Head ############################
head_title: "POTX to TIF Conversion in Java – Convert POTX to TIF"
head_description: "Convert POTX to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to TIF in few lines of code.
...
demos:
    enable: true
    title: "POTX to TIF Live Demos"
    content: |
        Convert POTX to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
