...
############################# Head ############################
head_title: "POTX to WMF Conversion in Java – Convert POTX to WMF"
head_description: "Convert POTX to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to WMF in few lines of code.
