...
############################# Head ############################
head_title: "POTX to WMZ Conversion in Java – Convert POTX to WMZ"
head_description: "Convert POTX to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to WMZ in few lines of code.
