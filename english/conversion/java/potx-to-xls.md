...
############################# Head ############################
head_title: "POTX to XLS Conversion in Java – Convert POTX to XLS"
head_description: "Convert POTX to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to XLS in few lines of code.
