...
############################# Head ############################
head_title: "POTX to XLSX Conversion in Java – Convert POTX to XLSX"
head_description: "Convert POTX to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert POTX Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting POTX to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the POTX file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "POTX to XLSX Live Demos"
    content: |
        Convert POTX to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
