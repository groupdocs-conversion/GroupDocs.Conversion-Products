...
############################# Head ############################
head_title: "PPS to DOCX Conversion in Java – Convert PPS to DOCX"
head_description: "Convert PPS to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "PPS to DOCX Live Demos"
    content: |
        Convert PPS to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
