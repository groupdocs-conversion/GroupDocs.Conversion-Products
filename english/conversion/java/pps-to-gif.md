...
############################# Head ############################
head_title: "PPS to GIF Conversion in Java – Convert PPS to GIF"
head_description: "Convert PPS to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to GIF in few lines of code.
...
demos:
    enable: true
    title: "PPS to GIF Live Demos"
    content: |
        Convert PPS to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
