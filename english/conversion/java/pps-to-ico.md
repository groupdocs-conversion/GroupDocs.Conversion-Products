...
############################# Head ############################
head_title: "PPS to ICO Conversion in Java – Convert PPS to ICO"
head_description: "Convert PPS to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to ICO in few lines of code.
...
demos:
    enable: true
    title: "PPS to ICO Live Demos"
    content: |
        Convert PPS to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
