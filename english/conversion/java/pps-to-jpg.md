...
############################# Head ############################
head_title: "PPS to JPG Conversion in Java – Convert PPS to JPG"
head_description: "Convert PPS to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to JPG in few lines of code.
...
demos:
    enable: true
    title: "PPS to JPG Live Demos"
    content: |
        Convert PPS to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
