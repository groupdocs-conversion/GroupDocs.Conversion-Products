...
############################# Head ############################
head_title: "PPS to PNG Conversion in Java – Convert PPS to PNG"
head_description: "Convert PPS to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to PNG in few lines of code.
