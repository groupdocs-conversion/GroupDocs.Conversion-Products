...
############################# Head ############################
head_title: "PPS to PPSX Conversion in Java – Convert PPS to PPSX"
head_description: "Convert PPS to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to PPSX in few lines of code.
