...
############################# Head ############################
head_title: "PPS to PPT Conversion in Java – Convert PPS to PPT"
head_description: "Convert PPS to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to PPT in few lines of code.
...
demos:
    enable: true
    title: "PPS to PPT Live Demos"
    content: |
        Convert PPS to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
