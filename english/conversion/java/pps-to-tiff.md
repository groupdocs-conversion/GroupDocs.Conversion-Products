...
############################# Head ############################
head_title: "PPS to TIFF Conversion in Java – Convert PPS to TIFF"
head_description: "Convert PPS to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "PPS to TIFF Live Demos"
    content: |
        Convert PPS to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
