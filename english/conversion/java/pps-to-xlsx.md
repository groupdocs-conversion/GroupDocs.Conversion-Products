...
############################# Head ############################
head_title: "PPS to XLSX Conversion in Java – Convert PPS to XLSX"
head_description: "Convert PPS to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPS Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPS to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPS file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "PPS to XLSX Live Demos"
    content: |
        Convert PPS to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
