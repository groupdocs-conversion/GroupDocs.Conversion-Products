...
############################# Head ############################
head_title: "PPSM to DIF Conversion in Java – Convert PPSM to DIF"
head_description: "Convert PPSM to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSM Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSM to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSM file to DIF in few lines of code.
