...
############################# Head ############################
head_title: "PPSM to DOT Conversion in Java – Convert PPSM to DOT"
head_description: "Convert PPSM to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSM Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSM to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSM file to DOT in few lines of code.
