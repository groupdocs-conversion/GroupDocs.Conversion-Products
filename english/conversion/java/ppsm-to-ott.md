...
############################# Head ############################
head_title: "PPSM to OTT Conversion in Java – Convert PPSM to OTT"
head_description: "Convert PPSM to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSM Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSM to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSM file to OTT in few lines of code.
