...
############################# Head ############################
head_title: "PPSM to RTF Conversion in Java – Convert PPSM to RTF"
head_description: "Convert PPSM to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSM Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSM to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSM file to RTF in few lines of code.
