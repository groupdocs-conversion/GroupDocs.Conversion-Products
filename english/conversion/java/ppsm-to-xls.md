...
############################# Head ############################
head_title: "PPSM to XLS Conversion in Java – Convert PPSM to XLS"
head_description: "Convert PPSM to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSM Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSM to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSM file to XLS in few lines of code.
