...
############################# Head ############################
head_title: "PPSX to DOCX Conversion in Java – Convert PPSX to DOCX"
head_description: "Convert PPSX to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSX Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSX to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSX file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "PPSX to DOCX Live Demos"
    content: |
        Convert PPSX to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
