...
############################# Head ############################
head_title: "PPSX to DOT Conversion in Java – Convert PPSX to DOT"
head_description: "Convert PPSX to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSX Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSX to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSX file to DOT in few lines of code.
...
demos:
    enable: true
    title: "PPSX to DOT Live Demos"
    content: |
        Convert PPSX to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
