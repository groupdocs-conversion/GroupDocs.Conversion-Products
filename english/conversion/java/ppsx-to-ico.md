...
############################# Head ############################
head_title: "PPSX to ICO Conversion in Java – Convert PPSX to ICO"
head_description: "Convert PPSX to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSX Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSX to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSX file to ICO in few lines of code.
...
demos:
    enable: true
    title: "PPSX to ICO Live Demos"
    content: |
        Convert PPSX to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
