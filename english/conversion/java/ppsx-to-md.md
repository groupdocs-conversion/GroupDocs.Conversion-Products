...
############################# Head ############################
head_title: "PPSX to MD Conversion in Java – Convert PPSX to MD"
head_description: "Convert PPSX to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSX Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSX to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSX file to MD in few lines of code.
...
demos:
    enable: true
    title: "PPSX to MD Live Demos"
    content: |
        Convert PPSX to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
