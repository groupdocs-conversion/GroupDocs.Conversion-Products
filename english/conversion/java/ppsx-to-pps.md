...
############################# Head ############################
head_title: "PPSX to PPS Conversion in Java – Convert PPSX to PPS"
head_description: "Convert PPSX to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSX Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSX to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSX file to PPS in few lines of code.
...
demos:
    enable: true
    title: "PPSX to PPS Live Demos"
    content: |
        Convert PPSX to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
