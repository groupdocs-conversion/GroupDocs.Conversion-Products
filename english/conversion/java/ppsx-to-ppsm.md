...
############################# Head ############################
head_title: "PPSX to PPSM Conversion in Java – Convert PPSX to PPSM"
head_description: "Convert PPSX to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSX Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSX to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSX file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "PPSX to PPSM Live Demos"
    content: |
        Convert PPSX to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
