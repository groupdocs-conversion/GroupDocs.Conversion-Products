...
############################# Head ############################
head_title: "PPSX to PSD Conversion in Java – Convert PPSX to PSD"
head_description: "Convert PPSX to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPSX Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPSX to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPSX file to PSD in few lines of code.
