...
############################# Head ############################
head_title: "PPT to DOCM Conversion in Java – Convert PPT to DOCM"
head_description: "Convert PPT to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "PPT to DOCM Live Demos"
    content: |
        Convert PPT to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
