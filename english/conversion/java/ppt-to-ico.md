...
############################# Head ############################
head_title: "PPT to ICO Conversion in Java – Convert PPT to ICO"
head_description: "Convert PPT to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to ICO in few lines of code.
...
demos:
    enable: true
    title: "PPT to ICO Live Demos"
    content: |
        Convert PPT to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
