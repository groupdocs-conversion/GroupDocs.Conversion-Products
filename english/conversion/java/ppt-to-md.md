...
############################# Head ############################
head_title: "PPT to MD Conversion in Java – Convert PPT to MD"
head_description: "Convert PPT to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to MD in few lines of code.
...
demos:
    enable: true
    title: "PPT to MD Live Demos"
    content: |
        Convert PPT to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
