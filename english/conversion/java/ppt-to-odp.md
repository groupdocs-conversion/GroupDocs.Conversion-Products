...
############################# Head ############################
head_title: "PPT to ODP Conversion in Java – Convert PPT to ODP"
head_description: "Convert PPT to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to ODP in few lines of code.
...
demos:
    enable: true
    title: "PPT to ODP Live Demos"
    content: |
        Convert PPT to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
