...
############################# Head ############################
head_title: "PPT to RTF Conversion in Java – Convert PPT to RTF"
head_description: "Convert PPT to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to RTF in few lines of code.
...
demos:
    enable: true
    title: "PPT to RTF Live Demos"
    content: |
        Convert PPT to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
