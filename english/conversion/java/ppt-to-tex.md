...
############################# Head ############################
head_title: "PPT to TEX Conversion in Java – Convert PPT to TEX"
head_description: "Convert PPT to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to TEX in few lines of code.
...
demos:
    enable: true
    title: "PPT to TEX Live Demos"
    content: |
        Convert PPT to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
