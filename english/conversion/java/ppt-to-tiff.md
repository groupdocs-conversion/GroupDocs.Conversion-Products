...
############################# Head ############################
head_title: "PPT to TIFF Conversion in Java – Convert PPT to TIFF"
head_description: "Convert PPT to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "PPT to TIFF Live Demos"
    content: |
        Convert PPT to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
