...
############################# Head ############################
head_title: "PPT to WEBP Conversion in Java – Convert PPT to WEBP"
head_description: "Convert PPT to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "PPT to WEBP Live Demos"
    content: |
        Convert PPT to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
