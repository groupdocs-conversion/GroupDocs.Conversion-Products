...
############################# Head ############################
head_title: "PPT to XLSX Conversion in Java – Convert PPT to XLSX"
head_description: "Convert PPT to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPT Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPT to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPT file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "PPT to XLSX Live Demos"
    content: |
        Convert PPT to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
