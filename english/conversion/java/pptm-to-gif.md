...
############################# Head ############################
head_title: "PPTM to GIF Conversion in Java – Convert PPTM to GIF"
head_description: "Convert PPTM to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to GIF in few lines of code.
...
demos:
    enable: true
    title: "PPTM to GIF Live Demos"
    content: |
        Convert PPTM to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
