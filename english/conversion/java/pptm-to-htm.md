...
############################# Head ############################
head_title: "PPTM to HTM Conversion in Java – Convert PPTM to HTM"
head_description: "Convert PPTM to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to HTM in few lines of code.
...
demos:
    enable: true
    title: "PPTM to HTM Live Demos"
    content: |
        Convert PPTM to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
