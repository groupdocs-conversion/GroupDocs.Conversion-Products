...
############################# Head ############################
head_title: "PPTM to HTML Conversion in Java – Convert PPTM to HTML"
head_description: "Convert PPTM to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to HTML in few lines of code.
