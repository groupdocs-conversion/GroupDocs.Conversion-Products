...
############################# Head ############################
head_title: "PPTM to ODS Conversion in Java – Convert PPTM to ODS"
head_description: "Convert PPTM to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to ODS in few lines of code.
...
demos:
    enable: true
    title: "PPTM to ODS Live Demos"
    content: |
        Convert PPTM to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
