...
############################# Head ############################
head_title: "PPTM to PPSM Conversion in Java – Convert PPTM to PPSM"
head_description: "Convert PPTM to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "PPTM to PPSM Live Demos"
    content: |
        Convert PPTM to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
