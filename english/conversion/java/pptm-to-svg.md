...
############################# Head ############################
head_title: "PPTM to SVG Conversion in Java – Convert PPTM to SVG"
head_description: "Convert PPTM to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to SVG in few lines of code.
...
demos:
    enable: true
    title: "PPTM to SVG Live Demos"
    content: |
        Convert PPTM to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
