...
############################# Head ############################
head_title: "PPTM to XLSX Conversion in Java – Convert PPTM to XLSX"
head_description: "Convert PPTM to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "PPTM to XLSX Live Demos"
    content: |
        Convert PPTM to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
