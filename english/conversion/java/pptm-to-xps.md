...
############################# Head ############################
head_title: "PPTM to XPS Conversion in Java – Convert PPTM to XPS"
head_description: "Convert PPTM to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTM Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTM to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTM file to XPS in few lines of code.
...
demos:
    enable: true
    title: "PPTM to XPS Live Demos"
    content: |
        Convert PPTM to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
