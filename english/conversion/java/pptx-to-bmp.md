...
############################# Head ############################
head_title: "PPTX to BMP Conversion in Java – Convert PPTX to BMP"
head_description: "Convert PPTX to BMP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to BMP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to BMP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to BMP in few lines of code.
...
demos:
    enable: true
    title: "PPTX to BMP Live Demos"
    content: |
        Convert PPTX to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
