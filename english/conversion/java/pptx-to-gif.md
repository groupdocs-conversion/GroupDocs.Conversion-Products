...
############################# Head ############################
head_title: "PPTX to GIF Conversion in Java – Convert PPTX to GIF"
head_description: "Convert PPTX to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to GIF in few lines of code.
...
demos:
    enable: true
    title: "PPTX to GIF Live Demos"
    content: |
        Convert PPTX to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
