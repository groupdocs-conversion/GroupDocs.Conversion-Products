...
############################# Head ############################
head_title: "PPTX to ICO Conversion in Java – Convert PPTX to ICO"
head_description: "Convert PPTX to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to ICO in few lines of code.
...
demos:
    enable: true
    title: "PPTX to ICO Live Demos"
    content: |
        Convert PPTX to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
