...
############################# Head ############################
head_title: "PPTX to MD Conversion in Java – Convert PPTX to MD"
head_description: "Convert PPTX to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to MD in few lines of code.
...
demos:
    enable: true
    title: "PPTX to MD Live Demos"
    content: |
        Convert PPTX to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
