...
############################# Head ############################
head_title: "PPTX to PPSM Conversion in Java – Convert PPTX to PPSM"
head_description: "Convert PPTX to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to PPSM in few lines of code.
...
demos:
    enable: true
    title: "PPTX to PPSM Live Demos"
    content: |
        Convert PPTX to PPSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
