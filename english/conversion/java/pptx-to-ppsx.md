...
############################# Head ############################
head_title: "PPTX to PPSX Conversion in Java – Convert PPTX to PPSX"
head_description: "Convert PPTX to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to PPSX in few lines of code.
