...
############################# Head ############################
head_title: "PPTX to TEX Conversion in Java – Convert PPTX to TEX"
head_description: "Convert PPTX to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to TEX in few lines of code.
...
demos:
    enable: true
    title: "PPTX to TEX Live Demos"
    content: |
        Convert PPTX to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
