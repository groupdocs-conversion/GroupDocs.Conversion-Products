...
############################# Head ############################
head_title: "PPTX to XLSX Conversion in Java – Convert PPTX to XLSX"
head_description: "Convert PPTX to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PPTX Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PPTX to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PPTX file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "PPTX to XLSX Live Demos"
    content: |
        Convert PPTX to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
