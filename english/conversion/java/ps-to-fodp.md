...
############################# Head ############################
head_title: "PS to FODP Conversion in Java – Convert PS to FODP"
head_description: "Convert PS to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PS Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PS to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PS file to FODP in few lines of code.
...
demos:
    enable: true
    title: "PS to FODP Live Demos"
    content: |
        Convert PS to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
