...
############################# Head ############################
head_title: "PS to HTM Conversion in Java – Convert PS to HTM"
head_description: "Convert PS to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PS Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PS to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PS file to HTM in few lines of code.
...
demos:
    enable: true
    title: "PS to HTM Live Demos"
    content: |
        Convert PS to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
