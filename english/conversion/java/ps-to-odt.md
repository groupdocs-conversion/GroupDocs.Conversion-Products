...
############################# Head ############################
head_title: "PS to ODT Conversion in Java – Convert PS to ODT"
head_description: "Convert PS to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PS Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PS to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PS file to ODT in few lines of code.
