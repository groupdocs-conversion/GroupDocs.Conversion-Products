...
############################# Head ############################
head_title: "PS to RTF Conversion in Java – Convert PS to RTF"
head_description: "Convert PS to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PS Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PS to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PS file to RTF in few lines of code.
...
demos:
    enable: true
    title: "PS to RTF Live Demos"
    content: |
        Convert PS to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
