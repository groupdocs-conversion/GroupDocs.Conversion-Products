...
############################# Head ############################
head_title: "PS to TEX Conversion in Java – Convert PS to TEX"
head_description: "Convert PS to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PS Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PS to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PS file to TEX in few lines of code.
...
demos:
    enable: true
    title: "PS to TEX Live Demos"
    content: |
        Convert PS to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
