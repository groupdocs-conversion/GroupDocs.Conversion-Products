...
############################# Head ############################
head_title: "PSD to TIF Conversion in Java – Convert PSD to TIF"
head_description: "Convert PSD to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PSD Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PSD to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PSD file to TIF in few lines of code.
...
demos:
    enable: true
    title: "PSD to TIF Live Demos"
    content: |
        Convert PSD to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
