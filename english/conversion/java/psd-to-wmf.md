...
############################# Head ############################
head_title: "PSD to WMF Conversion in Java – Convert PSD to WMF"
head_description: "Convert PSD to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PSD Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PSD to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PSD file to WMF in few lines of code.
...
demos:
    enable: true
    title: "PSD to WMF Live Demos"
    content: |
        Convert PSD to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
