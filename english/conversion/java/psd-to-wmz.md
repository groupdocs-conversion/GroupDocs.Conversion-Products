...
############################# Head ############################
head_title: "PSD to WMZ Conversion in Java – Convert PSD to WMZ"
head_description: "Convert PSD to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PSD Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PSD to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PSD file to WMZ in few lines of code.
