...
############################# Head ############################
head_title: "PSD to XLSX Conversion in Java – Convert PSD to XLSX"
head_description: "Convert PSD to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PSD Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PSD to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PSD file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "PSD to XLSX Live Demos"
    content: |
        Convert PSD to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
