...
############################# Head ############################
head_title: "PST to DOCX Conversion in Java – Convert PST to DOCX"
head_description: "Convert PST to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PST Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PST to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PST file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "PST to DOCX Live Demos"
    content: |
        Convert PST to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
