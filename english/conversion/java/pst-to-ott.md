...
############################# Head ############################
head_title: "PST to OTT Conversion in Java – Convert PST to OTT"
head_description: "Convert PST to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PST Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PST to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PST file to OTT in few lines of code.
...
demos:
    enable: true
    title: "PST to OTT Live Demos"
    content: |
        Convert PST to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
