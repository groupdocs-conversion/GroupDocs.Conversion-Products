...
############################# Head ############################
head_title: "PST to SXC Conversion in Java – Convert PST to SXC"
head_description: "Convert PST to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PST Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PST to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PST file to SXC in few lines of code.
...
demos:
    enable: true
    title: "PST to SXC Live Demos"
    content: |
        Convert PST to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
