...
############################# Head ############################
head_title: "PST to XLSM Conversion in Java – Convert PST to XLSM"
head_description: "Convert PST to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PST Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PST to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PST file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "PST to XLSM Live Demos"
    content: |
        Convert PST to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
