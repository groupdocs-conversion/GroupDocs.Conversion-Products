...
############################# Head ############################
head_title: "PST to XLT Conversion in Java – Convert PST to XLT"
head_description: "Convert PST to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PST Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PST to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PST file to XLT in few lines of code.
...
demos:
    enable: true
    title: "PST to XLT Live Demos"
    content: |
        Convert PST to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
