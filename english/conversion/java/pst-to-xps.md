...
############################# Head ############################
head_title: "PST to XPS Conversion in Java – Convert PST to XPS"
head_description: "Convert PST to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert PST Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting PST to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the PST file to XPS in few lines of code.
...
demos:
    enable: true
    title: "PST to XPS Live Demos"
    content: |
        Convert PST to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
