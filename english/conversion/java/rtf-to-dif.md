...
############################# Head ############################
head_title: "RTF to DIF Conversion in Java – Convert RTF to DIF"
head_description: "Convert RTF to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to DIF in few lines of code.
...
demos:
    enable: true
    title: "RTF to DIF Live Demos"
    content: |
        Convert RTF to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
