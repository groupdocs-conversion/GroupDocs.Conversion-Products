...
############################# Head ############################
head_title: "RTF to HTML Conversion in Java – Convert RTF to HTML"
head_description: "Convert RTF to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to HTML in few lines of code.
...
demos:
    enable: true
    title: "RTF to HTML Live Demos"
    content: |
        Convert RTF to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
