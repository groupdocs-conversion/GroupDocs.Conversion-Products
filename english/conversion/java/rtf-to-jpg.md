...
############################# Head ############################
head_title: "RTF to JPG Conversion in Java – Convert RTF to JPG"
head_description: "Convert RTF to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to JPG in few lines of code.
...
demos:
    enable: true
    title: "RTF to JPG Live Demos"
    content: |
        Convert RTF to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
