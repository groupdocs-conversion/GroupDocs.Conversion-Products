...
############################# Head ############################
head_title: "RTF to MD Conversion in Java – Convert RTF to MD"
head_description: "Convert RTF to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to MD in few lines of code.
...
demos:
    enable: true
    title: "RTF to MD Live Demos"
    content: |
        Convert RTF to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
