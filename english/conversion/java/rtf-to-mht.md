...
############################# Head ############################
head_title: "RTF to MHT Conversion in Java – Convert RTF to MHT"
head_description: "Convert RTF to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to MHT in few lines of code.
