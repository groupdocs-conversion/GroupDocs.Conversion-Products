...
############################# Head ############################
head_title: "RTF to TIF Conversion in Java – Convert RTF to TIF"
head_description: "Convert RTF to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert RTF Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting RTF to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the RTF file to TIF in few lines of code.
...
demos:
    enable: true
    title: "RTF to TIF Live Demos"
    content: |
        Convert RTF to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
