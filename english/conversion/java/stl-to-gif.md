...
############################# Head ############################
head_title: "STL to GIF Conversion in Java – Convert STL to GIF"
head_description: "Convert STL to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to GIF in few lines of code.
...
demos:
    enable: true
    title: "STL to GIF Live Demos"
    content: |
        Convert STL to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
