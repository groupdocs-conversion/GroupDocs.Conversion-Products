...
############################# Head ############################
head_title: "STL to POT Conversion in Java – Convert STL to POT"
head_description: "Convert STL to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to POT in few lines of code.
