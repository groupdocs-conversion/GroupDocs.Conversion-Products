...
############################# Head ############################
head_title: "STL to PPTM Conversion in Java – Convert STL to PPTM"
head_description: "Convert STL to PPTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to PPTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to PPTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to PPTM in few lines of code.
...
demos:
    enable: true
    title: "STL to PPTM Live Demos"
    content: |
        Convert STL to PPTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
