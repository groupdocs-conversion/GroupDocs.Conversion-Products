...
############################# Head ############################
head_title: "STL to TIFF Conversion in Java – Convert STL to TIFF"
head_description: "Convert STL to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to TIFF in few lines of code.
