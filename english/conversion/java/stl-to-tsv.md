...
############################# Head ############################
head_title: "STL to TSV Conversion in Java – Convert STL to TSV"
head_description: "Convert STL to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert STL Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting STL to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the STL file to TSV in few lines of code.
...
demos:
    enable: true
    title: "STL to TSV Live Demos"
    content: |
        Convert STL to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
