...
############################# Head ############################
head_title: "SVG to DOT Conversion in Java – Convert SVG to DOT"
head_description: "Convert SVG to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to DOT in few lines of code.
...
demos:
    enable: true
    title: "SVG to DOT Live Demos"
    content: |
        Convert SVG to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
