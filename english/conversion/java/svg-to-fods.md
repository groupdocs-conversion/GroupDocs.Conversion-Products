...
############################# Head ############################
head_title: "SVG to FODS Conversion in Java – Convert SVG to FODS"
head_description: "Convert SVG to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to FODS in few lines of code.
...
demos:
    enable: true
    title: "SVG to FODS Live Demos"
    content: |
        Convert SVG to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
