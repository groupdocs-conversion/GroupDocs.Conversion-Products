...
############################# Head ############################
head_title: "SVG to ICO Conversion in Java – Convert SVG to ICO"
head_description: "Convert SVG to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to ICO in few lines of code.
...
demos:
    enable: true
    title: "SVG to ICO Live Demos"
    content: |
        Convert SVG to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
