...
############################# Head ############################
head_title: "SVG to JPG Conversion in Java – Convert SVG to JPG"
head_description: "Convert SVG to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to JPG in few lines of code.
...
demos:
    enable: true
    title: "SVG to JPG Live Demos"
    content: |
        Convert SVG to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
