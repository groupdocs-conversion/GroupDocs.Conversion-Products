...
############################# Head ############################
head_title: "SVG to MD Conversion in Java – Convert SVG to MD"
head_description: "Convert SVG to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to MD in few lines of code.
...
demos:
    enable: true
    title: "SVG to MD Live Demos"
    content: |
        Convert SVG to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
