...
############################# Head ############################
head_title: "SVG to MHT Conversion in Java – Convert SVG to MHT"
head_description: "Convert SVG to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to MHT in few lines of code.
...
demos:
    enable: true
    title: "SVG to MHT Live Demos"
    content: |
        Convert SVG to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
