...
############################# Head ############################
head_title: "SVG to OTT Conversion in Java – Convert SVG to OTT"
head_description: "Convert SVG to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to OTT in few lines of code.
...
demos:
    enable: true
    title: "SVG to OTT Live Demos"
    content: |
        Convert SVG to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
