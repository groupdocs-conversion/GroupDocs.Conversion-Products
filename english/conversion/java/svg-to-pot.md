...
############################# Head ############################
head_title: "SVG to POT Conversion in Java – Convert SVG to POT"
head_description: "Convert SVG to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to POT in few lines of code.
...
demos:
    enable: true
    title: "SVG to POT Live Demos"
    content: |
        Convert SVG to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
