...
############################# Head ############################
head_title: "SVG to PPS Conversion in Java – Convert SVG to PPS"
head_description: "Convert SVG to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to PPS in few lines of code.
...
demos:
    enable: true
    title: "SVG to PPS Live Demos"
    content: |
        Convert SVG to PPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
