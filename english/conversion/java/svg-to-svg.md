...
############################# Head ############################
head_title: "SVG to SVG Conversion in Java – Convert SVG to SVG"
head_description: "Convert SVG to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to SVG in few lines of code.
...
demos:
    enable: true
    title: "SVG to SVG Live Demos"
    content: |
        Convert SVG to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
