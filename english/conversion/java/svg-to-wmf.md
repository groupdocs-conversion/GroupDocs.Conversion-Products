...
############################# Head ############################
head_title: "SVG to WMF Conversion in Java – Convert SVG to WMF"
head_description: "Convert SVG to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVG Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVG to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVG file to WMF in few lines of code.
...
demos:
    enable: true
    title: "SVG to WMF Live Demos"
    content: |
        Convert SVG to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
