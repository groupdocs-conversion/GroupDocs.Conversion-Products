...
############################# Head ############################
head_title: "SVGZ to JPEG Conversion in Java – Convert SVGZ to JPEG"
head_description: "Convert SVGZ to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVGZ Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVGZ to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVGZ file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "SVGZ to JPEG Live Demos"
    content: |
        Convert SVGZ to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
