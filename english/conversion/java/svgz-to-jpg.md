...
############################# Head ############################
head_title: "SVGZ to JPG Conversion in Java – Convert SVGZ to JPG"
head_description: "Convert SVGZ to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SVGZ Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SVGZ to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SVGZ file to JPG in few lines of code.
