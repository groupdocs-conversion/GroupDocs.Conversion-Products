...
############################# Head ############################
head_title: "SXC to EPUB Conversion in Java – Convert SXC to EPUB"
head_description: "Convert SXC to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "SXC to EPUB Live Demos"
    content: |
        Convert SXC to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
