...
############################# Head ############################
head_title: "SXC to FODS Conversion in Java – Convert SXC to FODS"
head_description: "Convert SXC to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to FODS in few lines of code.
...
demos:
    enable: true
    title: "SXC to FODS Live Demos"
    content: |
        Convert SXC to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
