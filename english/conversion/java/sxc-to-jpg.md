...
############################# Head ############################
head_title: "SXC to JPG Conversion in Java – Convert SXC to JPG"
head_description: "Convert SXC to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to JPG in few lines of code.
...
demos:
    enable: true
    title: "SXC to JPG Live Demos"
    content: |
        Convert SXC to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
