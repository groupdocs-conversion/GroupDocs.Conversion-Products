...
############################# Head ############################
head_title: "SXC to MD Conversion in Java – Convert SXC to MD"
head_description: "Convert SXC to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to MD in few lines of code.
...
demos:
    enable: true
    title: "SXC to MD Live Demos"
    content: |
        Convert SXC to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
