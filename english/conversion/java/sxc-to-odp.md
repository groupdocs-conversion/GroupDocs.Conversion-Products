...
############################# Head ############################
head_title: "SXC to ODP Conversion in Java – Convert SXC to ODP"
head_description: "Convert SXC to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to ODP in few lines of code.
