...
############################# Head ############################
head_title: "SXC to PNG Conversion in Java – Convert SXC to PNG"
head_description: "Convert SXC to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to PNG in few lines of code.
...
demos:
    enable: true
    title: "SXC to PNG Live Demos"
    content: |
        Convert SXC to PNG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
