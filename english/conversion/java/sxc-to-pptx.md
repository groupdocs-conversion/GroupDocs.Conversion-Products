...
############################# Head ############################
head_title: "SXC to PPTX Conversion in Java – Convert SXC to PPTX"
head_description: "Convert SXC to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "SXC to PPTX Live Demos"
    content: |
        Convert SXC to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
