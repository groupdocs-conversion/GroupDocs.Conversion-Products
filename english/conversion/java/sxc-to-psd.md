...
############################# Head ############################
head_title: "SXC to PSD Conversion in Java – Convert SXC to PSD"
head_description: "Convert SXC to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to PSD in few lines of code.
...
demos:
    enable: true
    title: "SXC to PSD Live Demos"
    content: |
        Convert SXC to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
