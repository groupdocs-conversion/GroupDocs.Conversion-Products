...
############################# Head ############################
head_title: "SXC to SXC Conversion in Java – Convert SXC to SXC"
head_description: "Convert SXC to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to SXC in few lines of code.
...
demos:
    enable: true
    title: "SXC to SXC Live Demos"
    content: |
        Convert SXC to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
