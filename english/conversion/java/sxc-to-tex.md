...
############################# Head ############################
head_title: "SXC to TEX Conversion in Java – Convert SXC to TEX"
head_description: "Convert SXC to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to TEX in few lines of code.
...
demos:
    enable: true
    title: "SXC to TEX Live Demos"
    content: |
        Convert SXC to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
