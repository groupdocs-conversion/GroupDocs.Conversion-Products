...
############################# Head ############################
head_title: "SXC to TIFF Conversion in Java – Convert SXC to TIFF"
head_description: "Convert SXC to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to TIFF in few lines of code.
