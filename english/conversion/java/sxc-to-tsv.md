...
############################# Head ############################
head_title: "SXC to TSV Conversion in Java – Convert SXC to TSV"
head_description: "Convert SXC to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to TSV in few lines of code.
...
demos:
    enable: true
    title: "SXC to TSV Live Demos"
    content: |
        Convert SXC to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
