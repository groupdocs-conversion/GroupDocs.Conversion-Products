...
############################# Head ############################
head_title: "SXC to XPS Conversion in Java – Convert SXC to XPS"
head_description: "Convert SXC to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert SXC Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting SXC to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the SXC file to XPS in few lines of code.
...
demos:
    enable: true
    title: "SXC to XPS Live Demos"
    content: |
        Convert SXC to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
