...
############################# Head ############################
head_title: "TEX to DOCX Conversion in Java – Convert TEX to DOCX"
head_description: "Convert TEX to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to DOCX in few lines of code.
