...
############################# Head ############################
head_title: "TEX to DOT Conversion in Java – Convert TEX to DOT"
head_description: "Convert TEX to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to DOT in few lines of code.
...
demos:
    enable: true
    title: "TEX to DOT Live Demos"
    content: |
        Convert TEX to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
