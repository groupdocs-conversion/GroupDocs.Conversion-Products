...
############################# Head ############################
head_title: "TEX to DOTM Conversion in Java – Convert TEX to DOTM"
head_description: "Convert TEX to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "TEX to DOTM Live Demos"
    content: |
        Convert TEX to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
