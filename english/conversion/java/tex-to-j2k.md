...
############################# Head ############################
head_title: "TEX to J2K Conversion in Java – Convert TEX to J2K"
head_description: "Convert TEX to J2K in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to J2K in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to J2K in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java/) makes it easy for developers to convert the TEX file to J2K in few lines of code.

        *   Create a new instance of Converter class and load the TEX file with full path
        *   Set ConvertOptions for the J2K document type
        *   Call the convert() method and pass the document name (full path) and format (J2K) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target J2K format
...
demos:
    enable: true
    title: "TEX to J2K Live Demos"
    content: |
        Convert TEX to J2K right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
