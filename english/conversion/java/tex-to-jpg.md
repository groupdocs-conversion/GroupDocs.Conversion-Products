...
############################# Head ############################
head_title: "TEX to JPG Conversion in Java – Convert TEX to JPG"
head_description: "Convert TEX to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to JPG in few lines of code.
