...
############################# Head ############################
head_title: "TEX to POTM Conversion in Java – Convert TEX to POTM"
head_description: "Convert TEX to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to POTM in few lines of code.
...
demos:
    enable: true
    title: "TEX to POTM Live Demos"
    content: |
        Convert TEX to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
