...
############################# Head ############################
head_title: "TEX to PPSX Conversion in Java – Convert TEX to PPSX"
head_description: "Convert TEX to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "TEX to PPSX Live Demos"
    content: |
        Convert TEX to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
