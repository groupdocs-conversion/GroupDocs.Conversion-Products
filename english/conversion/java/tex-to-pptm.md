...
############################# Head ############################
head_title: "TEX to PPTM Conversion in Java – Convert TEX to PPTM"
head_description: "Convert TEX to PPTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to PPTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to PPTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to PPTM in few lines of code.
...
demos:
    enable: true
    title: "TEX to PPTM Live Demos"
    content: |
        Convert TEX to PPTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
