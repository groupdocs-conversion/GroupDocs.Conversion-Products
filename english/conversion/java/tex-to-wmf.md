...
############################# Head ############################
head_title: "TEX to WMF Conversion in Java – Convert TEX to WMF"
head_description: "Convert TEX to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to WMF in few lines of code.
...
demos:
    enable: true
    title: "TEX to WMF Live Demos"
    content: |
        Convert TEX to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
