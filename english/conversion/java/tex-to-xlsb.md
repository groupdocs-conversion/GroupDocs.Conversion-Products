...
############################# Head ############################
head_title: "TEX to XLSB Conversion in Java – Convert TEX to XLSB"
head_description: "Convert TEX to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to XLSB in few lines of code.
...
demos:
    enable: true
    title: "TEX to XLSB Live Demos"
    content: |
        Convert TEX to XLSB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
