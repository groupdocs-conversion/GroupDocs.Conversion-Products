...
############################# Head ############################
head_title: "TEX to XLSM Conversion in Java – Convert TEX to XLSM"
head_description: "Convert TEX to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TEX Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TEX to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TEX file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "TEX to XLSM Live Demos"
    content: |
        Convert TEX to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
