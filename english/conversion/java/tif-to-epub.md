...
############################# Head ############################
head_title: "TIF to EPUB Conversion in Java – Convert TIF to EPUB"
head_description: "Convert TIF to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "TIF to EPUB Live Demos"
    content: |
        Convert TIF to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
