...
############################# Head ############################
head_title: "TIF to GIF Conversion in Java – Convert TIF to GIF"
head_description: "Convert TIF to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to GIF in few lines of code.
...
demos:
    enable: true
    title: "TIF to GIF Live Demos"
    content: |
        Convert TIF to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
