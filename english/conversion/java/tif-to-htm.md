...
############################# Head ############################
head_title: "TIF to HTM Conversion in Java – Convert TIF to HTM"
head_description: "Convert TIF to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to HTM in few lines of code.
...
demos:
    enable: true
    title: "TIF to HTM Live Demos"
    content: |
        Convert TIF to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
