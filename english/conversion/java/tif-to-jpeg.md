...
############################# Head ############################
head_title: "TIF to JPEG Conversion in Java – Convert TIF to JPEG"
head_description: "Convert TIF to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "TIF to JPEG Live Demos"
    content: |
        Convert TIF to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
