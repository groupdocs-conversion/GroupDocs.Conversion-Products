...
############################# Head ############################
head_title: "TIF to ODT Conversion in Java – Convert TIF to ODT"
head_description: "Convert TIF to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to ODT in few lines of code.
...
demos:
    enable: true
    title: "TIF to ODT Live Demos"
    content: |
        Convert TIF to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
