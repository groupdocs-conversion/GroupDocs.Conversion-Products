...
############################# Head ############################
head_title: "TIF to PPSX Conversion in Java – Convert TIF to PPSX"
head_description: "Convert TIF to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to PPSX in few lines of code.
...
demos:
    enable: true
    title: "TIF to PPSX Live Demos"
    content: |
        Convert TIF to PPSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
