...
############################# Head ############################
head_title: "TIF to PPTX Conversion in Java – Convert TIF to PPTX"
head_description: "Convert TIF to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "TIF to PPTX Live Demos"
    content: |
        Convert TIF to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
