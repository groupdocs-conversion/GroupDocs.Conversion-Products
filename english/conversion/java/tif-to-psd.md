...
############################# Head ############################
head_title: "TIF to PSD Conversion in Java – Convert TIF to PSD"
head_description: "Convert TIF to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to PSD in few lines of code.
...
demos:
    enable: true
    title: "TIF to PSD Live Demos"
    content: |
        Convert TIF to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
