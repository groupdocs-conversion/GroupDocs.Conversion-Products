...
############################# Head ############################
head_title: "TIF to TIF Conversion in Java – Convert TIF to TIF"
head_description: "Convert TIF to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIF Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIF to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIF file to TIF in few lines of code.
...
demos:
    enable: true
    title: "TIF to TIF Live Demos"
    content: |
        Convert TIF to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
