...
############################# Head ############################
head_title: "TIFF to SVGZ Conversion in Java – Convert TIFF to SVGZ"
head_description: "Convert TIFF to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TIFF Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TIFF to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TIFF file to SVGZ in few lines of code.
...
demos:
    enable: true
    title: "TIFF to SVGZ Live Demos"
    content: |
        Convert TIFF to SVGZ right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
