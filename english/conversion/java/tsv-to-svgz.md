...
############################# Head ############################
head_title: "TSV to SVGZ Conversion in Java – Convert TSV to SVGZ"
head_description: "Convert TSV to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TSV Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TSV to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TSV file to SVGZ in few lines of code.
