...
############################# Head ############################
head_title: "TXT to HTML Conversion in Java – Convert TXT to HTML"
head_description: "Convert TXT to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to HTML in few lines of code.
...
demos:
    enable: true
    title: "TXT to HTML Live Demos"
    content: |
        Convert TXT to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
