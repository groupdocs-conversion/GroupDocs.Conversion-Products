...
############################# Head ############################
head_title: "TXT to ICO Conversion in Java – Convert TXT to ICO"
head_description: "Convert TXT to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to ICO in few lines of code.
...
demos:
    enable: true
    title: "TXT to ICO Live Demos"
    content: |
        Convert TXT to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
