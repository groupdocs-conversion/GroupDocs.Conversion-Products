...
############################# Head ############################
head_title: "TXT to JP2 Conversion in Java – Convert TXT to JP2"
head_description: "Convert TXT to JP2 in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to JP2 in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to JP2 in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to JP2 in few lines of code.
