...
############################# Head ############################
head_title: "TXT to ODP Conversion in Java – Convert TXT to ODP"
head_description: "Convert TXT to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to ODP in few lines of code.
...
demos:
    enable: true
    title: "TXT to ODP Live Demos"
    content: |
        Convert TXT to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
