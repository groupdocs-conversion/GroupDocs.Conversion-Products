...
############################# Head ############################
head_title: "TXT to ODS Conversion in Java – Convert TXT to ODS"
head_description: "Convert TXT to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to ODS in few lines of code.
...
demos:
    enable: true
    title: "TXT to ODS Live Demos"
    content: |
        Convert TXT to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
