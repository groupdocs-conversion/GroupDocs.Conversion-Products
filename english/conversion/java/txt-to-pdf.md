...
############################# Head ############################
head_title: "TXT to PDF Conversion in Java – Convert TXT to PDF"
head_description: "Convert TXT to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to PDF in few lines of code.
