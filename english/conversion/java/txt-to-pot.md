...
############################# Head ############################
head_title: "TXT to POT Conversion in Java – Convert TXT to POT"
head_description: "Convert TXT to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to POT in few lines of code.
...
demos:
    enable: true
    title: "TXT to POT Live Demos"
    content: |
        Convert TXT to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
