...
############################# Head ############################
head_title: "TXT to POTM Conversion in Java – Convert TXT to POTM"
head_description: "Convert TXT to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to POTM in few lines of code.
...
demos:
    enable: true
    title: "TXT to POTM Live Demos"
    content: |
        Convert TXT to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
