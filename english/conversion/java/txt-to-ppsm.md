...
############################# Head ############################
head_title: "TXT to PPSM Conversion in Java – Convert TXT to PPSM"
head_description: "Convert TXT to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to PPSM in few lines of code.
