...
############################# Head ############################
head_title: "TXT to PSD Conversion in Java – Convert TXT to PSD"
head_description: "Convert TXT to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to PSD in few lines of code.
...
demos:
    enable: true
    title: "TXT to PSD Live Demos"
    content: |
        Convert TXT to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
