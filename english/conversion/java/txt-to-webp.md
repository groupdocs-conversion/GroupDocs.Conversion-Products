...
############################# Head ############################
head_title: "TXT to WEBP Conversion in Java – Convert TXT to WEBP"
head_description: "Convert TXT to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "TXT to WEBP Live Demos"
    content: |
        Convert TXT to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
