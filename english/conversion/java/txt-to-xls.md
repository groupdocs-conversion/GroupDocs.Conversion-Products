...
############################# Head ############################
head_title: "TXT to XLS Conversion in Java – Convert TXT to XLS"
head_description: "Convert TXT to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert TXT Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting TXT to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the TXT file to XLS in few lines of code.
...
demos:
    enable: true
    title: "TXT to XLS Live Demos"
    content: |
        Convert TXT to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
