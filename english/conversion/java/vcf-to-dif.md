...
############################# Head ############################
head_title: "VCF to DIF Conversion in Java – Convert VCF to DIF"
head_description: "Convert VCF to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to DIF in few lines of code.
