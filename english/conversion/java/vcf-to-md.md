...
############################# Head ############################
head_title: "VCF to MD Conversion in Java – Convert VCF to MD"
head_description: "Convert VCF to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to MD in few lines of code.
...
demos:
    enable: true
    title: "VCF to MD Live Demos"
    content: |
        Convert VCF to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
