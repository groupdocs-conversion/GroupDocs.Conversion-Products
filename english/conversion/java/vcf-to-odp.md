...
############################# Head ############################
head_title: "VCF to ODP Conversion in Java – Convert VCF to ODP"
head_description: "Convert VCF to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to ODP in few lines of code.
...
demos:
    enable: true
    title: "VCF to ODP Live Demos"
    content: |
        Convert VCF to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
