...
############################# Head ############################
head_title: "VCF to POT Conversion in Java – Convert VCF to POT"
head_description: "Convert VCF to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to POT in few lines of code.
...
demos:
    enable: true
    title: "VCF to POT Live Demos"
    content: |
        Convert VCF to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
