...
############################# Head ############################
head_title: "VCF to WMF Conversion in Java – Convert VCF to WMF"
head_description: "Convert VCF to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to WMF in few lines of code.
...
demos:
    enable: true
    title: "VCF to WMF Live Demos"
    content: |
        Convert VCF to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
