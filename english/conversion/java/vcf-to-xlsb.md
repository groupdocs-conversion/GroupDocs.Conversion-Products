...
############################# Head ############################
head_title: "VCF to XLSB Conversion in Java – Convert VCF to XLSB"
head_description: "Convert VCF to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to XLSB in few lines of code.
...
demos:
    enable: true
    title: "VCF to XLSB Live Demos"
    content: |
        Convert VCF to XLSB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
