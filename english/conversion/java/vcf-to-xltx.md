...
############################# Head ############################
head_title: "VCF to XLTX Conversion in Java – Convert VCF to XLTX"
head_description: "Convert VCF to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VCF Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VCF to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VCF file to XLTX in few lines of code.
...
demos:
    enable: true
    title: "VCF to XLTX Live Demos"
    content: |
        Convert VCF to XLTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
