...
############################# Head ############################
head_title: "VDW to FODP Conversion in Java – Convert VDW to FODP"
head_description: "Convert VDW to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDW Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDW to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDW file to FODP in few lines of code.
...
demos:
    enable: true
    title: "VDW to FODP Live Demos"
    content: |
        Convert VDW to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
