...
############################# Head ############################
head_title: "VDX to GIF Conversion in Java – Convert VDX to GIF"
head_description: "Convert VDX to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to GIF in few lines of code.
...
demos:
    enable: true
    title: "VDX to GIF Live Demos"
    content: |
        Convert VDX to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
