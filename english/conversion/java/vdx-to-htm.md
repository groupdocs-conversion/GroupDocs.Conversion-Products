...
############################# Head ############################
head_title: "VDX to HTM Conversion in Java – Convert VDX to HTM"
head_description: "Convert VDX to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to HTM in few lines of code.
