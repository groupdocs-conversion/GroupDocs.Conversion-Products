...
############################# Head ############################
head_title: "VDX to MHTML Conversion in Java – Convert VDX to MHTML"
head_description: "Convert VDX to MHTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to MHTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to MHTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to MHTML in few lines of code.
