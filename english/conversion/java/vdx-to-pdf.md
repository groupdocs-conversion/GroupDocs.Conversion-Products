...
############################# Head ############################
head_title: "VDX to PDF Conversion in Java – Convert VDX to PDF"
head_description: "Convert VDX to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to PDF in few lines of code.
