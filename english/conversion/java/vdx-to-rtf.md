...
############################# Head ############################
head_title: "VDX to RTF Conversion in Java – Convert VDX to RTF"
head_description: "Convert VDX to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to RTF in few lines of code.
...
demos:
    enable: true
    title: "VDX to RTF Live Demos"
    content: |
        Convert VDX to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
