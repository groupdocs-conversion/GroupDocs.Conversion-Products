...
############################# Head ############################
head_title: "VDX to TIF Conversion in Java – Convert VDX to TIF"
head_description: "Convert VDX to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to TIF in few lines of code.
