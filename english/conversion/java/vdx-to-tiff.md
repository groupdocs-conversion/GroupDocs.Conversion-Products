...
############################# Head ############################
head_title: "VDX to TIFF Conversion in Java – Convert VDX to TIFF"
head_description: "Convert VDX to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "VDX to TIFF Live Demos"
    content: |
        Convert VDX to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
