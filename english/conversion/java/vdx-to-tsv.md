...
############################# Head ############################
head_title: "VDX to TSV Conversion in Java – Convert VDX to TSV"
head_description: "Convert VDX to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to TSV in few lines of code.
...
demos:
    enable: true
    title: "VDX to TSV Live Demos"
    content: |
        Convert VDX to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
