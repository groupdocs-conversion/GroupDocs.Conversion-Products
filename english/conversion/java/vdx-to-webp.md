...
############################# Head ############################
head_title: "VDX to WEBP Conversion in Java – Convert VDX to WEBP"
head_description: "Convert VDX to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "VDX to WEBP Live Demos"
    content: |
        Convert VDX to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
