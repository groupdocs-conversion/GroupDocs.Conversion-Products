...
############################# Head ############################
head_title: "VDX to WMF Conversion in Java – Convert VDX to WMF"
head_description: "Convert VDX to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VDX Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VDX to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VDX file to WMF in few lines of code.
...
demos:
    enable: true
    title: "VDX to WMF Live Demos"
    content: |
        Convert VDX to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
