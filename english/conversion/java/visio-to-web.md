...
############################# Head ############################
head_title: "VISIO to WEB Conversion in Java – Convert VISIO to WEB"
head_description: "Convert VISIO to WEB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VISIO Files to WEB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VISIO to WEB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VISIO file to WEB in few lines of code.
...
demos:
    enable: true
    title: "VISIO to WEB Live Demos"
    content: |
        Convert VISIO to WEB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "VISIO TO DOCX"
          link: "https://products.groupdocs.com/conversion/java/visio-to-docx/"
