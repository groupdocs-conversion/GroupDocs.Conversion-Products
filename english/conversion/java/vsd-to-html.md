...
############################# Head ############################
head_title: "VSD to HTML Conversion in Java – Convert VSD to HTML"
head_description: "Convert VSD to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSD Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSD to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSD file to HTML in few lines of code.
