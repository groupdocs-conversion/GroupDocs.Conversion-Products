...
############################# Head ############################
head_title: "VSD to PPSM Conversion in Java – Convert VSD to PPSM"
head_description: "Convert VSD to PPSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSD Files to PPSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSD to PPSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSD file to PPSM in few lines of code.
