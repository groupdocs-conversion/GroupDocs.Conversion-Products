...
############################# Head ############################
head_title: "VSD to XPS Conversion in Java – Convert VSD to XPS"
head_description: "Convert VSD to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSD Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSD to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSD file to XPS in few lines of code.
