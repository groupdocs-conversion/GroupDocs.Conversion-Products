...
############################# Head ############################
head_title: "VSDX to ODS Conversion in Java – Convert VSDX to ODS"
head_description: "Convert VSDX to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to ODS in few lines of code.
...
demos:
    enable: true
    title: "VSDX to ODS Live Demos"
    content: |
        Convert VSDX to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
