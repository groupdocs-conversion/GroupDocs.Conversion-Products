...
############################# Head ############################
head_title: "VSDX to ODT Conversion in Java – Convert VSDX to ODT"
head_description: "Convert VSDX to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to ODT in few lines of code.
...
demos:
    enable: true
    title: "VSDX to ODT Live Demos"
    content: |
        Convert VSDX to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
