...
############################# Head ############################
head_title: "VSDX to PSD Conversion in Java – Convert VSDX to PSD"
head_description: "Convert VSDX to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to PSD in few lines of code.
...
demos:
    enable: true
    title: "VSDX to PSD Live Demos"
    content: |
        Convert VSDX to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
