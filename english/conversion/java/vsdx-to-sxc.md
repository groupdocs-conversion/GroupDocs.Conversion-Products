...
############################# Head ############################
head_title: "VSDX to SXC Conversion in Java – Convert VSDX to SXC"
head_description: "Convert VSDX to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to SXC in few lines of code.
...
demos:
    enable: true
    title: "VSDX to SXC Live Demos"
    content: |
        Convert VSDX to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
