...
############################# Head ############################
head_title: "VSDX to TSV Conversion in Java – Convert VSDX to TSV"
head_description: "Convert VSDX to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to TSV in few lines of code.
