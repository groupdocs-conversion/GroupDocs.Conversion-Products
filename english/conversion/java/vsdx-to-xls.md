...
############################# Head ############################
head_title: "VSDX to XLS Conversion in Java – Convert VSDX to XLS"
head_description: "Convert VSDX to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to XLS in few lines of code.
...
demos:
    enable: true
    title: "VSDX to XLS Live Demos"
    content: |
        Convert VSDX to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
