...
############################# Head ############################
head_title: "VSDX to XLSX Conversion in Java – Convert VSDX to XLSX"
head_description: "Convert VSDX to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "VSDX to XLSX Live Demos"
    content: |
        Convert VSDX to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
