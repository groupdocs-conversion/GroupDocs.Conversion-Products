...
############################# Head ############################
head_title: "VSDX to XLTX Conversion in Java – Convert VSDX to XLTX"
head_description: "Convert VSDX to XLTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to XLTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to XLTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to XLTX in few lines of code.
