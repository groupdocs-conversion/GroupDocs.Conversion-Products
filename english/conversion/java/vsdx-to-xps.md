...
############################# Head ############################
head_title: "VSDX to XPS Conversion in Java – Convert VSDX to XPS"
head_description: "Convert VSDX to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSDX Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSDX to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSDX file to XPS in few lines of code.
