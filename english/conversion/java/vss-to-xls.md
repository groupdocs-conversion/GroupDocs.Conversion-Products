...
############################# Head ############################
head_title: "VSS to XLS Conversion in Java – Convert VSS to XLS"
head_description: "Convert VSS to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSS Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSS to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSS file to XLS in few lines of code.
...
demos:
    enable: true
    title: "VSS to XLS Live Demos"
    content: |
        Convert VSS to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
