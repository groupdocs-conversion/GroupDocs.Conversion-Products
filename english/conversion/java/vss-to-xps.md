...
############################# Head ############################
head_title: "VSS to XPS Conversion in Java – Convert VSS to XPS"
head_description: "Convert VSS to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSS Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSS to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSS file to XPS in few lines of code.
...
demos:
    enable: true
    title: "VSS to XPS Live Demos"
    content: |
        Convert VSS to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
