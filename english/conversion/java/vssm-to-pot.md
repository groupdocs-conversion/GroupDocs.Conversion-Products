...
############################# Head ############################
head_title: "VSSM to POT Conversion in Java – Convert VSSM to POT"
head_description: "Convert VSSM to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSSM Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSSM to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSSM file to POT in few lines of code.
