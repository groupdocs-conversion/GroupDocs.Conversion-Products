...
############################# Head ############################
head_title: "VSSX to DOCX Conversion in Java – Convert VSSX to DOCX"
head_description: "Convert VSSX to DOCX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSSX Files to DOCX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSSX to DOCX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSSX file to DOCX in few lines of code.
...
demos:
    enable: true
    title: "VSSX to DOCX Live Demos"
    content: |
        Convert VSSX to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
