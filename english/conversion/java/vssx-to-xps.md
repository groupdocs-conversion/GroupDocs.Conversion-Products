...
############################# Head ############################
head_title: "VSSX to XPS Conversion in Java – Convert VSSX to XPS"
head_description: "Convert VSSX to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSSX Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSSX to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSSX file to XPS in few lines of code.
...
demos:
    enable: true
    title: "VSSX to XPS Live Demos"
    content: |
        Convert VSSX to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
