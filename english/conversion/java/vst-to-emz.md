...
############################# Head ############################
head_title: "VST to EMZ Conversion in Java – Convert VST to EMZ"
head_description: "Convert VST to EMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VST Files to EMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VST to EMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VST file to EMZ in few lines of code.
