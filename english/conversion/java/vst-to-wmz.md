...
############################# Head ############################
head_title: "VST to WMZ Conversion in Java – Convert VST to WMZ"
head_description: "Convert VST to WMZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VST Files to WMZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VST to WMZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VST file to WMZ in few lines of code.
