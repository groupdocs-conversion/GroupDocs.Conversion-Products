...
############################# Head ############################
head_title: "VST to XLSB Conversion in Java – Convert VST to XLSB"
head_description: "Convert VST to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VST Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VST to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VST file to XLSB in few lines of code.
