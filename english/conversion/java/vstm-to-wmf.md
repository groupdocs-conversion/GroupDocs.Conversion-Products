...
############################# Head ############################
head_title: "VSTM to WMF Conversion in Java – Convert VSTM to WMF"
head_description: "Convert VSTM to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSTM Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSTM to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSTM file to WMF in few lines of code.
...
demos:
    enable: true
    title: "VSTM to WMF Live Demos"
    content: |
        Convert VSTM to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
