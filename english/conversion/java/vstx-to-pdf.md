...
############################# Head ############################
head_title: "VSTX to PDF Conversion in Java – Convert VSTX to PDF"
head_description: "Convert VSTX to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSTX Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSTX to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSTX file to PDF in few lines of code.
...
demos:
    enable: true
    title: "VSTX to PDF Live Demos"
    content: |
        Convert VSTX to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
