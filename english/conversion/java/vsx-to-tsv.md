...
############################# Head ############################
head_title: "VSX to TSV Conversion in Java – Convert VSX to TSV"
head_description: "Convert VSX to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSX Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSX to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSX file to TSV in few lines of code.
...
demos:
    enable: true
    title: "VSX to TSV Live Demos"
    content: |
        Convert VSX to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
