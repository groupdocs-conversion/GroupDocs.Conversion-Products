...
############################# Head ############################
head_title: "VSX to WMF Conversion in Java – Convert VSX to WMF"
head_description: "Convert VSX to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VSX Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VSX to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VSX file to WMF in few lines of code.
...
demos:
    enable: true
    title: "VSX to WMF Live Demos"
    content: |
        Convert VSX to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
