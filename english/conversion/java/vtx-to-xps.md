...
############################# Head ############################
head_title: "VTX to XPS Conversion in Java – Convert VTX to XPS"
head_description: "Convert VTX to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert VTX Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting VTX to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the VTX file to XPS in few lines of code.
...
demos:
    enable: true
    title: "VTX to XPS Live Demos"
    content: |
        Convert VTX to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
