...
############################# Head ############################
head_title: "WEBP to FODS Conversion in Java – Convert WEBP to FODS"
head_description: "Convert WEBP to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to FODS in few lines of code.
...
demos:
    enable: true
    title: "WEBP to FODS Live Demos"
    content: |
        Convert WEBP to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
