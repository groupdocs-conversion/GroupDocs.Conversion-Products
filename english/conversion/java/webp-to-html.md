...
############################# Head ############################
head_title: "WEBP to HTML Conversion in Java – Convert WEBP to HTML"
head_description: "Convert WEBP to HTML in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to HTML in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to HTML in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to HTML in few lines of code.
