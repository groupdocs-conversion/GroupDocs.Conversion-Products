...
############################# Head ############################
head_title: "WEBP to JPEG Conversion in Java – Convert WEBP to JPEG"
head_description: "Convert WEBP to JPEG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to JPEG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to JPEG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to JPEG in few lines of code.
...
demos:
    enable: true
    title: "WEBP to JPEG Live Demos"
    content: |
        Convert WEBP to JPEG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
