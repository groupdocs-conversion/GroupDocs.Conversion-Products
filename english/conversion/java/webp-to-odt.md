...
############################# Head ############################
head_title: "WEBP to ODT Conversion in Java – Convert WEBP to ODT"
head_description: "Convert WEBP to ODT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to ODT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to ODT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to ODT in few lines of code.
...
demos:
    enable: true
    title: "WEBP to ODT Live Demos"
    content: |
        Convert WEBP to ODT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
