...
############################# Head ############################
head_title: "WEBP to TIFF Conversion in Java – Convert WEBP to TIFF"
head_description: "Convert WEBP to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WEBP Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WEBP to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WEBP file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "WEBP to TIFF Live Demos"
    content: |
        Convert WEBP to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
