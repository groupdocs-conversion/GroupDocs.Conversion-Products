...
############################# Head ############################
head_title: "WMF to EPUB Conversion in Java – Convert WMF to EPUB"
head_description: "Convert WMF to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "WMF to EPUB Live Demos"
    content: |
        Convert WMF to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
