...
############################# Head ############################
head_title: "WMF to GIF Conversion in Java – Convert WMF to GIF"
head_description: "Convert WMF to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to GIF in few lines of code.
...
demos:
    enable: true
    title: "WMF to GIF Live Demos"
    content: |
        Convert WMF to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
