...
############################# Head ############################
head_title: "WMF to HTM Conversion in Java – Convert WMF to HTM"
head_description: "Convert WMF to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to HTM in few lines of code.
...
demos:
    enable: true
    title: "WMF to HTM Live Demos"
    content: |
        Convert WMF to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
