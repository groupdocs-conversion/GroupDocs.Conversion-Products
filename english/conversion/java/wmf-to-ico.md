...
############################# Head ############################
head_title: "WMF to ICO Conversion in Java – Convert WMF to ICO"
head_description: "Convert WMF to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to ICO in few lines of code.
...
demos:
    enable: true
    title: "WMF to ICO Live Demos"
    content: |
        Convert WMF to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
