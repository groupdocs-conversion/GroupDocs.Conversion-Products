...
############################# Head ############################
head_title: "WMF to MD Conversion in Java – Convert WMF to MD"
head_description: "Convert WMF to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to MD in few lines of code.
...
demos:
    enable: true
    title: "WMF to MD Live Demos"
    content: |
        Convert WMF to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
