...
############################# Head ############################
head_title: "WMF to OTP Conversion in Java – Convert WMF to OTP"
head_description: "Convert WMF to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to OTP in few lines of code.
...
demos:
    enable: true
    title: "WMF to OTP Live Demos"
    content: |
        Convert WMF to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
