...
############################# Head ############################
head_title: "WMF to PNG Conversion in Java – Convert WMF to PNG"
head_description: "Convert WMF to PNG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to PNG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to PNG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to PNG in few lines of code.
...
demos:
    enable: true
    title: "WMF to PNG Live Demos"
    content: |
        Convert WMF to PNG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
