...
############################# Head ############################
head_title: "WMF to POTX Conversion in Java – Convert WMF to POTX"
head_description: "Convert WMF to POTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to POTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to POTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to POTX in few lines of code.
