...
############################# Head ############################
head_title: "WMF to SXC Conversion in Java – Convert WMF to SXC"
head_description: "Convert WMF to SXC in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to SXC in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to SXC in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to SXC in few lines of code.
...
demos:
    enable: true
    title: "WMF to SXC Live Demos"
    content: |
        Convert WMF to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
