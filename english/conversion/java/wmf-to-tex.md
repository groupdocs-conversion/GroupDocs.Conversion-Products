...
############################# Head ############################
head_title: "WMF to TEX Conversion in Java – Convert WMF to TEX"
head_description: "Convert WMF to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to TEX in few lines of code.
...
demos:
    enable: true
    title: "WMF to TEX Live Demos"
    content: |
        Convert WMF to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
