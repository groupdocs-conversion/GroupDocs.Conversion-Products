...
############################# Head ############################
head_title: "WMF to TIFF Conversion in Java – Convert WMF to TIFF"
head_description: "Convert WMF to TIFF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to TIFF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to TIFF in few lines of code.
...
demos:
    enable: true
    title: "WMF to TIFF Live Demos"
    content: |
        Convert WMF to TIFF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
