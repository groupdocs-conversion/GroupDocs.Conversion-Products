...
############################# Head ############################
head_title: "WMF to TSV Conversion in Java – Convert WMF to TSV"
head_description: "Convert WMF to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMF Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMF to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMF file to TSV in few lines of code.
...
demos:
    enable: true
    title: "WMF to TSV Live Demos"
    content: |
        Convert WMF to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
