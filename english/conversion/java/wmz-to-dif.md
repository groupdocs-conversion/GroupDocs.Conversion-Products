...
############################# Head ############################
head_title: "WMZ to DIF Conversion in Java – Convert WMZ to DIF"
head_description: "Convert WMZ to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMZ Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMZ to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMZ file to DIF in few lines of code.
