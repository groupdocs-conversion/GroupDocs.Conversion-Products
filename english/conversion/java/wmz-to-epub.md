...
############################# Head ############################
head_title: "WMZ to EPUB Conversion in Java – Convert WMZ to EPUB"
head_description: "Convert WMZ to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMZ Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMZ to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMZ file to EPUB in few lines of code.
