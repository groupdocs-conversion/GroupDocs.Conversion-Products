...
############################# Head ############################
head_title: "WMZ to PPT Conversion in Java – Convert WMZ to PPT"
head_description: "Convert WMZ to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMZ Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMZ to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMZ file to PPT in few lines of code.
