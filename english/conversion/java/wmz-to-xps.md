...
############################# Head ############################
head_title: "WMZ to XPS Conversion in Java – Convert WMZ to XPS"
head_description: "Convert WMZ to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WMZ Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WMZ to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WMZ file to XPS in few lines of code.
...
demos:
    enable: true
    title: "WMZ to XPS Live Demos"
    content: |
        Convert WMZ to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
