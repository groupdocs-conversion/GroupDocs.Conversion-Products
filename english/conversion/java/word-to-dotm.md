...
############################# Head ############################
head_title: "Convert Word to DOTM in Java – 3 Steps Conversion"
head_description: "Convert Word file to DOTM and 80+ other file formats using native documents conversion API for Java applications."

############################# Header ############################
title: "Convert Word to DOTM in Java Applications"
description: "Convert Word files to DOTM and 80+ other file formats using native documents conversion API for Java applications."
...
steps:
    enable: true
    title_left: "How to Convert Word File to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to accurately convert the word documents to DOTM using a few lines of Java code.
...
demos:
    enable: true
    title: "Live Demos: Word to DOTM Converter"
    content: |
