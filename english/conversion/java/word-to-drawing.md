...
############################# Head ############################
head_title: "WORD to DRAWING Conversion in Java – Convert WORD to DRAWING"
head_description: "Convert WORD to DRAWING in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to DRAWING in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to DRAWING in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to DRAWING in few lines of code.

        *   Create a new instance of Converter class and load the WORD file with full path
        *   Set ConvertOptions for the DRAWING document type
        *   Call the convert() method and pass the document name (full path) and format (DRAWING) as parameter
    ...
    code: |
        ...
        // Get the convert options ready for the target DRAWING format
...
demos:
    enable: true
    title: "WORD to DRAWING Live Demos"
    content: |
        Convert WORD to DRAWING right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
