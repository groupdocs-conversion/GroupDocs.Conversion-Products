...
############################# Head ############################
head_title: "WORD to EBOOK Conversion in Java – Convert WORD to EBOOK"
head_description: "Convert WORD to EBOOK in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to EBOOK in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to EBOOK in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to EBOOK in few lines of code.
...
demos:
    enable: true
    title: "WORD to EBOOK Live Demos"
    content: |
        Convert WORD to EBOOK right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
