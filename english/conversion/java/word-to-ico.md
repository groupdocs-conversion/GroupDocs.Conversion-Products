...
############################# Head ############################
head_title: "Convert Word to ICO in Java – 3 Steps Conversion"
head_description: "Convert Word file to ICO and 80+ other file formats using native documents conversion API for Java applications."

############################# Header ############################
title: "Convert Word to ICO in Java Applications"
description: "Convert Word files to ICO and 80+ other file formats using native documents conversion API for Java applications."
...
steps:
    enable: true
    title_left: "How to Convert Word File to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to accurately convert the word documents to ICO using a few lines of Java code.
...
demos:
    enable: true
    title: "Live Demos: Word to ICO Converter"
    content: |
        Convert Word to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
