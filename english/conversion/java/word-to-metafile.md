...
############################# Static ############################
layout: "auto-gen"
date: 2022-03-01T15:22:07
draft: false

############################# Head ############################
head_title: "WORD to METAFILE Conversion in Java – Convert WORD to METAFILE"
head_description: "Convert WORD to METAFILE in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to METAFILE in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to METAFILE in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to METAFILE in few lines of code.

        *   Create a new instance of Converter class and load the WORD file with full path
        *   Set ConvertOptions for the METAFILE document type
        *   Call the convert() method and pass the document name (full path) and format (METAFILE) as parameter
...
demos:
    enable: true
    title: "WORD to METAFILE Live Demos"
    content: |
        Convert WORD to METAFILE right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
