...
############################# Head ############################
head_title: "WORD to MHT Conversion in Java – Convert WORD to MHT"
head_description: "Convert WORD to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to MHT in few lines of code.
