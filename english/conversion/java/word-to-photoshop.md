...
############################# Head ############################
head_title: "WORD to PHOTOSHOP Conversion in Java – Convert WORD to PHOTOSHOP"
head_description: "Convert WORD to PHOTOSHOP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to PHOTOSHOP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to PHOTOSHOP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to PHOTOSHOP in few lines of code.
...
demos:
    enable: true
    title: "WORD to PHOTOSHOP Live Demos"
    content: |
