...
############################# Head ############################
head_title: "WORD to PPTX Conversion in Java – Convert WORD to PPTX"
head_description: "Convert WORD to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to PPTX in few lines of code.
