...
############################# Head ############################
head_title: "Convert Word to Presentation in Java – 3 Steps Conversion"
head_description: "Convert Word file to Presentation and 80+ other file formats using native documents conversion API for Java applications."

############################# Header ############################
title: "Convert Word to Presentation in Java Applications"
description: "Convert Word files to Presentation and 80+ other file formats using native documents conversion API for Java applications."
...
steps:
    enable: true
    title_left: "How to Convert Word File to Presentation in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to accurately convert the word documents to Presentation using a few lines of Java code.
