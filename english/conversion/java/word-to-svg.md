...
############################# Head ############################
head_title: "WORD to SVG Conversion in Java – Convert WORD to SVG"
head_description: "Convert WORD to SVG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert WORD Files to SVG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting WORD to SVG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the WORD file to SVG in few lines of code.
