...
############################# Head ############################
head_title: "Convert Word to TIFF in Java – 3 Steps Conversion"
head_description: "Convert Word file to TIFF and 80+ other file formats using native documents conversion API for Java applications."

############################# Header ############################
title: "Convert Word to TIFF in Java Applications"
description: "Convert Word files to TIFF and 80+ other file formats using native documents conversion API for Java applications."
...
steps:
    enable: true
    title_left: "How to Convert Word File to TIFF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to accurately convert the word documents to TIFF using a few lines of Java code.
