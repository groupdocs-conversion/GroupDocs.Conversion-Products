...
############################# Head ############################
head_title: "XLAM to DOT Conversion in Java – Convert XLAM to DOT"
head_description: "Convert XLAM to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLAM Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLAM to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLAM file to DOT in few lines of code.
