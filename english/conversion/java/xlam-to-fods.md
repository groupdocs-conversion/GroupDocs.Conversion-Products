...
############################# Head ############################
head_title: "XLAM to FODS Conversion in Java – Convert XLAM to FODS"
head_description: "Convert XLAM to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLAM Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLAM to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLAM file to FODS in few lines of code.
...
demos:
    enable: true
    title: "XLAM to FODS Live Demos"
    content: |
        Convert XLAM to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
