...
############################# Head ############################
head_title: "XLAM to TSV Conversion in Java – Convert XLAM to TSV"
head_description: "Convert XLAM to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLAM Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLAM to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLAM file to TSV in few lines of code.
...
demos:
    enable: true
    title: "XLAM to TSV Live Demos"
    content: |
        Convert XLAM to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
