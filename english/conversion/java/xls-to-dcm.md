...
############################# Head ############################
head_title: "XLS to DCM Conversion in Java – Convert XLS to DCM"
head_description: "Convert XLS to DCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to DCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to DCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to DCM in few lines of code.
...
demos:
    enable: true
    title: "XLS to DCM Live Demos"
    content: |
        Convert XLS to DCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
