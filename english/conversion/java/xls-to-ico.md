...
############################# Head ############################
head_title: "XLS to ICO Conversion in Java – Convert XLS to ICO"
head_description: "Convert XLS to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to ICO in few lines of code.
...
demos:
    enable: true
    title: "XLS to ICO Live Demos"
    content: |
        Convert XLS to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
