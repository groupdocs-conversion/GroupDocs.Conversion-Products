...
############################# Head ############################
head_title: "XLS to ODP Conversion in Java – Convert XLS to ODP"
head_description: "Convert XLS to ODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to ODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to ODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to ODP in few lines of code.
...
demos:
    enable: true
    title: "XLS to ODP Live Demos"
    content: |
        Convert XLS to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
