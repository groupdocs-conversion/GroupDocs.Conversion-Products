...
############################# Head ############################
head_title: "XLS to PDF Conversion in Java – Convert XLS to PDF"
head_description: "Convert XLS to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to PDF in few lines of code.
...
demos:
    enable: true
    title: "XLS to PDF Live Demos"
    content: |
        Convert XLS to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
