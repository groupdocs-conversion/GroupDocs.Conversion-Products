...
############################# Head ############################
head_title: "XLS to POT Conversion in Java – Convert XLS to POT"
head_description: "Convert XLS to POT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to POT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to POT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to POT in few lines of code.
...
demos:
    enable: true
    title: "XLS to POT Live Demos"
    content: |
        Convert XLS to POT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
