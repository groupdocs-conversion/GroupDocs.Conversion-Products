...
############################# Head ############################
head_title: "XLS to POTM Conversion in Java – Convert XLS to POTM"
head_description: "Convert XLS to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to POTM in few lines of code.
...
demos:
    enable: true
    title: "XLS to POTM Live Demos"
    content: |
        Convert XLS to POTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
