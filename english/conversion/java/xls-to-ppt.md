...
############################# Head ############################
head_title: "XLS to PPT Conversion in Java – Convert XLS to PPT"
head_description: "Convert XLS to PPT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to PPT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to PPT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to PPT in few lines of code.
...
demos:
    enable: true
    title: "XLS to PPT Live Demos"
    content: |
        Convert XLS to PPT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
