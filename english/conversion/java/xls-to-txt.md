...
############################# Head ############################
head_title: "XLS to TXT Conversion in Java – Convert XLS to TXT"
head_description: "Convert XLS to TXT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to TXT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to TXT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to TXT in few lines of code.
...
demos:
    enable: true
    title: "XLS to TXT Live Demos"
    content: |
        Convert XLS to TXT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
