...
############################# Head ############################
head_title: "XLS to XLSX Conversion in Java – Convert XLS to XLSX"
head_description: "Convert XLS to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "XLS to XLSX Live Demos"
    content: |
        Convert XLS to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
