...
############################# Head ############################
head_title: "XLS to XLT Conversion in Java – Convert XLS to XLT"
head_description: "Convert XLS to XLT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to XLT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to XLT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to XLT in few lines of code.
...
demos:
    enable: true
    title: "XLS to XLT Live Demos"
    content: |
        Convert XLS to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
