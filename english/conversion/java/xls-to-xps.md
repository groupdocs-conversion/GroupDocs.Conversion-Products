...
############################# Head ############################
head_title: "XLS to XPS Conversion in Java – Convert XLS to XPS"
head_description: "Convert XLS to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLS Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLS to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLS file to XPS in few lines of code.
...
demos:
    enable: true
    title: "XLS to XPS Live Demos"
    content: |
        Convert XLS to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
