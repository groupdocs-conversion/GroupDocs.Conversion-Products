...
############################# Head ############################
head_title: "XLSB to MHT Conversion in Java – Convert XLSB to MHT"
head_description: "Convert XLSB to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSB Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSB to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSB file to MHT in few lines of code.
