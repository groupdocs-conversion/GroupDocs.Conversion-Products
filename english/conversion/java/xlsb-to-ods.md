...
############################# Head ############################
head_title: "XLSB to ODS Conversion in Java – Convert XLSB to ODS"
head_description: "Convert XLSB to ODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSB Files to ODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSB to ODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSB file to ODS in few lines of code.
...
demos:
    enable: true
    title: "XLSB to ODS Live Demos"
    content: |
        Convert XLSB to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
