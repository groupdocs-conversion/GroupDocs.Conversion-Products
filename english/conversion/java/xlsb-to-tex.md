...
############################# Head ############################
head_title: "XLSB to TEX Conversion in Java – Convert XLSB to TEX"
head_description: "Convert XLSB to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSB Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSB to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSB file to TEX in few lines of code.
...
demos:
    enable: true
    title: "XLSB to TEX Live Demos"
    content: |
        Convert XLSB to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
