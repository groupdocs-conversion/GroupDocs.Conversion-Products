...
############################# Head ############################
head_title: "XLSM to FODS Conversion in Java – Convert XLSM to FODS"
head_description: "Convert XLSM to FODS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSM Files to FODS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSM to FODS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSM file to FODS in few lines of code.
...
demos:
    enable: true
    title: "XLSM to FODS Live Demos"
    content: |
        Convert XLSM to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
