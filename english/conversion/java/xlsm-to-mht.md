...
############################# Head ############################
head_title: "XLSM to MHT Conversion in Java – Convert XLSM to MHT"
head_description: "Convert XLSM to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSM Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSM to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSM file to MHT in few lines of code.
...
demos:
    enable: true
    title: "XLSM to MHT Live Demos"
    content: |
        Convert XLSM to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
