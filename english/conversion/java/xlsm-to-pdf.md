...
############################# Head ############################
head_title: "XLSM to PDF Conversion in Java – Convert XLSM to PDF"
head_description: "Convert XLSM to PDF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSM Files to PDF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSM to PDF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSM file to PDF in few lines of code.
...
demos:
    enable: true
    title: "XLSM to PDF Live Demos"
    content: |
        Convert XLSM to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
