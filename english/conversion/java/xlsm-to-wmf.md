...
############################# Head ############################
head_title: "XLSM to WMF Conversion in Java – Convert XLSM to WMF"
head_description: "Convert XLSM to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSM Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSM to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSM file to WMF in few lines of code.
...
demos:
    enable: true
    title: "XLSM to WMF Live Demos"
    content: |
        Convert XLSM to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
