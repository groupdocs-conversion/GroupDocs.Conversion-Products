...
############################# Head ############################
head_title: "XLSX to DOT Conversion in Java – Convert XLSX to DOT"
head_description: "Convert XLSX to DOT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to DOT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to DOT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to DOT in few lines of code.
...
demos:
    enable: true
    title: "XLSX to DOT Live Demos"
    content: |
        Convert XLSX to DOT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
