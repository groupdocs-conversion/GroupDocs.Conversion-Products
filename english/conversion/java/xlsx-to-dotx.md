...
############################# Head ############################
head_title: "XLSX to DOTX Conversion in Java – Convert XLSX to DOTX"
head_description: "Convert XLSX to DOTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to DOTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to DOTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to DOTX in few lines of code.
...
demos:
    enable: true
    title: "XLSX to DOTX Live Demos"
    content: |
        Convert XLSX to DOTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
