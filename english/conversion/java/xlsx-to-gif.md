...
############################# Head ############################
head_title: "XLSX to GIF Conversion in Java – Convert XLSX to GIF"
head_description: "Convert XLSX to GIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to GIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to GIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to GIF in few lines of code.
...
demos:
    enable: true
    title: "XLSX to GIF Live Demos"
    content: |
        Convert XLSX to GIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
