...
############################# Head ############################
head_title: "XLSX to JP2 Conversion in Java – Convert XLSX to JP2"
head_description: "Convert XLSX to JP2 in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to JP2 in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to JP2 in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to JP2 in few lines of code.
...
demos:
    enable: true
    title: "XLSX to JP2 Live Demos"
    content: |
        Convert XLSX to JP2 right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
