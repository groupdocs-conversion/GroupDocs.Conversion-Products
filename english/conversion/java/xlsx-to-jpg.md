...
############################# Head ############################
head_title: "XLSX to JPG Conversion in Java – Convert XLSX to JPG"
head_description: "Convert XLSX to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to JPG in few lines of code.
...
demos:
    enable: true
    title: "XLSX to JPG Live Demos"
    content: |
        Convert XLSX to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
