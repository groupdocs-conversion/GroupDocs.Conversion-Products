...
############################# Head ############################
head_title: "XLSX to POTM Conversion in Java – Convert XLSX to POTM"
head_description: "Convert XLSX to POTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to POTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to POTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to POTM in few lines of code.
