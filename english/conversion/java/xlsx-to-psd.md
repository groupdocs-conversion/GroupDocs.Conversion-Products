...
############################# Head ############################
head_title: "XLSX to PSD Conversion in Java – Convert XLSX to PSD"
head_description: "Convert XLSX to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to PSD in few lines of code.
