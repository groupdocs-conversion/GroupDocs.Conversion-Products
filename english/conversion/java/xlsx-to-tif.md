...
############################# Head ############################
head_title: "XLSX to TIF Conversion in Java – Convert XLSX to TIF"
head_description: "Convert XLSX to TIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to TIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to TIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to TIF in few lines of code.
