...
############################# Head ############################
head_title: "XLSX to WMF Conversion in Java – Convert XLSX to WMF"
head_description: "Convert XLSX to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLSX Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLSX to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLSX file to WMF in few lines of code.
...
demos:
    enable: true
    title: "XLSX to WMF Live Demos"
    content: |
        Convert XLSX to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
