...
############################# Head ############################
head_title: "XLT to DOCM Conversion in Java – Convert XLT to DOCM"
head_description: "Convert XLT to DOCM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLT Files to DOCM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLT to DOCM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLT file to DOCM in few lines of code.
...
demos:
    enable: true
    title: "XLT to DOCM Live Demos"
    content: |
        Convert XLT to DOCM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
