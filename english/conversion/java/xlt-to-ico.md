...
############################# Head ############################
head_title: "XLT to ICO Conversion in Java – Convert XLT to ICO"
head_description: "Convert XLT to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLT Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLT to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLT file to ICO in few lines of code.
...
demos:
    enable: true
    title: "XLT to ICO Live Demos"
    content: |
        Convert XLT to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
