...
############################# Head ############################
head_title: "XLT to OTP Conversion in Java – Convert XLT to OTP"
head_description: "Convert XLT to OTP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLT Files to OTP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLT to OTP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLT file to OTP in few lines of code.
...
demos:
    enable: true
    title: "XLT to OTP Live Demos"
    content: |
        Convert XLT to OTP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
