...
############################# Head ############################
head_title: "XLT to PPTM Conversion in Java – Convert XLT to PPTM"
head_description: "Convert XLT to PPTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLT Files to PPTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLT to PPTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLT file to PPTM in few lines of code.
