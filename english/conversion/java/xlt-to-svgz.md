...
############################# Head ############################
head_title: "XLT to SVGZ Conversion in Java – Convert XLT to SVGZ"
head_description: "Convert XLT to SVGZ in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLT Files to SVGZ in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLT to SVGZ in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLT file to SVGZ in few lines of code.
