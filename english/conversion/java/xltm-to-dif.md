...
############################# Head ############################
head_title: "XLTM to DIF Conversion in Java – Convert XLTM to DIF"
head_description: "Convert XLTM to DIF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTM Files to DIF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTM to DIF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTM file to DIF in few lines of code.
...
demos:
    enable: true
    title: "XLTM to DIF Live Demos"
    content: |
        Convert XLTM to DIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
