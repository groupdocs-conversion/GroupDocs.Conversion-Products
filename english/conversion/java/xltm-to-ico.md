...
############################# Head ############################
head_title: "XLTM to ICO Conversion in Java – Convert XLTM to ICO"
head_description: "Convert XLTM to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTM Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTM to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTM file to ICO in few lines of code.
...
demos:
    enable: true
    title: "XLTM to ICO Live Demos"
    content: |
        Convert XLTM to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
