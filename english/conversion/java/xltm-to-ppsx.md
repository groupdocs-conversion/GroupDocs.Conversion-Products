...
############################# Head ############################
head_title: "XLTM to PPSX Conversion in Java – Convert XLTM to PPSX"
head_description: "Convert XLTM to PPSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTM Files to PPSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTM to PPSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTM file to PPSX in few lines of code.
