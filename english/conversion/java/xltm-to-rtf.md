...
############################# Head ############################
head_title: "XLTM to RTF Conversion in Java – Convert XLTM to RTF"
head_description: "Convert XLTM to RTF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTM Files to RTF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTM to RTF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTM file to RTF in few lines of code.
...
demos:
    enable: true
    title: "XLTM to RTF Live Demos"
    content: |
        Convert XLTM to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
