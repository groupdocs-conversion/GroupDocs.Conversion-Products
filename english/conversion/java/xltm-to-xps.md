...
############################# Head ############################
head_title: "XLTM to XPS Conversion in Java – Convert XLTM to XPS"
head_description: "Convert XLTM to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTM Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTM to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTM file to XPS in few lines of code.
...
demos:
    enable: true
    title: "XLTM to XPS Live Demos"
    content: |
        Convert XLTM to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
