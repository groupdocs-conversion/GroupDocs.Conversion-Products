...
############################# Head ############################
head_title: "XLTX to CSV Conversion in Java – Convert XLTX to CSV"
head_description: "Convert XLTX to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to CSV in few lines of code.
...
demos:
    enable: true
    title: "XLTX to CSV Live Demos"
    content: |
        Convert XLTX to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
