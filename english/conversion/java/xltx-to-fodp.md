...
############################# Head ############################
head_title: "XLTX to FODP Conversion in Java – Convert XLTX to FODP"
head_description: "Convert XLTX to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to FODP in few lines of code.
...
demos:
    enable: true
    title: "XLTX to FODP Live Demos"
    content: |
        Convert XLTX to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
