...
############################# Head ############################
head_title: "XLTX to JPG Conversion in Java – Convert XLTX to JPG"
head_description: "Convert XLTX to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to JPG in few lines of code.
...
demos:
    enable: true
    title: "XLTX to JPG Live Demos"
    content: |
        Convert XLTX to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
