...
############################# Head ############################
head_title: "XLTX to MD Conversion in Java – Convert XLTX to MD"
head_description: "Convert XLTX to MD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to MD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to MD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to MD in few lines of code.
...
demos:
    enable: true
    title: "XLTX to MD Live Demos"
    content: |
        Convert XLTX to MD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
