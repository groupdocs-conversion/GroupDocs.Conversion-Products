...
############################# Head ############################
head_title: "XLTX to PSD Conversion in Java – Convert XLTX to PSD"
head_description: "Convert XLTX to PSD in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to PSD in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to PSD in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to PSD in few lines of code.
...
demos:
    enable: true
    title: "XLTX to PSD Live Demos"
    content: |
        Convert XLTX to PSD right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
