...
############################# Head ############################
head_title: "XLTX to WMF Conversion in Java – Convert XLTX to WMF"
head_description: "Convert XLTX to WMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to WMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to WMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to WMF in few lines of code.
...
demos:
    enable: true
    title: "XLTX to WMF Live Demos"
    content: |
        Convert XLTX to WMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
