...
############################# Head ############################
head_title: "XLTX to XLS Conversion in Java – Convert XLTX to XLS"
head_description: "Convert XLTX to XLS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to XLS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to XLS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to XLS in few lines of code.
...
demos:
    enable: true
    title: "XLTX to XLS Live Demos"
    content: |
        Convert XLTX to XLS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
