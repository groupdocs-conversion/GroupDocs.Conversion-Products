...
############################# Head ############################
head_title: "XLTX to XLSB Conversion in Java – Convert XLTX to XLSB"
head_description: "Convert XLTX to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to XLSB in few lines of code.
