...
############################# Head ############################
head_title: "XLTX to XLSM Conversion in Java – Convert XLTX to XLSM"
head_description: "Convert XLTX to XLSM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to XLSM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to XLSM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to XLSM in few lines of code.
...
demos:
    enable: true
    title: "XLTX to XLSM Live Demos"
    content: |
        Convert XLTX to XLSM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
