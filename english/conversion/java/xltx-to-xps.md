...
############################# Head ############################
head_title: "XLTX to XPS Conversion in Java – Convert XLTX to XPS"
head_description: "Convert XLTX to XPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XLTX Files to XPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XLTX to XPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XLTX file to XPS in few lines of code.
...
demos:
    enable: true
    title: "XLTX to XPS Live Demos"
    content: |
        Convert XLTX to XPS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
