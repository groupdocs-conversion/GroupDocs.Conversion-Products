...
############################# Head ############################
head_title: "XML to CSV Conversion in Java – Convert XML to CSV"
head_description: "Convert XML to CSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to CSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to CSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to CSV in few lines of code.
...
demos:
    enable: true
    title: "XML to CSV Live Demos"
    content: |
        Convert XML to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
