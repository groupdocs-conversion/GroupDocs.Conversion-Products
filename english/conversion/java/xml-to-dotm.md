...
############################# Head ############################
head_title: "XML to DOTM Conversion in Java – Convert XML to DOTM"
head_description: "Convert XML to DOTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to DOTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to DOTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to DOTM in few lines of code.
...
demos:
    enable: true
    title: "XML to DOTM Live Demos"
    content: |
        Convert XML to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
