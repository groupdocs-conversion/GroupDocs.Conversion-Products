...
############################# Head ############################
head_title: "XML to DOTX Conversion in Java – Convert XML to DOTX"
head_description: "Convert XML to DOTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to DOTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to DOTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to DOTX in few lines of code.
...
demos:
    enable: true
    title: "XML to DOTX Live Demos"
    content: |
        Convert XML to DOTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
