...
############################# Head ############################
head_title: "XML to EMF Conversion in Java – Convert XML to EMF"
head_description: "Convert XML to EMF in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to EMF in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to EMF in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to EMF in few lines of code.
...
demos:
    enable: true
    title: "XML to EMF Live Demos"
    content: |
        Convert XML to EMF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
