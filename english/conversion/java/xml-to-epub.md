...
############################# Head ############################
head_title: "XML to EPUB Conversion in Java – Convert XML to EPUB"
head_description: "Convert XML to EPUB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to EPUB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to EPUB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to EPUB in few lines of code.
...
demos:
    enable: true
    title: "XML to EPUB Live Demos"
    content: |
        Convert XML to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
