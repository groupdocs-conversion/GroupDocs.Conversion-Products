...
############################# Head ############################
head_title: "XML to HTM Conversion in Java – Convert XML to HTM"
head_description: "Convert XML to HTM in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to HTM in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to HTM in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to HTM in few lines of code.
