...
############################# Head ############################
head_title: "XML to ICO Conversion in Java – Convert XML to ICO"
head_description: "Convert XML to ICO in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to ICO in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to ICO in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to ICO in few lines of code.
