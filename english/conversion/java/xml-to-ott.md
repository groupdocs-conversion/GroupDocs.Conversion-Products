...
############################# Head ############################
head_title: "XML to OTT Conversion in Java – Convert XML to OTT"
head_description: "Convert XML to OTT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to OTT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to OTT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to OTT in few lines of code.
...
demos:
    enable: true
    title: "XML to OTT Live Demos"
    content: |
        Convert XML to OTT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
