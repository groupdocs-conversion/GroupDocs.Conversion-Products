...
############################# Head ############################
head_title: "XML to PPS Conversion in Java – Convert XML to PPS"
head_description: "Convert XML to PPS in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to PPS in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to PPS in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to PPS in few lines of code.
