...
############################# Head ############################
head_title: "XML to PPTX Conversion in Java – Convert XML to PPTX"
head_description: "Convert XML to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "XML to PPTX Live Demos"
    content: |
        Convert XML to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
