...
############################# Head ############################
head_title: "XML to TEX Conversion in Java – Convert XML to TEX"
head_description: "Convert XML to TEX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to TEX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to TEX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to TEX in few lines of code.
...
demos:
    enable: true
    title: "XML to TEX Live Demos"
    content: |
        Convert XML to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
