...
############################# Head ############################
head_title: "XML to WEBP Conversion in Java – Convert XML to WEBP"
head_description: "Convert XML to WEBP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XML Files to WEBP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XML to WEBP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XML file to WEBP in few lines of code.
...
demos:
    enable: true
    title: "XML to WEBP Live Demos"
    content: |
        Convert XML to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
