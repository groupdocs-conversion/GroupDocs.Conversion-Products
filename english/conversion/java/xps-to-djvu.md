...
############################# Head ############################
head_title: "XPS to DJVU Conversion in Java – Convert XPS to DJVU"
head_description: "Convert XPS to DJVU in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to DJVU in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to DJVU in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to DJVU in few lines of code.
