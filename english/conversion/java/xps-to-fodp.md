...
############################# Head ############################
head_title: "XPS to FODP Conversion in Java – Convert XPS to FODP"
head_description: "Convert XPS to FODP in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to FODP in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to FODP in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to FODP in few lines of code.
...
demos:
    enable: true
    title: "XPS to FODP Live Demos"
    content: |
        Convert XPS to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
