...
############################# Head ############################
head_title: "XPS to JPG Conversion in Java – Convert XPS to JPG"
head_description: "Convert XPS to JPG in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to JPG in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to JPG in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to JPG in few lines of code.
...
demos:
    enable: true
    title: "XPS to JPG Live Demos"
    content: |
        Convert XPS to JPG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
