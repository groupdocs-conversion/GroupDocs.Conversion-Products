...
############################# Head ############################
head_title: "XPS to MHT Conversion in Java – Convert XPS to MHT"
head_description: "Convert XPS to MHT in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to MHT in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to MHT in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to MHT in few lines of code.
...
demos:
    enable: true
    title: "XPS to MHT Live Demos"
    content: |
        Convert XPS to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
