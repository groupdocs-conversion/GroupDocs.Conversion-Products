...
############################# Head ############################
head_title: "XPS to PPTX Conversion in Java – Convert XPS to PPTX"
head_description: "Convert XPS to PPTX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to PPTX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to PPTX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to PPTX in few lines of code.
...
demos:
    enable: true
    title: "XPS to PPTX Live Demos"
    content: |
        Convert XPS to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
