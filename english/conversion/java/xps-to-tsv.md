...
############################# Head ############################
head_title: "XPS to TSV Conversion in Java – Convert XPS to TSV"
head_description: "Convert XPS to TSV in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to TSV in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to TSV in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to TSV in few lines of code.
...
demos:
    enable: true
    title: "XPS to TSV Live Demos"
    content: |
        Convert XPS to TSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
