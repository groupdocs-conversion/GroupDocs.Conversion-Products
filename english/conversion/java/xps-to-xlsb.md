...
############################# Head ############################
head_title: "XPS to XLSB Conversion in Java – Convert XPS to XLSB"
head_description: "Convert XPS to XLSB in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to XLSB in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to XLSB in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to XLSB in few lines of code.
...
demos:
    enable: true
    title: "XPS to XLSB Live Demos"
    content: |
        Convert XPS to XLSB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
