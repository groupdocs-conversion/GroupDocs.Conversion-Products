...
############################# Head ############################
head_title: "XPS to XLSX Conversion in Java – Convert XPS to XLSX"
head_description: "Convert XPS to XLSX in Java using a few lines of code. Convert 160+ file formats via GroupDocs documents conversion APIs for java."

############################# Header ############################
title: "Convert XPS Files to XLSX in Java"
...
steps:
    enable: true
    title_left: "Steps for Converting XPS to XLSX in Java"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/java) makes it easy for developers to convert the XPS file to XLSX in few lines of code.
...
demos:
    enable: true
    title: "XPS to XLSX Live Demos"
    content: |
        Convert XPS to XLSX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
