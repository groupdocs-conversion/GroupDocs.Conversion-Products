...
############################# Head ############################
head_title: "AI to AI Converter – Convert AI to AI in C# .NET"
head_description: "How to convert AI to AI in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert AI to AI in C#"
description: "Native and high performance AI to AI conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the AI file to AI using a few lines of code.

        *   Create an instance of Converter class and load the AI file with full path
        *   Create & set ConvertOptions for the ai type
        *   Call Converter.Convert method and pass the full path and format (AI) as parameter
    ...
    code: |
        ...
        // set the convert options for AI format
