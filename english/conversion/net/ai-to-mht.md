...
############################# Head ############################
head_title: "AI to MHT Converter – Convert AI to MHT in C# .NET"
head_description: "How to convert AI to MHT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert AI to MHT in C#"
description: "Native and high performance AI to MHT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert AI to MHT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the AI file to MHT using a few lines of code.
