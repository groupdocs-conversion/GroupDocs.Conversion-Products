...
############################# Head ############################
head_title: "CAD to PHOTOSHOP Converter – Convert CAD to PHOTOSHOP in C# .NET"
head_description: "How to convert CAD to PHOTOSHOP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CAD to PHOTOSHOP in C#"
description: "Native and high performance CAD to PHOTOSHOP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert CAD to PHOTOSHOP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CAD file to PHOTOSHOP using a few lines of code.
...
demos:
    enable: true
    title: "CAD to PHOTOSHOP Live Demos"
    content: |
        Convert CAD to PHOTOSHOP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
