...
############################# Head ############################
head_title: "CDR to ICO Converter – Convert CDR to ICO in C# .NET"
head_description: "How to convert CDR to ICO in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CDR to ICO in C#"
description: "Native and high performance CDR to ICO conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert CDR to ICO in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CDR file to ICO using a few lines of code.
...
demos:
    enable: true
    title: "CDR to ICO Live Demos"
    content: |
        Convert CDR to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
