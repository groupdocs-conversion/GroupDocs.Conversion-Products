...
############################# Head ############################
head_title: "CDR to SVG Converter – Convert CDR to SVG in C# .NET"
head_description: "How to convert CDR to SVG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CDR to SVG in C#"
description: "Native and high performance CDR to SVG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert CDR to SVG in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CDR file to SVG using a few lines of code.
