...
############################# Head ############################
head_title: "CDR to TXT Converter – Convert CDR to TXT in C# .NET"
head_description: "How to convert CDR to TXT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CDR to TXT in C#"
description: "Native and high performance CDR to TXT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CDR file to TXT using a few lines of code.
