...
############################# Head ############################
head_title: "CDR to WEBP Converter – Convert CDR to WEBP in C# .NET"
head_description: "How to convert CDR to WEBP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CDR to WEBP in C#"
description: "Native and high performance CDR to WEBP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert CDR to WEBP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CDR file to WEBP using a few lines of code.
