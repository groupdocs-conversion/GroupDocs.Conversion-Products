...
############################# Head ############################
head_title: "CF2 to FODP Converter – Convert CF2 to FODP in C# .NET"
head_description: "How to convert CF2 to FODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CF2 to FODP in C#"
description: "Native and high performance CF2 to FODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CF2 file to FODP using a few lines of code.
