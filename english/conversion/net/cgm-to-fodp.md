...
############################# Head ############################
head_title: "CGM to FODP Converter – Convert CGM to FODP in C# .NET"
head_description: "How to convert CGM to FODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CGM to FODP in C#"
description: "Native and high performance CGM to FODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert CGM to FODP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CGM file to FODP using a few lines of code.
