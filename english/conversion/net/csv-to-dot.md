...
############################# Head ############################
head_title: "CSV to DOT Converter – Convert CSV to DOT in C# .NET"
head_description: "How to convert CSV to DOT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CSV to DOT in C#"
description: "Native and high performance CSV to DOT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CSV file to DOT using a few lines of code.
