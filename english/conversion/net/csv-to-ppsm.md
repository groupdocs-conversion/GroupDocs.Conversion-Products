...
############################# Head ############################
head_title: "CSV to PPSM Converter – Convert CSV to PPSM in C# .NET"
head_description: "How to convert CSV to PPSM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CSV to PPSM in C#"
description: "Native and high performance CSV to PPSM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert CSV to PPSM in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CSV file to PPSM using a few lines of code.
