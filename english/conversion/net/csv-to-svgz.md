...
############################# Head ############################
head_title: "CSV to SVGZ Converter – Convert CSV to SVGZ in C# .NET"
head_description: "How to convert CSV to SVGZ in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert CSV to SVGZ in C#"
description: "Native and high performance CSV to SVGZ conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the CSV file to SVGZ using a few lines of code.
