...
############################# Head ############################
head_title: "DGN to DOC Converter – Convert DGN to DOC in C# .NET"
head_description: "How to convert DGN to DOC in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DGN to DOC in C#"
description: "Native and high performance DGN to DOC conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DGN to DOC in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DGN file to DOC using a few lines of code.
...
demos:
    enable: true
    title: "DGN to DOC Live Demos"
    content: |
        Convert DGN to DOC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
