...
############################# Head ############################
head_title: "DGN to DOT Converter – Convert DGN to DOT in C# .NET"
head_description: "How to convert DGN to DOT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DGN to DOT in C#"
description: "Native and high performance DGN to DOT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DGN file to DOT using a few lines of code.
