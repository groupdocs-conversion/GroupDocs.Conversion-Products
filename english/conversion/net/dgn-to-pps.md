...
############################# Head ############################
head_title: "DGN to PPS Converter – Convert DGN to PPS in C# .NET"
head_description: "How to convert DGN to PPS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DGN to PPS in C#"
description: "Native and high performance DGN to PPS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DGN file to PPS using a few lines of code.
