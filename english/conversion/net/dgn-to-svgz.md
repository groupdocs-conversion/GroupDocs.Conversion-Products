...
############################# Head ############################
head_title: "DGN to SVGZ Converter – Convert DGN to SVGZ in C# .NET"
head_description: "How to convert DGN to SVGZ in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DGN to SVGZ in C#"
description: "Native and high performance DGN to SVGZ conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DGN to SVGZ in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DGN file to SVGZ using a few lines of code.
