...
############################# Head ############################
head_title: "DIB to DIB Converter – Convert DIB to DIB in C# .NET"
head_description: "How to convert DIB to DIB in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DIB to DIB in C#"
description: "Native and high performance DIB to DIB conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DIB file to DIB using a few lines of code.

        *   Create an instance of Converter class and load the DIB file with full path
        *   Create & set ConvertOptions for the dib type
        *   Call Converter.Convert method and pass the full path and format (DIB) as parameter
    ...
    code: |
        ...
        // set the convert options for DIB format
...
demos:
    enable: true
    title: "DIB to DIB Live Demos"
    content: |
        Convert DIB to DIB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
