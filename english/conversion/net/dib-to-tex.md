...
############################# Head ############################
head_title: "DIB to TEX Converter – Convert DIB to TEX in C# .NET"
head_description: "How to convert DIB to TEX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DIB to TEX in C#"
description: "Native and high performance DIB to TEX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DIB file to TEX using a few lines of code.
