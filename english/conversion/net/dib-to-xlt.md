...
############################# Head ############################
head_title: "DIB to XLT Converter – Convert DIB to XLT in C# .NET"
head_description: "How to convert DIB to XLT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DIB to XLT in C#"
description: "Native and high performance DIB to XLT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DIB file to XLT using a few lines of code.
