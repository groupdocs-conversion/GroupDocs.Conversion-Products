...
############################# Head ############################
head_title: "DNG to GIF Converter – Convert DNG to GIF in C# .NET"
head_description: "How to convert DNG to GIF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DNG to GIF in C#"
description: "Native and high performance DNG to GIF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DNG file to GIF using a few lines of code.
