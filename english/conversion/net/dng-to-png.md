...
############################# Head ############################
head_title: "DNG to PNG Converter – Convert DNG to PNG in C# .NET"
head_description: "How to convert DNG to PNG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DNG to PNG in C#"
description: "Native and high performance DNG to PNG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DNG to PNG in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DNG file to PNG using a few lines of code.
