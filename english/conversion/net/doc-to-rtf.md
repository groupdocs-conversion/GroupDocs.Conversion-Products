...
############################# Head ############################
head_title: "DOC to RTF Converter – Convert DOC to RTF in C# .NET"
head_description: "How to convert DOC to RTF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DOC to RTF in C#"
description: "Native and high performance DOC to RTF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DOC file to RTF using a few lines of code.
...
demos:
    enable: true
    title: "DOC to RTF Live Demos"
    content: |
        Convert DOC to RTF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
