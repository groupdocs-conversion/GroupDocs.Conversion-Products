...
############################# Head ############################
head_title: "DOCX to DOTM Converter – Convert DOCX to DOTM in C# .NET"
head_description: "How to convert DOCX to DOTM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DOCX to DOTM in C#"
description: "Native and high performance DOCX to DOTM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DOCX to DOTM in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DOCX file to DOTM using a few lines of code.
...
demos:
    enable: true
    title: "DOCX to DOTM Live Demos"
    content: |
        Convert DOCX to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
