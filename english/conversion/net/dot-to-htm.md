...
############################# Head ############################
head_title: "DOT to HTM Converter – Convert DOT to HTM in C# .NET"
head_description: "How to convert DOT to HTM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DOT to HTM in C#"
description: "Native and high performance DOT to HTM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DOT file to HTM using a few lines of code.
...
demos:
    enable: true
    title: "DOT to HTM Live Demos"
    content: |
        Convert DOT to HTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
