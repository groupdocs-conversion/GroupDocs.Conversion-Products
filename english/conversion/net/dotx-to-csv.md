...
############################# Head ############################
head_title: "DOTX to CSV Converter – Convert DOTX to CSV in C# .NET"
head_description: "How to convert DOTX to CSV in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DOTX to CSV in C#"
description: "Native and high performance DOTX to CSV conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DOTX file to CSV using a few lines of code.
