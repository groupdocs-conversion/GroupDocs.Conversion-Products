...
############################# Head ############################
head_title: "DOTX to ODS Converter – Convert DOTX to ODS in C# .NET"
head_description: "How to convert DOTX to ODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DOTX to ODS in C#"
description: "Native and high performance DOTX to ODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DOTX to ODS in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DOTX file to ODS using a few lines of code.
...
demos:
    enable: true
    title: "DOTX to ODS Live Demos"
    content: |
        Convert DOTX to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
