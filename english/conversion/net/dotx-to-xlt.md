...
############################# Head ############################
head_title: "DOTX to XLT Converter – Convert DOTX to XLT in C# .NET"
head_description: "How to convert DOTX to XLT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DOTX to XLT in C#"
description: "Native and high performance DOTX to XLT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DOTX file to XLT using a few lines of code.
...
demos:
    enable: true
    title: "DOTX to XLT Live Demos"
    content: |
        Convert DOTX to XLT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
