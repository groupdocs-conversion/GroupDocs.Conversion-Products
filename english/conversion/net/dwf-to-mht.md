...
############################# Head ############################
head_title: "DWF to MHT Converter – Convert DWF to MHT in C# .NET"
head_description: "How to convert DWF to MHT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DWF to MHT in C#"
description: "Native and high performance DWF to MHT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DWF file to MHT using a few lines of code.
