...
############################# Head ############################
head_title: "DWF to XLTX Converter – Convert DWF to XLTX in C# .NET"
head_description: "How to convert DWF to XLTX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DWF to XLTX in C#"
description: "Native and high performance DWF to XLTX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DWF to XLTX in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DWF file to XLTX using a few lines of code.
