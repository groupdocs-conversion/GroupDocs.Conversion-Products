...
############################# Head ############################
head_title: "DWFX to DWF Converter – Convert DWFX to DWF in C# .NET"
head_description: "How to convert DWFX to DWF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DWFX to DWF in C#"
description: "Native and high performance DWFX to DWF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DWFX to DWF in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DWFX file to DWF using a few lines of code.

        *   Create an instance of Converter class and load the DWFX file with full path
        *   Create & set ConvertOptions for the dwf type
        *   Call Converter.Convert method and pass the full path and format (DWF) as parameter
    ...
    code: |
        ...
        // set the convert options for DWF format
...
demos:
    enable: true
    title: "DWFX to DWF Live Demos"
    content: |
        Convert DWFX to DWF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
