...
############################# Head ############################
head_title: "DWFX to PNG Converter – Convert DWFX to PNG in C# .NET"
head_description: "How to convert DWFX to PNG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert DWFX to PNG in C#"
description: "Native and high performance DWFX to PNG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert DWFX to PNG in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the DWFX file to PNG using a few lines of code.
