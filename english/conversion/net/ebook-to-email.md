...
############################# Head ############################
head_title: "EBOOK to EMAIL Converter – Convert EBOOK to EMAIL in C# .NET"
head_description: "How to convert EBOOK to EMAIL in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert EBOOK to EMAIL in C#"
description: "Native and high performance EBOOK to EMAIL conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
demos:
    ...
    content: |
        Convert EBOOK to EMAIL right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
