...
############################# Head ############################
head_title: "Convert eBook to Photoshop in C# .NET VB.NET"
head_description: "Convert eBook files to Photoshop and 80+ other file formats using native documents conversion API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."

############################# Header ############################
title: "Convert eBook to Photoshop in .NET"
description: "Convert eBook files to Photoshop and 80+ other file formats using native documents conversion API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
demos:
    ...
    content: |
        Convert eBook to Photoshop right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/ebook-to-photoshop) website.  
