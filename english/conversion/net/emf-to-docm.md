...
############################# Head ############################
head_title: "EMF to DOCM Converter – Convert EMF to DOCM in C# .NET"
head_description: "How to convert EMF to DOCM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert EMF to DOCM in C#"
description: "Native and high performance EMF to DOCM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the EMF file to DOCM using a few lines of code.
