...
############################# Head ############################
head_title: "EPS to XPS Converter – Convert EPS to XPS in C# .NET"
head_description: "How to convert EPS to XPS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert EPS to XPS in C#"
description: "Native and high performance EPS to XPS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert EPS to XPS in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the EPS file to XPS using a few lines of code.
