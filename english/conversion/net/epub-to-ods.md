...
############################# Head ############################
head_title: "EPUB to ODS Converter – Convert EPUB to ODS in C# .NET"
head_description: "How to convert EPUB to ODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert EPUB to ODS in C#"
description: "Native and high performance EPUB to ODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the EPUB file to ODS using a few lines of code.
...
demos:
    enable: true
    title: "EPUB to ODS Live Demos"
    content: |
        Convert EPUB to ODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
