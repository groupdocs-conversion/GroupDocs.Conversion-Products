...
############################# Head ############################
head_title: "Convert Excel to DOC in C#, ASP.NET, VB.NET"
head_description: "Convert Excel worksheet to DOC and 80+ other file formats in C#, ASP.NET, VB.NET & .NET Core applications using document conversion API."

############################# Header ############################
title: "Convert Excel to DOC in C# .NET"
description: "Native and high performance Excel Worksheet to DOC conversion API for C#, ASP.NET, VB.NET & .NET Core applications, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Convert Excel to DOC in C# .NET"
    content_left: |
