...
############################# Head ############################
head_title: "Convert Excel to DOTM in C#, ASP.NET, VB.NET"
head_description: "Convert Excel worksheet to DOTM and 80+ other file formats in C#, ASP.NET, VB.NET & .NET Core applications using document conversion API."

############################# Header ############################
title: "Convert Excel to DOTM in C# .NET"
description: "Native and high performance Excel Worksheet to DOTM conversion API for C#, ASP.NET, VB.NET & .NET Core applications, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Convert Excel to DOTM in C# .NET"
    content_left: |
