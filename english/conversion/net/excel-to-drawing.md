...
############################# Head ############################
head_title: "Convert Excel to Drawing in C#, ASP.NET, VB.NET"
head_description: "Convert Excel worksheet to Drawing and 80+ other file formats in C#, ASP.NET, VB.NET & .NET Core applications using document conversion API."

############################# Header ############################
title: "Convert Excel to Drawing in C# .NET"
description: "Native and high performance Excel Worksheet to Drawing conversion API for C#, ASP.NET, VB.NET & .NET Core applications, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Convert Excel to Drawing in C# .NET"
    content_left: |
        ...
        *   Create & set **ConvertOptions** for the dwg type
    ...
    code: |
        ...
        var convertOptions = converter.GetPossibleConversions()["dwg"].ConvertOptions;
        // convert to Drawing format
        converter.Convert("output.dwg", convertOptions);
        ```
