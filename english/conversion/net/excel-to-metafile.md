...
############################# Head ############################
head_title: "EXCEL to METAFILE Converter – Convert EXCEL to METAFILE in C# .NET"
head_description: "How to convert EXCEL to METAFILE in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert EXCEL to METAFILE in C#"
description: "Native and high performance EXCEL to METAFILE conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        ...
        *   Create & set ConvertOptions for the metafile type
