...
############################# Head ############################
head_title: "Convert Excel to Web in C#, ASP.NET, VB.NET"
...
############################# Header ############################
title: "Convert Excel to Web in C# .NET"
description: "Native and high performance Excel Worksheet to Web conversion API for C#, ASP.NET, VB.NET & .NET Core applications, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Convert Excel to Web in C# .NET"
    content_left: |
