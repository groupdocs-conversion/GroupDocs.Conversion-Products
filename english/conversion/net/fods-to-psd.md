...
############################# Head ############################
head_title: "FODS to PSD Converter – Convert FODS to PSD in C# .NET"
head_description: "How to convert FODS to PSD in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert FODS to PSD in C#"
description: "Native and high performance FODS to PSD conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the FODS file to PSD using a few lines of code.
