...
############################# Head ############################
head_title: "GIF to MHT Converter – Convert GIF to MHT in C# .NET"
head_description: "How to convert GIF to MHT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert GIF to MHT in C#"
description: "Native and high performance GIF to MHT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert GIF to MHT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the GIF file to MHT using a few lines of code.
