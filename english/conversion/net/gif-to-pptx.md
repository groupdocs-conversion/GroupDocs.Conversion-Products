...
############################# Head ############################
head_title: "GIF to PPTX Converter – Convert GIF to PPTX in C# .NET"
head_description: "How to convert GIF to PPTX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert GIF to PPTX in C#"
description: "Native and high performance GIF to PPTX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the GIF file to PPTX using a few lines of code.
