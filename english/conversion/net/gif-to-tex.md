...
############################# Head ############################
head_title: "GIF to TEX Converter – Convert GIF to TEX in C# .NET"
head_description: "How to convert GIF to TEX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert GIF to TEX in C#"
description: "Native and high performance GIF to TEX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert GIF to TEX in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the GIF file to TEX using a few lines of code.
...
demos:
    enable: true
    title: "GIF to TEX Live Demos"
    content: |
        Convert GIF to TEX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
