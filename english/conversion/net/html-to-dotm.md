...
############################# Head ############################
head_title: "HTML to DOTM Converter – Convert HTML to DOTM in C# .NET"
head_description: "How to convert HTML to DOTM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert HTML to DOTM in C#"
description: "Native and high performance HTML to DOTM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the HTML file to DOTM using a few lines of code.
...
demos:
    enable: true
    title: "HTML to DOTM Live Demos"
    content: |
        Convert HTML to DOTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
