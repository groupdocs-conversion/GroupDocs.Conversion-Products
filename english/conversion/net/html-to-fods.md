...
############################# Head ############################
head_title: "HTML to FODS Converter – Convert HTML to FODS in C# .NET"
head_description: "How to convert HTML to FODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert HTML to FODS in C#"
description: "Native and high performance HTML to FODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert HTML to FODS in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the HTML file to FODS using a few lines of code.
...
demos:
    enable: true
    title: "HTML to FODS Live Demos"
    content: |
        Convert HTML to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
