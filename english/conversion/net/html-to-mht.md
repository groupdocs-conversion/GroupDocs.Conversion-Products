...
############################# Head ############################
head_title: "HTML to MHT Converter – Convert HTML to MHT in C# .NET"
head_description: "How to convert HTML to MHT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert HTML to MHT in C#"
description: "Native and high performance HTML to MHT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the HTML file to MHT using a few lines of code.
