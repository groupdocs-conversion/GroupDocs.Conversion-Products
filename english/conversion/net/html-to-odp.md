...
############################# Head ############################
head_title: "HTML to ODP Converter – Convert HTML to ODP in C# .NET"
head_description: "How to convert HTML to ODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert HTML to ODP in C#"
description: "Native and high performance HTML to ODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert HTML to ODP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the HTML file to ODP using a few lines of code.
...
demos:
    enable: true
    title: "HTML to ODP Live Demos"
    content: |
        Convert HTML to ODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
