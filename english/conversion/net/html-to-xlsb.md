...
############################# Head ############################
head_title: "HTML to XLSB Converter – Convert HTML to XLSB in C# .NET"
head_description: "How to convert HTML to XLSB in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert HTML to XLSB in C#"
description: "Native and high performance HTML to XLSB conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert HTML to XLSB in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the HTML file to XLSB using a few lines of code.
