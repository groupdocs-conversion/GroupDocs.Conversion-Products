...
############################# Head ############################
head_title: "IFC to EPUB Converter – Convert IFC to EPUB in C# .NET"
head_description: "How to convert IFC to EPUB in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IFC to EPUB in C#"
description: "Native and high performance IFC to EPUB conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert IFC to EPUB in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IFC file to EPUB using a few lines of code.
