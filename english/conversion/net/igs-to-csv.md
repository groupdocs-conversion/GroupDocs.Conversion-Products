...
############################# Head ############################
head_title: "IGS to CSV Converter – Convert IGS to CSV in C# .NET"
head_description: "How to convert IGS to CSV in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IGS to CSV in C#"
description: "Native and high performance IGS to CSV conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IGS file to CSV using a few lines of code.
...
demos:
    enable: true
    title: "IGS to CSV Live Demos"
    content: |
        Convert IGS to CSV right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
