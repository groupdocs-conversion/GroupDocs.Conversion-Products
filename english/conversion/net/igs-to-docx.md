...
############################# Head ############################
head_title: "IGS to DOCX Converter – Convert IGS to DOCX in C# .NET"
head_description: "How to convert IGS to DOCX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IGS to DOCX in C#"
description: "Native and high performance IGS to DOCX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert IGS to DOCX in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IGS file to DOCX using a few lines of code.
...
demos:
    enable: true
    title: "IGS to DOCX Live Demos"
    content: |
        Convert IGS to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
