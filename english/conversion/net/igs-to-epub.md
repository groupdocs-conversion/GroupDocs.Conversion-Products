...
############################# Head ############################
head_title: "IGS to EPUB Converter – Convert IGS to EPUB in C# .NET"
head_description: "How to convert IGS to EPUB in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IGS to EPUB in C#"
description: "Native and high performance IGS to EPUB conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IGS file to EPUB using a few lines of code.
...
demos:
    enable: true
    title: "IGS to EPUB Live Demos"
    content: |
        Convert IGS to EPUB right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
