...
############################# Head ############################
head_title: "IGS to IGS Converter – Convert IGS to IGS in C# .NET"
head_description: "How to convert IGS to IGS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IGS to IGS in C#"
description: "Native and high performance IGS to IGS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IGS file to IGS using a few lines of code.

        *   Create an instance of Converter class and load the IGS file with full path
        *   Create & set ConvertOptions for the igs type
        *   Call Converter.Convert method and pass the full path and format (IGS) as parameter
    ...
    code: |
        ...
        // set the convert options for IGS format
