...
############################# Head ############################
head_title: "IGS to JPEG Converter – Convert IGS to JPEG in C# .NET"
head_description: "How to convert IGS to JPEG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IGS to JPEG in C#"
description: "Native and high performance IGS to JPEG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert IGS to JPEG in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IGS file to JPEG using a few lines of code.
