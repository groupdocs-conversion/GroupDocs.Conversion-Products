...
############################# Head ############################
head_title: "IGS to PPTX Converter – Convert IGS to PPTX in C# .NET"
head_description: "How to convert IGS to PPTX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert IGS to PPTX in C#"
description: "Native and high performance IGS to PPTX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the IGS file to PPTX using a few lines of code.
...
demos:
    enable: true
    title: "IGS to PPTX Live Demos"
    content: |
        Convert IGS to PPTX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
