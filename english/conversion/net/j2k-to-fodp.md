...
############################# Head ############################
head_title: "J2K to FODP Converter – Convert J2K to FODP in C# .NET"
head_description: "How to convert J2K to FODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert J2K to FODP in C#"
description: "Native and high performance J2K to FODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert J2K to FODP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the J2K file to FODP using a few lines of code.
...
demos:
    enable: true
    title: "J2K to FODP Live Demos"
    content: |
        Convert J2K to FODP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "J2K TO DOCX"
          link: "https://products.groupdocs.com/conversion/net/j2k-to-docx/"
