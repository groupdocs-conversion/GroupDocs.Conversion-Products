...
############################# Head ############################
head_title: "JLS to DOC Converter – Convert JLS to DOC in C# .NET"
head_description: "How to convert JLS to DOC in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JLS to DOC in C#"
description: "Native and high performance JLS to DOC conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert JLS to DOC in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JLS file to DOC using a few lines of code.
