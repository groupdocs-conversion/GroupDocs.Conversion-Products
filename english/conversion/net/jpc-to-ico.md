...
############################# Head ############################
head_title: "JPC to ICO Converter – Convert JPC to ICO in C# .NET"
head_description: "How to convert JPC to ICO in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPC to ICO in C#"
description: "Native and high performance JPC to ICO conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert JPC to ICO in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPC file to ICO using a few lines of code.
...
demos:
    enable: true
    title: "JPC to ICO Live Demos"
    content: |
        Convert JPC to ICO right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
...
more_formats:
    ...
    format: 
        ...
        # format loop
        - name: "JPC TO DOCX"
          link: "https://products.groupdocs.com/conversion/net/jpc-to-docx/"
