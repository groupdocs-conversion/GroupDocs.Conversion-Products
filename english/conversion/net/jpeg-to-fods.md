...
############################# Head ############################
head_title: "JPEG to FODS Converter – Convert JPEG to FODS in C# .NET"
head_description: "How to convert JPEG to FODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPEG to FODS in C#"
description: "Native and high performance JPEG to FODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPEG file to FODS using a few lines of code.
...
demos:
    enable: true
    title: "JPEG to FODS Live Demos"
    content: |
        Convert JPEG to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
