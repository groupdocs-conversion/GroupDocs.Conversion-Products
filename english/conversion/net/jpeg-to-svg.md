...
############################# Head ############################
head_title: "JPEG to SVG Converter – Convert JPEG to SVG in C# .NET"
head_description: "How to convert JPEG to SVG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPEG to SVG in C#"
description: "Native and high performance JPEG to SVG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPEG file to SVG using a few lines of code.
...
demos:
    enable: true
    title: "JPEG to SVG Live Demos"
    content: |
        Convert JPEG to SVG right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
