...
############################# Head ############################
head_title: "JPEG to XLSX Converter – Convert JPEG to XLSX in C# .NET"
head_description: "How to convert JPEG to XLSX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPEG to XLSX in C#"
description: "Native and high performance JPEG to XLSX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert JPEG to XLSX in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPEG file to XLSX using a few lines of code.
