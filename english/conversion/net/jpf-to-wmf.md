...
############################# Head ############################
head_title: "JPF to WMF Converter – Convert JPF to WMF in C# .NET"
head_description: "How to convert JPF to WMF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPF to WMF in C#"
description: "Native and high performance JPF to WMF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert JPF to WMF in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPF file to WMF using a few lines of code.
