...
############################# Head ############################
head_title: "JPG to BMP Converter – Convert JPG to BMP in C# .NET"
head_description: "How to convert JPG to BMP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPG to BMP in C#"
description: "Native and high performance JPG to BMP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert JPG to BMP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPG file to BMP using a few lines of code.
...
demos:
    enable: true
    title: "JPG to BMP Live Demos"
    content: |
        Convert JPG to BMP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
