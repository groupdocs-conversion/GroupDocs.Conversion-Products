...
############################# Head ############################
head_title: "JPG to JP2 Converter – Convert JPG to JP2 in C# .NET"
head_description: "How to convert JPG to JP2 in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPG to JP2 in C#"
description: "Native and high performance JPG to JP2 conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPG file to JP2 using a few lines of code.
