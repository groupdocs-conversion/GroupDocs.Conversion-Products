...
############################# Head ############################
head_title: "JPM to XPS Converter – Convert JPM to XPS in C# .NET"
head_description: "How to convert JPM to XPS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPM to XPS in C#"
description: "Native and high performance JPM to XPS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPM file to XPS using a few lines of code.
