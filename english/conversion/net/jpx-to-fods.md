...
############################# Head ############################
head_title: "JPX to FODS Converter – Convert JPX to FODS in C# .NET"
head_description: "How to convert JPX to FODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPX to FODS in C#"
description: "Native and high performance JPX to FODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPX file to FODS using a few lines of code.
...
demos:
    enable: true
    title: "JPX to FODS Live Demos"
    content: |
        Convert JPX to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
