...
############################# Head ############################
head_title: "JPX to XPS Converter – Convert JPX to XPS in C# .NET"
head_description: "How to convert JPX to XPS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert JPX to XPS in C#"
description: "Native and high performance JPX to XPS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert JPX to XPS in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the JPX file to XPS using a few lines of code.
