...
############################# Head ############################
head_title: "LOG to EMZ Converter – Convert LOG to EMZ in C# .NET"
head_description: "How to convert LOG to EMZ in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert LOG to EMZ in C#"
description: "Native and high performance LOG to EMZ conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert LOG to EMZ in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the LOG file to EMZ using a few lines of code.
