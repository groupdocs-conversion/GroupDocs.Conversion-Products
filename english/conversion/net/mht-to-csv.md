...
############################# Head ############################
head_title: "MHT to CSV Converter – Convert MHT to CSV in C# .NET"
head_description: "How to convert MHT to CSV in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MHT to CSV in C#"
description: "Native and high performance MHT to CSV conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MHT file to CSV using a few lines of code.
