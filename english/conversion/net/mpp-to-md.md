...
############################# Head ############################
head_title: "MPP to MD Converter – Convert MPP to MD in C# .NET"
head_description: "How to convert MPP to MD in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MPP to MD in C#"
description: "Native and high performance MPP to MD conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert MPP to MD in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MPP file to MD using a few lines of code.
