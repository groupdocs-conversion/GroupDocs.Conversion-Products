...
############################# Head ############################
head_title: "MPP to TIFF Converter – Convert MPP to TIFF in C# .NET"
head_description: "How to convert MPP to TIFF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MPP to TIFF in C#"
description: "Native and high performance MPP to TIFF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MPP file to TIFF using a few lines of code.
