...
############################# Head ############################
head_title: "MPX to CSV Converter – Convert MPX to CSV in C# .NET"
head_description: "How to convert MPX to CSV in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MPX to CSV in C#"
description: "Native and high performance MPX to CSV conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert MPX to CSV in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MPX file to CSV using a few lines of code.
