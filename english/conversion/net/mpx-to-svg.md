...
############################# Head ############################
head_title: "MPX to SVG Converter – Convert MPX to SVG in C# .NET"
head_description: "How to convert MPX to SVG in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MPX to SVG in C#"
description: "Native and high performance MPX to SVG conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert MPX to SVG in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MPX file to SVG using a few lines of code.
