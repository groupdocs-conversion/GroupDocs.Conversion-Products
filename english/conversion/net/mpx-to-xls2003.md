...
############################# Head ############################
head_title: "MPX to XLS2003 Converter – Convert MPX to XLS2003 in C# .NET"
head_description: "How to convert MPX to XLS2003 in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert MPX to XLS2003 in C#"
description: "Native and high performance MPX to XLS2003 conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert MPX to XLS2003 in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the MPX file to XLS2003 using a few lines of code.

        *   Create an instance of Converter class and load the MPX file with full path
        *   Create & set ConvertOptions for the xlas2003 type
    ...
    code: |
        ...
        var convertOptions = converter.GetPossibleConversions()["xlas2003"].ConvertOptions;
        // convert to XLS2003 format
        converter.Convert("output.xlas2003", convertOptions);
        ```
