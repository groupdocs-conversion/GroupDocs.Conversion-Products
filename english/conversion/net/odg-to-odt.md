...
############################# Head ############################
head_title: "ODG to ODT Converter – Convert ODG to ODT in C# .NET"
head_description: "How to convert ODG to ODT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert ODG to ODT in C#"
description: "Native and high performance ODG to ODT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the ODG file to ODT using a few lines of code.
