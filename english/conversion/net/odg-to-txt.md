...
############################# Head ############################
head_title: "ODG to TXT Converter – Convert ODG to TXT in C# .NET"
head_description: "How to convert ODG to TXT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert ODG to TXT in C#"
description: "Native and high performance ODG to TXT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the ODG file to TXT using a few lines of code.
