...
############################# Head ############################
head_title: "ODP to WMF Converter – Convert ODP to WMF in C# .NET"
head_description: "How to convert ODP to WMF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert ODP to WMF in C#"
description: "Native and high performance ODP to WMF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the ODP file to WMF using a few lines of code.
