...
############################# Head ############################
head_title: "ODT to HTM Converter – Convert ODT to HTM in C# .NET"
head_description: "How to convert ODT to HTM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert ODT to HTM in C#"
description: "Native and high performance ODT to HTM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the ODT file to HTM using a few lines of code.
