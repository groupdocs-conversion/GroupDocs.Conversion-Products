...
############################# Head ############################
head_title: "ODT to ICO Converter – Convert ODT to ICO in C# .NET"
head_description: "How to convert ODT to ICO in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert ODT to ICO in C#"
description: "Native and high performance ODT to ICO conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert ODT to ICO in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the ODT file to ICO using a few lines of code.
