...
############################# Head ############################
head_title: "ONE to XPS Converter – Convert ONE to XPS in C# .NET"
head_description: "How to convert ONE to XPS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert ONE to XPS in C#"
description: "Native and high performance ONE to XPS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the ONE file to XPS using a few lines of code.
