...
############################# Head ############################
head_title: "OTG to DOCX Converter – Convert OTG to DOCX in C# .NET"
head_description: "How to convert OTG to DOCX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OTG to DOCX in C#"
description: "Native and high performance OTG to DOCX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OTG file to DOCX using a few lines of code.
