...
############################# Head ############################
head_title: "OTG to DOT Converter – Convert OTG to DOT in C# .NET"
head_description: "How to convert OTG to DOT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OTG to DOT in C#"
description: "Native and high performance OTG to DOT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert OTG to DOT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OTG file to DOT using a few lines of code.
