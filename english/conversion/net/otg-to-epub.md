...
############################# Head ############################
head_title: "OTG to EPUB Converter – Convert OTG to EPUB in C# .NET"
head_description: "How to convert OTG to EPUB in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OTG to EPUB in C#"
description: "Native and high performance OTG to EPUB conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OTG file to EPUB using a few lines of code.
