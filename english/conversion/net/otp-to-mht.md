...
############################# Head ############################
head_title: "OTP to MHT Converter – Convert OTP to MHT in C# .NET"
head_description: "How to convert OTP to MHT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OTP to MHT in C#"
description: "Native and high performance OTP to MHT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OTP file to MHT using a few lines of code.
