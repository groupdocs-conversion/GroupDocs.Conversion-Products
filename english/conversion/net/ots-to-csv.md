...
############################# Head ############################
head_title: "OTS to CSV Converter – Convert OTS to CSV in C# .NET"
head_description: "How to convert OTS to CSV in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OTS to CSV in C#"
description: "Native and high performance OTS to CSV conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert OTS to CSV in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OTS file to CSV using a few lines of code.
