...
############################# Head ############################
head_title: "OTS to ICO Converter – Convert OTS to ICO in C# .NET"
head_description: "How to convert OTS to ICO in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OTS to ICO in C#"
description: "Native and high performance OTS to ICO conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OTS file to ICO using a few lines of code.
