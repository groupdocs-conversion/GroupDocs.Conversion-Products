...
############################# Head ############################
head_title: "OTT to SXC Converter – Convert OTT to SXC in C# .NET"
head_description: "How to convert OTT to SXC in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OTT to SXC in C#"
description: "Native and high performance OTT to SXC conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert OTT to SXC in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OTT file to SXC using a few lines of code.
...
demos:
    enable: true
    title: "OTT to SXC Live Demos"
    content: |
        Convert OTT to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
