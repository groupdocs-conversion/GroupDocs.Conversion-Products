...
############################# Head ############################
head_title: "OUTLOOK to ODS Converter – Convert OUTLOOK to ODS in C# .NET"
head_description: "How to convert OUTLOOK to ODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OUTLOOK to ODS in C#"
description: "Native and high performance OUTLOOK to ODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert OUTLOOK to ODS in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OUTLOOK file to ODS using a few lines of code.
