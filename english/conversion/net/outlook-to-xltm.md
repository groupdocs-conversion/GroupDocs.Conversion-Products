...
############################# Head ############################
head_title: "OUTLOOK to XLTM Converter – Convert OUTLOOK to XLTM in C# .NET"
head_description: "How to convert OUTLOOK to XLTM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert OUTLOOK to XLTM in C#"
description: "Native and high performance OUTLOOK to XLTM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert OUTLOOK to XLTM in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the OUTLOOK file to XLTM using a few lines of code.
...
demos:
    enable: true
    title: "OUTLOOK to XLTM Live Demos"
    content: |
        Convert OUTLOOK to XLTM right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
...
more_formats:
    ...
    format: 
        ...
        - name: "OUTLOOK TO OUTLOOK"
          link: "https://products.groupdocs.com/conversion/net/outlook-to-outlook/"
