...
############################# Head ############################
head_title: "POTX to DOCX Converter – Convert POTX to DOCX in C# .NET"
head_description: "How to convert POTX to DOCX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert POTX to DOCX in C#"
description: "Native and high performance POTX to DOCX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the POTX file to DOCX using a few lines of code.
...
demos:
    enable: true
    title: "POTX to DOCX Live Demos"
    content: |
        Convert POTX to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
