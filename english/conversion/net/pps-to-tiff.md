...
############################# Head ############################
head_title: "PPS to TIFF Converter – Convert PPS to TIFF in C# .NET"
head_description: "How to convert PPS to TIFF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert PPS to TIFF in C#"
description: "Native and high performance PPS to TIFF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the PPS file to TIFF using a few lines of code.
