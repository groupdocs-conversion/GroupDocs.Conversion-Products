...
############################# Head ############################
head_title: "PPT to ODP Converter – Convert PPT to ODP in C# .NET"
head_description: "How to convert PPT to ODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert PPT to ODP in C#"
description: "Native and high performance PPT to ODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the PPT file to ODP using a few lines of code.
