...
############################# Head ############################
head_title: "PROJECT to HTML Converter – Convert PROJECT to HTML in C# .NET"
head_description: "How to convert PROJECT to HTML in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert PROJECT to HTML in C#"
description: "Native and high performance PROJECT to HTML conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert PROJECT to HTML in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the PROJECT file to HTML using a few lines of code.
...
demos:
    enable: true
    title: "PROJECT to HTML Live Demos"
    content: |
        Convert PROJECT to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
