...
############################# Head ############################
head_title: "PS to PDF Converter – Convert PS to PDF in C# .NET"
head_description: "How to convert PS to PDF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert PS to PDF in C#"
description: "Native and high performance PS to PDF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the PS file to PDF using a few lines of code.
...
demos:
    enable: true
    title: "PS to PDF Live Demos"
    content: |
        Convert PS to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
