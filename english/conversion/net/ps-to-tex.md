...
############################# Head ############################
head_title: "PS to TEX Converter – Convert PS to TEX in C# .NET"
head_description: "How to convert PS to TEX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert PS to TEX in C#"
description: "Native and high performance PS to TEX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the PS file to TEX using a few lines of code.
