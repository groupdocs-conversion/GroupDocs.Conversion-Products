...
############################# Head ############################
head_title: "PST to PS Converter – Convert PST to PS in C# .NET"
head_description: "How to convert PST to PS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert PST to PS in C#"
description: "Native and high performance PST to PS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the PST file to PS using a few lines of code.

        *   Create an instance of Converter class and load the PST file with full path
        *   Create & set ConvertOptions for the ps type
        *   Call Converter.Convert method and pass the full path and format (PS) as parameter
    ...
    code: |
        ...
        // set the convert options for PS format
