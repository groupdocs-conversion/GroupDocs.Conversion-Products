...
############################# Head ############################
head_title: "RTF to DCM Converter – Convert RTF to DCM in C# .NET"
head_description: "How to convert RTF to DCM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert RTF to DCM in C#"
description: "Native and high performance RTF to DCM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the RTF file to DCM using a few lines of code.
