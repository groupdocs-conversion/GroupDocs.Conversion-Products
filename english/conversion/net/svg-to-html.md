...
############################# Head ############################
head_title: "SVG to HTML Converter – Convert SVG to HTML in C# .NET"
head_description: "How to convert SVG to HTML in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert SVG to HTML in C#"
description: "Native and high performance SVG to HTML conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert SVG to HTML in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the SVG file to HTML using a few lines of code.
...
demos:
    enable: true
    title: "SVG to HTML Live Demos"
    content: |
        Convert SVG to HTML right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
