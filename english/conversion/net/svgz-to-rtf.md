...
############################# Head ############################
head_title: "SVGZ to RTF Converter – Convert SVGZ to RTF in C# .NET"
head_description: "How to convert SVGZ to RTF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert SVGZ to RTF in C#"
description: "Native and high performance SVGZ to RTF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert SVGZ to RTF in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the SVGZ file to RTF using a few lines of code.
