...
############################# Head ############################
head_title: "SXC to DIF Converter – Convert SXC to DIF in C# .NET"
head_description: "How to convert SXC to DIF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert SXC to DIF in C#"
description: "Native and high performance SXC to DIF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert SXC to DIF in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the SXC file to DIF using a few lines of code.
