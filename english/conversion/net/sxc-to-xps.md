...
############################# Head ############################
head_title: "SXC to XPS Converter – Convert SXC to XPS in C# .NET"
head_description: "How to convert SXC to XPS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert SXC to XPS in C#"
description: "Native and high performance SXC to XPS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the SXC file to XPS using a few lines of code.
