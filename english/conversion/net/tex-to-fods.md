...
############################# Head ############################
head_title: "TEX to FODS Converter – Convert TEX to FODS in C# .NET"
head_description: "How to convert TEX to FODS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TEX to FODS in C#"
description: "Native and high performance TEX to FODS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TEX file to FODS using a few lines of code.
...
demos:
    enable: true
    title: "TEX to FODS Live Demos"
    content: |
        Convert TEX to FODS right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
