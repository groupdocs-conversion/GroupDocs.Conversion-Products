...
############################# Head ############################
head_title: "TEX to MHT Converter – Convert TEX to MHT in C# .NET"
head_description: "How to convert TEX to MHT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TEX to MHT in C#"
description: "Native and high performance TEX to MHT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert TEX to MHT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TEX file to MHT using a few lines of code.
...
demos:
    enable: true
    title: "TEX to MHT Live Demos"
    content: |
        Convert TEX to MHT right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
