...
############################# Head ############################
head_title: "TIF to DCM Converter – Convert TIF to DCM in C# .NET"
head_description: "How to convert TIF to DCM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TIF to DCM in C#"
description: "Native and high performance TIF to DCM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TIF file to DCM using a few lines of code.
