...
############################# Head ############################
head_title: "TIF to WEBP Converter – Convert TIF to WEBP in C# .NET"
head_description: "How to convert TIF to WEBP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TIF to WEBP in C#"
description: "Native and high performance TIF to WEBP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TIF file to WEBP using a few lines of code.
...
demos:
    enable: true
    title: "TIF to WEBP Live Demos"
    content: |
        Convert TIF to WEBP right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
