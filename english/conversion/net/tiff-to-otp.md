...
############################# Head ############################
head_title: "TIFF to OTP Converter – Convert TIFF to OTP in C# .NET"
head_description: "How to convert TIFF to OTP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TIFF to OTP in C#"
description: "Native and high performance TIFF to OTP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert TIFF to OTP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TIFF file to OTP using a few lines of code.
