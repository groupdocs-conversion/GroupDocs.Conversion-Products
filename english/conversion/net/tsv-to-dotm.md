...
############################# Head ############################
head_title: "TSV to DOTM Converter – Convert TSV to DOTM in C# .NET"
head_description: "How to convert TSV to DOTM in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TSV to DOTM in C#"
description: "Native and high performance TSV to DOTM conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TSV file to DOTM using a few lines of code.
