...
############################# Head ############################
head_title: "TSV to POT Converter – Convert TSV to POT in C# .NET"
head_description: "How to convert TSV to POT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert TSV to POT in C#"
description: "Native and high performance TSV to POT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert TSV to POT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the TSV file to POT using a few lines of code.
