...
############################# Head ############################
head_title: "VDX to RTF Converter – Convert VDX to RTF in C# .NET"
head_description: "How to convert VDX to RTF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert VDX to RTF in C#"
description: "Native and high performance VDX to RTF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the VDX file to RTF using a few lines of code.
