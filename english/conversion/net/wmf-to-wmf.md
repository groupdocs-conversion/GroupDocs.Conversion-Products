...
############################# Head ############################
head_title: "WMF to WMF Converter – Convert WMF to WMF in C# .NET"
head_description: "How to convert WMF to WMF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert WMF to WMF in C#"
description: "Native and high performance WMF to WMF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the WMF file to WMF using a few lines of code.
