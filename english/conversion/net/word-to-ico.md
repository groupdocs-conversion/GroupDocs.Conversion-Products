...
############################# Head ############################
head_title: "WORD to ICO Converter – Convert WORD to ICO in C# .NET"
head_description: "How to convert WORD to ICO in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert WORD to ICO in C#"
description: "Native and high performance WORD to ICO conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert WORD to ICO in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the WORD file to ICO using a few lines of code.
