...
############################# Head ############################
head_title: "Convert Word File to PDF in C# .NET – 3 Steps Conversion"
head_description: "Convert Word document files to PDF and 80+ other file formats using native documents conversion API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."

############################# Header ############################
title: "Convert Word File to PDF in C# .NET"
description: "Convert Word document files to PDF and 80+ other file formats using native documents conversion API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "How to Convert Word File to PDF in .NET"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to accurately convert the word documents to PDF using a few lines of C# .NET code.
...
demos:
    enable: true
    title: "Live Demos: Word to PDF Converter"
    content: |
        Convert Word to PDF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
