...
############################# Head ############################
head_title: "Convert Word File to Presentation in C# .NET – 3 Steps Conversion"
head_description: "Convert Word document files to Presentation and 80+ other file formats using native documents conversion API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."

############################# Header ############################
title: "Convert Word File to Presentation in C# .NET"
description: "Convert Word document files to Presentation and 80+ other file formats using native documents conversion API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "How to Convert Word File to Presentation in .NET"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to accurately convert the word documents to Presentation using a few lines of C# .NET code.

        *   Create an instance of **Converter** class and load the Word file with full path
        *   Create & set **ConvertOptions** for the pptx type
        *   Call **Converter.Convert** method and pass the full path and format (Presentation) as parameter
    ...
    code: |
        ...
        // set the convert options for Presentation format
...
demos:
    enable: true
    title: "Live Demos: Word to Presentation Converter"
    content: |
