...
############################# Head ############################
head_title: "WORD to TXT Converter – Convert WORD to TXT in C# .NET"
head_description: "How to convert WORD to TXT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert WORD to TXT in C#"
description: "Native and high performance WORD to TXT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert WORD to TXT in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the WORD file to TXT using a few lines of code.
