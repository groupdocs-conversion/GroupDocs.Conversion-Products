...
############################# Head ############################
head_title: "XLS to CSV Converter – Convert XLS to CSV in C# .NET"
head_description: "How to convert XLS to CSV in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLS to CSV in C#"
description: "Native and high performance XLS to CSV conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert XLS to CSV in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLS file to CSV using a few lines of code.
