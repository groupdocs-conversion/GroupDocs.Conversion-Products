...
############################# Head ############################
head_title: "XLSX to DOTX Converter – Convert XLSX to DOTX in C# .NET"
head_description: "How to convert XLSX to DOTX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLSX to DOTX in C#"
description: "Native and high performance XLSX to DOTX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLSX file to DOTX using a few lines of code.
