...
############################# Head ############################
head_title: "XLSX to FODP Converter – Convert XLSX to FODP in C# .NET"
head_description: "How to convert XLSX to FODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLSX to FODP in C#"
description: "Native and high performance XLSX to FODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert XLSX to FODP in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLSX file to FODP using a few lines of code.
