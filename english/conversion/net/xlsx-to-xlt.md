...
############################# Head ############################
head_title: "XLSX to XLT Converter – Convert XLSX to XLT in C# .NET"
head_description: "How to convert XLSX to XLT in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLSX to XLT in C#"
description: "Native and high performance XLSX to XLT conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLSX file to XLT using a few lines of code.
