...
############################# Head ############################
head_title: "XLT to XPS Converter – Convert XLT to XPS in C# .NET"
head_description: "How to convert XLT to XPS in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLT to XPS in C#"
description: "Native and high performance XLT to XPS conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert XLT to XPS in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLT file to XPS using a few lines of code.
