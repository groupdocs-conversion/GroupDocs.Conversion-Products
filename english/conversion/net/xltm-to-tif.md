...
############################# Head ############################
head_title: "XLTM to TIF Converter – Convert XLTM to TIF in C# .NET"
head_description: "How to convert XLTM to TIF in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLTM to TIF in C#"
description: "Native and high performance XLTM to TIF conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert XLTM to TIF in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLTM file to TIF using a few lines of code.
...
demos:
    enable: true
    title: "XLTM to TIF Live Demos"
    content: |
        Convert XLTM to TIF right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
