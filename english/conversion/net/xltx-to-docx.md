...
############################# Head ############################
head_title: "XLTX to DOCX Converter – Convert XLTX to DOCX in C# .NET"
head_description: "How to convert XLTX to DOCX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLTX to DOCX in C#"
description: "Native and high performance XLTX to DOCX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert XLTX to DOCX in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLTX file to DOCX using a few lines of code.
...
demos:
    enable: true
    title: "XLTX to DOCX Live Demos"
    content: |
        Convert XLTX to DOCX right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
