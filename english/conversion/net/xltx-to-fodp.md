...
############################# Head ############################
head_title: "XLTX to FODP Converter – Convert XLTX to FODP in C# .NET"
head_description: "How to convert XLTX to FODP in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XLTX to FODP in C#"
description: "Native and high performance XLTX to FODP conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XLTX file to FODP using a few lines of code.
