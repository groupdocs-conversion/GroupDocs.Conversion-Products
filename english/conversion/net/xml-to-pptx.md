...
############################# Head ############################
head_title: "XML to PPTX Converter – Convert XML to PPTX in C# .NET"
head_description: "How to convert XML to PPTX in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XML to PPTX in C#"
description: "Native and high performance XML to PPTX conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert XML to PPTX in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XML file to PPTX using a few lines of code.
