...
############################# Head ############################
head_title: "XML to SXC Converter – Convert XML to SXC in C# .NET"
head_description: "How to convert XML to SXC in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XML to SXC in C#"
description: "Native and high performance XML to SXC conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XML file to SXC using a few lines of code.
...
demos:
    enable: true
    title: "XML to SXC Live Demos"
    content: |
        Convert XML to SXC right now by visiting [GroupDocs.Conversion Live Demos](https://products.groupdocs.app/conversion/family) website.  
