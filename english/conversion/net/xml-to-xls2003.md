...
############################# Head ############################
head_title: "XML to XLS2003 Converter – Convert XML to XLS2003 in C# .NET"
head_description: "How to convert XML to XLS2003 in C# .NET using a few lines of code? Use GroupDocs documents conversion APIs to convert 160+ file formats."

############################# Header ############################
title: "Convert XML to XLS2003 in C#"
description: "Native and high performance XML to XLS2003 conversion using server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Convert XML to XLS2003 in C#"
    content_left: |
        [GroupDocs.Conversion](https://products.groupdocs.com/conversion/net) makes it easy for developers to convert the XML file to XLS2003 using a few lines of code.
